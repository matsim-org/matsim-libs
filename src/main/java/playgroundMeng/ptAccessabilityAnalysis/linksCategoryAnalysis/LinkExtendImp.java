...
public class LinkExtendImp implements Link {
	...
	private Map<Double, Double> time2Score;
	
	public LinkExtendImp(Link link, PtAccessabilityConfig analysisConfig) {
		this.link = link;
		this.analysisConfig = analysisConfig;
	}
	
	public LinkExtendImp(Id<Link> linkId) {
		this.linkId = linkId; 
	}
	...
	public double getDistance2Stops(TransitStopFacilityExtendImp transitStopFacilityExtendImp) {
		...
		double x1 = stopCoord.getX(); double y1 = stopCoord.getY();
		double x2 = linkCoord.getX(); double y2 = linkCoord.getY();
	...
	public void setTime2Score(Double time, Double score) {
		Map<Double, Double> time2Score = new HashedMap();
		time2Score.put(time, score);
		this.time2Score = time2Score;
	}
	public Map<Double, Double> getTime2Score() {
		return time2Score;
	}
