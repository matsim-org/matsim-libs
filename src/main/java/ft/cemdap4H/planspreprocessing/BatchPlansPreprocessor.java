...
//		new ActivityTypeTimeConverter().run(cemdapOutputFolder+"mergedPlans.xml.gz", cemdapOutputFolder+"mergedPlans_dur.xml.gz", cemdapOutputFolder+"activityConfig.xml");
        ...
        new ReassignZonesByAttractiveness().run(baseFolder + "\\add_data\\shp\\Statistische_Bezirke_Hannover_Region.shp", baseFolder + "\\add_data\\Weights_All.txt", cemdapOutputFolder + "mergedPlans_dur_dropped_Work.xml.gz", simulationFolder + "finishedPlans.xml.gz");
