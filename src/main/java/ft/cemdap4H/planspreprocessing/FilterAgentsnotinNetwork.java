    ...
    private static void updateCoordLists(Person person) {
        ...
        for (Plan plan : person.getPlans()) {
            ...
            for (Activity act : activities) {
                ...
                Double buffercoordX = act.getCoord().getX() + safetyBufferInMeter;
                Double buffercoordY = act.getCoord().getY() + safetyBufferInMeter;

                Coord bufferCoord = new Coord(buffercoordX, buffercoordY);

                Coord transformedCoord = coordinateTransformation.transform(bufferCoord);
