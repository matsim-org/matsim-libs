 ...
 * 
 */
public void run(String shapeFile, String populationFile, String keyInShape, CoordinateTransformation ct) {
	...
	for (Person p : scenario.getPopulation().getPersons().values()){
		...
		PersonUtils.setCarAvail(p2, PersonUtils.getCarAvail(p));
	...
	new PopulationWriter(pop2).write(populationFile);
}
