 ...
 * 
 */
package taxibus.algorithm.optimizer.prebooked.clustered;
...
import taxibus.tasks.TaxibusStayTask;
...
public class JspritDispatchCreator implements RequestDispatcher {
	...
	public JspritDispatchCreator(PrebookedTaxibusOptimizerContext context) {
		...
		this.router = new DijkstraFactory().createPathCalculator(context.scenario.getNetwork(), context.travelDisutility, context.travelTime);
	}
