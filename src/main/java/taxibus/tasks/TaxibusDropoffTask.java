...
public class TaxibusDropoffTask extends StayTaskImpl implements TaxibusTaskWithRequests {
	private final Set<TaxibusRequest> requests;

	public TaxibusDropoffTask(double beginTime, double endTime, Set<TaxibusRequest> requests) {
