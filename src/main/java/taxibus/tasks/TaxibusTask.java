...
public interface TaxibusTask extends Task {
	public static enum TaxibusTaskType {
		...
		STAY, // not directly related to any customer (although may be related to serving a customer; e.g. a pickup
				// drive)
		PICKUP, DRIVE_WITH_PASSENGERS, DROPOFF;// serving n customers (TaxibusTaskWithRequests)
	}
