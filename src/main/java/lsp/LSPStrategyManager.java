 ...
 *         <li> There is a null binding of this interface in {@link LSPModule}.  If one wants to use strategies, this needs to be overwritten. </li>
 ...
 *         <li> So way to configure this "in code" is to bind {@link LSPStrategyManager} to a {@link Provider <LSPStrategyManager>} and then
