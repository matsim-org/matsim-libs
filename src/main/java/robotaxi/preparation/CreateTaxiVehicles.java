...
public class CreateTaxiVehicles {
	...
	public static void main(String[] args) {
		...
		int numberofVehicles = 50000;
		double operationStartTime = 0.; //t0
		double operationEndTime = 24*3600.;	//t1
		int seats = 4;
		String networkfile = "D:\\Axer\\MatsimDataStore\\WOB_BS_Taxi_only\\networkpt-feb.xml.gz";
		String taxisFile = "D:\\Axer\\MatsimDataStore\\WOB_BS_Taxi_only\\"+numberofVehicles+".xml";
