...
public class LineStringBasedFeatureGenerator implements FeatureGenerator{
	...
	private void initFeatureType() {
		...
		typeBuilder.add("delay_h", Double.class);
		typeBuilder.add("flow_veh", Double.class);
		typeBuilder.add("modes", Double.class);
	...
	public SimpleFeature getFeature(final Link link) {
		...
		attribs[10] = link.getAttributes().getAttribute("delay_h");
		attribs[11] = link.getAttributes().getAttribute("flow_veh");
		attribs[12] = link.getAllowedModes().toString();
