...
public class MyDrtTrajectoryAnalysisModule extends AbstractDvrpModeModule {
	...
	@Override
	public void install() {
		bindModal(MyDynModePassengerStats.class).toProvider(modalProvider(
				getter -> new MyDynModePassengerStats(getter.get(Network.class), getter.get(EventsManager.class), drtCfg,
