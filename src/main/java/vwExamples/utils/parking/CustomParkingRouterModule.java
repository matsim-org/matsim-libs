...
public class CustomParkingRouterModule extends AbstractModule {
    ...
    public void install() {
        ...
        ;
        addRoutingModuleBinding(TransportMode.car).toProvider(new CustomParkingRouterRoutingModuleProvider(TransportMode.car));
