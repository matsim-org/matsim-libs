package vwExamples.utils.createShiftingScenario.airDRT;
...
public class assignAirDRTTourCandidate implements SubTourValidator {
	Network network;
	Map<String, Geometry> cityZonesMap;
	Map<String, Geometry> serviceAreazonesMap;

	public assignAirDRTTourCandidate(Network network, Map<String, Geometry> cityZonesMap,
			Map<String, Geometry> serviceAreazonesMap) {
