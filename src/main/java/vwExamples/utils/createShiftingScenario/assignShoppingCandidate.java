...
public class assignShoppingCandidate implements SubTourValidator {
	Network network;
	Map<String, Geometry> cityZonesMap;
	Map<String, Geometry> serviceAreazonesMap;

	assignShoppingCandidate(Network network, Map<String, Geometry> cityZonesMap,
			Map<String, Geometry> serviceAreazonesMap) {
	...
	public boolean isValidSubTour(Subtour subTour) {
        ...
        return isWithinRegionShoppingTour(subTour) && (chain.equals(requiredChain));
	}
