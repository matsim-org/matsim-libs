package vwExamples.utils.createShiftingScenario.commuterDRT;
...
public class assignCommuterTourCandidate implements SubTourValidator {
	Network network;
	Map<String, Geometry> cityZonesMap;
	Map<String, Geometry> serviceAreazonesMap;

	public assignCommuterTourCandidate(Network network, Map<String, Geometry> cityZonesMap,
			Map<String, Geometry> serviceAreazonesMap) {
	...
	public boolean isValidSubTour(Subtour subTour) {
		...
		if (((isInboundCommuterTour(subTour) || isOutboundCommuterTour(subTour)) && subTourIsWithinServiceArea(subTour))) {
