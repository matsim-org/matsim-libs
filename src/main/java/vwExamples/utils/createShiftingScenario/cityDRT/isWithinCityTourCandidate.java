package vwExamples.utils.createShiftingScenario.cityDRT;
...
public class isWithinCityTourCandidate implements SubTourValidator {
	...
	public isWithinCityTourCandidate(Network network, Map<String, Geometry> cityZonesMap, Map<String, Geometry> serviceAreazonesMap) {
