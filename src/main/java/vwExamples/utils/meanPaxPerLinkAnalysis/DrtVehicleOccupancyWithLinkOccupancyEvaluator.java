 ...
 *
 */
public class DrtVehicleOccupancyWithLinkOccupancyEvaluator implements PersonEntersVehicleEventHandler, PersonLeavesVehicleEventHandler,
		ActivityEndEventHandler, ActivityStartEventHandler, LinkEnterEventHandler {
	...
	public DrtVehicleOccupancyWithLinkOccupancyEvaluator(double start, double end, int maxCapacity) {
