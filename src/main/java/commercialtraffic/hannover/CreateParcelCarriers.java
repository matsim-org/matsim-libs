...
public class CreateParcelCarriers {
    public static void main(String[] args) {
        String folder = "C:\\Users\\Joschka\\Documents\\shared-svn\\projects\\vw_rufbus\\commercialtraffic\\example\\input\\";

        Carriers carriers = new Carriers();
        Carrier carrier1 = CarrierImpl.newInstance(Id.create("smallParcel_op1", Carrier.class));
        Carrier carrier2 = CarrierImpl.newInstance(Id.create("smallParcel_op2", Carrier.class));
