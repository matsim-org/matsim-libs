...
public class ActivityChecker {
	...
	ActivityChecker(Activity activity, int[] ageInterval, Set<String> activityTypeSet, int age) {
		this.age = age;
	...
	boolean proof() {
		...
		if ((lowerAge != null) && (activityTypeSet != null) && (mode2beUsed != null)) {
			...
			return (isValidAge() && isValidActSet() && reachedActbyCar());
