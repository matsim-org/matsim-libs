 ...
 *
 */
public class ChangeAllLegModeWithPredefinedFromModesModule extends AbstractModule {
			...
			addPlanStrategyBinding(DefaultPlanStrategiesModule.DefaultStrategy.ChangeTripMode.toString())
					.toProvider(new Provider<PlanStrategy>() {
						...
						public PlanStrategy get() {
							...
							builder.addStrategyModule(new ChangeAllLegModeWithPredefinedFromModes(
