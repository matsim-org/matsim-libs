...
public class MutualControlerListener implements  FreightControlerListener, BeforeMobsimListener, AfterMobsimListener, ScoringListener,
ReplanningListener, IterationEndsListener {
	...
	@Inject
	protected MutualControlerListener(LSPsWithOffers lsps, DemandObjects demandObjects, DemandScoringModule demandScoringModule, LSPScoringModule lspScoringModule, MutualReplanningModule replanningModule) {
		this.lsps = lsps;
	...
	public void notifyScoring(ScoringEvent event) {
		...
		for(DemandObject demandObject : demandObjects.getDemandObjects().values()) {
			...
			if(score == true) {
				demandScoringModule.scoreDemandObjects();
			}		
		}
	}
