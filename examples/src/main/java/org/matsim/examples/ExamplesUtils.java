...
public class ExamplesUtils {
   ...
   * @return directory URL pointing to scenario in the "scenarios" directory in the "examples"
   *     project (where this method is located). Note that this works because it is entered as such
   *     in the pom.xml, so it is a bit of magic.
   */
