...
public class CollectionLSPScoringTest {
	...
	private TipSimulationTracker trinkgeldTracker;
	private TipInfo info;
	private TipInfoFunction function;
	private TipInfoFunctionValue value;
	...
	public void initialize() {
		...
		function = new TipInfoFunction();
		function.getValues().add(value);
		info = new TipInfo(function);
		trinkgeldTracker = new TipSimulationTracker(handler,info);
		collectionAdapter.addSimulationTracker(trinkgeldTracker);
		trinkgeldScorer = new TipScorer(collectionLSP, trinkgeldTracker);
