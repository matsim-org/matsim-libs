...
public class TableSplitterodfilecreator {
	...
	public TableSplitterodfilecreator(final String regex, final String tableFileName)
			throws IOException {
		this.regex = regex;
	...
	public static void main(final String[] args) throws IOException {
		TableSplitterodfilecreator ts = new TableSplitterodfilecreator("\t", "C:/Users/yalcin/Desktop/Zurich/Marcel_code/new/odtextnew.txt");
