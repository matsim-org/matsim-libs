...
//        private static final String NETWORK_FILE = "../../../shared-svn/studies/countries/de/berlin_scenario_2016/network_counts/network.xml.gz"; // <----------
        ...
        //    private static String EVENTS_FILE = "../../../runs-svn/berlin_scenario_2016/" + RUN_ID + "/" + RUN_ID + ".output_events.xml.gz";
        ...
        private static String fromMatsimOutputDirectory = "C:\\Users\\gthunig\\Desktop/analysis";

    //FromSrv Parameters
        private static final String SRV_BASE_DIR = "C:\\Users\\gthunig\\VSP\\shared-svn\\studies\\countries\\de\\berlin_scenario_2016\\analysis\\srv\\input/";
        ...
        private static String fromSrvOutputDirectory = "C:\\Users\\gthunig\\Desktop/analysisSrv";
    ...
    public static void main(String[] args) {
        ...
        fromMatsimTripFilter.activateModeChoice(TransportMode.pt, "slowPt");
        ...
        fromSrvTripFilter.activateModeChoice(TransportMode.pt);
        ...
        //determine output directory
        fromSrvOutputDirectory = fromSrvTripFilter.adaptOutputDirectory(fromSrvOutputDirectory);
        ...
        //Gnuplot
        String gnuplotScriptName = "plot_rel_path_run_absolutePath.gnu";
        String relativePathToGnuplotScript = "../../VSP/shared-svn/studies/countries/de/berlin_scenario_2016/analysis/gnuplot/" + gnuplotScriptName;
        File file = new File("../../../shared-svn/studies/countries/de/berlin_scenario_2016/analysis/gnuplot/");
        GnuplotUtils.runGnuplotScript(fromMatsimOutputDirectory, relativePathToGnuplotScript,fromSrvOutputDirectory);
    }
}
