...
public class Case1CreateDemand {
	...
	private void createPlans() {
		...
		try{
			...
			BufferedWriter bw=new BufferedWriter(new FileWriter("C:/Users/jeffw_000/Desktop/Dropbox/Uni/Master/Masterarbeit/MT/workspace new/ikeaStudy/output/Case1Distances.csv", true));
			BufferedWriter bw2=new BufferedWriter(new FileWriter("C:/Users/jeffw_000/Desktop/Dropbox/Uni/Master/Masterarbeit/MT/workspace new/ikeaStudy/output/Case1DistancesCars.csv", true));
...
// If agent is an IKEA visitor: set destination to IKEA-coordinates
					else if(parts[index_personId].contains("IKEA")&&parts[index_activityLocation].equals("1955")&&parts[index_activityType].equals("4")&&parts[index_mode].equals("1"))
