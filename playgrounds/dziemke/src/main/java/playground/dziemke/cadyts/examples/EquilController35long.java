...
public class EquilController35long {
	private final static Logger log = Logger.getLogger(EquilController35long.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/35_long/";
