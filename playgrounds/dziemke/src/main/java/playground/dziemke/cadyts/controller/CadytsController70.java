...
public class CadytsController70 {
	private final static Logger log = Logger.getLogger(CadytsController70.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_70";
		String outputDirectory = "D:/Workspace/container/demand/output/run_70";
