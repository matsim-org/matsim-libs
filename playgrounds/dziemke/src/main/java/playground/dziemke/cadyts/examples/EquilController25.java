...
public class EquilController25 {
	private final static Logger log = Logger.getLogger(EquilController25.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/25/";
...
//		config.strategy().addStrategySettings(strategySettings1);
		...
		StrategySettings strategySettings3 = new StrategySettings(new IdImpl(2));
