...
public class CadytsController65 {
	private final static Logger log = Logger.getLogger(CadytsController65.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_65";
		String outputDirectory = "D:/Workspace/container/demand/output/run_65";
