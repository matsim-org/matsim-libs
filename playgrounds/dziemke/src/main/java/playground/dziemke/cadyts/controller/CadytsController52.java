...
public class CadytsController52 {
	private final static Logger log = Logger.getLogger(CadytsController52.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_52";
		String outputDirectory = "D:/Workspace/container/demand/output/run_52";
