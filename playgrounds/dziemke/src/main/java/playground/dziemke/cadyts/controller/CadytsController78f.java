...
public class CadytsController78f {
	private final static Logger log = Logger.getLogger(CadytsController78f.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78f";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78f";
