...
public class EquilController02NoConfig {
	private final static Logger log = Logger.getLogger(EquilController02NoConfig.class);
	...
	public static void main(final String[] args) {
		...
		// counts
		//String countsFileName = "D:/Workspace/container/examples/equil-no-config/counts100.xml";
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/no-config/";
