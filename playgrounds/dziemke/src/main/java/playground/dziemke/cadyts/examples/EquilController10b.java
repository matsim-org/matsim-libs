...
public class EquilController10b {
	private final static Logger log = Logger.getLogger(EquilController10b.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/10b/";
