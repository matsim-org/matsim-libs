...
public class CadytsController61 {
	private final static Logger log = Logger.getLogger(CadytsController61.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_61";
		String outputDirectory = "D:/Workspace/container/demand/output/run_61";
