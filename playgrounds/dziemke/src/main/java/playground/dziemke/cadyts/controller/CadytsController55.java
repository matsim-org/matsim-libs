...
public class CadytsController55 {
	private final static Logger log = Logger.getLogger(CadytsController55.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_55";
		String outputDirectory = "D:/Workspace/container/demand/output/run_55";
...
//		config.strategy().addStrategySettings(strategySettings2);
		...
		// new 54
//		controler.getConfig().getModule("cadytsCar").addParam("startTime", "03:00:00");
//		controler.getConfig().getModule("cadytsCar").addParam("endTime", "22:00:00");
		// end new 54
