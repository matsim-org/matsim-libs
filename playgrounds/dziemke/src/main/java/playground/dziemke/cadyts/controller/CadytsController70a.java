...
public class CadytsController70a {
	private final static Logger log = Logger.getLogger(CadytsController70a.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_70a";
		String outputDirectory = "D:/Workspace/container/demand/output/run_70a";
