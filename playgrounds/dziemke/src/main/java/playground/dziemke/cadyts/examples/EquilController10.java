...
public class EquilController10 {
	private final static Logger log = Logger.getLogger(EquilController10.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/10/";
