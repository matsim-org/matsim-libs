...
public class CadytsController78g {
	private final static Logger log = Logger.getLogger(CadytsController78g.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78g";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78g";
