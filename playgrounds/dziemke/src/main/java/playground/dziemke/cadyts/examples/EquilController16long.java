...
public class EquilController16long {
	private final static Logger log = Logger.getLogger(EquilController16long.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/16_long/";
