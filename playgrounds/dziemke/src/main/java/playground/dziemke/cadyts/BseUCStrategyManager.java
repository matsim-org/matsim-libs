...
public class BseUCStrategyManager extends StrategyManager implements
	...
	protected void beforePopulationRunHook(Population population, ReplanningContext replanningContext) {
		...
		// 2013-04-17 try to switch off writing
		// writer = new SimpleWriter(
				
				// "../integration-parameterCalibration/test/cali3/C3Step0TestLocal_DC2/corrections.it"
				// changed to my file structure, dz
				
		// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
				
		//		"D:/Workspace/container/demand/output/run_20_cadyts/corrections.it"
		//				+ iter + ".log");
		// ---
		
		// 2013-04-16 try to switch off writing
