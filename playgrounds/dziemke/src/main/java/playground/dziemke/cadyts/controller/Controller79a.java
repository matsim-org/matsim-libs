...
public class Controller79a {
	private final static Logger log = Logger.getLogger(Controller79a.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_79a";
		String outputDirectory = "D:/Workspace/container/demand/output/run_79a";
