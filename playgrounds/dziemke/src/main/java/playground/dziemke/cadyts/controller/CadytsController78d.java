...
public class CadytsController78d {
	private final static Logger log = Logger.getLogger(CadytsController78d.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78d";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78d";
