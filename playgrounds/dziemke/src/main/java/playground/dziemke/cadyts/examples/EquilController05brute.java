...
public class EquilController05brute {
	private final static Logger log = Logger.getLogger(EquilController05brute.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/05_brute/";
