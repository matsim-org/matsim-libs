...
public class CadytsController73 {
	private final static Logger log = Logger.getLogger(CadytsController73.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_73";
		String outputDirectory = "D:/Workspace/container/demand/output/run_73";
