...
public class EquilController28 {
	private final static Logger log = Logger.getLogger(EquilController28.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/28/";
