...
public class EquilController04abrute {
	private final static Logger log = Logger.getLogger(EquilController04abrute.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/04a_brute/";
