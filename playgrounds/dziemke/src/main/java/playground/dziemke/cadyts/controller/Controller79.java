...
public class Controller79 {
	private final static Logger log = Logger.getLogger(Controller79.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		String outputDirectory = "D:/Workspace/container/demand/output/run_79";
