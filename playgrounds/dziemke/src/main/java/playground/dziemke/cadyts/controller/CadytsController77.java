...
public class CadytsController77 {
	private final static Logger log = Logger.getLogger(CadytsController77.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_77";
		String outputDirectory = "D:/Workspace/container/demand/output/run_77";
