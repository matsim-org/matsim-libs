...
public class EquilController35dlonga {
	private final static Logger log = Logger.getLogger(EquilController35dlonga.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/35d_longa/";
