...
public class CadytsController78h {
	private final static Logger log = Logger.getLogger(CadytsController78h.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		String outputDirectory = "D:/Workspace/container/demand/output/run_78h";
