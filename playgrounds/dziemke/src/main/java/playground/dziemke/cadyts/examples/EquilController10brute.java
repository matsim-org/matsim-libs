...
public class EquilController10brute {
	private final static Logger log = Logger.getLogger(EquilController10brute.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/10_brute/";
