...
public class EquilController35blong {
	private final static Logger log = Logger.getLogger(EquilController35blong.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/35b_long/";
