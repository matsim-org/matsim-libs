...
public class EquilController17 {
	private final static Logger log = Logger.getLogger(EquilController17.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/17/";
