...
public class CadytsController78b {
	private final static Logger log = Logger.getLogger(CadytsController78b.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78b";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78b";
