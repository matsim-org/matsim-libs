...
public class EquilController21b {
	private final static Logger log = Logger.getLogger(EquilController21b.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/21b/";
