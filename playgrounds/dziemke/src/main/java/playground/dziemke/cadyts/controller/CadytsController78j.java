...
public class CadytsController78j {
	private final static Logger log = Logger.getLogger(CadytsController78j.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78j";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78j";
		...
		strategySettings2.setDisableAfter(100);
