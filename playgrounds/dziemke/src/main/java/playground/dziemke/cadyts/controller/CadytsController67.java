...
public class CadytsController67 {
	private final static Logger log = Logger.getLogger(CadytsController67.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_67";
		String outputDirectory = "D:/Workspace/container/demand/output/run_67";
