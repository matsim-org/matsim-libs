...
public class EquilController35clonga {
	private final static Logger log = Logger.getLogger(EquilController35clonga.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/35c_longa/";
