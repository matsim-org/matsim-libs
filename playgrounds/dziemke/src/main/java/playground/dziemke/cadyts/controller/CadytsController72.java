...
public class CadytsController72 {
	private final static Logger log = Logger.getLogger(CadytsController72.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_72";
		String outputDirectory = "D:/Workspace/container/demand/output/run_72";
