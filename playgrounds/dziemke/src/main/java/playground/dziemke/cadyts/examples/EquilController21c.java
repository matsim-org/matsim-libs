...
public class EquilController21c {
	private final static Logger log = Logger.getLogger(EquilController21c.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/21c/";
		...
		strategySettings1.setProbability(0.4);
		...
		strategySettings2.setModuleName("cadytsCar");
		...
		strategySettings3.setModuleName("ReRoute");
		strategySettings3.setProbability(0.4);
		//strategySettings3.setDisableAfter(60);
		...
		controler.addPlanStrategyFactory("cadytsCar", new PlanStrategyFactory() {
			...
			public PlanStrategy createPlanStrategy(Scenario scenario2, EventsManager events2) {
				...
				planSelector.setCadytsWeight(1.*scenario2.getConfig().planCalcScore().getBrainExpBeta());
