...
public class CadytsController66 {
	private final static Logger log = Logger.getLogger(CadytsController66.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_66";
		String outputDirectory = "D:/Workspace/container/demand/output/run_66";
