...
public class CadytsController78i {
	private final static Logger log = Logger.getLogger(CadytsController78i.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78h";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78i";
