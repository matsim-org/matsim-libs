...
public class CadytsController78 {
	private final static Logger log = Logger.getLogger(CadytsController78.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78";
