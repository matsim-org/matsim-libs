...
public class CadytsController41 {
	private final static Logger log = Logger.getLogger(CadytsController41.class);
	...
	public static void main(String[] args) {
		...
		// controller
		String runId = "run_41";
		String outputDirectory = "D:/Workspace/container/demand/output/run_41";
