...
public class CadytsController68 {
	private final static Logger log = Logger.getLogger(CadytsController68.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_68";
		String outputDirectory = "D:/Workspace/container/demand/output/run_68";
