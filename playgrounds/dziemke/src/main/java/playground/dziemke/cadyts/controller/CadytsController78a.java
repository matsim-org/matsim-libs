...
public class CadytsController78a {
	private final static Logger log = Logger.getLogger(CadytsController78a.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78a";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78a";
