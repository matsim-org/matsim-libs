...
public class EquilController21a {
	private final static Logger log = Logger.getLogger(EquilController21a.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/21a/";
