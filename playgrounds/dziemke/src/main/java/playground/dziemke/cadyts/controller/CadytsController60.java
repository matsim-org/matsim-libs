...
public class CadytsController60 {
	private final static Logger log = Logger.getLogger(CadytsController60.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_60";
		String outputDirectory = "D:/Workspace/container/demand/output/run_60";
