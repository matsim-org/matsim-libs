...
public class CadytsController78c {
	private final static Logger log = Logger.getLogger(CadytsController78c.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78c";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78c";
