...
public class CadytsController78test {
	private final static Logger log = Logger.getLogger(CadytsController78test.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_78test";
		String outputDirectory = "D:/Workspace/container/demand/output/run_78test";
