...
public class CadytsController71 {
	private final static Logger log = Logger.getLogger(CadytsController71.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_71";
		String outputDirectory = "D:/Workspace/container/demand/output/run_71";
