...
public class CadytsController69 {
	private final static Logger log = Logger.getLogger(CadytsController69.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_69";
		String outputDirectory = "D:/Workspace/container/demand/output/run_69";
