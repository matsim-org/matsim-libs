...
public class EquilController35along {
	private final static Logger log = Logger.getLogger(EquilController35along.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/35a_long/";
