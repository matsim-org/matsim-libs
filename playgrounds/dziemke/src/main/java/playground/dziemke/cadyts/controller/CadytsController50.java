...
public class CadytsController50 {
	private final static Logger log = Logger.getLogger(CadytsController50.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_50";
		String outputDirectory = "D:/Workspace/container/demand/output/run_50";
