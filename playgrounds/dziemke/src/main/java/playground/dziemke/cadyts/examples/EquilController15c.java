...
public class EquilController15c {
	private final static Logger log = Logger.getLogger(EquilController15c.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/15c/";
...
//		config.strategy().addStrategySettings(strategySettings1);
		...
		strategySettings2.setProbability(0.4);
		...
		controler.addPlanStrategyFactory("cadytsCar", new PlanStrategyFactory() {
			...
			public PlanStrategy createPlanStrategy(Scenario scenario2, EventsManager events2) {
				...
				planSelector.setCadytsWeight(60.*scenario2.getConfig().planCalcScore().getBrainExpBeta());
