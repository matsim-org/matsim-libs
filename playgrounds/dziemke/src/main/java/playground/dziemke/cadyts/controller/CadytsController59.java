...
public class CadytsController59 {
	private final static Logger log = Logger.getLogger(CadytsController59.class);
...
//		config.addModule("ccc", cadytsCarConfigGroup);
		...
		// controller
		String runId = "run_59";
		String outputDirectory = "D:/Workspace/container/demand/output/run_59";
