...
public class EquilController35short {
	private final static Logger log = Logger.getLogger(EquilController35short.class);
	...
	public static void main(final String[] args) {
		...
		// controller
		//String runId = "run_xy";
		String outputDirectory = "D:/Workspace/container/examples/equil/output/35_short/";
...
//		config.strategy().addStrategySettings(strategySettings1);
		...
		strategySettings2.setProbability(0.2);
