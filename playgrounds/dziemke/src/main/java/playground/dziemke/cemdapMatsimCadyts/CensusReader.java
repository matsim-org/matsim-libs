...
//	            	}
//        			
//	                Integereger origin = null ;
//	                Integereger destination = 0;
//	                
//	                
//	                // new
//	                
...
//	                    try {
//	                        origin = Integereger.parseInteger(row[2]);
//	                        destination = planningAreaId;
//	                        Integer trips = Integereger.parseInteger(row[4]);
//	                        // It is important that Integererior traffic is left out in this case (commuterFileIn), since the car share for
//	                        // exterior is used here and this car share relates to people LIVING exterior of planning area.
//	                        Integer scaledTrips = scale(trips, carShareExterior);
//	                        String label = row[3];
...
//	                        } else {
//	                        	// IMPORTANT!!!
//	                        	LOG.info("Ignoring this entry since Integererior traffic will otherweise be counted twice.");
//	                        }
//	                    } catch (Exception e) {
...
//	                        destination = Integereger.parseInteger(row[2]);
//	                        Integer trips = Integereger.parseInteger(row[4]);
//	                        Integer scaledTrips = scale(trips, carShareIntegererior);
//	                        String label = row[3] ;
...
//	private void process(Integer origin, Integer destination, Integer trips) {
...
//	private Integer scale(Integer trips, double carShare) {
//		double factor = this.factor;
//		double value = trips * factor * carShare;
//		Integer scaledTrips = (Integer) value;
//		if (scaledTrips == 0) {
////			Random r = new Random();
////			double randomNumber = r.nextDouble();
//			
//			// With a probability of 50% raise number of scaled trips by one. This is because the cast to Integer
