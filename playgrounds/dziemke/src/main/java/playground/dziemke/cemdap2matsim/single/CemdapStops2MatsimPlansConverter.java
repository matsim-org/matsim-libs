...
public class CemdapStops2MatsimPlansConverter {
	...
	public static void main(String[] args) throws IOException {
		String cemdapStopsFile = "D:/Workspace/CEMDAP_Test_Version/Output/24_beeline/stops.out1";
//		String cemdapStopsFile2 = "D:/Workspace/container/demand/input/cemdap2matsim/06/stops.out1";
		...
		String outputBase = "D:/Workspace/container/demand/input/cemdap2matsim/09";
...
//		log.info("cemdapStopsFile2: "+cemdapStopsFile2);
		...
		// new CemdapStopsParser().parse(cemdapStopsFile, planNumber, scenario, cemdapTazFeatures, popFraction);
		
//		log.info("parsing "+cemdapStopsFile2+" file...");
//		// call the parser 
//		planNumber = 1;
//		// new CemdapStopsParser().parse(cemdapStopsFile2, planNumber, scenario, personObjectAttributes, popFraction);
//		log.info("done. (parsing)");

				
		log.info("assigning coordinates to activities...");
		new Feature2Coord().assignCoords(scenario, personObjectAttributes, cemdapTazFeatures);
