					...
					public void install() {
						addControlerListenerBinding().toProvider(new Provider<ControlerListener>() {
							...
							public ControlerListener get() {
								...
								GridBasedAccessibilityShutdownListenerV3 listener = new GridBasedAccessibilityShutdownListenerV3(accessibilityCalculator, (ActivityFacilities) activityFacilites, null, scenario, bb.getXMin(), bb.getYMin(), bb.getXMax(),bb.getYMax(), cellSize);
