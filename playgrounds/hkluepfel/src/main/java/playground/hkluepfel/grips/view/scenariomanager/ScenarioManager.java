...
import org.matsim.contrib.grips.scenariogenerator.Scenario2Matsim;
import org.matsim.contrib.grips.scenariogenerator.RunMatsim;
...
//		panels.add(tabSelectPanel);
		...
		for (AbstractModule module : controller.getModules())
		{
			...
			ModuleButtonListener moduleButtonListener = new ModuleButtonListener(this, module.getModuleType());
			button.addActionListener(moduleButtonListener);
			button.addMouseMotionListener(moduleButtonListener);
			button.addMouseListener(moduleButtonListener);
