...
public class OTFVisVisulalization {
	...
	public static void main(String [] args) {
		if (args.length == 2) {
			...
			new org.matsim.contrib.grips.visualization.OTFVisVisualization(config,it,wms,layer).run();
		}else {	
			printUsage();
			System.exit(-1);
		}
	...
	protected static void printUsage() {
		...
		System.out.println("Takes the given iteration of GRIPS evacuation scenario is input, removes evacuation links and nodes, an runs OTFVis in live mode with the modified scenario.\n" +
