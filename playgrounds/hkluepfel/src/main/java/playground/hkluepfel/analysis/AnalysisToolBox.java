...
public class AnalysisToolBox extends AbstractToolBox {
	...
	private JComboBox<String> iterationsList;
	private JSlider gridSizeSlider;
	private JComboBox<Mode> modeList;
	...
	public AnalysisToolBox(Analysis evacuationAnalysis, Controller controller) {
		...
		iterationSelectionPanel.setBorder(BorderFactory.createEmptyBorder(2, 2,
				2, 2));
		this.iterationsList = new JComboBox<String>();
		...
		gridSizeSelectionPanel.setBorder(BorderFactory.createEmptyBorder(2, 2,
				2, 2));
		this.gridSizeSlider = new JSlider(SwingConstants.HORIZONTAL, 100, 600,
				(int) this.cellSize);
		...
		this.gridSizeSlider.addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent arg0) {
				if (!useCalculateButton) {
					...
					updateCellSize(value);
					//
					AnalysisToolBox.this.module.runCalculation();
				}
			}
		...
		this.modeList = new JComboBox<Mode>();
		...
		transparencySlider.addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent arg0) {
				// if (!useCalculateButton)
				// {
				AnalysisToolBox.this.module.setCellTransparency((((JSlider) arg0
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Save") {
			if (this.module.getEventHandler() != null) {
				...
				int returnVal = fc.showSaveDialog(this.controller
						.getParentComponent());
		 ...
		 */
			...
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				...
				this.ctInverse = new GeotoolsTransformation(this.getScenario()
						.getConfig().global().getCoordinateSystem(),
						"EPSG:4326");
