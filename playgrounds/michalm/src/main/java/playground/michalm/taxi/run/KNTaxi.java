...
class KNTaxi
{
     ...
     */
    public static void run(String configFile, boolean removeNonPassengers,
            boolean endActivitiesAtTimeZero, boolean otfvis)
    {
        ...
        if (removeNonPassengers) {
            PopulationUtils.removePersonsNotUsingMode(TaxiModule.TAXI_MODE,
