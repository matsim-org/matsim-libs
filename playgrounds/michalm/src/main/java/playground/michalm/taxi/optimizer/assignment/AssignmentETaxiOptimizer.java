 ...
 * <ul>
 * <li>charging scheduling can override planned request-related assignments and planned charging
 * assignments
 ...
 * <li>since the destination remains unknown till the end of pickup, all schedules end with STAY or
 * PICKUP tasks
 * </ul>
 */
public class AssignmentETaxiOptimizer
    extends AssignmentTaxiOptimizer
{
    ...
    public AssignmentETaxiOptimizer(ETaxiOptimizerContext optimContext,
    ...
    protected void scheduleCharging()
    {
        ...
        List<Dispatch<ChargerPlug>> assignments = eAssignmentProblem.findAssignments(vData, pData,
                cost);
