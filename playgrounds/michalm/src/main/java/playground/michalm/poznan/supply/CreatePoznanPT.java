...
public class CreatePoznanPT {
	public static void go(String visumFile, String transitScheduleWithNetworkFile, String transitNetworkFile,
		...
		Visum2TransitSchedule converter = new Visum2TransitSchedule(vNetwork, scenario.getTransitSchedule(),
		...
		new TransitScheduleWriterV1(scenario.getTransitSchedule()).write(transitScheduleWithNetworkFile);
