...
public class BarcelonaServedRequestsReader
{
    ...
    public void readFile(String file)
    {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            //id,FROM-y,FROM-x,TO-y,TO-x,DATE_start,HOUR_start,MINUTE_start,DATE_end,HOUR_end,MINUTE_end,travel time,distance
            ...
            while ((line = br.readLine()) != null) {
                ...
                Id<ServedRequest> id = Id.create(scanner.next(), ServedRequest.class);
                    ...
                    requests.add(new BarcelonaServedRequest(id, from, to, start, end, travelTime,
                            distance));
            }
        }
        catch (IOException e) {
