...
public class MZ1989ToXmlFiles {

	private final static Logger log = Logger.getLogger(MZ1989ToXmlFiles.class);
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("MATSim-DB: creates population, vehicles and households and xml files from MicroCensus 1989 database \n");
		
		
		// from local directory
		//String inputBase = "P:/Daten/Mikrozensen Verkehr Schweiz/2010/3_DB_SPSS/dat files/";
		String inputBase = "P:/Daten/Mikrozensen Verkehr Schweiz/Mz'89/spss/dat_files/";
				args = new String[] {
				...
				"C:/local/marmolea/output/MicroCensus1989/"
...
//////////////////////////////////////////////////////////////////////	
		...
		new MZ1989HouseholdParser(households,householdAttributes).parse(haushalteFile);
...
//////////////////////////////////////////////////////////////////////	
		...
		new MZ1989ZielPersonParser(population,populationAttributes,households,householdAttributes).parse(zielpersonenFile);
...
//		new MZ1994HouseholdPersonParser(households,population, populationAttributes).parse(haushaltspersonenFile);
...
////////////////////////////////////////////////////////////////////
		...
		ArrayList<Set<Id>> pids = new MZ1989WegeParser(population, wegeAttributes).parse(wegeFile);
		...
		MZPopulationUtils.eliminateToursWithUndefinedWegeTimesMZ1989(population);	
