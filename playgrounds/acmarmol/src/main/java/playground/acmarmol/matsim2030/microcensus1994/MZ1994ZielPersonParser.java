...
//		populationAttributes.putAttribute(intnr, MZConstants.TOTAL_TRIPS_DISTANCE, wege_dist);
		...
		else if(car_av.equals("9") | car_av.equals(" ")){car_av = MZConstants.NO_ANSWER;}
		...
		else if(mcycle_av.equals("9") | mcycle_av.equals(" ")){mcycle_av = MZConstants.NO_ANSWER;}
...
//		
		...
		else if(mofa_av.equals("9") | mofa_av.equals(" ")){mofa_av = MZConstants.NO_ANSWER;}
		...
		else if(bike_av.equals("9") | bike_av.equals(" ")){bike_av = MZConstants.NO_ANSWER;}
