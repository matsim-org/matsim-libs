...
public class MZ2005EtappenParser {
	...
	//////////////////////////////////////////////////////////////////////
		...
		public MZ2005EtappenParser(TreeMap<String, ArrayList<Etappe>> etappes) {
			super();
		...
		public void parse(String etappenFile) throws Exception{
			...
			while ((curr_line = br.readLine()) != null) {
				...
				//total people in car
				String total_people = entries[52].trim();
				
				//purpose
				String purpose ="";
				String wzweck1 = entries[49].trim();
