...
/**
* 
* MATSim-DB: creates population, vehicles and households and xml files from MicroCensus 2005 database
* 
*
* @author acmarmol
* 
...
public class MZ2005ToXmlFiles {

	private final static Logger log = Logger.getLogger(MZ2005ToXmlFiles.class);
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("MATSim-DB: creates population, vehicles and households and xml files from MicroCensus 2005 database \n");
		...
		String inputBase = "P:/Daten/Mikrozensen Verkehr Schweiz/MZ 2005/MZ05_Datenbank_CH/2_DB_SPSS/dat files/";
		args = new String[] {
				inputBase+"haushalte.dat",
				inputBase+"haushaltspersonen.dat",
				inputBase+"fahrzeuge.dat",
				...
				"C:/local/marmolea/output/MicroCensus2005/"
...
//////////////////////////////////////////////////////////////////////	
		...
		new MZ2005HouseholdParser(households,householdAttributes).parse(haushalteFile);
...
//////////////////////////////////////////////////////////////////////	
		...
		new MZ2005ZielPersonParser(population,populationAttributes,households,householdAttributes).parse(zielpersonenFile);
...
//////////////////////////////////////////////////////////////////////
		...
		new MZ2005EtappenParser(wegeAttributes).parse(etappenFile);
