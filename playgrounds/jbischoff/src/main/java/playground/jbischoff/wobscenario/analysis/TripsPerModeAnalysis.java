...
public static void main(String[] args) {
	...
	String plansF = "D:/runs-svn/vw_rufbus/run120.10/run120.10.output_plans.xml.gz";
	String eventsF = "D:/runs-svn/vw_rufbus/run120.10/run120.10.output_events.xml.gz";
