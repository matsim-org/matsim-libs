...
//        	System.err.println("T: " +time+ "V: "+schedule.getVehicle().getName()+" D: "+delay);
//            System.err.println("TaxiUtils.isCurrentTaskDelayed(Schedule schedule, int time): "
//                    + "This is very unlikely! I am just curious if this ever happens. Vehicle: "+schedule.getVehicle().getName()+" Delay: "+delay);
//                  printScheduledRequests(schedule.getVehicle());
        }
