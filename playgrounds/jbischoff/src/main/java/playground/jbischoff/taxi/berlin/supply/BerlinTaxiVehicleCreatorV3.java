...
public class BerlinTaxiVehicleCreatorV3
{
    ...
    private static final String TAXISOVERTIME = DATADIR + "OD/2013/vehicles/taxisweekly.csv";
    private static final String STATUSMATRIX = DATADIR + "OD/2014/status/statusMatrixAv.xml";
    ...
    private static final String ZONESSHP = DATADIR + "OD/shp_merged/zones.shp";
    private static final String ZONESXML = DATADIR + "OD/shp_merged/zones.xml";
    ...
    private void prepareMatrices()
    {
        ...
        Matrix avestatus = statusMatrix.getMatrix("ave");
