...
public class CreateTaxibusSubpopulation {
	...
	private void run(){
		...
		new MatsimPopulationReader(scenario).readFile("C:/Users/Joschka/Documents/shared-svn/projects/vw_rufbus/scenario/input/vw054.120.plans.xml.gz");
		...
		new ObjectAttributesXmlWriter(scenario.getPopulation().getPersonAttributes()).writeFile("C:/Users/Joschka/Documents/shared-svn/projects/vw_rufbus/scenario/input/vw054.120.personAttributes.xml.gz");
	}
