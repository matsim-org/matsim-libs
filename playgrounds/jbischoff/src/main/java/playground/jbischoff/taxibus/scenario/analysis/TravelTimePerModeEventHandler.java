...
public class TravelTimePerModeEventHandler implements PersonArrivalEventHandler, PersonDepartureEventHandler{
	...
	Map<String, Map<Id<Person>, Double>> mode2personId2DepartureTime;
	Map<String, Map<Id<Person>, Double>> mode2personId2TravelTime;
	...
	public TravelTimePerModeEventHandler(PtDriverIdAnalyzer ptDriverIdAna) {
		...
		this.mode2personId2DepartureTime = new HashMap<>();
		this.mode2personId2TravelTime = new HashMap<>();
...
//		}
	...
	public Map<String, Double> getUserGroup2mode2noOfTrips() {
