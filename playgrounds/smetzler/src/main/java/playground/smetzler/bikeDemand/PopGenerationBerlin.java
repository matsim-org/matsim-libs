...
public class PopGenerationBerlin implements Runnable {
	...
	String outputPop = "../../../shared-svn/studies/countries/de/berlin-bike/input/demand/Berlin_bike.xml";
...
//			y = minY + rnd.nextDouble() * (maxY - minY);
	...
	private void generatePopulation() {
		generateHomeWorkHomeTrips("home1", "work1", 200000); // create 1000 trips from zone 'home1' to 'work1'
