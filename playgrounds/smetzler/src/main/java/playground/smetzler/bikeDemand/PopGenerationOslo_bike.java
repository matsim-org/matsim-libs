...
public class PopGenerationOslo_bike implements Runnable {
	

	String outputPop = "../../../../desktop/Oslo/demand/Oslo2000greatArea_b&C.xml";
	...
	public static void main(String[] args) {
		PopGenerationOslo_bike Pop = new PopGenerationOslo_bike();
		Pop.run();
	}
