...
public class MultipleEnsemblesBoxPlot {
	...
	public void addSeriesPerEnsembleSize(ArrayList<Double> averageExpenditures, int size) {
		dataset.add(averageExpenditures, "Ensemble Expenditure Averages", Integer.toString(size));
	}
	...
	public JFreeChart createChart() {	
		...
		final NumberAxis yAxis = new NumberAxis("Ensemble Expenditure Averages[days][runs]");
