...
public class EmissionTravelDisutilityCalculator implements TravelDisutility {
	...
	public EmissionTravelDisutilityCalculator(PersonalizableTravelTime timeCalculator, PlanCalcScoreConfigGroup cnScoringGroup, EmissionModule emissionModule, EmissionCostModule emissionCostModule, Set<Id> hotspotLinks) {
