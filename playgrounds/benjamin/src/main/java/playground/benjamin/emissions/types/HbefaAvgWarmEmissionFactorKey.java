 ...
 *
 */
public class HbefaAvgWarmEmissionFactorKey{
	...
	public HbefaAvgWarmEmissionFactorKey(){
	}
	...
	public boolean equals(Object obj) {
	        if(this == obj) {
	         ...
	         if (!(obj instanceof HbefaAvgWarmEmissionFactorKey)) {
	                return false; 
	         }
	         HbefaAvgWarmEmissionFactorKey key = (HbefaAvgWarmEmissionFactorKey) obj;
