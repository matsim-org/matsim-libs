 ...
 *
 */
public class SpatialAveragingDemandEmissionsKrasnojarsk {
	private static final Logger logger = Logger.getLogger(SpatialAveragingDemandEmissionsKrasnojarsk.class);

	private String baseCase = "bau"; // exposureInternalization, latsis, 981
	/*
	 * When 'base' is used no comparison to a policy case is calculated.
	 */
	private String compareCase = "base"; // base, zone30, pricing, exposurePricing, 983
...
//	final String pollutant2analyze = WarmPollutant.NOX.toString();
	...
	public static void main(String[] args) throws IOException{
		new SpatialAveragingDemandEmissionsKrasnojarsk().run();
	}
}