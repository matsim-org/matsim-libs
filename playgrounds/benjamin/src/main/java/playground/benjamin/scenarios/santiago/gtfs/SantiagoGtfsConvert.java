...
//		CoordinateTransformation transform0  = new WGS84toCH1903LV03() ;
		...
		converter.convert() ;
		// ---
		new NetworkWriter(scenario0.getNetwork()).write( filepath0 + "/transitnetwork.xml.gz");
		new TransitScheduleWriter( scenario0.getTransitSchedule() ).writeFile( filepath0 + "/transitschedule.xml.gz");
		new VehicleWriterV1( scenario0.getTransitVehicles() ).writeFile( filepath0 + "/transitvehicles.xml.gz");
	}
