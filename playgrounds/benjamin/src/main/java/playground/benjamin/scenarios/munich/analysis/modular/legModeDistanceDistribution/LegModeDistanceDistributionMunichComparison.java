 ...
 *
 */
public class LegModeDistanceDistributionMunichComparison {
	private final static Logger logger = Logger.getLogger(LegModeDistanceDistributionMunichComparison.class);
