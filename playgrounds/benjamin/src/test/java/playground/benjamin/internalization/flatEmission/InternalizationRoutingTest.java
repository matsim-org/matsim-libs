...
//
	...
	private void createNetwork() {
		...
		double x7 = -17500.0;
		Node node2 = NetworkUtils.createAndAddNode2(network, Id.create("2", Node.class), new Coord(x7, 0.0));
		double x6 = -15500.0;
		Node node3 = NetworkUtils.createAndAddNode2(network, Id.create("3", Node.class), new Coord(x6, 0.0));
		double x5 = -2500.0;
		Node node4 = NetworkUtils.createAndAddNode2(network, Id.create("4", Node.class), new Coord(x5, 0.0));
		Node node5 = NetworkUtils.createAndAddNode2(network, Id.create("5", Node.class), new Coord(0.0, 0.0));
		double x4 = -5000.0;
		double y3 = -8660.0;
		Node node6 = NetworkUtils.createAndAddNode2(network, Id.create("6", Node.class), new Coord(x4, y3));
		double x3 = -15000.0;
		double y2 = -8660.0;
		Node node7 = NetworkUtils.createAndAddNode2(network, Id.create("7", Node.class), new Coord(x3, y2));
		double x2 = -7500.0;
		Node node8 = NetworkUtils.createAndAddNode2(network, Id.create("8", Node.class), new Coord(x2, 2500.0));
		double x1 = -7500.0;
		double y1 = -2500.0;
		Node node9 = NetworkUtils.createAndAddNode2(network, Id.create("9", Node.class), new Coord(x1, y1));
		double x = -7500.0;
		double y = -5000.0;
		Node node10 = NetworkUtils.createAndAddNode2(network, Id.create("10", Node.class), new Coord(x, y));
