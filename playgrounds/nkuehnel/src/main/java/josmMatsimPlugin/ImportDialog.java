...
public class ImportDialog extends JPanel {
	...
	protected final static JComboBox importSystem = new JComboBox(Preferences.coordSystems);

	public ImportDialog() {
		GridBagConstraints c = new GridBagConstraints();
		setLayout(new GridBagLayout());
		
		importSystem.setSelectedItem(Main.pref.get("matsim_importSystem", "WGS84"));
