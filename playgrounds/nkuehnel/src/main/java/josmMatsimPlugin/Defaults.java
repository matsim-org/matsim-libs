...
public class Defaults
{
	...
	protected static String exportPath=System.getProperty("user.home")+ "\\josm_matsim_export";
	...
	protected static String[] coordSystems =
	...
	protected static void handleInput(Map<String, JComponent> input)
	{
		for (int i =0; i<12; i++)
		{
			...
			defaults.put(OsmExportDefaultsDialog.types[i], new OsmHighwayDefaults(hierarchy, lanes, freespeed, freespeedFactor, laneCapacity, ((JCheckBox)input.get(i+"_5")).isSelected()));
		}
	}
}
