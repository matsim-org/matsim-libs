...
public class GreedyUmlaufBuilderTest {
	...
	private void createNetwork() {
		...
		double x2 = -2000;
		Node node2 = NetworkUtils.createAndAddNode2(network, Id.create(2, Node.class), new Coord(x2, (double) 1000));
		double x1 = -1000;
		Node node3 = NetworkUtils.createAndAddNode2(network, Id.create(3, Node.class), new Coord(x1, (double) 0));
		double x = -1000;
		Node node4 = NetworkUtils.createAndAddNode2(network, Id.create(4, Node.class), new Coord(x, (double) 1000));
		Node node5 = NetworkUtils.createAndAddNode2(network, Id.create(5, Node.class), new Coord((double) 0, (double) 0));
		Node node6 = NetworkUtils.createAndAddNode2(network, Id.create(6, Node.class), new Coord((double) 0, (double) 1000));
		Node node7 = NetworkUtils.createAndAddNode2(network, Id.create(7, Node.class), new Coord((double) 500, (double) 500));
		Node node8 = NetworkUtils.createAndAddNode2(network, Id.create(8, Node.class), new Coord((double) 1500, (double) 500));
		Node node9 = NetworkUtils.createAndAddNode2(network, Id.create(9, Node.class), new Coord((double) 2500, (double) 500));
		Node node10 = NetworkUtils.createAndAddNode2(network, Id.create(10, Node.class), new Coord((double) 3500, (double) 500));
		Node node11 = NetworkUtils.createAndAddNode2(network, Id.create(11, Node.class), new Coord((double) 4000, (double) 0));
		Node node12 = NetworkUtils.createAndAddNode2(network, Id.create(12, Node.class), new Coord((double) 4000, (double) 1000));
		Node node13 = NetworkUtils.createAndAddNode2(network, Id.create(13, Node.class), new Coord((double) 5000, (double) 0));
		Node node14 = NetworkUtils.createAndAddNode2(network, Id.create(14, Node.class), new Coord((double) 5000, (double) 1000));
