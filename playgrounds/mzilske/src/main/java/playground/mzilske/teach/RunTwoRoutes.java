...
//            stratSets.setStrategyName("SelectExpBeta");
        ...
        controler.setScoringFunctionFactory(new ScoringFunctionFactory() {
            ...
            public ScoringFunction createNewScoringFunction(Person person) {
                ...
                sumScoringFunction.addScoringFunction(new CharyparNagelLegScoring(CharyparNagelScoringParameters.getBuilder(scenario.getConfig().planCalcScore(), scenario.getConfig().scenario()).create(), scenario.getNetwork()));
