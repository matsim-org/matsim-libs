...
public class BerlinActivityDurationsCongested {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		new MatsimPopulationReader(baseScenario).readFile("car-congested/output-berlin/ITERS/it.200/2kW.15.200.experienced_plans.xml.gz");
		new MatsimNetworkReader(baseScenario).readFile(BerlinRun.BERLIN_PATH + "network/bb_4.xml.gz");
		{
			File file = new File("car-congested/durations-simulated.txt");
		...
		{
			File file = new File("car-congested/distances.txt");
	...
	private static void distances(PrintWriter pw, int callrate, VolumesAnalyzer baseVolumes, Scenario baseScenario) {
		...
		new MatsimPopulationReader(scenario).readFile("car-congested/output-"+callrate+"/ITERS/it.20/20.experienced_plans.xml.gz");
		...
		new MatsimEventsReader(events).readFile("car-congested/output-"+callrate+"/ITERS/it.20/20.events.xml.gz");
