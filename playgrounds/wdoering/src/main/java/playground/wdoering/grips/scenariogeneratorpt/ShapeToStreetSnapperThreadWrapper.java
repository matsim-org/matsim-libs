...
public class ShapeToStreetSnapperThreadWrapper implements Runnable {
	...
	private BusStopMapViewer mapViewer;
	private final String net;
	private final BusStopSelector evacuationAreaSelector;
	...
	public ShapeToStreetSnapperThreadWrapper(String osm, BusStopSelector evacuationAreaSelector) {
		this.net = osm;
...
//		CoordinateReferenceSystem targetCRS = MGC.getCRS("EPSG:3395");
	...
	public void setView(BusStopMapViewer myMapViewer) {
