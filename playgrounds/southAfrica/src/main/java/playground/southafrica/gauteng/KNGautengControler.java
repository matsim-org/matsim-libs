...
class KNGautengControler {
	...
	public static void main ( String[] args ) {
		...
		Double valueOfTimeMultiplier = 4. ; // see above 
		...
		if ( args!=null && args.length>0 && args[0] != null ) {
			...
			configFileName = "/Users/nagel/ie-calvin/MATSim-SA/trunk/data/sanral2010/config/kaiconfig.xml" ;
		}
