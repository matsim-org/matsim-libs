...
public class ChainSimilarityAnalyser {
	final private static Logger LOG = Logger.getLogger(ChainSimilarityAnalyser.class);
	...
	private static void execute(String xmlFolder, String outputfolder,
		...
		for(File vehicleFile : vehicleFiles){
			ChainSimilarityAnalysisRunnable job = new ChainSimilarityAnalysisRunnable(vehicleFile, output, counter);
