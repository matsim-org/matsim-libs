...
package playground.southafrica.projects.maxess;
...
public class RunAmenityReaderForNmbm {
	final private static Logger LOG = Logger.getLogger(RunAmenityReaderForNmbm.class);
