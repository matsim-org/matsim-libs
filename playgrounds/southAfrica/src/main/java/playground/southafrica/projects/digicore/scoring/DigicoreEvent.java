...
public enum DigicoreEvent {
	...
	DigicoreEvent(int eventId) {
		this.eventId = eventId;
	}
	
	private static Logger log = Logger.getLogger(DigicoreEvent.class);
	private int eventId;
	
	public static DigicoreEvent getEvent(int eventId){
		switch (eventId) {
		case 7:
