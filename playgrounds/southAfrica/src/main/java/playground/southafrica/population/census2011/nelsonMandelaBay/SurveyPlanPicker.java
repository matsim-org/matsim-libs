 ...
 * Travel Survey of 2004 for Nelson Mandela Bay, to a synthetic population of
...
public class SurveyPlanPicker {
	...
	public static void main(String[] args){
		...
		spp.pickActivityChainsForPopulation(populationFolder);
	...
	public void buildQuadTreeFromSurvey(String surveyPopulationFolder){
		...
		for(Id personId : this.surveyPopulation.getScenario().getPopulation().getPersons().keySet()){
	...
	public void pickActivityChainsForPopulation(String populationFolder){
		...
		for(Id personId : censusPopulation.getScenario().getPopulation().getPersons().keySet()){
