...
public class JohScoringFunctionEstimation implements ScoringFunction {
	...
	// Settings of 105
	private static double beta_time_car = -2.8; 
	private static double beta_time_pt = 0.2; 
	private static double beta_time_bike = -1.7;
	private static double beta_time_walk = -2; 
	
	private static double constantPt = -0.2;
	private static double constantBike = 0.05;
	private static double constantWalk = 0.55;
