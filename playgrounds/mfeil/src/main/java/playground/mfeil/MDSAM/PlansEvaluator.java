...
public class PlansEvaluator extends PlansConstructor implements PlanStrategyModule {
	...
	// 	Type of writing the Biogeme file		
		...
		this.writePlansForBiogemeWithRandomSelectionAccumulated(this.outputFileBiogeme, this.attributesInputFile, 
				super.beta, super.gamma, super.similarity, super.incomeConstant, super.incomeDivided, super.incomeDividedLN, super.incomeBoxCox, super.age, super.gender, super.income, super.license, super.carAvail, super.seasonTicket, super.travelDistance, super.travelCost, super.travelConstant, super.beta_travel, super.bikeIn, super.munType);
	}
