...
public class OneWayCarsharingRDWithParkingStation  {
	...
	public OneWayCarsharingRDWithParkingStation(Link link, int numberOfVehicles, ArrayList<String> vehicleIDs, int availableParkingSpaces) {
