...
public class CostStructure1 implements CostCalculation{
	...
	private final static double end1 = 3600.0 * 12.0;
	
	private final static double start2 = 3600.0 * 14.0;
	private final static double end2 = 3600.0 * 18.0;
	@Override
	public double getCost(RentalInfo rentalInfo) {
		...
		if ((startTime < end1 && startTime >= start1) || (startTime < end2 && startTime >= start2))
			reduction = 0.5;
