...
public class MaxProfitWithLandPrices extends RetailerModelImpl
{
  ...
  public MaxProfitWithLandPrices(MatsimServices controler, Map<Id<ActivityFacility>, ActivityFacilityImpl> retailerFacilities)
  {
  ...
  private void computePotentialCustomers() {
	  ...
	  for (Integer i = Integer.valueOf(0); i.intValue() < first.size(); i = Integer.valueOf(i.intValue() + 1)) {
	      ...
	      landPrice = CoordUtils.calcEuclideanDistance(link.getCoord(), coord) * (-0.00001) + 1.0;
