package playground.balac.twowaycarsharing.replanning;
...
public class SubtourModeChoiceStrategy implements PlanStrategy {
	...
	public SubtourModeChoiceStrategy(final Scenario controler) {
		...
		SubtourModeChoice smc = new SubtourModeChoice(controler.getConfig());
		CarsharingPermissableModesCalculator cpmc = new CarsharingPermissableModesCalculator();
