...
public class CarSharingListener implements StartupListener, IterationEndsListener {
  ...
  public CarSharingListener(FtConfigGroup configGroup, PlansCalcRouteFtInfo plansCalcRouteFtInfo)
  {
...
public void notifyStartup(StartupEvent event) {
	...
	twoWayReservationhandler = new TwoWayReservationhandler(plansCalcRouteFtInfo, event.getControler());

    event.getControler().getEvents().addHandler(twoWayReservationhandler);
