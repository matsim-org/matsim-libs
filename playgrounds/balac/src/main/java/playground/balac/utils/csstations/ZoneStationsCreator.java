...
public class ZoneStationsCreator {
	...
	public static void main(String[] args) throws IOException {
		...
		final BufferedWriter outLink = IOUtils.getBufferedWriter("C:/Users/balacm/Desktop/Stations_GreaterZurich_zone10km_3x.txt");
		...
		while(s!=null) {		
			...
			if (CoordUtils.calcEuclideanDistance(coordS, coord) < 10000) {
				if (write) {
				outLink.write(arr1[0] + "\t" + arr1[1] + "\t" +arr1[2] + "\t" +arr1[3] + "\t" +arr1[4] + "\t" +arr1[5] + "\t" + Integer.toString(Integer.parseInt(arr1[6]) * 3));
				outLink.newLine();
				outLink.flush();
