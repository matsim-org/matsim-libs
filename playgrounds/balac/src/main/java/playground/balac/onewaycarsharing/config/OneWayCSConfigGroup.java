...
package playground.balac.onewaycarsharing.config;
...
public class OneWayCSConfigGroup extends Module {
	...
	private final static Logger logger = Logger.getLogger(OneWayCSConfigGroup.class);
	...
	public void addParam(String param_name, String value) {
		...
		if (!validParameterName) {
			logger.warn("Unknown parameter name in module " + OneWayCSConfigGroup.GROUP_NAME + ": \"" + param_name + "\". It is ignored.");
		}
