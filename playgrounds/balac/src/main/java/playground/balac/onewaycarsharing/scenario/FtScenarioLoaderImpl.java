package playground.balac.onewaycarsharing.scenario;
...
public class FtScenarioLoaderImpl extends ScenarioLoaderImpl {
	...
	public FtScenarioLoaderImpl(Scenario scenario, PlansCalcRouteFtInfo plansCalcRouteFtInfo, OneWayCSConfigGroup ftConfigGroup) {
		super(scenario);
