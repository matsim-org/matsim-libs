...
public class CarSharingSummaryWriter
{
  ...
  public void write(Person person, LinkImpl startLink, CarSharingStation fromStation, CarSharingStation toStation, LinkImpl endLink, double departureTime, double arrivalTime, Activity actBefore, Activity actAfter)
  {
    try
    {
