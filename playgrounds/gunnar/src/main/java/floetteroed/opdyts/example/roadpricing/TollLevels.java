...
class TollLevels implements DecisionVariable {
	...
	public String toPSTricks() {
		final PSTricksDiagramWriter writer = new PSTricksDiagramWriter(12.0,
				6.0);
		writer.setEndLine("\n");
		...
		writer.add("toll", H_PER_S * this.morningLevel2start_s,
				this.level1cost_money);
		writer.add("toll", H_PER_S * this.morningLevel2start_s,
				this.level2cost_money);
		writer.add("toll", H_PER_S * this.morningLevel3start_s,
				this.level2cost_money);
		writer.add("toll", H_PER_S * this.morningLevel3start_s,
				this.level3cost_money);
		writer.add("toll", H_PER_S * this.morningLevel3end_s,
				this.level3cost_money);
		writer.add("toll", H_PER_S * this.morningLevel3end_s,
				this.level2cost_money);
		writer.add("toll", H_PER_S * this.morningLevel2end_s,
				this.level2cost_money);
		writer.add("toll", H_PER_S * this.morningLevel2end_s,
				this.level1cost_money);

		writer.add("toll", H_PER_S * this.eveningLevel2start_s,
				this.level1cost_money);
		writer.add("toll", H_PER_S * this.eveningLevel2start_s,
				this.level2cost_money);
		writer.add("toll", H_PER_S * this.eveningLevel3start_s,
				this.level2cost_money);
		writer.add("toll", H_PER_S * this.eveningLevel3start_s,
				this.level3cost_money);
		writer.add("toll", H_PER_S * this.eveningLevel3end_s,
				this.level3cost_money);
		writer.add("toll", H_PER_S * this.eveningLevel3end_s,
				this.level2cost_money);
		writer.add("toll", H_PER_S * this.eveningLevel2end_s,
				this.level2cost_money);
		writer.add("toll", H_PER_S * this.eveningLevel2end_s,
				this.level1cost_money);
