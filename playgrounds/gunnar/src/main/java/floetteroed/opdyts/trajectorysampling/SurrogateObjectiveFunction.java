...
// implements VectorBasedObjectiveFunction {
{
	...
	// private final VectorBasedObjectiveFunction
	// originalVectorBasedObjectiveFunction;
	...
	SurrogateObjectiveFunction(
			...
			// originalObjectBasedObjectiveFunction,
			// final VectorBasedObjectiveFunction
			// originalVectorBasedObjectiveFunction,
	...
	// final double initialGradientNorm
		...
		// originalObjectBasedObjectiveFunction;
		// this.originalVectorBasedObjectiveFunction =
		// originalVectorBasedObjectiveFunction;
	...
	public Vector gradient(final Vector alphas) {
		...
		for (int l = 0; l < alphas.size(); l++) {
			result.add(l, this.equilibriumGapWeight
					// * this.initialGradientNorm
		 ...
		 */
		for (int l = 0; l < alphas.size(); l++) {
			result.add(l, this.uniformityWeight
			// * this.initialGradientNorm
					* 2.0 * alphas.get(l));
		}
		return result;
