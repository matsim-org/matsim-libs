...
public class RunRoadClassification {
	...
	static void justRun() {
		...
		try (InputStream is = new FileInputStream(DownloadExampleData.SIOUX_FALLS)) {
			OsmNetworkReader osmNetworkReader = new OsmNetworkReader(scenario.getNetwork(), DownloadExampleData.COORDINATE_TRANSFORMATION);
	...
	static void optimize() {
		...
		decisionVariables.add(new AbstractRoadClassificationDecisionVariable(scenario.getNetwork()) {
			@Override
			void doSetHighwayDefaults(OsmNetworkReader osmNetworkReader) {
				...
				osmNetworkReader.setHighwayDefaults(6, "minor", 1, 45.0 / 3.6, 1.0, 600);
				osmNetworkReader.setHighwayDefaults(6, "unclassified", 1, 45.0 / 3.6, 1.0, 600);
				osmNetworkReader.setHighwayDefaults(6, "residential", 1, 30.0 / 3.6, 1.0, 600);
				osmNetworkReader.setHighwayDefaults(6, "living_street", 1, 15.0 / 3.6, 1.0, 300);
		...
		decisionVariables.add(new AbstractRoadClassificationDecisionVariable(scenario.getNetwork()) {
			...
			void doSetHighwayDefaults(OsmNetworkReader osmNetworkReader) {
				...
				// motorway 2 instead of 1 lane
				osmNetworkReader.setHighwayDefaults(1, "motorway", 2, 120.0 / 3.6, 1.0, 1900, true);
				osmNetworkReader.setHighwayDefaults(1, "motorway_link", 1, 80.0 / 3.6, 1.0, 1800, true);
				osmNetworkReader.setHighwayDefaults(2, "trunk", 1, 80.0 / 3.6, 1.0, 1800);
				osmNetworkReader.setHighwayDefaults(2, "trunk_link", 1, 50.0 / 3.6, 1.0, 1600);
				osmNetworkReader.setHighwayDefaults(3, "primary", 1, 80.0 / 3.6, 1.0, 1800);
				osmNetworkReader.setHighwayDefaults(3, "primary_link", 1, 60.0 / 3.6, 1.0, 1700);
				osmNetworkReader.setHighwayDefaults(4, "secondary", 1, 60.0 / 3.6, 1.0, 1700);
				osmNetworkReader.setHighwayDefaults(5, "tertiary", 1, 45.0 / 3.6, 1.0, 1600);
				osmNetworkReader.setHighwayDefaults(6, "minor", 1, 45.0 / 3.6, 1.0, 1600);
				osmNetworkReader.setHighwayDefaults(6, "unclassified", 1, 45.0 / 3.6, 1.0, 1600);
				osmNetworkReader.setHighwayDefaults(6, "residential", 1, 30.0 / 3.6, 1.0, 1400);
				osmNetworkReader.setHighwayDefaults(6, "living_street", 1,  15.0/3.6, 1.0,  1000);
			}
		});
		...
		decisionVariables.add(new AbstractRoadClassificationDecisionVariable(scenario.getNetwork()) {
			...
			void doSetHighwayDefaults(OsmNetworkReader osmNetworkReader) {
				// default capacities
				// no multi-lane roads
				osmNetworkReader.setHighwayDefaults(1, "motorway", 1, 120.0 / 3.6, 1.0, 2000, true);
				osmNetworkReader.setHighwayDefaults(1, "motorway_link", 1, 80.0 / 3.6, 1.0, 1500, true);
				osmNetworkReader.setHighwayDefaults(2, "trunk", 1, 80.0 / 3.6, 1.0, 2000);
				osmNetworkReader.setHighwayDefaults(2, "trunk_link", 1, 50.0 / 3.6, 1.0, 1500);
				osmNetworkReader.setHighwayDefaults(3, "primary", 1, 80.0 / 3.6, 1.0, 1500);
		...
		decisionVariables.add(new AbstractRoadClassificationDecisionVariable(scenario.getNetwork()) {
			...
			void doSetHighwayDefaults(OsmNetworkReader osmNetworkReader) {
				// Derived capacities (from triangular fundamental diagram)
				// no multi-lane roads
				osmNetworkReader.setHighwayDefaults(1, "motorway", 1, 120.0 / 3.6, 1.0, 1900, true);
				osmNetworkReader.setHighwayDefaults(1, "motorway_link", 1, 80.0 / 3.6, 1.0, 1800, true);
				osmNetworkReader.setHighwayDefaults(2, "trunk", 1, 80.0 / 3.6, 1.0, 1800);
				osmNetworkReader.setHighwayDefaults(2, "trunk_link", 1, 50.0 / 3.6, 1.0, 1600);
				osmNetworkReader.setHighwayDefaults(3, "primary", 1, 80.0 / 3.6, 1.0, 1800);
		...
		decisionVariables.add(new AbstractRoadClassificationDecisionVariable(scenario.getNetwork()) {
			...
			void doSetHighwayDefaults(OsmNetworkReader osmNetworkReader) {
				...
				osmNetworkReader.setHighwayDefaults(1, "motorway", 2, 120.0 / 3.6, 1.0, 2000, true);
				osmNetworkReader.setHighwayDefaults(1, "motorway_link", 2, 80.0 / 3.6, 1.0, 1500, true);
				osmNetworkReader.setHighwayDefaults(2, "trunk", 2, 80.0 / 3.6, 1.0, 2000);
				osmNetworkReader.setHighwayDefaults(2, "trunk_link", 1, 50.0 / 3.6, 1.0, 1500);
				osmNetworkReader.setHighwayDefaults(3, "primary", 1, 80.0 / 3.6, 1.0, 1500);
				osmNetworkReader.setHighwayDefaults(3, "primary_link", 1, 60.0 / 3.6, 1.0, 1500);
				osmNetworkReader.setHighwayDefaults(4, "secondary", 1, 60.0 / 3.6, 1.0, 1000);
		...
		decisionVariables.add(new AbstractRoadClassificationDecisionVariable(scenario.getNetwork()) {
			...
			void doSetHighwayDefaults(OsmNetworkReader osmNetworkReader) {
				...
				// motorway, trunk 2 instead of 1 lane
				osmNetworkReader.setHighwayDefaults(1, "motorway", 2, 120.0 / 3.6, 1.0, 1900, true);
				osmNetworkReader.setHighwayDefaults(1, "motorway_link", 2, 80.0 / 3.6, 1.0, 1800, true);
				osmNetworkReader.setHighwayDefaults(2, "trunk", 2, 80.0 / 3.6, 1.0, 1800);
				osmNetworkReader.setHighwayDefaults(2, "trunk_link", 1, 50.0 / 3.6, 1.0, 1600);
				osmNetworkReader.setHighwayDefaults(3, "primary", 1, 80.0 / 3.6, 1.0, 1800);
				osmNetworkReader.setHighwayDefaults(3, "primary_link", 1, 60.0 / 3.6, 1.0, 1700);
				osmNetworkReader.setHighwayDefaults(4, "secondary", 1, 60.0 / 3.6, 1.0, 1700);
		...
		decisionVariables.add(new AbstractRoadClassificationDecisionVariable(scenario.getNetwork()) {
			...
			void doSetHighwayDefaults(OsmNetworkReader osmNetworkReader) {
				...
				osmNetworkReader.setHighwayDefaults(1, "motorway_link", 2, 80.0 / 3.6, 1.0, 1500, true);
				osmNetworkReader.setHighwayDefaults(2, "trunk", 2, 80.0 / 3.6, 1.0, 2000);
				osmNetworkReader.setHighwayDefaults(2, "trunk_link", 2, 50.0 / 3.6, 1.0, 1500);
				osmNetworkReader.setHighwayDefaults(3, "primary", 2, 80.0 / 3.6, 1.0, 1500);
				osmNetworkReader.setHighwayDefaults(3, "primary_link", 1, 60.0 / 3.6, 1.0, 1500);
				osmNetworkReader.setHighwayDefaults(4, "secondary", 1, 60.0 / 3.6, 1.0, 1000);
				osmNetworkReader.setHighwayDefaults(5, "tertiary", 1, 45.0 / 3.6, 1.0, 600);
				osmNetworkReader.setHighwayDefaults(6, "minor", 1, 45.0 / 3.6, 1.0, 600);
		...
		decisionVariables.add(new AbstractRoadClassificationDecisionVariable(scenario.getNetwork()) {
			...
			void doSetHighwayDefaults(OsmNetworkReader osmNetworkReader) {
				...
				osmNetworkReader.setHighwayDefaults(1, "motorway_link", 2, 80.0 / 3.6, 1.0, 1800, true);
				osmNetworkReader.setHighwayDefaults(2, "trunk", 2, 80.0 / 3.6, 1.0, 1800);
				osmNetworkReader.setHighwayDefaults(2, "trunk_link", 2, 50.0 / 3.6, 1.0, 1600);
				osmNetworkReader.setHighwayDefaults(3, "primary", 2, 80.0 / 3.6, 1.0, 1800);
				osmNetworkReader.setHighwayDefaults(3, "primary_link", 1, 60.0 / 3.6, 1.0, 1700);
				osmNetworkReader.setHighwayDefaults(4, "secondary", 1, 60.0 / 3.6, 1.0, 1700);
				osmNetworkReader.setHighwayDefaults(5, "tertiary", 1, 45.0 / 3.6, 1.0, 1600);
				osmNetworkReader.setHighwayDefaults(6, "minor", 1, 45.0 / 3.6, 1.0, 1600);
