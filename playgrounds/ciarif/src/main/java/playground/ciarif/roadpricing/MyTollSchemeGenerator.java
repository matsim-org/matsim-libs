...
public class MyTollSchemeGenerator {


	private static final Logger log = Logger.getLogger(MyTollSchemeGenerator.class);

//	private static final String EQUILCONFIG = "../../matsim/input/preprocess/ivtch-config.xml";
...
//	private static final String IVTCHCONF = "../testData/schweiz-ivtch/ivtch-config.xml";
	...
	private static final String SCHWEIZCHCONF = "../../matsim/input/preprocess/ivtch-config.xml";

//	private static final String IVTOUTFILE = "../testData/output/ivtch/zurichCityAreaWithHighwaysPricingScheme.kmz";

	private static final String IVTOUTSCHEME = "../../matsim/output/preprocess/roadpricing/zurichCityAreaWithHighwaysPricingScheme.xml";
...
//	private static final String IVTCHGISOUTBASE = "/Volumes/data/work/vspSvn/studies/schweiz-ivtch/baseCase/roadpricing/zurichCityArea/zurichCityAreaWithoudHighways";
	...
	private static final String SCHWEIZCHOUTBASE = "../../matsim/output/preprocess/roadpricing/zurichCityAreaWithoutHighwaysNew";

	private static final String SCHWEIZCHGISOUTBASE = "../../matsim/output/preprocess/roadpricing/zurichCityAreaWithoutHighways";
...
//		}
		...
		//tollNetwork = (NetworkImpl) this.applyLinkIdFilter(tollNetwork, linkIdsToFilter);
		...
		RoadPricingSchemeImpl pricingScheme = this.createRoadPricingScheme(tollNetwork);
		//write it to file
	...
	private Network applyLinkIdFilter(Network tollNetwork,List<Id> linkIdsToFilter) {
	...
	private RoadPricingSchemeImpl createRoadPricingScheme(NetworkImpl tollNetwork) {
...
//		MyNetwork n = new MyNetwork();
		...
		for (Link l : net.getLinks().values()) {
			...
			if (ppp.contains(new Point(new CoordinateArraySequence(
				...
				//log.info("Links = " + n.getLinks().values());
				//log.info("Nodes = " + n.getNodes().values());
				n.addLink(l);
			}
		}
		return n;
