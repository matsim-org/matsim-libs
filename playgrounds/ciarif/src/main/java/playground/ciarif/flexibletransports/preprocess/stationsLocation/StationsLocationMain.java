...
import playground.ciarif.flexibletransports.preprocess.membership.MembershipMain;
...
public class StationsLocationMain {
	...
	public void run(String inputFile) {
		...
		StationAssigner stationAssigner = new StationAssigner (membershipAssigner);
		stationAssigner.run();
