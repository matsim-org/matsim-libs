...
public class LinksRetailerReader {
	...
	// Public methods
	public void init() {
		this.linkIdFile = this.controler.getConfig().findParam(CONFIG_GROUP,CONFIG_LINKS);
	...
	private void createFreeLinks() {
		String freeLinksParameterString = this.controler.getConfig().findParam(CONFIG_GROUP,CONFIG_LINKS_PAR);
