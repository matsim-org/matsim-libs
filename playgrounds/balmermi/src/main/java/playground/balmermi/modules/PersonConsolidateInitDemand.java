...
//
//            if (result.isEmpty()) { throw new RuntimeException("Person id="+plan.getPerson().getId()+": knowledge act of type="+actOption.getType()+" missing!"); }
//		}
...
//        throw new RuntimeException("Knowledges are no more.");
//
//        for (ActivityOptionImpl actOptionK : result1) {
//			boolean toDelete = true;
//			for (ActivityOption actOption : actOptions) {
...
//            throw new RuntimeException("Knowledges are no more.");
//
//            if (!result) { throw new RuntimeException("Person id="+plan.getPerson().getId()+": could not remove act="+aok.getType()+" from knowledge!"); }
//		}
//
...
//        throw new RuntimeException("Knowledges are no more.");
//
//        List<ActivityOptionImpl> kActOptions = result;
