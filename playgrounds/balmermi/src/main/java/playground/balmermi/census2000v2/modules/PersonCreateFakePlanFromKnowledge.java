...
//
//        ArrayList<ActivityOptionImpl> home_acts = result1;
//		if (home_acts.size()==0) {
//            String result;
//            throw new RuntimeException("Knowledges are no more.");
//
//            throw new RuntimeException("pid="+person.getId()+", kdesc="+ result +": no home activity defined"); }
...
//                throw new RuntimeException("Knowledges are no more.");
//
//                throw new RuntimeException("pid="+person.getId()+", kdesc="+ result +", hhid_w="+hh.getId()+": given facilities do not match the household!"); }
//		}
//		else {
//            String result;
//            throw new RuntimeException("Knowledges are no more.");
//
//            throw new RuntimeException("pid="+person.getId()+", kdesc="+ result +": more than 2 home activities defined"); }
//
...
//            throw new RuntimeException("Knowledges are no more.");
//
//            ArrayList<ActivityOptionImpl> work_acts = result;
...
//            throw new RuntimeException("Knowledges are no more.");
//
//            ArrayList<ActivityOptionImpl> educ_acts = result;
