...
//				Assert.assertTrue(group.getSignalIds().contains(Id.create(132)));
	...
	private void create3WayNetwork(Scenario sc) {
		...
		Node n1, n2, n3, n4;
		Link l;
		n1 = fac.createNode(Id.create(1, Node.class), sc.createCoord(0.0, 0.0));
		net.addNode(n1);
		n2 = fac.createNode(Id.create(2, Node.class), sc.createCoord(-10.0, 10.0));
		net.addNode(n2);
		n3 = fac.createNode(Id.create(3, Node.class), sc.createCoord(0.0, 10.0));
		net.addNode(n3);
		n4 = fac.createNode(Id.create(4, Node.class), sc.createCoord(10.0, 8.0));
		net.addNode(n4);
