 ...
 *
 */
public class DgOsmBBJunctionDetectionToolsc {
...
//					log.info("  detected junction node: " + toNodeId);
		...
		if (junctionMatsimNodes.size()<2){
			...
			for (org.matsim.api.core.v01.network.Node n: mNodes){
				...
				if (((ndx>=(xcord-25.0))&&(ndx<=(xcord+25.0)))&&((ndy>=(ycord-25.0))&&(ndy>(xcord+25.0)))) {
...
//		String baseOutDir = baseOutDirTest;
		...
		String kmlJunctionsOutFile = baseOutDir + "junctions_tstim.kml";
		String kmlNetworkOutFile = baseOutDir + "network2.kml";
		
		DgOsmBBJunctionDetectionToolsc tools = new DgOsmBBJunctionDetectionToolsc();
