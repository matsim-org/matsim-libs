...
//		event.getServices().getMobsimListeners().add(this.signalEngie);
	...
	public void notifyShutdown(ShutdownEvent event) {
		SignalsData data = (SignalsData) event.getServices().getScenario().getScenarioElement(SignalsData.ELEMENT_NAME);
		new SignalsScenarioWriter(event.getServices().getControlerIO()).writeSignalsData(data);
	}
