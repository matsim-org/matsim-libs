 ...
 * (in contrast to DgPhase which end is defined by the dropping of the largest setting starting at the phase starting time)
 * i.e. different TtPhases cannot overlap each other (whereby DgPhases may do so)
 * 
 * @author tthunig
 *
 */
final class TtPhase {
		...
		private static final Logger log = Logger.getLogger(TtPhase.class);
		...
		public TtPhase(Integer phaseOn, Integer phaseDrop) {
