...
public class DgCottbusNet2Shape {
	...
	public static final class SimpleWidthCalculator implements WidthCalculator{
		...
		public SimpleWidthCalculator(NetworkImpl n, Double d) {}
...
//		writer.write(netFile);
		...
		String outputDirectory = "/media/data/work/repos/shared-svn/studies/dgrether/cottbus/cottbus_feb_fix/shape_files/shape_network_wgs84_utm33n/";
