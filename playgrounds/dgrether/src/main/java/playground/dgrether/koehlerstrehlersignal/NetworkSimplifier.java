...
//									inLink.getOrigId() + "-" + outLink.getOrigId(),
	 ...
	 *            A Set of integer indicating the node types as specified by
	 *            {@link NetworkCalcTopoType}
	 * @see NetworkCalcTopoType NetworkCalcTopoType for a list of available
	 *      classifications.
	 */
	...
	/**
	 * 
	 * @param mergeLinkStats
	 *            If set true, links will be merged despite their different
	 *            attributes. If set false, only links with the same attributes
	 *            will be merged, thus preserving as much information as
	 *            possible. Default is set false.
	 */
