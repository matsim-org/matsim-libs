 ...
 * @author tthunig
 */
public class TtDgMATSimScenario2KoehlerStrehler2010 {
	
	public static final Logger log = Logger.getLogger(TtDgMATSimScenario2KoehlerStrehler2010.class);
	...
	public TtDgMATSimScenario2KoehlerStrehler2010(Scenario scenario, CoordinateReferenceSystem crs) {
