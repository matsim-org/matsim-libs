...
//	private static double interpTime_idw10x10= Double.MAX_VALUE;
	...
	private static File outputFile= new File("Z:/WinHome/Docs/Interpolation/MiniTest/Evaluation.txt");
	 ...
	 */
	public MiniTest(int interpolationMethod, int numberOfRows, int numberOfColumns, boolean allNeighbors, double exponent){
		String neighbors;
		...
		if (interpolationMethod == 2)
			this.interpolatedSG.writeToFile("Z:/WinHome/Docs/Interpolation/MiniTest/" + interpolationMethod + "_" + neighbors + "_exp" + exponent + "_" + numberOfRows + "x" + numberOfColumns + ".txt"); //TODO in resources speichern
		else
			this.interpolatedSG.writeToFile("Z:/WinHome/Docs/Interpolation/MiniTest/" + interpolationMethod + "_" + numberOfRows + "x" + numberOfColumns + ".txt"); //TODO in resources speichern
...
//		}		
	...
	static void interpolationTest(int interpolationMethod, int numberOfRows, int numberOfColumns, boolean allNeighbors, double exp){
		...
		MiniTest testScenario= new MiniTest(interpolationMethod, numberOfRows, numberOfColumns, allNeighbors, exp);
