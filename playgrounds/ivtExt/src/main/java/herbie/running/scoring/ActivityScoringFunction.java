...
org.matsim.deprecated.scoring.functions.CharyparNagelActivityScoring {
	...
	public ActivityScoringFunction(Plan plan, ScoringParameters params, final TreeMap<Id, FacilityPenalty> facilityPenalties, final ActivityFacilities facilities, Config config) {
		super(params);
		this.params = params;
		this.plan = plan;
	...
	protected double getPerformanceScore(String actType, double duration) {
		...
		if ( true ) throw new RuntimeException( "desires do not exist anymore" );
