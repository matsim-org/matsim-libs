...
public class IDSCDriveTaskTracker implements OnlineDriveTaskTracker {
	...
	IDSCDriveTaskTracker(Vehicle vehicle, VrpLeg vrpDynLeg, VrpOptimizerWithOnlineTracking optimizer,
			MobsimTimer timer) {
	...
	public void divertPath(VrpPathWithTravelData newSubPath) {
		...
		if (!newSubPath.getFromLink().equals(diversionPoint.link)) {
			throw new IllegalArgumentException(
					"links dont match: " + newSubPath.getFromLink().getId() + "!=" + diversionPoint.link.getId());
		}
