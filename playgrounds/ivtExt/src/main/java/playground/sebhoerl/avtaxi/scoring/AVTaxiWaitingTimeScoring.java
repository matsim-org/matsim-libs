...
public class AVTaxiWaitingTimeScoring implements SumScoringFunction.ArbitraryEventScoring {
    ...
    public AVTaxiWaitingTimeScoring(double marginalUtilityOfWaiting, double marginalUtilityOfTraveling) {
    ...
    public void handleEvent(Event event) {
        if (event instanceof PersonDepartureEvent) {
            if (((PersonDepartureEvent) event).getLegMode() == TaxiModule.TAXI_MODE) {
