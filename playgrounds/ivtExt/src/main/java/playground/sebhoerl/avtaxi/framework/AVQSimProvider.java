...
public class AVQSimProvider extends TaxiQSimProvider {
    private final EventsManager eventsManager;
    private final Collection<AbstractQSimPlugin> plugins;
	private final VehicleType vehicleType;
	
	@Inject
	public AVQSimProvider(EventsManager eventsManager, Collection<AbstractQSimPlugin> plugins, Scenario scenario,
    ...
    public Mobsim get() {
        ...
        qSim.addQueueSimulationListeners(new AVPrebookingEngine(passengerEngine));
	...
	protected VrpAgentSource createVrpAgentSource(TaxiOptimizer optimizer, QSim qSim,
        ...
        AVActionCreator avActionCreator = new AVActionCreator(passengerEngine, legCreator,
