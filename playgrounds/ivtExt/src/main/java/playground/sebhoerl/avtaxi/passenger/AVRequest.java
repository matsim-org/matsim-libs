...
public class AVRequest extends RequestImpl implements PassengerRequest {
    ...
    public AVRequest(Id<Request> id, MobsimPassengerAgent passengerAgent, Link pickupLink, Link dropoffLink, double pickupTime, double submissionTime, AVOperator operator) {
