...
public class seb__NetworkShapeFilter {
    final private Logger logger = Logger.getLogger(seb__NetworkShapeFilter.class);
    ...
    static public void main(String[] args) throws IOException {
     ...
     // load options
        ...
        new seb__NetworkShapeFilter().filter(network, "shapefiles/Export_Output_2.shp");
        new NetworkWriter(network).write("test.xml");
    }
