 ...
 * @author mrieser
 */
public final class VirtualNetworkReaderMatsimV1 extends MatsimXmlParser {
    ...
    private final static Logger log = Logger.getLogger(org.matsim.core.network.io.NetworkReaderMatsimV1.class);

    public VirtualNetworkReaderMatsimV1(Network network) {
        this(new IdentityTransformation(), network);
    }

    public VirtualNetworkReaderMatsimV1(
