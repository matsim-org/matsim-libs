...
public class SpencerSelfishOldNotWorking extends RebalancingDispatcher {
    ...
    private SpencerSelfishOldNotWorking( //
        ...
        GlobalAssert.that(subStrategy.equals("noComm") || subStrategy.equals("voronoi") || subStrategy.equals("selfishLoiter"));
    ...
    private Link computeWeberLink(List<AVRequest> avRequests, ArrayList<Double> weights, Link initialGuess) {
        ...
        GlobalAssert.that((weberCoord.getX() >= networkBounds[0]) && (weberCoord.getY() >= networkBounds[1]) && (weberCoord.getX() <= networkBounds[2])
