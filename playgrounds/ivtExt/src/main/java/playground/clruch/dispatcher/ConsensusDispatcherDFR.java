            ...
            Map<VirtualNode, List<AVRequest>> requests = getVirtualNodeRequests();
            {
                ...
                Map<VirtualLink, Integer> rebalanceCount = new HashMap<>();
                {
                    for (VirtualLink vLink : virtualNetwork.getVirtualLinks()) {
                        ...
                        int imbalanceTo = -vi_excess.get(vLink.getFrom());
                        ...
                        int rebalanceFromTo = (int) Math.floor(vehicles_From_to_To);
                        ...
                        // TODO: continue
                        // TODO redesign this part if/else and dispatch and check result feasiblity.
