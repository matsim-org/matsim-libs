...
public class DiagramDemo {
    public static void main(String[] args) throws IOException {
        ...
        Files.lines(Paths.get("C:\\Users\\Joel\\Documents\\Studium\\ETH\\Bachelorarbeit\\Simulation_Data\\2017_03_22_Sioux_Hungarian_check1av\\output\\data\\basicdemo.csv")));
        ...
        try{
            ...
            DiagramCreator.createDiagram(dir, "binnedWaitingTimes", "waiting times", table.get(0),
                    Tensors.of(table.get(5),table.get(7),table.get(9),table.get(10)));
