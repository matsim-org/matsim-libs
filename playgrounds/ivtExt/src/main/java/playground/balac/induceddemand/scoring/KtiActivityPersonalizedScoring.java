 ...
 */
public class KtiActivityPersonalizedScoring implements ActivityScoring, ScoringFunctionAccumulator.ActivityScoring {
	private static final Logger logger = Logger.getLogger(KtiActivityPersonalizedScoring.class);
