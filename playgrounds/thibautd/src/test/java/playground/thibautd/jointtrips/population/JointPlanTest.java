...
// 			PlanElement copiedElement = elements.get(i);
// 			PlanElement copyElement = copyElements.get(i);
// 
...
// 					copyElement);
// 
// 			//if (copiedElement instanceof Activity) {
// 			//	Assert.assertEquals(
// 			//			"activity in copy has a different id!",
// 			//			((JointActivity) copiedElement).getId(),
// 			//			((JointActivity) copyElement).getId());
// 			//}
// 			//else {
// 			//	if (((JointLeg) copiedElement).getJoint()) {
// 			//		jointCount++;
// 			//	}
// 
// 			//	Assert.assertEquals(
// 			//			"copied leg and copy do not have the same joint status!",
// 			//			((JointLeg) copiedElement).getJoint(),
// 			//			((JointLeg) copyElement).getJoint());
// 
// 			//	Assert.assertEquals(
// 			//			"copied leg and copy do not have the same number of linked elements!",
// 			//			((JointLeg) copiedElement).getLinkedElements().size(),
// 			//			((JointLeg) copyElement).getLinkedElements().size());
// 			//}
// 		}
// 
// 		if (jointCount <= 0) {
// 			// check the tests tested something
// 			throw new RuntimeException( "no joint leg examined: jointCount="+jointCount );
// 		}
// 
