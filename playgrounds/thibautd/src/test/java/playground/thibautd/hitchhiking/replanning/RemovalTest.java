...
public class RemovalTest {
	...
	public void initPlans() {
		...
		PlanImpl plan = new PlanImpl(PopulationUtils.getFactory().createPerson(Id.create("one passenger trip", Person.class)));
		plans.add( plan );
		...
		plan = new PlanImpl(PopulationUtils.getFactory().createPerson(Id.create("one driver trip", Person.class)));
		plans.add( plan );
		plan.createAndAddActivity( "h" , link1 ).setEndTime( 1 );
		plan.createAndAddLeg( HitchHikingConstants.DRIVER_MODE );
		plan.createAndAddActivity( "h" , link1 );

		plan = new PlanImpl(PopulationUtils.getFactory().createPerson(Id.create("one tour with one passenger trip", Person.class)));
		plans.add( plan );
		plan.createAndAddActivity( "h" , link1 ).setEndTime( 1 );
		plan.createAndAddLeg( HitchHikingConstants.PASSENGER_MODE );
		...
		plan = new PlanImpl(PopulationUtils.getFactory().createPerson(Id.create("one tour with one driver trip", Person.class)));
		plans.add( plan );
		plan.createAndAddActivity( "h" , link1 ).setEndTime( 1 );
		plan.createAndAddLeg( HitchHikingConstants.DRIVER_MODE );
		plan.createAndAddActivity( "w" , link2 ).setEndTime( 2 );
		...
		plan = new PlanImpl(PopulationUtils.getFactory().createPerson(Id.create("two tours with one passenger trip each", Person.class)));
		plans.add( plan );
		plan.createAndAddActivity( "h" , link1 ).setEndTime( 1 );
		plan.createAndAddLeg( HitchHikingConstants.PASSENGER_MODE );
		plan.createAndAddActivity( "w" , link2 ).setEndTime( 2 );
		...
		plan = new PlanImpl(PopulationUtils.getFactory().createPerson(Id.create("two tours with one and two passenger trips", Person.class)));
		plans.add( plan );
		plan.createAndAddActivity( "h" , link1 ).setEndTime( 1 );
		plan.createAndAddLeg( HitchHikingConstants.PASSENGER_MODE );
		plan.createAndAddActivity( "w" , link2 ).setEndTime( 2 );
