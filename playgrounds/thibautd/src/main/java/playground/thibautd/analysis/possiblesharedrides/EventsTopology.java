...
//	 * window
//	 */
//	public List<AgentArrivalEvent> getNeighbors(final AgentArrivalEvent event) {
//		return getNeighbors(event.getTime(), event.getLinkId());
//	}
//	
//	public List<AgentArrivalEvent> getNeighbors(final AgentDepartureEvent event) {
//		return getNeighbors(event.getTime(), event.getLinkId());
//	}
//
//	public List<Event> getNeighbors(final double time, final Id link) {
//		List<? extends Event> temporalNeighbors = getTemporalNeighbors(time, this.timeWindowRadius);
//		List<Id> spatialNeighborhood = 
//			this.linkTopology.getNeighbors(link);
//		List<Event> output = new ArrayList<Event>();
//
//		for (Event currentEvent : temporalNeighbors) {
...
//			final double timeWindowRadius) {
//		List<? extends Event> neighbors = getTemporalNeighbors(timeWindowCenter, timeWindowRadius);
//		List<LinkEvent> output = new ArrayList<LinkEvent>();
//
//		// only return events for the good link
//		for (Event event : neighbors) {
...
//	 * =========================================================================
//	 */
//	private List<? extends Event> getTemporalNeighbors(final Event event) {
...
//	 */
//	private List<? extends Event>  getTemporalNeighbors(
//			final double timeWindowCenter,
//			final double timeWindowRadius) {
//		int lowIndex = 0;
