...
//		List<Event> departureNeighbors =
//			this.leaveLinksTopology.getNeighbors(departure);
//		List<Event> arrivalNeighbors =
...
//
//	private int countPossibleSharedRides(
//			final List<Event> departureNeighbors,
//			final List<Event> arrivalNeighbors) {
...
//		for (Event event : departureNeighbors) {
