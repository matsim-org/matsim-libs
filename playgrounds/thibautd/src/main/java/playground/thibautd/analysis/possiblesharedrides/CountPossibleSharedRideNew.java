...
// * @author thibautd
// */
//public class CountPossibleSharedRideNew {
...
//	 */
//	public CountPossibleSharedRideNew(
...
//	 *
//	 * @param acceptableDistance for titles only
//	 * @param timeWindowRadius for titles only
//	 */
//	public CountPossibleSharedRideNew(
//			final double acceptableDistance,
//			final double timeWindowRadius) {
...
//	 * acceptable distance)!
//	 */
//	public void loadTripData(final String fileName) {
//		try {
...
//							Double.parseDouble(line[distance]),
//							Integer.valueOf(line[count]),
//							new IdImpl(line[departureId]),
//							new IdImpl(line[arrivalId])));
//			}
//		}
//		} catch (IOException e) {
...
//
//	@Deprecated
//	public void correctFileFromPlans(
//			final String fileName,
//			final Population population,
//			final Network network,
//			final String outputFile) {
//		loadTripData(fileName);
//
//		List<TripData> newResults = new ArrayList<TripData>();
//		Plan plan;
//		double minTimeDist;
//		double timeDist;
//		double depTime;
...
//			plan = population.getPersons().get(data.id).getSelectedPlan();
//			leg = null;
//
//			minTimeDist = Double.POSITIVE_INFINITY;
//
...
//	 */
//	public ChartUtil getBoxAndWhiskersPerTimeBin(final int nTimeBins, final double minDist) {
//		this.prepareForAnalysis();
//		String title = "Number of possible joint trips per departure time\n"+
//				(minDist > 0 ? "trips of more than "+minDist+"km only\n" : "")+
//				"acceptable distance: "+this.acceptableDistance+"m,\n"+
//				"acceptable time: "+(this.timeWindowRadius/60d)+" min.";
...
//	 */
//	public ChartUtil getBoxAndWhiskersPerDistanceBin(final double binWidth, final double maxTripLength) {
//		this.prepareForAnalysis();
//		String title = "Number of possible joint trips per trip distance\n"+
//				"acceptable distance: "+this.acceptableDistance+"m,\n"+
//				"acceptable time: "+(this.timeWindowRadius/60d)+" min.";
//		BoxAndWhiskersChart chart = new BoxAndWhiskersChart(
//				title,
...
//		for (TripData data : this.results) {
//			kmDist = data.distance / 1000d;
//			if (kmDist < maxTripLength) {
//				chart.add(kmDist, data.numberOfJoinableTrips);
//			}
//		}
//
//		return chart;
//	}
//
//	public void writeRawData(final String fileName) {
...
//			line += "\t" + data.departureLinkId;
//			line += "\t" + data.arrivalLinkId;
//
//			count++;
//			if (count == next) {
...
//				AgentDepartureEvent departure = getDepartureEvent(
//						personId,
//						departureTime,
//						departureId);
//				//log.debug("getting departure events... DONE");
//				//log.debug("getting arrival events...");
//				AgentArrivalEvent arrival = getArrivalEvent(
//						personId,
//						arrivalTime,
//						arrivalId);
//				if (arrival == null) {
...
//		}
//
//		return new TripData(personId, departureTime, distance, numberOfJoinableTrips, departureId, arrivalId);
//	}
//
//	private AgentDepartureEvent getDepartureEvent(
//			final Id person,
...
//	}
//
//	private AgentArrivalEvent getArrivalEvent(
//			final Id person,
//			final double expectedTime,
//			final Id link) {
//		//log.debug("expected time: "+(expectedTime/3600d)+"h");
...
//		List<AgentDepartureEvent> departureNeighbors =
//			this.leaveLinksTopology.getNeighbors(departure);
//		List<AgentArrivalEvent> arrivalNeighbors =
...
//		Id currentId;
//		// the own trip of the agent will be detected
//		int count = -1;
//		
...
//		public final Id id;
//		public final Id departureLinkId;
//		public final Id arrivalLinkId;
//
...
//			this.departureLinkId = departureId;
//			this.arrivalLinkId = arrivalId;
//		}
//	}
//
