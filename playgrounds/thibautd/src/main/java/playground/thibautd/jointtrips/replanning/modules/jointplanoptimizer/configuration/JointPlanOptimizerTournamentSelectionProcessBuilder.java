/* *********************************************************************** *
 * project: org.matsim.*
 * JointPlanOptimizerTournamentSelectionProcessBuilder.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
 ...
 * @author thibautd
 */
public class JointPlanOptimizerTournamentSelectionProcessBuilder implements JointPlanOptimizerProcessBuilder {
	private final JointReplanningConfigGroup configGroup;

	public JointPlanOptimizerTournamentSelectionProcessBuilder(
	...
	public NaturalSelector createNaturalSelector(
		...
		int tournamentSize = (int) Math.round(
