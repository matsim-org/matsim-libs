 ...
 * @author thibautd
 */
public class UglyHerbieMultilegControler {
	private static final Logger log = Logger.getLogger(UglyHerbieMultilegControler.class);
...
//		super( scenario );
//		herbieConfigGroup = (HerbieConfigGroup) getConfig().getModule(HerbieConfigGroup.GROUP_NAME);
