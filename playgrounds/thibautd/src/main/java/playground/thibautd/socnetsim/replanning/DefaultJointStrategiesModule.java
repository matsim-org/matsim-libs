...
import playground.thibautd.socnetsim.framework.replanning.removers.CoalitionMinSelectorFactory;
import playground.thibautd.socnetsim.framework.replanning.removers.LexicographicRemoverFactory;
import playground.thibautd.socnetsim.framework.replanning.removers.MinimumSumOfMinimumLossSelectorFactory;
import playground.thibautd.socnetsim.framework.replanning.removers.MinimumSumOfMinimumsSelectorFactory;
import playground.thibautd.socnetsim.framework.replanning.removers.MinimumSumSelectorFactory;
import playground.thibautd.socnetsim.framework.replanning.removers.MinimumWeightedSumSelectorFactory;
import playground.thibautd.socnetsim.framework.replanning.removers.ParetoMinSelectorFactory;
import playground.thibautd.socnetsim.framework.replanning.removers.WhoIsTheBossMinSelectorFactory;
