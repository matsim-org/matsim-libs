...
//	private static final String OUTPUT_DIR = "F:/OneDrive/Dokumente/Masterarbeit/MATSIM/output/Matsim/Berlin/100it/" ;
...
//	//Ende  Namesdefinition Berlin
	...
	private static final String OUTPUT_DIR = "F:/OneDrive/Dokumente/Masterarbeit/MATSIM/output/Matsim/Grid/2-Carrier/100it/" ;
	private static final String TEMP_DIR = "F:/OneDrive/Dokumente/Masterarbeit/MATSIM/output/Temp/" ;	
	...
	private static final String ALGORITHM_NAME = "grid-algorithm" ;
	private static final String TOLL_NAME = "grid_tollLink";
...
//		
		...
		CarrierPlanStrategyManagerFactory strategyManagerFactory  = createMyStrategyManager(scenario, ctrl) ;
		{
...
//				netBuilder.setRoadPricingCalculator(rpCalculator);
	...
	private static void configureTimeDependentNetwork(Scenario scenario) {
		//Ansatz von KN. Bringt jedoch Fehler "Link ... is not TimeDependent"
...
//			//Bringt keine Fehlermeldung mehr, hat aber auch keine inhaltliche Auswirkung...
//			NetworkChangeEventFactory cef = new NetworkChangeEventFactoryImpl() ;
//			TimeVariantLinkFactory tvl= new TimeVariantLinkFactory();
//			for ( Link link : scenario.getNetwork().getLinks().values() ) {
//				Link tdlink = tvl.createLink(link.getId(), link.getFromNode(), link.getToNode(), scenario.getNetwork(), link.getLength(), link.getFreespeed(), link.getCapacity(), link.getNumberOfLanes());
//				double speed = tdlink.getFreespeed() ;
//				final double threshold = 5./3.6;		//5km/h
//				if ( speed > threshold ) {
//					{
//						NetworkChangeEvent event = cef.createNetworkChangeEvent(0.*3600.) ;
//						event.setFreespeedChange(new ChangeValue( ChangeType.ABSOLUTE,  threshold/10 ));
//						event.addLink(tdlink);
//						((NetworkImpl)scenario.getNetwork()).addNetworkChangeEvent(event);
//					}
//					{
//						NetworkChangeEvent event = cef.createNetworkChangeEvent(24*3600.) ;
