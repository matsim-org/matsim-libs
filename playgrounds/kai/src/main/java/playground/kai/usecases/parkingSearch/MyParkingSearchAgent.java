 ...
 *
 */
final class MyParkingSearchAgent implements MobsimDriverAgent, MobsimPassengerAgent, HasPerson, PlanAgent {
	...
	public MyParkingSearchAgent(final Plan plan1, final Netsim simulation) {
