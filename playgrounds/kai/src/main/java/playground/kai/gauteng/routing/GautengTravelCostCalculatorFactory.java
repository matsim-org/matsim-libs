 ...
 *
 */
public class GautengTravelCostCalculatorFactory implements TravelCostCalculatorFactory {
	...
	public PersonalizableTravelCost createTravelCostCalculator(PersonalizableTravelTime timeCalculator, PlanCalcScoreConfigGroup cnScoringGroup) {
		return new GautengTravelCostCalculator(timeCalculator, cnScoringGroup);
	}
