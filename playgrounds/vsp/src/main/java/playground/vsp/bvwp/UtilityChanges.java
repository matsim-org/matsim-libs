	...
	final void computeAndPrintResults( Values economicValues, ScenarioForEvalData nullfall, ScenarioForEvalData planfall, Html html ) {
		...
		for ( Id id : nullfall.getAllRelations() ) { // for all OD relations
			...
			for ( DemandSegment demandSegment : DemandSegment.values() ) { // for all types (e.g. PV or GV)
				...
				ValuesForAUserType econValuesImprovedMode = economicValues.getByMode(improvedMode).getByDemandSegment(demandSegment) ;
				ValuesForAUserType attributesNullfallImprovedMode = nullfallForODRelation.getByMode(improvedMode).getByDemandSegment(demandSegment) ;
				ValuesForAUserType attributesPlanfallImprovedMode = planfallForODRelation.getByMode(improvedMode).getByDemandSegment(demandSegment) ;
				...
				for ( Mode mode : Mode.values() ) { // for all modes
					ValuesForAUserType econValues = economicValues.getByMode(mode).getByDemandSegment(demandSegment) ;
					ValuesForAUserType attributesNullfall = nullfallForODRelation.getByMode(mode).getByDemandSegment(demandSegment) ;
					ValuesForAUserType attributesPlanfall = planfallForODRelation.getByMode(mode).getByDemandSegment(demandSegment) ;
...
//		html.endHtml() ;
	...
	private double computeAndPrintGivingOrReceiving(double utils, ValuesForAUserType econValues,
			ValuesForAUserType attributesNullfall, ValuesForAUserType attributesPlanfall, final double deltaAmounts, Html html) {
	...
	private double computeAndPrintImplicitUtl(double utils,
			ValuesForAUserType econValuesImprovedMode, ValuesForAUserType attributesNullfallImprovedMode,
			ValuesForAUserType attributesPlanfallImprovedMode,
			ValuesForAUserType econValues,
			ValuesForAUserType attributesNullfall,
			ValuesForAUserType attributesPlanfall,
	...
	private double computeAndPrintValuesForAltnutzer(double utils,
			...
			ValuesForAUserType quantitiesPlanfall, double amountAltnutzer, Html html) {
