 ...
 *
 */
public class VehicleDeparturesAnalysis {

	private final Logger log = Logger.getLogger(VehicleDeparturesAnalysis.class);
	private final Level logLevel = Level.OFF;

	private final String planned = "planned";
	private final String realized = "realized";

	private TreeMap<Id, TreeMap<Id, StopId2RouteId2DelayAtStopData>> stopId2Route2DelayAtStopMap;


	public VehicleDeparturesAnalysis(StopId2RouteId2DelayAtStopHandler vehicleDelayHandler){
	...
	private Tuple<Double, Integer> getNextDepartureTime(Id stopId, double time, Id lineId, Id routeId, String type){
		...
		TreeMap<Id, StopId2RouteId2DelayAtStopData> possibleRoutes = this.stopId2Route2DelayAtStopMap.get(stopId);
		...
		for (StopId2RouteId2DelayAtStopData delayContainer : possibleRoutes.values()) {
