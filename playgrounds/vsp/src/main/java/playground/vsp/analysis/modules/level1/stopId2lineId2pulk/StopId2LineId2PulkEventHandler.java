 ...
 *
 */
public class StopId2LineId2PulkEventHandler implements TransitDriverStartsEventHandler, VehicleDepartsAtFacilityEventHandler{
	
	private final Logger log = Logger.getLogger(StopId2LineId2PulkEventHandler.class);
	...
	public StopId2LineId2PulkEventHandler(){
