 ...
 *
 */
public class VehId2DelayAtStopEventHandler implements VehicleDepartsAtFacilityEventHandler, TransitDriverStartsEventHandler{

	private final Logger log = Logger.getLogger(VehId2DelayAtStopEventHandler.class);
	...
	public VehId2DelayAtStopEventHandler(){
