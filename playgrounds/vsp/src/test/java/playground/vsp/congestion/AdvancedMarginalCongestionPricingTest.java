...
public class AdvancedMarginalCongestionPricingTest {
	...
	public final void test0a(){
		...
		ActivityImpl activity1 = PopulationUtils.createActivityFromLinkId("work", linkId);
		...
		ActivityImpl activity2 = PopulationUtils.createActivityFromLinkId("work", linkId);
		...
		ActivityImpl activity3 = PopulationUtils.createActivityFromLinkId("work", linkId);
		...
		ActivityImpl activity4 = PopulationUtils.createActivityFromLinkId("work", linkId);
	...
	public final void test0b(){
		...
		ActivityImpl activity1 = PopulationUtils.createActivityFromLinkId("overnightActivity", linkId);
		activity1.setEndTime(7 * 3600.);
		ActivityImpl activity2 = PopulationUtils.createActivityFromLinkId("overnightActivity", linkId);
	...
	public final void test0c(){
		...
		ActivityImpl activity1 = PopulationUtils.createActivityFromLinkId("firstActivityType", linkId);
		activity1.setEndTime(7 * 3600.);
		ActivityImpl activity2 = PopulationUtils.createActivityFromLinkId("lastActivityType", linkId);
		activity2.setStartTime(18 * 3600.);
