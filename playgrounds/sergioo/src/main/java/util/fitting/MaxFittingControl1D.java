...
public class MaxFittingControl1D extends FittingControl1D{

	//Constructors
	public MaxFittingControl1D(MatrixND<Double> controlConstants) {
	...
	protected void applyRule(MatrixND<Double> data, int[] position, int dimension) {
		...
		if(controlConstants.getElement(position)<sum) {
