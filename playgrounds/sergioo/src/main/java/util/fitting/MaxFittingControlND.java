...
public class MaxFittingControlND extends FittingControlND {

	//Constructors
	public MaxFittingControlND(MatrixND<Double> controlConstants) {
	...
	protected void applyRule(MatrixND<Double> data, int[] position, int[] dimensions) {
		...
		if(controlConstants.getElement(position)<sum[0] && !(controlConstants.getElement(position)==0 && sum[0]==0)) {
