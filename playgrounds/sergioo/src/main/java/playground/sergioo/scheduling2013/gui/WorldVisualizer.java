...
public class WorldVisualizer implements Visualizer {
	...
	public WorldVisualizer(VisualizersSet visualizersSet, PlaceSharer placeSharer, Map<Id<ActivityFacility>, ? extends ActivityFacility> facilities, Network network, double smallestTime) {
