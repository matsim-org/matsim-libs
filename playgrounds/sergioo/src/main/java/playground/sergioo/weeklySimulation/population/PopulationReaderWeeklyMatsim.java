 ...
 * @author balmermi
 */
public class PopulationReaderWeeklyMatsim extends MatsimXmlParser implements MatsimPopulationReader {
	...
	public void endTag(final String name, final String content, final Stack<String> context) {
		if (PERSON.equals(name)) {
			if (this.plans instanceof Population) {
				((Population) this.plans).addPerson(this.currperson);
			} else {
	...
	private void startAct(final Attributes atts) {
		...
		if (atts.getValue(ATTR_ACT_LINK) != null) {
			...
			this.curract = PopulationUtils.createActivityFromCoordAndLinkId(atts.getValue(ATTR_ACT_TYPE), coord, linkId);
