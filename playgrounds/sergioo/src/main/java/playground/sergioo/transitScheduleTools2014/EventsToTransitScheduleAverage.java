...
public class EventsToTransitScheduleAverage implements TransitDriverStartsEventHandler, VehicleDepartsAtFacilityEventHandler {
	...
	public EventsToTransitScheduleAverage(TransitSchedule transitSchedule, Vehicles vehicles) {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		EventsToTransitScheduleAverage eventsToTransitSchedule = new EventsToTransitScheduleAverage(scenario.getTransitSchedule(), ((MutableScenario)scenario).getTransitVehicles());
