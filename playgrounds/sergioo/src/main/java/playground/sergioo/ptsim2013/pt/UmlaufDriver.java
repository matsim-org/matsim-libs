...
public class UmlaufDriver extends AbstractTransitDriver {
	...
	public UmlaufDriver(Umlauf umlauf,
		...
		Person driverPerson = PopulationUtils.getDefaultFactory().createPerson(Id.createPersonId("pt_" + umlauf.getId())); // we use the non-wrapped route for efficiency, but the leg has to return the wrapped one.
