 ...
 * @author balmermi
 */
public class PopulationReaderMatsimPops extends MatsimXmlParser implements MatsimPopulationReader {
	...
	private final static String ATTR_PERSON_POP_ID = "pop_id";
	...
	private PersonImplPops currperson = null;
	...
	public PopulationReaderMatsimPops(final Scenario scenario) {
