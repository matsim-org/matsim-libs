...
public class CarAccessibility {
	...
	public static void main(String[] args) {
		...
		TravelDisutility disutilityFunction = (new TravelCostCalculatorFactoryImpl()).createTravelDisutility(travelTimeCalculator.getLinkTravelTimes(), scenario.getConfig().planCalcScore());
