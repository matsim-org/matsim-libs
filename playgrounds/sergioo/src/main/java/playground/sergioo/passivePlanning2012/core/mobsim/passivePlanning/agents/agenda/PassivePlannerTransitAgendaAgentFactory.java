...
public final class PassivePlannerTransitAgendaAgentFactory implements AgentFactory {
	...
	public MobsimDriverAgent createMobsimAgentFromPerson(final Person person) {
		PassivePlannerTransitAgent agent = new PassivePlannerTransitAgendaAgent((BasePerson)person, simulation, passivePlannerManager, personHouseholdMapping.getHousehold(person.getId()), modes); 
		return agent;
	}
