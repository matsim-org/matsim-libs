...
public class WeigthsNetworkPanel extends LayersPanel implements MouseListener, MouseMotionListener, MouseWheelListener, KeyListener {
	...
	//Methods
	public WeigthsNetworkPanel(WeigthsNetworkWindow window, NetworkPainter networkPainter, Map<Tuple<Id, Id>, Tuple<Boolean, Double>> ids, SortedMap<Id, MPAreaData> dataMPAreas, SortedMap<String, Coord> stopsBase) {
		super();
		this.window = window;
