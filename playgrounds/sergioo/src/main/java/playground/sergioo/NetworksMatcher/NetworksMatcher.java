...
public class NetworksMatcher {
	...
	public static void main(String[] args) {
		...
		LayersWindow windowHR = new DoubleNetworkMatchingWindow("Networks matching", new NetworkNodesPainter(networkHighResolution), new NetworkNodesPainter(networkLowResolutionLength));
...
public class NetworksMatcher {
	...
	public static void main(String[] args) {
		...
		matchingProcess.execute(networkHighResolution, networkLowResolutionLength);
		LayersWindow windowHR = new DoubleNetworkMatchingWindow(matchingProcess.getFinalMatchings(), "Networks matching", new NetworkNodesPainter(networkHighResolution), new NetworkNodesPainter(networkLowResolutionLength, Color.BLACK, Color.CYAN));
		windowHR.setVisible(true);
		while(!windowHR.isReadyToExit())
			try {
				Thread.sleep(100);
