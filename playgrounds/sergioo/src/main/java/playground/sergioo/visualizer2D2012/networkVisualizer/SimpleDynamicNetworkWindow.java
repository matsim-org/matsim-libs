...
public class SimpleDynamicNetworkWindow extends LayersWindow implements ActionListener {
	...
	//Methods
	public SimpleDynamicNetworkWindow(String title, Network network) {
		this(title, new DynamicNetworkPainter(network));
	}
	
	public SimpleDynamicNetworkWindow(String title, DynamicNetworkPainter networkPainter) {
		setTitle(title);
		setDefaultCloseOperation(HIDE_ON_CLOSE);
		this.setLocation(0,0);
		this.setLayout(new BorderLayout()); 
		layersPanels.put(PanelIds.ONE, new DynamicNetworkPanel(this, networkPainter));
