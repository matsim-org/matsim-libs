...
public class WeigthsNetworkWindow extends LayersWindow implements ActionListener {
	...
	//Methods
	public WeigthsNetworkWindow(String title, NetworkPainter networkPainter, Map<Tuple<Id<TransitStopFacility>, Id<ActivityFacility>>, Tuple<Boolean, Double>> ids, SortedMap<Id<ActivityFacility>, MPAreaData> dataMPAreas, SortedMap<String, Coord> stopsBase) {
		setTitle(title);
		setDefaultCloseOperation(HIDE_ON_CLOSE);
		this.setLocation(0,0);
		this.setLayout(new BorderLayout());
		layersPanels.put(PanelIds.ONE, new WeigthsNetworkPanel(this, networkPainter, ids, dataMPAreas, stopsBase));
