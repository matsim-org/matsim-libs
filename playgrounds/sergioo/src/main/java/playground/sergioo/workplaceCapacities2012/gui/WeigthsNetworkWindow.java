...
public class WeigthsNetworkWindow extends LayersWindow implements ActionListener {
	...
	//Methods
	public WeigthsNetworkWindow(String title, NetworkPainter networkPainter, Map<Tuple<Id, Id>, Tuple<Boolean, Double>> ids, SortedMap<Id, MPAreaData> dataMPAreas, SortedMap<String, Coord> stopsBase) {
		setTitle(title);
