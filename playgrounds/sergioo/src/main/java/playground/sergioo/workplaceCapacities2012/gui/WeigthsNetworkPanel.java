...
public class WeigthsNetworkPanel extends LayersPanel implements MouseListener, MouseMotionListener, MouseWheelListener, KeyListener {
	...
	//Methods
	public WeigthsNetworkPanel(WeigthsNetworkWindow window, NetworkPainter networkPainter, Map<Tuple<Id<TransitStopFacility>, Id<ActivityFacility>>, Tuple<Boolean, Double>> ids, SortedMap<Id<ActivityFacility>, MPAreaData> dataMPAreas, SortedMap<String, Coord> stopsBase) {
		super();
		this.window = window;
