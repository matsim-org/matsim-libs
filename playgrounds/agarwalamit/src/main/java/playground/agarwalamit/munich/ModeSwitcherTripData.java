...
public class ModeSwitcherTripData {

	public ModeSwitcherTripData() {
		modeSwitchInfo = new ModeSwitcherInfoCollector(modeSwitchTypes);
	}

	private Logger log = Logger.getLogger(ModeSwitcherTripData.class);
	...
	public static void main(String[] args) {
		...
		for(String runNr : runCases){
			ModeSwitcherTripData mstt = new ModeSwitcherTripData();
			mstt.run(dir+runNr);
