...
public class PatnaExternalDemandGenerator {
	...
	private final String networkFile = PatnaUtils.INPUT_FILES_DIR+"/simulationInputs/network/network_diff_linkSpeed.xml.gz";
	public static void main(String[] args) {
		new PatnaExternalDemandGenerator().run();
	}

	private void run(){
		String outPlansFile = PatnaUtils.INPUT_FILES_DIR+"/simulationInputs/external/shpNetwork/outerCordonDemand_10pct.xml.gz";
