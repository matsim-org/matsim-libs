...
public class JointCountsGenerator {
	...
	private static final String urbanCountFile = PatnaUtils.INPUT_FILES_DIR+"/simulationInputs/urban/"+PatnaUtils.PATNA_NETWORK_TYPE.toString()+"/urbanCounts_excl_rckw_shpNetwork.xml.gz";
