...
public class EquilEmissionTest {
	...
	public void emissionTollTest () {
		...
		final playground.agarwalamit.emissions.EmissionModalTravelDisutilityCalculatorFactory emissionTducf = new playground.agarwalamit.emissions.EmissionModalTravelDisutilityCalculatorFactory(emissionModule, emissionCostModule, sc.getConfig().planCalcScore());
