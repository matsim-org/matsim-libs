...
public class FlowFundamentalDiagramOTF implements LinkLeaveEventHandler, LinkEnterEventHandler{
	...
	public FlowFundamentalDiagramOTF(Scenario sc, Id linkId){
		this.scenario = sc;
		this.linkId = linkId;
	...
	public void saveAsPng(String dir){
		...
		XYLineChart chart = new XYLineChart("Fundamental diagram", "velocity m/s", "flow p/s");
		...
		chart.saveAsPng(dir + "/fndflow.png", 800, 400);
	}
