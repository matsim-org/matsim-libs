...
//how it does what I guess/know it does.
...
//Config file (already done in my object creation)
...
//a handler that analyzes legs and calculates average speed for each mode from that analysis
//these speeds are written in the .txt by the PrintStram at the end of the qsim run.
...
//Modified QSim used. This is done in my createModifiedQSim() method
