 ...
 * @author mrieser
 */
public class CsvBatchReformatter implements VehicleTrajectoryHandler, Closeable {
	
	private final ZoneIdToIndexMapping mapping;
	private final BufferedWriter writer;
	
	public CsvBatchReformatter(final ZoneIdToIndexMapping mapping, String filename) {
	...
	public static void main(String[] args) throws IOException {
		...
		//String runs="abcdefghijklmnopqrstuvwxyz";
		String runs="01020304050607080910111213141516171819202122232425";
		//for(int i = 0; i<runs.length();i=i+2){
		for(int i=0;i<1;i++){
			//String runDirName="C:/Users/jeremy/SVI Dosierung/KreuzlingenNetzSzen3/Marcel20130507/mitDosierung_it.100/it.100/SensitivityTest"+runs.charAt(i)+runs.charAt(i+1);
			...
			String csvTrajFilename=runDirName+"/100.vehTrajectories.csv";
		...
		CsvBatchReformatter csv = new CsvBatchReformatter(zoneMapping, csvTrajFilename);
