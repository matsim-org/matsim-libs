...
public class IAActivitiesFilter {
	...
	public static void main(String[] args) throws IOException {
		BufferedReader reader = IOUtils.getBufferedReader("/data/vis/zrh25pct/ia/agentactivity.txt.gz");
		BufferedWriter writer = IOUtils.getBufferedWriter("/data/vis/zrh25pct/ia/agentactivity_zrh.txt");
...
//		double endLimit = 8.0 * 3600;
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				double x1 = Double.parseDouble(parts[4]);
				double y1 = Double.parseDouble(parts[5]);
