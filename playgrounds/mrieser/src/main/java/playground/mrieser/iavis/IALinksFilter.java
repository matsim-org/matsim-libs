...
public class IALinksFilter {
	...
	public static void main(String[] args) throws IOException {
		BufferedReader reader = IOUtils.getBufferedReader("/data/vis/zrh25pct/ia/links.txt.gz");
		BufferedWriter writer = IOUtils.getBufferedWriter("/data/vis/zrh25pct/ia/links_zrh.txt");
