...
//        throw new RuntimeException("Knowledges are no more.");
//
//        knowledges.getKnowledgesByPersonId().putAll(result1.getKnowledgesByPersonId());
//        Knowledges result;
//        throw new RuntimeException("Knowledges are no more.");
//
//        knowledges.getKnowledgesByPersonId().putAll(result.getKnowledgesByPersonId());
//
//		// merge population
...
//		new PopulationWriter(population, censusScenario.getNetwork()).write(outPopulationFile);
//		log.info("done.");
//
