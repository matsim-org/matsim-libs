...
public class CurrentLegToSecureFacilityReplannerFactory extends WithinDayDuringLegReplannerFactory {
	...
	public CurrentLegToSecureFacilityReplannerFactory(Scenario scenario, AbstractMultithreadedModule abstractMultithreadedModule, double replanningProbability) {
