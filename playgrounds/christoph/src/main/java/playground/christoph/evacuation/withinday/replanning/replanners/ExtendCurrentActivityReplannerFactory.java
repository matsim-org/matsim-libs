...
public class ExtendCurrentActivityReplannerFactory extends WithinDayDuringActivityReplannerFactory {
	...
	public ExtendCurrentActivityReplannerFactory(Scenario scenario, AgentCounterI agentCounter, AbstractMultithreadedModule abstractMultithreadedModule, double replanningProbability) {
	...
	public WithinDayDuringActivityReplanner createReplanner() {
		WithinDayDuringActivityReplanner replanner = new ExtendCurrentActivityReplanner(super.getId(), scenario);
