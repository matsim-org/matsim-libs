...
public class InsecureActivityPerformingIdentifiers  extends DuringActivityIdentifier {

	private static final Logger log = Logger.getLogger(InsecureActivityPerformingIdentifiers.class);
	
	protected ActivityReplanningMap activityReplanningMap;
	protected Coord centerCoord;
	protected double secureDistance;
	
	public InsecureActivityPerformingIdentifiers(Controler controler, Coord centerCoord, double secureDistance) {
	...
	// Only for Cloning.
	public InsecureActivityPerformingIdentifiers(ActivityReplanningMap activityReplanningMap, Coord centerCoord, double secureDistance) {
	...
	public InsecureActivityPerformingIdentifiers clone() {
		/*
		 *  We don't want to clone the ActivityReplanningMap. Instead we
		 *  reuse the existing one.
		 */
		InsecureActivityPerformingIdentifiers clone = new InsecureActivityPerformingIdentifiers(this.activityReplanningMap, this.centerCoord, this.secureDistance);
