...
public class ParkingReplannerFactory extends WithinDayDuringLegReplannerFactory {

	private Scenario scenario;
	
	public ParkingReplannerFactory(Scenario scenario, WithinDayEngine replanningManager,
