 ...
 * for pt counts.
 */
class CadytsCountsComparisonAlgorithm {
	/**
	 * The StopAttributes of the simulation
	 */
	private final CadytsOccupancyAnalyzer oa;
	/**
	 * The counts object
	 */
	Counts counts;
	...
	final static Logger log = Logger.getLogger(CadytsCountsComparisonAlgorithm.class);

	StringBuffer content = new StringBuffer();

	CadytsCountsComparisonAlgorithm(final CadytsOccupancyAnalyzer oa, final Counts counts, final Network network, final double countsScaleFactor) {
		this.oa = oa;
		this.counts = counts;
