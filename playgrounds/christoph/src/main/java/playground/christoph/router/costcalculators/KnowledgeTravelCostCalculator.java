...
public class KnowledgeTravelCostCalculator implements TravelDisutility {
	...
	public KnowledgeTravelCostCalculator(TravelTime timeCalculator, PlanCalcScoreConfigGroup config) {
