...
public class FlexibleCellSimEngineRunner extends FlexibleCellSimEngine implements Runnable {
	...
	private final FlexibleCellSimEngine simEngine;
	
	/*package*/ FlexibleCellSimEngineRunner(CyclicBarrier startBarrier, CyclicBarrier separationBarrier, 
			CyclicBarrier endBarrier, Netsim sim, FlexibleCellSimEngine simEngine) {
		super(sim);
	...
	/*package*/ FlexibleCellNode getFlexibleCellNode(Id nodeId) {
		return simEngine.getFlexibleCellNode(nodeId);
	}
	...
	/*package*/ FlexibleCellLink getFlexibleCellLink(Id linkId) {
		return simEngine.getFlexibleCellLink(linkId);
	}
}
