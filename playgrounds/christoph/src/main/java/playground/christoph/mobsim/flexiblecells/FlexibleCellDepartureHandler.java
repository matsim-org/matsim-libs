...
public class FlexibleCellDepartureHandler implements DepartureHandler {

	private FlexibleCellSimEngine simEngine;
	private Set<String> handledModes = new HashSet<String>();
	
	public FlexibleCellDepartureHandler(FlexibleCellSimEngine simEngine, Set<String> handledModes) {
	...
	private void handleMultiModalDeparture(double now, MobsimDriverAgent personAgent, Id linkId) {
		...
		FlexibleCellLink extension = simEngine.getFlexibleCellLink(linkId);
