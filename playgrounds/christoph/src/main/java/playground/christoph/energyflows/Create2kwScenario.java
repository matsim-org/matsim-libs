...
//
//        RelocateActivities relocateActivities = new RelocateActivities(zurichFacilities, scenario.getActivityFacilities(), result);
...
//		new PopulationWriter(scenario.getPopulation(), scenario.getNetwork()).write(populationOutFile);
//		log.info("...done.");
//	}
//}
