 ...
 * @author cdobler
 */
public class MultiNodeDijkstraTest extends MatsimTestCase {

	private final static Logger log = Logger.getLogger(MultiNodeDijkstraTest.class);

	private MyMultiNodeDijkstra makeMultiNodeDikstra(Network network, TravelDisutility travelDisutility, TravelTime travelTime) {	
		return (MyMultiNodeDijkstra) new MyFastDijkstraFactory().createPathCalculator(network, travelDisutility, travelTime);
	}
	...
	public void testMultipleStarts() {
		...
		MyMultiNodeDijkstra dijkstra = makeMultiNodeDikstra(f.network, tc, tc);
