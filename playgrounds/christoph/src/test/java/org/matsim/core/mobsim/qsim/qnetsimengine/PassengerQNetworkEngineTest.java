...
public class PassengerQNetworkEngineTest extends MatsimTestCase {
	...
	public void testInvalidDepartureWrongLink() {
		...
		jointDepartureOrganizer.createJointDeparture(new IdImpl("jd1"), new IdImpl("1to2"), new IdImpl("v1"), new IdImpl("p1"), passengerIds);
	...
	public void testOnlyDriver() {
		...
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p1")));
	}
	...
	public void testDriverAndPassenger1() {
		...
		makeNetwork(scenario.getNetwork());
		makeNonStopDriver(new IdImpl("p1"), new IdImpl("v1"), scenario.getPopulation(), scenario.getNetwork(), 3600.0);
		makeNonStopPassenger(new IdImpl("p2"), scenario.getPopulation(), scenario.getNetwork(), 3660.0);
		...
		// check whether all scheduled joint departures have been processed
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p1")));
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p2")));
	}
	...
	public void testDriverAndPassenger2() {
		...
		makeNetwork(scenario.getNetwork());
		makeNonStopDriver(new IdImpl("p1"), new IdImpl("v1"), scenario.getPopulation(), scenario.getNetwork(), 3660.0);
	...
	public void testPickup1() {
		...
		makeNetwork(scenario.getNetwork());
		makeDropOffPickupDriver(new IdImpl("p1"), scenario.getPopulation(), scenario.getNetwork(), 3600.0, 3650.0);
		makePickUpPassenger(new IdImpl("p2"), scenario.getPopulation(), scenario.getNetwork(), 3700.0);
		...
		passengerIds.add(new IdImpl("p2"));
		jointDepartureOrganizer.createJointDeparture(new IdImpl("jd2"), new IdImpl("1to2"), new IdImpl("v1"), new IdImpl("p1"), passengerIds);
	...
	public void testPickup2() {
		...
		makeNetwork(scenario.getNetwork());
		makeDropOffPickupDriver(new IdImpl("p1"), scenario.getPopulation(), scenario.getNetwork(), 3600.0, 3700.0);
		makePickUpPassenger(new IdImpl("p2"), scenario.getPopulation(), scenario.getNetwork(), 3650.0);
	...
	/*
	 * Driver, one passenger and and one picked up passenger
	 * Driver reaches pickup location before passenger
	 */
	public void testPickup3() {
		...
		makeDropOffPickupDriver(new IdImpl("p1"), scenario.getPopulation(), scenario.getNetwork(), 3600.0, 3650.0);
		makeNonStopPassenger(new IdImpl("p2"), scenario.getPopulation(), scenario.getNetwork(), 3600.0);
		makePickUpPassenger(new IdImpl("p3"), scenario.getPopulation(), scenario.getNetwork(), 3700.0);
		...
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p1")));
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p2")));
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p3")));
	}
	...
	public void testDropOff() {
		...
		makeNetwork(scenario.getNetwork());
		makeDropOffPickupDriver(new IdImpl("p1"), scenario.getPopulation(), scenario.getNetwork(), 3600.0, 3650.0);
		makeDropOffPassenger(new IdImpl("p2"), scenario.getPopulation(), scenario.getNetwork(), 3600.0);
	...
	public void testOverall() {
		...
		makeNetwork(scenario.getNetwork());
		makeDemand(scenario.getPopulation(), scenario.getNetwork());
		...
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p2")));
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p3")));
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p4")));
		assertEquals(null, peekJointDeparture(jointDepartureOrganizer, new IdImpl("p5")));
	}
	...
	public void testDriverSwitch() {
		...
		makeNetwork(scenario.getNetwork());
		makeDriverA(new IdImpl("p1"), scenario.getPopulation(), scenario.getNetwork(), 3600.0);
		makeDriverB(new IdImpl("p2"), scenario.getPopulation(), scenario.getNetwork(), 3600.0);
		...
		passengerIds = new ArrayList<Id>();
		jointDepartureOrganizer.createJointDeparture(new IdImpl("jd2"), new IdImpl("1to2"), new IdImpl("v1"), new IdImpl("p2"), passengerIds);
	...
	public void testDriverSwitchAndEarlierPickup() {
		...
		makeNetwork(scenario.getNetwork());
		makeDriverA(new IdImpl("p1"), scenario.getPopulation(), scenario.getNetwork(), 3650.0);
		makeDriverB(new IdImpl("p2"), scenario.getPopulation(), scenario.getNetwork(), 3650.0);
		makePickUpPassenger(new IdImpl("p3"), scenario.getPopulation(), scenario.getNetwork(), 3600.0);
	...
	public void testDriverSwitchAndBetweenPickup() {
		...
		makeNetwork(scenario.getNetwork());
		makeDriverA(new IdImpl("p1"), scenario.getPopulation(), scenario.getNetwork(), 3600.0);
		makeDriverB(new IdImpl("p2"), scenario.getPopulation(), scenario.getNetwork(), 3700.0);
		makePickUpPassenger(new IdImpl("p3"), scenario.getPopulation(), scenario.getNetwork(), 3650.0);
	...
	public void testJointAndNonJointDeparture() {
		...
		makeNetwork(scenario.getNetwork());
		makeNonStopDriver(new IdImpl("p1"), new IdImpl("v1"), scenario.getPopulation(), scenario.getNetwork(), 3600.0);
		makeNonStopDriver(new IdImpl("p2"), new IdImpl("v2"), scenario.getPopulation(), scenario.getNetwork(), 3600.0);
	...
	private JointDeparture peekJointDeparture(JointDepartureOrganizer jointDepartureOrganizer, Id agentId) {
		List<JointDeparture> jointDepartures = jointDepartureOrganizer.scheduledDepartures.get(agentId);
		if (jointDepartures == null || jointDepartures.size() == 0) return null;
		else return jointDepartures.get(0);
	}
	...
	private static void makeDemand(Population population, Network network) {
		makeDropOffPickupDriver(new IdImpl("p1"), population, network, 3600.0, 3700.0);
		makeNonStopPassenger(new IdImpl("p2"), population, network, 3600.0);
		makeNonStopPassenger(new IdImpl("p3"), population, network, 3600.0);
		makeDropOffPassenger(new IdImpl("p4"), population, network, 3600.0);
		makePickUpPassenger(new IdImpl("p5"), population, network, 3780.0);
	}

	private static void makeNonStopDriver(Id id, Id vehicleId, Population population, Network network, double activityEndTime) {
	...
	private static void makeDriverA(Id id, Population population, Network network, double activityEndTime) {
		Person person = population.getFactory().createPerson(id);
	...
	private static void makeDriverB(Id id, Population population, Network network, double activityEndTime) {
		Person person = population.getFactory().createPerson(id);
	...
	private static void makeDropOffPickupDriver(Id id, Population population, Network network, double activityEndTime, double stopEndTime) {
		Person person = population.getFactory().createPerson(id);
	...
	private static void makeNonStopPassenger(Id id, Population population, Network network, double activityEndTime) {
		Person person = population.getFactory().createPerson(id);
	...
	private static void makeDropOffPassenger(Id id, Population population, Network network, double departureTime) {
		Person person = population.getFactory().createPerson(id);
	...
	private static void makePickUpPassenger(Id id, Population population, Network network, double activityEndTime) {
		Person person = population.getFactory().createPerson(id);
