...
public class BusCorridorPersonLeavesVehicleEventHandler implements PersonLeavesVehicleEventHandler{
	
	Scenario scenario;
	
	public BusCorridorPersonLeavesVehicleEventHandler(Scenario scenario) {
	...
	public void handleEvent(PersonLeavesVehicleEvent event) {
		System.out.println(" *** "+getDayTime(event.getTime())+" Uhr: Person "+event.getPersonId()+ " steigt aus dem "+event.getVehicleId()+" aus.");
	}
