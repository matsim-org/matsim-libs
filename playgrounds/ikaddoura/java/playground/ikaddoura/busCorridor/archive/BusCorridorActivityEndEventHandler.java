...
public class BusCorridorActivityEndEventHandler implements ActivityEndEventHandler{
	
	Scenario scenario;
	
	public BusCorridorActivityEndEventHandler(Scenario scenario) {
	...
	public void handleEvent(ActivityEndEvent event) {
		System.out.println(getDayTime(event.getTime())+" Uhr: Person "+event.getPersonId()+" beendet die Aktivität "+event.getActType()+" am Link "+event.getLinkId()+".");
	}
