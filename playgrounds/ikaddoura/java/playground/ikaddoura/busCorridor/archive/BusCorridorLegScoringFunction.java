 ...
 */
public class BusCorridorLegScoringFunction implements LegScoring, BasicScoring {

	private final static Logger log = Logger.getLogger(BusCorridorLegScoringFunction.class);
	...
	public BusCorridorLegScoringFunction(final Plan plan, final CharyparNagelScoringParameters params) {
		this.params = params;
		this.reset();
