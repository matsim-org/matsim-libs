...
public class NoiseTest {
	...
	public final void test1(){
		...
		NoiseContext noiseSpatialInfo = new NoiseContext(scenario, new NoiseParameters());
	...
	public final void test2(){
		...
		Assert.assertEquals("wrong agent units per receiver point and time interval", null , noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("0", ReceiverPoint.class)).getTimeInterval2affectedAgentUnits().get(12 * 3600.));
		// between 9 and 10 two agents are at receiver point 0
		Assert.assertEquals("wrong agent units per receiver point and time interval", 2. , noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("0", ReceiverPoint.class)).getTimeInterval2affectedAgentUnits().get(10 * 3600.), MatsimTestUtils.EPSILON);
		// between 5 and 6 there is one agent at receiver point 16
		Assert.assertEquals("wrong agent units per receiver point and time interval", 1. , noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2affectedAgentUnits().get(6 * 3600.), MatsimTestUtils.EPSILON);
		...
		Assert.assertEquals("wrong agent units per receiver point and time interval", affectedAgentUnits, noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("0", ReceiverPoint.class)).getTimeInterval2affectedAgentUnits().get(11 * 3600.), MatsimTestUtils.EPSILON);
		...
		Assert.assertEquals("wrong immission at receiver point 16", 0., noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2immission().get(10 * 3600.), MatsimTestUtils.EPSILON);
		Assert.assertEquals("wrong immission at receiver point 16", 0., noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2immission().get(12 * 3600.), MatsimTestUtils.EPSILON);
		...
		Assert.assertEquals("wrong distance between receiver point Id '16' and link Id 'linkA5'", correctionTermDs, noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getLinkId2distanceCorrection().get(Id.create("linkA5", Link.class)), 0.0000001); 
		
		double correctionTermAngle = 10 * Math.log10((80.6271289) / (180));
		Assert.assertEquals("wrong angle correction for receiver point Id '16' and link Id 'linkA5'", correctionTermAngle, noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getLinkId2angleCorrection().get(Id.create("linkA5", Link.class)), 0.0000001);
		...
		Assert.assertEquals("wrong immission at receiver point 16", immissionFromLinkA5, noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2LinkId2IsolatedImmission().get(11 * 3600.).get(Id.create("linkA5", Link.class)), 0.0000001);
		Assert.assertEquals("wrong immission at receiver point 16", 0., noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2LinkId2IsolatedImmission().get(11 * 3600.).get(Id.create("linkB5", Link.class)), MatsimTestUtils.EPSILON);
		...
		double immissionRP16 = 10 * Math.log10((
				Math.pow(10,(0.1 * noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2LinkId2IsolatedImmission().get(11 * 3600.).get(Id.create("linkA5", Link.class))))
						+ (Math.pow(10,(0.1 * noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2LinkId2IsolatedImmission().get(11 * 3600.).get(Id.create("link2", Link.class)))))
				));		
		Assert.assertEquals("wrong immission at receiver point 16", immissionRP16, noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2immission().get(11 * 3600.), MatsimTestUtils.EPSILON);
		...
		double laermEinwohnerGleichwert = lautheitsgewicht * noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2affectedAgentUnits().get(11 * 3600.);
		...
		Assert.assertEquals("wrong damage costs", damageCostsRP16, noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2damageCosts().get(11 * 3600.), MatsimTestUtils.EPSILON);
		Assert.assertEquals("wrong damage costs", 0., noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("0", ReceiverPoint.class)).getTimeInterval2damageCosts().get(11 * 3600.), MatsimTestUtils.EPSILON);
		Assert.assertEquals("wrong damage costs", 0., noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2damageCosts().get(12 * 3600.), MatsimTestUtils.EPSILON);
		Assert.assertEquals("wrong damage costs", 0., noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2damageCosts().get(10 * 3600.), MatsimTestUtils.EPSILON);
		...
		Assert.assertEquals("wrong damage cost per affected agent unit", damageCostsPerAffectedAgentUnitRP16, noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2damageCostPerAffectedAgentUnit().get(11 * 3600.), MatsimTestUtils.EPSILON);
		...
		// link2
		Assert.assertEquals("wrong allocation of total damage cost at the receiver point to links", Math.pow(((Math.pow(10, (0.05 * noiseControlerListener.getNoiseContext().getReceiverPoints().get(Id.create("16", ReceiverPoint.class)).getTimeInterval2LinkId2IsolatedImmission().get(11 * 3600.).get(Id.create("link2", Link.class))))) / (Math.pow(10, (0.05 * immissionRP16)))), 2)  * damageCostsRP16, noiseControlerListener.getNoiseDamageCosts().getLinkId2timeInterval2damageCost().get(Id.create("link2", Link.class)).get(11 * 3600.), MatsimTestUtils.EPSILON);
