...
public class ExternalControler {
	...
	private int numberOfBuses = 5; // at least one bus! for first iteration!
	private double fare = -1.3; // for first iteration
...
//			this.setNumberOfBuses(operator.increaseNumberOfBuses());
			this.setFare(operator.increaseFare(this.getFare(), -0.2));
		...
		chartWriter.writeLineChartScoresOperator(outputExternalIterationDirPath, iteration2numberOfBuses, iteration2operatorProfit, iteration2operatorCosts, iteration2operatorEarnings);
	}
