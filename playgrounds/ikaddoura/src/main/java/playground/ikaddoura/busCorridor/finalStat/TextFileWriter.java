...
public class TextFileWriter {
	...
	public void writeFile(String outputExternalIterationDirPath, Map<Integer, Double> iteration2numberOfBuses, Map<Integer, Double> iteration2fare, Map<Integer, Double> iteration2capacity, Map<Integer, Double> iteration2operatorCosts, Map<Integer, Double> iteration2operatorEarnings, Map<Integer, Double> iteration2operatorProfit, Map<Integer, Double> iteration2userScore, Map<Integer, Double> iteration2userScoreSum, Map<Integer, Double> iteration2totalScore, Map<Integer, Integer> iteration2numberOfCarLegs, Map<Integer, Integer> iteration2numberOfPtLegs, Map<Integer, Integer> iteration2numberOfWalkLegs){
	    ...
	    String zeile1 = "ITERATION ; NumberOfBuses ; fare ; capacity ; OperatorCosts (AUD) ; OperatorEarnings (AUD); OperatorProfit (AUD) ; UserScore (avg. executed) ; UserScore (Sum) ; TotalScore ; CarLegs ; PtLegs ; WalkLegs";
	    bw.write(zeile1);
	    bw.newLine();
	    ...
	    for (Integer iteration : iteration2numberOfBuses.keySet()){
	    	...
	    	String zeile = iteration+ " ; "+numberOfBuses+" ; "+fare+" ; "+capacity+" ; "+costs+ " ; "+earnings+" ; "+operatorProfit+" ; "+userScore+" ; "+userScoreSum+" ; "+totalScore+" ; "+carLegs+" ; "+ptLegs+" ; "+walkLegs;
