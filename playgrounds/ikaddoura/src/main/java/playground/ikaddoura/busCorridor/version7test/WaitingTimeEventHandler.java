 ...
 *
 */
public class WaitingTimeEventHandler implements PersonEntersVehicleEventHandler, AgentDepartureEventHandler, AgentArrivalEventHandler{
	Map <Id, Double> personId2WaitingTime = new HashMap<Id, Double>();
	Map <Id, Double> personId2PersonEntersVehicleTime = new HashMap<Id, Double>();
	Map <Id, Double> personId2AgentDepartureTime = new HashMap<Id, Double>();
	Map <Id, Double> personId2InVehicleTime = new HashMap<Id, Double>();


	public WaitingTimeEventHandler() {
	}
	...
	public void handleEvent(PersonEntersVehicleEvent event) {
		if (event.getPersonId().toString().contains("person") && event.getVehicleId().toString().contains("bus")){
			...
			System.out.println("Person Id: "+event.getPersonId()+ " - WaitingTime: "+waitingTime);
		}
		else {
