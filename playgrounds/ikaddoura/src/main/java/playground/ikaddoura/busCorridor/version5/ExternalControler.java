...
public class ExternalControler {
	...
	static String networkFile = "../../shared-svn/studies/ihab/busCorridor/input_version5/network.xml";
	static String configFile = "../../shared-svn/studies/ihab/busCorridor/input_version5/config_busline.xml";
	static String populationFile = "../../shared-svn/studies/ihab/busCorridor/input_version5/population.xml"; // for first iteration
	static String outputExternalIterationDirPath = "../../shared-svn/studies/ihab/busCorridor/output_version5";
