...
public class ExternalControler {
	...
	private void externalIteration() throws IOException {
		...
		for (int extIt = 0; extIt <= numberOfExternalIterations ; extIt++){
			...
			InternalControler internalControler = new InternalControler(configFile, this.extItNr, this.getDirectoryExtIt(), lastInternalIteration, populationFile, outputExternalIterationDirPath, this.getNumberOfBuses(), networkFile);
			...
			// set number of Buses for next external iteration
