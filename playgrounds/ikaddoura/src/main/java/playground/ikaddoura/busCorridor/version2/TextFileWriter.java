...
public class TextFileWriter {
	...
	public void writeFile(String outputDirectoryPath, Map<Integer, Integer> iteration2numberOfBuses, Map<Integer, Double> iteration2providerScore, Map<Integer, Double> iteration2userScore){
		File file = new File(outputDirectoryPath+"/busNumberScoreStats.txt");
