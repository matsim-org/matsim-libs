...
public class CreatePopulation implements Runnable {
	...
	private Coord blur(String zone) {
		...
		double xCoord = zoneGeometries.get(zone).getX()+rnd.nextDouble()*500-rnd.nextDouble()*500;
		double yCoord = zoneGeometries.get(zone).getY()+rnd.nextDouble()*500-rnd.nextDouble()*500;
