...
public class Operator {
	...
	private final double COSTS_PER_VEH_DAY = 126; // anzupassen in Abh. von der Kapazität / Fahrzeugart!!!
	private final double COSTS_PER_VEH_KM = 0.9; // anzupassen in Abh. von Kapazität / Fahrzeugart!!!
...
//		double routeLength = getRouteLength(network);
		...
		this.costs = ((numberOfBuses * COSTS_PER_VEH_DAY) + (vehicleKm * COSTS_PER_VEH_KM) + (vehicleHours * COSTS_PER_VEH_HOUR)) * OVERHEAD_PERCENTAGE;
