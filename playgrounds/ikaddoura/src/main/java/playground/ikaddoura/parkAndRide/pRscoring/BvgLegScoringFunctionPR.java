 ...
 *
 */
public class BvgLegScoringFunctionPR implements LegScoring, BasicScoring {

	private final static Logger log = Logger.getLogger(BvgLegScoringFunctionPR.class);
	...
	protected final BvgScoringFunctionParametersPR bvgParameters;
	protected final Double utilityOfLineSwitch;

	public BvgLegScoringFunctionPR(final Plan plan, final CharyparNagelScoringParameters charyparNagelParameters, final BvgScoringFunctionParametersPR bvgParameters, Double utilityOfLineSwitch, Network network) {
