	...
	public void handlePlan(Plan plan) {
			...
			if (hasHomeActivity == true && hasWorkActivity == true) {
				log.info("Plan contains Home and Work Activity. Proceeding...");
					...
					log.info("Home-Work-Home sequence contains a ParkAndRide Activity. Removing the ParkAndRide activities and randomly choose a leg mode for the remaining leg.");
