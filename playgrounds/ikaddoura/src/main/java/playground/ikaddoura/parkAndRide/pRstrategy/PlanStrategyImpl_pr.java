 ...
 * Only modifying plans if person has a P+R activity.
 *
 * @author mrieser, modified by ikaddoura
 * @see org.matsim.core.replanning
 */
public final class PlanStrategyImpl_pr implements PlanStrategy {
	...
	private final static Logger log = Logger.getLogger(PlanStrategyImpl_pr.class);
	 ...
	 * @param planSelector
	 */
	public PlanStrategyImpl_pr(final PlanSelector planSelector) {
	...
	public void run(final Person person) {
		...
		// checks if person has a P+R activity
		...
		// if person has a P+R activity proceed with strategy modules...
		if (hasPrAct){
			this.counter++;
