 ...
 *
 */
public final class ExternalEffectInVehicleTimeEvent extends Event implements HasPersonId {
	
	public static final String EVENT_TYPE = "ExternalEffectInVehicleTime";
	...
	public ExternalEffectInVehicleTimeEvent(Id personId, Id vehicleId, double time, int delayedPassengers, double externalDelay, boolean isFirstTransfer) {
		super(time);
