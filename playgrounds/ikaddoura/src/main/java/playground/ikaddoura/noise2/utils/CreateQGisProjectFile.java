...
//		String workingDirectory =  "/Users/ihab/Documents/workspace/runs-svn/berlin_internalization_noise/analysis/";
//		String qGisProjectFile = "damages" + time + ".qgs";
//		
...
//				
//		VectorLayer noiseLayer = new VectorLayer("noise", workingDirectory + "1a_Internalization_damages_receiverPoint.csv", QGisConstants.geometryType.Point);
//		noiseLayer.setDelimiter(";");
//		noiseLayer.setXField("x");
//		noiseLayer.setYField("y");
//		
//		NoiseRenderer renderer = new NoiseRenderer(noiseLayer);
//		renderer.setRenderingAttribute("damages_receiverPoint_" + time);
//		
