...
public class CreatePopulation_opt3 implements Runnable {
	...
	static String networkFile = "/Users/Ihab/Documents/workspace/shared-svn/studies/ihab/opt3/input_opt3/network_opt3.xml";
	private Map<String, Coord> zoneGeometries = new HashMap<String, Coord>();
	private Scenario scenario;
	private Population population;

	public static void main(String[] args) {
		CreatePopulation_opt3 population = new CreatePopulation_opt3();
		population.run();
	}
