...
public class TestRunLocationChoice {
	...
	public void prepareTests() {
		...
		config.setParam("controler", "outputDirectory", utils.getOutputDirectory() + "output/");
			// Activate transit
		config.setParam("transit", "useTransit", "false");
			// Set files
	...
	private void createPrefs(Scenario tempScenario, String pathToPrefsFile) {
	...
	private void createFacilities(Scenario tempScenario, String pathToFacilitiesFile) {
		int facilityId = 0;
