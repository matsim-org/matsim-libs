	...
	public void prepare() {
		...
		this.defaultNetworkMapper = new AbstractNetworkMapper() {
			...
			protected Network providePreparedNetwork(String path2Network, String path2VissimZoneShp) {
				...
				network.addNode(networkFactory.createNode(Id.create(1, Node.class), new CoordImpl(10, 30)));
				network.addNode(networkFactory.createNode(Id.create(2, Node.class), new CoordImpl(110, 130)));
