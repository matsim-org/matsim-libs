...
public class TestPTMapperBusAndTram {
	...
	public void prepareTests() {
		...
		TransitScheduleReaderV1 reader = new TransitScheduleReaderV1(this.schedule, new RouteFactoriesRegister());
	...
	public void testCreateAdditionalLinks() {
		...
		TransitScheduleReaderV1 reader = new TransitScheduleReaderV1(transitSchedule, new RouteFactoriesRegister());
