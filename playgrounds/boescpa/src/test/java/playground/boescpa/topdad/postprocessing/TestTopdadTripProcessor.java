...
public class TestTopdadTripProcessor {
	...
	public void testTripProcessing() {
		...
		Assert.assertEquals("Test: TripProcessing.analyzeTrips - pt mode distance sum not as expected.", 963017.0, pt[1], 0);
		...
		Assert.assertEquals("Test: TripProcessing.analyzeTrips - transit_walk mode distance sum not as expected.", 430244.0, transit_walk[1], 0);
