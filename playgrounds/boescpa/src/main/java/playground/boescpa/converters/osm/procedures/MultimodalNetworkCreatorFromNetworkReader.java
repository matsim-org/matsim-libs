 ...
 * @author boescpa
 */
public class MultimodalNetworkCreatorFromNetworkReader extends MultimodalNetworkCreator {

	public MultimodalNetworkCreatorFromNetworkReader(Network network) {
		super(network);
	}
