...
import playground.boescpa.converters.vissim.tools.RouteConverter;
...
public class MapRoutes {
	...
	public static void main(String[] args) {
		...
		HashMap<Id, Long[]> msRoutes = routeConverter.convertEvents(msKeyMap, path2EventsFile, path2MsNetwork, path2VissimZoneShp);
	}
