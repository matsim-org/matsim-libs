...
import playground.boescpa.av.staticDemand.*;
import playground.boescpa.av.staticDemand.StaticAVSim.SimBase;
 ...
 * @author boescpa
 */
public class StaticBikeSim {
    private static Logger log = Logger.getLogger(StaticBikeSim.class);
    ...
    private static Map<AutonomousVehicle, ForceModel.Force> redistributingVehicles;
    ...
    public static void main(String[] args) {
        ...
        final StaticAVSim.SimBase simBase = setUpSim(tripFile, shareOfOriginalAgentsServedByAV, shareOfOriginalFleetReplacedByAV,
    ...
    private static SimBase setUpSim(String tripFile, double shareOfOriginalAgentsServedByAV,
        ...
        StaticDemand staticDemand = new StaticDemandBikeImpl(tripFile, shareOfOriginalAgentsServedByAV);
        ...
        StaticBikeSim.redistributionSwitch = redistributionSwitch;
    ...
    private static void handleMetRequests(int posOfRequestToHandle, Trip requestToHandle, int assignedVehicle) {
        ...
        double travelTimeAgent = requestToHandle.distance/Constants.EBIKE_SPEED; //requestToHandle.endTime - requestToHandle.startTime;
        ...
        usedVehicle.incAccessDistance((responseTime - waitingTimeForAssignment) * Constants.WALK_SPEED / Constants.BEELINE_FACTOR_STREET);
    ...
    protected static class SimBaseImpl implements StaticAVSim.SimBase {
