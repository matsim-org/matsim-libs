...
public class PlotPlans {
	...
	public static void main(String[] args) {
		...
		VehicleRoutingProblemSolution solution = MatsimJspritFactory.createSolution(carrier.getSelectedPlan(), scenario.getNetwork());
		
		new Plotter(vrp,solution.getRoutes()).plot("output/plot", "carrier1");
