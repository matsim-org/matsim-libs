...
public class KiDSchema {
	...
	public static String FAHRZEUGHALTER_WIRTSCHAFTSZWEIG = "H01"; //Halter
	public static String FAHRZEUGHALTER_KREISTYP = "H04";
	public static String FAHRZEUGHALTER_EMPLOYEES = "H05";
	...
	public static String LEG_QUELLE_PLZ = "F02c";
	public static String LEG_QUELLE_GKZ = "F02a"; //Gemeindekennziffer
	public static String LEG_QUELLE_LAND = "F02b";
	public static String LEG_QUELLADRESSE_GEO_LONG = "F02d";
	public static String LEG_QUELLADRESSE_GEO_LAT = "F02e";
	
	public static String LEG_ZIEL_PLZ = "F08c";
	public static String LEG_ZIEL_GKZ = "F08a"; //Gemeindekennziffer
	public static String LEG_ZIEL_LAND = "F08b";
	...
	public static String LEG_DURATION = "F15";
	public static String LEG_DISTANCE = "F14";
