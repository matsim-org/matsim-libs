...
public class LCPAsWithTwoTypesAndTwoTypesOfTolls {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedWriter writer = new BufferedWriter(new FileWriter(new File("sensitivity/output/lcpas-with-two-types-and-two-tolls.txt")));
