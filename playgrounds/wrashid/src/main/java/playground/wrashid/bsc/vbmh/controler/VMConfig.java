...
public class VMConfig {
	public static double walkingSpeed = 4000; //m/h //!! Wert ist nur provisorisch >> BIS Skript?
	...
	public static int maxDistance = 2500; //Maximaler Umkreis in dem Parkplaetze gesucht werden
