...
public class MiniScenario {
	...
	public static void createNetwork(Scenario scenario) {
		...
		Node n0 = factory.createNode(Id.create("n0", Node.class), new Coord(0.0, 0.0));
		Node n1 = factory.createNode(Id.create("n1", Node.class), new Coord(5000.0, 0.0));
		Node n2 = factory.createNode(Id.create("n2", Node.class), new Coord(5000.0, 5000.0));
		Node n3 = factory.createNode(Id.create("n3", Node.class), new Coord(0.0, 5000.0));
		double x = -5000.0;
		Node nEnterLeave = factory.createNode(Id.create("nEnterLeave", Node.class), new Coord(x, 0.0));
...
//		scenario.getConfig().setParam("JDEQSim", "storageCapacityFactor", "5.0");	// instead of 1.0
		Mobsim sim = new JDEQSimulation(ConfigUtils.addOrGetModule(scenario.getConfig(), JDEQSimConfigGroup.NAME, JDEQSimConfigGroup.class), scenario, eventsManager);
		sim.run();
