...
public class SelectCityAgents {
	...
	public static void main(String[] args) {
		...
		int scenarioAreaRadius = 10000;
		
		String outputPlansFile = "C:/eTmp/census2000v2_ZhCut10km_1pct.xml.gz";
		...
		new PopulationWriter(scenario.getPopulation(), scenario.getNetwork(), 0.1).write(outputPlansFile);
	}
