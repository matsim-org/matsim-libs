...
public class GPSNIReplanner extends WithinDayDuringLegReplanner {
	...
	GPSNIReplanner(Id id, Scenario scenario, ActivityEndRescheduler internalInterface, 
	...
	public boolean doReplanning(MobsimAgent withinDayAgent) {
		...
		Activity activity = (Activity) this.withinDayAgentUtils.getModifiablePlan(withinDayAgent).getPlanElements().
