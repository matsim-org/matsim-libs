...
public class SearchTraffic {
	...
	public static void main(String[] args) {
		String eventsFile="H:/data/experiments/parkingSearchOct2013/runs/run104/output/";
		...
		TrafficOnRoadsCount trafficOnRoadsCount = new TrafficOnRoadsCount(new IdImpl("65802"));
	...
	Wait2LinkEventHandler, LinkEnterEventHandler, LinkLeaveEventHandler{
		...
		public TrafficOnRoadsCount(Id agentId){
		}
