...
public class WithinDayParkingController_ZHScenario implements StartupListener, ReplanningListener {
	...
	public WithinDayParkingController_ZHScenario(Controler controler, MultiModalControlerListener multiModalControlerListener) {
	...
	public void notifyStartup(StartupEvent event) {
		...
		if (!NetworkUtils.isMultimodal(event.getControler().getNetwork())) {
			...
			//multiModalConfigGroup.setSimulatedModes(multiModalConfigGroup.getSimulatedModes()+",ride");
	...
	private void addParkingToAllFacilities() {
		for (ActivityFacility facility : ((ScenarioImpl) scenario).getActivityFacilities().getFacilities().values()) {
			ActivityOptionImpl activityOptionImpl = new ActivityOptionImpl("parking");
			activityOptionImpl.setCapacity(1000);
			activityOptionImpl.setFacility(facility);
			facility.addActivityOption(activityOptionImpl);
		}
	...
	public static void main(String[] args) {
		...
		controler.addControlerListener(new WithinDayParkingController_ZHScenario(controler, multiModalControlerListener));
