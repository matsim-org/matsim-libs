...
package playground.wrashid.sschieffer.simulations.stellasTests.HighChargingSpeed;
...
public class SSSimP{
	...
	public static void main(String[] args) throws IOException, ConvergenceException, FunctionEvaluationException, IllegalArgumentException {
		...
		final String outputPath="/cluster/home/baug/stellas/Runs/HighCharging/SSP/";
