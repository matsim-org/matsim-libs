...
package playground.wrashid.sschieffer.simulations.stellasTests.V2GPlusMinus50000;
...
public class SSPPlus50000{
	...
	public static void main(String[] args) throws IOException, ConvergenceException, FunctionEvaluationException, IllegalArgumentException {
		...
		final String outputPath="/cluster/home/baug/stellas/Runs/V2GPlusMinusSS/SimSSPPlus/";
