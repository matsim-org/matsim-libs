 ...
 *
 */
public class DistanceDistributionTripEvents implements TransitDriverStartsEventHandler, PersonEntersVehicleEventHandler, PersonLeavesVehicleEventHandler, LinkEnterEventHandler, LinkLeaveEventHandler, ActivityStartEventHandler, ActivityEndEventHandler, TeleportationArrivalEventHandler, PersonStuckEventHandler {
	...
	//Attributes
	private Map<Id, TravellerChain> chains = new HashMap<Id, DistanceDistributionTripEvents.TravellerChain>();
	private Map<Id, PTVehicle> ptVehicles = new HashMap<Id, DistanceDistributionTripEvents.PTVehicle>();
	...
	//Constructors
	public DistanceDistributionTripEvents(Network network, Set<Id> pIdsToExclude) {
	...
	public static void main(String[] args) throws IOException {
		...
		new MatsimNetworkReader(scenario.getNetwork()).read(args[0]);
		...
		for(int i=0; i<=lastIteration; i+=iterationsInterval) {
			...
			DistanceDistributionTripEvents distanceDistribution = new DistanceDistributionTripEvents(scenario.getNetwork(), new HashSet<Id>());
