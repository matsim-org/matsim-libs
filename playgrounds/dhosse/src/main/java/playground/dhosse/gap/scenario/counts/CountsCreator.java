...
public class CountsCreator {
	 ...
	 * @return
	 */
	public static Counts<Link> createCountingStations(Network network){
		...
		Count<Link> count5 = counts.createAndAddCount(Id.createLinkId("18003"), "Burgstr Richtung Süden");
		...
		Count<Link> count6 = counts.createAndAddCount(Id.createLinkId("12997"), "Burgstr Richtung Norden");
		...
		//Alleestraße Ost
		//Richtung Osten
		Count<Link> count7 = counts.createAndAddCount(Id.createLinkId("13027"), "Alleestraße Richtung Osten");
		...
		//Richtung Westen
		Count<Link> count8 = counts.createAndAddCount(Id.createLinkId("13026"), "Alleestraße Richtung Westen");
		...
		//Promenadenstraße
		//Richtung Süden
		Count<Link> count9 = counts.createAndAddCount(Id.createLinkId("-49944_0"), "Promenadenstraße Richtung Süden");
		...
		//Richtung Norden
		Count<Link> count10 = counts.createAndAddCount(Id.createLinkId("574"), "Promenadenstraße Richtung Norden");
		...
		//Loisachstraße
		//Richtung Osten
		Count<Link> count11 = counts.createAndAddCount(Id.createLinkId("9948"), "Loisachstraße Richtung Osten");
		...
		//Richtung Westen
		Count<Link> count12 = counts.createAndAddCount(Id.createLinkId("9949"), "Loisachstraße Richtung Westen");
		...
		Count<Link> count13 = counts.createAndAddCount(Id.createLinkId("3599"), "Hauptstraße Nord Ri Norden");
		...
		Count<Link> count14 = counts.createAndAddCount(Id.createLinkId("3598"), "Hauptstraße Nord Ri Süden");
		count14.setCoord(network.getLinks().get(Id.createLinkId("3598")).getCoord());
		count14.createVolume(9, 896);
		count14.createVolume(17, 912);
		Count<Link> count15 = counts.createAndAddCount(Id.createLinkId("15493"), "Hauptstraße Süd Ri Norden");
		...
		Count<Link> count16 = counts.createAndAddCount(Id.createLinkId("15492"), "Hauptstraße Süd Ri Süden");
...
//		count20.createVolume(17, 82);
		...
		Count<Link> count22 = counts.createAndAddCount(Id.createLinkId("3833"), "Alpspitzstraße Ri Norden");
		...
		Count<Link> count23 = counts.createAndAddCount(Id.createLinkId("22360"), "Krottenkopfstraße Ri Norden");
		...
		Count<Link> count24 = counts.createAndAddCount(Id.createLinkId("22359"), "Krottenkopfstraße Ri Süden");
		...
		Count<Link> count32 = counts.createAndAddCount(Id.createLinkId("2035"), "St.-Martin-Straße Ost Richtung Westen");
		...
		Count<Link> count33 = counts.createAndAddCount(Id.createLinkId("25274"), "St.-Martin-Straße West Richtung Osten");
		...
		Count<Link> count34 = counts.createAndAddCount(Id.createLinkId("20925"), "St.-Martin-Straße West Richtung Westen");
		...
		Count<Link> count35 = counts.createAndAddCount(Id.createLinkId("2032"), "Olympiastraße Nord Richtung Norden");
		count35.setCoord(network.getLinks().get(Id.createLinkId("2032")).getCoord());
		count35.createVolume(9, 265);
		count35.createVolume(17, 371);
		Count<Link> count36 = counts.createAndAddCount(Id.createLinkId("2031"), "Olympiastraße Nord Richtung Süden");
		count36.setCoord(network.getLinks().get(Id.createLinkId("2031")).getCoord());
		count36.createVolume(9, 264);
		count36.createVolume(17, 424);
		Count<Link> count37 = counts.createAndAddCount(Id.createLinkId("18761"), "Olympiastraße Süd Richtung Norden");
		...
		Count<Link> count38 = counts.createAndAddCount(Id.createLinkId("18760"), "Olympiastraße Süd Richtung Süden");
		...
		Count<Link> count39 = counts.createAndAddCount(Id.createLinkId("20150"), "St.-Martin-Straße 2 Ost Richtung Osten");
		...
		Count<Link> count40 = counts.createAndAddCount(Id.createLinkId("20151"), "St.-Martin-Straße 2 Ost Richtung Westen");
		...
		Count<Link> count41 = counts.createAndAddCount(Id.createLinkId("20148"), "St.-Martin-Straße 2 West Richtung Osten");
		...
		Count<Link> count42 = counts.createAndAddCount(Id.createLinkId("20149"), "St.-Martin-Straße 2 West Richtung Westen");
...
//		Count<Link> count43 = counts.createAndAddCount(Id.createLinkId("1730"), "Reißerkopfstraße Nord Richtung Norden");
//		count43.setCoord(network.getLinks().get(Id.createLinkId("1730")).getCoord());
//		count43.createVolume(9, 57);
//		count43.createVolume(17, 87);
//		Count<Link> count44 = counts.createAndAddCount(Id.createLinkId("1731"), "Reißerkopfstraße Nord Richtung Süden");
//		count44.setCoord(network.getLinks().get(Id.createLinkId("1731")).getCoord());
//		count44.createVolume(9, 44);
//		count44.createVolume(17, 84);
//		Count<Link> count45 = counts.createAndAddCount(Id.createLinkId("10285"), "Reißerkopfstraße Süd Richtung Norden");
//		count45.setCoord(network.getLinks().get(Id.createLinkId("10285")).getCoord());
//		count45.createVolume(9, 31);
//		count45.createVolume(17, 29);
//		Count<Link> count46 = counts.createAndAddCount(Id.createLinkId("10286"), "Reißerkopfstraße Süd Richtung Süden");
