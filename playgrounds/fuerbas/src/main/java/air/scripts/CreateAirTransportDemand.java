...
public class CreateAirTransportDemand {
	...
	private static final String outputDirectory = repos + "shared-svn/studies/countries/de/flight/demand/destatis/2011_september_2/";
	private static final String outputPopulation = outputDirectory + "population_september_2011_tabelle_2.2.2_new.xml.gz";
