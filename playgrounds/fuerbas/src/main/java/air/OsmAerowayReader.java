...
// *
// * @author fuerbas after mrieser, aneumann
// */
//
public class OsmAerowayReader {
//
//	private final static Logger log = Logger.getLogger(OsmAerowayReader.class);
//
...
//	private final Set<String> unknownAeroways = new HashSet<String>();
//	private long id = 0;
//	private final Map<String, OsmAerowayDefaults> aerowayDefaults = new HashMap<String, OsmAerowayDefaults>();
...
//	 */
//	public OsmAerowayReader(final Network network, final CoordinateTransformation transformation) {
...
//	 */
//	public OsmAerowayReader(final Network network, final CoordinateTransformation transformation, boolean useAerowayDefaults) {
//		this.network = (NetworkImpl) network;
//		this.transform = transformation;
//
//		if (useAerowayDefaults) {
...
//		this.aerowayDefaults.put(highwayType, new OsmAerowayDefaults(hierarchy, lanes, freespeed, freespeedFactor, laneCapacity_vehPerHour, oneway));
//	}
//
//	/**
...
//			if ((highway != null) && (this.aerowayDefaults.containsKey(highway))) {
//				// check to which level a way belongs
//				way.hierarchy = this.aerowayDefaults.get(highway).hierarchy;
//
...
//
//		// load defaults
//		OsmAerowayDefaults defaults = this.aerowayDefaults.get(highway);
//		if (defaults == null) {
//			this.unknownAeroways.add(highway);
//			return;
//		}
//
...
//	}
//
//	private static class OsmAerowayDefaults {
//
...
//
//		public OsmAerowayDefaults(final int hierarchy, final double lanes, final double freespeed, final double freespeedFactor, final double laneCapacity, final boolean oneway) {
//			this.hierarchy = hierarchy;
//			this.lanes = lanes;
...
//			if ("way".equals(name)) {
//				boolean used = false;
//				OsmAerowayDefaults osmHighwayDefaults = aerowayDefaults.get(this.currentWay.tags.get("highway"));
