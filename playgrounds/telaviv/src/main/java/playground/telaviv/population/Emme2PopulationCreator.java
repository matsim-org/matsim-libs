...
//			desires.accumulateActivityDuration(activity.getType(), activity.getDuration());
	...
	private TransportMode getPrimaryTransportMode(int code)
	{
...
//			case 7: transportMode = TransportMode.other; break; // Taxi
			case 7: transportMode = TransportMode.undefined; break; // Taxi
//			case 8: transportMode = TransportMode.other; break; // Car Passenger
			case 8: transportMode = TransportMode.undefined; break; // Car Passenger
...
//			default: log.warn("Unknown Primary Transport Mode Code!"); transportMode = TransportMode.other; break;
			default: log.warn("Unknown Primary Transport Mode Code!"); transportMode = TransportMode.undefined; break;
		}
			
		return transportMode;
	}
	
	private TransportMode getSwitchedTransportMode(int code, TransportMode currentTransportMode)
	{
		switch (code)
		{
...
//			case 4: currentTransportMode = TransportMode.other; break; // to taxi 
			case 4: currentTransportMode = TransportMode.undefined; break; // to taxi
...
//			case 6: currentTransportMode = TransportMode.other; break; // to passenger
			case 6: currentTransportMode = TransportMode.undefined; break; // to passenger
...
//				currentTransportMode = TransportMode.bus; break;
	...
	private TransportMode getSecondaryTransportMode(int code)
	{
		TransportMode transportMode = null;
		switch (code)
		{
...
//			case 3: transportMode = TransportMode.other; break; // Car Passenger
			case 3: transportMode = TransportMode.undefined; break; // Car Passenger
			
//			default: log.warn("Unknown Secondary Transport Mode Code!"); transportMode = TransportMode.other; break;
			default: log.warn("Unknown Secondary Transport Mode Code!"); transportMode = TransportMode.undefined; break;
		}
