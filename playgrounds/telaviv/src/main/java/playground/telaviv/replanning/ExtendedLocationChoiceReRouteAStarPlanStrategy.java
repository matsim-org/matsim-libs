/* *********************************************************************** *
 * project: org.matsim.*
 * ExtendedLocationChoiceReRouteAStarPlanStrategy.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
 ...
 * <param name="Module_1" value="playground.telaviv.replanning.ExtendedLocationChoiceReRouteAStarPlanStrategy" /> 
 */
public class ExtendedLocationChoiceReRouteAStarPlanStrategy implements PlanStrategy {
	...
	public ExtendedLocationChoiceReRouteAStarPlanStrategy(Controler controler) {
		...
		planStrategyDelegate.addStrategyModule(new ReRouteLandmarks(config, network, travelCostCalc, travelTimeCalc, new FreespeedTravelTimeCost(config.charyparNagelScoring())));
	}
