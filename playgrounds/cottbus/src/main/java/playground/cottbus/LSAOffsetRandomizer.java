...
public class LSAOffsetRandomizer {
	...
	final static String OUTPUT_PATH = "./input/cottbus/random/"; // output path
	final static String SIGNAL_SYSTEMS_CONFIG = "./input/cottbus/signalSystemsConfigT90.xml"; // input
