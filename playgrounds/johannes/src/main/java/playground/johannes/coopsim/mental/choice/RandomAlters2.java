 ...
 * 
 */
public class RandomAlters2 implements ActivityGroupGenerator {
	...
	public RandomAlters2(double proba, Random random) {
		this(proba, 0, random);
	}

	public RandomAlters2(double proba, int min, Random random) {
		this.proba = proba;
		this.random = random;
		this.min = min;
	}
