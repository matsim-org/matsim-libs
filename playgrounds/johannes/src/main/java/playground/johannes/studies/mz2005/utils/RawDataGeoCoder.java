...
import playground.johannes.studies.sbsurvey.util.GoogleLocationLookup.RequestLimitException;
 ...
 *
 */
public class RawDataGeoCoder {

	private static final Logger logger = Logger.getLogger(RawDataGeoCoder.class);
