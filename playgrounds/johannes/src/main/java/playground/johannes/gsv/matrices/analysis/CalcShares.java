...
public class CalcShares {
	...
	public static void main(String[] args) throws IOException {
		...
		reader.read("/home/johannes/gsv/matrices/refmatrices/itp.xml");
		NumericMatrix carItpMatrix = reader.getMatrix();
		MatrixOperations.applyFactor(carItpMatrix, 1/365.0);
				
		reader.read("/home/johannes/gsv/matrices/simmatrices/miv.819.2.xml");
...
//		MatrixOperations.multiply(carSimMatrix, 11.8);
		...
		reader.read("/home/johannes/gsv/matrices/analysis/marketShares/rail.all.nuts3.xml");
		NumericMatrix railSimMatrix = reader.getMatrix();
		MatrixOperations.applyFactor(railSimMatrix, 1/365.0);
		
		reader.read("/home/johannes/gsv/matrices/analysis/marketShares/car.share.xml");
