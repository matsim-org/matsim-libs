...
//		log.info("done.");
	...
	public static void main(String[] args) {
		...
		SpanningTree st = new SpanningTree(ttc, new RandomizingTimeDistanceTravelDisutilityFactory( TransportMode.car, scenario.getConfig().planCalcScore() ).createTravelDisutility(ttc));
