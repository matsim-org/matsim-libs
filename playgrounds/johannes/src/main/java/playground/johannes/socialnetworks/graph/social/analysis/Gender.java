 ...
 *
 */
public class Gender extends SocioMatrix {

	/* (non-Javadoc)
	 * @see playground.johannes.socialnetworks.graph.social.analysis.SocioMatrix#getAttributeValue(playground.johannes.socialnetworks.graph.social.SocialVertex)
	 */
	@Override
	protected String getAttributeValue(SocialVertex vertex) {
		return vertex.getPerson().getPerson().getSex();
	}
