...
public class PlotFractalDimensionDistance {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		SpatialSparseGraph graph = new Population2SpatialGraph(CRSUtils.getCRS(21781)).read("/Users/fearonni/vsp-work/work/socialnets/data/schweiz/complete/plans/plans.0.001.xml");
