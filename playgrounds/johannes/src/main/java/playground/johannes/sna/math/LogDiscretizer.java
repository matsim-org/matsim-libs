...
public class LogDiscretizer implements Discretizer {
	...
	/**
	 * Creates a new discretizer where values greater than <tt>upperBound</tt>
	 * are rounded down to <tt>upperBound</tt>. Values less than 1 are rounded
	 * up to 1.
	 * 
	 * @param base
	 *            the base of the logarithm
	...
	/**
	 * Creates a new discretizer where values greater than <tt>upperBound</tt>
	 * are rounded down to <tt>upperBound</tt> and values less than
	 * <tt>lowerBound</tt> are rounded up to <tt>lowerBound</tt>.
	 * 
	 * @param base
	 *            the base of the logarithm
	 * @param upperBound
