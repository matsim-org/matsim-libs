...
public final class RunWithRoadPricing {
	...
	public static void main(String[] args) {
		...
		ObjectAttributesXmlReader reader = new ObjectAttributesXmlReader(objAttr);
...
//					new PlanCalcScoreConfigGroup.ActivityParams(objAttr.getAttribute(persID.toString(), "Income").toString());
...
//		
		...
		//PlanCalcScoreConfigGroup.ActivityParams configActParam = new PlanCalcScoreConfigGroup.ActivityParams("other");
		//configActParam.setOpeningTime(12000);
		//config.planCalcScore().addActivityParams(configActParam);
		...
		if(useCadyts) registerCadyts(controler, cadytsWeight);
	...
	private static void registerCadyts(final Controler controler, final double cadytsWeight){
...
//			}
//		} ) ;
		System.err.println("FIX RunWithRoadPricing.registerCadyts");
		System.exit(-1);
