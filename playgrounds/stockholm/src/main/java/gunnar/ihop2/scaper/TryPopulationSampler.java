...
public class TryPopulationSampler {
	public static void main(String[] args){
		String srcpop = "H:\\Matsim\\Stockholm Scenario\\teleportation\\input\\initial_plans_full.xml";
		String destpop = "H:\\Matsim\\Stockholm Scenario\\teleportation\\input\\initial_plans_scaper_10%.xml";
		String network = "";
		double sample = 0.1;
