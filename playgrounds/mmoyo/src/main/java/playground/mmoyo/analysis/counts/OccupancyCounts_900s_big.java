...
/**Counts occupancy for routed plans*/
public class OccupancyCounts_900s_big {
	...
	public static void main(String[] args) throws SAXException, ParserConfigurationException, IOException {
		...
		configs[0]= "../shared-svn/studies/countries/de/berlin-bvg09/ptManuel/comparison/routed_plans/routed_configs/config_900s_big_rieser.xml";
