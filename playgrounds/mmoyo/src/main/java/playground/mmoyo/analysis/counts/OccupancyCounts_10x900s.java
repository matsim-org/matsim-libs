...
public class OccupancyCounts_10x900s {
	...
	public static void main(String[] args) throws SAXException, ParserConfigurationException, IOException {
		...
		String configFile1 = "../shared-svn/studies/countries/de/berlin-bvg09/ptManuel/lines344_M44/counts/config_900s_big_rieser.xml";
		OccupancyCounts.main(new String[]{configFile1, transitLineStrId, transitRouteStrId1, transitRouteStrId2});
