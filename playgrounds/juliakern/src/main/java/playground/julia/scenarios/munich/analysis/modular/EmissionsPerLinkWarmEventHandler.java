 ...
 * 
 */
public class EmissionsPerLinkWarmEventHandler implements
	...
	public EmissionsPerLinkWarmEventHandler(double simulationEndTime,
			int noOfTimeBins) {
	...
	public void handleEvent(WarmEmissionEvent event) {
		...
		Map<WarmPollutant, Double> warmEmissionsOfEvent = event.getWarmEmissions(); //TODO macht das einen unterschied, ob ich hier eine kopie erstelle? sollte nicht
