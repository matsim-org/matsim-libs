 ...
 *
 */
public class TotalEmissionsPerLinkColdEventHandler implements ColdEmissionEventHandler{
	private static final Logger logger = Logger.getLogger(TotalEmissionsPerLinkColdEventHandler.class);
	...
	public TotalEmissionsPerLinkColdEventHandler(double simulationEndTime, int noOfTimeBins) {
