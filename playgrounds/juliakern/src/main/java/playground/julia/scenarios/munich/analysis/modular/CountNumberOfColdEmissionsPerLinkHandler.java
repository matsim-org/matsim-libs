 ...
 *
 */
public class CountNumberOfColdEmissionsPerLinkHandler implements ColdEmissionEventHandler{
	private static final Logger logger = Logger.getLogger(CountNumberOfColdEmissionsPerLinkHandler.class);
	...
	public CountNumberOfColdEmissionsPerLinkHandler(double simulationEndTime, int noOfTimeBins) {
	...
	public void handleEvent(ColdEmissionEvent event) {
		...
		//TODO was passiert mit Zeiten ausserhalb des Zeitintervalls?
