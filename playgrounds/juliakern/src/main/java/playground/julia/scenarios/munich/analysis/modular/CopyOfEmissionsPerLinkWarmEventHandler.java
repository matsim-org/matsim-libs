 ...
 *
 */
public class CopyOfEmissionsPerLinkWarmEventHandler implements WarmEmissionEventHandler{
	private static final Logger logger = Logger.getLogger(CopyOfEmissionsPerLinkWarmEventHandler.class);
	...
	public CopyOfEmissionsPerLinkWarmEventHandler(double simulationEndTime, int noOfTimeBins){
