 ...
 *                                                                         *
 * *********************************************************************** */
package playground.julia.internalization;
...
public class EmissionTravelCostCalculator implements PersonalizableTravelDisutility{
	...
	public double getLinkTravelDisutility(Link link, double time) {
		...
		iteration. Cold emission costs are assumed not to change routing; they might change mode choice (not implemented)! */
			...
			System.out.println(expectedEmissionCosts+"  "+link.getId().toString());
...
////		else 
			...
			//generalized costs
			//generalizedTravelCost = generalizedDistanceCost;
			//generalizedTravelCost = generalizedTravelTimeCost;
			//generalizedTravelCost = generalizedExpectedEmissionCost;
			generalizedTravelCost = generalizedExpectedEmissionCost+generalizedTravelTimeCost;
			//generalizedTravelCost = generalizedExpectedEmissionCost+generalizedDistanceCost;
			//generalizedTravelCost = generalizedTravelTimeCost+generalizedDistanceCost;
			//generalizedTravelCost = generalizedTravelTimeCost + generalizedDistanceCost + generalizedExpectedEmissionCost;
			
			System.out.println("generalizedTravelCost"+generalizedTravelCost);
