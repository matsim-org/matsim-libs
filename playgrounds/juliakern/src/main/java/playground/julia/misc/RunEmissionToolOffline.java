...
import playground.julia.emissions.*;
...
//	static String emissionEventOutputFile = eventsPath + ".emission.events.xml.gz";
	...
	private void run(String[] args) throws IOException {
		...
		EventHandler v1Handler = new EmissionsPerLinkWarmEventHandler(24*60*60., 36);
		//EventHandler v1Handler = new EmissionsPerLinkWarmEventHandlerV0(24*60*60., 36);
		//EventHandler v1Handler = new EmissionsPerLinkWarmEventHandlerV1(24*60*60., 36);
		emissionModule.getEmissionEventsManager().addHandler(v1Handler);
		...
		System.out.println("dauer in milli sec " + (endTime-startTime));
	}
