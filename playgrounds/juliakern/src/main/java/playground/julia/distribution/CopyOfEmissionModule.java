 ...
 *
 */
public class CopyOfEmissionModule {
	private static final Logger logger = Logger.getLogger(CopyOfEmissionModule.class);
	...
	//===
	static String roadTypeMappingFile = "../../detailedEval/emissions/hbefaForMatsim/roadTypeMapping.txt";;
	static String emissionVehicleFile = "../../detailedEval/emissions/testScenario/input/emissionVehicles_1pct.xml.gz";
	
	static String averageFleetWarmEmissionFactorsFile = "../../detailedEval/emissions/hbefaForMatsim/EFA_HOT_vehcat_2005average.txt";
	static String averageFleetColdEmissionFactorsFile = "../../detailedEval/emissions/hbefaForMatsim/EFA_ColdStart_vehcat_2005average.txt";
	

	static String detailedWarmEmissionFactorsFile = "../../detailedEval/emissions/hbefaForMatsim/EFA_HOT_SubSegm_2005detailed.txt";
	static String detailedColdEmissionFactorsFile = "../../detailedEval/emissions/hbefaForMatsim/EFA_ColdStart_SubSegm_2005detailed.txt";
	...
	public CopyOfEmissionModule(Scenario scenario) {
		this.scenario = scenario;
	}
	
	public CopyOfEmissionModule(Scenario scenario, Vehicles emissionVehicles) {
		this.scenario = scenario;
