 ...
 *
 */
public class RunEmissionPricingSample {
	...
	static String plansFile = "input/sample/test_plans.xml"; 
			//inputPath + "mergedPopulation_All_1pct_scaledAndMode_workStartingTimePeakAllCommuter0800Var2h_gk4.xml.gz";
