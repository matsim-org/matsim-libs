...
import playground.julia.emissions.ColdEmissionAnalysisModule;
...
public class CopyOfTestColdEmissionAnalysisModule {
	...
	public void calculateColdEmissionsAndThrowEventTest_Exceptions() {
		...
		// testCasesExceptions.add(vehicleInfoForNoCase); //no longer an exception
	...
	//
	@Test 
	public void calculateColdEmissionsAndThrowEventTest_missingVehicleInformation() {
		...
		// seventh case: "PASSENGER_CAR;PC diesel;;>=2L"
		String vehInfo7 = vehicleInfoForNoCase; 
		Id linkId7 = new IdImpl("link id 7"), personId7 = new IdImpl("person 7");
		
		HandlerToTestEmissionAnalysisModules.reset();
		ceam.calculateColdEmissionsAndThrowEvent(linkId7, personId7, startTime, parkingDuration, accDistance, vehInfo7);
		String message = "The expected emissions for an event with vehicle information string '" + vehInfo7+ "' are " + 
	...
	public void calculateColdEmissionsAndThrowEventTest_minimalVehicleInformation() {
		...
		Id linkId11 = new IdImpl("link id 11"), personId11 = new IdImpl("person 11");
		
		HandlerToTestEmissionAnalysisModules.reset();
		ceam.calculateColdEmissionsAndThrowEvent(linkId11, personId11, startTime, parkingDuration, accDistance, vehInfo11);
