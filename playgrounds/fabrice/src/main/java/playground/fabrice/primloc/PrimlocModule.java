...
//			return;
//
//		Object knowledge = this.knowledges.getKnowledgesByPersonId().get(guy.getId());
//        ArrayList<ActivityOptionImpl> result1;
//        throw new RuntimeException("Knowledges are no more.");
//
//        ActivityFacility home = result1.get(0).getFacility();
...
//                throw new RuntimeException("Knowledges are no more.");
//
//                ActivityFacility homeOfGuy = result.get(0).getFacility();
