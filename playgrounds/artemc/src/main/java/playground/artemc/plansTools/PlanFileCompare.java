...
public class PlanFileCompare {
	...
	new MatsimPopulationReader(scenario1).parse("H:/MATSimSimuliations/output_10000_19788pt_links_FC/it.0/0.plans.xml/0.plans.xml");
	new MatsimPopulationReader(scenario2).parse("H:/MATSimSimuliations/output_10000_19788pt_links_FC/it.0/0.plans.xml/0.plans.xml");
