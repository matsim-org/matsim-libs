package playground.artemc.events;
...
public class EventsToTravelSummaryRelationalTablesGUI_V2 extends JFrame {
    ...
    private final EventsToTravelSummaryRelationalTablesGUI_V2 self = this;
...
//					if (args.length == 1){
//						frame.eventsFile = args[0];
//						frame.changeDefaultProperties();
//					};
				} catch (Exception e) {
					e.printStackTrace();
				}
	 ...
	 * Create the frame.
	 */
    public EventsToTravelSummaryRelationalTablesGUI_V2() {
		...
		eventsToSQLPropertiesFileComponent.setText(defaultPropertiesFile);
	...
	public void runEventsProcessing() throws NoConnectionException {
		boolean isTransit = false;
		MutableScenario scenario = (MutableScenario) ScenarioUtils
				.createScenario(ConfigUtils.loadConfig(configFileComponent.getText()));
	...
	public void changeDefaultProperties(String property, String value) {
				try {
					String propertyValue = this.defaultProperties
							                       .getProperty(property);
					// reflection
