...
public class SocialCostCalculator implements TravelDisutility,
	...
	public SocialCostCalculator(final Network network, EventsManager events, TravelTime travelTime, Controler controler) {
		this(network, 15 * 60, 30 * 3600, events, travelTime, controler); // default timeslot-duration: 15 minutes
	}

	public SocialCostCalculator(final Network network, final int timeslice, EventsManager events, TravelTime travelTime, Controler controler) {
		this(network, timeslice, 30 * 3600, events, travelTime, controler); // default: 30 hours at most
	}

	public SocialCostCalculator(Network network, int timeslice, int maxTime, EventsManager events, TravelTime travelTime, Controler controler) {
