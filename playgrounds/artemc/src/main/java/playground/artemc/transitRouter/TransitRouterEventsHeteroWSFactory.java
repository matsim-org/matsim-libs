 ...
 * @author sergioo
 */
public class TransitRouterEventsHeteroWSFactory implements TransitRouterFactory {
	...
	@Inject
    public TransitRouterEventsHeteroWSFactory(final Scenario scenario, final WaitTime waitTime, final StopStopTime stopStopTime, final IncomeHeterogeneity incomeHeterogeneity) {
	...
	public TransitRouter createTransitRouter() {
		return new TransitRouterVariableImpl(config, new TransitRouterNetworkTravelTimeAndDisutilityHeteroWS(config, routerNetwork, waitTime, stopStopTime, scenario.getConfig().travelTimeCalculator(), scenario.getConfig().qsim(), new PreparedTransitSchedule(scenario.getTransitSchedule()), incomeHeterogeneity), routerNetwork);
	}
