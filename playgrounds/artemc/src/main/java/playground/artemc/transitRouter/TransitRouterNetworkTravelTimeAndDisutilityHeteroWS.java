...
public class TransitRouterNetworkTravelTimeAndDisutilityHeteroWS extends TransitRouterNetworkTravelTimeAndDisutility implements TravelDisutility {
	...
	public TransitRouterNetworkTravelTimeAndDisutilityHeteroWS(final TransitRouterConfig config, TransitRouterNetworkWW routerNetwork, WaitTime waitTime, StopStopTime stopStopTime, TravelTimeCalculatorConfigGroup tTConfigGroup, QSimConfigGroup qSimConfigGroup, PreparedTransitSchedule preparedTransitSchedule, IncomeHeterogeneity incomeHeterogeneity) {
		this(config, routerNetwork, waitTime, stopStopTime, tTConfigGroup, qSimConfigGroup.getStartTime(), qSimConfigGroup.getEndTime(), preparedTransitSchedule, incomeHeterogeneity);
	}
	public TransitRouterNetworkTravelTimeAndDisutilityHeteroWS(final TransitRouterConfig config, TransitRouterNetworkWW routerNetwork, WaitTime waitTime, StopStopTime stopStopTime, TravelTimeCalculatorConfigGroup tTConfigGroup, double startTime, double endTime, PreparedTransitSchedule preparedTransitSchedule, IncomeHeterogeneity incomeHeterogeneity) {
