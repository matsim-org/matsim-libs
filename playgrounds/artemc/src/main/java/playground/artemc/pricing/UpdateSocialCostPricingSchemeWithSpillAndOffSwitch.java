 ...
 */
public class UpdateSocialCostPricingSchemeWithSpillAndOffSwitch extends AbstractModule {

	static private Logger log;

	public UpdateSocialCostPricingSchemeWithSpillAndOffSwitch(){
		this.log = Logger.getLogger(UpdateSocialCostPricingSchemeWithSpillAndOffSwitch.class);
	}
...
//		}
		...
		public void notifyIterationStarts(IterationStartsEvent event) {
			...
			if(event.getIteration()>900){
				this.blendFactor = 0.0;
				log.info("Tolls are kept constant.");
			}
		}
