...
public class NoCrowdingScoringFunctionFactory implements ScoringFunctionFactory
{
	...
	public NoCrowdingScoringFunctionFactory(ScoringFunctionFactory delegate)
	{
	...
	public NoCrowdingScoringFunctionFactory(ScoringFunctionFactory delegate, EventsManager events, ScoreTracker scoreTracker, MatsimServices controler)
	{
		this.delegate = delegate;
		this.events = events;
	...
	{
		return new NoCrowdingScoringFunction(delegate.createNewScoringFunction(person), events,  scoreTracker, controler);
	}
