...
public class TransferDelayInVehicleHandler implements PersonEntersVehicleEventHandler, PersonLeavesVehicleEventHandler, TransitDriverStartsEventHandler, VehicleArrivesAtFacilityEventHandler, VehicleDepartsAtFacilityEventHandler {
	...
	private final Map<Id<Vehicle>, Double> vehiclesAtStops =  new HashMap<>();
	...
	public void handleEvent(VehicleDepartsAtFacilityEvent event) {
		...
		double vehicleArrivalTime = event.getTime();
		double vehicleDepartureTime = vehiclesAtStops.get(event.getVehicleId());
		double delayPerPerson = (vehicleArrivalTime - vehicleDepartureTime) / numberOfAgentsTransfering;
