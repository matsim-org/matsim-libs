...
public class extractWorkActivities1week_DCM_v2015 {
...
// 	double constant =	2.57561;
	...
	public static void main(String args[]) throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException, NoConnectionException, ParseException {
		...
		new extractWorkActivities1week_DCM_v2015().go(dayFile);
	}
...
//		outWorkLocations.close();
		...
		outWorkLocations_DCM_NoLanduse.write("card_id,duration(hours),JourneyID,workStation,workLat,workLon,activityStartTime(min),boardingStation,boardingLat,boardingLon, activityEndTime, originStation,originLat,originLon,journeyTimeToWork(min)"+"\n");
		outWorkLocations_DCM_NoLanduse .close();
