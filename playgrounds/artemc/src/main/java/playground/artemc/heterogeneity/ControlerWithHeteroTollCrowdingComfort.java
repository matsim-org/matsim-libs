...
public class ControlerWithHeteroTollCrowdingComfort {

	private static final Logger log = Logger.getLogger(ControlerWithHeteroTollCrowdingComfort.class);
	...
	public static void main(String[] args){
		...
		ControlerWithHeteroTollCrowdingComfort runner = new ControlerWithHeteroTollCrowdingComfort();
		runner.run();
	}
