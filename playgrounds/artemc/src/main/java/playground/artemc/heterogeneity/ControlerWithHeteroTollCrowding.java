...
public class ControlerWithHeteroTollCrowding {

	private static final Logger log = Logger.getLogger(ControlerWithHeteroTollCrowding.class);
	...
	public static void main(String[] args){
		...
		ControlerWithHeteroTollCrowding runner = new ControlerWithHeteroTollCrowding();
		runner.run();
	}
