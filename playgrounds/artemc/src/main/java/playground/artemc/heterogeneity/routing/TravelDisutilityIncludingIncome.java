 ...
 */
public class TravelDisutilityIncludingIncome implements TravelDisutility{


	private static final Logger log = Logger.getLogger(TravelDisutilityIncludingIncome.class) ;
	...
	public static class Builder implements TravelDisutilityFactory{
		...
		public TravelDisutility createTravelDisutility(TravelTime timeCalculator, PlanCalcScoreConfigGroup cnScoringGroup) {
			if (incomeHeterogeneity.getType()!="homo"){
				return new TravelDisutilityIncludingIncome(
	...
	private TravelDisutilityIncludingIncome(final TravelDisutility normalTravelDisutility, final IncomeHeterogeneity incomeHeterogeneity, final TravelTime timeCalculator, PlanCalcScoreConfigGroup cnScoringGroup){
		this.incomeHeterogeneity = incomeHeterogeneity;
