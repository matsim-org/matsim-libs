 ...
 * @auther artemc
 */
public class TransitRouterHeteroWSImplFactory implements TransitRouterFactory {
	...
	private final HeterogeneityConfig heterogeneityConfig;
	
	public TransitRouterHeteroWSImplFactory(final Scenario scenario, final WaitTime waitTime, final StopStopTime stopStopTime, 	HeterogeneityConfig heterogeneityConfig) {
	...
	public TransitRouter createTransitRouter() {
		return new TransitRouterVariableImpl(config, new TransitRouterNetworkTravelTimeAndDisutilityHeteroWS(config, routerNetwork, waitTime, stopStopTime, scenario.getConfig().travelTimeCalculator(), scenario.getConfig().qsim(), new PreparedTransitSchedule(scenario.getTransitSchedule()),heterogeneityConfig), routerNetwork);
	}
