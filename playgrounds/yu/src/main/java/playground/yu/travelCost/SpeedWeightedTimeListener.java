...
public class SpeedWeightedTimeListener implements IterationStartsListener {
	public static class SpeedWeightedTravelCostCalculatorFactoryImpl implements
	...
	public static class SpeedWeightedTravelTimeCostCalculator implements TravelDisutility {
		...
		public SpeedWeightedTravelTimeCostCalculator(
	...
	public void notifyIterationStarts(IterationStartsEvent event) {
		...
		if (event.getIteration() > ctl.getConfig().controler().getFirstIteration()) {
			ctl.addOverridingModule(new AbstractModule() {
				@Override
				public void install() {
					bindTravelDisutilityFactory().toInstance(new SpeedWeightedTravelCostCalculatorFactoryImpl());
				}
			});
		}
	}
