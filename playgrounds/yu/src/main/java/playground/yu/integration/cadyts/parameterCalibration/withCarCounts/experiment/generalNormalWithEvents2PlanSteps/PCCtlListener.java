...
public class PCCtlListener extends BseParamCalibrationControlerListener
	...
	private Events2PlanSteps events2PlanStep2 = null;
	...
	private void initializeStrategyManager(Controler ctl) {
		// INITIALIZING events2planStep
		events2PlanStep2 = new Events2PlanSteps(ctl.getNetwork(),
				ctl.getPopulation());
		...
		((PCStrMn) ctl.getStrategyManager()).init(
				...
				(MultinomialLogitChoice) chooser, delta, events2PlanStep2);

		// events addhandler e2p
		ctl.getEvents().addHandler(events2PlanStep2);
	}
	...
	public void notifyStartup(final StartupEvent event) {
		...
		// INITIALIZING StrategyManager and Events2PlanSteps
	...
	public void notifyBeforeMobsim(BeforeMobsimEvent event) {
		events2PlanStep2.reset(event.getIteration());
	}

	@Override
	public void notifyIterationEnds(IterationEndsEvent event) {
		events2PlanStep2.clearUpAfterMobsim();
		// ################################################
