...
//		/*
//		 * // deactivate generating of new Plans by plan innovation String
//		 * disablePlanGeneratingAfterIterStr = config.findParam("bse",
//		 * "disablePlanGeneratingAfterIter"); int
//		 * disablePlanGeneratingAfterIter; if (disablePlanGeneratingAfterIterStr
//		 * == null) { disablePlanGeneratingAfterIter = getLastIteration() + 1; }
//		 * else { disablePlanGeneratingAfterIter = Integer
...
//		 * 
//		 * if (modules.length != moduleProbs.length) { throw new
//		 * RuntimeException(
//		 * "Length of Parameter :\tstrategyModules and Parameter :\tstrategyModuleProbabilities should be the same."
//		 * ); }
//		 * 
//		 * for (int i = 0; i < modules.length; i++) { String module =
//		 * modules[i].trim(); double prob =
//		 * Double.parseDouble(moduleProbs[i].trim());
//		 * 
//		 * if (module.equals("ChangeExpBeta")) { // ChangeExpBeta PlanStrategy
//		 * changeExpBeta = new PlanStrategyImpl( new
//		 * ExpBetaPlanChanger(config.planCalcScore() .getBrainExpBeta()));
//		 * manager.addStrategy(changeExpBeta, 0.0); manager.addChangeRequest(
//		 * getFirstIteration() + manager.getMaxPlansPerAgent() + 1// 505 ,
//		 * changeExpBeta, prob); } else if (module.equals("SelectExpBeta")) { //
//		 * SelectExpBeta PlanStrategy selectExpBeta = new PlanStrategyImpl( new
//		 * ExpBetaPlanSelector(config.planCalcScore()));
//		 * manager.addStrategy(selectExpBeta, 0.0); manager.addChangeRequest(
//		 * getFirstIteration() + manager.getMaxPlansPerAgent() + 1//505 ,
//		 * selectExpBeta, prob);
//		 * 
//		 * } else if (module.equals("ReRoute")) { // ReRoute PlanStrategy
//		 * reRoute = new PlanStrategyImpl( new RandomPlanSelector());
//		 * reRoute.addStrategyModule(new ReRoute(this));
//		 * manager.addStrategy(reRoute, 0.0); manager.addChangeRequest(
//		 * getFirstIteration() + manager.getMaxPlansPerAgent() + 1, reRoute,
//		 * prob); manager.addChangeRequest(disablePlanGeneratingAfterIter + 1,
//		 * reRoute, 0); } else if (module.equals("TimeAllocationMutator")) { //
//		 * TimeAllocationMutator PlanStrategy timeAllocationMutator = new
//		 * PlanStrategyImpl( new RandomPlanSelector()); timeAllocationMutator
...
//		 * manager.getMaxPlansPerAgent() + 1, timeAllocationMutator, prob);
//		 * manager.addChangeRequest(disablePlanGeneratingAfterIter + 1,
//		 * timeAllocationMutator, 0); } else if
//		 * (module.equals("ChangeSingleLegMode")) { // TimeAllocationMutator
//		 * PlanStrategy changeSingleLegMode = new PlanStrategyImpl( new
//		 * RandomPlanSelector()); changeSingleLegMode.addStrategyModule(new
//		 * ChangeSingleLegMode( config));
//		 * changeSingleLegMode.addStrategyModule(new ReRoute(this));
//		 * 
//		 * manager.addStrategy(changeSingleLegMode, 0.0);
//		 * manager.addChangeRequest( getFirstIteration() +
//		 * manager.getMaxPlansPerAgent() + 1, changeSingleLegMode, prob);
//		 * manager.addChangeRequest(disablePlanGeneratingAfterIter + 1,
