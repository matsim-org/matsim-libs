 ...
 * 
 */
public class PlansScoring4PCinclLT implements PlansScoring4PC_I,
		StartupListener, ScoringListener, IterationStartsListener {
	private final static Logger log = Logger
			.getLogger(PlansScoring4PCinclLT.class);
	...
	public void notifyStartup(final StartupEvent event) {
		...
		planScorer = new Events2Score4PCinclLT(ctl.getConfig(),
