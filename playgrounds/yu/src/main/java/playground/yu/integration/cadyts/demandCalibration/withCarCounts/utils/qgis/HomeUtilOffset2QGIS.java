...
import playground.yu.integration.cadyts.demandCalibration.withCarCounts.experiments.actLocUtilOffset.Grid2Graph2;
import playground.yu.integration.cadyts.demandCalibration.withCarCounts.experiments.actLocUtilOffset.HomeLoc_TipUtilOffsetExtractor;
import playground.yu.utils.qgis.X2QGIS;

public class HomeUtilOffset2QGIS implements X2QGIS {
	/**
	...
	private Grid2Graph2 g2g = null;

	public HomeUtilOffset2QGIS(Scenario scenario, String coordRefSys,
			HomeLoc_TipUtilOffsetExtractor homeTUO) {
		crs = MGC.getCRS(coordRefSys);
		g2g = new Grid2Graph2(crs, homeTUO);
	}
