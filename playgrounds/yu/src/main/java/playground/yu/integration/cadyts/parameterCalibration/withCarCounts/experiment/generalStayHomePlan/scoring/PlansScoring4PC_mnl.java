...
public class PlansScoring4PC_mnl extends PlansScoring4PC implements
	...
	private final static Logger log = Logger
			.getLogger(PlansScoring4PC_mnl.class);

	@Override
	public void notifyStartup(final StartupEvent event) {
		Controler ctl = event.getControler();

		planScorer = new Events2Score4PC_mnl(ctl.getConfig(),
				ctl.getScoringFunctionFactory(), ctl.getPopulation());

		log.debug("PlansScoring4PC_mnl loaded ScoringFunctionFactory");
