...
public class PopPruner extends NewPopulation {
	...
	public static void main(String args[]) {
		...
		String oldPopFilename = "../integration-parameterCalibration/test/output/output_plans.xml.gz";
		String newPopFilename = "../integration-parameterCalibration/test/output/output_only4plans.xml.gz";
