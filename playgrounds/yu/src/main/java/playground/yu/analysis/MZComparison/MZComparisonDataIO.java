...
public class MZComparisonDataIO implements TabularFileHandler {
	...
	public void setData2Compare(final MZComparisonData data2compare) {
		...
		setValueFromData2Compare(ADDOTA, "car",
				data2compare.getAvgTollDailyDistance_car_m() / 1000.0);
		setValueFromData2Compare(ADDOTA, "pt",
				data2compare.getAvgTollDailyDistance_pt_m() / 1000.0);
		setValueFromData2Compare(ADDOTA, "walk",
				data2compare.getAvgTollDailyDistance_walk_m() / 1000.0);
		setValueFromData2Compare(ADDOTA, "others",
				data2compare.getAvgTollDailyDistance_other_m() / 1000.0);

		String ADERTOTA = "average daily en route time [min] (MATSim)";
		setValueFromData2Compare(ADERTOTA, "car",
				data2compare.getAvgTollDailyEnRouteTime_car_min());
		setValueFromData2Compare(ADERTOTA, "pt",
				data2compare.getAvgTollDailyEnRouteTime_pt_min());
		setValueFromData2Compare(ADERTOTA, "walk",
				data2compare.getAvgTollDailyEnRouteTime_walk_min());
		setValueFromData2Compare(ADERTOTA, "others",
				data2compare.getAvgTollDailyEnRouteTime_other_min());
	}
