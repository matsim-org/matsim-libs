 ...
 *
 */
public class AnalysisTest4BlnWithXMLEvents implements Analysis4Bln {
	...
	private static void printUsage() {
		...
		System.out
				.println(" arg 1: name incl. path to events file (.xml[.gz])(required)");
		System.out
				.println(" arg 2: path to output file incl. \"/\" (required) e.g. ...analysis/");
		// ------------------------------------------------------------------------------
		System.out
		...
		System.out.println(" arg 6: with toll? true or false (required)");
		System.out.println(" arg 7: runId (required)");
		System.out.println("----------------");
	}
	...
	private static void runIntern(final String[] args, final String scenario) {
		...
		// "events4mvi");
		String outputBase = args[2]/* ...analysis/ */+ args[args.length - 1]/* runId */
