...
public class GeometricDistanceExtractor extends AbstractPersonAlgorithm
	...
	private double[] carLegDists = new double[9], ptLegDists = new double[9],
	...
	private int getPurposeIdx(String purpose) {
	...
	private void prepareData4Plot(int transportModeIndex, final String purpose,
