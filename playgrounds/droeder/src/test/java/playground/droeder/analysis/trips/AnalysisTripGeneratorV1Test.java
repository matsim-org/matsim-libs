...
//			
//			event = new ActivityEndEvent(0.0, agentId, link1, fac1, type1);
//			events.add(event);
//			pe = fac.createActivityFromLinkId(type1, link1);
//			elements.add(pe);
//			
//			event = new AgentDepartureEvent(1.0, agentId, link1, mode1);
//			events.add(event);
//			pe = fac.createLeg(mode1);
//			elements.add(pe);
//			
//			event = new AgentArrivalEvent(10.0, agentId, link4, mode1);
//			events.add(event);
//			
//			event = new ActivityStartEvent(11.0, agentId, link4, fac4, type3);
//			events.add(event);
//			pe = fac.createActivityFromLinkId(type1, link1);
//			elements.add(pe);
//			
...
//			pe = fac.createLeg(mode1);
//			elements.add(pe);
//			event = new AgentArrivalEvent(10.0, agentId, link2, mode1);
//			events.add(event);
//			
//			event = new ActivityStartEvent(11.0, agentId, link2, fac2, type2);
//			events.add(event);
//			pe = fac.createActivityFromLinkId(type2, link2);
//			elements.add(pe);
//			event = new ActivityEndEvent(13.0, agentId, link2, fac2, type2);
//			events.add(event);
//			
//			event = new AgentDepartureEvent(14.0, agentId, link2, mode2);
//			events.add(event);
//			pe = fac.createLeg(mode2);
//			elements.add(pe);
//			event = new AgentArrivalEvent(20.0, agentId, link3, mode2);
//			events.add(event);
//			
//			event = new ActivityStartEvent(21.0, agentId, link3, fac3, type2);
//			events.add(event);
//			pe = fac.createActivityFromLinkId(type2, link2);
//			elements.add(pe);
//			event = new ActivityEndEvent(22.0, agentId, link3, fac3, type2);
//			events.add(event);
//			
//			event = new AgentDepartureEvent(23.0, agentId, link3, mode1);
//			events.add(event);
//			pe = fac.createLeg(mode1);
//			elements.add(pe);
//			event = new AgentArrivalEvent(30.0, agentId, link4, mode1);
//			events.add(event);
//			
//			event = new ActivityStartEvent(31.0, agentId, link4, fac4, type3);
//			events.add(event);
...
//		}
//		
//		this.sets = TTAnalysisTripGeneratorV1.calculateTripSet(this.personEvents, this.planElements, null, false).getTripSets();
//	}
//
//	@Test
