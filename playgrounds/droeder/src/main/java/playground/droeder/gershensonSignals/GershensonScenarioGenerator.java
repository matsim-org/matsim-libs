...
public class GershensonScenarioGenerator {
	public static final String INPUT = DaPaths.DASTUDIES + "gershenson\\";
	public static final String OUTPUT =DaPaths.DASTUDIES + "gershenson\\";
	...
	private static final String OUTPUTDIRECTORY = DaPaths.OUTPUT + "gershenson\\";
	...
	private Id id1, id2, id3, id4, id11, id12, id13, id14, id15, id16, id17, id18;
	...
	public void createScenario() {
		...
		if (isUseLanes) {
			...
			LanesConsistencyChecker lcc =new LanesConsistencyChecker(scenario.getNetwork(), scenario.getLaneDefinitions());
		...
		if (isUseSignalSystems) {
			...
			SignalSystemsConsistencyChecker sscc = new SignalSystemsConsistencyChecker(scenario.getNetwork(), scenario.getLaneDefinitions(), scenario.getSignalSystems());
...
//		//create signal group for traffic on link 18
	...
	private void createPlans(ScenarioImpl scenario) {
		...
		for (int i = 1; i <= 500; i++) {
			...
			route1 = new LinkNetworkRouteImpl(l11.getId(), l12.getId());
			...
			route = new LinkNetworkRouteImpl(l13.getId(), l14.getId());
