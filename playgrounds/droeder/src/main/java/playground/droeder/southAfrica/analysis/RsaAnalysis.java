...
import playground.andreas.aas.modules.ptAccessibility.PtAccesibilityMain;
...
//		new MatsimPopulationReader(sc).readFile(dir.getOutputFilename(Controler.FILENAME_POPULATION));
		...
		PtAccesibilityMain ptAcces = new PtAccesibilityMain("pt_", sc, cluster, activityCluster);
		...
		TTtripAnalysis tripAna = new TTtripAnalysis(ptModes, networkModes, "pt_", sc.getPopulation());
