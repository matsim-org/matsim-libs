...
public class CTUtilities {
	...
	public static void ConvertFacilityCoordinates(String[] args){
		...
		new PopulationReader(sc).read(input);
	...
	public static void ConvertPlanCoordinates(){
		...
		Scenario sc = ScenarioUtils.createScenario(ConfigUtils.createConfig());
		new PopulationReader(sc).read("/Volumes/Nifty/workspace/coct-data/matsim/20150930/output/ITERS/it.0/0.plans.xml.gz");
	...
	public static void checkEndTimeDuration(){
		...
		Scenario sc = ScenarioUtils.createScenario(ConfigUtils.createConfig());
		new PopulationReader(sc).read("/Volumes/Nifty/workspace/coct-data/matsim/businessCases/facilityMove/relocatedPlans_Belcon.xml.gz");
	...
	public static void generateFacilitiesFile(){
		...
		Scenario sc = ScenarioUtils.createScenario(ConfigUtils.createConfig());
		new PopulationReader(sc).read("/Volumes/Nifty/workspace/coct-data/matsim/businessCases/facilityMove/relocatedPlans_Belcon.xml.gz");
		new MatsimNetworkReader(sc.getNetwork()).read("/Volumes/Nifty/workspace/coct-data/matsim/20150930/network.xml.gz");
	...
	public static void calculateAffectedVehicleVkt(String[] args){
		...
		new PopulationReader(scBase).read(basePopulation);
		...
		new PopulationReader(scBelcon).read(belconPopulation);
		...
		new PopulationReader(scKraaicon).read(kraaiconPopulation);
