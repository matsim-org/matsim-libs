...
import playground.gregor.sim2dio.jaxb.gmlfeature.ObjectFactory;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLAbstractFeatureType;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLAbstractGeometryType;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLBoundingShapeType;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLBoxType;
...
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLLinearRingMemberType;
...
public class Sim2DEnvironmentWriter02 extends MatsimJaxbXmlWriter{
	...
	playground.gregor.sim2dio.jaxb.sim2denvironment02.ObjectFactory sim2dFac = new playground.gregor.sim2dio.jaxb.sim2denvironment02.ObjectFactory();
	...
	public void write(String filename) {
		...
		try {
			...
			JAXBContext jc = JAXBContext.newInstance(playground.gregor.sim2dio.jaxb.sim2denvironment02.ObjectFactory.class);
	...
	private XMLFeatureAssociationType getJXBSection(Section sec) {
		...
		if (sec.getNeighbors() != null) {
			...
			List<JAXBElement<String>> l = xmlNeighbors.getFID();
			for (Id id : sec.getNeighbors()) {
				JAXBElement<String> n = this.sim2dFac.createXMLNeighborsTypeFID(id.toString());
				l.add(n);
			}
