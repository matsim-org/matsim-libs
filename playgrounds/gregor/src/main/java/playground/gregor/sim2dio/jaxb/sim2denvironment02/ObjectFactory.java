 ...
 * generated in the playground.gregor.sim2dio.jaxb.sim2denvironment02 package. 
...
public class ObjectFactory {
    ...
    private final static QName _XMLNeighborsTypeFID_QNAME = new QName("http://www.matsim.org/files/dtd", "FID");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: playground.gregor.sim2dio.jaxb.sim2denvironment02
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.matsim.org/files/dtd", name = "FID", scope = XMLNeighborsType.class)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlID
    public JAXBElement<String> createXMLNeighborsTypeFID(String value) {
        return new JAXBElement<String>(_XMLNeighborsTypeFID_QNAME, String.class, XMLNeighborsType.class, value);
    }
