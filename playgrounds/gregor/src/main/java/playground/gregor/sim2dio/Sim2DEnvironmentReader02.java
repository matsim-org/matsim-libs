...
package playground.gregor.sim2dio;
...
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLAbstractFeatureType;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLBoundingShapeType;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLCoordType;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLCoordinatesType;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLFeatureAssociationType;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLLinearRingType;
import playground.gregor.sim2dio.jaxb.gmlfeature.XMLPolygonType;
import playground.gregor.sim2dio.jaxb.sim2denvironment02.XMLFeatureCollectionType;
import playground.gregor.sim2dio.jaxb.sim2denvironment02.XMLNeighborsType;
import playground.gregor.sim2dio.jaxb.sim2denvironment02.XMLOpeningsType;
import playground.gregor.sim2dio.jaxb.sim2denvironment02.XMLSectionPropertyType;
import playground.gregor.sim2dio.jaxb.sim2denvironment02.XMLSim2DEnvironmentSectionType;
...
public class Sim2DEnvironmentReader02  extends MatsimJaxbXmlParser{
	...
	public Sim2DEnvironmentReader02(Sim2DEnvironment env, String schemaLocation, boolean isValidating) {
		super(schemaLocation);
		this.env = env;
		this.isValidating = isValidating;
	}

	public Sim2DEnvironmentReader02(Sim2DEnvironment env, boolean isValidating) {
	...
	public void readFile(String filename) throws UncheckedIOException {
		...
		try {
			jc = JAXBContext.newInstance(playground.gregor.sim2dio.jaxb.sim2denvironment02.ObjectFactory.class);
...
//				System.out.println(crs.getName());
	...
	private Id[] getNeighbors(XMLSectionPropertyType ff) {
		...
		Id [] ret = new Id[xmlNeighbors.getFID().size()];
		int idx = 0;
		for (JAXBElement<String> jxbNeighbor : xmlNeighbors.getFID() ) {
