...
public class RingRoadBiMultiLane {
	...
	public static final class Setting {
		...
		public Setting(double rho1, double rho2, int lanes, double sideLength, int rounds) {
			this.rho1 = rho1;
			this.rho2 = rho2;
			this.lanes = lanes;
		...
		public String toString() {
			...
			return "rho1: " + this.rho1 + " rho2: " + this.rho2 + " lanes: " + this.lanes + " sideLength: " + this.sideLength + " rounds: " + this.rounds;
		}
	}
...
//				sc.addScenarioElement(Sim2DScenario.ELEMENT_NAME, sc2d);
				...
				Node n2 = fac.createNode(Id.createNodeId("2"), new Coord(l, l));
				Node n3 = fac.createNode(Id.createNodeId("3"), new Coord((double) 0, l));
				net.addNode(n3);
				net.addNode(n2);
				net.addNode(n1);
				net.addNode(n0);
				...
				Link l3 = fac.createLink(Id.createLinkId("3"), n3, n0);
				Link l3rev = fac.createLink(Id.createLinkId("3rev"), n0, n3);
