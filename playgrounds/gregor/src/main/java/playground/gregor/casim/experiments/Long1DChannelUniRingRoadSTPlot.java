...
public class Long1DChannelUniRingRoadSTPlot {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int R = 12; R <= 12; R++) {
			...
			try {
				...
				// "/Users/laemmel/devel/bipedca/ant/new_ring_rd_uni_sph_"
				// + R)));
				bw = new BufferedWriter(new FileWriter(new File(
			...
			Link l1rev = fac.createLink(Id.createLinkId("1rev"), n0, n1);
	...
	private static void runIt(Network net, List<Link> linksLR, Scenario sc,
		...
		try {
			monitor.addSpaceTimePlotter(new BufferedWriter(new FileWriter(
					new File(
							"/Users/laemmel/devel/bipedca/ant/space_time_rr_sph_"
									+ CASingleLaneDensityEstimatorSPH.H
									+ "_load_" + th))),
