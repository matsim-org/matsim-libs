...
public class CALink implements CANetworkEntity{
	...
	private double vHat = 1.26; //cells per unit time
	private final double rhoHat = 5.091; //particles per meter
//	private double D = 0.72;
	...
	private final CANode ds;

	private final CANode us;
...
//		System.out.println("up");
	...
	/*package*/ void fireUpstreamLeft(CAAgent a, double time) {
...
//			throw new RuntimeException("inconsisten network!");
	...
	/*package*/ CAAgent[] getParticles() {
		return this.particles;
	}

	/*package*/ double[] getTimes() {
		return this.time;
	}
