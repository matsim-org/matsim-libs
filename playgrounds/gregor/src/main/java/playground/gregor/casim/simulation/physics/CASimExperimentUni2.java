...
public class CASimExperimentUni2 {
	...
	public static void main(String [] args) {
		...
		for (double rho = 0.1; rho <= 1; rho+=0.1) {
			...
			for (int i = 0; i < 100; i++) {
				runIt(net,rho,links,monitor,sc);
				monitor.reset(0);
			}
		}
	...
	private static void runIt(Network net, double rho, List<Link> links, CALinkMonitor monitor, Scenario sc) {
		//visualization stuff
