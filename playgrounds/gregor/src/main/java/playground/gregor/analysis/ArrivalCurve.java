...
public class ArrivalCurve implements AgentArrivalEventHandler{
	...
	public static void main(String [] args) {
		String events = "/Users/laemmel/devel/crisscross/output/ITERS/it.0/0.events.xml.gz";
		EventsManager mgr = EventsUtils.createEventsManager();
		
		BufferedWriter w = null;
		try {
			w = new BufferedWriter(new FileWriter(new File("/Users/laemmel/devel/crisscross/dbg/arr")));
		} catch (IOException e) {
