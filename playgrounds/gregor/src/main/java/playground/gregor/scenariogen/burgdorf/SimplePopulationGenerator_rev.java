...
public class SimplePopulationGenerator_rev {
	public static void main(String [] args) {
		...
		for (int i = 0; i < nrAgents; i++) {
			...
			act0 = fac.createActivityFromLinkId("origin", new IdImpl("sim2d_"+ mod + "_" + rev + "-11046"));
			act0.setEndTime(t);
			...
			act1 = fac.createActivityFromLinkId("destination", new IdImpl("sim2d_"+ mod + "_" + rev + "-11060"));
			...
			act02 = fac.createActivityFromLinkId("origin", new IdImpl("sim2d_"+ mod2 + "_" + rev2 + "-11046"));
			act02.setEndTime(t);
			...
			Activity act12;// = fac.createActivityFromLinkId("destination", new IdImpl("sim2d_0_rev_-11026"));
			mod2 = MatsimRandom.getRandom().nextInt(11);
			rev2 = MatsimRandom.getRandom().nextBoolean() ? "rev_" : "";
			act12 = fac.createActivityFromLinkId("destination", new IdImpl("sim2d_"+ mod2 + "_" + rev2 + "-11058"));
...
//				int mod = MatsimRandom.getRandom().nextInt(4);
//				String rev = MatsimRandom.getRandom().nextBoolean() ? "rev_" : "";
//				act0 = fac.createActivityFromLinkId("origin", new IdImpl("sim2d_"+ mod + "_" + rev + "-19535"));
//				act0.setEndTime(t);
//				plan.addActivity(act0);
//				Leg leg = fac.createLeg("car");
//				plan.addLeg(leg);
...
//				mod = MatsimRandom.getRandom().nextInt(11);
//				rev = MatsimRandom.getRandom().nextBoolean() ? "rev_" : "";
//				act1 = fac.createActivityFromLinkId("destination", new IdImpl("sim2d_"+ mod + "_" + rev + "-11260"));
//				plan.addActivity(act1);
//				pop.addPerson(pers);
////				t += .5;
////				if ((i+1)%(960) == 0) {
