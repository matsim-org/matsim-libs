...
public class RunAgain {
	...
	private static final String NEW_DIR = "/Users/laemmel/tmp/runagain/";
...
//		dropDepTimes(sc.getPopulation());
		...
		Analyzer.main(new String[]{NEW_DIR + "/output/ITERS/it.0/0.events.xml.gz", "/Users/laemmel/arbeit/papers/2015/TRBwFZJ/hybridsim_trb2016/analysis/runagain-vehicles_plot_data"});
