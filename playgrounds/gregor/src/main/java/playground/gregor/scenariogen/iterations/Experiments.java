...
//			Id[] nb = new Id[]{Id.create("s7", Section.class)};
		...
		}
		{
			...
			double flow = WIDTH *MAX_FLOW;
			l.setFreespeed(1.34);
			double dist = CoordUtils.calcEuclideanDistance(n6.getCoord(), n10.getCoord());
			l.setLength(dist);
			l.setCapacity(flow);;
			Set<String> modes = new HashSet<String>();
			modes.add("walk2d");modes.add("walk");modes.add("car");
		...
		}
		{
			...
			double flow = WIDTH *MAX_FLOW;
			l.setFreespeed(1.34);
			double dist = CoordUtils.calcEuclideanDistance(n11.getCoord(), n10.getCoord());
			l.setLength(dist);
			l.setCapacity(flow);;
			Set<String> modes = new HashSet<String>();
			modes.add("walk2d");modes.add("walk");modes.add("car");
		...
		}
		{
			...
			double flow = WIDTH *MAX_FLOW;
			l.setFreespeed(1.34);
			double dist = CoordUtils.calcEuclideanDistance(n12.getCoord(), n13.getCoord());
			l.setLength(dist);
			l.setCapacity(flow);;
			Set<String> modes = new HashSet<String>();
			modes.add("walk2d");modes.add("walk");modes.add("car");
		...
		}
		{
			...
			double flow = WIDTH *MAX_FLOW;
			l.setFreespeed(1.34);
			double dist = CoordUtils.calcEuclideanDistance(n9.getCoord(), n13.getCoord());
			l.setLength(dist);
			l.setCapacity(flow);;
			Set<String> modes = new HashSet<String>();
			modes.add("walk2d");modes.add("walk");modes.add("car");
