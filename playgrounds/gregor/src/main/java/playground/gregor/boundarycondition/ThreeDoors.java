...
//		createNetworkChangeEvents(sc);
	...
	private static void create2DWorld(Sim2DScenario sc2) {
		...
		NodeImpl n0 = fac.createNode(new IdImpl("n0"), new CoordImpl(0,37));
		NodeImpl n1 = fac.createNode(new IdImpl("n1"), new CoordImpl(15,37));
		NodeImpl n2 = fac.createNode(new IdImpl("n2"), new CoordImpl(20,37));
		NodeImpl n3 = fac.createNode(new IdImpl("n3"), new CoordImpl(19,3));
		NodeImpl n4 = fac.createNode(new IdImpl("n4"), new CoordImpl(20,3));
		net.addNode(n0);
		net.addNode(n1);
		net.addNode(n2);
		net.addNode(n3);
		...
		{
			Link l = fac.createLink(id3, n3, n4);
			double flow = width *SEPC_FLOW;
			l.setFreespeed(1.34);
			l.setLength(1);
			l.setCapacity(flow);;
		...
		{
			Link l = fac.createLink(id3Rev, n4, n3);
			double flow = width *SEPC_FLOW;
			l.setFreespeed(1.34);
			l.setLength(1);
			l.setCapacity(flow);;
