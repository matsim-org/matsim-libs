...
public class Sim2DEnvironmentWriter02 extends MatsimJaxbXmlWriter{

	private static final Logger log = Logger.getLogger(Sim2DEnvironmentWriter02.class);
	...
	playground.gregor.sim2d_v4.io.jaxb.sim2denvironment02.ObjectFactory sim2dFac = new playground.gregor.sim2d_v4.io.jaxb.sim2denvironment02.ObjectFactory();

	public Sim2DEnvironmentWriter02(Sim2DEnvironment env) {
		this.env = env;
	}
	...
	public void write(String filename) {
		...
		try {
			...
			JAXBContext jc = JAXBContext.newInstance(playground.gregor.sim2d_v4.io.jaxb.sim2denvironment02.ObjectFactory.class);
