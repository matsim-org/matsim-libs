...
//			ll.b=0;
//			ll.a=255;
//			ll.x0 = (float) ((l.getFromNode().getCoord().getX())+dy*width/2);
//			ll.x1 = (float) ((l.getToNode().getCoord().getX())+dy*width/2);
//			ll.y0 = (float) ((l.getFromNode().getCoord().getY())-dx*width/2);
//			ll.y1 = (float) ((l.getToNode().getCoord().getY())-dx*width/2);
//			ll.weight = (float) width;
//
//			info.w = ll;
//
//			Text t = new Text();
//			t.x = (float) (l.getCoord().getX() + 1.5*width*dy);
//			t.y = (float) (l.getCoord().getY() - 1.5*width*dx);
//			info.t = t;
//			t.minScale = 8;
//			t.r = t.g = t.b = 0;
//			t.text = "0";
