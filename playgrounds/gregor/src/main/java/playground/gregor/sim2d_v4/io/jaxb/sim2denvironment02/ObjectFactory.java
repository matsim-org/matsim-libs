...
public class ObjectFactory {
    ...
    private final static QName _XMLNeighborsTypeNeighborsIds_QNAME = new QName("http://www.matsim.org/files/dtd", "neighborsIds");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.matsim.org/files/dtd", name = "neighborsIds", scope = XMLNeighborsType.class)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlID
    public JAXBElement<String> createXMLNeighborsTypeNeighborsIds(String value) {
        return new JAXBElement<String>(_XMLNeighborsTypeNeighborsIds_QNAME, String.class, XMLNeighborsType.class, value);
    }
