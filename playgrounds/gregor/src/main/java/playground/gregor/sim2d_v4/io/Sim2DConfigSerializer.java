...
public class Sim2DConfigSerializer extends MatsimJaxbXmlWriter {
	
	private static final Logger log = Logger.getLogger(Sim2DConfigSerializer.class);
...
//	public static final String SCHEMA = "http://matsim.org/files/dtd/sim2DConfig_v0.1.xsd";
	...
	public Sim2DConfigSerializer(Sim2DConfig conf) {
		this.conf = conf;
	}
