...
import playground.gregor.sim2d_v3.ghostpopulation.GhostPopulationEngine;
import playground.gregor.sim2d_v3.helper.UTurnRemover;
...
public class PeekabotVisController extends Controller2D{
	...
	protected void loadData() {
		...
		Sim2DConfigGroup s2d = (Sim2DConfigGroup) this.config.getModule("sim2d");
		this.vis.setFloorShapeFile(s2d.getFloorShapeFile());
