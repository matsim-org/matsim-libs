...
/**
 * <p>Java class for CrossReferencePropertyType complex type.
 * 
 ...
 *         &lt;element ref="{urn:x-inspire:specification:gmlas:Network:3.2}CrossReference"/>
 *       &lt;/sequence>
...
@XmlType(name = "CrossReferencePropertyType", propOrder = {
    "crossReference"
})
public class CrossReferencePropertyType {

    @XmlElement(name = "CrossReference")
    protected CrossReferenceType crossReference;
    @XmlAttribute
     ...
     *     
     */
    public void setCrossReference(CrossReferenceType value) {
