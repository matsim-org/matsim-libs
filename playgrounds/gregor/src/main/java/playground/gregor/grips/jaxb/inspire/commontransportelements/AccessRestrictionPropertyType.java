...
/**
 * <p>Java class for AccessRestrictionPropertyType complex type.
 * 
 ...
 *         &lt;element ref="{urn:x-inspire:specification:gmlas:CommonTransportElements:3.0}AccessRestriction"/>
 *       &lt;/sequence>
...
@XmlType(name = "AccessRestrictionPropertyType", propOrder = {
    "accessRestriction"
})
public class AccessRestrictionPropertyType {

    @XmlElement(name = "AccessRestriction")
    protected AccessRestrictionType accessRestriction;
    @XmlAttribute
     ...
     *     
     */
    public void setAccessRestriction(AccessRestrictionType value) {
        this.accessRestriction = value;
    }

    public boolean isSetAccessRestriction() {
