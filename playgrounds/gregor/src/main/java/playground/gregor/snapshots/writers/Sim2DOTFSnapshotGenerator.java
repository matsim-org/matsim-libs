...
public class Sim2DOTFSnapshotGenerator {
	...
	// public static String RUNS_SVN =
	// "../../../../../arbeit/svn/runs-svn/run1020/output";
	public static String RUNS_SVN = "/home/laemmel/devel/sim2d/output";
	// public static String RUNS_SVN =
	// "../../../matsim/test/output/org/matsim/evacuation/run/ShelterEvacuationControllerTest/testShelterEvacuationController";
	...
	public Sim2DOTFSnapshotGenerator() {
		...
		// if (this.scenario.getConfig().evacuation().getEvacuationScanrio() ==
		// EvacuationScenario.night ||
		// this.scenario.getConfig().evacuation().getEvacuationScanrio() ==
		// EvacuationScenario.from_file) {
		// this.startTime = 3 * 3600.;
		// this.scenario.getConfig().simulation().setEndTime(5*3600);
		// } else if
		// (this.scenario.getConfig().evacuation().getEvacuationScanrio() ==
		// EvacuationScenario.day) {
		// this.startTime = 12 * 3600.;
		// this.scenario.getConfig().simulation().setEndTime(14*3600);
		// } else if
		// (this.scenario.getConfig().evacuation().getEvacuationScanrio() ==
		// EvacuationScenario.afternoon) {
	...
	public void run() {
		...
		// this.scenario.getNetwork().getFactory().createNode(new
		// IdImpl("minXY"), new CoordImpl(643000,9870000)));//HACK to get the
		// bounding box big enough;
		// otherwise we could get negative openGL coords since we calculating
		// offsetEast, offsetNorth based on this bounding box
