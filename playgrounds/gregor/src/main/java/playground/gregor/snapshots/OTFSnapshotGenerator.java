...
public class OTFSnapshotGenerator {
	...
	public void run() {
		...
		// SimpleBackgroundTextureDrawer sbgII = new
		// SimpleBackgroundTextureDrawer("./res/arrow.png");
		// SimpleBackgroundTextureDrawer sbgIII = new
		// SimpleBackgroundTextureDrawer("./res/blocked.png");
		// WrongDirectionArrowsFromEvents w = new
		// WrongDirectionArrowsFromEvents(sbgII,sbgIII,this.scenario.getNetwork());
