...
extends      BinTree
//implements   TraversableSortedContainer<Interval>
{
/***  data  ******************************************************************/
...
/***  get methods  ***********************************************************/
     ...
     */
    protected BinTreeNode _findParentFor ( Interval obj )
    {
     ...
     */
    public Interval contains ( Interval obj )
    {
	if ( isEmpty() )
	    return null ;
     ...
     * @return object in tree with same key as given object, null otherwise
     */
    public Interval contains ( int t )
    {
    	if ( isEmpty() )
    		return null ;
     ...
     */
    protected BinTreeNode _nodeToDelete ( Interval obj )
    {
	BinTreeNode parent = _findParentFor( obj ) ;               // "parent" of obj
	...
	else
	{
	    ...
	    Interval tempobj = node.obj ;       // interchange objects
