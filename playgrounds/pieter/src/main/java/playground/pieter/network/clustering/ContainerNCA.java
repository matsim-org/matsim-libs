...
public class ContainerNCA extends NodeClusteringAlgorithm {
	...
	private ContainerNCA(Network network, String linkMethodName,
	...
	private ContainerNCA(Network network) {
...
//		nwr.readFile("f:/matsimWorkspace/matsim/examples/siouxfalls/network-wo-dummy-node.xml");
		 ...
		 ContainerNCA nca = new ContainerNCA(scenario.getNetwork(),
		...
		ContainerNCA nca2 = new ContainerNCA(
				scenario.getNetwork());
