...
//					- nc.getChild2().getInternalFlow();
	...
	public static void main(String[] args) {
		String fileName = "f:/TEMP/zurichmindeltaoutlinks.txt";
...
//		 nwr.readFile("data/singaporev1/network/planningNetwork_CLEAN.xml");
		 IntraMinDeltaAvgOutLinksNCA nca = new IntraMinDeltaAvgOutLinksNCA(scenario.getNetwork(),
		...
		IntraMinDeltaAvgOutLinksNCA nca2 = new IntraMinDeltaAvgOutLinksNCA(
				scenario.getNetwork());
