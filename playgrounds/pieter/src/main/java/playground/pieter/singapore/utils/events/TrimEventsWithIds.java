...
public class TrimEventsWithIds implements EventWriter, BasicEventHandler {
	private BufferedWriter out = null;
	private TreeSet<String> sampledIds;
	...
	public TrimEventsWithIds(final String filename, TreeSet<String> sampledIds) {
		init(filename);
