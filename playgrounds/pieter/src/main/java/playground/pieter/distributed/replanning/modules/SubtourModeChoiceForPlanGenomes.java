 ...
 *
 */
public class SubtourModeChoiceForPlanGenomes extends AbstractMultithreadedModule {
    private PermissibleModesCalculator permissibleModesCalculator;

    private final String[] chainBasedModes;
    private final String[] modes;

    public SubtourModeChoiceForPlanGenomes(final Config config) {
    ...
    public SubtourModeChoiceForPlanGenomes(
