...
public class SlavePopulationReaderMatsimV5 extends MatsimXmlParser implements PopulationReader {
    ...
    private final List<String> idStrings;
    ...
    public SlavePopulationReaderMatsimV5(final Scenario scenario, List<String> idStrings) {
...
//        skip if this guy is not in th elist of idStrings
        if (!idStrings.contains(atts.getValue(ATTR_PERSON_ID)))
            return;
