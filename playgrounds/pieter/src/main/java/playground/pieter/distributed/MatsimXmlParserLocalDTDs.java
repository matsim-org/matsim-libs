 ...
 * @author mrieser
 */
public abstract class MatsimXmlParserLocalDTDs extends DefaultHandler {

	private static final Logger log = Logger.getLogger(MatsimXmlParserLocalDTDs.class);
	 ...
	 */
	public MatsimXmlParserLocalDTDs() {
		this(true);
	}

	public MatsimXmlParserLocalDTDs(final boolean validateXml) {
