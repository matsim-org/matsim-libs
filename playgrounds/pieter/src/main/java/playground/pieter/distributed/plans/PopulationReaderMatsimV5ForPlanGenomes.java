 ...
 * @author balmermi
 */
public class PopulationReaderMatsimV5ForPlanGenomes extends MatsimXmlParser implements PopulationReader {
	...
	private PersonForPlanGenomes currperson = null;
	private PlanGenome currplan = null;
	...
	public PopulationReaderMatsimV5ForPlanGenomes(final Scenario scenario) {
	...
	private void startPerson(final Attributes atts) {
		...
		this.currperson = new PersonForPlanGenomes(Id.create(atts.getValue(ATTR_PERSON_ID), Person.class));
...
//                        		getBeelineDistanceFactor();
	...
	private void startRoute(final Attributes atts) {
		...
		this.currRoute = this.scenario.getPopulation().getFactory().createRoute(
