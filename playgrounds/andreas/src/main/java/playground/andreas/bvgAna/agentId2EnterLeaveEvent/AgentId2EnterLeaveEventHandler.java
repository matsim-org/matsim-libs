...
package playground.andreas.bvgAna.agentId2EnterLeaveEvent;
 ...
 *
 */
public class AgentId2EnterLeaveEventHandler implements PersonEntersVehicleEventHandler, PersonLeavesVehicleEventHandler{
	
	private final Logger log = Logger.getLogger(AgentId2EnterLeaveEventHandler.class);
	...
	public AgentId2EnterLeaveEventHandler(Set<Id> agentIds){
