...
public class PopGeoFilter extends NewPopulation implements TabularFileHandler {
	...
	public static void main(final String[] args) {
		...
		MutableScenario bigScenario = (MutableScenario) ScenarioUtils.createScenario(ConfigUtils.createConfig());
...
//		new MatsimNetworkReader(bigScenario).readFile(wholeBigNetworkFile);
		...
		MatsimPopulationReader popReader = new PopulationReader(new SharedNetScenario(bigScenario, wholeRoutedPop));
		...
		MatsimPopulationReader origPopReader = new PopulationReader(new SharedNetScenario(bigScenario, unroutedWholePop));
