...
//		new MatsimNetworkReader(network).readFile(netFilename);
		...
		Activity act = PopulationUtils.createActivityFromCoord("whatever", new Coord((double) 4579260, (double) 5841710));
		actList.add(act);
		act = PopulationUtils.createActivityFromCoord("whatever", new Coord((double) 4579260, (double) 5841710));
		actList.add(act);

		Activity act2 = PopulationUtils.createActivityFromCoord("whatever2", new Coord((double) 4579260, (double) 5841710));
		actList.add(act2);
