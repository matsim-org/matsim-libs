 ...
 *
 */
public class MATSim4UrbanSimConfigurationConnector {
	
	// logger
	private static final Logger log = Logger.getLogger(MATSim4UrbanSimConfigurationConnector.class);
	 ...
	 */
	public MATSim4UrbanSimConfigurationConnector(ScenarioImpl scenario, MatsimConfigType matsimConfig){
	 ...
	 */
	public MATSim4UrbanSimConfigurationConnector(ScenarioImpl scenario, String matsimConfiFile){
	...
	private void initMATSim4UrbanSimParameter(Matsim4UrbansimType matsim4UrbanSimParameter){
		...
		scenario.getConfig().setParam(Constants.MATSIM_4_URBANSIM_PARAM, Constants.BETA_BRAIN, 1 + "");
		...
		log.info("Beta: " + scenario.getConfig().getParam(Constants.MATSIM_4_URBANSIM_PARAM, Constants.BETA_BRAIN) );
