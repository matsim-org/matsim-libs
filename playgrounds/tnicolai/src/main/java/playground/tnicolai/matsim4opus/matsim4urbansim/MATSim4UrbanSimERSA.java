...
import playground.tnicolai.matsim4opus.gis.SpatialGridTableWriter;
...
//			modifyLinks( ((NetworkImpl)scenario.getNetwork()), capacity);
	...
	private ERSAControlerListener initAndAddControlerListener(ActivityFacilitiesImpl parcels,
		...
		ZoneLayer<ZoneAccessibilityObject> startZones = createGridLayerByGridSize(gridSizeInFeet, boundary);
