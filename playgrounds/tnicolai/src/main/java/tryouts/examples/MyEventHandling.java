...
public class MyEventHandling {
	...
	public static void main(String[] args) {
		...
		//path to events file
		String inputFile = "/Users/thomas/Development/workspace/matsim/output/example5-2000agents_v1/ITERS/it.50/50.events.xml.gz";
...
//		System.out.println("Avarage travel time for 2000 agents: " + handler.getAverageTravelTime());
		...
		handler.writeChart("/Users/thomas/Development/workspace/matsim/output/example5-2000agents_v1/ITERS/it.50/chart.png");
