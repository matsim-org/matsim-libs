...
/**
 * Basic event handler that collects the relation between vehicles and carrier. Necessary since link
 * enter and leave events do not contain any information of the carrier. For the connection between
 * driver and Vehicle the {@link Vehicle2CarrierEventHandler} can be used.
 *
 * @author kturner
 */
public final class Vehicle2CarrierEventHandler
  ...
  // Is this handler ever going to be called concurrently? If not a normal HashMap is probably
  // sufficient
  // At least the default events manager guarantees single threaded invocation of your handler.
  // --> we can check this. Currently, it was made only analogous to Vehicle2DriverEventHandler  kmt
  // sep'22
