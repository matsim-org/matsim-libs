...
/**
 * A shipment from one location to another, with certain size and other constraints such as
...
public final class CarrierShipment implements Attributable {
  ...
  public static class Builder {
    ...
    /**
     * @Deprecated Please use Builder newInstance(Id<CarrierShipment> id, Id<Link> from, Id<Link>
     * to, int size) instead.
     *
     * <p>Returns a new shipment builder.
     *
     * <p>The builder is init with the shipment's origin (from), destination (to) and with the
     * shipment's size. The default-value for serviceTime is 0.0. The default-value for a timeWindow
     * is [start=0.0, end=Double.maxValue()].
     *
     * @param from
     * @param to
     * @param size
    ...
    public static Builder newInstance(
        Id<CarrierShipment> id, Id<Link> from, Id<Link> to, int size) {
    ...
    /**
     * @Deprecated Please use Builder (Id<CarrierShipment> id, Id<Link> from, Id<Link> to, int size)
     * instead.
     */
    @Deprecated
