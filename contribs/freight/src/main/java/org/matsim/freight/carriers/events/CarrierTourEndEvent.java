...
/**
 * An event, that informs when a Freight {@link Tour} has ended. There are NO specific information
...
public final class CarrierTourEndEvent extends AbstractCarrierEvent {
  ...
  public static CarrierTourEndEvent convert(GenericEvent event) {
    ...
    Id<Tour> tourId =
        Id.create(attributes.get(CarrierEventAttributes.ATTRIBUTE_TOUR_ID), Tour.class);
