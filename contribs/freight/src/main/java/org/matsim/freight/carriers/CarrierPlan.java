...
public class CarrierPlan implements BasicPlan, Attributable {
  ...
  /**
   * In future (starting in May'23) this is the score from the MATSim scoring function. The jsprit
   * score is saved in attribute. Please use the method getJspritScore() to access it.
   *
  ...
  /**
   * In future (starting in May'23) this is the score from the MATSim scoring function. The jsprit
   * score is saved in attribute. Please use the method setJspritScore() to store it.
   *
   * @return the (MATSim) score
   */
  @Override
  ...
  /**
   * Store the score from the jsprit VRP solving in an attribute of the CarrierPlan. This is _not_
   * the score from the MATSim simulation.
   */
