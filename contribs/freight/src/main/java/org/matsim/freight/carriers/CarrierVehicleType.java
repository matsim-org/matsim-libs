 ...
 *
 * <p>I decided to put vehicle cost information into the type (which is indeed not a physical
 * attribute of the type). Thus physical and non-physical attributes are used. This is likely to be
 * changed in the future.
 *
 * @author sschroeder
 */
public class CarrierVehicleType {
  // this is now really only a name space for the builder method.  There are two options where this
  // could go:
  ...
  // However, note that when moving it, the class here still needs to be available since otherwise a
  // lot of outside code will break.
  // kai, sep'19
  ...
  public static class Builder {
    ...
    /**
     * Returns a new instance of builder initialized with the typeId and the values the given from
     * existing CarrierVehicleType.
     *
     * <p>Can be used for create a new, modified CarrierVehicleType basing on an existing one.
    ...
    public static Builder newInstance(
        Id<VehicleType> typeId, CarrierVehicleType carrierVehicleType) {
