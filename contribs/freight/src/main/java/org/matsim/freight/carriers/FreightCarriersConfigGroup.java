...
public class FreightCarriersConfigGroup extends ReflectiveConfigGroup {
  ...
  private static final String CARRIERS_FILE_DESC =
  ...
  private static final String CARRIERS_VEHICLE_TYPE_DESC =
  ...
  private static final String VEHICLE_ROUTING_ALGORITHM_DESC =
      "(Optional) Vehicle Routing Algorithm File, according to jsprit library. "
          + "Empty value \"\" means a default algorithm is used.";

  @Positive private int travelTimeSliceWidth = 1800;
  static final String TRAVEL_TIME_SLICE_WIDTH = "travelTimeSliceWidth";
  private static final String TRAVEL_TIME_SLICE_WIDTH_DESC =
      "time slice width used for calculation of travel times in seconds."
          + " The smaller the value, the more precise the calculation of routing costs but the longer the computation time."
          + " Default value is 1800 seconds.";

  public enum UseDistanceConstraintForTourPlanning {
    noDistanceConstraint,
    basedOnEnergyConsumption
  }

  static final String USE_DISTANCE_CONSTRAINT = "useDistanceConstraintForTourPlanning";
  private UseDistanceConstraintForTourPlanning useDistanceConstraintForTourPlanning =
      UseDistanceConstraintForTourPlanning.noDistanceConstraint;
  private static final String USE_DISTANCE_CONSTRAINT_DESC =
  ...
  // ### TimeWindowHandling ###
  public enum TimeWindowHandling {
    ignore,
    enforceBeginnings
  }
  ...
  /**
   * Physically enforces beginnings of time windows for freight activities, i.e. freight agents wait
   * before closed doors until they can deliver / pick up their goods, and then take their required
   * duration.
   */
  ...
  public void setUseDistanceConstraintForTourPlanning(
      UseDistanceConstraintForTourPlanning useDistanceConstraintForTourPlanning) {
