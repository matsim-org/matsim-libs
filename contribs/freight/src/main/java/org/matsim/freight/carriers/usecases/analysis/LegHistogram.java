...
/**
 * It is a copy of {@link org.matsim.analysis.LegHistogram}. It is modified to include or exclude
 * persons.
 *
 * @author mrieser
 *     <p>Counts the number of vehicles departed, arrived or got stuck per time bin based on events.
 */
public class LegHistogram
  ...
  /**
   * Creates a new LegHistogram with the specified binSize and a default number of bins, such that
   * 30 hours are analyzed.
   *
   * @param binSize The size of a time bin in seconds.
   */
  ...
  /**
   * @return a graphic showing the number of departures, arrivals and vehicles en route of all
   *     legs/trips
   */
  ...
  /**
   * @param legMode
   * @return a graphic showing the number of departures, arrivals and vehicles en route for all legs
  ...
  /**
   * @param legMode transport mode
   * @return number(s) of vehicles that got stuck in a time-bin, for all legs with the specified
   *     mode
   */
   ...
   * legs/trips to the specified file.
   *
   * @param filename
   * @see #getGraphic()
   */
