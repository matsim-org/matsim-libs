...
class CarrierStrategyManagerImpl implements CarrierStrategyManager {
  ...
  public void addStrategy(
      GenericPlanStrategy<CarrierPlan, Carrier> strategy, String subpopulation, double weight) {
    delegate.addStrategy(strategy, subpopulation, weight);
  }

  @Override
  public void run(
      Iterable<? extends HasPlansAndId<CarrierPlan, Carrier>> persons,
      int iteration,
  ...
  @Override
  public void setPlanSelectorForRemoval(PlanSelector<CarrierPlan, Carrier> planSelector) {
    delegate.setPlanSelectorForRemoval(planSelector);
  }

  @Override
  public List<GenericPlanStrategy<CarrierPlan, Carrier>> getStrategies(String subpopulation) {
