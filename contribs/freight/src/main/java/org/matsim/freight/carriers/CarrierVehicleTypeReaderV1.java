  ...
  public void startTag(String name, Attributes attributes, Stack<String> context) {
    ...
    if (name.equals("engineInformation")) {
      ...
      VehicleUtils.setFuelConsumption(
          this.currentType, Double.parseDouble(attributes.getValue("gasConsumption")));
    ...
    if (name.equals("costInformation")) {
      ...
      if (fix == null || perMeter == null || perSecond == null)
        throw new IllegalStateException(
            "cannot read costInformation correctly. probably the paramName was written wrongly");
