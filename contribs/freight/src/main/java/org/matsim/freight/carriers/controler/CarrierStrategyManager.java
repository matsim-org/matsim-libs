 ...
 *
 * <ul>
 *   <li>There is a null binding of this interface in {@link CarrierModule}. If one wants to use
 ...
 *       However, since it is not there before injection, it also cannot be configured before
 ...
 *   <li>So way to configure this "in code" is to bind {@link CarrierStrategyManager} to a {@link
 *       Provider<CarrierStrategyManager>} and then configure it in the provider.
 * </ul>
 */
