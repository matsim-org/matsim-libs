...
public class CarrierShipmentDeliveryEndEvent extends AbstractCarrierEvent {
  ...
  public CarrierShipmentDeliveryEndEvent(
  ...
  public Map<String, String> getAttributes() {
    ...
    attr.put(
        CarrierEventAttributes.ATTRIBUTE_DROPOFF_DURATION, String.valueOf(this.deliveryDuration));
  ...
  public static CarrierShipmentDeliveryEndEvent convert(GenericEvent event) {
    ...
    Id<CarrierShipment> shipmentId =
        Id.create(
            attributes.get(CarrierEventAttributes.ATTRIBUTE_SHIPMENT_ID), CarrierShipment.class);
    ...
    CarrierShipment shipment =
        CarrierShipment.Builder.newInstance(shipmentId, null, shipmentTo, size)
            .setDeliveryServiceTime(
                Double.parseDouble(
                    attributes.get(CarrierEventAttributes.ATTRIBUTE_DROPOFF_DURATION)))
            .build();
