...
public class Tour {
  ...
  public static class Builder {
     ...
     *
     * @deprecated Please use {@link #newInstance(Id)} instead. kmt sep'22
     *     <p>
    ...
    /**
     * Returns a new tour builder. This now also includes an Id for this tour.
     *
     ...
     * @throws IllegalStateException if shipment is null or if shipment has already been picked up
     *     or if last element is not a leg.
     */
     ...
     *
     * @param shipment
     * @throws IllegalStateException if shipment is null or if shipment has not been picked up yet
     *     or if last element is not a leg.
     */
  ...
  public abstract static class TourElement {
    public abstract TourElement duplicate();
  }

  public abstract static class TourActivity extends TourElement {
  ...
  public abstract static class ShipmentBasedActivity extends TourActivity {
