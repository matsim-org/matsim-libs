...
public class ScheduledTour {
   ...
   *
   * <p>Look at the builder. It might be easier to build a scheduled tour. You get the builder this
   * way: ScheduledTour.Builder.newInstance(carrierVehicle).
   *
   * @param tour
   * @param vehicle
   * @param departureTime
