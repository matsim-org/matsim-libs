...
//			double marginalCost = getMarginalInsertionCosts(prevAct, nextAct, deliveryAct);
			Tour newTour = null;
			if(localConstraintsMet(prevAct, nextAct, deliveryAct)){
				newTour = buildTour(tour,shipment,i);
				double marginalCost = newTour.costs.transportCosts - tour.costs.transportCosts;	
