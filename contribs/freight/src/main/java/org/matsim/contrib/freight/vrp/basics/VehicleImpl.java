...
public class VehicleImpl implements Vehicle {
	...
	public static class Type {
		...
		public Type(String typeId, int capacity, VehicleCostParams vehicleCostParams) {
			super();
			this.typeId = typeId;
	...
	public static class Factory {
		public Type createType(String typeId, int capacity, VehicleCostParams vehicleCostParams){
			return new Type(typeId,capacity,vehicleCostParams);
		}
		public VehicleCostParams createVehicleCostParams(double fix, double perTimeUnit, double perDistanceUnit){
		...
		public VehicleImpl createtStandardVehicle(){
			return createVehicle("standard","noLocation",createType("standard",0,createVehicleCostParams(0,0,1.0)));
		}
	}
	...
	/* (non-Javadoc)
	 * @see org.matsim.contrib.freight.vrp.basics.Vehicle#setEarliestDeparture(double)
	 */
	...
	/* (non-Javadoc)
	 * @see org.matsim.contrib.freight.vrp.basics.Vehicle#setLatestArrival(double)
	 */
