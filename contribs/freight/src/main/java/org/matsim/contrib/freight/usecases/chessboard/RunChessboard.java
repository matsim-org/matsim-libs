...
public class RunChessboard {
	...
	public static void main(String[] args) {
        ...
        for(int i=0;i<nuRuns;i++) {
            final String outputDir = "output/" + i + ".run/";
            createOutputDir(outputDir);

            Config config = ConfigUtils.loadConfig("input/usecases/chessboard/passenger/config.xml");
            ...
            controler.addOverridingModule(new AbstractModule() {
                ...
                @Override
                public void install() {
                    final CarrierScoreStats scores = new CarrierScoreStats(carriers, outputDir +"/carrier_scores", true);
