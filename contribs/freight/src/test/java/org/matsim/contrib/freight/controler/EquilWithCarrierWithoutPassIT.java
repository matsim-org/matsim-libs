...
public class EquilWithCarrierWithoutPassIT {
	...
	public void testScoringInSecondsWoTimeWindowEnforcement(){
		...
		final CarrierModule carrierModule = new CarrierModule( FreightUtils.getOrCreateCarriers(controler.getScenario()) );
	...
	public void testScoringInSecondsWithWithinDayRescheduling(){
		freightConfigGroup.setPhysicallyEnforceTimeWindowBeginnings(true);
		CarrierModule carrierControler = new CarrierModule(FreightUtils.getOrCreateCarriers(controler.getScenario()));
