...
public class FixedCostsTest {
  ...
  private static final Logger log = LogManager.getLogger(FixedCostsTest.class);
  ...
  public void setUp() throws Exception {
    // Create carrier with services; service1 nearby the depot, service2 at the opposite side of the
    // network
    ...
    // carrier3: has both vehicles of Type A (no fixed costs, variable costs: 1 EUR/km) and Type B
    // (fixed costs of 10 EUR/vehicle, no variable costs)
    CarrierCapabilities cc3 =
        CarrierCapabilities.Builder.newInstance()
            .addType(carrierVehType_A)
            .addType(carrierVehType_B)
            .addVehicle(carrierVehicle_A)
  ...
  public final void test_carrier3CostsAreCorrectly() {
    Assert.assertEquals(
        ...
        carriersPlannedAndRouted
            .getCarriers()
            .get(Id.create("carrier3", Carrier.class))
            .getSelectedPlan()
            .getJspritScore(),
        MatsimTestUtils.EPSILON);
  }
