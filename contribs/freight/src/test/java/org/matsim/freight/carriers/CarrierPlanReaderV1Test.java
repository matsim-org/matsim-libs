...
/**
 * Created by IntelliJ IDEA. User: zilske Date: 10/31/11 Time: 11:46 AM To change this template use
...
public class CarrierPlanReaderV1Test {
  ...
  public void testReaderReadsUnScoredAndUnselectedPlanCorrectly() {
    ...
    CarrierPlanReaderV1 carrierPlanReaderV1 =
        new CarrierPlanReaderV1(carriers, carrierVehicleTypes);
    carrierPlanReaderV1.readFile(
        utils.getClassInputDirectory() + "carrierPlansEquils_unscored_unselected.xml");
    Carrier carrier = carriers.getCarriers().values().iterator().next();
