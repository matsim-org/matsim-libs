 ...
 *     <p>Test for the distance constraint. 4 different setups are used to control the correct
 *     working of the constraint for services
 *     <p>2 additional setups are defined when using shipments instead of service. Shipments allow
 *     reloading of good during the tour.
 */
public class DistanceConstraintTest {
  ...
  static final URL SCENARIO_URL = ExamplesUtils.getTestScenarioURL("freight-chessboard-9x9");

  /**
   * Option 1: Tour is possible with the vehicle with the small battery and the vehicle with the
   * small battery is cheaper
   *
  ...
  public final void CarrierSmallBatteryTest_Version1()
    ...
    VehicleType vehicleType_LargeV1 =
        VehicleUtils.createVehicleType(Id.create("LargeBattery_V1", VehicleType.class));
    vehicleType_LargeV1
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
        .setFixedCost(100.);
    ...
    VehicleType vehicleType_SmallV1 =
        VehicleUtils.createVehicleType(Id.create("SmallBattery_V1", VehicleType.class));
    vehicleType_SmallV1
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
    ...
    Assert.assertEquals(
        vehicleType_SmallV1.getId(),
        ((Vehicle) carrierV1.getSelectedPlan().getScheduledTours().iterator().next().getVehicle())
            .getType()
            .getId());
    double maxDistance_vehicleType_LargeV1 =
        VehicleUtils.getEnergyCapacity(vehicleType_LargeV1.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_LargeV1.getEngineInformation());
    double maxDistance_vehicleType_SmallV1 =
        VehicleUtils.getEnergyCapacity(vehicleType_SmallV1.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_SmallV1.getEngineInformation());

    Assert.assertEquals(
        "Wrong maximum distance of the tour of this vehicleType",
        30000,
        maxDistance_vehicleType_LargeV1,
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Wrong maximum distance of the tour of this vehicleType",
        30000,
        maxDistance_vehicleType_SmallV1,
        MatsimTestUtils.EPSILON);

    double distanceTour = 0.0;
    List<Tour.TourElement> elements =
        carrierV1
            .getSelectedPlan()
            .getScheduledTours()
            .iterator()
          ...
          distanceTour =
              distanceTour
                  + RouteUtils.calcDistance(
                      (NetworkRoute) legElement.getRoute(), 0, 0, scenario.getNetwork());
      }
    }
    Assert.assertEquals(
  ...
  /**
   * Option 2: Tour is not possible with the vehicle with the small battery. Thats why one vehicle
   * with a large battery is used.
   */
  @Test
  public final void CarrierLargeBatteryTest_Version2()
    ...
    VehicleType vehicleType_LargeV2 =
        VehicleUtils.createVehicleType(Id.create("LargeBattery_V2", VehicleType.class));
    vehicleType_LargeV2
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
    ...
    VehicleType vehicleType_SmallV2 =
        VehicleUtils.createVehicleType(Id.create("SmallBattery_V2", VehicleType.class));
    vehicleType_SmallV2
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
    ...
    Assert.assertEquals(
        ...
        carrierV2
            ...
            .getType()
            .getId());
    double maxDistance_vehicleType_LargeV2 =
        VehicleUtils.getEnergyCapacity(vehicleType_LargeV2.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_LargeV2.getEngineInformation());
    double maxDistance_vehicleType_SmallV2 =
        VehicleUtils.getEnergyCapacity(vehicleType_SmallV2.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_SmallV2.getEngineInformation());

    Assert.assertEquals(
        "Wrong maximum distance of the tour of this vehicleType",
        30000,
        maxDistance_vehicleType_LargeV2,
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Wrong maximum distance of the tour of this vehicleType",
        15000,
        maxDistance_vehicleType_SmallV2,
        MatsimTestUtils.EPSILON);
  ...
  /**
   * Option 3: costs for using one long range vehicle are higher than the costs of using two short
   * range truck
   */
  @Test
  public final void Carrier2SmallBatteryTest_Version3()
    ...
    VehicleType vehicleType_LargeV3 =
        VehicleUtils.createVehicleType(Id.create("LargeBattery_V3", VehicleType.class));
    vehicleType_LargeV3
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
    ...
    VehicleType vehicleType_SmallV3 =
        VehicleUtils.createVehicleType(Id.create("SmallBattery_V3", VehicleType.class));
    vehicleType_SmallV3
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
    ...
    double maxDistance_vehicleType_LargeV3 =
        VehicleUtils.getEnergyCapacity(vehicleType_LargeV3.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_LargeV3.getEngineInformation());
    double maxDistance_vehicleType_SmallV3 =
        VehicleUtils.getEnergyCapacity(vehicleType_SmallV3.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_SmallV3.getEngineInformation());

    Assert.assertEquals(
        "Wrong maximum distance of the tour of this vehicleType",
        30000,
        maxDistance_vehicleType_LargeV3,
        MatsimTestUtils.EPSILON);

    Assert.assertEquals(
        "Wrong maximum distance of the tour of this vehicleType",
        30000,
        maxDistance_vehicleType_SmallV3,
        MatsimTestUtils.EPSILON);
    ...
    for (ScheduledTour scheduledTour : carrierV3.getSelectedPlan().getScheduledTours()) {
      ...
      Assert.assertEquals(
          vehicleType_SmallV3.getId(), scheduledTour.getVehicle().getType().getId());
  ...
  /**
   * Option 4: An additional service outside the range of both BEV types. Therefore one diesel
   * vehicle must be used and one vehicle with a small battery.
   */
  @Test
  public final void CarrierWithAdditionalDieselVehicleTest_Version4()
    ...
    VehicleType vehicleType_LargeV4 =
        VehicleUtils.createVehicleType(Id.create("LargeBattery_V4", VehicleType.class));
    vehicleType_LargeV4
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
    ...
    VehicleType vehicleType_SmallV4 =
        VehicleUtils.createVehicleType(Id.create("SmallBattery_V4", VehicleType.class));
    vehicleType_SmallV4
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
    ...
    VehicleType vehicleType_Diesel =
        VehicleUtils.createVehicleType(Id.create("DieselVehicle", VehicleType.class));
    vehicleType_Diesel
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
    ...
    double maxDistance_vehicleType_Large4 =
        VehicleUtils.getEnergyCapacity(vehicleType_LargeV4.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_LargeV4.getEngineInformation());
    double maxDistance_vehicleType_SmallV4 =
        VehicleUtils.getEnergyCapacity(vehicleType_SmallV4.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_SmallV4.getEngineInformation());

    Assert.assertEquals(
        "Wrong maximum distance of the tour of this vehicleType",
        30000,
        maxDistance_vehicleType_Large4,
        MatsimTestUtils.EPSILON);

    Assert.assertEquals(
        "Wrong maximum distance of the tour of this vehicleType",
        30000,
        maxDistance_vehicleType_SmallV4,
        MatsimTestUtils.EPSILON);
    ...
    for (ScheduledTour scheduledTour : carrierV4.getSelectedPlan().getScheduledTours()) {
      ...
      if (thisTypeId.equals("SmallBattery_V4"))
        ...
        Assert.assertEquals(
            ...
            distanceTour,
            MatsimTestUtils.EPSILON);
      else Assert.fail("Wrong vehicleType used");
    }
  }

  /**
   * Option 5: This test uses shipments instead of service . As a consequence the vehicles can
   * return to the depot, load more goods and run another subtour. Distance is set to a value that,
   * due to distance restrictions, two tours are necessary.
   *
   * <p>This option (5) is designed similar to option 2
   */
  @Test
  public final void CarrierWithShipmentsMidSizeBatteryTest_Version5()
      throws ExecutionException, InterruptedException {
    Config config = ConfigUtils.createConfig();
    config.controller().setOutputDirectory(testUtils.getOutputDirectory());
    prepareConfig(config);
    ...
    VehicleType vehicleType_MidSizeV5 =
        VehicleUtils.createVehicleType(Id.create("MidSizeBattery_V5", VehicleType.class));
    vehicleType_MidSizeV5
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
        .setFixedCost(100.);
    ...
    VehicleUtils.setEnergyConsumptionKWhPerMeter(
        vehicleType_MidSizeV5.getEngineInformation(), 0.015);
    ...
    Assert.assertEquals(
        ...
        carrierV5
            ...
            .getType()
            .getId());
    double maxDistance_vehicleType_LargeV5 =
        VehicleUtils.getEnergyCapacity(vehicleType_MidSizeV5.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_MidSizeV5.getEngineInformation());

    Assert.assertEquals(
        "Wrong maximum distance of the tour of this vehicleType",
        20000,
        maxDistance_vehicleType_LargeV5,
        MatsimTestUtils.EPSILON);
    ...
    Assert.assertTrue(
        "The schedulded tour has a non expected distance", distancesOfTours.contains(12000.0));
    // The other tour has distance of 20000m
    Assert.assertTrue(
        "The schedulded tour has a non expected distance", distancesOfTours.contains(20000.0));
  }

  /**
   * Option 6: This test uses shipments instead of service . As a consequence the vehicles can
   * return to the depot, load more goods and run another subtour. Distance is set to a value that
   * one tour can be run with loading once.
   *
   * <p>This option (6) is designed similar to option 5
   */
  @Test
  public final void CarrierWithShipmentsLargeBatteryTest_Version6()
      throws ExecutionException, InterruptedException {
    Config config = ConfigUtils.createConfig();
    config.controller().setOutputDirectory(testUtils.getOutputDirectory());
    prepareConfig(config);
    ...
    VehicleType vehicleType_LargeV5 =
        VehicleUtils.createVehicleType(Id.create("LargeBattery_V5", VehicleType.class));
    vehicleType_LargeV5
        .getCostInformation()
        .setCostsPerMeter(0.00055)
        .setCostsPerSecond(0.008)
    ...
    Assert.assertEquals(
        ...
        carrierV5
            ...
            .getId());
    double maxDistance_vehicleType_LargeV5 =
        VehicleUtils.getEnergyCapacity(vehicleType_LargeV5.getEngineInformation())
            / VehicleUtils.getEnergyConsumptionKWhPerMeter(
                vehicleType_LargeV5.getEngineInformation());
    ...
    Assert.assertTrue(
        "The schedulded tour has a non expected distance", distancesOfTours.contains(24000.0));
  }
  ...
  static void prepareConfig(Config config) {
    ...
    freightCarriersConfigGroup.setUseDistanceConstraintForTourPlanning(
        UseDistanceConstraintForTourPlanning.basedOnEnergyConsumption);
  }

  private static Carrier addTwoServicesToCarrier(Carrier carrier) {
    // Service 1
    CarrierService service1 =
        CarrierService.Builder.newInstance(
                Id.create("Service1", CarrierService.class), Id.createLinkId("j(3,8)"))
            .setServiceDuration(20)
            .setServiceStartTimeWindow(TimeWindow.newInstance(8 * 3600, 10 * 3600))
            .setCapacityDemand(40)
            .build();
    CarriersUtils.addService(carrier, service1);

    // Service 2
    CarrierService service2 =
        CarrierService.Builder.newInstance(
                Id.create("Service2", CarrierService.class), Id.createLinkId("j(0,3)R"))
            .setServiceDuration(20)
            .setServiceStartTimeWindow(TimeWindow.newInstance(8 * 3600, 10 * 3600))
            .setCapacityDemand(40)
            .build();
  ...
  private static Carrier addTwoShipmentsToCarrier(Carrier carrier) {
    // Shipment 1
    CarrierShipment shipment1 =
        CarrierShipment.Builder.newInstance(
                Id.create("Shipment1", CarrierShipment.class),
                Id.createLinkId("i(1,8)"),
                Id.createLinkId("j(3,8)"),
                40)
            .setDeliveryServiceTime(20)
            .setDeliveryTimeWindow(TimeWindow.newInstance(8 * 3600, 12 * 3600))
            .build();
    CarriersUtils.addShipment(carrier, shipment1);

    // Shipment 2
    CarrierShipment shipment2 =
        CarrierShipment.Builder.newInstance(
                Id.create("Shipment2", CarrierShipment.class),
                Id.createLinkId("i(1,8)"),
                Id.createLinkId("j(0,3)R"),
                40)
            .setDeliveryServiceTime(20)
            .setDeliveryTimeWindow(TimeWindow.newInstance(8 * 3600, 12 * 3600))
            .build();
  ...
  private static Carrier addThreeServicesToCarrier(Carrier carrier) {
    ...
    // Service 3
    CarrierService service3 =
        CarrierService.Builder.newInstance(
                Id.create("Service3", CarrierService.class), Id.createLinkId("j(9,2)"))
            .setServiceDuration(20)
            .setServiceStartTimeWindow(TimeWindow.newInstance(8 * 3600, 10 * 3600))
            .setCapacityDemand(40)
            .build();
  ...
  /**
   * Creates the vehicle at the depot, ads this vehicle to the carriers and sets the capabilities.
   * Sets TimeWindow for the carriers.
   *
   * @param
   */
      ...
      if (singleCarrier.getId().toString().equals(singleVehicleType.getDescription()))
        vehicles.add(
            createCarrierVehicle(
                singleVehicleType.getId().toString(),
  ...
  static CarrierVehicle createCarrierVehicle(
      String vehicleName,
      double earliestStartingTime,
      double latestFinishingTime,
      VehicleType singleVehicleType) {

    return CarrierVehicle.Builder.newInstance(
            Id.create(vehicleName, Vehicle.class), Id.createLinkId("i(1,8)"), singleVehicleType)
        .setEarliestStart(earliestStartingTime)
        .setLatestEnd(latestFinishingTime)
        .build();
  }
   ...
   * @param
   */
  private static void defineCarriers(
      Carriers carriers,
      FleetSize fleetSize,
      Carrier singleCarrier,
    ...
    singleCarrier.setCarrierCapabilities(
        CarrierCapabilities.Builder.newInstance().setFleetSize(fleetSize).build());
    ...
    singleCarrier
        ...
        .getVehicleTypes()
        .addAll(vehicleTypes.getVehicleTypes().values());
