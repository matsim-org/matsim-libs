...
public class NetworkBasedTransportCostsTest {
  ...
  public void test_whenAddingTwoDifferentVehicleTypes_itMustAccountForThem() {
    ...
    com.graphhopper.jsprit.core.problem.vehicle.VehicleType type1 =
        mock(com.graphhopper.jsprit.core.problem.vehicle.VehicleType.class);
    ...
    com.graphhopper.jsprit.core.problem.vehicle.VehicleType type2 =
        mock(com.graphhopper.jsprit.core.problem.vehicle.VehicleType.class);
    ...
    Assert.assertEquals(
        20000.0,
        c.getTransportCost(
            Location.newInstance("20"),
            Location.newInstance("21"),
            0.0,
            mock(Driver.class),
            vehicle1),
        0.01);
    ...
    Assert.assertEquals(
        20000.0,
        c.getDistance(Location.newInstance("6"), Location.newInstance("21"), 0.0, vehicle1),
        0.01);
    Assert.assertEquals(
        20000.0,
        c.getDistance(Location.newInstance("6"), Location.newInstance("21"), 0.0, vehicle2),
        0.01);
  }
  ...
  public void test_whenAddingTwoVehicleTypesViaConstructor_itMustAccountForThat() {
    ...
    VehicleType vehType1 =
        VehicleUtils.getFactory().createVehicleType(Id.create("type1", VehicleType.class));
    ...
    VehicleType vehType2 =
        VehicleUtils.getFactory().createVehicleType(Id.create("type2", VehicleType.class));
    ...
    Assert.assertEquals(
        20000.0,
        networkBasedTransportCosts.getTransportCost(
            Location.newInstance("20"),
            Location.newInstance("21"),
            0.0,
            mock(Driver.class),
    ...
    Assert.assertEquals(
        20000.0,
        networkBasedTransportCosts.getDistance(
            Location.newInstance("6"), Location.newInstance("21"), 0.0, vehicle1),
        0.01);
    Assert.assertEquals(
        20000.0,
        networkBasedTransportCosts.getDistance(
            Location.newInstance("6"), Location.newInstance("21"), 0.0, vehicle2),
        0.01);
  }
}
