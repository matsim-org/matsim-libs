...
class ExampleMultipleTwoEchelonChainsReplanningTest {
	static Logger log = LogManager.getLogger(ExampleMultipleTwoEchelonChainsReplanningTest.class);
	...
	void testMain() {
...

		{
			...
			PopulationUtils.readPopulation(expected, utils.getClassInputDirectory() + "output_plans.xml.gz");
