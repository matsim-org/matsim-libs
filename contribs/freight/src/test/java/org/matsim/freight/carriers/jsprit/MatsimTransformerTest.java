...
public class MatsimTransformerTest {
  ...
  public void whenTransforming_jSpritType2matsimType_itIsMadeCorrectly() {
    com.graphhopper.jsprit.core.problem.vehicle.VehicleType jspritType =
        VehicleTypeImpl.Builder.newInstance("myType")
            .addCapacityDimension(0, 50)
            .setCostPerDistance(10.0)
            .setCostPerTransportTime(5.0)
            .setFixedCost(100.0)
            .build();
  ...
  public void whenTransforming_matsimType2jSpritType_itIsMadeCorrectly() {
    ...
    com.graphhopper.jsprit.core.problem.vehicle.VehicleType jspritType =
        MatsimJspritFactory.createJspritVehicleType(matsimType);
  ...
  public void whenTransforming_jspritVehicle2matsimVehicle_itIsMadeCorrectly() {
    ...
    Vehicle jspritVehicle =
        VehicleImpl.Builder.newInstance("myVehicle")
            .setEarliestStart(10.0)
            .setLatestArrival(20.0)
            .setStartLocation(Location.newInstance("loc"))
            .setType(jspritType)
            .build();
  ...
  public void whenTransforming_matsimService2jspritService_isMadeCorrectly() {
    CarrierService carrierService =
        CarrierService.Builder.newInstance(
                Id.create("serviceId", CarrierService.class), Id.create("locationId", Link.class))
            .setCapacityDemand(50)
            .setServiceDuration(30.0)
            .setServiceStartTimeWindow(TimeWindow.newInstance(10.0, 20.0))
            .build();
  ...
  public void whenTransforming_jspritService2matsimService_isMadeCorrectly() {
    Service carrierService =
        Service.Builder.newInstance("serviceId")
            .addSizeDimension(0, 50)
            .setLocation(Location.newInstance("locationId"))
            .setServiceTime(30.0)
            .setTimeWindow(
  ...
  public void whenTransforming_matsimShipment2jspritShipment_isMadeCorrectly() {
    CarrierShipment carrierShipment =
        CarrierShipment.Builder.newInstance(
                Id.create("ShipmentId", CarrierShipment.class),
                Id.createLinkId("PickupLocationId"),
                Id.createLinkId("DeliveryLocationId"),
                50)
  ...
  public void whenTransforming_jspritShipment2matsimShipment_isMadeCorrectly() {
    Shipment shipment =
        Shipment.Builder.newInstance("shipmentId")
            .addSizeDimension(0, 50)
    ...
    for (Tour.TourElement e : sTour.getTour().getTourElements()) {
      if (e instanceof Tour.TourActivity) {
        if (e instanceof Tour.ServiceActivity) {
          ...
          Service service =
              Service.Builder.newInstance(carrierService.getId().toString())
                  .setLocation(Location.newInstance(carrierService.getLocationLinkId().toString()))
                  .build();
  ...
  @Test
  public void
      whenTransforming_matsimScheduledTourWithServiceAct2vehicleRoute_routeAndVehicleMustNotBeNull() {
    ScheduledTour sTour = getMatsimServiceTour();
  ...
  @Test
  public void
      whenTransforming_matsimScheduledTourWithServiceAct2vehicleRoute_vehicleMustHaveTheCorrectId() {
    ScheduledTour sTour = getMatsimServiceTour();
    VehicleRoutingProblem vehicleRoutingProblem = getVehicleRoutingProblem(sTour);
    VehicleRoute route = MatsimJspritFactory.createRoute(sTour, vehicleRoutingProblem);
  ...
  @Test
  public void
      whenTransforming_matsimScheduledTourWithServiceAct2vehicleRoute_earliestStartMustBe10() {
    ScheduledTour sTour = getMatsimServiceTour();
    VehicleRoutingProblem vehicleRoutingProblem = getVehicleRoutingProblem(sTour);
    VehicleRoute route = MatsimJspritFactory.createRoute(sTour, vehicleRoutingProblem);
  ...
  @Test
  public void
      whenTransforming_matsimScheduledTourWithServiceAct2vehicleRoute_firstActIdMustBeCorrect() {
    ScheduledTour sTour = getMatsimServiceTour();
    VehicleRoutingProblem vehicleRoutingProblem = getVehicleRoutingProblem(sTour);
    VehicleRoute route = MatsimJspritFactory.createRoute(sTour, vehicleRoutingProblem);
  ...
  @Test
  public void
      whenTransforming_matsimScheduledTourWithServiceAct2vehicleRoute_secondActIdMustBeCorrect() {
    ScheduledTour sTour = getMatsimServiceTour();
    VehicleRoutingProblem vehicleRoutingProblem = getVehicleRoutingProblem(sTour);
    VehicleRoute route = MatsimJspritFactory.createRoute(sTour, vehicleRoutingProblem);
  ...
  public void whenTransforming_matsimPlan2vehicleRouteSolution_itIsMadeCorrectly() {
    ...
    VehicleRoutingProblem vehicleRoutingProblem =
        VehicleRoutingProblem.Builder.newInstance()
            .addAllJobs(services1)
            .addAllJobs(services2)
            .addVehicle(v1)
            .addVehicle(v2)
            .build();

    CarrierPlan plan =
        new CarrierPlan(CarriersUtils.createCarrier(Id.create("myCarrier", Carrier.class)), sTours);
    plan.setScore(-100.0);
    VehicleRoutingProblemSolution solution =
        MatsimJspritFactory.createSolution(plan, vehicleRoutingProblem);
  ...
  private ScheduledTour getMatsimServiceTour() {
    CarrierService s1 =
        CarrierService.Builder.newInstance(
                Id.create("serviceId", CarrierService.class), Id.create("to1", Link.class))
            .setCapacityDemand(20)
            .build();
    CarrierService s2 =
        CarrierService.Builder.newInstance(
                Id.create("serviceId2", CarrierService.class), Id.create("to2", Link.class))
  ...
  private CarrierVehicle getMatsimVehicle(
      String VehicleId, String locationId, VehicleType matsimType) {
    return CarrierVehicle.Builder.newInstance(
            Id.create(VehicleId, org.matsim.vehicles.Vehicle.class),
            Id.create(locationId, Link.class),
            matsimType)
        .setEarliestStart(10.0)
        .setLatestEnd(20.0)
        .build();
  ...
  private VehicleType getMatsimVehicleType() {
    ...
    //		CarriersUtils.CarrierVehicleTypeBuilder builder =
    // CarriersUtils.CarrierVehicleTypeBuilder.newInstance( Id.create( "matsimType",
    // VehicleType.class ) )
    VehicleType vehicleType =
        VehicleUtils.getFactory()
            .createVehicleType(Id.create("matsimType", VehicleType.class))
            .setMaximumVelocity(13.8);
    vehicleType.getCapacity().setOther(50);
    vehicleType
        .getCostInformation()
        .setCostsPerMeter(10.0)
        .setCostsPerSecond(5.0)
        .setFixedCost(100.);
  ...
  private CarrierShipment getMatsimShipment(String id, String from, String to, int size) {
    return CarrierShipment.Builder.newInstance(
  ...
  public void createVehicleRoutingProblemBuilderWithServices_isMadeCorrectly() {
    ...
    new MatsimNetworkReader(network)
        .readFile(testUtils.getClassInputDirectory() + "grid-network.xml");
    ...
    assertNotNull(vrp);
    assertEquals(
        com.graphhopper.jsprit.core.problem.VehicleRoutingProblem.FleetSize.INFINITE,
        vrp.getFleetSize());
  ...
  @Test
  //	@Ignore		//Set to ignore due to not implemented functionality of Shipments in
  // MatsimJspritFactory
  ...
  private Carrier createCarrierWithServices() {
    ...
    CarrierService carrierService1 =
        CarrierService.Builder.newInstance(
                Id.create("serviceId", CarrierService.class), Id.create("i(7,4)R", Link.class))
            .setCapacityDemand(20)
            .setServiceDuration(10.0)
            .build();
    CarriersUtils.addService(carrier, carrierService1);
    CarrierService carrierService2 =
        CarrierService.Builder.newInstance(
                Id.create("serviceId2", CarrierService.class), Id.create("i(3,9)", Link.class))
            .setCapacityDemand(10)
