...
public class CarrierModuleTest {
  ...
  public void setUp() {
    ...
    freightCarriersConfigGroup.setCarriersFile(
        testUtils.getClassInputDirectory() + "carrierPlansEquils.xml");
    freightCarriersConfigGroup.setCarriersVehicleTypesFile(
        testUtils.getClassInputDirectory() + "vehicleTypes.xml");
  ...
  @Test
  // using this constructor does not work at the moment, as the module would need to derive the
  // carriers out of the scenario.
