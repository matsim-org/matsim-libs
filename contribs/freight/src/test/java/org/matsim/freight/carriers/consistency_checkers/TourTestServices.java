 ...
 * IF all jobs (1 pickup and 1 delivery per shipments) are scheduled once, this method will return enum ALL_JOBS_IN_TOURS
 ...
 *
 * NOTE: There are many inconsistencies that are catched by other methods, i.g. delivery of a shipment before pickup.
 *
 */

public class TourTestServices {
	private static final Logger log = LogManager.getLogger(TourTestServices.class);
	@RegisterExtension
