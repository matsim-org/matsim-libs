...
public class CarrierVehicleTypeTest {
  ...
  public void setUp() throws Exception {
    ...
    VehicleType newVehicleType1 =
        VehicleUtils.getFactory().createVehicleType(Id.create("medium2", VehicleType.class));
    ...
    VehicleType smallType = newVehicleType;
    {
      ...
      //			VehicleType smallType = CarriersUtils.CarrierVehicleTypeBuilder.newInstance( smallTypeId,
      // mediumType )
  ...
  public void test_whenCopyingTypeMedium_itCopiesDescriptionCorrectly() {
    VehicleType medium2 =
        types.getVehicleTypes().get(Id.create("medium2", org.matsim.vehicles.VehicleType.class));
  ...
  public void test_whenModifyingTypeSmall_itModifiesDescriptionCorrectly() {
    VehicleType small =
        types.getVehicleTypes().get(Id.create("small", org.matsim.vehicles.VehicleType.class));
