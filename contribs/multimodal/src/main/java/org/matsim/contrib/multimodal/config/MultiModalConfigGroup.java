...
public class MultiModalConfigGroup extends ConfigGroup {
  ...
  public final Map<String, String> getComments() {
    ...
    map.put(
        MULTI_MODAL_SIMULATION_ENABLED,
    ...
    map.put(
        INPUT_SLOPE_INFORMATION_FILE,
        "Path to a file containing slope information for the network's links (required file format: ObjectAttributes).");
    map.put(
        CREATE_MULTI_MODAL_NETWORK,
        "Use this if your network is not multi modal. Links with free speeds that are lower than "
            + "the specified cutoff value will be usable for walk and bike trips.");
    map.put(
        CUTOFF_VALUE_FOR_NON_MOTORIZED_MODES,
