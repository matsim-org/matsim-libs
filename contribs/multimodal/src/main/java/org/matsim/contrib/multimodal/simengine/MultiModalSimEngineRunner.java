...
class MultiModalSimEngineRunner extends NetworkElementActivator implements Runnable {
   ...
   * cdobler, sep'14
   */
  private final Queue<MultiModalQNodeExtension> nodesQueue =
      new ConcurrentLinkedQueue<MultiModalQNodeExtension>();
   ...
   * cdobler, sep'14
   */
  private final List<MultiModalQLinkExtension> linksList =
      new LinkedList<MultiModalQLinkExtension>();
  ...
  /*package*/ MultiModalSimEngineRunner(
      Phaser startBarrier, Phaser separationBarrier, Phaser endBarrier) {
