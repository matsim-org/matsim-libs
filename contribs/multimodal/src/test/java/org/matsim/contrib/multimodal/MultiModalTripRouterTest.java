...
public class MultiModalTripRouterTest {
  ...
  public void testRouteLeg() {
    ...
    multiModalConfigGroup.setSimulatedModes(
        TransportMode.bike
            + ", "
            + TransportMode.walk
            + ", "
    ...
    Map<Id<Link>, Double> linkSlopes =
        new LinkSlopesReader().getLinkSlopes(multiModalConfigGroup, scenario.getNetwork());
            ...
            AbstractModule.override(
                Collections.singleton(
                    new AbstractModule() {
                      @Override
                      public void install() {
                        bind(EventsManager.class)
                            .toInstance(EventsUtils.createEventsManager(config));
    ...
    PlanRouter planRouter =
        new PlanRouter(tripRouter, injector.getInstance(TimeInterpretation.class));

    /*
     * Create travel time object
     */
    // pre-initialize the travel time calculator to be able to use it in the wrapper
    //		TravelTimeCalculatorFactory travelTimeCalculatorFactory = new
    // TravelTimeCalculatorFactoryImpl();
    //		TravelTimeCalculator travelTimeCalculator =
    // travelTimeCalculatorFactory.createTravelTimeCalculator(scenario.getNetwork(),
    ...
    //		multiModalTravelTimes.put(TransportMode.bike, new BikeTravelTimeOld(configGroup, new
    // WalkTravelTimeOld(configGroup)));
    //		multiModalTravelTimes.put(TransportMode.ride, new
    // RideTravelTime(travelTimeCalculator.getLinkTravelTimes(), new
    // WalkTravelTimeOld(configGroup)));
    //		multiModalTravelTimes.put(TransportMode.pt, new PTTravelTime(configGroup,
    // travelTimeCalculator.getLinkTravelTimes(), new WalkTravelTimeOld(configGroup)));

    //		Map<String, LegRouter> legRouters = createLegRouters(config, scenario.getNetwork(),
  ...
  private void checkMode(Scenario scenario, String transportMode, PlanRouter planRouter) {
    // XXX transportMode parameter is NOT USED, hence this test is NOT DOING WHAT IT SHOULD! td oct
    // 15
  ...
  private Person createPerson(Scenario scenario) {
    ...
    Person person =
        scenario.getPopulation().getFactory().createPerson(Id.create("person", Person.class));
    ...
    Activity startActivity =
        scenario
            .getPopulation()
            .getFactory()
            .createActivityFromLinkId("start", Id.create("startLink", Link.class));
    ...
    Activity endActivity =
        scenario
            .getPopulation()
            .getFactory()
            .createActivityFromLinkId("end", Id.create("endLink", Link.class));
  ...
  private void createNetwork(Scenario scenario) {
    ...
    Node startNode =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("startNode", Node.class), new Coord(0.0, 0.0));
    Node splitNode =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("splitNode", Node.class), new Coord(1.0, 0.0));

    Node carNode =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("carNode", Node.class), new Coord(2.0, 2.0));
    Node ptNode =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("ptNode", Node.class), new Coord(2.0, 1.0));
    Node walkNode =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("walkNode", Node.class), new Coord(2.0, 0.0));
    double y1 = -1.0;
    Node bikeNode =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("bikeNode", Node.class), new Coord(2.0, y1));
    double y = -2.0;
    Node rideNode =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("rideNode", Node.class), new Coord(2.0, y));

    Node joinNode =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("joinNode", Node.class), new Coord(1.0, 0.0));
    Node endNode =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("endNode", Node.class), new Coord(0.0, 0.0));
    ...
    Link startLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("startLink", Link.class), startNode, splitNode);

    Link toCarLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("toCarLink", Link.class), splitNode, carNode);
    Link toPtLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("toPtLink", Link.class), splitNode, ptNode);
    Link toWalkLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("toWalkLink", Link.class), splitNode, walkNode);
    Link toBikeLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("toBikeLink", Link.class), splitNode, bikeNode);
    Link toRideLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("toRideLink", Link.class), splitNode, rideNode);

    Link fromCarLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("fromCarLink", Link.class), carNode, joinNode);
    Link fromPtLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("fromPtLink", Link.class), ptNode, joinNode);
    Link fromWalkLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("fromWalkLink", Link.class), walkNode, joinNode);
    Link fromBikeLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("fromBikeLink", Link.class), bikeNode, joinNode);
    Link fromRideLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("fromRideLink", Link.class), rideNode, joinNode);

    Link endLink =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("endLink", Link.class), joinNode, endNode);
