...
public class BikeTravelTimeTest {
  ...
  public void testLinkTravelTimeCalculation() {
    ...
    Node node1 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n1", Node.class), new Coord(0.0, 0.0));
    Node node2 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n2", Node.class), new Coord(1.0, 0.0));
    Link link =
        scenario.getNetwork().getFactory().createLink(Id.create("l1", Link.class), node1, node2);
    link.setLength(1.0);
    ...
    Person person =
        scenario.getPopulation().getFactory().createPerson(Id.create("p1", Person.class));
  ...
  private static class TestRunnable implements Runnable {
    ...
    public TestRunnable(
        ...
        BikeTravelTime bikeTravelTime,
        Link link,
        double expectedTravelTime1,
        double expectedTravelTime2) {
      this.p1 = p1;
      this.p2 = p2;
