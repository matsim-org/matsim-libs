...
public class BikeTravelTimeTest extends MatsimTestCase {
	...
	public void testThreadLocals() {
		...
		Person p1 = PopulationUtils.getDefaultFactory().createPerson(Id.create("1", Person.class));
		PersonUtils.setAge(p1, 90);
		PersonUtils.setSex(p1, "f");

		Person p2 = PopulationUtils.getDefaultFactory().createPerson(Id.create("2", Person.class));
