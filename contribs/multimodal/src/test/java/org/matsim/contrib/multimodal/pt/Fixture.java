 ...
 *
 * <ul>
 *   <li>blue line: regular line every 20 minutes from A to C with stop on all facilities
 * </ul>
 *
 * @author cdobler
 */
/*package*/ class Fixture {
  ...
  void buildNetwork() {
    ...
    this.links[4] =
        this.network
            .getFactory()
            .createLink(Id.create("4", Link.class), this.nodes[1], this.nodes[3]);

    this.links[0].setAllowedModes(
        CollectionUtils.stringToSet(
            TransportMode.walk + "," + TransportMode.transit_walk + "," + TransportMode.car));
    this.links[1].setAllowedModes(CollectionUtils.stringToSet(TransportMode.car));
    this.links[2].setAllowedModes(
        CollectionUtils.stringToSet(
            TransportMode.walk + "," + TransportMode.transit_walk + "," + TransportMode.car));
    this.links[3].setAllowedModes(
        CollectionUtils.stringToSet(TransportMode.walk + "," + TransportMode.transit_walk));
    this.links[4].setAllowedModes(
        CollectionUtils.stringToSet(
            TransportMode.walk + "," + TransportMode.transit_walk + "," + TransportMode.car));
  ...
  void buildBlueLine() {
    ...
    { // route from left to right
      NetworkRoute netRoute =
          RouteUtils.createLinkNetworkRouteImpl(this.links[0].getId(), this.links[2].getId());
      ...
      TransitRoute route =
          this.builder.createTransitRoute(
              Id.create("blue A > C", TransitRoute.class), netRoute, stops, "train");
  ...
  /*package*/ Person createPersonAndAdd(
      Scenario scenario, String id, String legMode, String routingMode) {
    ...
    Activity from =
        scenario
            .getPopulation()
            .getFactory()
            .createActivityFromLinkId("home", Id.create("0", Link.class));
    ...
    Activity to =
        scenario
            .getPopulation()
            .getFactory()
            .createActivityFromLinkId("home", Id.create("3", Link.class));
