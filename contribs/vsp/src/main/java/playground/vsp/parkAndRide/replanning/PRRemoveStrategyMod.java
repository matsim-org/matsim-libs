    ...
    if (hasHomeActivity == true && hasWorkActivity == true) {
      ...
      log.info(
          "PlanElements of possible work Activities: "
              ...
              + ". Removing park-and-ride of work activity "
      ...
      if (prIndicesToRemove.size() == 2) {
        log.info(
            "Home-Work-Home sequence contains two park-and-ride activities. Removing the park-and-ride activities and randomly choose a mode for the remaining leg.");
        ...
        MultiModalConfigGroup multiModalConfigGroup =
            (MultiModalConfigGroup) sc.getConfig().getModule(MultiModalConfigGroup.GROUP_NAME);
        ...
        log.info(
            "Home-Work-Home sequence doesn't contain park-and-ride. Not modifying the plan...");
      } else if (prIndicesToRemove.size() > 2) {
        log.warn(
            "More than two park-and-ride activities in this Home-Work-Home sequence. This should not be possible. Not modifying the plan...");
      } else if (prIndicesToRemove.size() < 2) {
        log.info(
            "Home-Work-Home sequence only contains one park-and-ride. Not modifying the plan...");
      }
