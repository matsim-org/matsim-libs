...
/**
 * Copy/Paste of TransitTimeAllocationMutator, that calls ParkAndRidePlanMutateTimeAllocation
 * instead of TransitPlanMutateTimeAllocation. Ignoring the activities "parkAndRide" and "pt
 * interaction".
 *
 * @author ikaddoura
 */
public class PRTimeAllocationMutator extends AbstractMultithreadedModule {
  ...
  /**
   * Creates a new TimeAllocationMutator with a mutation range as defined in the configuration
   * (module "TimeAllocationMutator", param "mutationRange"), or the default value of 1800 (seconds)
   * if there is no value specified in the configuration.
   */
  ...
  public PlanAlgorithm getPlanAlgoInstance() {
    PRPlanMutateTimeAllocation pmta =
        new PRPlanMutateTimeAllocation(this.mutationRange, MatsimRandom.getLocalInstance());
