  ...
  public void createPRFacility(Id<PRFacility> id, Node node, String stopName, int capacity) {
    ...
    Link prLink1in =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("prLink1in_" + id, Link.class), node, prNode1);
    scenario.getNetwork().addLink(setPRLink(prLink1in));
    Link prLink1out =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("prLink1out_" + id, Link.class), prNode1, node);
    ...
    Link prLink2in =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("prLink2in_" + id, Link.class), prNode1, prNode2);
    scenario.getNetwork().addLink(setPseudePRLink(prLink2in));
    Link prLink2out =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("prLink2out_" + id, Link.class), prNode2, prNode1);
    ...
    Link prLink3in =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("prLink3in_" + id, Link.class), prNode2, prNode3);
    scenario.getNetwork().addLink(setPseudePRLink(prLink3in));
    Link prLink3out =
        scenario
            .getNetwork()
            .getFactory()
            .createLink(Id.create("prLink3out_" + id, Link.class), prNode3, prNode2);
