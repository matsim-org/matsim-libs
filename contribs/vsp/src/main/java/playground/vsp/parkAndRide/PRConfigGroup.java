...
public class PRConfigGroup extends ConfigGroup {
  ...
  public Map<String, String> getComments() {
    ...
    map.put(
        INPUT_FILE,
        "REQUIRED: a csv file with park-and-ride facilities. Format: park-and-ride-facility-Id;Link1in-Id;Link1out-Id;Link2in-Id;Link2out-Id;Link3in-Id;Link3out-Id;TransitStopFacilityName;Capacity[vehicles per park-and-ride-facility]");

    map.put(
        INTERMODAL_TRANSFER_PENALTY,
        "[utils/transfer] normally negative utility for park-and-ride transfers");

    map.put(
        GRAVITY,
        "facility choice parameter: park-and-ride facilities are chosen following a simple gravitation model: "
            + "\n\t\t"
