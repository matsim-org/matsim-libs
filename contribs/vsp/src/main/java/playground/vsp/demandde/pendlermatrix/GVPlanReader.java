...
public class GVPlanReader {
  ...
  private static final String GV_NETWORK_FILENAME =
      "/Users/michaelzilske/workspace/prognose_2025/demand/network_cleaned_wgs84.xml.gz";

  private static final String NETWORK_FILENAME = "/Users/michaelzilske/osm/motorway_germany.xml";

  private static final String GV_PLANS =
      "/Users/michaelzilske/workspace/run1061/1061.output_plans.xml.gz";

  private static final String FILTER_FILENAME =
      "/Users/michaelzilske/workspace/prognose_2025/demand/filter.shp";

  private static final String LANDKREISE =
      "/Users/michaelzilske/workspace/prognose_2025/osm_zellen/landkreise.shp";

  private static boolean isCoordInShape(
      Coord linkCoord, Collection<SimpleFeature> features, GeometryFactory factory) {
    boolean found = false;
  ...
  public static void main(String[] args) {
    ...
    PopulationReaderTask populationReaderTask =
        new PopulationReaderTask(GV_PLANS, gvNetwork.getNetwork());

    PersonDereferencerTask personDereferencerTask = new PersonDereferencerTask();

    PersonGeoTransformatorTask personGeoTransformatorTask =
        new PersonGeoTransformatorTask(TransformationFactory.WGS84, TransformationFactory.DHDN_GK4);
    ...
    PopulationWriterTask populationWriterTask =
        new PopulationWriterTask(
            "/Users/michaelzilske/workspace/prognose_2025/demand/naechster_versuch_gv.xml",
            gvNetwork.getNetwork());
