...
public class DgLanduseReader {
  ...
  public static final String BASE_DIR =
      "../../../shared-svn/studies/countries/de/berlin_brandenburg_corine_landcover/shapefiles/";
  ...
  private static final String[] landuse_files_home = {
    STADTGEFUEGE_KONTINUIERLICH, STADTGEFUEGE_NICHT_KONTINUIERLICH
  };
  //	private static final String[] landuse_files_home = {STADTGEFUEGE_NICHT_KONTINUIERLICH};

  private static final String[] landuse_files_work = {
    STADTGEFUEGE_KONTINUIERLICH,
    STADTGEFUEGE_NICHT_KONTINUIERLICH,
    INDUSTRIE_GEWERBEGEBIETE,
    STRASSEN_SCHIENENNETZE_GEBAUEDE,
    HAFENGEBIET,
    FLUGHAEFEN,
    DEPONIEN,
    BAUSTELLEN
  ...
  private Tuple<Collection<SimpleFeature>, CoordinateReferenceSystem> readLanduseData(
      String[] shapefiles) {
