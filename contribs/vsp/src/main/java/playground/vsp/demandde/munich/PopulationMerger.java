...
public class PopulationMerger {
  ...
  private String prognose2025FreightDemandFile =
      "../../detailedEval/pop/gueterVerkehr/population_gv_bavaria_10pct_wgs84.xml.gz";
  //	private String prognose2025FreightDemandFile =
  // "../../detailedEval/pop/gueterVerkehr/population_gv_bavaria_1pct_wgs84.xml.gz";
  // this "falls from the sky" (ruby script)

  //	private String prognose2025CommuterDemandFile =
  // "../../detailedEval/pop/pendlerVerkehr/population_pv_bavaria_10pct_wgs84.xml.gz";
  //	private String pendlerstatistikInCommutingDemandFile =
  // "../../detailedEval/pop/pendlerVerkehr/pendlermatrizen/onlyIn/pendlerverkehr_1pct_dhdn_gk4.xml.gz";

  private String pendlerstatistikCommutingDemandFile =
      "../../detailedEval/pop/pendlerVerkehr/pendlermatrizen/inAndOut/pendlerverkehr_10pct_scaledAndMode_workStartingTimePeak0800Var2h_dhdn_gk4.xml.gz";
  //	private String pendlerstatistikCommutingDemandFile =
  // "../../detailedEval/pop/pendlerVerkehr/pendlermatrizen/inAndOut/pendlerverkehr_1pct_scaledAndMode_workStartingTimePeak0800Var2h_dhdn_gk4.xml.gz";
  // this comes from other classes in this playground module

  private String outputPath = "../../detailedEval/pop/merged/";
  private String outputFileName =
      "mergedPopulation_All_10pct_scaledAndMode_workStartingTimePeakAllCommuter0800Var2h_gk4.xml.gz";
  //	private String outputFileName =
  ...
  protected static final CoordinateTransformation wgs84ToDhdnGk4 =
  ...
  private void addPendlerstatistikInCommuterDemand(
      String pendlerstatistikInCommutingDemandFile,
      String networkFile,
      Population mergedPopulation) {
    Population inCommuterPopulation =
        PopulationMerger.getPopulation(pendlerstatistikInCommutingDemandFile, networkFile);
  ...
  private static void addMidDemand(
      String midDemandFile, String networkFile, Population mergedPopulation) {
  ...
  private static void addPrognose2025FreightDemand(
      String prognose2025FreightDemandFile, String networkFile, Population mergedPopulation) {
    Population freightPopulation =
        PopulationMerger.getPopulation(prognose2025FreightDemandFile, networkFile);
  ...
  private static void addPrognose2025CommuterDemand(
      String prognose2025CommuterDemandFile, String networkFile, Population mergedPopulation) {
    Population commuterPopulation =
        PopulationMerger.getPopulation(prognose2025CommuterDemandFile, networkFile);
