...
public class PendlerMatrixReader {
  ...
  private static final String PV_EINPENDLERMATRIX =
      "../../detailedEval/eingangsdaten/Pendlermatrizen/EinpendlerMUC_843_062004.csv";

  private static final String PV_AUSPENDLERMATRIX =
      "../../detailedEval/eingangsdaten/Pendlermatrizen/AuspendlerMUC_843_062004.csv";
  ...
  private void readMatrix(final String filename) {
    ...
    LogManager.getLogger(this.getClass())
        .warn(
            "this method may read double entries in the Pendlermatrix (such as Nuernberg) twice. "
        ...
        .parse(
            ...
            new TabularFileHandler() {
              ...
              public void startRow(String[] row) {
                ...
                Integer quelle = null;
                Integer ziel = 0;
                // car market share for commuter work/education trips (taken from "Regionaler
                // Nahverkehrsplan-Fortschreibung, MVV 2007)
                double carMarketShare = 0.67;
                // scale factor, since Pendlermatrix only considers "sozialversicherungspflichtige
                // Arbeitnehmer" (taken from GuthEtAl2005)
