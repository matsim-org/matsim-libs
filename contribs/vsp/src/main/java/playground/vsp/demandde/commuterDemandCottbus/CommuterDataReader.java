...
public class CommuterDataReader {
  ...
  private static final Logger log = LogManager.getLogger(CommuterDataReader.class);
          ...
          if (!result[0].equals("")) {
            ...
            if (currentTo.equals("")) {
              ...
              try {
                ...
                CommuterDataElement current =
                    new CommuterDataElement(currentFromCode, currentTo, commuters);
