...
class BuildingEnergyAggregatedEnergyConsumptionCalculator {
  ...
  private static final Logger log =
      LogManager.getLogger(BuildingEnergyAggregatedEnergyConsumptionCalculator.class);
  ...
  BuildingEnergyAggregatedEnergyConsumptionCalculator(
      BuildingEnergyConsumptionRuleFactory rules,
      List<Id> links,
      List<Integer> timeBins,
      Map<String, Map<Id, Integer>> maxValues) {
    this.rules = rules;
    this.links = links;
  ...
  Map<String, EnergyConsumption> run(
      Map<String, Map<String, LinkOccupancyStats>> occupancyRun2Type2Occupancy) {
    log.info("calculating energy-consumption.");
    for (Entry<String, Map<String, LinkOccupancyStats>> e :
        occupancyRun2Type2Occupancy.entrySet()) {
   ...
   * @return
   */
  private void calcEnergyConsumptionPerType(
      LinkOccupancyStats runRawData,
