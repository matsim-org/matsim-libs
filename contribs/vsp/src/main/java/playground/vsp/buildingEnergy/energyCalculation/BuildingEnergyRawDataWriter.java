...
public class BuildingEnergyRawDataWriter {
  ...
  private static final Logger log = LogManager.getLogger(BuildingEnergyRawDataWriter.class);
  ...
  public BuildingEnergyRawDataWriter(
      String baseRunId,
  ...
  void write(String path) {
    ...
    b.append(
        baseRunId
            + ";"
            + run2PopulationStats.get(baseRunId).getWorkCnt()
            + ";"
    ...
    for (String id : run2type2RawOccupancy.keySet()) {
      ...
      b.append(
          id
              + ";"
              + run2PopulationStats.get(id).getWorkCnt()
              + ";"
   ...
   */
  private void dumpSingleRunRawData(
      String path, String id, Map<String, LinkOccupancyStats> rawRunAnalysis) {
  ...
  private void writeOccupancy(
      String path, String id, Map<String, LinkActivityOccupancyCounter> map) {
