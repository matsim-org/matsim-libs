...
class BuildingEnergyActivityProbabilityDataWriter {
  ...
  private static final Logger log =
      LogManager.getLogger(BuildingEnergyActivityProbabilityDataWriter.class);
  ...
  void write(String outputPath, ActivityProbabilities proba, List<Integer> timeBins) {
    ...
    try {
      ...
      writer.write("\n");
      // write the content
      for (Entry<String, Map<String, Map<String, Double>>> run :
          proba.getProbabilities().entrySet()) {
