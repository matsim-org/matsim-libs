...
public class ParametricRunsExample {
  ...
  public static void main(String[] args) {
    ...
    PrepareParametricRuns parametricRuns =
        new PrepareParametricRuns("~/.ssh/known_hosts", "~/.ssh/id_rsa_tub_math", userName);
    ...
    buffer.append(
        "runNr\tascStyle\tstepSize\titerations2Convergence\tselfTunerWt\twarmUpIts" + "\n");
        ...
        for (int conIts : convIterations) {
          for (double selfTunWt : selfTuningWts) {
            for (int warmUpIt : warmUpIts) {
              ...
              String arg =
                  ascStyle + " " + stepSize + " " + conIts + " " + selfTunWt + " " + warmUpIt;
              ...
              String[] additionalLines = {
                ...
                "java -Djava.awt.headless=true -Xmx58G -cp agarwalamit-0.11.0-SNAPSHOT.jar "
                    ...
                    + "/net/ils4/agarwal/equilOpdyts/carPt/output/"
                    + jobName
                    + "/ "
