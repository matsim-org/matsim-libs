...
public class JobScriptWriter {
   ...
   *
   * <ul>
   *   <li>max run time is set to 9 days
   *   <li>error messages and output into the output file
   *   <li>send an email at beginning and end of the job
   *   <li>email address is agarwal@vsp.tu-berlin.de
   *   <li>a 16GB node with 4 processors
   *   <li>required free memory is 7.5 GB
   * </ul>
   *
  ...
  public static void main(String[] args) {
    ...
    String[] additionalLines = {
      ...
      "java -Djava.awt.headless=true -Xmx29G -cp agarwalamit-0.10.0-SNAPSHOT.jar "
          ...
          + "/net/ils4/agarwal/equilOpdyts/carBicycle/output/"
          + jobName
          + "/ "
  ...
  public void appendCommands(
      ...
      final String locationOfClusterLogFile,
      final String[] additionalLinesInJobScript) {
  ...
  public void writeLocally(final String localFileName) {
    ...
    if (localFileName.endsWith(".sh")) {
      ...
      LOGGER.warn(
          localFileName
              + "does not ends with \".sh\". Assuming it is a location rather than a script name, adding \"test.sh\".");
  ...
  private void createDefaults(String userName) {
    ...
    buffer.append(
        "#$ -j y"); // 'Join'=yes, i.e. write error messages and output into the output file
    buffer.append(newLine);
