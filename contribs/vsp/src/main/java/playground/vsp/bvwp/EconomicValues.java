...
class EconomicValues {
  ...
  //			ValuesForAMode roadValues = economicValues.getByMode(Mode.road) ;
  //			{
  //				ValuesForAUserType pvCommercialValues =
  // roadValues.getByDemandSegment(DemandSegment.PV_COMMERCIAL) ;
  ...
  //			{
  //				ValuesForAUserType valuesForAModeAndDemandSegment =
  // valuesForAMode.getByDemandSegment(DemandSegment.PV_NON_COMMERCIAL) ;
