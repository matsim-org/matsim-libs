...
/**
 * Java class for attvalues-content complex type.
 *
...
public class XMLAttvaluesContent {
   ...
   * there is not a <CODE>set</CODE> method for the attvalue property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link XMLAttvalue }
   */
