...
public class ObjectFactory {
  ...
  private static final QName _Parents_QNAME = new QName("http://www.gexf.net/1.2draft", "parents");
  private static final QName _Edge_QNAME = new QName("http://www.gexf.net/1.2draft", "edge");
  private static final QName _Keywords_QNAME =
      new QName("http://www.gexf.net/1.2draft", "keywords");
  private static final QName _Gexf_QNAME = new QName("http://www.gexf.net/1.2draft", "gexf");
  private static final QName _Position_QNAME =
      new QName("http://www.gexf.net/1.2draft", "position");
  private static final QName _Spells_QNAME = new QName("http://www.gexf.net/1.2draft", "spells");
  private static final QName _Attribute_QNAME =
      new QName("http://www.gexf.net/1.2draft", "attribute");
  private static final QName _Meta_QNAME = new QName("http://www.gexf.net/1.2draft", "meta");
  private static final QName _Creator_QNAME = new QName("http://www.gexf.net/1.2draft", "creator");
  private static final QName _Size_QNAME = new QName("http://www.gexf.net/1.2draft", "size");
  private static final QName _Node_QNAME = new QName("http://www.gexf.net/1.2draft", "node");
  private static final QName _Graph_QNAME = new QName("http://www.gexf.net/1.2draft", "graph");
  private static final QName _Default_QNAME = new QName("http://www.gexf.net/1.2draft", "default");
  private static final QName _Attvalues_QNAME =
      new QName("http://www.gexf.net/1.2draft", "attvalues");
  private static final QName _Nodes_QNAME = new QName("http://www.gexf.net/1.2draft", "nodes");
  private static final QName _Description_QNAME =
      new QName("http://www.gexf.net/1.2draft", "description");
  private static final QName _Edges_QNAME = new QName("http://www.gexf.net/1.2draft", "edges");
  private static final QName _Color_QNAME = new QName("http://www.gexf.net/1.2draft", "color");
  private static final QName _Attributes_QNAME =
      new QName("http://www.gexf.net/1.2draft", "attributes");
  private static final QName _Thickness_QNAME =
      new QName("http://www.gexf.net/1.2draft", "thickness");
  private static final QName _Options_QNAME = new QName("http://www.gexf.net/1.2draft", "options");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: playground.vsp.gexf
   */
  ...
  public JAXBElement<XMLAttributeContent> createAttribute(XMLAttributeContent value) {
    return new JAXBElement<XMLAttributeContent>(
        _Attribute_QNAME, XMLAttributeContent.class, null, value);
  }
  ...
  public JAXBElement<XMLAttvaluesContent> createAttvalues(XMLAttvaluesContent value) {
    return new JAXBElement<XMLAttvaluesContent>(
        _Attvalues_QNAME, XMLAttvaluesContent.class, null, value);
  }
  ...
  public JAXBElement<XMLAttributesContent> createAttributes(XMLAttributesContent value) {
    return new JAXBElement<XMLAttributesContent>(
        _Attributes_QNAME, XMLAttributesContent.class, null, value);
  }
