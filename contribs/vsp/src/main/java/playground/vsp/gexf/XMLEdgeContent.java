...
/**
 * Java class for edge-content complex type.
 *
...
@XmlType(
    name = "edge-content",
    propOrder = {"attvaluesOrSpellsOrColor"})
public class XMLEdgeContent {
  ...
  @XmlAttribute protected XMLEdgetypeType type;
  ...
  @XmlAttribute protected Float weight;
   ...
   * there is not a <CODE>set</CODE> method for the attvaluesOrSpellsOrColor property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ColorContent } {@link
   * XMLAttvaluesContent } {@link EdgeShapeContent } {@link XMLSpellsContent } {@link
   * ThicknessContent }
   */
   ...
   *
   * @return possible object is {@link XMLEdgetypeType }
   */
   ...
   *
   * @param value allowed object is {@link XMLEdgetypeType }
   */
