...
/**
 * Java class for spells-content complex type.
 *
...
public class XMLSpellsContent {
   ...
   * there is not a <CODE>set</CODE> method for the spell property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link XMLSpell }
   */
