...
public class StopId2DelayOfLine24hAnalyzer extends AbstractAnalysisModule {
  private static final Logger log = LogManager.getLogger(StopId2DelayOfLine24hAnalyzer.class);
  ...
  public void postProcessData() {
    ...
    // own postProcessing
    TreeMap<Id, TreeMap<Id, StopId2RouteId2DelayAtStopData>> results =
        this.stopId2RouteId2DelayAtStopAnalyzer.getStopId2RouteId2DelayAtStop();
    ...
    for (Entry<Id, TreeMap<Id, StopId2RouteId2DelayAtStopData>> stopEntry : results.entrySet()) {
      StopId2DelayOfLine24hData stopId2DelayOfLine24hMapData =
          new StopId2DelayOfLine24hData(stopEntry.getKey());
