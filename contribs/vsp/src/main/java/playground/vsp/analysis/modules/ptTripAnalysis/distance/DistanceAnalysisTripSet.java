...
public class DistanceAnalysisTripSet extends AbstractAnalysisTripSet {
  private static final Logger log = LogManager.getLogger(DistanceAnalysisTripSet.class);
  ...
  public String toString() {
    ...
    if (super.getMode().equals(TransportMode.pt)) {
      ...
      b.append("accesWalkDist [m];");
      super.println(this.accesWalkDist, b);
      b.append("inPtDist [m];");
      super.println(this.inPtDist, b);
      b.append("switchWalkDist [m];");
      super.println(this.switchWalkDist, b);
      b.append("egressWalkDist [m];");
      super.println(this.egressWalkDist, b);
    }
    return b.toString();
  }
}
