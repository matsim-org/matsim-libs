 ...
 */
public class CarDistanceEventHandler
    implements LinkLeaveEventHandler,
        PersonDepartureEventHandler,
        PersonArrivalEventHandler,
        VehicleEntersTrafficEventHandler,
        VehicleLeavesTrafficEventHandler {
  private static final Logger logger = LogManager.getLogger(CarDistanceEventHandler.class);
      ...
      if (personId2departureLinkId.get(personId) == null) {
        logger.warn(
            "Person "
                ...
                + " is arriving on link "
                + linkId
                + " without having departed anywhere before...");
      } else {
