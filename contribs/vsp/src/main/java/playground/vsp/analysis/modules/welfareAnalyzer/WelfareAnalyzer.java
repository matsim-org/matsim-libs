...
public class WelfareAnalyzer extends AbstractAnalysisModule {
  private static final Logger log = LogManager.getLogger(WelfareAnalyzer.class);
  ...
  public void postProcessData() {
    ...
    this.userBenefitsWithoutTransferPayments =
        this.userBenefitsAna.getAllUsersLogSum() + this.transferAna.getAllUsersAmount();
  }
  ...
  public void writeResults(String outputFolder) {
    ...
    try {
      ...
      bw.newLine();
      bw.write(
          "userBenefits without transferPayments : " + this.userBenefitsWithoutTransferPayments);
      bw.newLine();
