...
public class PtTripAnalysisContainer {
  ...
  public static final int nRows = FIELDS.values().length;
  public static final int nColumns = ZONES.values().length;

  private double[][] datafields =
      new double[PtTripAnalysisContainer.nRows][PtTripAnalysisContainer.nColumns];
  ...
  public void calculateAverages() {
    for (int i = 0; i < PtTripAnalysisContainer.nColumns; i++) {
      datafields[FIELDS.avgTT.ordinal()][i] =
          datafields[FIELDS.sumTTime.ordinal()][i] / datafields[FIELDS.tripCnt.ordinal()][i];
      datafields[FIELDS.avgAccessWalkTime.ordinal()][i] =
          datafields[FIELDS.accesWalkTTime.ordinal()][i]
              / datafields[FIELDS.accesWalkCnt.ordinal()][i];
      datafields[FIELDS.avgSwitchWalkTime.ordinal()][i] =
          datafields[FIELDS.switchWalkTTime.ordinal()][i]
              / datafields[FIELDS.switchWalkCnt.ordinal()][i];
      datafields[FIELDS.avgEgressWalkTime.ordinal()][i] =
          datafields[FIELDS.egressWalkTTime.ordinal()][i]
              / datafields[FIELDS.egressWalkCnt.ordinal()][i];
      datafields[FIELDS.avgAccessWaitTime.ordinal()][i] =
          datafields[FIELDS.accesWaitTime.ordinal()][i]
              / datafields[FIELDS.accesWaitCnt.ordinal()][i];
      datafields[FIELDS.avgSwitchWaitTime.ordinal()][i] =
          datafields[FIELDS.switchWaitTime.ordinal()][i]
              / datafields[FIELDS.switchWaitCnt.ordinal()][i];
      datafields[FIELDS.avgNTransfers.ordinal()][i] =
          datafields[FIELDS.lineCnt.ordinal()][i] / datafields[FIELDS.tripCnt.ordinal()][i] - 1;
    }
  }
}
