 ...
 *
 * <p>It then provides: - total emissions per emission type - warm emissions per person and emission
 * type - cold emissions per person and emission type - sum of warm and cold emissions per person
 * and emission type
 *
 * @author ikaddoura, benjamin
 */
public class EmissionsAnalyzer extends AbstractAnalysisModule {
  private static final Logger log = LogManager.getLogger(EmissionsAnalyzer.class);
  ...
  public void postProcessData() {
    ...
    if (true) {
      throw new RuntimeException(
          "function below is no longer there; don't know what to do.  kai, dec'18");
    }
    //		this.person2totalEmissions = EmissionUtils.sumUpEmissionsPerId(person2warmEmissions,
    // person2coldEmissions);
  ...
  public void writeResults(String outputFolder) {
    ...
    try {
      ...
      if (true) {
        throw new RuntimeException(
            "functionality below is no longer there; don't know what to do.  kai, dec'18");
      }
