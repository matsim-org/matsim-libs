 ...
 */
public class PtLines2PaxAnalysisHandler
    implements
  ...
  private static final Logger log = LogManager.getLogger(PtLines2PaxAnalysisHandler.class);
  ...
  public PtLines2PaxAnalysisHandler(
  ...
  public void handleEvent(VehicleDepartsAtFacilityEvent event) {
    ...
    this.linesPaxCounts
        .get(v.getLineId())
        .vehicleDeparts(event.getTime(), v.getCapacity(), v.getSeatsOccupied(), v.getLocationId());
  }
