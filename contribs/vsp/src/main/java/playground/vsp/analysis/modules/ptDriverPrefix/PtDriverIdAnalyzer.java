...
public class PtDriverIdAnalyzer extends AbstractAnalysisModule {
  private static final Logger log = LogManager.getLogger(PtDriverIdAnalyzer.class);
  ...
  public void postProcessData() {
    // Analyzing the ptDriverPrefix here would be to late. Getting the ptDriverPrefix while parsing
    // the events.
  }
