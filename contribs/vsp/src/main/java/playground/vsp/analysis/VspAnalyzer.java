...
public class VspAnalyzer {
  ...
  /**
   * Simple container-class to handle {@link AbstractAnalysisModule}s. The modules are processed in
   * the order as they are added. The initialization of the single modules has to be done before.
   * Make sure you add the correct data to the module, especially if you are handling events.Only
   * one events-file will be handled!
   *
   ...
   *
   * <p>If you use this constructor, no events will be handled!!!
   *
   * @param outdir, the output-directory
   */
