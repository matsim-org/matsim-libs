...
public class DefaultAnalysis_ik {
  ...
  private static final Logger log = LogManager.getLogger(DefaultAnalysis_ik.class);
  ...
  public DefaultAnalysis_ik(
      MutableScenario scenario, String iterationOutputDir, String eventsFile) {
  ...
  public void init(String aasRunnerConfigFile) {
    ...
    //		String emissionVehicleFile =
    // "/Users/Ihab/Documents/workspace/shared-svn/projects/detailedEval/pop/merged/emissionVehicles_1pct.xml.gz";
    //		String emissionInputPath =
    // "/Users/Ihab/Documents/workspace/shared-svn/projects/detailedEval/emissions/hbefaForMatsim/";
    //		String roadTypeMappingFile = emissionInputPath + "roadTypeMapping.txt";
    //		String averageFleetWarmEmissionFactorsFile = emissionInputPath +
    // "EFA_HOT_vehcat_2005average.txt";
    //		String averageFleetColdEmissionFactorsFile = emissionInputPath +
    // "EFA_ColdStart_vehcat_2005average.txt";
    //		boolean isUsingDetailedEmissionCalculation = true;
    //		String detailedWarmEmissionFactorsFile = emissionInputPath +
    // "EFA_HOT_SubSegm_2005detailed.txt";
    //		String detailedColdEmissionFactorsFile = emissionInputPath +
    // "EFA_ColdStart_SubSegm_2005detailed.txt";
    ...
    //		String emissionsEventsFile =
    // "/Users/Ihab/Documents/workspace/shared-svn/studies/ihab/test/output/test_fakePt/ITERS/it.0/analysis/EmissionEventsWriter/emission.events.xml";
    ...
    //		VehDelayAtStopHistogramAnalyzer delayHistogramAna = new
    // VehDelayAtStopHistogramAnalyzer(ptDriverPrefix, numberOfDetailedSlots);
    ...
    //				throw new RuntimeException("Person " + person.getId() + " has the same prefix as the pt
    // Driver: " + ptDriverPrefix + ". Aborting...");
    //			}
    //		}
  ...
  public void writeResults() {
    ...
    for (AbstractAnalysisModule module : this.anaModules) {
      ...
      log.info(
          "Writing results of module " + module.getName() + " to " + moduleOutputDir + "... done.");
    }
