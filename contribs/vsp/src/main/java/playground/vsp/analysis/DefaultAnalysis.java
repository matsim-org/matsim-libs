...
public class DefaultAnalysis {
  ...
  private static final Logger log = LogManager.getLogger(DefaultAnalysis.class);
  ...
  public void init(String aasRunnerConfigFile) {
    log.info(
        "Configuration through config file is currently not implemented. Initializing all modules with defaults.");
  ...
  public void run() {
    ...
    if (this.eventsFile == null) {
      ...
      log.warn(
          "Make sure if this is what you want. Analysis modules "
