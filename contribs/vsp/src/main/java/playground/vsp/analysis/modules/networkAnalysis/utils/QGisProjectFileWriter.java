...
/**
 * Writes a collection of geometries into a QuantumGIS project file (*.gqs). The geometries have to
 * be written into a shapefile first, the qgs-file references its layers to them.
 *
 * @author dhosse
 */
public class QGisProjectFileWriter extends MatsimXmlWriter implements MatsimWriter {
  ...
  private static final String VERSION =
      "<qgis projectname=\"\" version=\"1.8.0-Lisboa\">"; // current version of this Writer: QGis
  // 1.8.0-Lisboa
  ...
  private Map<String, Class<? extends Geometry>> files =
      new HashMap<String, Class<? extends Geometry>>();

  /**
   * Initializes a new project file writer.
   *
   * @param files Map consisting the name for the geometries and their class (e.g. <code>
   *     com.vividsolutions.jts.geom.Polygon.class()</code>
   */
  ...
  private static class QGisWriterHandler {
    ...
    public void writeLegendLayer(BufferedWriter out, String key) throws IOException {
      ...
      out.write(
          "\t\t<legendlayer drawingOrder=\"-1\" open=\"false\" checked=\"Qt::Checked\" name=\""
              + key
              + "\" showFeatureCount=\"0\">\n");
    ...
    public void writeProjectLayer(
        final BufferedWriter out, String key, String geometry, String clazz, String type)
        throws IOException {
      ...
      if (key.equals("nodeTypes")) {
        ...
        out.write("\t\t\t\t<symbols>\n");
        out.write(
            "\t\t\t\t\t<symbol outputUnit=\"MM\" alpha=\"1\" type=\"" + type + "\" name=\"0\">\n");
        out.write("\t\t\t\t\t\t<layer pass=\"0\" class=\"" + clazz + "\" locked=\"0\">\n");
        out.write("\t\t\t\t\t\t\t<prop k=\"capstyle\" v=\"square\"/>\n");

        String color = "";

        if (key.equals("network")) color = "0,0,0,255";
        if (key.equals("envelope")) color = "255,85,0,255";
        if (key.equals("highDegreeNodes")) color = "255,0,170,255";
    ...
    private void writePolygonLayer(
        BufferedWriter out, String key, String geometry, String clazz, String type, String id)
        throws IOException {
    ...
    private void writeNodeTypesLayer(
        BufferedWriter out, String key, String geometry, String clazz, String type, String id)
        throws IOException {
      ...
      out.write(
          "\t\t\t\t\t<symbol outputUnit=\"MM\" alpha=\"1\" type=\"" + type + "\" name=\"1\">\n");
      out.write("\t\t\t\t\t\t<layer pass=\"0\" class=\"" + clazz + "\" locked=\"0\">\n");
      out.write("\t\t\t\t\t\t\t<prop k=\"angle\" v=\"0\"/>\n");
      ...
      out.write(
          "\t\t\t\t\t<symbol outputUnit=\"MM\" alpha=\"1\" type=\"" + type + "\" name=\"2\">\n");
      out.write("\t\t\t\t\t\t<layer pass=\"0\" class=\"" + clazz + "\" locked=\"0\">\n");
      out.write("\t\t\t\t\t\t\t<prop k=\"angle\" v=\"0\"/>\n");
