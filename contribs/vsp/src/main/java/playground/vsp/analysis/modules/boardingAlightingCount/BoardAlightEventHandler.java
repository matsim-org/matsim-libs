 ...
 * @author droeder
 */
public class BoardAlightEventHandler
    implements
  ...
  private static final Logger log = LogManager.getLogger(BoardAlightEventHandler.class);
  ...
  public void handleEvent(PersonLeavesVehicleEvent event) {
    ...
    // as the stopId of the vehicle might change before the person arrives at the next facility we
    // store it here!
