...
public class GnuplotUtils {
  ...
  public static void runGnuplotScript(
      String pathToSpecificAnalysisDir, String relativePathToGnuplotScript) {
    runGnuplotScript(pathToSpecificAnalysisDir, relativePathToGnuplotScript, "");
  }

  public static void runGnuplotScript(
      String pathToSpecificAnalysisDir,
      String relativePathToGnuplotScript,
      String... gnuplotArguments) {
    /*
    ...
    */
    ...
    LOG.info(
        "Relative path from analysis directory to directory with gnuplot script is = "
            + relativePathToGnuplotScript);
    ...
    try {
      ...
      // If OS is Windows --- example (daniel r) // os.arch=amd64 // os.name=Windows 7 //
      // os.version=6.1
      if (osName.contains("Win") || osName.contains("win")) {
        ...
        // If OS is Macintosh --- example (dominik) // os.arch=x86_64 // os.name=Mac OS X //
        // os.version=10.10.2
        ...
        // If OS is Linux --- example (benjamin) // os.arch=amd64 // os.name=Linux	//
        // os.version=3.13.0-45-generic
      } else if (osName.contains("Lin") || osName.contains("lin")) {
        LOG.warn(
            "This implemenation has not yet been tested for Linux. Please report if you use this.");
        processBuilder =
            new ProcessBuilder(
                "bash",
                "-c",
