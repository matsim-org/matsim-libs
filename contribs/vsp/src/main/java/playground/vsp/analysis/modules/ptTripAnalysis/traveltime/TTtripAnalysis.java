 ...
 *     <p>This class analyzes the trip-dependent traveltime per mode
 */
public class TTtripAnalysis extends AbstractAnalysisModule {
   ...
   * @param population, the population corresponding to the analyzed eventsfile (i.e. analyze
   *     runId.iteration.events.xml.gz, use runId.iteration.plans.xml.gz!)
   */
  public TTtripAnalysis(
      Collection<String> ptModes, Collection<String> networkModes, Population population) {
