...
/**
 * This module collects all <code>PersonEntersVehicleEvent</code> and <code>PersonLeavesVehicleEvent
 * </code> with their corresponding <code>ActivityEndEvent</code> and <code>ActivityStartEvent
 * </code> ignoring <code>pt interaction</code> events not differentiating between public and
 * private vehicles.
 *
 * @author ikaddoura
 */
public class EnterLeaveVehicle2ActivityAnalyzer extends AbstractAnalysisModule {
  private static final Logger log = LogManager.getLogger(EnterLeaveVehicle2ActivityAnalyzer.class);
  ...
  public void postProcessData() {
    ...
    this.enterVehicleEvent2ActivityEndEvent =
        this.enterLeaveHandler.getPersonEntersVehicleEvent2ActivityEndEvent();
    this.leaveVehicleEvent2ActivityStartEvent =
        this.enterLeaveHandler.getPersonLeavesVehicleEvent2ActivityStartEvent();
  }

  @Override
  public void writeResults(String outputFolder) {

    //		for (PersonEntersVehicleEvent enterEvent :
    // this.enterVehicleEvent2ActivityEndEvent.keySet()){
    //			ActivityEndEvent actend = this.enterVehicleEvent2ActivityEndEvent.get(enterEvent);
    //			log.info(enterEvent.getDriverId() + " enters vehicle " + enterEvent.getVehicleId() + "
    // (Time:" + enterEvent.getTime() + ") after " + actend.getDriverId() + " ends activity " +
    // actend.getActType() + " (Time: "+ actend.getTime()+")");
    //		}
  ...
  public Map<PersonLeavesVehicleEvent, ActivityStartEvent>
