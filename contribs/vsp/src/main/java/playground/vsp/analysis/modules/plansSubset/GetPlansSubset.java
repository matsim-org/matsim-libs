...
public class GetPlansSubset extends AbstractAnalysisModule {
  ...
  /**
   * writes persons and their plans from sc to a file. when ids is null all persons are selected,
   * otherwise only the persons with the specified id's.
   *
  ...
  public void writeResults(String outputFolder) {
    new PopulationWriter(this.newSc.getPopulation(), this.sc.getNetwork())
        .write(outputFolder + "plans.xml.gz");
  }
}
