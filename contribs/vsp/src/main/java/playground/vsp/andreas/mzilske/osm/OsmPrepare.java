...
public class OsmPrepare {
  ...
  private static final Logger log = LogManager.getLogger(OsmPrepare.class);
  ...
  public static void main(String[] args) {
    new OsmPrepare(
            "/Users/michaelzilske/sotm-paper/osm-work/berlin.osm",
            "/Users/michaelzilske/sotm-paper/osm-work/berlin-filtered.osm",
            new String[] {
              "motorway",
              "motorway_link",
              "trunk",
  ...
  public void prepareOsm() {
    ...
    JOSMTolerantFastXMLReader reader =
        new JOSMTolerantFastXMLReader(new File(filename), true, CompressionMethod.None);
    ...
    JOSMTolerantFastXMLReader reader2 =
        new JOSMTolerantFastXMLReader(new File(filename), true, CompressionMethod.None);
