...
public class ReadRohData implements TabularFileHandler {
  ...
  private static final Logger log = LogManager.getLogger(ReadRohData.class);

  private TabularFileParserConfig tabFileParserConfig;
  private TreeMap<String, TreeMap<String, ArrayList<RohDataBox>>> countId2DataBoxListMap =
      new TreeMap<String, TreeMap<String, ArrayList<RohDataBox>>>();
  private TreeMap<String, ArrayList<RohDataBox>> tempList;

  public static TreeMap<String, TreeMap<String, ArrayList<RohDataBox>>> readCountDataForWeek(
      String folderName) {
