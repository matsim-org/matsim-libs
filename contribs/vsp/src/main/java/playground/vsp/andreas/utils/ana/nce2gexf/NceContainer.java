...
public class NceContainer {
  ...
  static final String toStringHeader =
      "# from node id; from node x; from node y; to node id; to node x; to node y; diffPerLink";
  ...
  public NceContainer(
      Id fromNodeId, Coord fromNodeCoord, Id toNodeId, Coord toNodeCoord, double diffPerLink) {
  ...
  public String toString() {
    ...
    strBuffer.append(this.fromNodeId);
    strBuffer.append("; ");
    strBuffer.append(this.fromNodeCoord.getX());
    strBuffer.append("; ");
    strBuffer.append(this.fromNodeCoord.getY());
    strBuffer.append("; ");
    strBuffer.append(this.toNodeId);
    strBuffer.append("; ");
    strBuffer.append(this.toNodeCoord.getX());
    strBuffer.append("; ");
    strBuffer.append(this.toNodeCoord.getY());
    strBuffer.append("; ");
