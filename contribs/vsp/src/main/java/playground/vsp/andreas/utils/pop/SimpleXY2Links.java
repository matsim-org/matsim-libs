...
/**
 * Assigns each activity in each plan of each person in the population a link where the activity
 * takes place based on the coordinates given for the activity. This tool is used for mapping a new
 * demand/population to a network for the first time.
 *
 * @author mrieser
 */
public class SimpleXY2Links {
  ...
  public void run(final String[] args) {
    ...
    StreamingDeprecated.addAlgorithm(
        plans, new org.matsim.core.population.algorithms.XY2Links(network, null));
