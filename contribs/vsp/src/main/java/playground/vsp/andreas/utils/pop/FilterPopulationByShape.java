 ...
 * @author aneumann
 */
public class FilterPopulationByShape
    implements LinkEnterEventHandler,
        PersonEntersVehicleEventHandler,
        PersonLeavesVehicleEventHandler {

  private static final Logger log = LogManager.getLogger(FilterPopulationByShape.class);
  ...
  public FilterPopulationByShape(
      String netFile,
      String popInFile,
      String eventsFile,
      String areaShapeFile,
      String popOutFile) {
  ...
  public static void main(String[] args) {
    ...
    //		String popInFile =
    // "e:/_shared-svn/andreas/paratransit/input/trb_2012/plans/bvg.run189.10pct.100.plans.selected_movedToTXL.xml.gz";
    //		String eventsFile =
    // "e:/berlin-bvg09_runs/bvg.run189.10pct/ITERS/it.100/bvg.run189.10pct.100.events.xml.gz";
    //		String areaShapeFile =
    // "e:/_shared-svn/andreas/paratransit/input/trb_2012/area/simulated_area.shp";
    //		String popOutFile =
    // "e:/_shared-svn/andreas/paratransit/input/trb_2012/plans/bvg.run189.10pct.100.plans.selected_movedToTXL_diluted.xml.gz";

    // Spandau
    //		String netFile = "e:/_shared-svn/andreas/paratransit/input/trb_2012/network.final.xml.gz";
    //		String popInFile =
    // "e:/berlin-bvg09_runs/bvg.run192.100pct/ITERS/it.100/bvg.run192.100pct.100.plans.selected.xml.gz";
    //		String eventsFile =
    // "e:/berlin-bvg09_runs/bvg.run192.100pct/ITERS/it.100/bvg.run192.100pct.100.events.xml.gz";
    //		String areaShapeFile =
    // "e:/_shared-svn/andreas/paratransit/input/trb_2012/area/spandau_area.shp";
    //		String popOutFile =
    // "e:/_shared-svn/andreas/paratransit/input/trb_2012/plans/bvg.run192.100pct.100.plans.selected_spandau.xml.gz";
    ...
    String areaShapeFile =
        "e:/_shared-svn/andreas/paratransit/input/trb_2012/area/spandau_area.shp";
    String popOutFile =
        "e:/_shared-svn/andreas/paratransit/input/trb_2012/plans/bvg.run189.10pct.100.plans.selected_movedToTXL_spandau.xml.gz";

    FilterPopulationByShape filter =
        new FilterPopulationByShape(netFile, popInFile, eventsFile, areaShapeFile, popOutFile);
  }
}
