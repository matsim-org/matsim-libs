...
public class ReadCoopLoggerFileAndReturnCoopsInBusiness implements TabularFileHandler {
  ...
  private static final Logger log =
      LogManager.getLogger(ReadCoopLoggerFileAndReturnCoopsInBusiness.class);
  ...
  public static Set<String> readCoopLoggerFileAndReturnCoopsInBusiness(String filename) {
    ReadCoopLoggerFileAndReturnCoopsInBusiness reader =
        new ReadCoopLoggerFileAndReturnCoopsInBusiness(filename);
