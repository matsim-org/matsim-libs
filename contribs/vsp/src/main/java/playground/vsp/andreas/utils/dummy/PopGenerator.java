...
public class PopGenerator {
  ...
  public static void main(String[] args) {
    ...
    //		PopGenerator.createPopT1(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corr_t_1.xml.gz");
    //		PopGenerator.createPopT2(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corr_t_2.xml.gz");
    //		PopGenerator.createPopT3(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corr_t_3.xml.gz");
    //		PopGenerator.createPopT4(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corr_t_4.xml.gz");
    //
    //		PopGenerator.createPopS1(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corr_s_1.xml.gz");
    //		PopGenerator.createPopS2(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corr_s_2.xml.gz");
    //		PopGenerator.createPopS3(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corr_s_3.xml.gz");
    //		PopGenerator.createPopS4(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corr_s_4.xml.gz");
    //
    //		networkFilename = outputDir + "network_cross.xml";
    //		nPersonsPerHour = 1000;
    //		PopGenerator.createPopCross(networkFilename, nPersonsPerHour, outputDir +
    // "pop_cross.xml.gz");

    //		networkFilename = outputDir + "network_corridor.xml";
    //		nPersonsPerHour = 1000;
    //		PopGenerator.createPopVirginiaCorridor(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corridor_1000.xml.gz", 7, 9);
    //		PopGenerator.createPopVirginiaCorridor(networkFilename, nPersonsPerHour, outputDir +
    // "pop_corridor_1000_short.xml.gz", 7, 8);
  }

  private static void createPopTut(
      String networkFilename, int nPersonsPerHour, String outFilename) {
  ...
  private static void createPopCross(
      String networkFilename, int nPersonsPerHour, String outFilename) {
    Scenario sc = ScenarioUtils.createScenario(ConfigUtils.createConfig());
    new MatsimNetworkReader(sc.getNetwork()).readFile(networkFilename);
    Population pop = sc.getPopulation();
  ...
  private static void createPopVirginiaCorridor(
      String networkFilename,
      int nPersonsPerHour,
      String outFilename,
      int departureIntervalStart,
      int departureIntervalEnd) {
    Scenario sc = ScenarioUtils.createScenario(ConfigUtils.createConfig());
    new MatsimNetworkReader(sc.getNetwork()).readFile(networkFilename);
    Population pop = sc.getPopulation();
    ...
    createPersons(
        ...
        node1Coord,
        node2Coord,
        departureIntervalStart,
        departureIntervalEnd);
  ...
  private static void createPersons(
    ...
    for (int i = 0; i < nPersonsToBeCreated; i++) {
      ...
      h1.setEndTime(
          departureIntervalStart * 3600.0
              + rnd.nextDouble() * (departureIntervalEnd - departureIntervalStart) * 3600.0);
      plan.addActivity(h1);
