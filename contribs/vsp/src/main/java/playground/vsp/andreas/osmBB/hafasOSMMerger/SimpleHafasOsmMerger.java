...
public class SimpleHafasOsmMerger {
  ...
  private static final Logger log = LogManager.getLogger(SimpleHafasOsmMerger.class);

  //	static final String hafasAlldat =
  // "D:/Berlin/BVG/berlin-bvg09/urdaten/BVG-Fahrplan_2008/Daten/1_Mo-Do/";
  ...
  private void addRouteProfilToRoutes() {
    ...
    for (Entry<Id<TransitLine>, TransitLine> transitLineEntry :
        this.osmScenario.getTransitSchedule().getTransitLines().entrySet()) {
      ...
      log.info(
          "Added " + transitLineEntry.getKey() + " with " + numberOfRoutesProcessed + " routes");
    }
  }
