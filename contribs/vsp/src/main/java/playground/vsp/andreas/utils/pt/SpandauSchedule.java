...
public class SpandauSchedule {
  ...
  public static void main(String[] args) {
    ...
    final String NO_SPANDAU_SCHEDULE_FILE =
        "e:/_shared-svn/andreas/paratransit/input/trb_2012/transitSchedules/noSpandauBusLines.xml.gz";
    final String SPANDAU_BUS_LINES =
    ...
    TransitSchedule noSpandauTransitSchedule =
    ...
    TransitSchedule spandauBusLinesTransitSchedule =
        TransitLineRemover.removeTransitLinesFromTransitSchedule(
