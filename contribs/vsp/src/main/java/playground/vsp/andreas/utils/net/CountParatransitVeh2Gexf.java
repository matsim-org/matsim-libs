...
public class CountParatransitVeh2Gexf extends MatsimJaxbXmlWriter {
  ...
  private static final Logger log = LogManager.getLogger(CountParatransitVeh2Gexf.class);
  ...
  public static void main(String[] args) {
    ...
    //		new
    // MatsimNetworkReader(scenario).readFile("D:/berlin_bvg3/bvg_3_bln_inputdata/rev554B-bvg00-0.1sample/network/network.final.xml.gz");
