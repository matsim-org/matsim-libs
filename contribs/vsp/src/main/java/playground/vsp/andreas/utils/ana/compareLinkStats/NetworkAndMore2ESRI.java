...
public class NetworkAndMore2ESRI extends Links2ESRIShape {
  ...
  public static void main(String[] args) {
    ...
    if (args.length == 0) {
      ...
      LinkStatsCompareConfig.linkStatsFileOne =
          "e:/run793/output/ITERS/it.600/run793.600.linkstats.txt";
      LinkStatsCompareConfig.linkStatsFileTwo =
          "e:/run794/output/ITERS/it.600/run794.600.linkstats.txt";
      //			LinkStatsCompareConfig.linkStatsFileOne =
      // "E:/run778/output/ITERS/it.900/run778.900.linkstats.txt";
      //			LinkStatsCompareConfig.linkStatsFileTwo =
      // "E:/run777/output/ITERS/it.900/run777.900.linkstats.txt";
