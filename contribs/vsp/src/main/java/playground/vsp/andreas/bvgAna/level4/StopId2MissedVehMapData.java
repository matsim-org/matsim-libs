...
public class StopId2MissedVehMapData {
  ...
  /**
   * @return The number of missed vehicles. Only positive values are considered. The case an agent
   *     could get a vehicle earlier is ignored.
   */
  ...
  public String toString() {
    return "Stop "
        + this.stopId
        + " missed vehicles "
        + this.getNumberOfMissedVehicles()
        + " with an average delay of "
        + this.getAverageAdditionalDelay();
  }
}
