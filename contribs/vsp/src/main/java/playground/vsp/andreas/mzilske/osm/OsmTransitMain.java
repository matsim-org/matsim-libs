...
public class OsmTransitMain {
  ...
  private static final Logger log = LogManager.getLogger(OsmTransitMain.class);
  ...
  public static void main(String[] args) throws IOException {
    new OsmTransitMain(
            "/Users/michaelzilske/Desktop/lv/potsdam.osm",
            TransformationFactory.WGS84,
            TransformationFactory.DHDN_GK4,
            "/Users/michaelzilske/Desktop/lv/transit-network.xml",
            "/Users/michaelzilske/Desktop/lv/transitschedule.xml")
        .convertOsm2Matsim();
  }
  ...
  public void convertOsm2Matsim(String[] transitFilter) {
    ...
    JOSMTolerantFastXMLReader reader =
        new JOSMTolerantFastXMLReader(new File(inFile), false, CompressionMethod.None);

    CoordinateTransformation coordinateTransformation =
        TransformationFactory.getCoordinateTransformation(this.fromCoordSystem, this.toCoordSystem);
    ...
    TransitNetworkSink transitNetworkSink =
        new TransitNetworkSink(
            scenario.getNetwork(),
