    ...
    if (row[0].trim().startsWith("#")) {
      ...
      try {
        ...
        if (this.nceNodeStringNodeId2nodeId.get(fromNodeIdString) == null) {
          this.nceNodeStringNodeId2nodeId.put(
              fromNodeIdString, Id.create(fromNodeIdString, Node.class));
        }
        ...
        if (this.nceNodeStringNodeId2nodeId.get(toNodeStringId) == null) {
          this.nceNodeStringNodeId2nodeId.put(
              toNodeStringId, Id.create(toNodeStringId, Node.class));
        }
        ...
        NceContainer nceContainer =
            new NceContainer(
                this.nceNodeStringNodeId2nodeId.get(fromNodeIdString),
                fromNodeCoord,
                this.nceNodeStringNodeId2nodeId.get(toNodeStringId),
                toNodeCoord,
                diffPerLink);
