...
/**
 * Stores Type-Count pairs clustered to one node. Optional: shifts the node's centroid to the
 * average of all given data points.
 *
 * @author aneumann
 */
public class GridNode {
  ...
  private static final Logger log = LogManager.getLogger(GridNode.class);
