...
/**
 * Calculates the number of people waiting at a transit stop facility as a function of time.
 *
 * @author mrieser
 */
public class TransitStopLoadByTime
  ...
  private final ConcurrentHashMap<Id<Person>, Double> passengerWaitingSince =
      new ConcurrentHashMap<>();
  private final ConcurrentHashMap<Id<TransitStopFacility>, StopData> stopData =
      new ConcurrentHashMap<>();
  ...
  private StopData getStopData(
      final Id<TransitStopFacility> stopId, final boolean createIfMissing) {
  ...
  private static class StopData {
    private final SortedMap<Double, Integer> nOfPassengersDeltaByTime =
        new TreeMap<>(); // Time, nOfDeltaPassengers
