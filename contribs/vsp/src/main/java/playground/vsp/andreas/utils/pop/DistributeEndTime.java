...
public class DistributeEndTime extends NewPopulation {
  ...
  public DistributeEndTime(
      Network network, Population plans, String filename, double startTime, double endTime) {
  ...
  public void run(Person person) {
    ...
    act.setEndTime(
        this.startTime + MatsimRandom.getRandom().nextDouble() * (this.endTime - this.startTime));
