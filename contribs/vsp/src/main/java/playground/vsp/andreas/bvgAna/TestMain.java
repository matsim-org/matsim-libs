...
public class TestMain {
  ...
  public static void main(String[] args) {
    ...
    //		String eventsFile =
    // "f:\\ils4\\data\\bvg\\runs\\bvg.run128.25pct\\it.100\\bvg.run128.25pct.100.events.xml.gz";
    //		String plansFile =
    // "f:\\ils4\\data\\bvg\\runs\\bvg.run128.25pct\\it.100\\bvg.run128.25pct.100.plans.selected.xml.gz";
    ...
    StopId2PersonEnterLeaveVehicleHandler stophandler =
        new StopId2PersonEnterLeaveVehicleHandler(stopIds);
    //		eventsManager.addHandler(stophandler);
    PersonEnterLeaveVehicle2ActivityHandler enterLeaveHandler =
        new PersonEnterLeaveVehicle2ActivityHandler(agentIds);
    //		eventsManager.addHandler(enterLeaveHandler);
    AgentId2EnterLeaveVehicleEventHandler aid2elhandler =
        new AgentId2EnterLeaveVehicleEventHandler(agentIds);
    ...
    //
    //		TreeMap<Id, Id> map3 = new
    // TransitScheduleDataProvider(sc.getTransitSchedule()).getRouteId2lineIdMap();
    //
    ...
    //
    //		Map<PersonEntersVehicleEvent, ActivityEndEvent> map6 =
    // enterLeaveHandler.getPersonEntersVehicleEvent2ActivityEndEvent();
    //		Map<PersonLeavesVehicleEvent, ActivityStartEvent> map7 =
    // enterLeaveHandler.getPersonLeavesVehicleEvent2ActivityStartEvent();
    //		TreeMap<Id, ArrayList<PersonEntersVehicleEvent>> map8 =
    // aid2elhandler.getAgentId2EnterEventMap();
    //		TreeMap<Id, ArrayList<PersonLeavesVehicleEvent>> map9 =
    // aid2elhandler.getAgentId2LeaveEventMap();
    //
    //		String name = new
    // TransitScheduleDataProvider(sc.getTransitSchedule()).getStopName(stopIds.first());
    //
    ...
    //
    //		Map<Id, List<StopId2RemainSeatedDataMapData>> remSeat =
    ...
    //
    //		TreeMap<Id, LinkedList<VehId2DelayAtStopMapData>> vdelay =
    // v2delay.getVehId2DelayAtStopMap();
    //
    //		TreeMap<Id, StopId2DelayOfLine24hMapData> s22 = s224h.getStopId2DelayOfLine24hMap();
    //
    //		TreeMap<Id, ArrayList<PersonEntersVehicleEvent>> v2em =
    // v2ELM.getVehId2PersonEnterEventMap();
    //		TreeMap<Id, ArrayList<PersonLeavesVehicleEvent>> v2lm =
    // v2ELM.getVehId2PersonLeaveEventMap();
    //
    //		@SuppressWarnings("unused")
    //		Set<Id> v2agidr = v2agid.getAgentIdsInVehicle(Id.create("veh_8"), 46127.0);
    //
    //		TreeMap<Id, TreeMap<Id, List<StopId2LineId2PulkData>>> s2pulkR =
    // s2pulk.getStopId2LineId2PulkDataList();
