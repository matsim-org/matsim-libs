 ...
 * @author aneumann
 */
public class StopId2DelayOfLine24hMap
  ...
  private final StopId2RouteId2DelayAtStopMap stopId2RouteId2DelayAtStopMap =
      new StopId2RouteId2DelayAtStopMap();
  ...
  private void calculateStopId2DelayOfLine24hMap() {
    TreeMap<Id, TreeMap<Id, StopId2RouteId2DelayAtStopMapData>> results =
        this.stopId2RouteId2DelayAtStopMap.getStopId2RouteId2DelayAtStopMap();
    ...
    for (Entry<Id, TreeMap<Id, StopId2RouteId2DelayAtStopMapData>> stopEntry : results.entrySet()) {
      StopId2DelayOfLine24hMapData stopId2DelayOfLine24hMapData =
          new StopId2DelayOfLine24hMapData(stopEntry.getKey());
      ...
      for (StopId2RouteId2DelayAtStopMapData routeData : stopEntry.getValue().values()) {
        ...
        for (int i = 0; i < plannedDepartures.size(); i++) {
          stopId2DelayOfLine24hMapData.addDelayForLine(
              lineId,
              realizedDepartures.get(i).doubleValue() - plannedDepartures.get(i).doubleValue());
        }
      }
    }
  }
