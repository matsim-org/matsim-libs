...
public class IllustrationsZZOther {
  ...
  private static void useCase1() {
...

    {
      ...
      System.out.println(
          "Without a value of time for freight there are not benefits for rail acceleration measures, despite "
    ...
    }
    {
      ...
      utilityChanges.computeAndPrintResults(economicValues, nullfall, planfall);
      System.out.println(
          "As was to be expected, the BVWP'03 benefit for the rail acceleration measure derives "
    ...
    }
    {
      ...
      utilityChanges.computeAndPrintResults(economicValues, nullfall, planfall);
      System.out.println(
          "As it should be, the suggested bvwp'15 method returns the same value as the rule-of-half.");
    }
  }
  ...
  private static void useCase2() {
    ...
    }
    {
      ...
      utilityChanges.computeAndPrintResults(economicValues, nullfall, planfall);
      System.out.println(
          "As is somewhat plausible, the bvwp'03 method leads to a smaller utl gain as the rule-of-half.");
      System.out.println("One notices the time gains for those persons leaving the road.");
      System.out.println(
          "The time LOSSES for those same persons entering the rail are added into the time GAINS of the old users.");
      System.out.println("There are also km losses for the persons entering the rail.");
      System.out.println(
          "But where are the corresponding km gains for road? Answer: The cost per car km is set to zero.");
    }
    {
      UtilityChanges utilityChanges = new UtilityChangesBVWP2015();
      utilityChanges.computeAndPrintResults(economicValues, nullfall, planfall);
      System.out.println(
          "As it should be, the bvwp'15 method returns the same result as the rule-of-half.");
    }
  }
}
