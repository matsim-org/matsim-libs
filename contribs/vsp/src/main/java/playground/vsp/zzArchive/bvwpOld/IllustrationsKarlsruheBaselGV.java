...
public class IllustrationsKarlsruheBaselGV {
  ...
  public static void main(String[] args) {
    ...
    }
    {
      ...
      html.multiFmtComment(
          "Comment: implicit utl just compensates for bvwp03 gain.  Can't get gain in RoH when VoX is zero in "
    ...
    }
    {
      ...
      html.multiFmtComment(
          "Comment: VoT_goods!=0 means large gains for acceleration of freight!!!");
      html.endBody();
      html.endHtml();
    }
    {
      ...
      System.out.println(
          "\n==================================================================================================================================");
      html.multiFmtComment(
          "bvwp2015 w/ implicit utl. and w/ road price as user price for rail in nullfall:");
      ...
      for (String id : nullfallTmp.getAllRelations()) {
        ...
        double roadPrice =
            attribsForOd
                .getByMode(Mode.road)
                .getByDemandSegment(DemandSegment.GV)
                .getByEntry(Attribute.priceUser);
        attribsForOd
            .getByMode(Mode.rail)
            .getByDemandSegment(DemandSegment.GV)
            .setByEntry(Attribute.priceUser, roadPrice);
      }
      UtilityChanges utilityChanges1 = new UtilityChangesBVWP2015();
      utilityChanges1.computeAndPrintResults(economicValues, nullfall, planfall, html);
      html.multiFmtComment(
          "Using road price as scarcity price results in 1/2 of benefits as computation according to resource consumption.");
      html.endBody();
      html.endHtml();
    }
    {
      ...
      economicValuesTmp
          .getByMode(Mode.road)
          .getByDemandSegment(DemandSegment.GV)
          .setByEntry(Attribute.excess_hrs, -1.00);
      economicValuesTmp
          .getByMode(Mode.rail)
          .getByDemandSegment(DemandSegment.GV)
          .setByEntry(Attribute.excess_hrs, -1.00);
      ...
      utilityChanges1.computeAndPrintResults(economicValuesTmp, nullfall, planfall, html);
      html.multiFmtComment(
          "Comment: With these values, same as w/ VoT for goods.  However, with VoR no gains for pure GV accelerations.");
      html.endBody();
      html.endHtml();
    }
  }
