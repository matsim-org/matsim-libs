...
class ScenarioFictiveExampleSep2012GV { // Relationsbezogen_mit_generalisierten_Kosten
  ...
  static ScenarioForEvalData createPlanfall1(ScenarioForEvalData nullfall) {
    System.out.println(
        "This is an example where (1) the rail GV travel time is improved; (2) additional demand switches to rail in consequence.");
    System.out.println(
        "As long as the VoT is zero, this will NOT lead to benefits according to RoH or with implicit utility.");
