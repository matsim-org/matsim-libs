...
public class EmissionTollTimeDistanceTravelDisutility implements TravelDisutility {
  ...
  private static final Logger log =
      LogManager.getLogger(EmissionTollTimeDistanceTravelDisutility.class);
  ...
  public EmissionTollTimeDistanceTravelDisutility(
  ...
  public double getLinkTravelDisutility(
    ...
    if (hotspotLinks == null) {
      ...
      linkExpectedEmissionDisutility =
          calculateExpectedEmissionDisutility(emissionVehicle, link, linkTravelTime);
    } else {
  ...
  private double calculateExpectedEmissionDisutility(
      Vehicle vehicle, Link link, double linkTravelTime) {
    double linkExpectedEmissionDisutility;
    ...
    Map<Pollutant, Double> expectedWarmEmissions =
        this.emissionModule
            ...
            .checkVehicleInfoAndCalculateWarmEmissions(vehicle, link, linkTravelTime);
    double expectedEmissionCosts =
        this.emissionCostModule.calculateWarmEmissionCosts(expectedWarmEmissions);
