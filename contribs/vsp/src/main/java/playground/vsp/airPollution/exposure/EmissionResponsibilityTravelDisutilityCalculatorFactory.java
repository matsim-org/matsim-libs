...
/** benjamin, ihab, amit */
public class EmissionResponsibilityTravelDisutilityCalculatorFactory
    implements TravelDisutilityFactory {

  private double sigma = 0.;
  private RandomizingTimeDistanceTravelDisutilityFactory
  ...
  public EmissionResponsibilityTravelDisutilityCalculatorFactory(
  ...
  public TravelDisutility createTravelDisutility(TravelTime timeCalculator) {
    ...
    return new EmissionResponsibilityTollTimeDistanceTravelDisutility(
