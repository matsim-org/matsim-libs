...
public class CommuterFileReaderV2 {
  ...
  public static void main(String[] args) {
    ...
    CommuterFileReaderV2 commuterFileReader =
        new CommuterFileReaderV2(commuterFileOutgoing, delimiter);

    String origin = "12051000"; // "Brandenburg an der Havel, St."
    String destination = "11000000"; // "Berlin, Stadt"
    LOG.info(
        "Simple test: 1513 = "
            + commuterFileReader.getRelationsMap().get(origin).get(destination).getTrips());
  }
  ...
  private void process(
    ...
    CommuterRelationV2 commuterRelation =
        new CommuterRelationV2(origin, destination, tripsAll, tripsMale, tripsFemale);
