...
public class Cemdap2MatsimUtils {
  ...
  /**
   * CEMDAP handles all IDs incl. zone IDs internally as integers. Casting IDs as integers removes
   * leading zeroes. In order to be consistent and enable zones to be found, zone IDs need to have
