 ...
 * In order to use this, you need to provide an attribute {@link org.matsim.core.population.PersonUtils#PERSONAL_INCOME_ATTRIBUTE_NAME} for persons that have
 * a specific income. Persons in the population, that have no attribute {@link org.matsim.core.population.PersonUtils#PERSONAL_INCOME_ATTRIBUTE_NAME} will use the
...
public class IncomeDependentUtilityOfMoneyPersonScoringParameters implements ScoringParametersForPerson {
    ...
    private double computeAvgIncome(Population population) {
        log.info("read income attribute '" + PersonUtils.PERSONAL_INCOME_ATTRIBUTE_NAME + "' of all agents and compute global average.\n" +
