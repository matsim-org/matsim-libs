...
public class CongestionAnalysisWriter {
  ...
  public void writeDetailedResults(String mode) {
    ...
    try {
      ...
      Map<Id<Person>, List<Double>> personId2listOfAmounts =
          this.handler.getPersonId2listOfAmounts(mode);
      Map<Id<Person>, List<Double>> personId2listOfDepartureTimes =
          this.handler.getPersonId2listOfDepartureTimes(mode);
      Map<Id<Person>, List<Double>> personId2listOfDistances =
          this.handler.getPersonId2listOfDistances(mode);
  ...
  public void writeAvgTollPerTimeBin(String mode) {
    ...
    File file = new File(fileName);
    Map<Double, Double> departureTime2avgAmount =
        this.handler.getAvgAmountPerTripDepartureTime(mode);
  ...
  public void writeCausingAgentId2totalAmount() {
    ...
    try {
      ...
      Map<Id<Person>, Double> personId2totalAmount =
          this.handler.getCausingAgentId2amountSumAllAgents();
  ...
  public void writeAffectedAgentId2totalAmount() {
    ...
    try {
      ...
      Map<Id<Person>, Double> personId2totalAmount =
          this.handler.getAffectedAgentId2amountSumAllAgents();
