 ...
 * @author ihab, amit
 */
public class AdvancedMarginalCongestionPricingContolerListener
    implements StartupListener, AfterMobsimListener, IterationEndsListener {
  private static final Logger log =
      LogManager.getLogger(AdvancedMarginalCongestionPricingContolerListener.class);
   ...
   */
  public AdvancedMarginalCongestionPricingContolerListener(
  ...
  public void notifyStartup(StartupEvent event) {
    ...
    this.pricingHandler =
        new AdvancedMarginalCongestionPricingHandler(eventsManager, this.scenario, this.factor);
  ...
  public void notifyAfterMobsim(AfterMobsimEvent event) {
    ...
    this.pricingHandler.printVTTS(
        this.scenario.getConfig().controller().getOutputDirectory()
            + "/ITERS/it."
            + event.getIteration()
            + "/VTTS_forAllDelayedTrips.csv");
    this.pricingHandler.printAvgVTTSperPerson(
        this.scenario.getConfig().controller().getOutputDirectory()
            + "/ITERS/it."
            + event.getIteration()
            + "/VTTS_AvgPerPerson_forAllDelayedTrips.csv");
