...
public final class CongestionEvent extends Event {
  ...
  public static final String ATTRIBUTE_EMERGENCETIME =
      "emergenceTime"; // i.e. the time when the causing agent enters the link
  ...
  public CongestionEvent(
      ...
      double externalDelay,
      Id<Link> linkId,
      double emergenceTime) {
    super(time);
