 ...
 *
 * <p>In this implementation, the delay is allocated to ALL agents ahead in the flow queue. EACH
 * agent has to pay for the affected agent's total delay.
 *
...
public final class CongestionHandlerImplV7 implements CongestionHandler {
  ...
  private static final Logger log = LogManager.getLogger(CongestionHandlerImplV7.class);
