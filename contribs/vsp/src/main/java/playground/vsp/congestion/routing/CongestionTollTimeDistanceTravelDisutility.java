...
public class CongestionTollTimeDistanceTravelDisutility implements TravelDisutility {
  ...
  public CongestionTollTimeDistanceTravelDisutility(
  ...
  private double calculateExpectedTollDisutility(
      Id<Link> linkId, double time, Id<Person> personId) {
    ...
    double expectedLinkCongestionTollDisutility =
        -1 * this.marginalUtilityOfMoney * (blendedOldValue + blendedNewValue);
