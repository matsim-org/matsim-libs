 ...
 *
 * <p>For all carriers it writes out the: - score of the selected plan - number of tours (=
 * vehicles) of the selected plan - number of Services (input) - number of shipments (input) to a
 * tsv-file.
 *
