...
/**
 * Copied from <a
 * href="https://github.com/matsim-org/matsim-episim-libs/blob/master/src/main/java/org/matsim/episim/EpisimUtils.java">matsim-episim</a>
 */
public final class RandomFromDistribution {
  ...
  public static double nextGaussian(SplittableRandom rnd) {
    // Normally this allows to generate two numbers, but one is thrown away because this function is
    // stateless
  ...
  /**
   * Draws a log normal distributed random number according to X=e^{\mu+\sigma Z}, where Z is a
  ...
  public static double nextLogNormalFromMeanAndSigma(
      SplittableRandom rnd, double mean, double sigma) {
    if (mean > 0) {
