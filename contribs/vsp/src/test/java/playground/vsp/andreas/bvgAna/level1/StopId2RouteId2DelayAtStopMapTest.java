...
public class StopId2RouteId2DelayAtStopMapTest {
  ...
  public void testStopId2RouteId2DelayAtStopMap() {
    ...
    VehicleDepartsAtFacilityEvent event1 =
        new VehicleDepartsAtFacilityEvent(2., vehId1, facilityId1, 0.5);
    VehicleDepartsAtFacilityEvent event2 =
        new VehicleDepartsAtFacilityEvent(2.7, vehId2, facilityId2, 0.7);
    TransitDriverStartsEvent event3 =
        new TransitDriverStartsEvent(
            2.8, driverId1, vehId1, transitLineId1, transitRouteId1, departureId1);
    TransitDriverStartsEvent event4 =
        new TransitDriverStartsEvent(
            2.3, driverId2, vehId2, transitLineId2, transitRouteId2, departureId2);
    ...
    Assert.assertEquals(
        ...
        test.getStopId2RouteId2DelayAtStopMap()
            .get(event1.getFacilityId())
            .get(transitRouteId1)
            .getRealizedDepartures()
            .size());

    //	    String test1 = "{"+transitRouteId1+"=Stop: "+event1.getFacilityId()+", Line:
    // "+transitLineId1+", Route: "+transitRouteId1+", # planned Departures: 1, # realized
    // Departures: 1}";
