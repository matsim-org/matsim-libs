...
public class AgentId2PtTripTravelTimeMapDataTest {
  ...
  public void testAgentId2PtTripTravelTimeMapData() {
    ...
    ActivityEndEvent event =
        new ActivityEndEvent(1.2 * 3600, agentId1, linkId1, facilId1, "w", new Coord(234., 5.67));
    PersonDepartureEvent event3 =
        new PersonDepartureEvent(1.2 * 3600, agentId1, linkId2, "pt", "pt");
    PersonArrivalEvent event4 = new PersonArrivalEvent(1.9 * 3600, agentId1, linkId3, "pt");
    PersonDepartureEvent event5 =
        new PersonDepartureEvent(2.1 * 3600, agentId1, linkId3, "pt", "pt");
    ...
    System.out.println(
        "Total travel time should be: "
            + (event6.getTime() - event5.getTime() + event4.getTime() - event3.getTime())
            + " and is: "
            + test.getTotalTripTravelTime());
