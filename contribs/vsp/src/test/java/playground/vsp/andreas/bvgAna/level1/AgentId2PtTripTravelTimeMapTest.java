...
public class AgentId2PtTripTravelTimeMapTest {
   ...
   * playground.vsp.andreas.bvgAna.level1.AgentId2PtTripTravelTimeMap#AgentId2PtTripTravelTimeMap(java.util.Set)}.
   */
  @Test
  public void testAgentId2PtTripTravelTimeMap() {
    ...
    ActivityStartEvent event1 =
        new ActivityStartEvent(1.0, agentId1, linkId1, facilId1, "w", new Coord(234., 5.67));
    ActivityEndEvent event2 =
        new ActivityEndEvent(1.2, agentId1, linkId1, facilId1, "w", new Coord(234., 5.67));
    ...
    ActivityStartEvent event5 =
        new ActivityStartEvent(
            ...
            facilId2,
            "h",
            new Coord(123., 45.67)); // home mit anderen werten
    ActivityEndEvent event6 =
        new ActivityEndEvent(2.7, agentId1, linkId3, facilId2, "h", new Coord(123., 45.67));
    ...
    Assert.assertEquals(
        event4.getTime() - event3.getTime(),
        test.getAgentId2PtTripTravelTimeMap().get(agentId1).get(0).getTotalTripTravelTime(),
        0.);
  }
}
