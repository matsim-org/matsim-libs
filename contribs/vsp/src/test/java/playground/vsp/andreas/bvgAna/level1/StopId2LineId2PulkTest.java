...
public class StopId2LineId2PulkTest {
  ...
  public void testStopId2LineId2Pulk() {
    ...
    TransitDriverStartsEvent event1 =
        new TransitDriverStartsEvent(
            1.0, driverId1, vehicleId1, transitLineId1, transitRouteId1, departureId1);
    VehicleDepartsAtFacilityEvent event2 =
        new VehicleDepartsAtFacilityEvent(1.0, vehicleId1, facilityId1, 0.5);

    TransitDriverStartsEvent event3 =
        new TransitDriverStartsEvent(
            1.1, driverId2, vehicleId2, transitLineId1, transitRouteId1, departureId2);
    VehicleDepartsAtFacilityEvent event4 =
        new VehicleDepartsAtFacilityEvent(1.1, vehicleId2, facilityId1, 0.5);
    ...
    Assert.assertEquals(
        event2,
        test.getStopId2LineId2PulkDataList()
            .get(event2.getFacilityId())
            .get(event2.getVehicleId()));
