...
public class VehId2PersonEnterLeaveVehicleMapTest {
  ...
  TreeMap<Id, ArrayList<PersonEntersVehicleEvent>> enter =
      new TreeMap<Id, ArrayList<PersonEntersVehicleEvent>>();
  TreeMap<Id, ArrayList<PersonLeavesVehicleEvent>> leave =
  ...
  public void testVehId2PersonEnterLeaveVehicleMap() {
    ...
    //	    Assert.assertEquals(enter.get(vehId1).get(0),
    // test.getVehId2PersonEnterEventMap().get(vehId1).get(0));
    Assert.assertEquals(
        event1.getTime(), test.getVehId2PersonEnterEventMap().get(vehId1).get(0).getTime(), 0.);

    //	    Assert.assertEquals(enter.get(vehId1).get(1),
    // test.getVehId2PersonEnterEventMap().get(vehId1).get(1));
    Assert.assertEquals(
        event2.getTime(), test.getVehId2PersonEnterEventMap().get(vehId1).get(1).getTime(), 0.);

    //	    Assert.assertEquals(leave.get(vehId2).get(0),
    // test.getVehId2PersonLeaveEventMap().get(vehId2).get(0));
    Assert.assertEquals(
        event3.getTime(), test.getVehId2PersonLeaveEventMap().get(vehId2).get(0).getTime(), 0.);

    //	    Assert.assertEquals(leave.get(vehId2).get(1),
    // test.getVehId2PersonLeaveEventMap().get(vehId2).get(1));
    Assert.assertEquals(
        event4.getTime(), test.getVehId2PersonLeaveEventMap().get(vehId2).get(1).getTime(), 0.);
  }
}
