  ...
  protected void prepareControler(Controler controler) {
    ...
    InformedModeChoiceModule.Builder builder =
        InformedModeChoiceModule.newBuilder()
            ...
            .withLegEstimator(
                DefaultLegScoreEstimator.class, ModeOptions.AlwaysAvailable.class, "bike", "walk")
            .withLegEstimator(
                DefaultLegScoreEstimator.class, ModeOptions.ConsiderYesAndNo.class, "car")
            .withTripEstimator(
                PtTripWithDistanceBasedFareEstimator.class,
