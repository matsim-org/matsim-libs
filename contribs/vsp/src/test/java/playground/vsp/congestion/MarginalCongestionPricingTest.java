...
public class MarginalCongestionPricingTest {
  ...
  public final void implV4Test() {
    ...
    for (CongestionEvent event : congestionEvents) {
      ...
      if (event.getLinkId().equals(Id.createLinkId("3"))) {
        ...
        if (event.getCausingAgentId().toString().equals("0")
            && event.getAffectedAgentId().toString().equals("2")) {
          Assert.assertEquals("wrong delay.", 8, event.getDelay(), MatsimTestUtils.EPSILON);
          //					Assert.assertEquals("wrong delay.", 9, event.getDelay(),
          // MatsimTestUtils.EPSILON);//1 sec change  is caused due to the change in the flow
          // accumulation approach (can go to -ive). Amit Jan 17
          link3Delays++;
        } else if (event.getCausingAgentId().toString().equals("2")
            && event.getAffectedAgentId().toString().equals("4")) {
          Assert.assertEquals("wrong delay.", 10, event.getDelay(), MatsimTestUtils.EPSILON);
          link3Delays++;
        } else if (event.getCausingAgentId().toString().equals("0")
            && event.getAffectedAgentId().toString().equals("4")) {
          ...
          link3Delays++;
        } else if (event.getCausingAgentId().toString().equals("4")
            && event.getAffectedAgentId().toString().equals("6")) {
          //	delays 10,5
          ...
          link3Delays++;
        } else if (event.getCausingAgentId().toString().equals("6")
            && event.getAffectedAgentId().toString().equals("8")) {
          //	delays are 10, 10
          ...
          if (repetationPerson8_4Count > 0) {
            ...
            //						Assert.assertEquals("wrong delay.", 13, person8_4Delay,
            // MatsimTestUtils.EPSILON);
          }
          repetationPerson8_4Count++;
          link3Delays++;
        } else if (event.getCausingAgentId().toString().equals("6")
            && event.getAffectedAgentId().toString().equals("9")) {
          ...
          link3Delays++;
        } else if (event.getCausingAgentId().toString().equals("8")
            && event.getAffectedAgentId().toString().equals("9")) {
          Assert.assertEquals("wrong delay.", 10, event.getDelay(), MatsimTestUtils.EPSILON);
          link3Delays++;
        } else if (event.getCausingAgentId().toString().equals("6")
            && event.getAffectedAgentId().toString().equals("7")) {
          ...
          // //1 sec change  is caused due to the change in the flow accumulation approach (can go
          // to -ive). Amit Jan 17
          link3Delays++;
        }
        ...
        if (event.getCausingAgentId().toString().equals("6")
            && event.getAffectedAgentId().toString().equals("7")) {
        ...
        throw new RuntimeException(
            "Delay can not occur on link id - " + event.getLinkId().toString());
    }
  ...
  /**
   * generates network with 6 links. Even persons will go on one branch (up) and odd persons will go
   * on other (down).
   *
   * <p>o----4----o
   *
