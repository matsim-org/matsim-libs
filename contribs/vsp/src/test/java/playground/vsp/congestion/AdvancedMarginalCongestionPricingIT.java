...
public class AdvancedMarginalCongestionPricingIT {
  ...
  // test if the delayed arrival at a normal activity (not the first or last activity) results in
  // the right monetary amount
  @Test
  public final void test1() {

    String configFile =
        testUtils.getPackageInputDirectory() + "AdvancedMarginalCongestionPricingTest/config1.xml";
  ...
  public final void test3() {
    ...
    String configFile =
        testUtils.getPackageInputDirectory() + "AdvancedMarginalCongestionPricingTest/config3.xml";
