...
public final class PtAlongALineAnalysisMainModeIdentifier implements AnalysisMainModeIdentifier {
  ...
  private static final Logger log =
      LogManager.getLogger(PtAlongALineAnalysisMainModeIdentifier.class);
      ...
      if (pe instanceof Leg leg) {
        ...
        if (index < 0) {
          log.error(
              "unknown mode="
                  + leg.getMode()
                  + ". You are using a mode not included in matsim per default. Please bind your own "
                  + "AnalysisMainModeIdentifier that interprets all modes used in your scenario correctly.");
          throw new RuntimeException(
              "unknown mode in AnalysisMainModeIdentifier: " + leg.getMode());
        }
