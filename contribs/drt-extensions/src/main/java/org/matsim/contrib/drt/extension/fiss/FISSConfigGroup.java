...
public class FISSConfigGroup extends ReflectiveConfigGroup {
  ...
  @Parameter
  @Comment(
      "Defines the share of agents that should be explicitly assigned in the QSim. "
          + "Values between (0,1]")
  @Positive
  ...
  @Parameter
  @Comment(
      "Disable FISS in the last iteration to get events of all agents. May be required for post-processing")
