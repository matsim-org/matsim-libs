...
public class DrtShiftsReader extends MatsimXmlParser {
  ...
  private static final String ROOT = "shifts";
  ...
  public void startTag(final String name, final Attributes atts, final Stack<String> context) {
    switch (name) {
      case SHIFT_NAME:
        ...
        break;
      case BREAK_NAME:
        final DrtShiftBreakSpecificationImpl.Builder shiftBreakBuilder =
            DrtShiftBreakSpecificationImpl.newBuilder();
        shiftBreakBuilder.earliestStart(
            Double.parseDouble(atts.getValue(EARLIEST_BREAK_START_TIME)));
