...
public class DrtCompanionParams extends ReflectiveConfigGroupWithConfigurableParameterSets {
	...
	@Parameter
	@Comment("Specifies whether groups larger than the available vehicle seats can be created. If false, additional trips will be generated to accommodate passengers who cannot fit into a single vehicle.")
	private boolean limitCompanionsBySeats = false;

	@Parameter
	@Comment("Defines whether companions are generated by default. Overrides the per-person attribute " + DrtCompanionRideGenerator.PERSON_ATTRIBUTE)
	private boolean generateCompanionsByDefault = true;

	public void setLimitCompanionsBySeats(boolean val) {
		limitCompanionsBySeats = val;
	}

	public boolean getLimitCompanionsBySeats() {
		return limitCompanionsBySeats;
	}

	public void setGenerateCompanionsByDefault(boolean val) {
		generateCompanionsByDefault = val;
	}

	public boolean getGenerateCompanionsByDefault() {
		return generateCompanionsByDefault;
	}
