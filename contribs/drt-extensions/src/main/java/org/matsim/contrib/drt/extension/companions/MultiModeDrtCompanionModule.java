...
public class MultiModeDrtCompanionModule extends AbstractModule {
  ...
  public void install() {
    for (DrtConfigGroup drtCfg : multiModeDrtCfg.getModalElements()) {
      if (drtCfg instanceof DrtWithExtensionsConfigGroup
          && ((DrtWithExtensionsConfigGroup) drtCfg).getDrtCompanionParams().isPresent()) {
        DrtWithExtensionsConfigGroup drtWithExtensionsConfigGroup =
            (DrtWithExtensionsConfigGroup) drtCfg;
