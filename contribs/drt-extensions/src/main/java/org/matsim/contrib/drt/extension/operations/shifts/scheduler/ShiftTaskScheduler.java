...
public interface ShiftTaskScheduler {
  DrtTaskType RELOCATE_VEHICLE_SHIFT_BREAK_TASK_TYPE =
      new DrtTaskType("RELOCATE_SHIFT_BREAK", DRIVE);
  DrtTaskType RELOCATE_VEHICLE_SHIFT_CHANGEOVER_TASK_TYPE =
      new DrtTaskType("RELOCATE_SHIFT_CHANGEOVER", DRIVE);

  void relocateForBreak(ShiftDvrpVehicle vehicle, OperationFacility breakFacility, DrtShift shift);

  void relocateForShiftChange(
