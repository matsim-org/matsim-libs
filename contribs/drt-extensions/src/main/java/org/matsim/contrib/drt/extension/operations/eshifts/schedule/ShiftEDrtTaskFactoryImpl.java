...
public class ShiftEDrtTaskFactoryImpl implements ShiftDrtTaskFactory {
  ...
  @Override
  public DrtDriveTask createDriveTask(
      DvrpVehicle vehicle, VrpPathWithTravelData path, DrtTaskType drtTaskType) {
    return delegate.createDriveTask(vehicle, path, drtTaskType);
  }

  @Override
  public DrtStopTask createStopTask(
  ...
  @Override
  public DrtStayTask createStayTask(
      DvrpVehicle vehicle, double beginTime, double endTime, Link link) {
    return delegate.createStayTask(vehicle, beginTime, endTime, link);
  }

  @Override
  public ShiftBreakTask createShiftBreakTask(
      DvrpVehicle vehicle,
      double beginTime,
      double endTime,
      Link link,
  ...
  @Override
  public ShiftChangeOverTask createShiftChangeoverTask(
      DvrpVehicle vehicle,
      double beginTime,
      double endTime,
      Link link,
  ...
  @Override
  public WaitForShiftStayTask createWaitForShiftStayTask(
      DvrpVehicle vehicle,
      double beginTime,
      double endTime,
      Link link,
  ...
  public WaitForShiftStayTask createChargingWaitForShiftStayTask(
      DvrpVehicle vehicle,
      double beginTime,
      double endTime,
      Link link,
    ...
    ChargingTask chargingTask =
        new ChargingTaskImpl(
            ...
            totalEnergy);
    return new EDrtWaitForShiftStayTask(
        beginTime, endTime, link, totalEnergy, facility, chargingTask);
  }

  public EDrtShiftBreakTaskImpl createChargingShiftBreakTask(
      DvrpVehicle vehicle,
      double beginTime,
      double endTime,
      Link link,
    ...
    ChargingTask chargingTask =
        new ChargingTaskImpl(
            ...
            ((EvDvrpVehicle) vehicle).getElectricVehicle(),
            totalEnergy);
    return new EDrtShiftBreakTaskImpl(
        beginTime, endTime, link, shiftBreak, totalEnergy, chargingTask, facility);
  }

  public ShiftChangeOverTask createChargingShiftChangeoverTask(
      DvrpVehicle vehicle,
      double beginTime,
      double endTime,
      Link link,
    ...
    ChargingTask chargingTask =
        new ChargingTaskImpl(
            ...
            ((EvDvrpVehicle) vehicle).getElectricVehicle(),
            totalEnergy);
    return new EDrtShiftChangeoverTaskImpl(
        beginTime, endTime, link, shift, totalEnergy, chargingTask, facility);
  }
}
