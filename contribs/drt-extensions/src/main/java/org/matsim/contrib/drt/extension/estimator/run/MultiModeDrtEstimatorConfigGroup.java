 ...
 */
public final class MultiModeDrtEstimatorConfigGroup extends ReflectiveConfigGroup
    implements MultiModal<DrtEstimatorConfigGroup> {
  ...
  protected void checkConsistency(Config config) {
    ...
    Verify.verify(
        config.getModule(DrtEstimatorConfigGroup.GROUP_NAME) == null,
  ...
  public Collection<DrtEstimatorConfigGroup> getModalElements() {
    return (Collection<DrtEstimatorConfigGroup>)
        getParameterSets(DrtEstimatorConfigGroup.GROUP_NAME);
  }
