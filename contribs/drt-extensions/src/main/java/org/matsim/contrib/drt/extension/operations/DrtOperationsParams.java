...
public class DrtOperationsParams extends ReflectiveConfigGroupWithConfigurableParameterSets {
  ...
  @Nullable private ShiftsParams shiftsParams;

  @Nullable private OperationFacilitiesParams operationFacilitiesParams;
  ...
  private void initSingletonParameterSets() {
    // shifts (optional)
    addDefinition(
        ShiftsParams.SET_NAME,
        ShiftsParams::new,
        () -> shiftsParams,
        params -> shiftsParams = (ShiftsParams) params);
    // operationFacilities (optional)
    addDefinition(
        OperationFacilitiesParams.SET_NAME,
        OperationFacilitiesParams::new,
