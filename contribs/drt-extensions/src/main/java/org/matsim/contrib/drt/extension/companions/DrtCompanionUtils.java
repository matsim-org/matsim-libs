...
public class DrtCompanionUtils {
  ...
  public static final String ADDITIONAL_GROUP_SIZE_ATTRIBUTE = "additionalGroupSize";
  public static final String ADDITIONAL_GROUP_PART_ATTRIBUTE = "additionalGroupPart";
  ...
  public static WeightedRandomSelection<Integer> createIntegerSampler(
      final List<Double> distribution) {
    WeightedRandomSelection<Integer> wrs =
        new WeightedRandomSelection<>(MatsimRandom.getLocalInstance());
  ...
  public static Integer getAdditionalGroupSize(Person person) {
    if (person.getAttributes().getAttribute(ADDITIONAL_GROUP_SIZE_ATTRIBUTE) == null) {
      ...
      return Integer.parseInt(
          person.getAttributes().getAttribute(ADDITIONAL_GROUP_SIZE_ATTRIBUTE).toString());
    }
  }
  ...
  public static Integer getAdditionalGroupPart(Person person) {
    if (person.getAttributes().getAttribute(ADDITIONAL_GROUP_PART_ATTRIBUTE) == null) {
      ...
      return Integer.parseInt(
          person.getAttributes().getAttribute(ADDITIONAL_GROUP_PART_ATTRIBUTE).toString());
    }
  }
