...
public class OperationFacilitiesReader extends MatsimXmlParser {
  ...
  private static final Logger log = LogManager.getLogger(OperationFacilitiesReader.class);
  ...
  public void startTag(final String name, final Attributes atts, final Stack<String> context) {
    switch (name) {
      case FACILITY_NAME:
        ...
        Coord coord =
            new Coord(
                Double.parseDouble(atts.getValue(X_COORD)),
                Double.parseDouble(atts.getValue(Y_COORD)));
