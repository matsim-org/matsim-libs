...
public record InsertionCalculator(Network network, double stopDuration, LinkToLinkTravelTimeMatrix linkToLinkTravelTimeMatrix) {
    public final static double NOT_FEASIBLE_COST = 1e6;
