...
public class FISSQSimModule extends AbstractQSimModule {
  ...
  public static final String COMPONENT_NAME = "FISS";
  ...
  @Provides
  @Singleton
  FISS provideMultiModalDepartureHandler(
    ...
    return new FISS(
        matsimServices, qNetsimEngine, scenario, eventsManager, fissConfigGroup, travelTime);
  }
}
