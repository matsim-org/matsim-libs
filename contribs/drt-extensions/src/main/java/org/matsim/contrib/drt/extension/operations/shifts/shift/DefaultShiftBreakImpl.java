...
public class DefaultShiftBreakImpl implements DrtShiftBreak {
  ...
  private static final double UNSCHEDULED_ARRIVAL_TIME = Double.NaN;
  ...
  public DefaultShiftBreakImpl(
      double earliestBreakStartTime, double latestBreakEndTime, double duration) {
