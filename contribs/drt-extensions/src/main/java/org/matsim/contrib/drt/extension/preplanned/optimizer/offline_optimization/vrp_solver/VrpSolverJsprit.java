...
public class VrpSolverJsprit implements VrpSolver {
    ...
    public VrpSolverJsprit(Options options, DrtConfigGroup drtCfg, Network network, TravelTime travelTime) {
    ...
    private TravelTimeMatrix createTravelTimeMatrix(double time) {
        ...
        Matrix nodeToNodeMatrix = TravelTimeMatrices.calculateTravelTimeMatrix(
			new TravelTimeMatrices.RoutingParams(network, travelTime, travelDisutility, Runtime.getRuntime().availableProcessors()), nodeByZone, time);
