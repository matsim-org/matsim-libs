...
public class MultiModalDrtLegEstimatorTest {
  ...
  public void setUp() throws Exception {
    ...
    controler =
        MATSimApplication.prepare(
            new DrtTestScenario(
                MultiModalDrtLegEstimatorTest::prepare, MultiModalDrtLegEstimatorTest::prepare),
            config);
  }
  ...
  private static void prepare(Controler controler) {
    InformedModeChoiceModule.Builder builder =
        InformedModeChoiceModule.newBuilder()
            ...
            .withLegEstimator(
                MultiModalDrtLegEstimator.class, ModeOptions.AlwaysAvailable.class, "drt", "av");
  ...
  private static void prepare(Config config) {
    ...
    MultiModeDrtEstimatorConfigGroup estimators =
        ConfigUtils.addOrGetModule(config, MultiModeDrtEstimatorConfigGroup.class);
  ...
  public void run() {
    ...
    assertThat(new File(out, "kelheim-mini-drt.drt_estimates_drt.csv")).exists().isNotEmpty();
  }
}
