...
public class DrtWithExtensionsConfigGroupTest {
  private static final double WEIGHT_1 = 4711.;
  private static final double WEIGHT_2 = 1337.;
  private static final double WEIGHT_3 = 911.;
  ...
  private static Path writeConfig(final TemporaryFolder tempFolder, List<Double> weights)
      throws IOException {
  ...
  public void loadConfigGroupTest() throws IOException {
    ...
    DrtWithExtensionsConfigGroup loadedCfg =
        ConfigUtils.addOrGetModule(config, DrtWithExtensionsConfigGroup.class);
    Assert.assertTrue(loadedCfg.getDrtCompanionParams().isPresent());
    Assert.assertTrue(
        loadedCfg
            .getDrtCompanionParams()
            .get()
