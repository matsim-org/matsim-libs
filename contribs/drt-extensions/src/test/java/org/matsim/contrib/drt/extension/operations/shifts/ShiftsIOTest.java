...
public class ShiftsIOTest {
  ...
  private void checkContent(DrtShiftsSpecification shiftsSpecification) {
    ...
    DrtShiftSpecification shiftSpecification1 =
        shiftsSpecification.getShiftSpecifications().get(sid11);
    ...
    assertEquals(
        28800., shiftSpecification1.getBreak().orElseThrow().getEarliestBreakStartTime(), 0);
    assertEquals(32400., shiftSpecification1.getBreak().orElseThrow().getLatestBreakEndTime(), 0);

    DrtShiftSpecification shiftSpecification2 =
        shiftsSpecification.getShiftSpecifications().get(sid22);
    ...
    assertEquals(
        29200., shiftSpecification2.getBreak().orElseThrow().getEarliestBreakStartTime(), 0);
    assertEquals(32800., shiftSpecification2.getBreak().orElseThrow().getLatestBreakEndTime(), 0);

    DrtShiftSpecification shiftSpecification3 =
        shiftsSpecification.getShiftSpecifications().get(sid33);
