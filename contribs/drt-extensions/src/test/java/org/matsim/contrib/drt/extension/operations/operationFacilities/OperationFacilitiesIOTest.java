...
public class OperationFacilitiesIOTest {
  ...
  public void test() {
    ...
    OperationFacilitiesSpecification operationFacilities =
        new OperationFacilitiesSpecificationImpl();

    for (int i = 0; i < 10; i++) {
      operationFacilities.addOperationFacilitySpecification(
          OperationFacilitySpecificationImpl.newBuilder() //
    ...
    new OperationFacilitiesWriter(operationFacilities)
        .writeFile(utils.getOutputDirectory() + "facilities.xml");
    ...
    for (int i = 0; i < 10; i++) {
      ...
      final OperationFacilitySpecification facility =
          copy.getOperationFacilitySpecifications().get(id);
