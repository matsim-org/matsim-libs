...
//			}
		...
		{ // need to go away
			String file2del = outDir+linkDynamics+"_"+trafficDynamics+"_maxflowFromFdiag.png";
			new File(file2del).deleteOnExit();
		}

		{ // need to go away
			String file2del = outDir+linkDynamics+"_"+trafficDynamics+"_none.png";
			new File(file2del).deleteOnExit();
		}
