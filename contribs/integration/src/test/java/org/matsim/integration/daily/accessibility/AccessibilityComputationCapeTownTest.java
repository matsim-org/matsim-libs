		...
		if (createQGisOutput) {
			...
			for (String actType : activityTypes) {
				...
				for (Modes4Accessibility mode : acg.getIsComputingMode()) {
					...
					VisualizationUtils.createQGisOutputGraduatedStandardColorRange(actType, mode.toString(), new Envelope(-520000, -488000, -3733000, -3698000), workingDirectory, TransformationFactory.WGS84_SA_Albers, includeDensityLayer,
