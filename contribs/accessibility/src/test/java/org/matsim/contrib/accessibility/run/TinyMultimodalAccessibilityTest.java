...
public class TinyMultimodalAccessibilityTest {
  ...
  private static Scenario createTestScenario(final Config config) {
    ...
    ActivityFacility facility1 =
        opportunities
            .getFactory()
            .createActivityFacility(Id.create("1", ActivityFacility.class), new Coord(200, 0));
    opportunities.addActivityFacility(facility1);
    ActivityFacility facility2 =
        opportunities
            .getFactory()
            .createActivityFacility(Id.create("2", ActivityFacility.class), new Coord(200, 200));
    opportunities.addActivityFacility(facility2);
    // ActivityFacility facility3 = opportunities.getFactory().createActivityFacility(Id.create("3",
    // ActivityFacility.class), new Coord(280, 40));
  ...
  public static TransitSchedule createTransitSchedule(Scenario scenario) {
    ...
    Departure dep =
        builder.createDeparture(Id.create("dep1", Departure.class), 8. * 3600 + 1. * 60.);
  ...
  public static Network createLessSymmetricMultimodalTestNetwork(Scenario scenario) {
    ...
    Node node1 =
        NetworkUtils.createAndAddNode(
            network, Id.create(1, Node.class), new Coord((double) 10, (double) 100));
    Node node2 =
        NetworkUtils.createAndAddNode(
            network, Id.create(2, Node.class), new Coord((double) 10, (double) 190));
    Node node3 =
        NetworkUtils.createAndAddNode(
            network, Id.create(3, Node.class), new Coord((double) 10, (double) 10));
    Node node4 =
        NetworkUtils.createAndAddNode(
            network, Id.create(4, Node.class), new Coord((double) 120, (double) 100));
    Node node5 =
        NetworkUtils.createAndAddNode(
            network, Id.create(5, Node.class), new Coord((double) 120, (double) 190));
    Node node6 =
        NetworkUtils.createAndAddNode(
            network, Id.create(6, Node.class), new Coord((double) 120, (double) 10));
    Node node7 =
        NetworkUtils.createAndAddNode(
            network, Id.create(7, Node.class), new Coord((double) 190, (double) 100));
    Node node8 =
        NetworkUtils.createAndAddNode(
            network, Id.create(8, Node.class), new Coord((double) 190, (double) 190));
    Node node9 =
        NetworkUtils.createAndAddNode(
            network, Id.create(9, Node.class), new Coord((double) 190, (double) 10));
    Node node10 =
        NetworkUtils.createAndAddNode(
            network, Id.create(10, Node.class), new Coord((double) 40, (double) 40));
    Node node11 =
        NetworkUtils.createAndAddNode(
            network, Id.create(11, Node.class), new Coord((double) 140, (double) 40));
    Node node12 =
        NetworkUtils.createAndAddNode(
            network, Id.create(12, Node.class), new Coord((double) 240, (double) 40));
      ...
      for (Tuple<ActivityFacility, Double> tuple : accessibilitiesMap.keySet()) {
        ...
        LOG.warn(
            "CHECK X = "
                ...
                + tuple.getFirst().getCoord().getY()
                + " -- car value = "
                + accessibilitiesMap.get(tuple).get(TransportMode.car));
        if (tuple.getFirst().getCoord().getX() == 50.) {
          if (tuple.getFirst().getCoord().getY() == 50.) {
            Assert.assertEquals(
                -0.017248522428805767,
                accessibilitiesMap.get(tuple).get("freespeed"),
            ...
            Assert.assertEquals(
                ...
                MatsimTestUtils.EPSILON);
            Assert.assertEquals(
                0.0020510618020555325,
                accessibilitiesMap.get(tuple).get(TransportMode.pt),
                MatsimTestUtils.EPSILON);
