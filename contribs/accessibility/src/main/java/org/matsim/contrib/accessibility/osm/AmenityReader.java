...
public class AmenityReader {
  private static final Logger log = LogManager.getLogger(AmenityReader.class);
   ...
   *     href="http://wiki.openstreetmap.org/wiki/Key:amenity">Amenity values</a> to MATSim activity
   *     types.
   ...
   */
  public AmenityReader(
      String file, CoordinateTransformation ct, Map<String, String> osmToMatsimTypeMap) {
