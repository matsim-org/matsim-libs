...
public final class AccessibilityFacilityUtils {
  ...
  public static Map<String, String> buildOsmAmenityToMatsimTypeMap() {
    // yyyy intellij says that what follows here is identical with something in OSMKeyForLeisure.
    // kai, feb'20
  ...
  public static Map<String, String> buildOsmLeisureToMatsimTypeMap() {
    // yyyy intellij says that what follows here is identical with something in
    // RunCombinedOsmReaderCottbus.  kai, feb'20
  ...
  public static Map<String, String> buildOsmLeisureToMatsimTypeMapV2() {
    ...
    map.put(
        "recreation_ground",
        FacilityTypes.LEISURE); // not in Wiki, but in tags; Added on 2018-12-12
