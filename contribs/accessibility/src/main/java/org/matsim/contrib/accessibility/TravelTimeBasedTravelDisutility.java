...
class TravelTimeBasedTravelDisutility implements TravelDisutility{
	...
	public TravelTimeBasedTravelDisutility(final TravelTime timeCalculator, ScoringConfigGroup cnScoringGroup) {
		 ...
		 */
		this.marginalCostOfTime = (-cnScoringGroup.getDefaultModeParams().get(TransportMode.car).getMarginalUtilityOfTraveling() / 3600.0) + (cnScoringGroup.getDefaultPerforming_utils_hr() / 3600.0);
	}
