...
public class CombinedOsmReader {
  private static final Logger log = LogManager.getLogger(CombinedOsmReader.class);
  ...
  public void parseFile(String osmFile) throws FileNotFoundException {
    ...
    CombinedOsmSink combinedOsmSink =
        new CombinedOsmSink(
            this.outputCRS,
            this.osmLandUseToMatsimTypeMap,
            this.osmBuildingToMatsimTypeMap,
            this.osmAmenityToMatsimTypeMap,
            this.osmLeisureToMatsimTypeMap,
            this.osmTourismToMatsimTypeMap,
            this.unmannedEntitiesList,
