...
public class LandUseBuildingReader {
  private static final Logger log = LogManager.getLogger(LandUseBuildingReader.class);
   ...
   * @param ct the (projected) coordinate reference system to which the WGS84 coordinates of
   *     OpenStreetMap will be converted to; and
   * @param osmToMatsimTypeMap a mapping of OpenStreetMap <a
   *     href="http://wiki.openstreetmap.org/wiki/Key:landuse">Land Use</a> to MATSim activity
   *     types.
   */
  public LandUseBuildingReader(
  ...
  public void parseLandUseAndBuildings(String file) throws FileNotFoundException {
    ...
    LandUseBuildingSink landUseBuildingSink =
        new LandUseBuildingSink(
            this.ct,
            this.osmLandUseToMatsimTypeMap,
            this.osmBuildingToMatsimTypeMap,
