...
public final class SpatialGridTableWriter {
  ...
  public void write(SpatialGrid grid, String fileName) throws IOException {
    ...
    //		// it is a bit idiotic to do as follows.  However, I need the output scanline by scanline,
    // and that is not possible with the
    //		// regular accessibility writer.  Clearly, the following should somehow be separate ... and
