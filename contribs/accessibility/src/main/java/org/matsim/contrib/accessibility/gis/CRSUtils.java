...
final class CRSUtils {
  ...
  private static final Map<Integer, CoordinateReferenceSystem> crsMappings =
      new ConcurrentHashMap<Integer, CoordinateReferenceSystem>();
  ...
  /**
   * Returns the spatial reference id for a given coordinate reference system. If the coordinate
   * reference system has multiple identifiers one is randomly selected.
   *
   * @param crs a coordinate reference system.
   * @return the spatial reference id for the coordinate reference system or <tt>0</tt> if the
   *     coordinate reference system has no identifiers.
   */
  ...
  /**
   * Determines the transformation from the coordinate reference system of <tt>source</tt> to the
   * one of <tt>target</tt>.
   *
   * @param source a geometry.
   * @param target a geometry.
   * @return a transformation or <tt>null</tt> if the transformation could not be determined.
   */
