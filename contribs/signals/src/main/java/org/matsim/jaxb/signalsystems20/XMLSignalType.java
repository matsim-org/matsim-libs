...
@XmlType(
    name = "signalType",
    propOrder = {"lane", "turningMoveRestrictions"})
public final class XMLSignalType extends XMLMatsimObjectType {
   ...
   * there is not a <CODE>set</CODE> method for the lane property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link XMLSignalType.XMLLane }
   */
   ...
   *
   * @return possible object is {@link XMLSignalType.XMLTurningMoveRestrictions }
   */
   ...
   *
   * @param value allowed object is {@link XMLSignalType.XMLTurningMoveRestrictions }
   */
  ...
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "")
  public static class XMLLane extends XMLIdRefType {}
