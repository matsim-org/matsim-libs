...
@XmlType(
    ...
    propOrder = {"signalSystemController"})
public final class XMLSignalSystemType extends XMLIdRefType {
   ...
   *
   * @return possible object is {@link XMLSignalSystemControllerType }
   */
   ...
   *
   * @param value allowed object is {@link XMLSignalSystemControllerType }
   */
