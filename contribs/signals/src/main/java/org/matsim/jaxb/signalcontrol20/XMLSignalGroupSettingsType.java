...
@XmlType(
    name = "signalGroupSettingsType",
    propOrder = {"onset", "dropping"})
public final class XMLSignalGroupSettingsType extends XMLIdRefType {
   ...
   *
   * @return possible object is {@link XMLSignalGroupSettingsType.XMLOnset }
   */
   ...
   *
   * @param value allowed object is {@link XMLSignalGroupSettingsType.XMLOnset }
   */
   ...
   *
   * @return possible object is {@link XMLSignalGroupSettingsType.XMLDropping }
   */
   ...
   *
   * @param value allowed object is {@link XMLSignalGroupSettingsType.XMLDropping }
   */
