...
@XmlType(
    name = "signalSystemControllerType",
    propOrder = {"controllerIdentifier", "signalPlan"})
public final class XMLSignalSystemControllerType {
   ...
   * there is not a <CODE>set</CODE> method for the signalPlan property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link XMLSignalPlanType }
   */
