...
/**
 * This is the base type for all matsim objects which have an type-wide unique id. Be aware of the
 * idRefType which has to be used in all cases where an Id is only referenced.
 *
...
@XmlSeeAlso({XMLSignalSystemType.class, XMLSignalType.class})
