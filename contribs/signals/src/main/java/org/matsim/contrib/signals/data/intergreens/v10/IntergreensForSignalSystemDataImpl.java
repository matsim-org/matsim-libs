...
public final class IntergreensForSignalSystemDataImpl implements IntergreensForSignalSystemData {
  ...
  private Map<Id<SignalGroup>, Map<Id<SignalGroup>, Integer>> endingGroupToBeginningGroupTimeMap =
      new HashMap<>();
  private Map<Id<SignalGroup>, Map<Id<SignalGroup>, Integer>> beginningGroupToEndingGroupTimeMap =
      new HashMap<>();
  ...
  public List<Tuple<Id<SignalGroup>, Id<SignalGroup>>> getEndingBeginningSignalGroupKeys() {
    ...
    for (Entry<Id<SignalGroup>, Map<Id<SignalGroup>, Integer>> e :
        this.endingGroupToBeginningGroupTimeMap.entrySet()) {
  ...
  @Override
  public Integer getIntergreenTime(
      Id<SignalGroup> endingSignalGroupId, Id<SignalGroup> beginningSignalGroupId) {
    Map<Id<SignalGroup>, Integer> beginningSgMap =
        this.endingGroupToBeginningGroupTimeMap.get(endingSignalGroupId);
  ...
  @Override
  public void setIntergreenTime(
      Integer timeSeconds,
      Id<SignalGroup> endingSignalGroupId,
      Id<SignalGroup> beginningSignalGroupId) {
    Map<Id<SignalGroup>, Integer> endingSgMap =
        this.endingGroupToBeginningGroupTimeMap.get(endingSignalGroupId);
    if (endingSgMap == null) {
    ...
    Map<Id<SignalGroup>, Integer> beginningSgMap =
        this.beginningGroupToEndingGroupTimeMap.get(beginningSignalGroupId);
    if (beginningSgMap == null) {
