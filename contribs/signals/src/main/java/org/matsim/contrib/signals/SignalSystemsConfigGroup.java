...
public final class SignalSystemsConfigGroup extends ReflectiveConfigGroup {
  ...
  public static final String ACTION_ON_CONFLICTING_DIRECTION_VIOLATION =
      "actionOnConflictingDirectionViolation";
  ...
  private ActionOnSignalSpecsViolation actionOnIntergreenViolation =
      ActionOnSignalSpecsViolation.WARN;
  private ActionOnSignalSpecsViolation actionOnConflictingDirectionViolation =
      ActionOnSignalSpecsViolation.WARN;
  ...
  protected void checkConsistency(Config config) {
    if ((this.signalSystemFile == null) && (this.signalControlFile != null)) {
      throw new IllegalStateException(
          "For using a SignalSystemConfiguration a definition of the signal systems must exist!");
    }
  }
  ...
  public void setActionOnIntergreenViolation(
      ActionOnSignalSpecsViolation actionOnIntergreenViolation) {
      ...
      default:
        throw new IllegalArgumentException(
            "The value "
                ...
                + " for key : "
                + ACTION_ON_INTERGREEN_VIOLATION
                + " is not supported by this config group");
    }
  }
  ...
  public void setActionOnConflictingDirectionViolation(
      ActionOnSignalSpecsViolation actionOnConflictingDirectionViolation) {
      ...
      default:
        throw new IllegalArgumentException(
            "The value "
                + actionOnConflictingDirectionViolation
                + " for key : "
                + ACTION_ON_CONFLICTING_DIRECTION_VIOLATION
                + " is not supported by this config group");
    }
  }
