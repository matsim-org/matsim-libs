...
public final class IntergreenTimesWriter10 extends MatsimJaxbXmlWriter {
  ...
  public static final String INTERGREENTIMES10 =
      "http://www.matsim.org/files/dtd/intergreenTimes_v1.0.xsd";
  ...
  private XMLIntergreenTimes convertDataToXml() {
    ...
    for (IntergreensForSignalSystemData intergreens :
        this.intergreensData.getIntergreensForSignalSystemDataMap().values()) {
      ...
      for (Tuple<Id<SignalGroup>, Id<SignalGroup>> endingBeginningSgIds :
          intergreens.getEndingBeginningSignalGroupKeys()) {
        XMLEndingSignalGroupType xmlEnding =
            this.getXmlEnding(xmlss.getEndingSignalGroup(), endingBeginningSgIds.getFirst());
        if (xmlEnding == null) {
        ...
        XMLBeginningSignalGroup xmlBeginn =
            fac.createXMLEndingSignalGroupTypeXMLBeginningSignalGroup();
        xmlBeginn.setRefId(endingBeginningSgIds.getSecond().toString());
        xmlBeginn.setTimeSeconds(
            BigInteger.valueOf(
                intergreens.getIntergreenTime(
                    endingBeginningSgIds.getFirst(), endingBeginningSgIds.getSecond())));
  ...
  private XMLEndingSignalGroupType getXmlEnding(
      List<XMLEndingSignalGroupType> endings, Id<SignalGroup> endingId) {
