...
public final class CreateAllDayGreenFromSignalControl {
  ...
  public static void main(String[] args) {
    ...
    if (args == null || args.length < 2) {
      throw new UnsupportedOperationException(
          "Please call this class with two arguments: "
  ...
  private static Scenario convertSignalControl(String pathToSignalControl) {
    ...
    for (SignalSystemControllerData signalSystemControl :
        signals.getSignalControlData().getSignalSystemControllerDataBySystemId().values()) {
      ...
      for (SignalPlanData signalPlan : signalSystemControl.getSignalPlanData().values()) {
        ...
        for (SignalGroupSettingsData signalGroupSetting :
