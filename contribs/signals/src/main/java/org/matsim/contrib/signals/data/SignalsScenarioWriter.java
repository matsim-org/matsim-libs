...
public final class SignalsScenarioWriter {
  ...
  private static final String FILENAME_CONFLICTING_DIRECTIONS =
      "output_conflicting_directions_v1.0.xml.gz";
  ...
  public SignalsScenarioWriter(String outputDirectoryPath) {
    ...
    this.pathToConflictingDirectionsOutputFilename =
        outputDirectoryPath + FILENAME_CONFLICTING_DIRECTIONS;
  }
  ...
  public SignalsScenarioWriter(final OutputDirectoryHierarchy controlerIo) {
    ...
    this.pathToIntergreenTimesOutputFilename =
        controlerIo.getOutputFilename(FILENAME_INTERGREEN_TIMES);
