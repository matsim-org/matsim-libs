 ...
 */
public class SignalsAndLanesOsmNetworkReaderBenchmark extends OsmNetworkReader {

	private final static Logger LOG = Logger.getLogger(SignalsAndLanesOsmNetworkReaderBenchmark.class);
...
//		String outputDir = "../../../../../../shared-svn/studies/sbraun/osmData/signalsAndLanesReader/cottbus/";
		...
		SignalsAndLanesOsmNetworkReaderBenchmark reader = new SignalsAndLanesOsmNetworkReaderBenchmark(network, ct, signalsData, lanes);
...
//		reader.setMakePedestrianSignals(false);
	...
	public SignalsAndLanesOsmNetworkReaderBenchmark(Network network, CoordinateTransformation transformation,
