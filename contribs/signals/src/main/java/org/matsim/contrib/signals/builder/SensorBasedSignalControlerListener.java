 ...
 */
final class SensorBasedSignalControlerListener
    implements SignalControlerListener, IterationStartsListener, ShutdownListener {

  @Inject(optional = true)
  SignalSystemsManager signalManager = null;

  @Inject(optional = true)
  LinkSensorManager sensorManager = null;

  @Override
  public void notifyIterationStarts(IterationStartsEvent event) {
    if (this.sensorManager != null) this.sensorManager.reset(event.getIteration());
  }
