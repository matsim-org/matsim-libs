...
final class OTFClientLiveWithSignals {
          ...
          public void run() {
            OTFVisConfigGroup otfVisConfigGroup =
                ConfigUtils.addOrGetModule(
                    config, OTFVisConfigGroup.GROUP_NAME, OTFVisConfigGroup.class);
            ...
            if ((config.qsim().isUseLanes())
              ...
              connectionManager.connectReaderToReceiver(
                  OTFLaneReader.class, OTFLaneSignalDrawer.class);
              connectionManager.connectReceiverToLayer(
                  OTFLaneSignalDrawer.class, SimpleSceneLayer.class);
            } else if ((boolean)
                ConfigUtils.addOrGetModule(
                        config, SignalSystemsConfigGroup.GROUP_NAME, SignalSystemsConfigGroup.class)
                    .isUseSignalSystems()) {
              ...
              connectionManager.connectReaderToReceiver(
                  OTFSignalReader.class, OTFLaneSignalDrawer.class);
              connectionManager.connectReceiverToLayer(
                  OTFLaneSignalDrawer.class, SimpleSceneLayer.class);
            }
            ...
            OTFOGLDrawer mainDrawer =
                new OTFOGLDrawer(clientQuadTree, otfVisConfigGroup, canvas, hostControl);
            ...
            if (otfVisConfigGroup.isMapOverlayMode()) {
              ...
              if (otfVisConfigGroup.getMapBaseURL().isEmpty()) {
                ...
                WMSService wms =
                    new WMSService(
                        otfVisConfigGroup.getMapBaseURL(), otfVisConfigGroup.getMapLayer());
  ...
  private static TileFactory osmTileFactory() {
    ...
    TileFactoryInfo info =
        new TileFactoryInfo(
            0, 17, 17, 256, true, true, "http://tile.openstreetmap.org", "x", "y", "z") {
          @Override
