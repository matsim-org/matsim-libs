...
public final class SylviaConfigGroup extends ReflectiveConfigGroup {
  ...
  private static final String USE_FIXED_TIME_CYCLE_CMT =
      "limits the total amount of available extension time to the cycle time "
  ...
  private static final String MAX_GREEN_SCALE_CMT =
      "The maximal green time for each signal group is determined by multiplying "
  ...
  /**
   * extends the phase only if downstream links are empty. except forced extension points that are
   * extended anyway. i.e. switch off useFixedTimeCycle... too to get meaningful results
   */
