...
public final class Signals {
  ...
  public static class Configurator {
    ...
    /**
     * Call this method when you want to add your own SignalController. E.g. via new
     * Configurator(controler).addSignalControllerFactory(LaemmerSignalController.IDENTIFIER,
     * LaemmerSignalController.LaemmerFactory.class);
     */
    public final void addSignalControllerFactory(
