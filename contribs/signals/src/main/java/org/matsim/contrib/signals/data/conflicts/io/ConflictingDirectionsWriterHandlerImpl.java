...
final class ConflictingDirectionsWriterHandlerImpl implements ConflictingDirectionsWriterHandler {
  ...
  public void writeHeaderAndStartElement(BufferedWriter out) throws IOException {
    ...
    //		out.write("<!DOCTYPE conflictData SYSTEM \"" + MatsimXmlWriter.DEFAULT_DTD_LOCATION +
    // "conflictData.dtd\">\n\n");
  }
  ...
  public void writeIntersections(ConflictData conflictData, BufferedWriter out) throws IOException {
    for (IntersectionDirections conflictingDirections :
        conflictData.getConflictsPerSignalSystem().values()) {
      this.startIntersection(
          conflictingDirections.getNodeId(), conflictingDirections.getSignalSystemId(), out);
  ...
  private void startIntersection(Id<Node> nodeId, Id<SignalSystem> systemId, BufferedWriter out)
      throws IOException {
  ...
  private void writeListOfDirections(List<Id<Direction>> directionList, BufferedWriter out)
      throws IOException {
