...
/**
 * Creates a simple one-crossing-scenario and starts it with the simple responsive signal from this
 * package.
 *
 * @author tthunig
 */
public class RunSimpleResponsiveSignalExample {
  ...
  public RunSimpleResponsiveSignalExample() {
    ...
    new Configurator(controler)
        .addSignalControllerFactory(
            SimpleResponsiveSignal.IDENTIFIER,
  ...
  private static void createSignals(Scenario scenario) {
    ...
    SignalPlanData signalPlan =
        SignalUtils.createSignalPlan(conFac, 60, 0, Id.create("SignalPlan1", SignalPlan.class));
