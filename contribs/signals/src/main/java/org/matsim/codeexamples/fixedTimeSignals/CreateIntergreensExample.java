 ...
 *
 * <p>If there is no intergreen data available for your scenario you may use the intergreen times of
 * a correct fixed time signal control, i.e. a signal control with realistic intergreen times where
 * no collisions may occur.
 *
 * @link TtCalculateSimplifiedIntergreens for how to extract intergreen times from a fixed time
 *     control
 * @author dgrether
 */
public class CreateIntergreensExample {
  ...
  private static void createIntergreens(SignalsData sd) {
    ...
    IntergreensForSignalSystemData ig3 =
        igdf.createIntergreensForSignalSystem(Id.create("3", SignalSystem.class));
    ...
    IntergreensForSignalSystemData ig4 =
        igdf.createIntergreensForSignalSystem(Id.create("4", SignalSystem.class));
  ...
  public static void main(String[] args) throws IOException {
    ...
    IntergreenTimesWriter10 writer =
        new IntergreenTimesWriter10(signalsData.getIntergreenTimesData());
