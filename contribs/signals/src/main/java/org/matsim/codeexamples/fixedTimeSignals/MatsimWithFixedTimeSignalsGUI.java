...
/**
 * Starts a MATSim GUI that is able to simulate fixed-time traffic signals and by default runs the
 * example that can be found in examples/tutorial/example90TrafficLights with lanes.
 *
 * @author tthunig
 */
