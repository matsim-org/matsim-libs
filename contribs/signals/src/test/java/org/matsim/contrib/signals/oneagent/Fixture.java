...
public class Fixture {
  ...
  private Config createConfigOneSignal(Boolean useIntergreens) {
    ...
    if (useIntergreens) {
      ...
      signalsConfig.setActionOnIntergreenViolation(
  ...
  private void setSignalSystemConfigValues(
      SignalSystemsConfigGroup signalsConfig, MatsimTestUtils testUtils) {
  ...
  public Scenario createAndLoadTestScenarioTwoSignals(boolean useConflictData) {
    ...
    signalsConfig.setIntersectionLogic(
    ...
    net.addLink(
        net.getFactory()
            .createLink(linkId6, net.getNodes().get(nodeId2), net.getNodes().get(nodeId6)));
    ...
    signalsData
        ...
        .getSignalSystemData()
        .get(signalSystemId2)
        .addSignalData(secondSignal);
    SignalGroupData secondGroup =
        signalsData
            .getSignalGroupsData()
            .getFactory()
    ...
    SignalGroupSettingsData groupPlanSettings =
        signalsData
            .getSignalControlData()
            .getFactory()
    ...
    // add conflict data
    IntersectionDirections conflictsNode2 =
        signalsData
