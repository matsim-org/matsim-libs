...
//    @SuppressWarnings("ConstantConditions")
    ...
    public void singleJunction(){
        ...
        Way way1 = new Way(1,nodeWay1,Arrays.asList(new Tag("highway", "motorway"), new Tag("oneway","no")));
        Way way2 = new Way(2,nodeWay2,Arrays.asList(new Tag("highway", "motorway"), new Tag("oneway","no")));
        ...
        new NetworkWriter(network).write(file.getParent().toAbsolutePath().toString() + "\\network.xml");
