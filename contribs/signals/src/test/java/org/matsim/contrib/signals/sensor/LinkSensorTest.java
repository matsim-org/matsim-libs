...
public class LinkSensorTest {
  ...
  /**
   * Creates a Network with one 600 m link fs 6 -> fs_tt 100 s and flow_cap = 1 veh/s 1 ---------- 2
   */
  ...
  public void testSensorNumberOfCarsMonitoring() {
    ...
    VehicleLeavesTrafficEvent link2WaitEvent =
        new VehicleLeavesTrafficEvent(110.0, agId2, link.getId(), vehId2, TransportMode.car, 1.0);
  ...
  public void testSensorDistanceMonitoring() {
    ...
    VehicleLeavesTrafficEvent link2WaitEvent =
        new VehicleLeavesTrafficEvent(101.0, agId2, link.getId(), vehId2, TransportMode.car, 1.0);
    sensor.handleEvent(link2WaitEvent);
