 ...
 *
 * <p>Additionally, it supports a main method to start the otfvis with signals and lanes example out
 * of Eclipse, where it is not possible to execute main methods using MATSim from contribs (except
 * in tests).
 */
