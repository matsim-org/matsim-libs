...
public class TransitPerformanceRecorder {
  ...
  public TransitPerformanceRecorder(
      Scenario scenario, EventsManager eventsManager, MobSimSwitcher switcher) {
  ...
  public TransitPerformanceRecorder(Scenario scenario, EventsManager eventsManager) {
    ...
    vehicletrackers =
        new VehicleTrackerCollection(scenario.getTransitVehicles().getVehicles().size());
  ...
  class RidershipHandler
    ...
    public void handleEvent(PersonEntersVehicleEvent event) {
      VehicleTracker tracker =
          vehicletrackers.get(event.getVehicleId().toString(), event.getTime());
      // skip car drivers
    ...
    public void handleEvent(TransitDriverStartsEvent event) {
      ...
      VehicleTracker tracker =
          new VehicleTracker(
              fullDeparture, event.getDriverId(), getVehicleCapacity(event.getVehicleId()));
    ...
    public void handleEvent(VehicleArrivesAtFacilityEvent event) {
      ...
      transitPerformance.addVehicleDwellEventAtStop(
          tracker.getFullDeparture().getLineId(),
          tracker.getFullDeparture().getRouteId(),
          event.getFacilityId(),
          dwellEvent);
    }
