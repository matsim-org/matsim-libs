 ...
 * number of bytes have been written, or when the flush method is invoked.
 *
 * <p>Copyright 2005 - Philip Isenhour - http://javatechniques.com/
 *
 ...
 *
 * <p>1. The origin of this software must not be misrepresented; you must not claim that you wrote
 * the original software. If you use this software in a product, an acknowledgment in the product
 * documentation would be appreciated but is not required.
 *
 * <p>2. Altered source versions must be plainly marked as such, and must not be misrepresented as
 * being the original software.
 *
 * <p>3. This notice may not be removed or altered from any source distribution.
 *
 * <p>$Id: 1.1 2005/10/26 17:19:05 isenhour Exp $
 */
import java.io.*;
...
public class CompressedBlockOutputStream extends FilterOutputStream {
  ...
  /**
   * Constructs a CompressedBlockOutputStream that writes to the given underlying output stream 'os'
   * and sends a compressed block once 'size' byte have been written. The default compression
   * strategy and level are used.
   */
  ...
  /**
   * Constructs a CompressedBlockOutputStream that writes to the given underlying output stream 'os'
   * and sends a compressed block once 'size' byte have been written. The compression level and
   * strategy should be specified using the constants defined in java.util.zip.Deflator.
   */
