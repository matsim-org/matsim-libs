...
class PlanSerializable implements Serializable {
  ...
  public PlanSerializable(Plan plan) {
    ...
    for (PlanElement planElement : plan.getPlanElements())
      ...
      else planElements.add(new LegSerializable((Leg) planElement));
  ...
  public Plan getPlan(Population population) {
    ...
    for (PlanElementSerializable planElementSerializable : planElements)
      ...
      else plan.addLeg(((LegSerializable) planElementSerializable).getLeg());
    return plan;
  }
    ...
    public Activity getActivity() {
      Activity activity =
          PopulationUtils.createActivityFromCoordAndLinkId(
              type, coord.getCoord(), linkIdString == null ? null : Id.createLinkId(linkIdString));
      activity.setEndTime(endTime);
      activity.setFacilityId(
          facIdString == null ? null : Id.create(facIdString, ActivityFacility.class));
  ...
  class LegSerializable implements PlanElementSerializable {
    ...
    public LegSerializable(Leg leg) {
      ...
      if (leg.getRoute() != null) {
        ...
        else route = new GenericRouteSerializable(leg.getRoute());
      }
    }
  ...
  class NetworkRouteSerializable implements RouteSerializable {
    ...
    public NetworkRouteSerializable(NetworkRoute route) {
      ...
      for (Id<Link> linkid : linkIds) linkIdStrings.add(linkid.toString());
    }
    ...
    public Route getRoute(String mode) {
      ...
      for (String linkId : linkIdStrings) linkIds.add(Id.createLinkId(linkId));
      route.setLinkIds(startLinkId, linkIds, endLinkId);
      route.setTravelCost(travelCost);
      route.setTravelTime(travelTime);
      route.setVehicleId(
          vehicleIdString == null ? null : Id.create(vehicleIdString, Vehicle.class));
      return route;
    }
  }
