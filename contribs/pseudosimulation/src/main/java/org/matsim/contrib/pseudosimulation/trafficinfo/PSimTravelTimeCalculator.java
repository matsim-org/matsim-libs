 ...
 * @author fouriep
 */
public class PSimTravelTimeCalculator
  ...
  // I have replaced inheritance by delegation to make TravelTimeCalculator final, but I can't say
  // if that preserves functionality.  Hopefully, it is covered by a regression
  // test.  kai, feb'19
  ...
  public void reset(int iteration) {
    if (switcher == null || switcher.isQSimIteration()) {
      LogManager.getLogger(travelTimeCalculator.getClass())
          .error("Calling reset on traveltimecalc");
      travelTimeCalculator.reset(iteration);
    } else {
      LogManager.getLogger(travelTimeCalculator.getClass())
          .error("Not resetting travel times as this is a PSim iteration");
    }
  }
}
