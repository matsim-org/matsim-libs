...
public class MobSimSwitcher
    implements IterationEndsListener, IterationStartsListener, BeforeMobsimListener {
  ...
  private boolean determineIfQSimIter(int iteration) {
    ...
    if (iteration == scenario.getConfig().controller().getLastIteration()
        || iteration == scenario.getConfig().controller().getFirstIteration()) {
  ...
  public void notifyBeforeMobsim(BeforeMobsimEvent event) {
    ...
    if (this.isQSimIteration()) return;
