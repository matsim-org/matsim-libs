...
public class QSimModuleForPSim extends AbstractModule {
	@Inject Config config ;
	
	private final boolean addDefaultQSimModules;
	
	public QSimModuleForPSim() {
		this(true);
	}
	
	public QSimModuleForPSim(boolean addDefaultQSimModules) {
...
//			getDefaultQSimModules().forEach(this::installQSimModule);
		...
		bind(Mobsim.class).toProvider(QSimProviderForPSim.class);
