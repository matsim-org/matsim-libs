...
public class CountList extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(currentCount == null) {
            String name = javax.swing.JOptionPane.showInputDialog("Nombre de la Estación");
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        if(evt.getClickCount()==2){
            if(currentCount==null)
                return;
            String name = javax.swing.JOptionPane.showInputDialog("Nombre de la Estación", currentCount.getCsId());
...
class CountTableModel extends AbstractTableModel {
    ...
    public CountTableModel(Count counts) {
        ...
        for(Map.Entry<Integer, Volume> entry : counts.getVolumes().entrySet()) {
            table[i][0] = new String(entry.getKey().toString());
            table[i][1] = new String(Double.toString(entry.getValue().getValue()));
            ++i;
        }
    }
    private void init(int r) {
        ...
        columnName[0] = new String("Hora");
        columnName[1] = new String("Volumen");
        rows = r;
        cols = 2;
    }
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        if(columnIndex == 0) {
            ...
            table[rowIndex][columnIndex] = val;
            int h = counts.getVolumes().get(Integer.valueOf(table[rowIndex][0].toString())).getHour();
    ...
    @Override
        ...
        if (evt.getType() == TableModelEvent.UPDATE) {
            ...
            try {
                ...
                javax.swing.JOptionPane.showMessageDialog(cList, "Los valores deben ser numéricos", "Error de formato", javax.swing.JOptionPane.WARNING_MESSAGE);
                cList.updateTable();
                //e.printStackTrace();
                return;
            }
    ...
    @Override
        ...
        if(arg!=null) {
            ...
            if(myvol.h_ < 1 || myvol.h_ > 24)
                javax.swing.JOptionPane.showMessageDialog(dad, "Hora Inválida", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            if(myvol.v_ < 0.0)
                javax.swing.JOptionPane.showMessageDialog(dad, "Volumen Inválido", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            if(dad.existCount(myvol.h_)) {
                if(javax.swing.JOptionPane.showConfirmDialog(dad, "Hora ya existente, ¿sobrescribir?", "Advertencia", javax.swing.JOptionPane.YES_NO_OPTION) == javax.swing.JOptionPane.OK_OPTION)
