...
public class CbcMpsAssignmentSolverTest {
	...
	public void testOneVehicleOneRequestExample() throws IOException {
		AssignmentSolver solver = new CbcMpsAssignmentSolver(9000.0, 9000.0, 1000, temporaryFolder.newFile("problem"),
	...
	public void testTwoRequestsWithOneVehicleLowPenalty() throws IOException {
		AssignmentSolver solver = new CbcMpsAssignmentSolver(250.0, 250.0, 1000, temporaryFolder.newFile("problem"),
				temporaryFolder.newFile("solution"));
