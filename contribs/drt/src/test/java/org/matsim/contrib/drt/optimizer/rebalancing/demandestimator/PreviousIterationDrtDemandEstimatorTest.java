...
public class PreviousIterationDrtDemandEstimatorTest {
  ...
  private void assertDemand(
      PreviousIterationDrtDemandEstimator estimator,
      double fromTime,
      DrtZone zone,
      double expectedDemand) {
    assertThat(estimator.getExpectedDemand(fromTime, ESTIMATION_PERIOD).applyAsDouble(zone))
        .isEqualTo(expectedDemand);
  }
}
