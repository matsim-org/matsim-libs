...
public class DrtFareHandlerTest {
	...
	public void testDrtFareHandler() {
		...
		var personId = Id.createPersonId("p1");
		{
			...
			events.processEvent(new DrtRequestSubmittedEvent(0.0, mode, requestId, Collections.singleton(personId), Id.createLinkId("12"),
		...
		}
		{
			...
			events.processEvent(new DrtRequestSubmittedEvent(0.0, mode, requestId, Collections.singleton(personId), Id.createLinkId("45"),
