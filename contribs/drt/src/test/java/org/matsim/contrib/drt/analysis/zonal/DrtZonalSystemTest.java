...
public class DrtZonalSystemTest {
  ...
  public void test_cellSize100() {
    DrtZonalSystem drtZonalSystem =
        createFromPreparedGeometries(
            createNetwork(), DrtGridUtils.createGridFromNetwork(createNetwork(), 100));
  ...
  public void test_cellSize700() {
    DrtZonalSystem drtZonalSystem =
        createFromPreparedGeometries(
            createNetwork(), DrtGridUtils.createGridFromNetwork(createNetwork(), 700));
  ...
  public void test_gridWithinServiceArea() {
    ...
    DrtZonalSystem zonalSystem = createFromPreparedGeometries(createNetwork(), grid);
