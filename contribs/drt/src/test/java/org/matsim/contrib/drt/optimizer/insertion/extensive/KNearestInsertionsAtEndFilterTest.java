...
public class KNearestInsertionsAtEndFilterTest {
  ...
  public void k0_atEndInsertionsNotReturned() {
    ...
    var filteredInsertions =
        KNearestInsertionsAtEndFilter.filterInsertionsAtEnd(0, List.of(insertion));
  ...
  public void noAtEndInsertions_allReturned() {
    ...
    assertThat(filterOneInsertionAtEnd(insertion1, insertion2))
        .containsExactlyInAnyOrder(insertion1.insertion, insertion2.insertion);
  }
  ...
  public void onlyAtEndInsertions_theEarliestReturned() {
    ...
    assertThat(filterOneInsertionAtEnd(insertion1, insertion2))
        .containsExactly(insertion1.insertion);
    assertThat(filterOneInsertionAtEnd(insertion2, insertion1))
        .containsExactly(insertion1.insertion);
  }
  ...
  public void mixedTypeInsertions_bothReturned() {
    ...
    assertThat(filterOneInsertionAtEnd(insertionAfterStart, insertionAtEnd))
        .containsExactlyInAnyOrder(insertionAfterStart.insertion, insertionAtEnd.insertion);
  }

  private InsertionWithDetourData insertion(
      VehicleEntry vehicleEntry, int pickupIdx, double pickupDepartureTime) {
    return new InsertionWithDetourData(
        new Insertion(
            vehicleEntry,
            new InsertionPoint(
                pickupIdx,
                vehicleEntry.getWaypoint(pickupIdx),
                null,
