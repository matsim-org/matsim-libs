...
/**
 * This is a helper class that allows to loop through all persons that are active in a QSim. It is
 * used to prebook drt legs for specific legs.
 *
...
public class PopulationIterator implements Iterator<PersonItem> {
  ...
  public static class PopulationIteratorFactory {
