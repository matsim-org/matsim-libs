...
final class SelectiveInsertionSearch implements DrtInsertionSearch, MobsimBeforeCleanupListener {
  ...
  public SelectiveInsertionSearch(
      SelectiveInsertionProvider insertionProvider,
  ...
  public Optional<InsertionWithDetourData> findBestInsertion(
    ...
    collectDifferences(
        drtRequest, selectedInsertion.get().detourTimeInfo, insertionWithDetourData.detourTimeInfo);

    double insertionCost =
        insertionCostCalculator.calculate(
            drtRequest, insertion, insertionWithDetourData.detourTimeInfo);
    return insertionCost >= INFEASIBLE_SOLUTION_COST
        ? Optional.empty()
