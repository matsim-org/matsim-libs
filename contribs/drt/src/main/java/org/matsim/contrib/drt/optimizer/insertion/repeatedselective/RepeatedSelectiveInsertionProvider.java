...
class RepeatedSelectiveInsertionProvider {
  ...
  @VisibleForTesting
  RepeatedSelectiveInsertionProvider(
  ...
  public static RepeatedSelectiveInsertionProvider create(
      InsertionCostCalculator insertionCostCalculator,
      AdaptiveTravelTimeMatrix updatableTravelTimeMatrix,
      TravelTime travelTime,
      ForkJoinPool forkJoinPool,
      StopTimeCalculator stopTimeCalculator) {
    var detourTimeEstimatorWithUpdatedTravelTimes =
        DetourTimeEstimatorWithAdaptiveTravelTimes.create(
            SPEED_FACTOR, updatableTravelTimeMatrix, travelTime);
    return new RepeatedSelectiveInsertionProvider(
        insertionCostCalculator,
        new InsertionGenerator(stopTimeCalculator, detourTimeEstimatorWithUpdatedTravelTimes),
        forkJoinPool);
  }

  public List<InsertionWithDetourData> getInsertions(
                        ...
                        .map(
                            i ->
                                new InsertionWithCost(
                                    i,
                                    this.insertionCostCalculator.calculate(
