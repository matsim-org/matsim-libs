 ...
 */
public final class MultiModeDrtConfigGroup extends ReflectiveConfigGroup
    implements MultiModal<DrtConfigGroup> {
  ...
  protected void checkConsistency(Config config) {
    ...
    Verify.verify(
        config.getModule(DrtConfigGroup.GROUP_NAME) == null,
