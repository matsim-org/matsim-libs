...
/**
 * This class represents a prebooking logic that searches for DRT legs in the population and decides
 * based on a predefiend probability if each trip is prebooked or not. Furthermore, you can
 * configure how much in advance to the planned departure time the request is submitted using the
 * submissionSlack parameter.
 *
...
public class ProbabilityBasedPrebookingLogic implements PrebookingLogic, MobsimInitializedListener {
  ...
  private ProbabilityBasedPrebookingLogic(
      String mode,
  ...
  public static void install(
      Controler controller, DrtConfigGroup drtConfig, double probability, double prebookingSlack) {
