 ...
 */
public final class DirectTripDistanceBasedDrtEstimator implements DrtEstimator {
	...
	public static class Builder {
		...
		public DirectTripDistanceBasedDrtEstimator build() {
			return new DirectTripDistanceBasedDrtEstimator(rideDurationEstimator, waitingTimeEstimator, rideTimeDistributionGenerator, waitingTimeDistributionGenerator);
		}

	}

	public DirectTripDistanceBasedDrtEstimator(RideDurationEstimator rideDurationEstimator, WaitingTimeEstimator waitingTimeEstimator,
	 ...
	 */
	public static DirectTripDistanceBasedDrtEstimator normalDistributedNetworkBasedDrtEstimator(double estRideTimeAlpha, double estRideTimeBeta,
	 ...
	 * @return NetworkBasedDrtEstimator
	 */
	public static DirectTripDistanceBasedDrtEstimator mixDistributedNetworkBasedDrtEstimator(double estRideTimeAlpha, double estRideTimeBeta,
	...
	public Estimate estimate(DrtRoute route, OptionalTime departureTime) {
		...
		double typicalRideDuration = rideDurationEstimator.getEstimatedRideDuration(fromLinkId, toLinkId, departureTime, directDistance);
