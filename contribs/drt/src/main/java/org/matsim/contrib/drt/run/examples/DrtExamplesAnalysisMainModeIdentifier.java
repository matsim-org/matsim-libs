...
/* *********************************************************************** *
 * project: org.matsim.*
 * DrtExamplesAnalysisMainModeIdentifier.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
 ...
 *
 */
public final class DrtExamplesAnalysisMainModeIdentifier implements AnalysisMainModeIdentifier {

	private static final Logger log = LogManager.getLogger(DrtExamplesAnalysisMainModeIdentifier.class);

	private final List<String> modeHierarchy = new ArrayList<>() ;

	public DrtExamplesAnalysisMainModeIdentifier() {
		...
		modeHierarchy.add( "drt_autonomous" ) ;
		modeHierarchy.add( "drt_conventional" ) ;
