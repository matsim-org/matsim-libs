...
public class ShiftInsertionCostCalculator<D> extends InsertionCostCalculatorImpl<D> {
    ...
    public ShiftInsertionCostCalculator(DrtConfigGroup drtConfig, MobsimTimer timer,
        ...
        super(drtConfig, timer, costCalculationStrategy, detourTime, replacedDriveTimeEstimator);
        this.timer = timer;
    ...
    public double calculate(DrtRequest drtRequest, InsertionWithDetourData<D> insertion) {
        ...
        return super.calculate(drtRequest, insertion);
    }
