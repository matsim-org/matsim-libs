 ...
 * @author nkuehnel
 */
public class DrtShiftBreakStartedEvent extends Event {
    ...
    public DrtShiftBreakStartedEvent(double time, Id<DrtShift> shiftId, Id<DvrpVehicle> vehicleId, Id<Link> linkId) {
        super(time);
