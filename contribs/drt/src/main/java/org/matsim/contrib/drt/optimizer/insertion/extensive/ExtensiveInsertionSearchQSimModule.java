...
public class ExtensiveInsertionSearchQSimModule extends AbstractDvrpModeQSimModule {
  ...
  protected void configureQSim() {
        ...
        .toProvider(
            modalProvider(
                getter -> {
                  ...
                  return new ExtensiveInsertionSearch(
                      provider,
                      getter.getModal(MultiInsertionDetourPathCalculator.class),
                      insertionCostCalculator,
                      getter.getModal(StopTimeCalculator.class));
                }))
        .asEagerSingleton();
    ...
    addModalComponent(
        MultiInsertionDetourPathCalculator.class,
        new ModalProviders.AbstractProvider<>(getMode(), DvrpModes::mode) {
          ...
          public MultiInsertionDetourPathCalculator get() {
            ...
            return new MultiInsertionDetourPathCalculator(
