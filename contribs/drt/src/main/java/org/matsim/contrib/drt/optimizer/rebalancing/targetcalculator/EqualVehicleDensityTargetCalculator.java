...
/**
 * This class does not really calculate the expected demand but aims to distribute the fleet
 * vehicles equally over all zones, weighted by zone area size.
 *
 * <p>
 *
 * @author tschlenther
...
public final class EqualVehicleDensityTargetCalculator implements RebalancingTargetCalculator {
  ...
  public EqualVehicleDensityTargetCalculator(
      @NotNull DrtZonalSystem zonalSystem, @NotNull FleetSpecification fleetSpecification) {
  ...
  public ToDoubleFunction<DrtZone> calculate(
    ...
    return zone ->
        zoneAreaShares.getOrDefault(zone, 0.)
