...
public final class FeedforwardRebalancingStrategyParams extends ReflectiveConfigGroup
  ...
  @Parameter
  @Comment(
      "Specifies the time bin size of the feedforward signal. Within each time bin,"
  ...
  @Parameter
  @Comment(
      "Specifies the strength of the feedforward signal. Expect a double value in the range of [0, 1],"
  ...
  @Parameter
  @Comment(
      "Specifies the lead of the feedforward signal. The feedforward signal can lead the actual time"
