...
/**
 * This class provides the stop duration of a request. Eventually, this could also become a simple
 * attribute of a DrtRequest to simplify the code complexity.
 */
