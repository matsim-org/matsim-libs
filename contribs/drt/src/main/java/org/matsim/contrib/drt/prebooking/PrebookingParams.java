...
public class PrebookingParams extends ReflectiveConfigGroup {
  ...
  @Parameter
  @Comment(
      "Defines whether vehicles drive immediately to the next"
  ...
  public boolean scheduleWaitBeforeDrive =
      false; // in the future, this could also become a double value indicating
  ...
  @Parameter
  @Comment(
      "Request gets rejected if a vehicle waits longer than the indicated duration at the stop")
  @NotNull
  @Positive
  ...
  @Parameter
  @Comment(
      "When unscheduling requests because they have been canceled,"
