...
public final class PlusOneRebalancingParams extends ReflectiveConfigGroup {
	...
	public enum ZonalDemandAggregatorType {
		...
		EqualVehicleDensityZonalDemandAggregator
	}
	...
	@NotNull
	private PlusOneRebalancingParams.ZonalDemandAggregatorType zonalDemandAggregatorType = ZonalDemandAggregatorType.PreviousIterationZonalDemandAggregator;
	...
	protected void checkConsistency(Config config) {
		...
		if (getMinServiceTime() <= getMaxTimeBeforeIdle()) {
			throw new RuntimeException(PlusOneRebalancingParams.MIN_SERVICE_TIME + " must be greater than "
					+ PlusOneRebalancingParams.MAX_TIME_BEFORE_IDLE);
		}
	...
	public PlusOneRebalancingParams setRebalancingZonesShapeFile(String rebalancingZonesShapeFile) {
