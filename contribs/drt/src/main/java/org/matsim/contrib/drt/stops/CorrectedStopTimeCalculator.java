...
/**
 * This calculator extend the simple logic of DefaultStopTimeCalculator by allowing tasks to be
 * extended. This happens when an ongoing task is assigned a new pickup.
 */
