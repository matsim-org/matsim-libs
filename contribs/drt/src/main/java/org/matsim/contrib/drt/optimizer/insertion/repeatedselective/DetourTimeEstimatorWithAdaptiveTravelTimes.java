...
public class DetourTimeEstimatorWithAdaptiveTravelTimes implements DetourTimeEstimator {
  ...
  DetourTimeEstimatorWithAdaptiveTravelTimes(
      double speedFactor,
  ...
  public static DetourTimeEstimatorWithAdaptiveTravelTimes create(
      double speedFactor,
      AdaptiveTravelTimeMatrix updatableTravelTimeMatrix,
      TravelTime travelTime) {
    return new DetourTimeEstimatorWithAdaptiveTravelTimes(
        speedFactor, updatableTravelTimeMatrix, travelTime);
  }
