...
public class DrtZonalSystemParams extends ReflectiveConfigGroup {
  ...
  @Parameter
  @Comment(
      "size of square cells used for demand aggregation."
  ...
  public enum TargetLinkSelection {
    random,
    mostCentral
  }
  ...
  protected void checkConsistency(Config config) {
    ...
    Preconditions.checkArgument(
        zonesGeneration != ZoneGeneration.GridFromNetwork || cellSize != null,
        "cellSize must not be null when zonesGeneration is " + ZoneGeneration.GridFromNetwork);
    Preconditions.checkArgument(
        zonesGeneration != ZoneGeneration.ShapeFile || zonesShapeFile != null,
