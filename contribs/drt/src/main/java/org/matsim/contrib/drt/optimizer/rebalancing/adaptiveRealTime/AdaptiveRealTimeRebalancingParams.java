...
public final class AdaptiveRealTimeRebalancingParams extends ReflectiveConfigGroup {
	...
	public AdaptiveRealTimeRebalancingParams() {
		super(SET_NAME);
	}
	...
	protected void checkConsistency(Config config) {
		...
		if (getMinServiceTime() <= getMaxTimeBeforeIdle()) {
			throw new RuntimeException(AdaptiveRealTimeRebalancingParams.MIN_SERVICE_TIME
					+ " must be greater than "
					+ AdaptiveRealTimeRebalancingParams.MAX_TIME_BEFORE_IDLE);
		}
	...
	public AdaptiveRealTimeRebalancingParams setRebalancingZonesShapeFile(String rebalancingZonesShapeFile) {
