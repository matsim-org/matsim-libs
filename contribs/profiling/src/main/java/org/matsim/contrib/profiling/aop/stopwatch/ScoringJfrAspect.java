...
@Aspect
public class ScoringJfrAspect extends AbstractProfilingEventAspect {

	@Pointcut("execution(* org.matsim.core.controler.ControlerListenerManagerImpl.fireControlerScoringEvent(..))")
	public void eventPoints() {}

	public Event createEvent(JoinPoint.StaticPart thisJoinPointStaticPart) {
		return new AopStopwatchScoringJfrEvent();
	}
}
