...
@Aspect
public class PrepareForMobsimJfrAspect extends AbstractProfilingEventAspect {

	@Pointcut("execution(* org.matsim.core.controler.NewControler.prepareForMobsim(..))")
	public void eventPoints() {}

	public Event createEvent(JoinPoint.StaticPart thisJoinPointStaticPart) {
		return new AopStopwatchPrepareForMobsimJfrEvent();
	}
}
