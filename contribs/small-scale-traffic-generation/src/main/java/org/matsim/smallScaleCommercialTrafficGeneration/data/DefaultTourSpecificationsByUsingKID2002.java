...
public class DefaultTourSpecificationsByUsingKID2002 implements GetCommercialTourSpecifications {
	...
	@Override
	public Map<GenerateSmallScaleCommercialTrafficDemand.StopDurationGoodTrafficKey, EnumeratedDistribution<GenerateSmallScaleCommercialTrafficDemand.DurationsBounds>> createStopDurationDistributionPerCategory(String smallScaleCommercialTrafficType, RandomGenerator rng) {
		Map<GenerateSmallScaleCommercialTrafficDemand.StopDurationGoodTrafficKey, EnumeratedDistribution<GenerateSmallScaleCommercialTrafficDemand.DurationsBounds>> stopDurationProbabilityDistribution = new HashMap<>();
	...
	@Override
	public EnumeratedDistribution<GenerateSmallScaleCommercialTrafficDemand.TourStartAndDuration> createTourDistribution(
