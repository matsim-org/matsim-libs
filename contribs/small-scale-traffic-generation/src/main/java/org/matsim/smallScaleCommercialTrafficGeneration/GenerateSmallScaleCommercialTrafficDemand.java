...
public class GenerateSmallScaleCommercialTrafficDemand implements MATSimAppCommand {
	...
	private void createCarriers(Scenario scenario, TripDistributionMatrix odMatrix,
		...
		Map<StopDurationGoodTrafficKey, EnumeratedDistribution<DurationsBounds>> stopDurationTimeSelector = createStopDurationDistributionPerCategory(
...
//			final GenericStrategyManager<CarrierPlan, Carrier> strategyManager = new GenericStrategyManager<>();
	...
	private EnumeratedDistribution<DurationsBounds> createTourStartTimeDistribution(String smallScaleCommercialTrafficType) {

		List<Pair<DurationsBounds, Double>> tourStartProbabilityDistribution = new ArrayList<>();
		if (smallScaleCommercialTrafficType.equals(SmallScaleCommercialTrafficType.commercialPersonTraffic.toString())) {
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 1), 0.002));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(1, 2), 0.001));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(2, 3), 0.001));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(3, 4), 0.002));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(4, 5), 0.008));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(5, 6), 0.031));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(6, 7), 0.144));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(7, 8), 0.335));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(8, 9), 0.182));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(9, 10), 0.108));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 11), 0.057));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(11, 12), 0.032));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(12, 13), 0.021));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(13, 14), 0.021));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(14, 15), 0.019));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(15, 16), 0.012));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(16, 17), 0.009));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(17, 18), 0.006));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(18, 19), 0.004));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(19, 20), 0.003));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 21), 0.001));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(22, 23), 0.001));
		} else if (smallScaleCommercialTrafficType.equals(SmallScaleCommercialTrafficType.goodsTraffic.toString())) {
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 1), 0.008));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(1, 2), 0.003));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(2, 3), 0.008));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(3, 4), 0.012));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(4, 5), 0.028));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(5, 6), 0.052));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(6, 7), 0.115));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(7, 8), 0.222));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(8, 9), 0.197));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(9, 10), 0.14));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 11), 0.076));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(11, 12), 0.035));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(12, 13), 0.022));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(13, 14), 0.022));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(14, 15), 0.021));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(15, 16), 0.014));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(16, 17), 0.008));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(17, 18), 0.005));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(18, 19), 0.004));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(19, 20), 0.002));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 21), 0.001));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(21, 22), 0.001));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(22, 23), 0.002));
			tourStartProbabilityDistribution.add(Pair.create(new DurationsBounds(23, 24), 0.001));
	 ...
	 */
	@Deprecated //use createTourDistribution(String smallScaleCommercialTrafficType) instead
	private EnumeratedDistribution<DurationsBounds> createTourDurationTimeDistribution(String smallScaleCommercialTrafficType) {
		List<Pair<DurationsBounds, Double>> tourDurationProbabilityDistribution = new ArrayList<>();
		if (smallScaleCommercialTrafficType.equals(SmallScaleCommercialTrafficType.commercialPersonTraffic.toString())) {
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 1), 0.14));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(1, 2), 0.066));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(2, 3), 0.056));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(3, 4), 0.052));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(4, 5), 0.061));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(5, 6), 0.063));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(6, 7), 0.07));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(7, 8), 0.086));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(8, 9), 0.14));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(9, 10), 0.122));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 11), 0.068));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(11, 12), 0.031));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(12, 13), 0.018));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(13, 14), 0.01));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(14, 15), 0.006));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(15, 16), 0.003));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(16, 17), 0.002));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(17, 18), 0.001));
		} else if (smallScaleCommercialTrafficType.equals(SmallScaleCommercialTrafficType.goodsTraffic.toString())) {
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 1), 0.096));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(1, 2), 0.074));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(2, 3), 0.065));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(3, 4), 0.071));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(4, 5), 0.086));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(5, 6), 0.084));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(6, 7), 0.084));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(7, 8), 0.101));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(8, 9), 0.118));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(9, 10), 0.092));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 11), 0.048));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(11, 12), 0.027));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(12, 13), 0.015));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(13, 14), 0.011));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(14, 15), 0.006));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(15, 16), 0.004));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(16, 17), 0.002));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(17, 18), 0.001));
			tourDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(18, 19), 0.001));
		}
	 ...
	 */
	private Map<StopDurationGoodTrafficKey, EnumeratedDistribution<DurationsBounds>> createStopDurationDistributionPerCategory(String smallScaleCommercialTrafficType) {

		Map<StopDurationGoodTrafficKey, EnumeratedDistribution<DurationsBounds>> stopDurationProbabilityDistribution = new HashMap<>();

		if (smallScaleCommercialTrafficType.equals(SmallScaleCommercialTrafficType.commercialPersonTraffic.toString())) {
			List<Pair<DurationsBounds, Double>> thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 30), 0.098));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 60), 0.17));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 90), 0.127));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.11));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 180), 0.17));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.076));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.057));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 360), 0.01));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(360, 420), 0.026));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 480), 0.045));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(480, 540), 0.064));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 600), 0.034));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(600, 720), 0.012));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(720, 840), 0.002));
			...
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 30), 0.054));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 60), 0.164));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 90), 0.153));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.087));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 180), 0.12));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.055));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.044));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 360), 0.02));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(360, 420), 0.025));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 480), 0.069));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(480, 540), 0.132));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 600), 0.058));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(600, 720), 0.016));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(720, 840), 0.002));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Construction",null),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 30), 0.13));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 60), 0.324));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 90), 0.178));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.108));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 180), 0.097));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.034));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.02));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 360), 0.018));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(360, 420), 0.02));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 480), 0.027));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(480, 540), 0.029));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 600), 0.008));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(600, 720), 0.006));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(720, 840), 0.001));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Secondary Sector Rest",null),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 30), 0.178));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 60), 0.301));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 90), 0.192));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.104));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 180), 0.092));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.043));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.013));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 360), 0.017));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(360, 420), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 480), 0.016));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(480, 540), 0.016));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 600), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(600, 720), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(720, 840), 0.001));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Retail",null),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 30), 0.144));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 60), 0.372));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 90), 0.203));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.069));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 180), 0.112));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.038));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 360), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(360, 420), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 480), 0.012));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(480, 540), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 600), 0.005));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(600, 720), 0.005));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Traffic/Parcels",null),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 30), 0.196));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 60), 0.292));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 90), 0.19));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.101));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 180), 0.105));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.034));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.017));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 360), 0.009));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(360, 420), 0.013));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 480), 0.019));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(480, 540), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 600), 0.006));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(600, 720), 0.004));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(720, 840), 0.001));
			...
			List<Pair<DurationsBounds, Double>> thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.038));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.049));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.052));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.094));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.125));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.094));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.167));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.094));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.113));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.056));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.04));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.009));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.016));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.026));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.002));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Primary Sector", "vehTyp1"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.025));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.025));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.05));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.043));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.112));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.168));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.149));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.081));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.168));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.068));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.068));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.025));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.019));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Primary Sector", "vehTyp2"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.036));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.098));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.036));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.016));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.042));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.124));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.085));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.144));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.105));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.052));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.072));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.052));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.023));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.033));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.062));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.016));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(660, 780), 0.003));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Primary Sector", "vehTyp3"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.071));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.143));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.429));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.179));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.107));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.071));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Primary Sector", "vehTyp4"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.026));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.395));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.158));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.132));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.026));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.105));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.079));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.026));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.053));
			...
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.033));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.064));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.109));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.088));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.095));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.112));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.105));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.114));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.053));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.088));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.038));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.012));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.01));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.051));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.015));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Construction", "vehTyp1"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.02));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.027));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.061));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.045));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.068));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.083));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.112));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.114));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.146));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.058));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.114));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.036));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.022));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.065));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.023));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Construction", "vehTyp2"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.009));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.04));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.074));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.09));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.086));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.069));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.113));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.135));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.071));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.008));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.044));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.041));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.03));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.021));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.075));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.022));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.036));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.055));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.018));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.236));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.073));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.018));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.164));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.091));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.109));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.055));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.018));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.055));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.055));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.018));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.163));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.21));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.165));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.125));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.095));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.101));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.04));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.03));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.006));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.008));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.002));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.004));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.008));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.004));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Construction", "vehTyp5"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.072));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.093));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.123));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.113));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.137));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.081));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.102));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.087));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.079));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.032));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.021));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.018));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.016));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.009));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 780), 0.002));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Secondary Sector Rest", "vehTyp1"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.062));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.14));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.093));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.115));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.133));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.102));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.098));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.071));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.067));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.038));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.027));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.009));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.011));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Secondary Sector Rest", "vehTyp2"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.051));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.214));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.146));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.129));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.10));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.072));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.083));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.063));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.054));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.02));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.016));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.022));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.008));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 900), 0.003));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.163));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.224));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.153));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.061));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.173));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.082));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.122));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.01));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.01));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Secondary Sector Rest", "vehTyp4"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.003));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.195));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.225));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.16));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.143));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.089));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.075));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.031));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.048));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.01));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.003));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 660), 0.009));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Secondary Sector Rest", "vehTyp5"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.057));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.108));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.093));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.133));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.133));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.11));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.102));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.064));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.104));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.049));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.015));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.015));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.003));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.005));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.006));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.003));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Retail", "vehTyp1"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.084));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.119));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.183));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.076));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.085));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.101));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.124));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.069));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.057));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.041));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.002));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.025));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.004));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(780, 900), 0.002));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Retail", "vehTyp2"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.103));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.23));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.193));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.08));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.065));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.071));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.072));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.044));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.054));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.035));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.009));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.013));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.01));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.003));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.003));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.094));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.179));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.094));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.245));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.123));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.075));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.094));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.038));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.019));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.009));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.009));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.019));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Retail", "vehTyp4"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.066));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.063));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.142));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.165));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.135));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.102));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.122));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.033));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.086));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.043));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.023));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.017));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.003));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.159));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.173));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.173));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.088));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.115));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.071));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.051));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.041));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.02));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.031));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.017));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.007));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.292));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.135));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.062));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.197));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.051));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.079));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.022));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.045));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.056));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.034));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.006));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.022));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Traffic/Parcels", "vehTyp2"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.092));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.111));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.224));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.173));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.09));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.103));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.045));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.028));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.056));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.017));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.019));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.025));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.006));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.006));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.146));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.098));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.146));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.195));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.268));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.012));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.037));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.012));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.012));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Traffic/Parcels", "vehTyp4"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.026));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.042));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.062));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.121));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.133));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.144));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.144));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.104));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.121));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.046));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.026));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.005));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 900), 0.008));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Traffic/Parcels", "vehTyp5"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.061));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.093));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.101));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.125));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.125));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.101));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.124));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.08));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.093));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.046));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.013));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.017));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.004));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.005));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Employee Tertiary Sector Rest", "vehTyp1"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.081));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.101));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.101));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.109));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.124));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.065));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.109));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.124));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.097));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.032));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.022));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.017));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.003));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.008));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.052));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.114));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.155));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.111));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.151));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.112));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.125));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.043));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.051));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.026));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.016));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.009));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(660, 780), 0.003));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.02));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.082));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.102));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.449));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.061));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.163));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.102));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.02));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.02));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.02));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.151));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.296));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.156));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.065));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.121));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.05));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.075));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.01));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.015));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.01));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.005));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.005));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.056));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.084));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.095));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.118));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.12));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.096));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.112));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.083));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.095));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.045));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.033));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.022));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.018));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.004));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.077));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.093));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.103));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.092));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.098));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.091));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.108));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.092));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.095));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.043));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.035));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.01));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.011));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.021));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.007));
			stopDurationProbabilityDistribution.put(makeStopDurationGoodTrafficKey("Inhabitants", "vehTyp2"),
				new EnumeratedDistribution<>(rng, thisStopDurationProbabilityDistribution));
			thisStopDurationProbabilityDistribution.clear();

			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.06));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.141));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.152));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.107));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.094));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.087));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.089));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.067));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.06));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.037));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.023));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.025));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.015));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.012));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.006));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(660, 780), 0.001));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.062));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.11));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.12));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.144));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.151));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.129));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.062));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.079));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.041));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.031));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.019));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 540), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(540, 660), 0.002));
			...
			thisStopDurationProbabilityDistribution = new ArrayList<>();
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(0, 10), 0.024));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(10, 20), 0.099));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(20, 30), 0.147));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(30, 40), 0.17));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(40, 50), 0.133));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(50, 60), 0.108));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(60, 75), 0.116));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(75, 90), 0.058));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(90, 120), 0.075));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(120, 150), 0.03));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(150, 180), 0.01));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(180, 240), 0.014));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(240, 300), 0.005));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(300, 420), 0.004));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(420, 660), 0.007));
			thisStopDurationProbabilityDistribution.add(Pair.create(new DurationsBounds(660, 900), 0.002));
