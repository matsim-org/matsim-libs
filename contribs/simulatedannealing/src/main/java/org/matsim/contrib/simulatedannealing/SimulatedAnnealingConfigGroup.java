...
public class SimulatedAnnealingConfigGroup extends ReflectiveConfigGroup {
  ...
  private static final String NAME = "simulatedAnnealing";

  public enum ResetOption {
    temperatureOnly,
    solutionOnly,
    temperatureAndSolution
  }
  ...
  @Parameter
  @Comment(
      "Cooling Temperature schedule. Defines the shape of the cooling gradient. {linear, exponential}")
  public TemperatureFunction.DefaultFunctions coolingSchedule =
      TemperatureFunction.DefaultFunctions.exponentialMultiplicative; // seconds

  @Parameter
  @Comment(
      "Cooling parameter alpha. Used to control the speed of cooling. Should be >0. "
  ...
  @Parameter
  @Comment(
      "Number of simulated annealing iterations (!= MATSim iterations, see iterationRatio) spent at each temperature.")
  @PositiveOrZero
  public int iterationsPerTemperature = 3;

  @Parameter
  @Comment(
      "Number of MATSim iterations for each simulated annealing iteration. This can make sense if other components"
  ...
  @Parameter
  @Comment(
      "Reset whenever a new best solution has been found. This may help to widen the search. See https://doi.org/10.3390/math9141625")
  ...
  @Parameter
  @Comment(
      "Last iteration after which there will be no more optimization and the solution will be fixed to the best"
          + "found solution.")
  ...
  public abstract static class PerturbationParams extends ReflectiveConfigGroup
      implements MatsimParameters {

    public static final String SET_TYPE = "perturbationParams";
  ...
  public Collection<PerturbationParams> getPerturbationParams() {
    ...
    Collection<PerturbationParams> collection =
        (Collection<PerturbationParams>) getParameterSets(PerturbationParams.SET_TYPE);
