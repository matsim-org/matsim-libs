...
/**
 * based on: Locatelli, M. Simulated Annealing Algorithms for Continuous Global Optimization:
 * Convergence Conditions. Journal of Optimization Theory and Applications 104, 121–133 (2000). <a
 * href="https://doi.org/10.1023/A:1004680806815">DOI</a>
 *
...
public class NonMonotonicAdaptiveTemperatureFunction implements TemperatureFunction {
  ...
  public double getTemperature(
      ...
      double bestCost) {
    double tK =
        baseTemperatureFunction.getTemperature(
