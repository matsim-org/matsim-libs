...
/**
 * Perturbator that allows to apply multiple chained perturbations per iteration. The basic idea is
 * a list of {@link PerturbatorFactory}s from which a (weighted) random combination of actual
 * perturbators is drawn in every iteration.
 *
