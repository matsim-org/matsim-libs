...
public class BackwardFastMultiNodeTest {
  ...
  private void runTestBackwardsFastMultiNodeDijkstra_OneToOne(boolean searchAllEndNodes) {
    ...
    BackwardFastMultiNodeDijkstra dijkstra =
        (BackwardFastMultiNodeDijkstra)
            new BackwardFastMultiNodeDijkstraFactory(searchAllEndNodes)
  ...
  public void testBackwardsFastMultiNodeDijkstra_OneToMany() {
    ...
    BackwardFastMultiNodeDijkstra dijkstra =
        (BackwardFastMultiNodeDijkstra)
            new BackwardFastMultiNodeDijkstraFactory(false)
                .createPathCalculator(scenario.getNetwork(), travelDisutility, travelTime);
  ...
  public void testBackwardsFastMultiNodeDijkstra_OneToMany_SearchAllNodes() {
    ...
    BackwardFastMultiNodeDijkstra dijkstra =
        (BackwardFastMultiNodeDijkstra)
            new BackwardFastMultiNodeDijkstraFactory(true)
                .createPathCalculator(scenario.getNetwork(), travelDisutility, travelTime);
  ...
  private void createNetwork(Scenario scenario) {
    ...
    Node n0 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n0", Node.class), new Coord(0.0, 0.0));
    Node n1 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n1", Node.class), new Coord(1000.0, 0.0));
    Node n2 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n2", Node.class), new Coord(2000.0, 0.0));
    Node n3 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n3", Node.class), new Coord(3000.0, 0.0));
    double y1 = -2000.0;
    Node n4 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n4", Node.class), new Coord(1000.0, y1));
    double y = -4000.0;
    Node n5 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n5", Node.class), new Coord(1000.0, y));
