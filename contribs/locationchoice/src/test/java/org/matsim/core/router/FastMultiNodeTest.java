...
/**
 * Some more tests - but all of them assuming that there is only a single from node as in the
 * location choice use case. For test using multiple from nodes look at MultiNodeDijkstraTest!
 *
 * @author cdobler
 */
public class FastMultiNodeTest {
  ...
  public void testFastMultiNodeDijkstra_OneToOne() {
    ...
    FastMultiNodeDijkstra dijkstra =
        (FastMultiNodeDijkstra)
  ...
  public void testFastMultiNodeDijkstra_OneToMany() {
    ...
    FastMultiNodeDijkstra dijkstra =
        (FastMultiNodeDijkstra)
            new FastMultiNodeDijkstraFactory(false)
                .createPathCalculator(scenario.getNetwork(), travelDisutility, travelTime);
  ...
  public void testFastMultiNodeDijkstra_OneToMany_SearchAllNodes() {
    ...
    FastMultiNodeDijkstra dijkstra =
        (FastMultiNodeDijkstra)
            new FastMultiNodeDijkstraFactory(true)
                .createPathCalculator(scenario.getNetwork(), travelDisutility, travelTime);
  ...
  private static void createNetwork(Scenario scenario) {
    ...
    Node n4 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n4", Node.class), new Coord(2000.0, y1));
    double y = -4000.0;
    Node n5 =
        scenario
            .getNetwork()
            .getFactory()
            .createNode(Id.create("n5", Node.class), new Coord(2000.0, y));
