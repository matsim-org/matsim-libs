...
public class FacilityPenaltyTest {
  ...
  public void testGetPenalty() {
    ...
    Assert.assertEquals(
        facilitypenalty.getCapacityPenaltyFactor(0.0, 1.0), 0.0, MatsimTestUtils.EPSILON);
  }

  @Test
  public void testcalculateCapPenaltyFactor()
    ...
    method =
        facilitypenalty
            .getClass()
            .getDeclaredMethod("calculateCapPenaltyFactor", new Class[] {int.class, int.class});
