 ...
 * @author anhorni
 */
class FacilitiesLoadCalculator
    implements StartupListener, BeforeMobsimListener, AfterMobsimListener, IterationEndsListener {
  ...
  public void notifyStartup(final StartupEvent event) {
    ...
    FrozenTastesConfigGroup dccg =
        ConfigUtils.addOrGetModule(controler.getConfig(), FrozenTastesConfigGroup.class);
    this.eventsToFacilityLoad =
        new EventsToFacilityLoad(
            controler.getScenario().getActivityFacilities(), this.facilityPenalties, dccg);
  ...
  private static void printStatistics(
    ...
    try {
      final String header =
          "Facility_id\tx\ty\tNumberOfVisitorsPerDay\tAllVisitors\tCapacity\tsumPenaltyFactor\tis shopping facility";
      ...
      final BufferedWriter out_summary =
          IOUtils.getBufferedWriter(
              iterationPath + "/" + iteration + ".facFrequencies_summary.txt");

      out.write(header);
      out.newLine();

      double loadPerHourSum[] = {
