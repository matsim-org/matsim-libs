...
class LCPlanUtils {
  ...
  public static void copyPlanFieldsFromTo(Plan planTemplate, Plan planTarget) {
    ...
    throw new RuntimeException(
        "Unexpected combination of plan types was found: "
            + planTarget.getClass().toString()
            + " and "
            + planTemplate.getClass().toString()
            + ". Aborting!");
  }
  ...
  private static void copyPlanFieldsToFrom1(Plan planTarget, Plan planTemplate) {
    ...
    for (PlanElement pe : planTarget.getPlanElements()) {
      if (pe instanceof Activity) {
        ...
        Leg r = ((Leg) pe);
        r.setTravelTime(
            legTemplate.getDepartureTime().seconds()
                + legTemplate.getTravelTime().seconds()
                - r.getDepartureTime().seconds());
        ...
        throw new RuntimeException(
            "Unexpected PlanElement type was found: " + pe.getClass().toString() + ". Aborting!");
      actLegIndex++;
    }
  }
  ...
  public static void copyFromTo(Plan srcPlan, Plan destPlan) {
    if (destPlan instanceof Plan) {
      ...
      throw new RuntimeException(
          "Unexpected type of plan was found: " + destPlan.getClass().toString() + ". Aborting!");
  }
  ...
  public static Plan createCopy(Plan plan) {
    if (plan instanceof Plan) {
      ...
      throw new RuntimeException(
          "Unexpected type of plan was found: " + plan.getClass().toString() + ". Aborting!");
  }
  ...
  public static void setArrivalTime(Leg leg, double arrivalTime) {
    if (leg instanceof Leg) {
      ...
      throw new RuntimeException(
          "Unexpected type of leg was found: " + leg.getClass().toString() + ". Aborting!");
  }
  ...
  public static void setFacilityId(Activity activity, Id<ActivityFacility> facilityId) {
    if (activity instanceof Activity) {
      ...
      throw new RuntimeException(
          "Unexpected type of activity was found: "
