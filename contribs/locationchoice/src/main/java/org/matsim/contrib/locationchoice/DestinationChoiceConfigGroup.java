...
public class DestinationChoiceConfigGroup extends ReflectiveConfigGroup
    implements DestinationChoiceConfigGroupI {
  private static final Logger log = LogManager.getLogger(DestinationChoiceConfigGroup.class);
  ...
  public final Map<String, String> getComments() {
    ...
    map.put(
        USE_CONFIG_PARAMS_FOR_SCORING,
        "Default is 'true'. Parameter was already present in the DCScoringFunction.");
    map.put(
        USE_INDIVIDUAL_SCORING_PARAMETERS,
        "MATSim supports individual scoring parameters for sub-populations or even single agents. "
