...
class DCScoringFunctionFactory implements ScoringFunctionFactory {
  ...
  private static final Logger log = LogManager.getLogger(DCScoringFunctionFactory.class);
  ...
  public DCScoringFunctionFactory(Scenario scenario, DestinationChoiceContext lcContext) {
    ...
    if (dccg != null) {
      ...
      log.warn(
          "No DestinationChoiceConfigGroup was found in the config - cannot configure DCScoringFunctionFactory according to it!");
  }
  ...
  public void setUsingIndividualScoringParameters(boolean val) {
    ...
    if (!this.usingIndividualScoringParameters) {
      ...
      this.nonPersonalizedScoringParameters =
          new ScoringParameters.Builder(
                  config.scoring(),
                  config.scoring().getScoringParameters(subPopulationAttributeName),
                  config.scenario())
              .build();
    }
  }
  ...
  public ScoringFunction createNewScoringFunction(Person person) {
    ...
    if (this.usingIndividualScoringParameters) {
      ScoringParameters scoringParameters =
          new ScoringParameters.Builder(this.scenario, person).build();
      scoringFunctionAccumulator.addScoringFunction(
      ...
      scoringFunctionAccumulator.addScoringFunction(
          new CharyparNagelAgentStuckScoring(scoringParameters));
    } else {
      scoringFunctionAccumulator.addScoringFunction(
          new CharyparNagelLegScoring(
              this.nonPersonalizedScoringParameters,
              ...
              this.scenario.getConfig().transit().getTransitModes()));
      scoringFunctionAccumulator.addScoringFunction(
          new CharyparNagelAgentStuckScoring(this.nonPersonalizedScoringParameters));
    }
