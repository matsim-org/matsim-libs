...
public class ArrayRoutingNetworkFactory extends AbstractRoutingNetworkFactory {
  ...
  private static final Logger log = LogManager.getLogger(ArrayRoutingNetworkFactory.class);
  ...
  @Override
  public ArrayRoutingNetworkLink createRoutingNetworkLink(
      final Link link, final RoutingNetworkNode fromNode, final RoutingNetworkNode toNode) {
