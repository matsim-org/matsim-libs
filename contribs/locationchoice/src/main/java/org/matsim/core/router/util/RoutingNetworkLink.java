...
public interface RoutingNetworkLink extends Link {
  // yy In most of matsim we have the convention that the wrapped object is provided, but the
  // methods are not delegated.  I.e.
  ...
  // (I can imagine that this came from retrofitting, but a design choice explanation would still be
  // helpful.)  kai, may'17
