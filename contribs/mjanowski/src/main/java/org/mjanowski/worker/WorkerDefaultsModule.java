...
public final class WorkerDefaultsModule extends AbstractModule {
    @Override
    public void install() {
        install(new WorkerEventsManagerModule());
        install(new WorkerSimModule());
        install(new WorkerQSimModule());
