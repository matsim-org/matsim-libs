...
class WorkerSimListenerManager implements MatsimManager {

	private final static Logger log = Logger.getLogger(WorkerSimListenerManager.class);

	private final Mobsim sim;

	private final EventListenerList listenerList = new EventListenerList();

	public WorkerSimListenerManager(Mobsim sim){
		this.sim = sim;
	}
