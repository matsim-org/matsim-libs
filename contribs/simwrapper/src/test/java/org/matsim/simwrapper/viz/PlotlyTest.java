...
public class PlotlyTest {
  ...
  public void data() throws IOException {
    ...
    ScatterTrace.ScatterBuilder trace =
        ScatterTrace.builder(Plotly.INPUT, Plotly.INPUT)
            .text(Plotly.TEXT_INPUT)
            .marker(Marker.builder().color(Plotly.TEXT_INPUT).size(Plotly.INPUT).build());
  ...
  public void multiple() throws IOException {
    ...
    ScatterTrace line =
        ScatterTrace.builder(Plotly.INPUT, Plotly.INPUT)
            ...
            .decreasing(
                Decreasing.builder().changeLine(ChangeLine.builder().width(10).build()).build())
            .hoverLabel(
                HoverLabel.builder()
                    .font(Font.builder().family(Font.Family.OPEN_SANS).build())
                    .build())
            .build();

    HistogramTrace hist =
        HistogramTrace.builder(Plotly.INPUT)
            .autoBinX(true)
    ...
    plot.config = Config.builder().displayLogo(false).responsive(true).build();
