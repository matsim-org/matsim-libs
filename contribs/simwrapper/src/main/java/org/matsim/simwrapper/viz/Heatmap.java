...
public class Heatmap extends Viz {
  ...
  /** Array[] containing names of columns with data to be categorized on the x-axis. */
  @JsonProperty(required = true)
  ...
  /**
   * Transpose the heatmap matrix, thus flipping the x and y axes. Can be useful if your data is
   * stored one way, but you want it displayed the other.
   */
