...
public class TrafficCountsDashboard implements Dashboard {
  ...
  @Nullable private final String countsPath;

  @Nullable private final Set<String> networkModes;
  ...
  public void configure(Header header, Layout layout) {
    ...
    for (int i = 0; i < labels.size(); i++) {
      if (i == 0)
        header.description +=
            String.format(Locale.US, "%s: < %.2f; ", labels.get(i), limits.get(i));
      else if (i == labels.size() - 1)
        header.description +=
            String.format(Locale.US, "%s: > %.2f", labels.get(i), limits.get(i - 1));
      else
        header.description +=
            String.format(
                Locale.US, "%s: %.2f - %.2f; ", labels.get(i), limits.get(i - 1), limits.get(i));
    }
    ...
    if (countsPath != null) argList.addAll(List.of("--counts", countsPath));
        ...
        .el(
            ...
            (viz, data) -> {
              ...
              Plotly.DataSet ds =
                  viz.addDataset(
                          data.compute(
                              CountComparisonAnalysis.class, "count_comparison_quality.csv", args))
              ...
              viz.addTrace(
                  BarTrace.builder(Plotly.OBJ_INPUT, Plotly.INPUT)
                      ...
                      .build(),
                  ds.mapping().x("n").y("source").name("quality", Plotly.ColorScheme.RdYlBu));
            })
        .el(
            Plotly.class,
            (viz, data) -> {
        ...
        .el(
            ...
            (viz, data) -> {
              Plotly.DataSet ds =
                  viz.addDataset(
                      data.compute(
                          CountComparisonAnalysis.class, "count_comparison_by_hour.csv", args));
        ...
        .el(
            ...
            (viz, data) -> {
              Plotly.DataSet ds =
                  viz.addDataset(
                      data.compute(
                          CountComparisonAnalysis.class, "count_comparison_daily.csv", args));
    ...
    layout
        ...
        .el(
            ...
            (viz, data) -> {
              ...
              viz.addDataset(
                  "counts",
                  data.compute(CountComparisonAnalysis.class, "count_comparison_daily.csv", args));
        ...
        .el(
            ...
            (viz, data) -> {
              ...
              Plotly.DataSet ds =
                  viz.addDataset(
                      data.compute(CountComparisonAnalysis.class, "count_error_by_hour.csv", args));
              ...
              viz.addTrace(
                  ScatterTrace.builder(Plotly.INPUT, Plotly.INPUT)
                      ...
                      .name("Mean rel. error")
                      .build(),
                  ds.mapping().x("hour").y("mean_rel_error"));
              ...
              viz.addTrace(
                  ScatterTrace.builder(Plotly.INPUT, Plotly.INPUT)
                      ...
                      .name("Mean abs. error")
                      .build(),
                  ds.mapping().x("hour").y("mean_abs_error"));
        ...
        .el(
            ...
            (viz, data) -> {
              ...
              viz.addTrace(
                  ...
                  ds.mapping().x("hour").y("simulated_traffic_volume").name("name"));

              viz.addTrace(
                  BarTrace.builder(Plotly.OBJ_INPUT, Plotly.INPUT).name("Observed").build(),
                  ds.mapping().x("hour").y("observed_traffic_volume").name("name"));
            });
  }
}
