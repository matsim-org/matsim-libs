...
//		- (Note: The congestion index is not recommended by VSP, please use the excess travel time index above described instead)s
//		The speed performance index is the ratio of average travel speed and the free speed (in the MATSim sense, i.e. the effective speed including traffic lights etc. but excluding congestion).
//			A performance index of 0.5 means that the average speed is half of the free speed. A road with a performance index below 0.5 is considered to be in a congested state.
//
