    ...
    layout
        ...
        .el(
            ...
            (viz, data) -> {
              ...
              Plotly.DataSet ds =
                  viz.addDataset(
                      data.compute(
                          TrafficAnalysis.class, "traffic_stats_by_road_type_and_hour.csv", args));
        ...
        .el(
            ...
            ((viz, data) -> {
              ...
              viz.dataset =
                  data.compute(TrafficAnalysis.class, "traffic_stats_by_road_type_daily.csv", args);
    ...
    layout
        ...
        .el(
            ...
            (viz, data) -> {
              ...
              viz.datasets.csvBase =
                  data.compute(TrafficAnalysis.class, "traffic_stats_by_link_daily.csv", args);
