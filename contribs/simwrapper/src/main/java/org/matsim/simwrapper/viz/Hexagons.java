...
public final class Hexagons extends Viz {
  ...
  // TODO DOCs
  public Hexagons addAggregation(
    ...
    this.aggregations.put(
        aggregationTitle,
        List.of(
            new Aggregations.FromToObject(fromTitle, fromX, fromY),
            new Aggregations.FromToObject(toTitle, toX, toY)));
  ...
  // TODO docs
  public Hexagons addAggregation(
      String aggregationTitle, String fromTitle, String fromX, String fromY) {
    this.aggregations.put(
        aggregationTitle, List.of(new Aggregations.FromToObject(fromTitle, fromX, fromY)));
  ...
  private static final class Aggregations {
    ...
    private Aggregations(
        String fromTitle, String fromX, String fromY, String toTitle, String toX, String toY) {
