    ...
    layout
        ...
        .el(
            ...
            (viz, data) -> {
              ...
              viz.stacked = false;
              viz.dataset =
                  data.compute(PopulationAttributeAnalysis.class, "amount_per_age_group.csv");
              viz.x = "Age";
              viz.xAxisName = "Age (≤)";
        ...
        .el(
            ...
            (viz, data) -> {
              ...
              viz.dataset =
                  data.compute(PopulationAttributeAnalysis.class, "amount_per_sex_group.csv");
              viz.useLastRow = true;
            });
    ...
    layout
        ...
        .el(
            ...
            (viz, data) -> {
              ...
              viz.dataset =
                  data.compute(
                      PopulationAttributeAnalysis.class, "average_income_per_age_group.csv");
              viz.x = "Age";
              viz.xAxisName = "Age (≤)";
