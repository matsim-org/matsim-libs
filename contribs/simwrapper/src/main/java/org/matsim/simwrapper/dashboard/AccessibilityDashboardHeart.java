 ...
 */
public class AccessibilityDashboardHeart implements Dashboard {
	 ...
	 */
	public AccessibilityDashboardHeart(String coordinateSystem, List<String> pois, Modes4Accessibility mode) {
