...
/* *********************************************************************** *
 * project: org.matsim.*
 * BicycleAnalysisMainModeIdentifier.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
...
/**
 * This class is only necessary because the bicycle contrib uses mode "bicycle" instead of TransportMode.bike
 *
 * @author vsp-gleich
 *
 */
public final class BicycleAnalysisMainModeIdentifier implements AnalysisMainModeIdentifier {

	private static final Logger log = LogManager.getLogger(BicycleAnalysisMainModeIdentifier.class);

	private final List<String> modeHierarchy = new ArrayList<>() ;

	public BicycleAnalysisMainModeIdentifier() {
