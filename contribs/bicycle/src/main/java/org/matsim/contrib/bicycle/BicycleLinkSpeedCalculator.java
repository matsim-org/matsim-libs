...
public interface BicycleLinkSpeedCalculator extends LinkSpeedCalculator {
  /**
   * @deprecated -- I find it weird that we need a separate interface for something that it
   *     elsewhere in the code expressed by (..., ..., null, null). Maybe should use "optional"??
   *     kai, dec'22
   */
