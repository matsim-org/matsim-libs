...
public final class BicycleConfigGroup extends ReflectiveConfigGroup {
  ...
  private static final String USER_DEFINED_NETWORK_ATTRIBUTE_MARGINAL_UTILITY =
      "marginalUtilityOfUserDefinedNetworkAttribute_m";
  private static final String USER_DEFINED_NETWORK_ATTRIBUTE_NAME =
      "userDefinedNetworkAttributeName";
  private static final String USER_DEFINED_NETWORK_ATTRIBUTE_DEFAULT_VALUE =
  ...
  public final Map<String, String> getComments() {
    ...
    map.put(
        USER_DEFINED_NETWORK_ATTRIBUTE_MARGINAL_UTILITY,
        "marginalUtilityOfUserDefinedNetworkAttribute");
    map.put(USER_DEFINED_NETWORK_ATTRIBUTE_NAME, "userDefinedNetworkAttributeName");
    map.put(
        USER_DEFINED_NETWORK_ATTRIBUTE_DEFAULT_VALUE, "userDefinedNetworkAttributeDefaultValue");
