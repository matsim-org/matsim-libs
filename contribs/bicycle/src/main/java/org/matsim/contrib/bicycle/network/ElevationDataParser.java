...
public class ElevationDataParser {
  ...
  public static void main(String[] args) {
    ...
    String tiffFile =
        "../../../shared-svn/studies/countries/de/berlin-bike/networkRawData/elevation_berlin/BerlinEUDEM.tif"; // Berlin EU-DEM
    // String tiffFile =
    // "../../../shared-svn/studies/countries/de/berlin-bike/networkRawData/elevation_berlin/srtm3/srtm_39_02.tif"; // Berlin SRTM3
    // String tiffFile =
    // "../../../shared-svn/studies/countries/de/berlin-bike/networkRawData/elevation_stuttgart/stuttgartEUDEM.tif"; // Stuttgart EU-DEM
    // String tiffFile =
    // "../../../shared-svn/studies/countries/de/berlin-bike/networkRawData/elevation_stuttgart/srtm_38_03.tif"; // Stuttgart SRTM3
    // String tiffFile =
    // "../../../shared-svn/studies/countries/de/berlin-bike/networkRawData/elevation_brasilia/srtm_27_16.tif"; // Brasilia SRTM3
    ...
    System.out.println(
        "Kreuzberg (Berg): " + elevationDataParser.getElevation(13.379491, 52.487610));
    System.out.println("Herrmannplatz: " + elevationDataParser.getElevation(13.422301, 52.486477));
    System.out.println(
        "U-Bahnhof Boddinstraße: " + elevationDataParser.getElevation(13.423210, 52.480278));
  }
  ...
  public double getElevation(Coord coord) {
    ...
    try {
      posGrid =
          gg.worldToGrid(new DirectPosition2D(transformedCoord.getX(), transformedCoord.getY()));
