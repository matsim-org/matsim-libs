...
public class RunBicycleExampleMod {
	private static final Logger LOG = LogManager.getLogger(RunBicycleExampleMod.class);
	...
	public static void main(String[] args) {
		...
		new RunBicycleExampleMod().runWithOwnScoring(config, considerMotorizedInteraction);
	}
