...
/**
 * This mode availability filters out "car" from the list of given modes if an agent does not have a
 * driving license or does not have car availability. The way it is implemented is consistent with
 * the constriant in SubtourModeChoice.
 *
 * <p>Car is not available if Person.getLicense gives "no" or if PersonUtils.getCarAvail returns
 * "never".
 *
 * @author sebhoerl
 */
