...
public class TourFinderModule extends AbstractDiscreteModeChoiceExtension {
  ...
  public static final Collection<String> COMPONENTS =
      Arrays.asList(PLAN_BASED, ACTIVITY_BASED, HOME_BASED);
  ...
  @Provides
  @Singleton
  public ActivityTourFinder provideActivityBasedTourFinder(
  ...
  @Provides
  @Singleton
  public TourFinder provideTourFinder(
      DiscreteModeChoiceConfigGroup dmcConfig, Map<String, Provider<TourFinder>> components) {
    ...
    if (provider != null) {
      ...
      throw new IllegalStateException(
          String.format(
              "There is no TourFinder component called '%s',", dmcConfig.getTourFinder()));
    }
  }
}
