...
/**
 * This constraint forbids or allows a certain mode depending on whether a certain link attribute is
 * available for the origin and/or destination.
 *
 * @author sebhoerl
 */
public class LinkAttributeConstraint implements TripConstraint {
  ...
  public LinkAttributeConstraint(
      Network network,
  ...
  public static class Factory implements TripConstraintFactory {
    ...
    public TripConstraint createConstraint(
        Person person, List<DiscreteModeChoiceTrip> trips, Collection<String> availableModes) {
      return new LinkAttributeConstraint(
          network, restrictedModes, linkAttributeName, linkAttributeValue, requirement);
    }
  }
}
