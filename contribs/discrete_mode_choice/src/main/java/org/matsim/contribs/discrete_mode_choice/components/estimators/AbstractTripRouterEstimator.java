...
/**
 * This is an abstract estimator class that makes it easy to rely on MATSim's TripRouter. Instead of
 * just getting a proposed mode, this class already routes the trip with the given mode in the
 * background. All that remains is to analyze the PlanElements to estimate a utility.
 *
 * @author sebhoerl
 */
public abstract class AbstractTripRouterEstimator implements TripEstimator {
  ...
  public AbstractTripRouterEstimator(
  ...
  @Override
  public final TripCandidate estimateTrip(
      Person person, String mode, DiscreteModeChoiceTrip trip, List<TripCandidate> previousTrips) {
  ...
  /**
   * Implement this if you just want to calculate a utility, but don't want to return a custom
   * TripCandidate object.
   */
  protected double estimateTrip(
      Person person,
      String mode,
      DiscreteModeChoiceTrip trip,
      List<TripCandidate> previousTrips,
      List<? extends PlanElement> routedTrip) {
    return 0.0;
  }
   ...
   */
  protected TripCandidate estimateTripCandidate(
      Person person,
      String mode,
      DiscreteModeChoiceTrip trip,
      List<TripCandidate> previousTrips,
