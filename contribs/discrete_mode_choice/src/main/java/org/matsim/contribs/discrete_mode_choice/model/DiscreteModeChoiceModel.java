...
public interface DiscreteModeChoiceModel {
  ...
  /**
   * Defines how choices are handled that cannot be taken, because constraints or missing modes make
   * the choice infeasible.
   */
  public static enum FallbackBehaviour {
    IGNORE_AGENT,
    INITIAL_CHOICE,
    EXCEPTION
  }
