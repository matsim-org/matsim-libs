...
public interface TourFilter {
  /**
   * This function is called before any mode choice attempt for a certain tour is made. It should
   * return whether the tour should be ignored for decision making.
   */
