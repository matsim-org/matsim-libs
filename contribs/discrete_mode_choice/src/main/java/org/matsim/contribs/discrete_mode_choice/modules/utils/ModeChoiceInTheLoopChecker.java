...
/**
 * Internal listener that is used to do some runtime checks when mode-choice-in-the-loop should be
 * enforced.
 *
 * @author sebhoerl
 */
public class ModeChoiceInTheLoopChecker implements StartupListener {
  ...
  @Inject
  public ModeChoiceInTheLoopChecker(
      ReplanningConfigGroup strategyConfig, PlanSelector<Plan, Person> removalSelector) {
