...
public class ConstraintModule extends AbstractDiscreteModeChoiceExtension {
  ...
  public static final Collection<String> TRIP_COMPONENTS =
      Arrays.asList(VEHICLE_CONTINUITY, SHAPE_FILE, LINK_ATTRIBUTE, TRANSIT_WALK);

  public static final Collection<String> TOUR_COMPONENTS =
      Arrays.asList(FROM_TRIP_BASED, VEHICLE_CONTINUITY, SUBTOUR_MODE);
  ...
  private TourConstraintFactory getTourConstraintFactory(
      String name, Map<String, Provider<TourConstraintFactory>> components) {
  ...
  private TripConstraintFactory getTripConstraintFactory(
      String name, Map<String, Provider<TripConstraintFactory>> components) {
  ...
  @Provides
  @Singleton
  public TourConstraintFactory provideTourConstraintFactory(
  ...
  @Provides
  @Singleton
  public TripConstraintFactory provideTripConstraintFactory(
      DiscreteModeChoiceConfigGroup dmcConfig,
  ...
  @Provides
  @Singleton
  public LinkAttributeConstraint.Factory provideLinkAttributeConstraintFactory(
      Network network, DiscreteModeChoiceConfigGroup dmcConfig) {
    LinkAttributeConstraintConfigGroup config = dmcConfig.getLinkAttributeConstraintConfigGroup();
    return new LinkAttributeConstraint.Factory(
        network,
        config.getConstrainedModes(),
  ...
  @Provides
  @Singleton
  public ShapeFileConstraint.Factory provideShapeFileConstraintFactory(
      Network network, DiscreteModeChoiceConfigGroup dmcConfig, Config matsimConfig) {
    ...
    return new ShapeFileConstraint.Factory(
        network, config.getConstrainedModes(), config.getRequirement(), url);
  }

  @Provides
  @Singleton
  public VehicleTripConstraint.Factory provideVehicleTripConstraintFactory(
    ...
    return new VehicleTripConstraint.Factory(
        config.getRestrictedModes(), config.getIsAdvanced(), homeFinder);
  }

  @Provides
  @Singleton
  public VehicleTourConstraint.Factory provideVehicleTourConstraintFactory(
      DiscreteModeChoiceConfigGroup dmcConfig, HomeFinder homeFinder) {
  ...
  @Provides
  @Singleton
  public SubtourModeConstraint.Factory provideSubtourModeConstraintFactory(
      DiscreteModeChoiceConfigGroup dmcConfig) {
