...
/**
 * This class is a TourEstimator which is based on a TripEstimator. Every trip in the tour is
 * estimated by the underlying TripEstimator and utilities are summed up to arrive at a total
 * utility for the whole tour.
 *
 * @author sebhoerl
 */
public class CumulativeTourEstimator implements TourEstimator {
  ...
  @Override
  public TourCandidate estimateTour(
      Person person,
      List<String> modes,
