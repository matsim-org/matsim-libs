...
/**
 * The maximum utility selector collects a set of candidates with a given utility value and then
 * selects the one with the highest utility. Internally, always only the best candidate is held.
 *
 * @author sebhoerl
 */
