...
/**
 * This is a plan selector for replanning that always selects a plan that is *not* selected
 * currently. This is especially useful when keeping only one plan in an agent's memory but
 * replanning is frequently. This way always the new replanned version will be kept.
 *
 * @author sebhoerl
 */
