...
public class HomeFinderModule extends AbstractDiscreteModeChoiceExtension {
  ...
  @Provides
  @Singleton
  public ActivityTypeHomeFinder provideActivityTypeHomeFinder(
  ...
  public HomeFinder provideHomeFinder(
      DiscreteModeChoiceConfigGroup dmcConfig, Map<String, Provider<HomeFinder>> components) {
    ...
    if (provider != null) {
      ...
      throw new IllegalStateException(
          String.format(
              "There is no HomeFinder component called '%s',", dmcConfig.getHomeFinder()));
    }
  }
}
