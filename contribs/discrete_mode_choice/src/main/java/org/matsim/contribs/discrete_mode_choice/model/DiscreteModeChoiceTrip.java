...
/**
 * This class represents an agent's trip. It contains structural information such as the origin and
 * destination activity and the mode that has initially been used to cover the trip.
 *
 * @author sebhoerl
 */
