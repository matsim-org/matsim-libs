...
/**
 * A UtilitySelector collects a set of candidates for a specific choice (using addCanddiate) and
 * finally selects one of them according to a predefined process.
 *
 * @author sebhoerl
 */
