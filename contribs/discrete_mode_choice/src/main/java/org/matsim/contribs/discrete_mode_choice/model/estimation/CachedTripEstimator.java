...
/**
 * This trip estimator wraps another TripEstimator for which it caches results. One can configure
 * which modes should be cached. This way, for instance when a trip would be estimates many times,
 * e.g. in a tour-based model, one makes sure that this only happens once.
 *
 * @author sebhoerl
 */
