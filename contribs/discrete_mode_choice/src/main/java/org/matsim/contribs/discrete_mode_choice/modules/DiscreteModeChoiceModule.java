...
/**
 * Main module of the Discrete Mode Choice extension. Should be added as an overriding module before
 * the MATSim controller is started.
 *
 * @author sebhoerl
 */
public class DiscreteModeChoiceModule extends AbstractModule {
  ...
  @Inject private DiscreteModeChoiceConfigGroup dmcConfig;
