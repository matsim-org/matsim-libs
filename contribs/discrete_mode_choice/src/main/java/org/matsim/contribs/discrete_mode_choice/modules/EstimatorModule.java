...
public class EstimatorModule extends AbstractDiscreteModeChoiceExtension {
  ...
  public static final Collection<String> TRIP_COMPONENTS =
      Arrays.asList(MATSIM_TRIP_SCORING, UNIFORM);
  public static final Collection<String> TOUR_COMPONENTS =
      Arrays.asList(MATSIM_DAY_SCORING, CUMULATIVE, UNIFORM);
  ...
  @Provides
  public TourEstimator provideTourEstimator(
      DiscreteModeChoiceConfigGroup dmcConfig, Map<String, Provider<TourEstimator>> components) {
    ...
    if (provider != null) {
      ...
      throw new IllegalStateException(
          String.format(
              "There is no TourEstimator component called '%s',", dmcConfig.getTourEstimator()));
    }
  }

  @Provides
  public TripEstimator provideTripEstimator(
      DiscreteModeChoiceConfigGroup dmcConfig, Map<String, Provider<TripEstimator>> components) {
    ...
    if (provider != null) {
      ...
      throw new IllegalStateException(
          String.format(
              "There is no TripEstimator component called '%s',", dmcConfig.getTripEstimator()));
    }
  }
  ...
  @Provides
  public MATSimTripScoringEstimator provideMATSimTripScoringEstimator(
    ...
    return new MATSimTripScoringEstimator(
        facilities,
        tripRouter,
        waitingTimeEstimator,
        scoringParametersForPerson,
        timeInterpretation,
        scoringConfig.getPtLegModes());
  }

  @Provides
  public MATSimDayScoringEstimator provideMATSimDayScoringEstimator(
      MATSimTripScoringEstimator tripEstimator,
      ScoringParametersForPerson scoringParametersForPerson,
      DiscreteModeChoiceConfigGroup dmcConfig,
      TimeInterpretation timeInterpretation) {
    return new MATSimDayScoringEstimator(
        new CachedTripEstimator(tripEstimator, dmcConfig.getCachedModes()),
        scoringParametersForPerson,
        timeInterpretation);
  }

  @Provides
  public CumulativeTourEstimator provideCumulativeTourEstimator(
      TripEstimator tripEstimator, TimeInterpretation timeInterpretation) {
