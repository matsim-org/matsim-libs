...
/**
 * This HomeFinder implementation searches for a configurable activity type in an agent's plan. As
 * soon as the activity type is found, the respective location is return as the "home" location of
 * the agent. Default is activity type "home".
 *
 * @author sebhoerl
 */
