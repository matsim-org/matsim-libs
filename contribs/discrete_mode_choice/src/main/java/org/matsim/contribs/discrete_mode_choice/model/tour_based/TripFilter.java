...
public interface TripFilter {
  /**
   * This function is called before any mode choice attempt for a certain trip is made. It should
   * return whether the trip should be ignored for decision making.
   */
