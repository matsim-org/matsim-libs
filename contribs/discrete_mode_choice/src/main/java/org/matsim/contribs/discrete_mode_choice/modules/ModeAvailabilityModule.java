...
public class ModeAvailabilityModule extends AbstractDiscreteModeChoiceExtension {
  ...
  @Provides
  public DefaultModeAvailability provideDefaultModeAvailability(
  ...
  @Provides
  public ModeAvailability provideModeAvailability(
      DiscreteModeChoiceConfigGroup dmcConfig, Map<String, Provider<ModeAvailability>> components) {
    ...
    if (provider != null) {
      ...
      throw new IllegalStateException(
          String.format(
              "There is no ModeAvailability component called '%s',",
