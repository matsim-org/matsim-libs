...
/**
 * Module that is added if a TransitSchedule is available. It binds a PTWaitingTimeEstimator that is
 * able to estimate a waiting time from the schedule.
 *
 * @author sebhoerl
 */
public class ScheduleWaitingTimeEstimatorModule extends AbstractModule {
  ...
  @Provides
  @Singleton
  public ScheduleWaitingTimeEstimator provideScheduleWaitingTimeEstimator(
