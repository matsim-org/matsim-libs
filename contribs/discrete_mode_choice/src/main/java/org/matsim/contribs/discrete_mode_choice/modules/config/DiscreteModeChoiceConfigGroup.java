...
public class DiscreteModeChoiceConfigGroup extends ReflectiveConfigGroup {
  ...
  private Collection<String> tourConstraints =
      new HashSet<>(Arrays.asList(ConstraintModule.VEHICLE_CONTINUITY));
  ...
  private static final String PERFORM_REROUTE_CMT =
      "Defines whether the "
          + DiscreteModeChoiceModule.STRATEGY_NAME
  ...
  private static final String ENFORCE_SINGLE_PLAN_CMT =
  ...
  private static final String FALLBACK_BEHAVIOR_CMT =
  ...
  private static final String TRIP_CONSTRAINTS_CMT =
  ...
  private static final String TRIP_FILTERS_CMT =
  ...
  public static final String CACHED_MODES_CMT =
  ...
  public void setTourFiltersAsString(String tourFilters) {
    this.tourFilters =
        Arrays.asList(tourFilters.split(",")).stream()
            .map(String::trim)
  ...
  public void setTripFiltersAsString(String tripFilters) {
    this.tripFilters =
        Arrays.asList(tripFilters.split(",")).stream()
            .map(String::trim)
            .collect(Collectors.toSet());
  }
  ...
  public void setTourConstraintsAsString(String tourConstraints) {
    this.tourConstraints =
        Arrays.asList(tourConstraints.split(",")).stream()
            .map(String::trim)
            .collect(Collectors.toSet());
  }
  ...
  public void setTripConstraintsAsString(String tripConstraints) {
    this.tripConstraints =
        Arrays.asList(tripConstraints.split(",")).stream()
            .map(String::trim)
            .collect(Collectors.toSet());
  }
  ...
  public void setCachedModesAsString(String cachedModes) {
    this.cachedModes =
        Arrays.asList(cachedModes.split(",")).stream()
            .map(String::trim)
            .collect(Collectors.toSet());
  }
  ...
  private final Map<Tuple<String, String>, ConfigGroup> componentRegistry =
      createComponentRegistry(createComponentSupplierRegistry());
  ...
  private Map<Tuple<String, String>, ComponentSupplier> createComponentSupplierRegistry() {
    ...
    registry.put(
        new Tuple<>(TOUR_FINDER, TourFinderModule.ACTIVITY_BASED), //
        ActivityTourFinderConfigGroup::new);
    registry.put(
        new Tuple<>(HOME_FINDER, HomeFinderModule.ACTIVITY_BASED), //
        ActivityHomeFinderConfigGroup::new);
    registry.put(
        new Tuple<>(MODE_AVAILABILITY, ModeAvailabilityModule.DEFAULT), //
        ModeAvailabilityConfigGroup::new);
    registry.put(
        new Tuple<>(MODE_AVAILABILITY, ModeAvailabilityModule.CAR), //
        ModeAvailabilityConfigGroup::new);
    registry.put(
        new Tuple<>(SELECTOR, SelectorModule.MULTINOMIAL_LOGIT), //
        MultinomialLogitSelectorConfigGroup::new);
    registry.put(
        new Tuple<>(TRIP_CONSTRAINT, ConstraintModule.LINK_ATTRIBUTE), //
        LinkAttributeConstraintConfigGroup::new);
    registry.put(
        new Tuple<>(TRIP_CONSTRAINT, ConstraintModule.SHAPE_FILE), //
        ShapeFileConstraintConfigGroup::new);
    registry.put(
        new Tuple<>(TRIP_CONSTRAINT, ConstraintModule.VEHICLE_CONTINUITY), //
        VehicleTripConstraintConfigGroup::new);
    registry.put(
        new Tuple<>(TOUR_CONSTRAINT, ConstraintModule.VEHICLE_CONTINUITY), //
        VehicleTourConstraintConfigGroup::new);
    registry.put(
        new Tuple<>(TOUR_CONSTRAINT, ConstraintModule.SUBTOUR_MODE), //
        SubtourModeConstraintConfigGroup::new);
    registry.put(
        new Tuple<>(TRIP_ESTIMATOR, EstimatorModule.MATSIM_TRIP_SCORING), //
        MATSimTripScoringConfigGroup::new);
    registry.put(
        new Tuple<>(TOUR_FILTER, FilterModule.TOUR_LENGTH), //
  ...
  private Map<Tuple<String, String>, ConfigGroup> createComponentRegistry(
    ...
    for (Map.Entry<Tuple<String, String>, ComponentSupplier> entry :
        componentSupplierRegistry.entrySet()) {
      ConfigGroup componentConfig =
          entry.getValue().create(entry.getKey().getFirst(), entry.getKey().getSecond());
  ...
  public ConfigGroup createParameterSet(String parameterSetType) {
    List<String> segments =
        Arrays.asList(parameterSetType.split(":")).stream()
            .map(String::trim)
    ...
    if (segments.size() == 2) {
      ...
      throw new IllegalStateException(
          String.format(
              "Wrongly formatted component: %s (shoud be 'componentType:componentName')",
              parameterSetType));
    }
  }
  ...
  public void addParameterSet(ConfigGroup set) {
    if (!componentRegistry.containsValue(set)) {
      throw new IllegalStateException(
          "Attempt to add unknown parameter set to DiscreteModeChoiceConfigGroup");
    }
  }
  ...
  public ConfigGroup getComponentConfig(String componentType, String componentName) {
    ...
    if (componentRegistry.containsKey(key)) {
      ...
      throw new IllegalStateException(
          String.format(
              "Unknown component configuration of type '%s' and name '%s'.",
  ...
  public ActivityTourFinderConfigGroup getActivityTourFinderConfigGroup() {
    return (ActivityTourFinderConfigGroup)
        getComponentConfig(TOUR_FINDER, TourFinderModule.ACTIVITY_BASED);
  }

  /** See {@link ActivityHomeFinderConfigGroup} */
  public ActivityHomeFinderConfigGroup getActivityHomeFinderConfigGroup() {
    return (ActivityHomeFinderConfigGroup)
        getComponentConfig(HOME_FINDER, HomeFinderModule.ACTIVITY_BASED);
  }

  /** See {@link ModeAvailabilityConfigGroup} */
  public ModeAvailabilityConfigGroup getDefaultModeAvailabilityConfig() {
    return (ModeAvailabilityConfigGroup)
        getComponentConfig(MODE_AVAILABILITY, ModeAvailabilityModule.DEFAULT);
  }

  /** See {@link ModeAvailabilityConfigGroup} */
  public ModeAvailabilityConfigGroup getCarModeAvailabilityConfig() {
    return (ModeAvailabilityConfigGroup)
        getComponentConfig(MODE_AVAILABILITY, ModeAvailabilityModule.CAR);
  }

  /** See {@link MultinomialLogitSelectorConfigGroup} */
  public MultinomialLogitSelectorConfigGroup getMultinomialLogitSelectorConfig() {
    return (MultinomialLogitSelectorConfigGroup)
        getComponentConfig(SELECTOR, SelectorModule.MULTINOMIAL_LOGIT);
  }
  ...
  public LinkAttributeConstraintConfigGroup getLinkAttributeConstraintConfigGroup() {
    return (LinkAttributeConstraintConfigGroup)
        getComponentConfig(TRIP_CONSTRAINT, ConstraintModule.LINK_ATTRIBUTE);
  }

  /** See {@link ShapeFileConstraintConfigGroup} */
  public ShapeFileConstraintConfigGroup getShapeFileConstraintConfigGroup() {
    return (ShapeFileConstraintConfigGroup)
        getComponentConfig(TRIP_CONSTRAINT, ConstraintModule.SHAPE_FILE);
  }

  /** See {@link VehicleTripConstraintConfigGroup} */
  public VehicleTripConstraintConfigGroup getVehicleTripConstraintConfig() {
    return (VehicleTripConstraintConfigGroup)
        getComponentConfig(TRIP_CONSTRAINT, ConstraintModule.VEHICLE_CONTINUITY);
  }

  /** See {@link VehicleTourConstraintConfigGroup} */
  public VehicleTourConstraintConfigGroup getVehicleTourConstraintConfig() {
    return (VehicleTourConstraintConfigGroup)
        getComponentConfig(TOUR_CONSTRAINT, ConstraintModule.VEHICLE_CONTINUITY);
  }

  /** See {@link SubtourModeConstraintConfigGroup} */
  public SubtourModeConstraintConfigGroup getSubtourConstraintConfig() {
    return (SubtourModeConstraintConfigGroup)
        getComponentConfig(TOUR_CONSTRAINT, ConstraintModule.SUBTOUR_MODE);
  }

  /** See {@link MATSimTripScoringConfigGroup} */
  public MATSimTripScoringConfigGroup getMATSimTripScoringConfigGroup() {
    return (MATSimTripScoringConfigGroup)
        getComponentConfig(TRIP_ESTIMATOR, EstimatorModule.MATSIM_TRIP_SCORING);
  }
  ...
  public Map<String, String> getComments() {
    ...
    comments.put(
        FALLBACK_BEHAVIOUR,
        FALLBACK_BEHAVIOR_CMT
            + Arrays.asList(FallbackBehaviour.values()).stream()
                .map(String::valueOf)
                .collect(Collectors.joining(", ")));
    comments.put(
        MODE_AVAILABILITY,
        MODE_AVAILABILITY_CMT + String.join(", ", ModeAvailabilityModule.COMPONENTS));
    ...
    comments.put(
        TOUR_CONSTRAINTS,
        TOUR_CONSTRAINTS_CMT + String.join(", ", ConstraintModule.TOUR_COMPONENTS));
    comments.put(
        TRIP_CONSTRAINTS,
        TRIP_CONSTRAINTS_CMT + String.join(", ", ConstraintModule.TRIP_COMPONENTS));
    comments.put(
        TOUR_ESTIMATOR, TOUR_ESTIMATOR_CMT + String.join(", ", EstimatorModule.TOUR_COMPONENTS));
    comments.put(
        TRIP_ESTIMATOR, TRIP_ESTIMATOR_CMT + String.join(", ", EstimatorModule.TRIP_COMPONENTS));
  ...
  public static DiscreteModeChoiceConfigGroup getOrCreate(Config config) {
    DiscreteModeChoiceConfigGroup configGroup =
        (DiscreteModeChoiceConfigGroup) config.getModules().get(GROUP_NAME);
