...
/**
 * Base class for extensions to Discrete Mode Choice. It provides some helper methods to easily bind
 * new estimators, constraints, and more.
 *
 * @author sebhoerl
 */
public abstract class AbstractDiscreteModeChoiceExtension extends AbstractModule {
  ...
  public final void install() {
    ...
    tourConstraintFactoryBinder =
        MapBinder.newMapBinder(binder(), String.class, TourConstraintFactory.class);
    tripConstraintFactoryBinder =
        MapBinder.newMapBinder(binder(), String.class, TripConstraintFactory.class);
  ...
  protected final LinkedBindingBuilder<TourConstraintFactory> bindTourConstraintFactory(
      String name) {
    return tourConstraintFactoryBinder.addBinding(name);
  }

  protected final LinkedBindingBuilder<TripConstraintFactory> bindTripConstraintFactory(
      String name) {
