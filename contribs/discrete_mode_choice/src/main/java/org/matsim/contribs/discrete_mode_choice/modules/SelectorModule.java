...
public class SelectorModule extends AbstractDiscreteModeChoiceExtension {
  ...
  public static final Collection<String> COMPONENTS =
      Arrays.asList(MAXIMUM, MULTINOMIAL_LOGIT, RANDOM);
  ...
  @Provides
  public UtilitySelectorFactory provideTourSelectorFactory(
    ...
    if (provider != null) {
      ...
      throw new IllegalStateException(
          String.format(
              "There is no UtilitySelector component for tours called '%s',",
              dmcConfig.getSelector()));
    }
  }
  ...
  public MultinomialLogitSelector.Factory provideMultinomialLogitTripSelector(
    ...
    return new MultinomialLogitSelector.Factory(
        config.getMinimumUtility(), config.getMaximumUtility(), config.getConsiderMinimumUtility());
  }
