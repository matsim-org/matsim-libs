...
public class NestCalculatorTest {
  ...
  public void testNoNesting() throws NoFeasibleChoiceException {
    ...
    NestedUtilityCandidate carCandidate =
        new DefaultNestedTripCandidate(-1.0, "car", 0.0, structure.getRoot());
    NestedUtilityCandidate busCandidate =
        new DefaultNestedTripCandidate(-2.0, "bus", 0.0, structure.getRoot());
  ...
  public void testNoNestingRedBlue() throws NoFeasibleChoiceException {
    ...
    NestedUtilityCandidate carCandidate =
        new DefaultNestedTripCandidate(-1.0, "car", 0.0, structure.getRoot());
    NestedUtilityCandidate redbusCandidate =
        new DefaultNestedTripCandidate(-1.0, "redbus", 0.0, structure.getRoot());
    NestedUtilityCandidate bluebusCandidate =
        new DefaultNestedTripCandidate(-1.0, "bluebus", 0.0, structure.getRoot());
  ...
  public void testNestedBalancedRedBlue() throws NoFeasibleChoiceException {
    ...
    NestedUtilityCandidate carCandidate =
        new DefaultNestedTripCandidate(-1.0, "car", 0.0, structure.getRoot());
    NestedUtilityCandidate redbusCandidate =
        new DefaultNestedTripCandidate(-1.0, "redbus", 0.0, busNest);
    NestedUtilityCandidate bluebusCandidate =
        new DefaultNestedTripCandidate(-1.0, "bluebus", 0.0, busNest);
    ...
    assertEquals(
        Math.log(2.0 * Math.exp(-1.0)), calculator.calculateExpectedUtility(busNest), 1e-6);
    ...
    assertEquals(0.5, calculator.calculateConditionalProbability(bluebusCandidate), 1e-6);
    assertEquals(
        0.48267825516781476, calculator.calculateConditionalProbability(carCandidate), 1e-6);
    assertEquals(
        1.0 - 0.48267825516781476, calculator.calculateConditionalProbability(busNest), 1e-6);
    assertEquals(0.48267825516781476, calculator.calculateProbability(carCandidate), 1e-6);
    assertEquals(
        0.5 * (1.0 - 0.48267825516781476), calculator.calculateProbability(redbusCandidate), 1e-6);
    assertEquals(
        0.5 * (1.0 - 0.48267825516781476), calculator.calculateProbability(bluebusCandidate), 1e-6);
    ...
    assertEquals(0.5, calculator.calculateConditionalProbability(bluebusCandidate), 1e-6);
    assertEquals(
        0.4982671389865804, calculator.calculateConditionalProbability(carCandidate), 1e-6);
    assertEquals(
        1.0 - 0.4982671389865804, calculator.calculateConditionalProbability(busNest), 1e-6);
    assertEquals(0.4982671389865804, calculator.calculateProbability(carCandidate), 1e-6);
    assertEquals(
        0.5 * (1.0 - 0.4982671389865804), calculator.calculateProbability(redbusCandidate), 1e-6);
    assertEquals(
        0.5 * (1.0 - 0.4982671389865804), calculator.calculateProbability(bluebusCandidate), 1e-6);
  }
  ...
  public void testNestedUnbalancedRedBlue() throws NoFeasibleChoiceException {
    ...
    NestedUtilityCandidate carCandidate =
        new DefaultNestedTripCandidate(-1.0, "car", 0.0, structure.getRoot());
    NestedUtilityCandidate redbusCandidate =
        new DefaultNestedTripCandidate(-0.5, "redbus", 0.0, busNest);
    NestedUtilityCandidate bluebusCandidate =
        new DefaultNestedTripCandidate(-1.0, "bluebus", 0.0, busNest);
    ...
    busNest.setScaleParameter(1.0);
    assertEquals(
        0.6224593312018546, calculator.calculateConditionalProbability(redbusCandidate), 1e-6);
    assertEquals(
        1.0 - 0.6224593312018546,
        calculator.calculateConditionalProbability(bluebusCandidate),
        1e-6);
  }
}
