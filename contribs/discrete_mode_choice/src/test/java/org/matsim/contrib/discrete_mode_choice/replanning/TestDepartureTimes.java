...
public class TestDepartureTimes {
  ...
  public void testPushDepartureTimeToNextTour() throws NoFeasibleChoiceException {
    ...
    Plan plan =
        new PlanBuilder() //
            ...
            .addLeg(
                "generic",
                1200.0) // This trip is too long, so the time should be pushed to next tour
  ...
  public void testAccumulateAndPushDepartureTimeToNextTour() throws NoFeasibleChoiceException {
    ...
    Plan plan =
        new PlanBuilder() //
            ...
            .addLeg(
                "generic",
                3200.0) // This trip is too long, so the time should be pushed to next tour
            .addActivityWithEndTime("home", 3000.0) //
            .addLeg("generic", 500.0) //
  ...
  private static void assertDepartureTimes(
      DiscreteModeChoiceModel model, Plan plan, List<Double> referenceTimes)
  ...
  private static TripBasedModel createTripBasedModel() {
  ...
  private static TourBasedModel createTourBasedModel() {
    ...
    TourEstimator estimator =
        new CumulativeTourEstimator(new TestTripEstimator(), timeInterpretation);
  ...
  private static class TestTripEstimator implements TripEstimator {
    @Override
