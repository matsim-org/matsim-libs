...
public class SubtourModeChoiceReplacementTest {
  ...
  public void testChoiceSet() throws NoFeasibleChoiceException {
    ...
    dmcChains =
        computeDMC(planBuilder, modes, constrainedModes, considerCarAvailability, false, samples);
    smcChains =
        computeSMC(planBuilder, modes, constrainedModes, considerCarAvailability, false, samples);
    ...
    // Allow single legs
    dmcChains =
        computeDMC(planBuilder, modes, constrainedModes, considerCarAvailability, true, samples);
    smcChains =
        computeSMC(planBuilder, modes, constrainedModes, considerCarAvailability, true, samples);
  ...
  private Set<List<String>> computeDMC(
      PlanBuilder planBuilder,
      List<String> modes,
      List<String> constrainedModes,
      boolean considerCarAvailability,
      boolean allowSingleLegs,
      int samples)
    ...
    TourConstraintFactory vehicleConstraintFactory =
        new VehicleTourConstraint.Factory(constrainedModes, homeFinder);

    TourConstraintFactory subtourModeChoiceConstraintFactory =
        new SubtourModeConstraint.Factory(allowSingleLegs ? constrainedModes : modes);
  ...
  private Set<List<String>> computeSMC(
      PlanBuilder planBuilder,
      List<String> modes,
      List<String> constrainedModes,
      boolean considerCarAvailability,
    ...
    ChooseRandomLegModeForSubtour smc =
