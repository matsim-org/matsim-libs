...
public class SharingReservingEvent extends AbstractSharingEvent {
  public static final String TYPE = "sharing vehicle reserving";

  public SharingReservingEvent(
      double time,
      Id<SharingService> serviceId,
      Id<Person> personId,
      Id<Link> linkId,
      Id<SharingVehicle> vehicleId,
  ...
  public static SharingReservingEvent convert(GenericEvent event) {
    return new SharingReservingEvent(
        event.getTime(), //
