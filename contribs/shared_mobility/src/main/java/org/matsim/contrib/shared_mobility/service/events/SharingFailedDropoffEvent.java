...
public class SharingFailedDropoffEvent extends AbstractSharingEvent {
  public static final String TYPE = "sharing vehicle dropoff failed";

  public SharingFailedDropoffEvent(
      double time,
  ...
  public static SharingFailedDropoffEvent convert(GenericEvent event) {
    return new SharingFailedDropoffEvent(
        event.getTime(), //
