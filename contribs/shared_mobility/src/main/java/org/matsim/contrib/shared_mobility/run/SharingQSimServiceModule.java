...
public class SharingQSimServiceModule extends AbstractModalQSimModule<SharingMode> {
  ...
  protected void configureQSim() {
    ...
    bindModal(FreefloatingService.class)
        .toProvider(
            modalProvider(
                getter -> {
                  ...
                  return new FreefloatingService(
                      Id.create(serviceConfig.getId(), SharingService.class),
                      specification.getVehicles(),
                      network,
    ...
    bindModal(StationBasedService.class)
        .toProvider(
            modalProvider(
                getter -> {
                  Network network = getter.get(Network.class);
                  ...
                  return new StationBasedService(
                      Id.create(serviceConfig.getId(), SharingService.class),
                      specification,
                      network,
                      serviceConfig.getMaximumAccessEgressDistance());
