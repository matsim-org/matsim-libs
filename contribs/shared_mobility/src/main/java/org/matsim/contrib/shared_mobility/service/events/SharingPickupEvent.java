...
public class SharingPickupEvent extends AbstractSharingEvent {
  public static final String TYPE = "sharing vehicle pickup";
  Id<SharingVehicle> sharingVehicleId;

  public SharingPickupEvent(
      double time,
  ...
  public static SharingPickupEvent convert(GenericEvent event) {
    return new SharingPickupEvent(
        event.getTime(), //
