...
public class VehicleInteractionPoint extends InteractionPoint {
  ...
  protected VehicleInteractionPoint(
      SharingVehicle vehicle, Id<Link> linkId, Optional<Id<SharingStation>> stationId) {
  ...
  public static VehicleInteractionPoint of(SharingVehicle vehicle) {
    return new VehicleInteractionPoint(vehicle, vehicle.getLink().getId(), Optional.empty());
  }

  public static VehicleInteractionPoint of(SharingVehicle vehicle, SharingStation station) {
    return new VehicleInteractionPoint(
        vehicle, vehicle.getLink().getId(), Optional.of(station.getId()));
  }
}
