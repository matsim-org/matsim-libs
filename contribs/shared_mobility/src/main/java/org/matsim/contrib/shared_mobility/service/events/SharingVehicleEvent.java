...
public class SharingVehicleEvent extends Event implements HasLinkId {
  public static final String TYPE = "sharing vehicle placed";
  ...
  public static SharingVehicleEvent convert(GenericEvent event) {
    return new SharingVehicleEvent(
        event.getTime(), //
