...
public class FreefloatingService implements SharingService {
  ...
  public FreefloatingService(
      Id<SharingService> serviceId,
      Collection<SharingVehicleSpecification> fleet,
      Network network,
  ...
  private static final IdMap<SharingStation, SharingStation> EMPTY_STATION_MAP =
      new IdMap<>(SharingStation.class);
