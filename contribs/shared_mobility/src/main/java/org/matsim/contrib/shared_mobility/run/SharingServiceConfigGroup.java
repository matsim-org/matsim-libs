...
public class SharingServiceConfigGroup extends ReflectiveConfigGroup {
  ...
  public static final String SERVICE_SCHEME_EXP =
      "One of: "
          + String.join(
              ", ",
              Arrays.asList(ServiceScheme.values()).stream()
                  .map(String::valueOf)
  ...
  public static final String MAXIMUM_ACCESS_EGRESS_DISTANCE_EXP =
      "Maximum distance to a bike or station";
  ...
  @NotNull private String serviceInputFile;

  @NotNull private String id;

  @NotNull private ServiceScheme serviceScheme;

  private String serviceAreaShapeFile;

  @NotNull private String mode;

  @Positive private double maximumAccessEgressDistance = 1000;

  @Nonnegative private double timeFare = 0.0;

  @Nonnegative private double distanceFare = 0.0;

  @Nonnegative private double baseFare = 0.0;

  @Nonnegative private double minimumFare = 0.0;
