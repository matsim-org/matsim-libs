...
public class SharingFailedPickupEvent extends AbstractSharingEvent {
  public static final String TYPE = "sharing vehicle pickup failed";

  public SharingFailedPickupEvent(
      double time,
  ...
  public static SharingFailedPickupEvent convert(GenericEvent event) {
    return new SharingFailedPickupEvent(
        event.getTime(), //
