...
public class SharingNetworkRentalsHandler
  ...
  public SharingNetworkRentalsHandler(
      EventsManager eventsManager, SharingServiceConfigGroup serviceParams, Network network) {
