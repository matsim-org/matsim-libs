...
public class SharingDropoffEvent extends AbstractSharingEvent {
  public static final String TYPE = "sharing vehicle dropoff";
  Id<SharingVehicle> sharingVehicleId;

  public SharingDropoffEvent(
      double time,
  ...
  public static SharingDropoffEvent convert(GenericEvent event) {
    return new SharingDropoffEvent(
        event.getTime(), //
