    ...
    if (name.equals("vehicle")) {
      ...
      service.addVehicle(
          ImmutableSharingVehicleSpecification.newBuilder() //
              ...
              .startLinkId(
                  attributes.getValue("startLink") == null
                      ? null
                      : Id.createLinkId(attributes.getValue("startLink"))) //
              .startStationId(
                  attributes.getValue("startStation") == null
                      ? null
                      : Id.create(attributes.getValue("startStation"), SharingStation.class)) //
              .build());
