...
/**
 * This is an example of a station-based bike-sharing service siouxfalls-2014 can be used to run the
 * simulation with the provided example input file
 */
public class RunTeleportationBikesharing {
  public static void main(String[] args) throws ConfigurationException {
    ...
    RoutingConfigGroup.TeleportedModeParams bikeRoutingParams =
        new RoutingConfigGroup.TeleportedModeParams("bike");
    ...
    RoutingConfigGroup.TeleportedModeParams walkRoutingParams =
        new RoutingConfigGroup.TeleportedModeParams("walk");
