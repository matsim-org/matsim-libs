...
class NoiseTollCalculator implements TravelDisutility {
  ...
  public double getLinkTravelDisutility(Link link, double time, Person person, Vehicle vehicle) {
    ...
    double timeIntervalEndTime =
        ((int) (time / this.noiseContext.getNoiseParams().getTimeBinSizeNoiseComputation()) + 1)
    ...
    if (this.noiseContext.getTimeInterval2linkId2noiseLinks().get(timeIntervalEndTime) == null
        || this.noiseContext
                .getTimeInterval2linkId2noiseLinks()
                .get(timeIntervalEndTime)
                .get(link.getId())
            == null) {
      ...
      if (isHGV) {
        ...
        if (this.noiseContext.getNoiseParams().getNoiseAllocationApproach()
            == NoiseConfigGroup.NoiseAllocationApproach.AverageCost) {
          linkExpectedToll =
              this.noiseContext
                  .getTimeInterval2linkId2noiseLinks()
                  .get(timeIntervalEndTime)
                  .get(link.getId())
                  .getAverageDamageCostPerVehicle(hgv);

        } else if (this.noiseContext.getNoiseParams().getNoiseAllocationApproach()
          ...
          linkExpectedToll =
              this.noiseContext
                  ...
                  .get(timeIntervalEndTime)
                  .get(link.getId())
                  .getMarginalDamageCostPerVehicle(hgv);
        ...
        if (this.noiseContext.getNoiseParams().getNoiseAllocationApproach()
          ...
          linkExpectedToll =
              this.noiseContext
                  ...
                  .get(timeIntervalEndTime)
                  .get(link.getId())
                  .getAverageDamageCostPerVehicle(car);
          ...
          linkExpectedToll =
              this.noiseContext
                  ...
                  .get(timeIntervalEndTime)
                  .get(link.getId())
                  .getMarginalDamageCostPerVehicle(car);
    ...
    double linkExpectedTollDisutility =
        this.noiseContext.getNoiseParams().getNoiseTollFactor() * linkExpectedToll;
