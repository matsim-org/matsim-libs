...
public interface NoiseEmission {
  ...
  /**
   * Trigegrs the calculation of noise emission for the current time bin at the link. The method is
   * not expected to return the emission but should use the methods provided in {@link
   * NoiseReceiverPoint} to set emission values.
   *
