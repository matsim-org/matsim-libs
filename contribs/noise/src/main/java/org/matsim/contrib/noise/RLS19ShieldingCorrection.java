...
public class RLS19ShieldingCorrection implements ShieldingCorrection {
  ...
  public double calculateShieldingCorrection(double s, double a, double b, double c) {
    /**
     * Shielding value (Schirmwert) z: the difference between length of the way from the emission
     * source via the obstacle to the immission receiver point and direct distance between emission
     * source and immission receiver point ~ i.e. the additional length that sound has to propagate
