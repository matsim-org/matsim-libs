...
public final class NoiseEventCaused extends Event {
  ...
  public static final String EVENT_TYPE = "noiseEventCaused";

  public static final String ATTRIBUTE_TIME_BIN = "timeBinEndTime";
  public static final String ATTRIBUTE_ENTERING_TIME = "linkEnteringTime";
  public static final String ATTRIBUTE_LINK_ID = "linkId";
  public static final String ATTRIBUTE_VEHICLE_ID = "causingVehicleId";
  public static final String ATTRIBUTE_AGENT_ID = "causingAgentId";
  ...
  public NoiseEventCaused(
      double time,
      double timeBinEndTime,
      double linkEnteringTime,
      Id<Person> causingAgentId,
      Id<Vehicle> causingVehicleId,
      double amount,
      Id<Link> linkId) {
    super(time);
