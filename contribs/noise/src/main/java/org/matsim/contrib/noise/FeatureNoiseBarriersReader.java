...
class FeatureNoiseBarriersReader {
  ...
  private static final Logger logger = LogManager.getLogger(FeatureNoiseBarriersReader.class);
  ...
  public static Collection<FeatureNoiseBarrierImpl> read(
      String path, String sourceCrs, String targetCrs) {
    ...
    while (features.hasNext()) {
      ...
      for (Polygon polygon : polygons) {
        ...
        FeatureNoiseBarrierImpl noiseBarrier =
            new FeatureNoiseBarrierImpl(id, transformedPolygon, height);
        if (Double.isNaN(polygon.getCentroid().getX())
            || Double.isNaN(polygon.getCentroid().getY())) {
