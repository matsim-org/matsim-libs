...
/**
 * Contains the relevant information for a single link, i.e. time-specific data such as number of
 * vehicles, noise emission or damages.
 *
 * @author ikaddoura
 */
final class NoiseLink {
  ...
  synchronized void addMarginalDamageCostPerVehicle(
      NoiseVehicleType type, double marginalDamageCostPerVehicle) {
