...
public class NoiseReceiverPoints implements Map<Id<ReceiverPoint>, NoiseReceiverPoint> {
  ...
  public void replaceAll(
      BiFunction<
              ? super Id<ReceiverPoint>, ? super NoiseReceiverPoint, ? extends NoiseReceiverPoint>
          function) {
  ...
  public boolean replace(
      Id<ReceiverPoint> key, NoiseReceiverPoint oldValue, NoiseReceiverPoint newValue) {
  ...
  @Override
  public NoiseReceiverPoint computeIfAbsent(
      Id<ReceiverPoint> key,
      Function<? super Id<ReceiverPoint>, ? extends NoiseReceiverPoint> mappingFunction) {
    return delegate.computeIfAbsent(key, mappingFunction);
  }

  @Override
  public NoiseReceiverPoint computeIfPresent(
      Id<ReceiverPoint> key,
      BiFunction<
              ? super Id<ReceiverPoint>, ? super NoiseReceiverPoint, ? extends NoiseReceiverPoint>
          remappingFunction) {
  ...
  @Override
  public NoiseReceiverPoint compute(
      Id<ReceiverPoint> key,
      BiFunction<
              ? super Id<ReceiverPoint>, ? super NoiseReceiverPoint, ? extends NoiseReceiverPoint>
          remappingFunction) {
  ...
  @Override
  public NoiseReceiverPoint merge(
      Id<ReceiverPoint> key,
      NoiseReceiverPoint value,
      BiFunction<
              ? super NoiseReceiverPoint, ? super NoiseReceiverPoint, ? extends NoiseReceiverPoint>
          remappingFunction) {
