...
public class T6_Transit {
	...
	private void createPopulation() {
		...
		{ // person 1
			...
			Activity act2 = (Activity) pb.createActivityFromLinkId("pt interaction", stop3.getLinkId());
			...
			Activity act3 = (Activity) pb.createActivityFromLinkId("pt interaction", stop6.getLinkId());
		...
		{ // person 3
			...
			Activity act2 = (Activity) pb.createActivityFromLinkId("pt interaction", stop4.getLinkId());
