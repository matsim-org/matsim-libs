...
/**
 * OTFAgentsListHandler is responsible for the IO of the agent's data in case of a mvi file
 * converted from an events-file.
 *
 * @author david
 */
public class OTFAgentsListHandler extends OTFDataReader {
  ...
  public static class Writer extends OTFDataWriter<VisData> {
    ...
    private static void writeAgent(AgentSnapshotInfo agInfo, ByteBuffer out) {
      ...
      Point2D.Double point =
          OTFServerQuadTree.transform(new Coord(agInfo.getEasting(), agInfo.getNorthing()));
