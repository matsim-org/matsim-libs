...
/**
 * The OTFClientQuad is a QuadTree holding OTFDataReads objects. It mirrors the OTFServerQuad on the
 * server side of the OTFVis exactly. It has several Executor classes defined for invalidating
 * reading and creading the Quad.
 *
 * @author dstrippgen
 */
