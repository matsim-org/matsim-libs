...
/**
 * InfoText is the class behind all text displayed in the OPenGL context. Texts can be either drawn
 * for one tick only or reside permanent until removal.
 *
 * @author dstrippgen
 */
public class InfoText implements Serializable {
  ...
  public void draw(TextRenderer renderer, GLAutoDrawable drawable, Rect rect) {
    ...
    renderer.draw(
        text, (int) ((x - rect.minX) * widthRatio), (int) ((y - rect.minY) * heightRatio));
