...
/**
 * OTFScaleBarDrawer draws a scale bar as an overlay. It depends on the chosen coordinates being in
 * meters.
 *
 * @author laemmel
 */
class OTFScaleBarDrawer implements GLEventListener {
  ...
  public void init(GLAutoDrawable glAutoDrawable) {
    ...
    this.back =
        GLUtils.createTexture(gl, getClass().getResourceAsStream("/res/otfvis/sb_background.png"));
  ...
  private float[] getOGLPos(int x, int y) {
    ...
    glu.gluProject(
        ...
        0);
    glu.gluUnProject(
        winX, winY, w_pos[2], this.modelview, 0, this.projection, 0, this.viewport, 0, obj_pos, 0);
