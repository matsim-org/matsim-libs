...
public class TwoLinesDemo {
  ...
  private void createNetwork() {
    ...
    double x3 = -2000;
    Node node1 =
        NetworkUtils.createAndAddNode(network, Id.create(1, Node.class), new Coord(x3, (double) 0));
    double x2 = -2000;
    Node node2 =
        NetworkUtils.createAndAddNode(
            network, Id.create(2, Node.class), new Coord(x2, (double) 1000));
    double x1 = -1000;
    Node node3 =
        NetworkUtils.createAndAddNode(network, Id.create(3, Node.class), new Coord(x1, (double) 0));
    double x = -1000;
    Node node4 =
        NetworkUtils.createAndAddNode(
            network, Id.create(4, Node.class), new Coord(x, (double) 1000));
    Node node5 =
        NetworkUtils.createAndAddNode(
            network, Id.create(5, Node.class), new Coord((double) 0, (double) 0));
    Node node6 =
        NetworkUtils.createAndAddNode(
            network, Id.create(6, Node.class), new Coord((double) 0, (double) 1000));
    Node node7 =
        NetworkUtils.createAndAddNode(
            network, Id.create(7, Node.class), new Coord((double) 500, (double) 500));
    Node node8 =
        NetworkUtils.createAndAddNode(
            network, Id.create(8, Node.class), new Coord((double) 1500, (double) 500));
    Node node9 =
        NetworkUtils.createAndAddNode(
            network, Id.create(9, Node.class), new Coord((double) 2500, (double) 500));
    Node node10 =
        NetworkUtils.createAndAddNode(
            network, Id.create(10, Node.class), new Coord((double) 3500, (double) 500));
    Node node11 =
        NetworkUtils.createAndAddNode(
            network, Id.create(11, Node.class), new Coord((double) 4000, (double) 0));
    Node node12 =
        NetworkUtils.createAndAddNode(
            network, Id.create(12, Node.class), new Coord((double) 4000, (double) 1000));
    Node node13 =
        NetworkUtils.createAndAddNode(
            network, Id.create(13, Node.class), new Coord((double) 5000, (double) 0));
    Node node14 =
        NetworkUtils.createAndAddNode(
            network, Id.create(14, Node.class), new Coord((double) 5000, (double) 1000));
    ...
    NetworkUtils.createAndAddLink(
        network, Id.create(3, Link.class), fromNode2, toNode2, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode3 = node4;
    final Node toNode3 = node6;
    NetworkUtils.createAndAddLink(
        network, Id.create(4, Link.class), fromNode3, toNode3, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode4 = node5;
    final Node toNode4 = node7;
    NetworkUtils.createAndAddLink(
        network, Id.create(5, Link.class), fromNode4, toNode4, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode5 = node6;
    final Node toNode5 = node7;
    NetworkUtils.createAndAddLink(
        network, Id.create(6, Link.class), fromNode5, toNode5, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode6 = node7;
    final Node toNode6 = node8;
    NetworkUtils.createAndAddLink(
        network, Id.create(7, Link.class), fromNode6, toNode6, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode7 = node8;
    final Node toNode7 = node9;
    NetworkUtils.createAndAddLink(
        network, Id.create(8, Link.class), fromNode7, toNode7, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode8 = node9;
    final Node toNode8 = node10;
    NetworkUtils.createAndAddLink(
        network, Id.create(9, Link.class), fromNode8, toNode8, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode9 = node10;
    final Node toNode9 = node12;
    NetworkUtils.createAndAddLink(
        network, Id.create(10, Link.class), fromNode9, toNode9, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode10 = node10;
    final Node toNode10 = node11;
    NetworkUtils.createAndAddLink(
        network, Id.create(11, Link.class), fromNode10, toNode10, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode11 = node12;
    final Node toNode11 = node14;
    NetworkUtils.createAndAddLink(
        network, Id.create(12, Link.class), fromNode11, toNode11, 1000.0, 10.0, 3600.0, (double) 1);
    final Node fromNode12 = node11;
    final Node toNode12 = node13;
    NetworkUtils.createAndAddLink(
        network, Id.create(13, Link.class), fromNode12, toNode12, 1000.0, 10.0, 3600.0, (double) 1);
  }
  ...
  private void createTransitSchedule() {
    ...
    TransitStopFacility stop1 =
        builder.createTransitStopFacility(
            Id.create(1, TransitStopFacility.class), new Coord(x1, y), false);
    double x = -100;
    TransitStopFacility stop2 =
        builder.createTransitStopFacility(
            Id.create(2, TransitStopFacility.class), new Coord(x, (double) 850), false);
    TransitStopFacility stop3 =
        builder.createTransitStopFacility(
            Id.create(3, TransitStopFacility.class), new Coord((double) 1400, (double) 450), false);
    TransitStopFacility stop4 =
        builder.createTransitStopFacility(
            Id.create(4, TransitStopFacility.class), new Coord((double) 3400, (double) 450), false);
    TransitStopFacility stop5 =
        builder.createTransitStopFacility(
            Id.create(5, TransitStopFacility.class), new Coord((double) 3900, (double) 50), false);
    TransitStopFacility stop6 =
        builder.createTransitStopFacility(
            Id.create(6, TransitStopFacility.class), new Coord((double) 3900, (double) 850), false);
    ...
    NetworkRoute networkRoute =
        RouteUtils.createLinkNetworkRouteImpl(link1.getId(), link13.getId());
    ...
    tRoute1.addDeparture(
        builder.createDeparture(Id.create(1, Departure.class), Time.parseTime("07:00:00")));
    tRoute1.addDeparture(
        builder.createDeparture(Id.create(2, Departure.class), Time.parseTime("07:05:00")));
    tRoute1.addDeparture(
        builder.createDeparture(Id.create(3, Departure.class), Time.parseTime("07:10:00")));
    tRoute1.addDeparture(
        builder.createDeparture(Id.create(4, Departure.class), Time.parseTime("07:15:00")));
    tRoute1.addDeparture(
        builder.createDeparture(Id.create(5, Departure.class), Time.parseTime("07:20:00")));
    tRoute1.addDeparture(
        builder.createDeparture(Id.create(6, Departure.class), Time.parseTime("07:25:00")));
    ...
    TransitRoute tRoute2 =
        builder.createTransitRoute(Id.create(1, TransitRoute.class), networkRoute, stopList, "bus");
    tLine2.addRoute(tRoute2);

    tRoute2.addDeparture(
        builder.createDeparture(Id.create(1, Departure.class), Time.parseTime("07:02:00")));
    tRoute2.addDeparture(
        builder.createDeparture(Id.create(2, Departure.class), Time.parseTime("07:12:00")));
    tRoute2.addDeparture(
        builder.createDeparture(Id.create(3, Departure.class), Time.parseTime("07:22:00")));
  ...
  private void createPopulation() {
    ...
    TransitStopFacility stop1 =
        schedule.getFacilities().get(Id.create(1, TransitStopFacility.class));
    /*TransitStopFacility stop2 =*/ schedule
        .getFacilities()
        .get(Id.create(2, TransitStopFacility.class));
    TransitStopFacility stop3 =
        schedule.getFacilities().get(Id.create(3, TransitStopFacility.class));
    TransitStopFacility stop4 =
        schedule.getFacilities().get(Id.create(4, TransitStopFacility.class));
    /*TransitStopFacility stop5 =*/ schedule
        .getFacilities()
        .get(Id.create(5, TransitStopFacility.class));
    TransitStopFacility stop6 =
        schedule.getFacilities().get(Id.create(6, TransitStopFacility.class));
    ...
    { // person 1
      ...
      Activity act2 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              null, Id.create(3, Link.class), TransportMode.pt);
      ...
      Activity act3 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              null, Id.create(6, Link.class), TransportMode.pt);
  ...
  private void runSim() {
    ...
    TransitRoute route2 =
        this.scenario
            .getTransitSchedule()
            .getTransitLines()
            .get(Id.create(2, TransitLine.class))
            .getRoutes()
            .get(Id.create(1, TransitRoute.class));
    ...
    OnTheFlyServer server =
        OTFVis.startServerAndRegisterWithQSim(scenario.getConfig(), scenario, events, sim);
