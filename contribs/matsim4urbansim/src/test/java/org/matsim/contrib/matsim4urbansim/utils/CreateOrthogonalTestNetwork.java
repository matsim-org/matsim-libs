...
public class CreateOrthogonalTestNetwork {
	...
	public static NetworkImpl createOrthogonalDistanceTestNetwork() {
		...
		Node node2 = NetworkUtils.createAndAddNode2(network, Id.create(2, Node.class), new Coord((double) 0, (double) 0));
		Node node3 = NetworkUtils.createAndAddNode2(network, Id.create(3, Node.class), new Coord((double) 0, (double) 375));
		Node node4 = NetworkUtils.createAndAddNode2(network, Id.create(4, Node.class), new Coord((double) 500, (double) 375));
		Node node5 = NetworkUtils.createAndAddNode2(network, Id.create(5, Node.class), new Coord((double) 1000, (double) 375));
