...
public class PopulationMergeTest extends MatsimTestCase{
	...
	public void testPopulationMergeZoneWarmAndHotStart(){
		...
		Person person2 = PopulationUtils.getDefaultFactory().createPerson(Id.create(2, Person.class));
		...
		Person person3 = PopulationUtils.getDefaultFactory().createPerson(Id.create(3, Person.class));
		...
		Person person4 = PopulationUtils.getDefaultFactory().createPerson(Id.create(4, Person.class));
		...
		Person person5 = PopulationUtils.getDefaultFactory().createPerson(Id.create(5, Person.class));
		...
		Person person6 = PopulationUtils.getDefaultFactory().createPerson(Id.create(6, Person.class));
