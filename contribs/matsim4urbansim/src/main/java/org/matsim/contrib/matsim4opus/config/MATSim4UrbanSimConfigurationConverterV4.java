...
//			printPlanCalcRouteGroupSettings();
			...
			checkConfigConsistencyAndWriteToLog(config, "At the end of the matsim4urbansim config converter:") ;
...
//			betaPtLnTMC		= getValueAsDouble(BETA_PT_LN_TRAVEL_MONETARY_COST);
	...
	private static final void checkConfigConsistencyAndWriteToLog(Config config, final String message) {
		log.info(message);
