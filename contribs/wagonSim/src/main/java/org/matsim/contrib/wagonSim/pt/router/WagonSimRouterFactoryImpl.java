 ...
 *
 */
public final class WagonSimRouterFactoryImpl implements TransitRouterFactory{
	...
	public WagonSimRouterFactoryImpl(WagonSimVehicleLoadListener vehLoad, 
		...
		this.config = config;
		this.routerNetwork = createRouterNetwork(this.schedule, this.config.beelineWalkConnectionDistance);
