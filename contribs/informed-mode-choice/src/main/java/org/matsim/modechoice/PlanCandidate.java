...
public final class PlanCandidate implements Comparable<PlanCandidate> {
  ...
  public static String[] createModeArray(String planType) {
    ...
    for (int i = 0; i < modes.length; i++) {
      ...
      if (modes[i].equals("null")) modes[i] = null;
      else modes[i] = modes[i].intern();
    }
  ...
  public String toString() {
    return "PlanCandidate{" + "modes=" + Arrays.toString(modes) + ", utility=" + utility + '}';
  }
}
