...
public class AnalyzeCarChoice implements MATSimAppCommand, PersonAlgorithm {
  ...
  @CommandLine.Mixin private CsvOptions csv = new CsvOptions(CSVFormat.Predefined.TDF);
  ...
  @Inject private ScoringParametersForPerson scoring;
  ...
  public void run(Person person) {
    ...
    for (String m :
        List.of(TransportMode.car, TransportMode.walk, TransportMode.bike, TransportMode.ride)) {
    ...
    double car_cost =
        params.modeParams.get(TransportMode.car).dailyMoneyConstant * params.marginalUtilityOfMoney;
