...
public class InformedModeChoiceConfigGroup extends ReflectiveConfigGroup {
  ...
  private List<String> modes =
      List.of(TransportMode.car, TransportMode.walk, TransportMode.pt, TransportMode.bike);
  ...
  @Parameter
  @Comment(
      "1/beta parameter to trade-off of exploration for alternatives. Parameter of 0 is equal to best choice.")
  ...
  public void setModes(Iterable<String> modes) {
    this.modes =
        StreamSupport.stream(modes.spliterator(), false)
            .map(String::intern)
            .distinct()
  ...
  public Map<String, String> getComments() {
    ...
    comments.put(
        CONFIG_PARAM_MODES, "Defines all modes that are available and open for mode choice.");
    return comments;
  }
