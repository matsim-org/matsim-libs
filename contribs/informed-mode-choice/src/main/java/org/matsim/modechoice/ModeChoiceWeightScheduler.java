...
public final class ModeChoiceWeightScheduler implements StartupListener, IterationStartsListener {
  ...
  public void notifyStartup(StartupEvent event) {
    ...
    if (disableInnovation > 0 && disableInnovation < 1) n *= disableInnovation;
  ...
  public void notifyIterationStarts(IterationStartsEvent event) {
    ...
    if (anneal == InformedModeChoiceConfigGroup.Schedule.off || event.getIteration() == 0) return;
  ...
  public static double anneal(
      InformedModeChoiceConfigGroup.Schedule schedule, double t_0, double n, double k) {
