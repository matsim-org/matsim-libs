...
public final class MinMaxEstimate {
  ...
  /**
   * Create a new maximum estimate. This is the default when only one estimate can be provided. An
   * estimate should never overestimate the costs, i.e. never underestimate the utility. This should
   * therefore return the maximum achievable utility.
   */
