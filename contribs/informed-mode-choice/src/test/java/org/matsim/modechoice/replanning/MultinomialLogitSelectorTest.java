...
public class MultinomialLogitSelectorTest {
  ...
  public void selection() {
    ...
    assertThat(sample).containsExactly(0.51, 0.306, 0.184);
    ...
    assertThat(sample).containsExactly(0.491, 0.323, 0.186);
    ...
    assertThat(sample).containsExactly(0.42304, 0.42012, 0.15684);
  }
  ...
  public void invariance() {
    ...
    assertThat(sample1).containsExactly(0.50819, 0.30373, 0.18808);
    assertThat(sample2).containsExactly(0.50656, 0.30717, 0.18627);
    assertThat(sample3).containsExactly(0.50239, 0.30943, 0.18818);
  }
  ...
  public void single() {
    ...
    List<PlanCandidate> candidates = List.of(new PlanCandidate(new String[] {"car"}, 1.));
