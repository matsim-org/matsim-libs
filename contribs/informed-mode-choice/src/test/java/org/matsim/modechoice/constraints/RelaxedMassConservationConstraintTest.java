...
public class RelaxedMassConservationConstraintTest {
  ...
  public void cycle() {
    ...
    RelaxedMassConservationConstraint.Context context =
        constraint.getContext(new EstimatorContext(person, null), PlanModel.newInstance(plan));
    ...
    assert constraint.isValid(
        context, new String[] {"walk", "bike", "bike", "bike", "bike", "walk"});
    assert constraint.isValid(
        context, new String[] {"walk", "walk", "bike", "bike", "walk", "walk"});
  }
