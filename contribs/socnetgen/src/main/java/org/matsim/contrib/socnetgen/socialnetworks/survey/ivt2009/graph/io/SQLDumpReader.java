...
import org.matsim.contrib.socnetgen.socialnetworks.survey.ivt2009.graph.io.AlterTableReader.VertexRecord;
...
//			return "often";
	...
	private Map<String, String> loadCountries() {
		try {
			InputStream stream = ClassLoader.getSystemResourceAsStream("org/matsim/contrib/socnetgen/socialnetworks/survey/ivt2009/graph/io/countries.txt");
