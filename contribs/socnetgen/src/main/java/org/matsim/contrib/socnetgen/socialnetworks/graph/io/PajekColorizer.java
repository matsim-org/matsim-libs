 ...
 * 
 */
package org.matsim.contrib.socnetgen.socialnetworks.graph.io;
...
public abstract class PajekColorizer<V extends Vertex, E extends Edge> {
	...
	private static class PajekColorTable {
		...
		public PajekColorTable() {
			try {
				InputStream stream = ClassLoader.getSystemResourceAsStream("org/matsim/contrib/socnetgen/socialnetworks/graph/io/PajekColorTable");
