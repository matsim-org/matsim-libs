...
public final class ReceiverConfigGroup extends ReflectiveConfigGroup {
  ...
  static final String ELEMENT_COSTSHARING = "collaboration";
  static final String ELEMENT_RECEIVER_FILE = "receiversFile";
  static final String ELEMENT_CARRIERS_FILE = "carriersFile";
  static final String ELEMENT_NONCOLLABORATING_FEE = "noncollaboratingFee";
  static final String ELEMENT_CREATE_PNG = "createPNG";
  static final String ELEMENT_REPLANNING_TYPE = "replanningModules";

  private String RECEIVERS_FILE = "./receivers.xml.gz";
  // (I converted this from "default" & static to private and non-static: static non-final
  // non-private variables often eventually cause problems.  kai, apr'23)
  ...
  public Map<String, String> getComments() {
    ...
    comments.put(
        ELEMENT_COSTSHARING,
        "The mechanism by which the carriers' costs are shared among receivers. "
    ...
    comments.put(
        ELEMENT_NONCOLLABORATING_FEE,
        "The fixed fee charged per receiver NOT collaborating in a coalition.");
    comments.put(ELEMENT_CREATE_PNG, "Should PNG output be created? Default is 'true'");
    comments.put(
        ELEMENT_REPLANNING_TYPE,
        "Replanning strategy used. Available values are 'serviceTime' (default), "
            + "'timeWindow' and 'deliveryFrequency'.");
    return comments;
  }

  //    @StringGetter(RECEIVER_FILE)
  // Here and elsewhere I commented out the StringSetter/Getter stuff.  This makes the config
  // accessible only from code.  Makes it easier to
  ...
  // I would prefer to have "createPNG" as an enum ... allows to add options later (such als
  // "createLotsOfPngs", "createSomePngs" etc.)
