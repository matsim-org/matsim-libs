...
/**
 * Changes the delivery frequency of a receiver and calculates new order sizes for the receiver.
 *
 * @author wlbean
 */
public class OrderSizeMutator implements GenericPlanStrategyModule<ReceiverPlan> {
  ...
  /**
   * This class changes the delivery frequency of a receiver by either increasing (if increase is
   * true) or decreasing (if increase is false) the weekly delivery frequency with one day.
   *
   * @param increase
   */
