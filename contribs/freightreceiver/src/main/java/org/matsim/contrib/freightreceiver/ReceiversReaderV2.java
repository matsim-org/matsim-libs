...
class ReceiversReaderV2 extends MatsimXmlParser implements MatsimReader {
  private static final String RECEIVERS = "freightReceivers";
  ...
  private static final String REORDER_POLICY = "reorderPolicy";
  private static final String PLAN = "plan";
  private static final String ORDER = "order";
  private static final String ITEM = "item";

  private static final String ATTR_RECEIVERS_DESC = "desc";
  private static final String ATTR_PRODUCT_TYPE_ID = "id";
  private static final String ATTR_PRODUCT_TYPE_ORIGIN_LINK_ID = "originLinkId";
  private static final String ATTR_PRODUCT_TYPE_DESC = "descr";
  private static final String ATTR_PRODUCT_TYPE_WEIGHT = "weight";
  private static final String ATTR_RECEIVER_ID = "id";
  private static final String ATTR_RECEIVER_LINK_ID = "linkId";
  private static final String ATTR_TIME_WINDOW_START = "start";
  private static final String ATTR_TIME_WINDOW_END = "end";
  private static final String ATTR_PRODUCT_ID = "id";
  private static final String ATTR_PRODUCT_ON_HAND = "onHand";
  private static final String ATTR_REORDER_POLICY_NAME = "name";
  private static final String ATTR_PLAN_SCORE = "score";
  private static final String ATTR_PLAN_SELECTED = "selected";
  private static final String ATTR_ORDER_CARRIER = "carrierId";
  private static final String ATTR_ITEM_ID = "id";
  // private final static String ATTR_ITEM_NAME = "name";
  private static final String ATTR_ITEM_PRODUCT = "productId";
  private static final String ATTR_ITEM_QUANTITY = "quantity";
  // private final static String ATTR_ITEM_DAILYQUANTITY = "dailyQuantity";
  private static final String ATTR_ITEM_SERVICE_TIME = "serviceTime";
  ...
  private void startProduct(Attributes atts) {
    ...
    currentProductBuilder
        .setProductType(receivers.getProductType(Id.create(id, ProductType.class)))
        .setStockOnHand(onHand);
  }
  ...
  private void startPlan(Attributes atts) {
    ...
    Object oStatus =
        currentReceiver.getAttributes().getAttribute(CollaborationUtils.ATTR_COLLABORATION_STATUS);
    assert oStatus != null;
  ...
  private void endOrder() {
    ReceiverOrder order =
        new ReceiverOrder(currentReceiver.getId(), currentOrders, currentOrderCarrierId);
  ...
  private void startItem(Attributes atts) {
    ...
    if (pt == null) {
      throw new IllegalArgumentException(
          "Cannot link the order item \"" + productId.toString() + "\" to a known product type.");
    }
