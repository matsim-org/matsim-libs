...
public final class ReceiversWriter extends MatsimXmlWriter implements MatsimWriter {
  private final Logger log = LogManager.getLogger(ReceiversWriter.class);
  ...
  private void sharedCodeBetweenV1andV2(String filename, String dtd, ReceiversWriterHandler handler)
      throws IOException {
    openFile(filename);
    writeXmlHead();
