...
/**
 * This class implements a receiver reorder strategy that changes the number of weekly deliveries
...

    {
      GenericPlanStrategyImpl<ReceiverPlan, Receiver> strategy =
          new GenericPlanStrategyImpl<>(
              new ExpBetaPlanChanger.Factory<ReceiverPlan, Receiver>().setBetaValue(10.0).build());
