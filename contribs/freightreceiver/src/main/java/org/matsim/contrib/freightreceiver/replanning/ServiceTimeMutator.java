...
final class ServiceTimeMutator implements GenericPlanStrategyModule<ReceiverPlan> {
  ...
  /**
   * This class changes the service time of a receivers' orders with the specified time. If {@link
   * #increase} is true, the service time will increase until the max allowed duration is reached.
   * Conversely, if increase is false, the service time will decrease until the minimum duration is
   * reached.
   */
