...
public class UsecasesCarrierScoringFunctionFactory implements CarrierScoringFunctionFactory {
  ...
  static class DriversLegScoring
    ...
    private CarrierVehicle getVehicle(Id<Vehicle> vehicleId) {
      ...
      log.error(
          "Vehicle with Id does not exists",
          new IllegalStateException("vehicle with id " + vehicleId + " is missing"));
      return null;
    }
    ...
    public void handleLeg(Leg leg) {
      if (leg.getRoute() instanceof NetworkRoute) {
        ...
        if (vehicle == null)
          throw new IllegalStateException("vehicle with id " + vehicleId + " is missing");
