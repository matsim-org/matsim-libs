...
/**
 * Second version of the freight receivers XML writer. The only difference is
 * that the register of product types now require the link Id to be set as well.
 *
 * @author jwjoubert
 */
 class ReceiversWriterHandlerImplV2 implements ReceiversWriterHandler {
	...
	public void startProduct(ProductType productType, BufferedWriter out) throws IOException {
		...
		out.write(productType.getOriginLinkId().toString());
		out.write("\" descr=\"");
