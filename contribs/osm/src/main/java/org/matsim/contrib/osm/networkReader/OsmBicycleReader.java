...
public final class OsmBicycleReader extends SupersonicOsmNetworkReader {
	...
	public OsmBicycleReader(OsmNetworkParser parser,
							...
							AfterLinkCreated afterLinkCreated, boolean adjustFreeSpeed) {
		super(parser, preserveNodeWithId, includeLinkAtCoordWithHierarchy, (link, tags, direction) -> handleLink(link, tags, direction, afterLinkCreated), adjustFreeSpeed);
	...
	public static class Builder extends AbstractBuilder<OsmBicycleReader> {
		...
		OsmBicycleReader createInstance() {
			...
			return new OsmBicycleReader(parser, preserveNodeWithId, includeLinkAtCoordWithHierarchy, afterLinkCreated, adjustFreeSpeed);
		}
	}
}
