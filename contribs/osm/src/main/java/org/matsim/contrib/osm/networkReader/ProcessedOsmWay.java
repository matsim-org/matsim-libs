...
class ProcessedOsmWay {
  ...
  public ProcessedOsmWay(
      long id, TLongArrayList nodeIds, Map<String, String> tags, LinkProperties linkProperties) {
    this.id = id;
  ...
  static ProcessedOsmWay create(
      OsmWay osmWay, Map<String, String> tags, LinkProperties linkProperties) {

    return new ProcessedOsmWay(osmWay.getId(), copyNodeIds(osmWay), tags, linkProperties);
  }
