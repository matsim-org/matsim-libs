...
public class OsmBicycleReaderTest {
  ...
  public void test_singleLinkPrimaryWithSurfaceAsphalt() {
    ...
    List<OsmTag> tags = Collections.singletonList(new Tag(OsmTags.HIGHWAY, OsmTags.PRIMARY));
    Utils.OsmData singleLink = Utils.createSingleLink(tags);
  ...
  public void test_singleLinkWithBicycleNotAllowed() {
    ...
    List<OsmTag> tags = Collections.singletonList(new Tag(OsmTags.HIGHWAY, OsmTags.MOTORWAY));
    Utils.OsmData singleLink = Utils.createSingleLink(tags);
  ...
  public void test_singleLinkWithOnlyBicycleAllowed() {
    ...
    List<OsmTag> tags = Collections.singletonList(new Tag(OsmTags.HIGHWAY, OsmTags.PEDESTRIAN));
    Utils.OsmData singleLink = Utils.createSingleLink(tags);
  ...
  public void test_builderDoesntOverrideLinkProperties() {
    ...
    var network =
        new OsmBicycleReader.Builder()
            ...
            .setLinkProperties(
                new ConcurrentHashMap<>(Map.of(OsmTags.MOTORWAY, LinkProperties.createMotorway())))
            .setCoordinateTransformation(Utils.transformation)
            .build()
            .read(osmFile);
