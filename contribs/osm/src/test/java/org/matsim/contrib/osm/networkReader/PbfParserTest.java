...
public class PbfParserTest {
	...
	public void parse_singleLink() {
		...
		new PbfParser.Builder()
				.setNodeHandler(node -> nodesCounter.getAndIncrement())
				.setWaysHandler(way -> waysCounter.getAndIncrement())
	...
	public void parse_onlyRelations() {
		...
		new PbfParser.Builder()
				.setExecutor(executor)
				.setRelationHandler(relation -> relationsCounter.getAndIncrement())
				.build()
				.parse(file);
