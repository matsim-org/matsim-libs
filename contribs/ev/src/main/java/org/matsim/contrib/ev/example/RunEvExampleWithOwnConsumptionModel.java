  ...
  public void run(String[] args) {
    ...
    Controler controler = new Controler(scenario);
    {
      DriveEnergyConsumption.Factory driveEnergyConsumptionFactory =
          new DriveEnergyConsumption.Factory() {
            @Override
            public DriveEnergyConsumption create(ElectricVehicle electricVehicle) {
              DriveEnergyConsumption.Factory factory =
              ...
              DriveEnergyConsumption consumption =
                  new DriveEnergyConsumption() {
                    @Override
                    public double calcEnergyConsumption(
                        Link link, double travelTime, double linkEnterTime) {

                      // discharge because the link must be driven:
                      double delta =
                          delegate.calcEnergyConsumption(link, travelTime, linkEnterTime);

                      double desiredSocAtEndOfLink =
                          (double)
                              electricVehicle
                      ...
                      // * above will often be negative; this is the purpose: discharging is
                      // negative i.e. we are
                      // charging on the link.  ((This is why I am in general against hiding the
                      // sign in the method
                      // name.  kai))
                      ...
                      // * need to make sure that we are not discharging beyond what is needed to
                      // drive the link
