 ...
 * a person begins a charging activity.
 *
 * <p>Do not use this class for charging DVRP vehicles (DynAgents). In that case, vehicle charging
 * is simulated with ChargingActivity (DynActivity). (It may work together, but that would need to
 * be tested. kai based on michal, dec'22)
 */
public class VehicleChargingHandler
  ...
  public static final String CHARGING_INTERACTION =
      ScoringConfigGroup.createStageActivityType(CHARGING_IDENTIFIER);
