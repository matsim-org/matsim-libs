...
public class HysteresisChargerPower implements ChargerPower {
	...
	static public class Factory implements ChargerPower.Factory {
		...
		@Inject
		public Factory(ChargerPower.Factory delegate, EvConfigGroup configGroup, EventsManager eventsManager) {
			this.delegate = delegate;
			this.chargingPeriod = configGroup.getChargeTimeStep();
			this.eventsManager = eventsManager;
		}

		public Factory(EvConfigGroup config, EventsManager eventsManager) {
			this(new DefaultChargerPower.Factory(config), config, eventsManager);
		}
