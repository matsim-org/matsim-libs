...
public class EvStatsModule extends AbstractModule {
  ...
  public void install() {
        ...
        new AbstractQSimModule() {
          ...
          protected void configureQSim() {
            if (evCfg.timeProfiles) {
              ...
              addQSimComponentBinding(EvModule.EV_COMPONENT)
                  .to(ChargerOccupancyXYDataCollector.class)
                  .asEagerSingleton();
              addQSimComponentBinding(EvModule.EV_COMPONENT)
    ...
    addControlerListenerBinding()
        .toProvider(
            new Provider<>() {
              @Inject private ChargerPowerTimeProfileCalculator calculator;
              ...
              public ControlerListener get() {
                ...
                return new ProfileWriter(
                    matsimServices, "ev", profileView, "charger_power_time_profiles");
              }
            });
  }
}
