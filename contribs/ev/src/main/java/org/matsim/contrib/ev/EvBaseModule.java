...
public class EvBaseModule extends AbstractModule {
  public void install() {
    ...
    {
      // this switches on all the QSimComponents that are registered at various places under
      // EvModule.EV_Component.
      ConfigUtils.addOrGetModule(this.getConfig(), QSimComponentsConfigGroup.class)
          .addActiveComponent(EvModule.EV_COMPONENT);
    }
  }
}
