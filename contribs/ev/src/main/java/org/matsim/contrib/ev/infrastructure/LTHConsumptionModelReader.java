...
/**
 * This class reads Energy consumption files from CSV as used in the IDEAS project between TU Berlin
 * and LTH Lund. CSVs contain a slope (in percent) in rows and columns with speeds in m/s. Values in
 * the table are in kWh
 */
public class LTHConsumptionModelReader {
  ...
  public DriveEnergyConsumption.Factory readURL(URL fileUrl) {
    ...
    return new LTHDriveEnergyConsumption.Factory(
        Doubles.toArray(speeds), Doubles.toArray(slopes), consumptionPerSpeedAndSlope, false);
  }
}
