...
public class DistributedStrategicChargingReservationEngine
	implements DistributedActivityHandler, DistributedMobsimEngine, NotifyAgentPartitionTransfer {

	static public final String PERSON_ATTRIBUTE = StrategicChargingReservationEngine.PERSON_ATTRIBUTE;
	...
	@Inject
	public DistributedStrategicChargingReservationEngine(
