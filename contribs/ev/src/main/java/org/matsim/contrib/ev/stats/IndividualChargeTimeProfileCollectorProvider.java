...
public final class IndividualChargeTimeProfileCollectorProvider
  ...
  @Inject
  IndividualChargeTimeProfileCollectorProvider(
      ElectricFleet evFleet, MatsimServices matsimServices, Config config) {
  ...
  public MobsimListener get() {
    ...
    return new TimeProfileCollector(
        header, calculator, 300, "individual_charge_time_profiles", matsimServices);
  }
}
