...
public final class ElectricFleetUtils {
  ...
  public static void setChargerTypes(
      EngineInformation engineInformation, Collection<String> chargerTypes) {
  ...
  public static ElectricVehicle create(
      ElectricVehicleSpecification vehicleSpecification,
      DriveEnergyConsumption.Factory driveFactory,
      AuxEnergyConsumption.Factory auxFactory,
  ...
  public static void createAndAddVehicleSpecificationsFromMatsimVehicles(
    ...
    vehicles.stream()
        .filter(
            vehicle ->
                EV_ENGINE_HBEFA_TECHNOLOGY.equals(
  ...
  public static ElectricVehicleSpecification createElectricVehicleSpecificationDefaultImpl(
      Vehicle matsimVehicle) {
    return new ElectricVehicleSpecificationDefaultImpl(matsimVehicle);
  }

  public static ElectricFleet createDefaultFleet(
      ElectricFleetSpecification fleetSpecification,
      DriveEnergyConsumption.Factory driveConsumptionFactory,
      AuxEnergyConsumption.Factory auxConsumptionFactory,
      ChargingPower.Factory chargingFactory) {
    ImmutableMap<Id<Vehicle>, ElectricVehicle> vehicles =
