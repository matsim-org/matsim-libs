...
public class GripsConfigReader extends MatsimXmlParser {

	private final static String GRIPS_CONFIG = "grips_config";
	...
	public GripsConfigReader(GripsConfigModule gcm) {
		this.gcm = gcm;
	}
	...
	public void startTag(String name, Attributes atts, Stack<String> context) {
		if (GRIPS_CONFIG.equals(name)) {
			startGripsConfig(atts);
	...
	private void startGripsConfig(Attributes atts) {
		// TODO Auto-generated method stub
	...
	private void setInputFile(String content) {
	...
	public static void main(String [] args){
		...
		GripsConfigReader gcr = new GripsConfigReader(gcm2);
		gcr.parse("/Users/laemmel/devel/hamburg/grips_config.xml");
