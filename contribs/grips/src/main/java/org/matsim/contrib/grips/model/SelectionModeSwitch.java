...
//		this.setBackground(new Color(200,150,200));
		...
		this.setBorder(BorderFactory.createTitledBorder(controller.getLocale().labelSelectionMode()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		//polygon selected
		else if (e.getActionCommand().equals(SelectionMode.POLYGONAL.toString()))
		{
