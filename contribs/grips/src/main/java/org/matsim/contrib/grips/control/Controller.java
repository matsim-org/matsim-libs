...
import org.matsim.contrib.grips.view.Visualizer;
import org.matsim.contrib.grips.view.renderer.AbstractRenderLayer;
import org.matsim.contrib.grips.view.renderer.GridRenderer;
import org.matsim.contrib.grips.view.renderer.ShapeRenderer;
...
//			System.out.println("grips config module:" + this.gripsConfigModule);
			...
			this.setWms(this.gripsConfigModule.getWms());
			this.setLayer(this.gripsConfigModule.getLayer());
	...
	public String getPopDensFilename() {
		return this.getGripsConfigModule().getPopDensFilename();
	}
