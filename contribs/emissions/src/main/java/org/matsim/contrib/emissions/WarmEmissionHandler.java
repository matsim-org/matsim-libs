 ...
 *
 */
public class WarmEmissionHandler implements LinkEnterEventHandler, LinkLeaveEventHandler, PersonArrivalEventHandler, PersonDepartureEventHandler, Wait2LinkEventHandler, VehicleLeavesTrafficEventHandler {
	...
	public void handleEvent(LinkEnterEvent event) {
		Tuple<Id<Link>, Double> linkId2Time = new Tuple<Id<Link>, Double>(event.getLinkId(), event.getTime());
		this.linkenter.put(driverAgents.get(event.getVehicleId()), linkId2Time);
	}
