...
public final class RunDetailedEmissionToolOfflineExample {
  ...
  public static void main(String[] args) {
    RunDetailedEmissionToolOfflineExample emissionToolOfflineExampleV2Vehv1 =
  ...
  public void run() {
    if (config == null) {
      ...
      throw new RuntimeException(
          "having default input is no longer supported; look at regression tests if you need that.  kai, apr'21");
    }
    ...
    EventWriterXML emissionEventWriter =
        new EventWriterXML(
            outputDirectory + RunAverageEmissionToolOfflineExample.emissionEventsFilename);
