...
public final class EmissionsConfigGroup extends ReflectiveConfigGroup {
	...
	public enum EmissionsComputationMethod {StopAndGoFraction,AverageSpeed,InterpolationFraction,BilinearInterpolationFraction}
...
//			+ Arrays.stream(NonScenarioVehicles.values()).map(handling -> " " + handling.toString()).collect(Collectors.joining()) +"."
	...
	public Map<String, String> getComments() {
		...
		map.put(USE_HBEFA_CONSISTENCY_CHECKER, USE_HBEFA_CONSISTENCY_CHECKER_CMT);

		map.put(SUMMARIZE_PM_METHOD, SUMMARIZE_PM_METHOD_CMT);

		map.put(DUPLICATE_SUBSEGMENTS, DUPLICATE_SUBSEGMENTS_CMT);
