...
/**
 * Raster holding (x,y, value) values The data is stored within a double[]. The class only offers
 * convenient methods to access this data by (x,y)-coordinates
 */
public class Raster {
  ...
  /**
   * This iterates over the x and y index of the raster and supplies the corresponding value into
   * the acceptor function At the moment this iteration is done sequentially. But this may change in
   * the future.
   *
  ...
  /**
   * This iterates over the x and y coordinates of the raster and supplies the corresponding value
   * into the acceptor function At the moment this iteration is done sequentially. But this may
  ...
  /**
   * Get the cell size of the raster, which determines the transformation between x,y-coodinates and
   * index
   */
  ...
  /**
   * This iterates over the x and y index of the raster. The iteration is done in parallel. The
   * result of the valueSupplier will be set on the corresponding pixel of the raster. This
   * manipulates the state of the raster. Make sure to not alter the state during the execution of
   * this method from outside.
   *
   * @param valueSupplier Function which takes an x and a y index and supplies a double value which
   *     is written into The corresponding pixel of the raster
   */
