 ...
 *     <p>TestColdEmissionsCase1 looks for Passenger_car, petrol the average
 */
public class TestColdEmissionAnalysisModuleCase1 {

  private static final Logger logger =
      LogManager.getLogger(TestColdEmissionAnalysisModuleCase1.class);
  ...
  public void calculateColdEmissionsAndThrowEventTest_completeData() {
    ...
    final Map<Pollutant, Double> calculatedPollutants =
    ...
    String message =
        "The expected emissions for "
            + testCase1.toString()
            + " are "
            + pollutants.size() * (Double) testCase1.get(4)
            + " but were "
            + sumOfEmissions;
    Assert.assertEquals(
        message,
