...
public class TestHbefaWarmEmissionFactorKey {
  ...
  public final void testEqualsForCompleteKeys() {
    ...
    String message =
        "these two objects should be the same but are not: "
            + normal.toString()
            + " and "
            + compare.toString();
    ...
    message =
        "these two objects should not be the same: "
            + normal.toString()
            + " and "
            + different.toString();
  ...
  public final void testEqualsForIncompleteKeys_roadCategory() {
    ...
    String message =
        "these two HbefaWarmEmissionFactorKeys should not be the same: "
            + normal.toString()
            + " and "
            + noRoadCat.toString();
  ...
  public final void testEqualsForIncompleteKeys_vehicleAttributes() {
    ...
    message =
        "these two HbefaWarmEmissionFactorKeys should be the same: "
            + normal.toString()
            + " and "
            + noVehAtt.toString();
