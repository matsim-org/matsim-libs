...
public class TestHbefaVehicleAttributes {
  ...
  // thus, the equals method should not throw nullpointer exceptions but return false or
  // respectively true
  ...
  public final void testEqualsForIncompleteAttributes_emConcept() {
    ...
    message =
        "no em concept was set, therefore "
            + normal.getHbefaEmConcept()
            + " should not equal "
            + noEmConcept.getHbefaEmConcept();
  ...
  public final void testEqualsForIncompleteAttributes_technology() {
    ...
    message =
        "no technology was set, therefore "
            + normal.getHbefaTechnology()
            + " should not equal "
            + noTechnology.getHbefaTechnology();
    ...
    message =
        "no em concept was set, therefore "
            + noTechnology.getHbefaEmConcept()
            + "should be set to 'average'";
  ...
  public final void testEqualsForIncompleteAttributes_sizeClass() {
    ...
    message =
        "no size class was set, therefore "
            + normal.getHbefaSizeClass()
            + " should not equal "
            + noSize.getHbefaSizeClass();
