 ...
 * @author ikaddoura
 */
public final class AnalysisEventHandler
    implements EventHandler, LinkLeaveEventHandler, PersonEntersVehicleEventHandler {

  private final Map<Id<Link>, Map<Integer, Integer>> linkId2time2leavingAgents = new HashMap<>();
  private final Map<Id<Link>, Map<Integer, List<Id<Person>>>> linkId2time2personIds =
      new HashMap<>();
