...
public class RunInternalizeAccidents {
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length > 0) {
			...
			outputDirectory = "./data/output/be_251/run_onlyBVWP_internalized_1/";
			runId = "run_onlyBVWP_internalized_1";
		...
		RunInternalizeAccidents runner = new RunInternalizeAccidents();
		runner.run();
	}
