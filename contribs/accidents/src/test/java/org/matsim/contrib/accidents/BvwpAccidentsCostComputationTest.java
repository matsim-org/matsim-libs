...
public class BvwpAccidentsCostComputationTest {
	...
	void test1() {
		...
		AccidentCostComputation accidentCostComputation = new AccidentCostComputationBVWP( ConfigUtils.createConfig() );

		double costs = accidentCostComputation.computeAccidentCosts(4820, link1, list);
	...
	void test2() {
		...
		double costs = accidentCostComputation.computeAccidentCosts(1000, link1, list);
