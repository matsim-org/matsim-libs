...
public class RideParkingCostTrackerTest {
  ...
  public void testPersonMoneyEvents() {
    ...
    TeleportedModeParkingCostTracker tracker =
        new TeleportedModeParkingCostTracker(TransportMode.ride, parkingCostConfigGroup);
    ...
    f.scenario
        ...
        .get(linkWork)
        .getAttributes()
        .putAttribute("pc_ride", hourlyParkingCostWork);
    f.scenario
        .getNetwork()
        .getLinks()
        .get(linkShop)
        .getAttributes()
        .putAttribute("pc_ride", hourlyParkingCostShop);
    ...
    f.events.processEvent(
        new ActivityEndEvent(12.00 * 3600, personId, linkWork, null, "work", new Coord(0, 0)));
    ...
    f.events.processEvent(
        new ActivityEndEvent(13.00 * 3600, personId, linkShop, null, "shop", new Coord(0, 0)));
    ...
    f.events.processEvent(
        new ActivityEndEvent(15.00 * 3600, personId, linkShop, null, "home", new Coord(0, 0)));
    Assert.assertEquals(
        11, collector.getEvents().size()); // there should be no parking cost event at home
    ...
    f.events.processEvent(
        new ActivityEndEvent(18.00 * 3600, personId, linkWork, null, "shop", new Coord(0, 0)));
