 ...
 */
public class TeleportedModeParkingCostTracker
    implements PersonArrivalEventHandler, ActivityEndEventHandler {

  private static final Logger log = LogManager.getLogger(MainModeParkingCostVehicleTracker.class);
  ...
  public TeleportedModeParkingCostTracker(
      String mode, ParkingCostConfigGroup parkingCostConfigGroup) {
  ...
  public void handleEvent(ActivityEndEvent event) {
    ...
    if (value instanceof Number n) {
      ...
      log.error(
          "Ride-ParkingCost attribute must be of type Double or Integer, but is of type "
              + value.getClass()
