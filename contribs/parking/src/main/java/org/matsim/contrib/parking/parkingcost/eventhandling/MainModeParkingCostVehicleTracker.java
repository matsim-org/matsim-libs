 ...
 */
public class MainModeParkingCostVehicleTracker
  ...
  public MainModeParkingCostVehicleTracker(
  ...
  public void handleEvent(VehicleEntersTrafficEvent event) {
    if (event.getNetworkMode().equals(trackedMode)) {
      ...
      if (value instanceof Number n) {
        ...
        log.error(
            "ParkingCost attribute must be of type Double or Integer, but is of type "
                + value.getClass()
