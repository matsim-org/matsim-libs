...
/**
 * Often one needs a HashMap, where the value can be incremented and decremented. This data
 * structure provides that facility for integers.
 *
 * <p>TODO: delete this (DoubleValueHashMap can do most of the work here => just add a method there
 * for conversion to id perhaps...)
 *
