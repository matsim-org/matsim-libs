...
public class RentableParking extends PublicParking {
  ...
  public boolean isRentable(double time) {
    return GeneralLib.isIn24HourInterval(
            startRentableTime, endRentableTime, GeneralLib.projectTimeWithin24Hours(time))
        && getAvailableParkingCapacity() > 0;
  }
