...
/**
 * Tracks how many vehicles are in a given area at any time based on {@linkplain
 * VehicleEntersTrafficEvent}s and {@linkplain VehicleLeavesTrafficEvent}s. PT vehicles are excluded
 * by tracking the involved vehicles of all {@linkplain TransitDriverStartsEvent}s. </br>
 *
 * <p>The functionality of the {@linkplain PenaltyGenerator} interface are delegated to the
 * {@linkplain MovingEntityCounter} received in the constructor.
 *
...
final class ParkingVehiclesCountEventHandler
   ...
   *
   * @param carCounter The central part of this class responsible for defining spatial and temporal
   *     resolution
   * @param network The used network. Necessary to look up link-ids
   * @param carWeight the weight of a single car; usually the inverse of the scenario percentage,
   *     i.e. 100 in case of 1pct scenario
   */
  ...
  /**
   * Gets the precise coordinate of a point at a certain percentage of the link's extent. Note: This
   * method currently (07/2019) is used to calculate the position of events, which ALWAYS happen at
   * the end-node of a link and therefore isn't very useful. However, I left it in in case this
