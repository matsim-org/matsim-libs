...
public class ParkingProxyConfigGroup extends ReflectiveConfigGroup {
  ...
  public static enum Iter0Method {
    noPenalty,
    hourPenalty,
    takeFromAttributes,
    estimateFromPlans
  ...
  public Map<String, String> getComments() {
    ...
    comments.put(
        SCALE_FACTOR,
        "The inverse of the scenario perentage, i.e. the number with which to multiply the"
    ...
    comments.put(
        DELAY_PER_CAR, "in seconds. Note that this should be scaled MANUALLY with the gridsize!");
    comments.put(
        MAX_DELAY, "in seconds. Note that this should be scaled MANUALLY with the gridsize!");
