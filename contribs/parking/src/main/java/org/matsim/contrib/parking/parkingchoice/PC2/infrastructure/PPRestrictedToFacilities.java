...
// people performing activities at facilities, which are mentioned in HashSet facility Ids, can use
// this parking.
public class PPRestrictedToFacilities extends PublicParking implements PrivateParking {

  public PPRestrictedToFacilities(
      Id<PC2Parking> id,
      int capacity,
      Coord coord,
      ParkingCostModel parkingCostModel,
      String groupName,
      HashSet<Id<ActivityFacility>> facilityIds) {
