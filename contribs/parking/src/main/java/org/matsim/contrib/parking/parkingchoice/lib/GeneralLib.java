...
public class GeneralLib {
  ...
  public static double projectTimeWithin24Hours(double time) {
    ...
    if (time == Double.NEGATIVE_INFINITY || time == Double.POSITIVE_INFINITY) {
      throw new Error(
          "system is in inconsistent state: " + "time is not allowed to be minus or plus infinity");
    }
   ...
   * @return
   */
  public static boolean isIn24HourInterval(
      double startIntervalTime, double endIntervalTime, double timeToCheck) {
