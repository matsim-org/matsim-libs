...
/**
 * Uses a linear raise in penalty time per car but stays between 0 and a maximum value. In
 * mathematical terms this means: </br> {@code P = [ 0 if c<0; r*c if 0<=c<=c_m; m if c>c_m},</br>
