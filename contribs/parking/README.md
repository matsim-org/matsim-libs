...
VSP 2026 ... when VehicleLeavesTraffic, then parking search time is estimated, and vehicle does not parking until this time is up.  (Is symmetrical to link departure queue.) {@link ParkingTest}.
