...
- Parking Parameterization: Parameterizes the parking search time on links. Is based on the occupancy within a certain area.
...
Parking Parameterization ... when VehicleLeavesTraffic, then parking search time is estimated, and vehicle does not parking until this time is up.  (Is symmetrical to link departure queue.) {@link ParkingTest}.
