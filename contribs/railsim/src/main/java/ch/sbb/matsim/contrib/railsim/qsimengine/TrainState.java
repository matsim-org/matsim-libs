...
final class TrainState {
  ...
  @Nullable final RailsimTransitDriverAgent pt;

  /** Next transit stop. */
  @Nullable TransitStopFacility nextStop;
  ...
  /**
   * Current allowed speed, which depends on train type, links, but not on other trains or speed
   * needed to stop.
   */
