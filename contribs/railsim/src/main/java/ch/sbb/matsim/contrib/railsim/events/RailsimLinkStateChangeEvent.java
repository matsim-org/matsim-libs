...
/**
 * Event thrown when the {@link ch.sbb.matsim.contrib.railsim.qsimengine.TrackState} of a {@link
 * Link} changes.
 */
public final class RailsimLinkStateChangeEvent extends Event implements HasLinkId, HasVehicleId {
  ...
  public RailsimLinkStateChangeEvent(
      double time, Id<Link> linkId, Id<Vehicle> vehicleId, TrackState state, int track) {
    super(time);
    this.linkId = linkId;
