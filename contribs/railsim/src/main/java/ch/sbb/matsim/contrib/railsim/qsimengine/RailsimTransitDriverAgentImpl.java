...
public final class RailsimTransitDriverAgentImpl extends TransitDriverAgentImpl implements RailsimTransitDriverAgent {
	...
	public RailsimTransitDriverAgentImpl(Map<Id<TransitStopArea>, List<TransitStopFacility>> stopAreas, Umlauf umlauf, String transportMode, TransitStopAgentTracker thisAgentTracker, InternalInterface internalInterface) {
