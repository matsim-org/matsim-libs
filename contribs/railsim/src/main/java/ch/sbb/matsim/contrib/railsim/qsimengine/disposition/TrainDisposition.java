...
public interface TrainDisposition {
   ...
   */
  @Nullable
  default List<RailLink> requestRoute(
      double time,
  ...
  /**
   * Inform the resource manager that the train has passed a link that can now be unblocked. This
   * needs to be called after track states have been updated already.
   */
