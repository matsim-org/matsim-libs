...
public final class RailsimCsvWriter {
  ...
  public static void writeLinkStatesCsv(List<RailsimLinkStateChangeEvent> events, String filename)
  ...
  public static void writeTrainStatesCsv(
      List<RailsimTrainStateEvent> events, Network network, String filename)
      throws UncheckedIOException {
    String[] header = {
      "vehicle",
      "time",
