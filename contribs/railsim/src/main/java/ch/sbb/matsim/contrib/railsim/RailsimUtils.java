...
public final class RailsimUtils {
  ...
  /**
   * Return the minimum time for the switch at the end of the link (toNode); if no link attribute is
  ...
  public static double getTrainDeceleration(
      VehicleType vehicle, RailsimConfigGroup railsimConfigGroup) {
  ...
  public static double getTrainAcceleration(
      VehicleType vehicle, RailsimConfigGroup railsimConfigGroup) {
