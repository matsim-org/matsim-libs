...
public class SBBTransitConfigGroup extends ReflectiveConfigGroup {
  ...
  public static final String GROUP_NAME = "SBBPt";

  private static final String PARAM_DETERMINISTIC_SERVICE_MODES = "deterministicServiceModes";
  private static final String PARAM_CREATE_LINK_EVENTS_INTERVAL = "createLinkEventsInterval";
  ...
  public Map<String, String> getComments() {
    ...
    comments.put(
        PARAM_DETERMINISTIC_SERVICE_MODES,
