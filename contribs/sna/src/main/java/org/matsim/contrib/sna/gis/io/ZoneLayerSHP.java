 ...
 *                                                                         *
 * *********************************************************************** */
package org.matsim.contrib.sna.gis.io;
...
public class ZoneLayerSHP {
	...
	public static void write(ZoneLayer layer, String filename) throws IOException {
		...
		/*
		 * This is a hack: write the .prj file.
		 */
		...
		pwriter.write(featureType.getDefaultGeometry().getCoordinateSystem().toWKT());
		pwriter.close();
	}
	...
	public static ZoneLayer read(String filename) throws IOException {
		...
		for(Feature feature : FeatureSHP.readFeatures(filename, Zone.FEATURE_TYPE_NAME)) {
