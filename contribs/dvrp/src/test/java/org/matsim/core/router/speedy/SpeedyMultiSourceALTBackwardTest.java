...
/**
 * A copy of SpeedyMultiSourceALTForwardTest (however the network is inverted and the computed paths
 * as well)
 *
...
public class SpeedyMultiSourceALTBackwardTest {
  ...
  private final SpeedyMultiSourceALT multiSourceALT =
      new SpeedyMultiSourceALT(landmarks, travelTime, travelDisutility);
  ...
  public void testManySources_backward_sameStartCost() {
    ...
    var path =
        multiSourceALT.calcLeastCostPath(List.of(startNodeB, startNodeC), nodeA, null, null, true);
