...
public class DefaultPassengerEngineTest {
  ...
  public void test_invalid_rejected() {
    ...
    fixture.assertPassengerEvents(
        ...
        new PassengerRequestRejectedEvent(
            0, MODE, requestId, List.of(fixture.PERSON_ID), "invalid"),
  ...
  public void test_valid_rejected() {
    ...
    fixture.assertPassengerEvents(
        ...
        new PassengerWaitingEvent(departureTime, MODE, requestId, List.of(fixture.PERSON_ID)),
        new PassengerRequestRejectedEvent(
            0, MODE, requestId, List.of(fixture.PERSON_ID), "rejecting_all_requests"),
        new PersonStuckEvent(1, fixture.PERSON_ID, fixture.linkAB.getId(), MODE));
  }
    ...
    public void requestSubmitted(Request request) {
      ...
      eventsManager.processEvent(
          new PassengerRequestRejectedEvent(
              ...
              MODE,
              request.getId(),
              passengerRequest.getPassengerIds(),
              "rejecting_all_requests"));
    }
