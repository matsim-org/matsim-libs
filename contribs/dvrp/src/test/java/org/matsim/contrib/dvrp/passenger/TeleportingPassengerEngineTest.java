...
public class TeleportingPassengerEngineTest {
  ...
  public void test_valid_teleported() {
    ...
    TeleportedRouteCalculator teleportedRouteCalculator =
        request -> {
          Route route =
              new GenericRouteImpl(request.getFromLink().getId(), request.getToLink().getId());
    ...
    fixture.assertPassengerEvents(
        ...
        new ActivityStartEvent(
            arrivalTime, fixture.PERSON_ID, fixture.linkBA.getId(), null, END_ACTIVITY));
  }
  ...
  public void test_invalid_rejected() {
    ...
    fixture.assertPassengerEvents(
        ...
        new PassengerRequestRejectedEvent(
            departureTime, MODE, requestId, List.of(fixture.PERSON_ID), "invalid"),
