...
public class GroupPassengerEngineTest {
  ...
  private final DvrpVehicle oneTaxi =
      new DvrpVehicleImpl(
  ...
  public void test_group() {
    ...
    double taxiArrivalTime =
        taxiEntersLinkBATime + (fixture.linkBA.getLength() / fixture.linkBA.getFreespeed());
    ...
    fixture.assertPassengerEvents(
        ...
        new ActivityStartEvent(
            dropoffEndTime, person2, fixture.linkBA.getId(), null, END_ACTIVITY));
  }

  private QSim createQSim(
      PassengerRequestValidator requestValidator, Class<? extends VrpOptimizer> optimizerClass) {
    return new QSimBuilder(fixture.config)
        .useDefaults()
        .addOverridingModule(new MobsimScopeEventHandlingModule())
        .addQSimModule(
            new PassengerEngineQSimModule(
                MODE, PassengerEngineQSimModule.PassengerEngineType.WITH_GROUPS))
        ...
        .addQSimModule(
            new AbstractDvrpModeQSimModule(MODE) {
              ...
              protected void configureQSim() {
                ...
                // supply
                addQSimComponentBinding(DynActivityEngine.COMPONENT_NAME)
                    .to(DynActivityEngine.class);
                ...
                // groups
                bindModal(PassengerGroupIdentifier.class)
                    .toInstance(
                        agent ->
                            Id.create("group1", PassengerGroupIdentifier.PassengerGroup.class));
              }
            })
