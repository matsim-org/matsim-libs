...
public class OnlineDriveTaskTrackerImpl implements OnlineDriveTaskTracker {
  ...
  public OnlineDriveTaskTrackerImpl(
      DvrpVehicle vehicle,
      VrpLeg vrpDynLeg,
   ...
   *
   * <ul>
   *   <li>if the next link can be changed: after the current link
   *   <li>If not then, (a) if the current link is not the last one, after the next link, or
   *   <li>(b) no diversion possible (the leg ends on the current link)
   * </ul>
   */
  @Override
