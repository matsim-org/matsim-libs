...
/**
 * Collects task profiles of DVRP vehicles. Based on {@link VehicleOccupancyProfileCalculator} but
 * only collects tasks.
 *
 * @author nkuehnel / MOIA
 */
public class VehicleTaskProfileCalculator
    implements TaskStartedEventHandler, TaskEndedEventHandler {
  ...
  public VehicleTaskProfileCalculator(
      String dvrpMode, FleetSpecification fleet, int timeInterval, QSimConfigGroup qsimConfig) {
