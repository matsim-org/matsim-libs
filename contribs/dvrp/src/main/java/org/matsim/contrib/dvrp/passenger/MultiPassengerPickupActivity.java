...
public class MultiPassengerPickupActivity extends FirstLastSimStepDynActivity
  ...
  public MultiPassengerPickupActivity(
  ...
  public void notifyPassengersAreReadyForDeparture(
    ...
    PassengerRequest request =
        getRequestForPassenger(passengers.stream().map(Identifiable::getId).toList());
    if (passengerHandler.tryPickUpPassengers(this, driver, request.getId(), now)) {
      requestsPickedUp++;
    } else {
