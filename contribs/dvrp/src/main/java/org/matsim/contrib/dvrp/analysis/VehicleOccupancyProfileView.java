...
public class VehicleOccupancyProfileView implements ProfileWriter.ProfileView {
  ...
  public VehicleOccupancyProfileView(
      VehicleOccupancyProfileCalculator calculator,
      Comparator<Task.TaskType> nonPassengerTaskTypeComparator,
  ...
  public ImmutableMap<String, double[]> profiles() {
    ...
    var nonPassengerTaskProfiles =
        calculator.getNonPassengerServingTaskProfiles().entrySet().stream()
