...
/**
 * A DivertedVrpPath is a VrpPath which additionally keeps information about the original path,
 * where the new path deviates from the original one, and at which link index they diverted.
 *
...
public class DivertedVrpPath implements VrpPath {
  ...
  private final int
      diversionLinkIdx; // originalPath.getLink(diversionLinkIdx) == newSubPath.getLink(0)
