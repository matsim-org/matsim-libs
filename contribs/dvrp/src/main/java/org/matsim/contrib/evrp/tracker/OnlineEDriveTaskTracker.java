...
public class OnlineEDriveTaskTracker implements OnlineDriveTaskTracker, ETaskTracker {
  ...
  public OnlineEDriveTaskTracker(
      EvDvrpVehicle vehicle, MobsimTimer timer, OnlineDriveTaskTracker driveTracker) {
  ...
  public double predictChargeAtEnd() {
    ...
    double driveEnergy =
        VrpPathEnergyConsumptions.calcRemainingTotalEnergy(
            ev, getPath(), getCurrentLinkIdx(), getCurrentLinkEnterTime());
