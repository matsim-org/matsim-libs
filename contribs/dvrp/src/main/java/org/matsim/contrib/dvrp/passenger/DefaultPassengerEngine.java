 ...
 */
public final class DefaultPassengerEngine
  ...
  DefaultPassengerEngine(
      ...
      AdvanceRequestProvider advanceRequestProvider) {
    this.mode = mode;
  ...
  public void doSimStep(double time) {
    ...
    while (iterator.hasNext()) {
      ...
      if (event.getTime() == time) {
        // There is a potential race condition wrt processing rejection events between doSimStep()
        // and handleEvent().
  ...
  public boolean handleDeparture(double now, MobsimAgent agent, Id<Link> fromLinkId) {
    ...
    if (request == null) { // immediate request
      ...
      eventsManager.processEvent(
          new PassengerWaitingEvent(now, mode, request.getId(), List.of(passenger.getId())));
  ...
  public static Provider<PassengerEngine> createProvider(String mode) {
    return new ModalProviders.AbstractProvider<>(mode, DvrpModes::mode) {
      ...
      public DefaultPassengerEngine get() {
        return new DefaultPassengerEngine(
            getMode(),
            eventsManager,
            mobsimTimer,
