...
public class PassengerRequests {
	public static final Comparator<PassengerRequest> EARLIEST_START_TIME_COMPARATOR = Comparator.comparing(
	...
	public static final Comparator<PassengerRequest> ABSOLUTE_COMPARATOR = Comparator.comparing(
			PassengerRequest::getEarliestStartTime)
