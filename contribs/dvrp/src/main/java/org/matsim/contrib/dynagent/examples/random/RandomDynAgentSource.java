...
public class RandomDynAgentSource implements AgentSource {
	...
	public RandomDynAgentSource(QSim qSim, Network network, EventsManager eventsManager, int agentCount) {
		this.qSim = qSim;
	...
	public void insertAgentsIntoMobsim() {
		...
		for (int i = 0; i < agentCount; i++) {
			...
			DynAgent agent = new DynAgent(id, startLinkId, eventsManager, agentLogic);
