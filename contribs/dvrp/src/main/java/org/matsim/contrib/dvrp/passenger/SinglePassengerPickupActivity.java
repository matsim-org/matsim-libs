...
public class SinglePassengerPickupActivity extends FirstLastSimStepDynActivity
  ...
  public SinglePassengerPickupActivity(
  ...
  public void notifyPassengersAreReadyForDeparture(
    ...
    if (request
        .getPassengerIds()
        .containsAll(passengers.stream().map(Identifiable::getId).toList())) {
