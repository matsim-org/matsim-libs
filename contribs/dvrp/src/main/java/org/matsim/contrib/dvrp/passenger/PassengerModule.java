 ...
 * dvrp objects relating to serving passengers (e.g. booking engine).
 *
 * <p>Some of the initialised objects will become modal at some point in the future. E.g.
 * VehicleType or TravelTime are likely to be provided separately per each mode in the future.
 *
 * @author michalm
 */
