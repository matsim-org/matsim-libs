...
public class DynActivityEngine implements MobsimEngine, ActivityHandler {
  public static final String COMPONENT_NAME = "DynActivityEngine";

  private InternalInterface internalInterface;

  private final List<DynAgent> dynAgents = new LinkedList<>();
  private final List<DynAgent> newDynAgents =
      new ArrayList<>(); // will to be handled in the next timeStep
