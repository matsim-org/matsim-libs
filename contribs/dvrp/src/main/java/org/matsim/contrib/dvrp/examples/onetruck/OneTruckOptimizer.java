...
final class OneTruckOptimizer implements VrpOptimizer {
	...
	public void requestSubmitted(Request request) {
		...
		VrpPathWithTravelData pathToCustomer = VrpPaths.calcAndCreatePath(lastTask.getLink(), fromLink, t0, router,
				travelTime);
		schedule.addTask(new DriveTask(new NamedTaskType("drive_empty"), pathToCustomer));
		...
		schedule.addTask(new DriveTask(new NamedTaskType("drive_loaded"), pathWithCustomer));
