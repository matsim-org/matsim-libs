 ...
 * @author michalm
 */
public class SparseDiscreteArc
    extends AbstractArc
{
    ...
    public SparseDiscreteArc(Link fromLink, Link toLink,
    ...
    public static class SparseDiscreteArcFactory
        implements ArcFactory
    {
        ...
        public SparseDiscreteArcFactory(ShortestPathCalculator shortestPathCalculator,
        ...
        {
            return new SparseDiscreteArc(fromLink, toLink, shortestPathCalculator,
                    timeDiscretizer);
        }
    }
}
