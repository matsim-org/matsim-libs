...
public interface PassengerRequestCreator {
  /**
   * Thread safety: This method can be called concurrently from multiple QSim worker threads. Prefer
   * stateless implementation, otherwise provide other ways to achieve thread-safety.
   *
   * @param id request ID
   ...
   * @return
   */
  PassengerRequest createRequest(
      Id<Request> id,
