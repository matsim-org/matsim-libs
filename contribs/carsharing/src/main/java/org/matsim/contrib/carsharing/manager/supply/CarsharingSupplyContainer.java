...
public class CarsharingSupplyContainer implements CarsharingSupplyInterface {
	...
	@Override
	public Link findClosestAvailableParkingSpace(Link destinationLink, String carsharingType, String companyId,
	...
	public void populateSupply() {
		...
		final FreeFloatingConfigGroup ffConfigGroup = (FreeFloatingConfigGroup) this.scenario.getConfig()
				.getModule(FreeFloatingConfigGroup.GROUP_NAME);
