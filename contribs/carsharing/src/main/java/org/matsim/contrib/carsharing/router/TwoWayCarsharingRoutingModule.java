...
public class TwoWayCarsharingRoutingModule implements RoutingModule {
	...
	private ArrayList<Id<Link>> startCoord = new ArrayList<Id<Link>>();
	private ArrayList<Id<Link>> endCoord = new ArrayList<Id<Link>>();

	private Person person = null;
	private int legcount = 0;
	public TwoWayCarsharingRoutingModule() {		
	...
	public List<? extends PlanElement> calcRoute(Facility fromFacility,
		...
		if (this.person == null || person != this.person) {
			legcount = 0;
			startCoord = new ArrayList<Id<Link>>();
			endCoord = new ArrayList<Id<Link>>();
			this.person = person;
