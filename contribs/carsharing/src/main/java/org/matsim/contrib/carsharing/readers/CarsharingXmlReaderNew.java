...
public class CarsharingXmlReaderNew extends MatsimXmlParser {
  ...
  private Map<String, CompanyContainer> companies =
      new ConcurrentHashMap<String, CompanyContainer>();
  ...
  private Map<String, CarsharingStation> twowaycarsharingstationsMap =
      new ConcurrentHashMap<String, CarsharingStation>();
  ...
  public void endTag(String name, String content, Stack<String> context) {
    if (name.equals("company")) {
      ...
      if (hasFF) {
        FreeFloatingVehiclesContainer ffvehiclesContainer =
            new FreeFloatingVehiclesContainer(
                ffVehicleLocationQuadTree, ffvehicleIdMap, ffvehiclesMap);
      ...
      if (hasTW) {
        VehiclesContainer twvehiclesContainer =
            new TwoWayContainer(
                twvehicleLocationQuadTree, twowaycarsharingstationsMap, twvehiclesMap);
        companyContainer.addCarsharingType("twoway", twvehiclesContainer);
        hasTW = false;
      }

      if (hasOW) {
        VehiclesContainer owvehiclesContainer =
            new OneWayContainer(
                owvehicleLocationQuadTree,
                onewaycarsharingstationsMap,
                owvehiclesMap,
                owvehicleToStationMap);
      ...
      Map<String, ArrayList<CSVehicle>> vehiclesPerType =
          new ConcurrentHashMap<String, ArrayList<CSVehicle>>();
      ...
      if (name.equals("twoway")) {
        TwoWayCarsharingStation station =
            new TwoWayCarsharingStation(id, link, numberOfVehiclesPerType, vehiclesPerType);
        ...
        OneWayCarsharingStation station =
            new OneWayCarsharingStation(
                id, link, numberOfVehiclesPerType, vehiclesPerType, avaialbleParkingSpots);
