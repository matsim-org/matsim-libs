...
public class FFVehiclesRentalsWriter extends MatsimXmlWriter {
  ...
  public void addVehicleRentals(
      String companyId, Id<Vehicle> vehicleId, ArrayList<RentalInfo> rentals) {
  ...
  public void writeFile(final String filename) {
    ...
    for (Entry<String, Map<Id<Vehicle>, ArrayList<RentalInfo>>> companyVehicleRentals :
        this.rentals.entrySet()) {
      this.writeStartTag(
          "company", Arrays.asList(createTuple("id", companyVehicleRentals.getKey())));

      for (Entry<Id<Vehicle>, ArrayList<RentalInfo>> vehicleRentals :
          companyVehicleRentals.getValue().entrySet()) {
        this.writeStartTag(
            "vehicle", Arrays.asList(createTuple("id", vehicleRentals.getKey().toString())));
