...
/* *********************************************************************** *
 * project: org.matsim.*
 * CarSharingContribAnalysisMainModeIdentifier.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
 ...
 *
 */
public final class CarSharingContribAnalysisMainModeIdentifier implements AnalysisMainModeIdentifier {

	private static final Logger log = LogManager.getLogger(CarSharingContribAnalysisMainModeIdentifier.class);

	private final List<String> modeHierarchy = new ArrayList<>() ;

	public CarSharingContribAnalysisMainModeIdentifier() {
		...
		// apparently outdated structure with access/egress modes per mode to be accessed. Will add them for now, but should be replaced with normal walk
		modeHierarchy.add( "access_walk_ff" ) ;
		modeHierarchy.add( "access_walk_tw" ) ;
		modeHierarchy.add( "access_walk_ow" ) ;
		modeHierarchy.add( "egress_walk_ff" ) ;
		modeHierarchy.add( "egress_walk_tw" ) ;
		modeHierarchy.add( "egress_walk_ow" ) ;
		...
		modeHierarchy.add( "freefloating_vehicle" ) ;
		modeHierarchy.add( "oneway_vehicle" ) ;
		modeHierarchy.add( "twoway_vehicle" ) ;
		modeHierarchy.add( "oneway" ) ;
		modeHierarchy.add( "freefloating" ) ;
		modeHierarchy.add( "twoway" ) ;
