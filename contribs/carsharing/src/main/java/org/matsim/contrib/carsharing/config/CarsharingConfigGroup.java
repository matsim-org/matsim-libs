...
public class CarsharingConfigGroup extends ReflectiveConfigGroup {
  ...
  public Map<String, String> getComments() {
    ...
    map.put(
        PARAM_STATS_WRITER_INTERVAL,
        "How often the carsharing demand statistics should be written. Default is every 10th iteration.");
    map.put(
        PARAM_VEHICLE_LOCATIONS,
        "Path to the input file containing th elocation of vehicles and stations.");
