...
public class DemandDistributionHandler
    implements StartRentalEventHandler, NoVehicleCarSharingEventHandler {
  ...
  public void createODMatrices(String companyId, double time) {
    ...
    this.ODMatrices.get(companyId)
        .get(time)
        .createMatrix(
            "rentals", "rentals of operator " + companyId + " starting at " + String.valueOf(time));
    this.ODMatrices.get(companyId)
        .get(time)
        .createMatrix(
            "no_vehicle",
            "no_vehicles of operator " + companyId + " starting at " + String.valueOf(time));
  }
  ...
  public void handleEvent(StartRentalEvent event) {
    ...
    RelocationZone originZone =
        this.carsharingVehicleRelocation.getRelocationZone(companyId, originLink.getCoord());
    RelocationZone destinationZone =
        this.carsharingVehicleRelocation.getRelocationZone(companyId, destinationLink.getCoord());
