...
public class FreeFloatingConfigGroup extends ReflectiveConfigGroup {
  ...
  public Map<String, String> getComments() {
    ...
    map.put(
        PARAM_AREAS,
        "The path to the input file containg the service are of the freefloating service. If not defined the whole study area will be considered eligile for free-floating carsharing.");
    map.put(
        PARAM_SEARCH_DISTANCE,
        "Defines the search radius for free-floating vehicles. Default is 500 meters.");
    map.put(
        PARAM_USE_FREEFLOATING,
        "Defines if the free-floating carsharing should be a mode alternative. Default is false.");
