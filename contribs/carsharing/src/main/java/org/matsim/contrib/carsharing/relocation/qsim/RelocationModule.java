...
public class RelocationModule extends AbstractModule {
  ...
  @Provides
  @Singleton
  public RelocationAgentSource provideAgentSource(
      QSim qsim,
      Scenario scenario,
      AgentFactory agentFactory,
      CarsharingVehicleRelocationContainer carsharingVehicleRelocation,
      Provider<TripRouter> routerProvider,
      CarsharingSupplyInterface carsharingSupply,
      @Named("ra") LeastCostPathCalculator lcpc) {
    return new RelocationAgentSource(
        scenario, qsim, carsharingVehicleRelocation, routerProvider, carsharingSupply, lcpc);
  }

  @Provides
  @Singleton
  @Named("ra")
  LeastCostPathCalculator provideRAPathCalculator(
      @Named("ff") TravelTime travelTimes,
      @Named("carnetwork") Network network,
