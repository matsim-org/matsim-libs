...
public class CarsharingScoringFunctionFactory implements ScoringFunctionFactory {
  ...
  @Inject
  CarsharingScoringFunctionFactory(
      final Scenario sc,
      final DemandHandler demandHandler,
      final CostsCalculatorContainer costsCalculatorContainer,
      final CarsharingSupplyInterface carsharingSupplyContainer) {
    this.scenario = sc;
  ...
  public ScoringFunction createNewScoringFunction(Person person) {
    ...
    scoringFunctionSum.addScoringFunction(
        new CharyparNagelActivityScoring(params.getScoringParameters(person)));
    scoringFunctionSum.addScoringFunction(
        new CharyparNagelAgentStuckScoring(params.getScoringParameters(person)));
