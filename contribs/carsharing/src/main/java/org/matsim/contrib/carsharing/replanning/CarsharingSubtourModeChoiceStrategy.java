...
public class CarsharingSubtourModeChoiceStrategy implements PlanStrategy {
  ...
  @Inject
  public CarsharingSubtourModeChoiceStrategy(
    ...
    CarsharingSubTourPermissableModesCalculator cpmc =
        new CarsharingSubTourPermissableModesCalculator(
            scenario, scenario.getConfig().subtourModeChoice().getModes(), memberships);
    SubtourModeChoice smc =
        new SubtourModeChoice(
            scenario.getConfig().global(), scenario.getConfig().subtourModeChoice(), cpmc);
