...
public class CarsharingSubTourPermissableModesCalculator implements PermissibleModesCalculator {
  ...
  public CarsharingSubTourPermissableModesCalculator(
      final Scenario scenario, final String[] availableModes, MembershipContainer memberships) {
  ...
  public Collection<String> getPermissibleModes(Plan plan) {
    ...
    if (Boolean.parseBoolean(
            scenario
                .getConfig()
                .getModules()
                .get("TwoWayCarsharing")
                .getParams()
                .get("useTwoWayCarsharing"))
