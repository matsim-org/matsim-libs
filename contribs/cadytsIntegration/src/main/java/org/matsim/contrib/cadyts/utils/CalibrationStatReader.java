      ...
      for (String s : colArray) {
        switch (col) {
          ...
          case 3:
            ...
            break;
          case 4:
            sData.setLink_lambda_avg(s);
            break;
          case 5:
            sData.setLink_lambda_stddev(s);
            break;
          case 6:
            sData.setLink_lambda_min(s);
            break;
          case 7:
            sData.setLink_lambda_max(s);
            break;
          case 8:
            sData.setPlan_lambda_avg(s);
            break;
          case 9:
            sData.setPlan_lambda_stddev(s);
            break;
          case 10:
            sData.setPlan_lambda_min(s);
            break;
          case 11:
            sData.setPlan_lambda_max(s);
            break;
          case 12:
            sData.setReplan_count(s);
            break;
        } // switch
        col++;
      }
