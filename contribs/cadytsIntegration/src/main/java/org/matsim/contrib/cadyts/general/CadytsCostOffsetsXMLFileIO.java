...
public final class CadytsCostOffsetsXMLFileIO<T extends Identifiable<T>>
    extends DynamicDataXMLFileIO<T> {
  // yyyy this is most probably not "costs" but just "offsets" (which end up being added into the
  // scoring function, so if anything
