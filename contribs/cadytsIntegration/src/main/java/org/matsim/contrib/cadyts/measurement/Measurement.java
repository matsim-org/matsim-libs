...
//	protected Count(final Id<Count> linkId, final String stationName) {
	protected Measurement(final Id<Measurement> measurementId) {
		this.measurementId = measurementId;
//		this.stationName = stationName;
	}

	/**
	 * Creates and adds a {@link Volume} to the {@link Measurement}ing station.
	 ...
	 * @return the {@link Measurement}ing station's {@link Volume}.
	 */
...
//	}
	...
	public final Id<Measurement> getMeasurementId() {
...
//		return "[Loc_id=" + this.measurementId + "]" +
//		"[cs_id=" + this.stationName + "]" +
//		"[nof_volumes=" + this.volumes.size() + "]";
		return "[Measurement_id=" + this.measurementId + "]" +
		"[n_of_volumes=" + this.volumes.size() + "]";
	}
