 ...
 *
 * <p>For the listing click on the class name above.
 *
 * @author nagel
 */
          ...
          public ScoringFunction createNewScoringFunction(Person person) {
            ...
            scoringFunctionAccumulator.addScoringFunction(
                new CharyparNagelLegScoring(
                    ...
                    config.transit().getTransitModes()));
            scoringFunctionAccumulator.addScoringFunction(new CharyparNagelActivityScoring(params));
            scoringFunctionAccumulator.addScoringFunction(
                new CharyparNagelAgentStuckScoring(params));

            final CadytsScoring<Link> scoringFunction =
                new CadytsScoring<>(person.getSelectedPlan(), config, cadytsContext);
