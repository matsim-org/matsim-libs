...
public class MatrixBasedPtModule extends AbstractModule {
  ...
  public void install() {
    if (getConfig().transit().isUseTransit()) {
      System.out.println(
          "You are trying to use MatrixBasedPtModule and physical transit simulation "
  ...
  PtMatrix createPtMatrix(
      RoutingConfigGroup plansCalcRoute, MatrixBasedPtRouterConfigGroup ippcm, Network network) {
