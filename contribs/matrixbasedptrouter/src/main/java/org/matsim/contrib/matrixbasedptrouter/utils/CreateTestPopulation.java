...
public final class CreateTestPopulation {
  ...
  /**
   * This method creates n persons for a test population. NOTE: It was written for the <code>
   * AccessibilityTest</code>, all home locations are at (0,100) and all work locations are at
   * (200,100). All legs are car legs.
   *
  ...
  public static Population createTestPopulation(int nPersons) {
    ...
    for (int i = 0; i < nPersons; i++) {
      ...
      Activity home =
          population
              .getFactory()
              .createActivityFromCoord("home", new Coord((double) 0, (double) 100));
      home.setEndTime(8. * 3600);
      Activity work =
          population
              .getFactory()
              .createActivityFromCoord("work", new Coord((double) 200, (double) 100));
  ...
  /**
   * This method creates n persons for a test population to test pseudo pt. ALL home activites are
   * at <code>homeCoord</code> and ALL work activities are at <code>workCoord</code>. All legs are
   * pt legs.
   *
