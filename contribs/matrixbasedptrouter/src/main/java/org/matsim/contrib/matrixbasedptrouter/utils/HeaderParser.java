...
public final class HeaderParser {
  ...
  /**
   * This is used to parse a header line from a tab-delimited urbansim header and generate a Map
   * that allows to look up column numbers (starting from 0) by giving the header line.
   *
   * <p>I.e. if you have a header "from_id <tab> to_id <tab> travel_time", then
   * idxFromKey.get("to_id") will return "1".
   *
   * <p>This makes the reading of column-oriented files independent from the sequence of the
   * columns.
   *
   * @param line
