...
public class RecursiveStatsContainerTest {
	...
	public final void testRecursiveStatsContainer() {
		...
		Assert.assertEquals("mean coop", 3.5, stats.getArithmeticMeanCoops(), MatsimTestUtils.EPSILON);
		...
		Assert.assertEquals("std dev coop", 4.230839160261236, stats.getStdDevCoop(), MatsimTestUtils.EPSILON);
