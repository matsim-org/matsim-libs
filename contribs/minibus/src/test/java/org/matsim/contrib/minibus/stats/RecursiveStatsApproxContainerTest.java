...
public class RecursiveStatsApproxContainerTest {
  ...
  public final void testRecursiveStatsContainer() {
    ...
    Assert.assertEquals(
        "mean coop",
        2.9190000000000005,
        stats.getArithmeticMeanOperators(),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "mean route", 1237.281, stats.getArithmeticMeanRoutes(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "mean pax", 14.190000000000001, stats.getArithmeticMeanPax(), MatsimTestUtils.EPSILON);
    Assert.assertEquals("mean veh", 125.191, stats.getArithmeticMeanVeh(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "std dev coop", 1.7181000000000002, stats.getStdDevOperators(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "std dev route", 1111.5819000000001, stats.getStdDevRoutes(), MatsimTestUtils.EPSILON);
