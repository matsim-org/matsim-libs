...
public class MaxRandomStartTimeAllocatorTest {
  ...
  public final void testRun() {
    ...
    Assert.assertEquals(
        "Compare start time", 12000.0, coop.getBestPlan().getStartTime(), MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Compare start time", 12000.0, testPlan.getStartTime(), MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Compare start time", 11920.0, testPlan.getStartTime(), MatsimTestUtils.EPSILON);
  }
}
