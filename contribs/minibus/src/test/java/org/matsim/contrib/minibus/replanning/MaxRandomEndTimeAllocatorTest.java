...
public class MaxRandomEndTimeAllocatorTest {
  ...
  public final void testRun() {
    ...
    Assert.assertEquals(
        "Compare end time", 40000.0, coop.getBestPlan().getEndTime(), MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Compare end time", 40000.0, testPlan.getEndTime(), MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Compare start time", 40000.0, coop.getBestPlan().getEndTime(), MatsimTestUtils.EPSILON);
    Assert.assertNotNull("Test plan should be not null", testPlan);
    Assert.assertEquals(
        "There should be one vehicle bought",
        1.0,
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Compare end time", 40070.0, testPlan.getEndTime(), MatsimTestUtils.EPSILON);
  }
}
