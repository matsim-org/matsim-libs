...
public class WeightedEndTimeExtensionTest {
  ...
  public final void testRun() {
    ...
    Assert.assertEquals(
        "Compare start time", 19500.0, coop.getBestPlan().getEndTime(), MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Compare start time", 50400.0, testPlan.getEndTime(), MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Compare start time", 24300.0, testPlan.getEndTime(), MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Compare start time", 36000.0, testPlan.getEndTime(), MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Compare start time", 47700.0, testPlan.getEndTime(), MatsimTestUtils.EPSILON);
  }
}
