...
public class AreaBtwLinksVsTerminiBeelinePenaltyTest {
  ...
  public void testRectangularLine() {
    ...
    NetworkUtils.createAndAddLink(
        scenario.getNetwork(),
        idLinkAB,
        scenario.getNetwork().getNodes().get(idNodeA),
        scenario.getNetwork().getNodes().get(idNodeB),
        10.0,
        1.0,
        1.0,
        1.0,
    ...
    NetworkUtils.createAndAddLink(
        ...
        idLinkBC,
        scenario.getNetwork().getNodes().get(idNodeB),
        scenario.getNetwork().getNodes().get(idNodeC),
        10.0,
        1.0,
        1.0,
        1.0,
    ...
    NetworkUtils.createAndAddLink(
        ...
        idLinkCD,
        scenario.getNetwork().getNodes().get(idNodeC),
        scenario.getNetwork().getNodes().get(idNodeD),
        10.0,
        1.0,
        1.0,
        1.0,
    ...
    NetworkUtils.createAndAddLink(
        ...
        idLinkCE,
        scenario.getNetwork().getNodes().get(idNodeC),
        scenario.getNetwork().getNodes().get(idNodeE),
        10.0,
        1.0,
        1.0,
        1.0,
    ...
    AreaBtwLinksVsTerminiBeelinePenalty penalty =
        new AreaBtwLinksVsTerminiBeelinePenalty(params, scenario.getNetwork());
