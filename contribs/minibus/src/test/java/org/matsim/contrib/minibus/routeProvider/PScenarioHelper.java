...
public class PScenarioHelper {
  ...
  public static Operator createTestCooperative(String testOutPutDir) {
    ...
    Operator coop =
        new BasicOperator(
            Id.create(pC.getPIdentifier() + 1, Operator.class),
            pC,
            new PFranchise(pC.getUseFranchise(), pC.getGridSize()));
    TransitSchedule sched = CreatePStops.createPStops(sC.getNetwork(), pC);
    RandomStopProvider randomStopProvider =
        new RandomStopProvider(pC, sC.getPopulation(), sched, null);

    PRouteProvider rP =
        new ComplexCircleScheduleProvider(
            sched,
            sC.getNetwork(),
            randomStopProvider,
            pC.getPlanningSpeedFactor(),
            pC.getVehicleMaximumVelocity(),
            pC.getDriverRestTime(),
            pC.getMode());
  ...
  public static Scenario createTestNetwork() {
    ...
    for (Link link : network.getLinks().values()) {
      ...
      // (adding small random noise to the link length so that there is no arbitrariness any more
      // for routers.  kai, oct'13)
    ...
    ids.add(Id.create("A", Link.class));
    ids.add(Id.create("B", Link.class));
    ids.add(Id.create("C", Link.class));
    ids.add(Id.create("D", Link.class));
    ...
    ids = new TreeSet<>();
    ids.add(Id.create("11", Link.class));
    ids.add(Id.create("12", Link.class));
    ids.add(Id.create("21", Link.class));
    ids.add(Id.create("23", Link.class));
    ids.add(Id.create("32", Link.class));
    ids.add(Id.create("33", Link.class));
    ...
    TransitStopFacility s1 =
        sf.createTransitStopFacility(
            Id.create("1", TransitStopFacility.class),
            new Coord((double) 1000, (double) 1000),
            false);
    TransitStopFacility s2a =
        sf.createTransitStopFacility(
            Id.create("2a", TransitStopFacility.class),
            new Coord((double) 2050, (double) 2950),
            false);
    TransitStopFacility s2b =
        sf.createTransitStopFacility(
            Id.create("2b", TransitStopFacility.class),
            new Coord((double) 2050, (double) 2950),
            false);
    TransitStopFacility s3 =
        sf.createTransitStopFacility(
            Id.create("3", TransitStopFacility.class),
            new Coord((double) 3950, (double) 1050),
            false);
    ...
    NetworkRoute netRoute =
        RouteUtils.createLinkNetworkRouteImpl(
            Id.create("11", Link.class), Id.create("11", Link.class));
    List<Id<Link>> linkIds = new ArrayList<>();
    Collections.addAll(
        linkIds,
        Id.create("12", Link.class),
        Id.create("23", Link.class),
        Id.create("33", Link.class),
        Id.create("32", Link.class),
        Id.create("21", Link.class));
    netRoute.setLinkIds(Id.create("11", Link.class), linkIds, Id.create("11", Link.class));
    route =
        sf.createTransitRoute(Id.create("1to3to1", TransitRoute.class), netRoute, stops, "train");
  ...
  public static Operator createCoop2111to2333() {
    ...
    TransitSchedule sched =
        CreateStopsForAllCarLinks.createStopsForAllCarLinks(sc.getNetwork(), conf);
    RandomStopProvider randomStopProvider =
        new RandomStopProvider(conf, sc.getPopulation(), sched, null);
    ComplexCircleScheduleProvider prov =
        new ComplexCircleScheduleProvider(
            sched,
            sc.getNetwork(),
            randomStopProvider,
            conf.getVehicleMaximumVelocity(),
            conf.getPlanningSpeedFactor(),
            conf.getDriverRestTime(),
            conf.getMode());

    Operator coop =
        new BasicOperator(
            Id.create(conf.getPIdentifier() + 1, Operator.class),
            conf,
            new PFranchise(conf.getUseFranchise(), conf.getGridSize()));
...
class Route2111to2333 implements PStrategy {
  ...
  public PPlan run(Operator cooperative) {
    ...
    TransitStopFacility startStop =
        sched.getFacilities().get(Id.create(pId + "2111", TransitStopFacility.class));
    TransitStopFacility endStop =
        sched.getFacilities().get(Id.create(pId + "2333", TransitStopFacility.class));
    ...
    newPlan.setLine(
        cooperative
            .getRouteProvider()
            .createTransitLineFromOperatorPlan(cooperative.getId(), newPlan));
    return newPlan;
  }
...
class Route2414to3444 implements PStrategy {
  ...
  public PPlan run(Operator cooperative) {
    ...
    newPlan.setEndTime(16.0 * 3600.0);
    TransitStopFacility startStop =
        sched.getFacilities().get(Id.create(pId + "2414", TransitStopFacility.class));
    TransitStopFacility endStop =
        sched.getFacilities().get(Id.create(pId + "3444", TransitStopFacility.class));
    ArrayList<TransitStopFacility> stops = new ArrayList<>();
    stops.add(startStop);
    stops.add(endStop);
    newPlan.setStopsToBeServed(stops);
...
class Route2111to1314to4443 implements PStrategy {
  ...
  public PPlan run(Operator cooperative) {
    ...
    TransitStopFacility startStop =
        sched.getFacilities().get(Id.create(pId + "2111", TransitStopFacility.class));
    TransitStopFacility middleStop =
        sched.getFacilities().get(Id.create(pId + "1314", TransitStopFacility.class));
    TransitStopFacility endStop =
        sched.getFacilities().get(Id.create(pId + "4443", TransitStopFacility.class));
    ArrayList<TransitStopFacility> stops = new ArrayList<>();
    stops.add(startStop);
...
class RouteVShaped implements PStrategy {
  ...
  public PPlan run(Operator cooperative) {
    ...
    TransitStopFacility startStop =
        sched.getFacilities().get(Id.create(pId + "2111", TransitStopFacility.class));
    TransitStopFacility mostDistantStop =
        sched.getFacilities().get(Id.create(pId + "3141", TransitStopFacility.class));
    TransitStopFacility endStop =
        sched.getFacilities().get(Id.create(pId + "3222", TransitStopFacility.class));
