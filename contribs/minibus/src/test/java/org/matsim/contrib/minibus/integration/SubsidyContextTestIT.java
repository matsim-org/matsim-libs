...
public class SubsidyContextTestIT implements TabularFileHandler {
  ...
  public final void testDefaultPControler() {
    ...
    Assert.assertEquals(
        "Number of budget (final iteration)", "-7123.2705000000", this.pStatsResults.get(31)[9]);
  ...
  public final void testSubsidyPControler() {
    ...
    Assert.assertEquals(
        "Number of budget (final iteration)", "-1876.5780555555", this.pStatsResults.get(31)[9]);
