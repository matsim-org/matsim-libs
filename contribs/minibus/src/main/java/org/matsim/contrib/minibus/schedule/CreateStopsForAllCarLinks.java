...
public final class CreateStopsForAllCarLinks {
  ...
  private static final Logger log = LogManager.getLogger(CreateStopsForAllCarLinks.class);
  ...
  public static TransitSchedule createStopsForAllCarLinks(
      Network network, PConfigGroup pConfigGroup) {
  ...
  public static TransitSchedule createStopsForAllCarLinks(
    ...
    CreateStopsForAllCarLinks cS =
        new CreateStopsForAllCarLinks(network, pConfigGroup, realTransitSchedule);
    cS.run();
