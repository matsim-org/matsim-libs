...
import org.matsim.contrib.minibus.hook.POperators;
 ...
 *
 * <ul>
 *   <li>average score of the operators
 *   <li>average positive score of the operators
 *   <li>average budget of the operators
 *   <li>average vehicle fleet size of the operators
 *   <li>average score per vehicle
 *   <li>average number of trips served
 *   <li>percentage of operators with positive score
 * </ul>
 *
...
final class PStatsOverview implements StartupListener, IterationEndsListener, ShutdownListener {
  ...
  private static final Logger log = LogManager.getLogger(PStatsOverview.class);
  ...
  enum INDEX {
    ...
    INDEX_NROUTESPOS(
        ...
        new DecimalFormat("#########0", new DecimalFormatSymbols(Locale.US))),
    INDEX_NPAX(
        "N pax", "N pax", new DecimalFormat("#########0", new DecimalFormatSymbols(Locale.US))),
    INDEX_NPAXPOS(
        "N pos pax",
        "N pos pax",
        new DecimalFormat("#########0", new DecimalFormatSymbols(Locale.US))),
    INDEX_NVEH(
        "N veh", "N veh", new DecimalFormat("#########0", new DecimalFormatSymbols(Locale.US))),
    INDEX_NVEHPOS(
        "N pos veh",
        "N pos veh",
        new DecimalFormat("#########0", new DecimalFormatSymbols(Locale.US))),
    ...
    INDEX_NSCORE(
        ...
        new DecimalFormat("#########0.00", new DecimalFormatSymbols(Locale.US))),
    INDEX_NSCOREPOS(
        "pos score per pos route",
        "pos score per pos route",
        new DecimalFormat("#########0.00", new DecimalFormatSymbols(Locale.US))),

    INDEX_SHAREPOSOPERATORS(
        "share pos operators",
        "share pos operators",
        new DecimalFormat("#########0.00", new DecimalFormatSymbols(Locale.US))),
    INDEX_SHAREPOSROUTES(
        "share pos routes",
        "share pos routes",
    ...
    INDEX_MEANPOSOPERATORS(
        "average number of pos operators",
        "average number of pos operators",
        new DecimalFormat("#########0.0", new DecimalFormatSymbols(Locale.US))),
    INDEX_MEANPOSROUTES(
        "average number of pos routes",
        "average number of pos routes",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),
    INDEX_MEANPOSPAX(
        "average number of pos pax",
        "average number of pos pax",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),
    INDEX_MEANPOSVEH(
        "average number of pos veh",
        "average number of pos veh",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),

    INDEX_SIGMAUPPERPOSOPERATORS(
        "average number of pos operators + 1 sigma",
        "average number of pos operators + 1 sigma",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),
    INDEX_SIGMAUPPERPOSROUTES(
        "average number of pos routes + 1 sigma",
        "average number of pos routes + 1 sigma",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),
    INDEX_SIGMAUPPERPOSPAX(
        "average number of pos pax + 1 sigma",
        "average number of pos pax + 1 sigma",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),
    INDEX_SIGMAUPPERPOSVEH(
        "average number of pos veh + 1 sigma",
        "average number of pos veh + 1 sigma",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),

    INDEX_SIGMALOWERPOSOPERATORS(
        "average number of pos operators - 1 sigma",
        "average number of pos operators - 1 sigma",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),
    INDEX_SIGMALOWERPOSROUTES(
        "average number of pos routes - 1 sigma",
        "average number of pos routes - 1 sigma",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),
    INDEX_SIGMALOWERPOSPAX(
        "average number of pos pax - 1 sigma",
        "average number of pos pax - 1 sigma",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US))),
    INDEX_SIGMALOWERPOSVEH(
        "average number of pos veh - 1 sigma",
        "average number of pos veh - 1 sigma",
        new DecimalFormat("#########0.00000", new DecimalFormatSymbols(Locale.US)));
  ...
  public void notifyStartup(final StartupEvent event) {
    ...
    if (this.pConfig.getWriteStatsInterval() > 0) {
      log.info("enabled");
      this.pStatsWriter =
          IOUtils.getBufferedWriter(controler.getControlerIO().getOutputFilename("pStats.txt"));
      try {
    ...
    if (this.pConfig.getWriteStatsInterval() > 0) {
      try {
        if (this.pStatsWriter != null) {
          ...
          log.warn(
              "Tried to close the pStatsWriter. However, it hasn't been initialized yet. Maybe the run suffered from an unexpected shutdown request.");
        }
      } catch (IOException e) {
        e.printStackTrace();
      }
