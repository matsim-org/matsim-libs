...
/**
 * Rereads the output of the {@linkplain PStatsOverview}. Note that this is not safe with respect to
 * changes in the code.
 *
 * @author aneumann
 */
public class PStatsOverviewReader implements TabularFileHandler {
  ...
  private static final Logger log = LogManager.getLogger(PStatsOverviewReader.class);
  ...
  private PStatsOverviewReader(String filename) {
    ...
    tabFileParserConfig.setDelimiterTags(
        new String[] {PStatsOverviewDataContainer.DELIMITER}); // \t
  }
