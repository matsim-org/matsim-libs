...
/**
 * Calculate penalty score for the area between all TransitStopFacilities (of the TransitRoute of
 * the PPlan) divided by the beeline distance between the two terminus stops of the stopsToBeServed
 * of the PPlan.
 *
...
class AreaBtwStopsVsTerminiBeelinePenalty implements RouteDesignScoringFunction {
  ...
  static final Logger log = LogManager.getLogger(AreaBtwStopsVsTerminiBeelinePenalty.class);
