 ...
 * @author aneumann
 */
final class CountTransfersPerModeModeCombination extends AbstractPAnalyisModule
    implements TransitDriverStartsEventHandler,
        PersonEntersVehicleEventHandler,
        ActivityStartEventHandler {

  private static final Logger log =
      LogManager.getLogger(CountTransfersPerModeModeCombination.class);
    ...
    if (!super.ptDriverIds.contains(event.getPersonId())) {
      ...
      if (this.agentId2LastPtModeUsed.get(event.getPersonId()) != null) {
        ...
        String tripCombination =
            this.agentId2LastPtModeUsed.get(event.getPersonId()) + "-" + ptMode;
