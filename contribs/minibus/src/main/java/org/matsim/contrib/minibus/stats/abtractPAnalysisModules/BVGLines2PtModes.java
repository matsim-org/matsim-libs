...
public final class BVGLines2PtModes implements LineId2PtMode {
  ...
  private static final Logger log = LogManager.getLogger(BVGLines2PtModes.class);

  private static final String BUS = "bvg_bus";
  private static final String TRAM = "bvg_tram";
  private static final String SBAHN = "s-bahn";
  private static final String UBAHN = "u-bahn";
