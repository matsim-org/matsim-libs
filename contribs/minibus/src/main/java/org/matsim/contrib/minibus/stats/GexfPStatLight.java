 ...
 * @author aneumann
 */
final class GexfPStatLight extends MatsimJaxbXmlWriter
    implements StartupListener, IterationEndsListener, ShutdownListener {

  private static final Logger log = LogManager.getLogger(GexfPStatLight.class);

  private static final String XSD_PATH = "http://www.gexf.net/1.2draft/gexf.xsd";
  private static final String FILENAME = "pStat_light.gexf.gz";
  ...
  @Inject
  GexfPStatLight(PConfigGroup pConfig) {
