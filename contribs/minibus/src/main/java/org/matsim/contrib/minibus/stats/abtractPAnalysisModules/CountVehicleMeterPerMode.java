 ...
 * @author aneumann
 */
final class CountVehicleMeterPerMode extends AbstractPAnalyisModule
    implements TransitDriverStartsEventHandler, LinkEnterEventHandler {

  private static final Logger log = LogManager.getLogger(CountVehicleMeterPerMode.class);
  ...
  public void handleEvent(LinkEnterEvent event) {
    ...
    ptMode2CountMap.put(
        ptMode,
        ptMode2CountMap.get(ptMode) + this.network.getLinks().get(event.getLinkId()).getLength());
  }
}
