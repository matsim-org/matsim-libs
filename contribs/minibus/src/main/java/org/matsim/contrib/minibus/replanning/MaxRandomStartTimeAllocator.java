...
public final class MaxRandomStartTimeAllocator extends AbstractPStrategyModule {
  ...
  private static final Logger log = LogManager.getLogger(MaxRandomStartTimeAllocator.class);
  ...
  public MaxRandomStartTimeAllocator(ArrayList<String> parameter) {
    ...
    if (parameter.size() != 3) {
      ...
      log.error(
          "Parameter 3: Search in both directions true/false. Setting it true will double the total mutation range.");
    }
