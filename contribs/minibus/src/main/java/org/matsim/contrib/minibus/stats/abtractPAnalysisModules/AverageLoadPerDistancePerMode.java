...
final class AverageLoadPerDistancePerMode extends AbstractPAnalyisModule {
  ...
  private static final Logger log = LogManager.getLogger(AverageLoadPerDistancePerMode.class);
  ...
  public AverageLoadPerDistancePerMode(
  ...
  public String getResult() {
    ...
    for (String ptMode : this.ptModes) {
      double averageLoadPerDistance =
          this.countPassengerMeterPerMode.getResults().get(ptMode)
              / this.countCapacityMeterPerMode.getResults().get(ptMode);
