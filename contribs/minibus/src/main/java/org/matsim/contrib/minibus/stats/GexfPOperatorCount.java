 ...
 */
@Deprecated
final class GexfPOperatorCount extends MatsimJaxbXmlWriter
  ...
  private static final String FILENAME = "pOperatorCount.gexf.gz";
  ...
  public void notifyShutdown(ShutdownEvent event) {
    if (this.getWriteGexfStatsInterval > 0) {
      this.write(
          event.getServices().getControlerIO().getOutputFilename(GexfPOperatorCount.FILENAME));
    }
  }
