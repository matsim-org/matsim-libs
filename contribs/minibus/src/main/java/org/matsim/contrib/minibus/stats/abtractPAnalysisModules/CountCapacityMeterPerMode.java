 ...
 * @author aneumann
 */
final class CountCapacityMeterPerMode extends AbstractPAnalyisModule
    implements TransitDriverStartsEventHandler,
        LinkEnterEventHandler,
        VehicleEntersTrafficEventHandler,
        VehicleLeavesTrafficEventHandler {

  private static final Logger log = LogManager.getLogger(CountCapacityMeterPerMode.class);
  ...
  public void handleEvent(LinkEnterEvent event) {
    ...
    double capacityMeterForThatLink =
        capacity * this.network.getLinks().get(event.getLinkId()).getLength();
