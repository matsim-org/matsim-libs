...
/**
 * Java class for parents-content complex type.
 *
...
public class XMLParentsContent {
   ...
   * there is not a <CODE>set</CODE> method for the parent property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link XMLParent }
   */
