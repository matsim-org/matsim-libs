...
//					Id<PPlan> pplanId = Id.create(pplan.getLine().getId().toString() + "-" +
// pplan.getId().toString(), PPlan.class);
...
//		if(this.firstTime){
//
//			 writer = IOUtils.getBufferedWriter(event.getServices().getControlerIO().getOutputPath() +
// "/welfareStats.txt");
//
//		} else{
//
//			writer =
// IOUtils.getAppendingBufferedWriter(event.getServices().getControlerIO().getOutputPath() +
// "/welfareStats.txt");
//
//		}
//
