...
/**
 * Java class for node-content complex type.
 *
...
@XmlType(
    name = "node-content",
    propOrder = {"attvaluesOrSpellsOrNodes"})
public class XMLNodeContent {
  ...
  @XmlAttribute private String pid;
   ...
   * there is not a <CODE>set</CODE> method for the attvaluesOrSpellsOrNodes property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SizeContent } {@link
   * PositionContent } {@link XMLEdgesContent } {@link ColorContent } {@link XMLAttvaluesContent }
   * {@link XMLParentsContent } {@link NodeShapeContent } {@link XMLNodesContent } {@link
   * XMLSpellsContent }
   */
