 ...
 *   <li>number of trips served
 *   <li>score
 *   <li>budget
 *   <li>start time of operation
 *   <li>end time of operation
 *   <li>links served starting from terminus
 * </ul>
 *
 ...
 * @author aneumann
 */
public final class POperatorLogger
    implements StartupListener, IterationEndsListener, ShutdownListener {

  private static final Logger log = LogManager.getLogger(POperatorLogger.class);

  public static final String FILESUFFIX = "pOperatorLogger.txt";
  ...
  public void notifyStartup(final StartupEvent event) {
    ...
    if (this.pConfig.getLogOperators()) {
      log.info("enabled");
      this.pOperatorLoggerWriter =
          IOUtils.getBufferedWriter(controler.getControlerIO().getOutputFilename(FILESUFFIX));
      try {
