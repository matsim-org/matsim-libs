...
//			log.info(handler2timeEntry.getKey().getClass().getSimpleName() + " needed " +
// handler2timeEntry.getValue() + "s");
//		}
//	}
//
...
//		PConfigGroup pConfig = ConfigUtils.addOrGetModule(config, PConfigGroup.GROUP_NAME,
// PConfigGroup.class);
//
...
//
//		CountPassengerMeterPerMode countPassengerMeterPerMode = new
// CountPassengerMeterPerMode(scenario.getNetwork());
//		eventHandlers.add(countPassengerMeterPerMode);
//		CountCapacityMeterPerMode countCapacityMeterPerMode = new
// CountCapacityMeterPerMode(scenario.getNetwork());
//		eventHandlers.add(countCapacityMeterPerMode);
//		eventHandlers.add(new AverageLoadPerDistancePerMode(countPassengerMeterPerMode,
// countCapacityMeterPerMode));
//
...
//		TicketMachine ticketMachine = new TicketMachine(pConfig.getEarningsPerBoardingPassenger(),
...
//
//		OperatorCostCollectorHandler oCCCollector = new
// OperatorCostCollectorHandler(pConfig.getPIdentifier(), pConfig.getCostPerVehicleAndDay(),
// pConfig.getCostPerKilometer(), pConfig.getCostPerHour());
...
//
//		TimeAwareComplexCircleScheduleProviderHandler scheduleProvider = new
// TimeAwareComplexCircleScheduleProviderHandler(pConfig.getPIdentifier());
