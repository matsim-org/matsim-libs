 ...
 * @author aneumann
 */
final class CountDeparturesWithNoCapacityLeftPerMode extends AbstractPAnalyisModule
  ...
  private static final Logger log =
      LogManager.getLogger(CountDeparturesWithNoCapacityLeftPerMode.class);
