...
interface PAnalysisModule extends TransitDriverStartsEventHandler {
  ...
  /**
   * @param lineIds2ptModeMap Is called at the beginning of each iteration. Contains one public
   *     transport mode for each line in the schedule.
   */
  public abstract void setLineId2ptModeMap(HashMap<Id<TransitLine>, String> lineIds2ptModeMap);

  /**
   * @return The header of the information collected by the module. The header must not change from
