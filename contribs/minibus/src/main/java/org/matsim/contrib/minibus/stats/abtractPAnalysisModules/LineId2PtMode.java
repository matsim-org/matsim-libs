...
/**
 * Some common methods for setting public transit modes for each public transit line. This
 * information should come from the mode set in the schedule itself. As of now August 2012, it is
 * not clear what the transport mode in the schedule is ment to be.
 *
 * @author aneumann
 */
