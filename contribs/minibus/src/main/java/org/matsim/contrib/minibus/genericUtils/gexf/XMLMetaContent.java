...
/**
 * Java class for meta-content complex type.
 *
...
@XmlType(
    name = "meta-content",
    propOrder = {"creatorOrKeywordsOrDescription"})
public class XMLMetaContent {
   ...
   * there is not a <CODE>set</CODE> method for the creatorOrKeywordsOrDescription property.
   *
