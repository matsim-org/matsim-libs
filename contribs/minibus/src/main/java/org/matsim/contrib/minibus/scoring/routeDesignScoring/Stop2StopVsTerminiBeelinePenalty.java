...
/**
 * Calculate penalty score for circuitous TransitRoutes (TransitRoute of the PPlan) measured as sum
 * of all beeline distances of consecutive StopsToBeServed TransitStops divided by the beeline
 * distance between the two terminus stops of the stopsToBeServed of the PPlan.
 *
 * @author gleich
 */
    ...
    lengthStop2Stop =
        lengthStop2Stop
            + CoordUtils.calcEuclideanDistance(
                previousStop.getCoord(), stopListToEvaluate.get(0).getCoord());
