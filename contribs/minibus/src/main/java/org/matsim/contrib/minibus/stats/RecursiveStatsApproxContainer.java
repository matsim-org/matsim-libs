...
/**
 * Collects average number of operators, routes, passengers and vehicles and its variance in a
 * recursive manner using exponential smoothing
 *
 * @author aneumann
 */
final class RecursiveStatsApproxContainer {
  ...
  private static final Logger log = LogManager.getLogger(RecursiveStatsApproxContainer.class);

  static final String toStringHeader =
      "# ES mean Operators; ES std dev Operators; ES mean Routes; ES std dev Routes; ES mean Pax; ES std dev Pax; ES mean Veh, ES std dev Veh";
  ...
  public void handleNewEntry(double operators, double routes, double pax, double veh) {
    ...
    if (this.numberOfEntries < initNEntries) {
      ...
      meanOperators_n_1 =
          (this.numberOfEntries * this.arithmeticMeanOperators + operators)
              / (this.numberOfEntries + 1);
      meanRoutes_n_1 =
          (this.numberOfEntries * this.arithmeticMeanRoutes + routes) / (this.numberOfEntries + 1);
      meanPax_n_1 =
          (this.numberOfEntries * this.arithmeticMeanPax + pax) / (this.numberOfEntries + 1);
      meanVeh_n_1 =
          (this.numberOfEntries * this.arithmeticMeanVeh + veh) / (this.numberOfEntries + 1);
      ...
      if (this.numberOfEntries == 0) {
        ...
        tempVarOperators_n_1 =
            this.tempVarOperators
                + (this.numberOfEntries + 1)
                    / (this.numberOfEntries)
                    * (meanOperators_n_1 - operators)
                    * (meanOperators_n_1 - operators);
        tempVarRoutes_n_1 =
            this.tempVarRoutes
                + (this.numberOfEntries + 1)
                    / (this.numberOfEntries)
                    * (meanRoutes_n_1 - routes)
                    * (meanRoutes_n_1 - routes);
        tempVarPax_n_1 =
            this.tempVarPax
                + (this.numberOfEntries + 1)
      ...
      tempStdDevOperators_n_1 =
          (1 - this.alpha) * this.stdDevOperators
              + this.alpha
                  * Math.sqrt((meanOperators_n_1 - operators) * (meanOperators_n_1 - operators));
      tempStdDevRoutes_n_1 =
          (1 - this.alpha) * this.stdDevRoutes
              + this.alpha * Math.sqrt((meanRoutes_n_1 - routes) * (meanRoutes_n_1 - routes));
      tempStdDevPax_n_1 =
          (1 - this.alpha) * this.stdDevPax
              + this.alpha * Math.sqrt((meanPax_n_1 - pax) * (meanPax_n_1 - pax));
      tempStdDevVeh_n_1 =
          (1 - this.alpha) * this.stdDevVeh
              + this.alpha * Math.sqrt((meanVeh_n_1 - veh) * (meanVeh_n_1 - veh));
  ...
  public String toString() {
    ...
    strBuffer.append(this.getArithmeticMeanOperators());
    strBuffer.append("; ");
    strBuffer.append(this.getStdDevOperators());
    strBuffer.append("; ");
    strBuffer.append(this.getArithmeticMeanRoutes());
    strBuffer.append("; ");
    strBuffer.append(this.getStdDevRoutes());
    strBuffer.append("; ");
    strBuffer.append(this.getArithmeticMeanPax());
    strBuffer.append("; ");
    strBuffer.append(this.getStdDevPax());
    strBuffer.append("; ");
    strBuffer.append(this.getArithmeticMeanVeh());
    strBuffer.append("; ");
    strBuffer.append(this.getStdDevVeh());
    strBuffer.append("; ");
