...
public class RoadPricingUtils {
  ...
  public static Cost createAndAddGeneralCost(
  ...
  public static void addLinkSpecificCost(
      RoadPricingSchemeImpl scheme,
      Id<Link> linkId,
      double startTime,
      double endTime,
  ...
  public static RoadPricingSchemeImpl loadRoadPricingSchemeAccordingToRoadPricingConfig(
      Scenario sc) {
    RoadPricingSchemeImpl scheme = (RoadPricingSchemeImpl) addOrGetRoadPricingScheme(sc);
    RoadPricingConfigGroup rpConfig =
        ConfigUtils.addOrGetModule(sc.getConfig(), RoadPricingConfigGroup.class);
    ;
