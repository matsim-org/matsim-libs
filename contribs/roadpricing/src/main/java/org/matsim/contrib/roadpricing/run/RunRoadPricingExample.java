...
/**
 * Basic "script" to use roadpricing. <br>
 * <br>
...
public final class RunRoadPricingExample {
   ...
   *
   * @param args optional arguments, the first which must be a <code>config.xml</code> file. If no
   *     arguments are passed, the class will use the config, and associated files from a test
   *     instance.
   */
