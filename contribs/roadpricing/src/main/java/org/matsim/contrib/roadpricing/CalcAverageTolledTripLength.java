...
/**
 * Calculates the distance of a trip which occurred on tolled links. Requires roadpricing to be on.
 *
 * @author mrieser
 */
final class CalcAverageTolledTripLength
  ...
  public CalcAverageTolledTripLength(
  ...
  public void handleEvent(final LinkEnterEvent event) {
    ...
    Cost cost =
        this.scheme.getLinkCostInfo(
            event.getLinkId(), event.getTime(), driverId, event.getVehicleId());
  ...
  public double getAverageTripLength() {
    ...
    //		log.warn("NOTE: The result of this calculation has been changed from 'av over all trips' to
    // 'av over tolled trips'.  kai/benjamin, apr'10") ;
