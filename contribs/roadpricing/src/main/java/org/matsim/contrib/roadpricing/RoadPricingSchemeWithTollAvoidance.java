...
/**
 * A road pricing scheme that is subject to person-specific avoidance. Those vehicles (not persons)
 * with a '<code>toll_evader</code>' attribute do not pay
 */
public class RoadPricingSchemeWithTollAvoidance implements RoadPricingScheme {
  ...
  @Override
  public RoadPricingSchemeImpl.Cost getLinkCostInfo(
  ...
  @Override
  public RoadPricingSchemeImpl.Cost getTypicalLinkCostInfo(Id<Link> linkId, double time) {
