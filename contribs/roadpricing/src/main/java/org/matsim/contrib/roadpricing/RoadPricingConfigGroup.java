...
public final class RoadPricingConfigGroup extends ReflectiveConfigGroup {
  ...
  public RoadPricingConfigGroup() {
    ...
    getComments()
        .put(
            GROUP_NAME,
            "The probability that the toll is actually paid by the vehicle/person. Must be in the range [0.0, 1.0], and defaults to 1.0");
  }
  ...
  public void setEnforcementProbability(double enforcementProbability) {
    ...
    if (enforcementProbability != 1.0) {
      LOG.warn(
          "The probability of collecting toll is less than 1. Make sure this is what you want!");
    }
