...
final class RoadPricingModuleDefaults extends AbstractModule {
  ...
  public void install() {
    ...
    install(
        AbstractModule.override(
            Collections.<AbstractModule>singletonList(new ControlerDefaultsModule()),
            new RoadPricingModule(roadPricingScheme)));
  }
  ...
  static class RoadPricingInitializer {
    ...
    RoadPricingInitializer(RoadPricingScheme roadPricingScheme, Scenario scenario) {
      RoadPricingScheme scenarioRoadPricingScheme =
      ...
      if (scenarioRoadPricingScheme == null) {
        ...
        if (roadPricingScheme != scenarioRoadPricingScheme) {
          throw new RuntimeException(
              "Trying to bind multiple, different RoadPricingSchemes (must be singleton)");
        }
      }
    }
  }
  ...
  /**
   * Provides the {@link RoadPricingScheme} from either the given instance, or read from file using
   * the file specified in the {@link RoadPricingConfigGroup}.
   */
    ...
    public RoadPricingScheme get() {
      ...
      if (scenarioRoadPricingScheme != null) {
        ...
        if (rpConfig.getTollLinksFile() == null) {
          throw new RuntimeException(
              "Road pricing inserted but neither toll links file nor RoadPricingScheme given.  "
                  + "Such an execution path is not allowed.  If you want a base case without toll, "
                  + "construct a zero toll file and insert that. ");
        }
        URL tollLinksFile =
            ConfigGroup.getInputFileURL(this.config.getContext(), rpConfig.getTollLinksFile());
  ...
  static class TravelDisutilityIncludingTollFactoryProvider
      implements Provider<TravelDisutilityFactory> {
    ...
    public TravelDisutilityFactory get() {
      ...
      final TravelDisutilityFactory originalTravelDisutilityFactory =
      ...
      RoadPricingTravelDisutilityFactory travelDisutilityFactory =
          new RoadPricingTravelDisutilityFactory(originalTravelDisutilityFactory, scheme, config);
