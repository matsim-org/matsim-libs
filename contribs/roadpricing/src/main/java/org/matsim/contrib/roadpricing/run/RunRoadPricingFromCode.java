...
/**
 * Basic 'script' to run roadpricing. This example ahows how to, programatically, configure the
 * roadpricing scheme instead of reading it from an XML file.
 */
public class RunRoadPricingFromCode {
  ...
  private static void createCustomRoadPricingScheme(Scenario scenario) {
    ...
    RoadPricingUtils.addLinkSpecificCost(
        scheme,
    ...
    RoadPricingUtils.createAndAddGeneralCost(
        scheme, Time.parseTime("06:00:00"), Time.parseTime("10:00:00"), 10.0);
  }
}
