...
public final class RoadPricingSchemeUsingTollFactor implements RoadPricingScheme {
  ...
  /**
   * @param pricingSchemeFileName the absolute path to the road pricing filename. It is important
   *     that this must be <i>absolute</i> as we do not have the {@link
   *     org.matsim.core.config.Config} to provide context.
   * @param tollFactor the implementation instance of toll factors.
   * @param scenario
   */
  private RoadPricingSchemeUsingTollFactor(
      URL pricingSchemeFileName, TollFactor tollFactor, Scenario scenario) {
  ...
  public static RoadPricingSchemeUsingTollFactor createAndRegisterRoadPricingSchemeUsingTollFactor(
      URL pricingSchemeFileName, TollFactor tollFactor, Scenario scenario) {
  ...
  @Override
  public Cost getLinkCostInfo(
      Id<Link> linkId, double time, Id<Person> personId, Id<Vehicle> vehicleId) {
