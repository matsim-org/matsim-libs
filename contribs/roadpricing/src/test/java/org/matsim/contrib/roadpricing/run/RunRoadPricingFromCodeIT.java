...
public class RunRoadPricingFromCodeIT {
  private static final Logger LOG = LogManager.getLogger(RunRoadPricingFromCodeIT.class);
  private static final String TEST_CONFIG =
      "./test/input/org/matsim/contrib/roadpricing/AvoidTolledRouteTest/config.xml";
