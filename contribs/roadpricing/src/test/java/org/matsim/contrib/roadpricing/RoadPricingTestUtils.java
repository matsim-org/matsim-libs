...
/*package*/ class RoadPricingTestUtils {
  ...
  static void createNetwork1(final MutableScenario scenario) {
    ...
    Node node2 =
        NetworkUtils.createAndAddNode(
            network, Id.create(2, Node.class), new Coord((double) 100, (double) 0));
    Node node3 =
        NetworkUtils.createAndAddNode(
            network, Id.create(3, Node.class), new Coord((double) 200, (double) 0));
    Node node4 =
        NetworkUtils.createAndAddNode(
            network, Id.create(4, Node.class), new Coord((double) 300, (double) 0));
    Node node5 =
        NetworkUtils.createAndAddNode(
            network, Id.create(5, Node.class), new Coord((double) 400, (double) 0));
    Node node6 =
        NetworkUtils.createAndAddNode(
            network, Id.create(6, Node.class), new Coord((double) 500, (double) 0));
  ...
  static void createNetwork2(final MutableScenario scenario) {
    ...
    Node node0 =
        NetworkUtils.createAndAddNode(
            network, Id.create("0", Node.class), new Coord((double) 0, (double) 10));
    Node node1 =
        NetworkUtils.createAndAddNode(
            network, Id.create("1", Node.class), new Coord((double) 0, (double) 100));
    Node node2 =
        NetworkUtils.createAndAddNode(
            network, Id.create("2", Node.class), new Coord((double) 100, (double) 100));
    Node node3 =
        NetworkUtils.createAndAddNode(
            network, Id.create("3", Node.class), new Coord((double) 150, (double) 150));
    Node node4 =
        NetworkUtils.createAndAddNode(
            network, Id.create("4", Node.class), new Coord((double) 200, (double) 100));
    Node node5 =
        NetworkUtils.createAndAddNode(
            network, Id.create("5", Node.class), new Coord((double) 300, (double) 100));
    final double y5 = -100;
    Node node6 =
        NetworkUtils.createAndAddNode(
            network, Id.create("6", Node.class), new Coord((double) 300, y5));
    final double y4 = -100;
    Node node7 =
        NetworkUtils.createAndAddNode(
            network, Id.create("7", Node.class), new Coord((double) 200, y4));
    final double y3 = -150;
    Node node8 =
        NetworkUtils.createAndAddNode(
            network, Id.create("8", Node.class), new Coord((double) 150, y3));
    final double y2 = -100;
    Node node9 =
        NetworkUtils.createAndAddNode(
            network, Id.create("9", Node.class), new Coord((double) 100, y2));
    final double y1 = -100;
    Node node10 =
        NetworkUtils.createAndAddNode(
            network, Id.create("10", Node.class), new Coord((double) 0, y1));
    final double y = -10;
    Node node11 =
        NetworkUtils.createAndAddNode(
            network, Id.create("11", Node.class), new Coord((double) 0, y));
  ...
  static void createPopulation1(final MutableScenario scenario) {
    ...
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            1, "07:00", link0.getId(), NetworkUtils.getLinkIds("1 2 3"), link4.getId()),
        population); // toll in 1st time slot
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            2, "11:00", link0.getId(), NetworkUtils.getLinkIds("1 2 3"), link4.getId()),
        population); // toll in 2nd time slot
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            3, "16:00", link0.getId(), NetworkUtils.getLinkIds("1 2 3"), link4.getId()),
        population); // toll in 3rd time slot
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            4, "09:59:50", link0.getId(), NetworkUtils.getLinkIds("1 2 3"), link4.getId()),
        population); // toll in 1st and 2nd time slot
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            5, "08:00:00", link1.getId(), NetworkUtils.getLinkIds("2 3"), link4.getId()),
        population); // starts on the 2nd link
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            6, "09:00:00", link0.getId(), NetworkUtils.getLinkIds("1 2"), link3.getId()),
        population); // ends not on the last link
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            7, "08:30:00", link1.getId(), NetworkUtils.getLinkIds("2"), link3.getId()),
        population); // starts and ends not on the first/last link
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            8, "08:35:00", link1.getId(), NetworkUtils.getLinkIds(""), link2.getId()),
        population); // starts and ends not on the first/last link
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            9, "08:40:00", link1.getId(), NetworkUtils.getLinkIds(""), link1.getId()),
        population); // two acts on the same link
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson1(
            10, "08:45:00", link2.getId(), NetworkUtils.getLinkIds(""), link3.getId()),
        population);
  }
  ...
  static void createPopulation2(final MutableScenario scenario) {
    ...
    RoadPricingTestUtils.addPersonToPopulation(
        RoadPricingTestUtils.createPerson2(
            1,
            "07:00",
            network.getLinks().get(Id.create("1", Link.class)),
  ...
  private static Person createPerson1(
      ...
      final Id<Link> homeLinkId,
      final List<Id<Link>> routeLinkIds,
      final Id<Link> workLinkId) {
    Person person = PopulationUtils.getFactory().createPerson(Id.create(personId, Person.class));
    Plan plan = PopulationUtils.createPlan(person);
    person.addPlan(plan);
    PopulationUtils.createAndAddActivityFromLinkId(plan, "h", (Id<Link>) homeLinkId)
        .setEndTime(Time.parseTime(startTime));
  ...
  protected static Population createReferencePopulation1(final Config config) {
    ...
    EventsToScore scoring =
        EventsToScore.createWithScoreUpdating(
            scenario, new CharyparNagelScoringFunctionFactory(scenario), events);
