...
public class RoadPricingIOTest {
  ...
  public void testWriteReadWrite() {
    ...
    assertEquals(
        "distance toll for org.matsim.contrib.roadpricing.RoadPricingTestUtils.createNetwork1().",
        scheme1.getDescription());
