...
public class AvoidTolledRouteTest {
	...
	public final void test1(){
		...
		// baseCase
		Config config1 = ConfigUtils.loadConfig( configFile, new RoadPricingConfigGroup());		
		...
		// link-based toll
		Config config2 = ConfigUtils.loadConfig( configFile, new RoadPricingConfigGroup() );		
