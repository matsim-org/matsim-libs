...
/*package*/ class Fixture {
	...
	static void createNetwork1(final MutableScenario scenario) {
		...
		Node node5 = NetworkUtils.createAndAddNode2(network, Id.create(5, Node.class), new Coord((double) 400, (double) 0));
		Node node6 = NetworkUtils.createAndAddNode2(network, Id.create(6, Node.class), new Coord((double) 500, (double) 0));
	...
	static void createNetwork2(final MutableScenario scenario) {
		...
		Node node2 = NetworkUtils.createAndAddNode2(network, Id.create( "2", Node.class), new Coord((double) 100, (double) 100));
		Node node3 = NetworkUtils.createAndAddNode2(network, Id.create( "3", Node.class), new Coord((double) 150, (double) 150));
		Node node4 = NetworkUtils.createAndAddNode2(network, Id.create( "4", Node.class), new Coord((double) 200, (double) 100));
		Node node5 = NetworkUtils.createAndAddNode2(network, Id.create( "5", Node.class), new Coord((double) 300, (double) 100));
		final double y5 = -100;
		Node node6 = NetworkUtils.createAndAddNode2(network, Id.create( "6", Node.class), new Coord((double) 300, y5));
		final double y4 = -100;
		Node node7 = NetworkUtils.createAndAddNode2(network, Id.create( "7", Node.class), new Coord((double) 200, y4));
		final double y3 = -150;
		Node node8 = NetworkUtils.createAndAddNode2(network, Id.create( "8", Node.class), new Coord((double) 150, y3));
		final double y2 = -100;
		Node node9 = NetworkUtils.createAndAddNode2(network, Id.create( "9", Node.class), new Coord((double) 100, y2));
		final double y1 = -100;
		Node node10 =NetworkUtils.createAndAddNode2(network, Id.create("10", Node.class), new Coord((double) 0, y1));
		final double y = -10;
		Node node11 =NetworkUtils.createAndAddNode2(network, Id.create("11", Node.class), new Coord((double) 0, y));
