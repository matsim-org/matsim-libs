...
public class DecongestionPricingTestIT {
  ...
  public final void test0a() {
    ...
    double tt0 =
        controler
            .getLinkTravelTimes()
            .getLinkTravelTime(
                scenario.getNetwork().getLinks().get(Id.createLinkId("link12")),
                6 * 3600 + 50. * 60,
                null,
                null);
    double tt1 =
    ...
    Assert.assertEquals(
        "Wrong travel time. The run output seems to have changed.",
        100.0,
        tt0,
    ...
    final int index =
        config.controller().getLastIteration() - config.controller().getFirstIteration();
    double avgScore =
        controler.getScoreStats().getScoreHistory().get(ScoreItem.executed).get(index);
    Assert.assertEquals(
        "Wrong average executed score. The tolls seem to have changed.",
        -33.940316666666666,
        avgScore,
        MatsimTestUtils.EPSILON);

    System.out.println(
        info.getlinkInfos().get(Id.createLinkId("link12")).getTime2toll().toString());
    System.out.println(
        info.getlinkInfos().get(Id.createLinkId("link12")).getTime2avgDelay().toString());

    Assert.assertEquals(
        "Wrong average delay (capacity is set in a way that one of the two agents has to wait 101 sec. Thus the average is 50.5",
        50.5,
        info.getlinkInfos().get(Id.createLinkId("link12")).getTime2avgDelay().get(84),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Wrong toll.",
        50.5 * 0.0123,
        info.getlinkInfos().get(Id.createLinkId("link12")).getTime2toll().get(84),
        MatsimTestUtils.EPSILON);
  }
  ...
  public final void test0c() {
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertNull(
        "Wrong toll.", info.getlinkInfos().get(Id.createLinkId("link12")).getTime2toll().get(84));
  }
  ...
  public final void test1() {
    ...
    double avgScore =
        controler.getScoreStats().getScoreHistory().get(ScoreItem.executed).get(index);
    Assert.assertEquals(
        "Wrong average executed score. The run output seems to have changed.",
        -12036.177448472225,
        avgScore,
        MatsimTestUtils.EPSILON);
    ...
    System.out.println(
        info.getlinkInfos().get(Id.createLinkId("link12")).getTime2toll().toString());
    Assert.assertEquals(
        "Wrong toll in time bin 61.",
        9.197000000000003,
        info.getlinkInfos().get(Id.createLinkId("link12")).getTime2toll().get(61),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "Wrong toll in time bin 73.",
        12.963999999999984,
        info.getlinkInfos().get(Id.createLinkId("link12")).getTime2toll().get(73),
        MatsimTestUtils.EPSILON);
  }
