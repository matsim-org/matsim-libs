...
/**
 * Keeps track of which vehicle is used by which person. Stores the last person who has entered the
 * vehicle and ignores transit vehicles.
 *
 * @author ikaddoura
 */
public class PersonVehicleTracker
    implements PersonEntersVehicleEventHandler, TransitDriverStartsEventHandler {
