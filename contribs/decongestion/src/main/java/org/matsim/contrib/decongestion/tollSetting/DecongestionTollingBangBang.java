...
/**
 * - If d > threshold: Increase the toll: + adjustment value - If d <= threshold: Decrease the toll:
 * - adjustment value
 *
 * @author ikaddoura
 */
public class DecongestionTollingBangBang implements DecongestionTollSetting {
  ...
  public void updateTolls() {
    ...
    final double toleratedAverageDelay =
        this.congestionInfo.getDecongestionConfigGroup().getToleratedAverageDelaySec();
    final double tollAdjustment =
        this.congestionInfo.getDecongestionConfigGroup().getTollAdjustment();
