...
/**
 * Contains the input parameters, e.g. how often the interval-based output is written out, the
 * number of iterations for which the price is kept constant, ...
 *
 * @author ikaddoura
 */
public class DecongestionConfigGroup extends ReflectiveConfigGroup {
  ...
  private static final String FRACTION_OF_ITERATIONS_TO_END_PRICE_ADJUSTMENT =
      "fractionOfIterationsToEndPriceAdjustment";
  private static final String TOLL_BLEND_FACTOR = "tollBlendFactor";
  private static final String INITIAL_TOLL = "initialToll";
  private static final String FRACTION_OF_ITERATIONS_TO_START_PRICE_ADJUSTMENT =
      "fractionOfIterationsToStartPriceAdjustment";
  ...
  private static final String INTEGRAL_APPROACH_UNUSED_HEADWAY_FACTOR =
      "integralApproachUnusedHeadwayFactor";
  ...
  private double fractionOfIterationsToStartPriceAdjustment =
      0.1; // set above 0.0 to disable pricing in the previous iterations
  private double fractionOfIterationsToEndPriceAdjustment =
      1.0; // set below 1.0 to disable price adjustment for final iterations
  ...
  public void setFractionOfIterationsToEndPriceAdjustment(
      double fRACTION_OF_ITERATIONS_TO_END_PRICE_ADJUSTMENT) {
