 ...
 *
 * <p>More info: <a href="http://en.wikipedia.org/wiki/Partial_sorting">Partial sorting</a>
 *
 * @param <T>
...
public class PartialSort<T> {
  ...
  @Nullable private final PriorityQueue<T> kSmallestElements; // descending order: from k-th to 1-st
   ...
   *
   * <p>SIDE EFFECT: elements are removed from the queue.
   *
