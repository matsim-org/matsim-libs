...
public class PartialSortTest {
  ...
  public void reversedComparator_largestElementsSelected() {
    assertThat(kSmallestElements(1, Stream.of(7, 1, 4, 9, 8), comparator.reversed()))
        .containsExactly(9);
    assertThat(kSmallestElements(3, Stream.of(7, 1, 4, 9, 8), comparator.reversed()))
  ...
  public void moreThenKElementsProvided() {
    ...
    assertThat(kSmallestElements(3, Stream.of(13, 7, 1, 55, 4, 9, 8, 11), comparator))
