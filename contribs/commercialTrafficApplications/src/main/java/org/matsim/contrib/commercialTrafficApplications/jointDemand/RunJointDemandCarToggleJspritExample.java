...
class RunJointDemandCarToggleJspritExample {
  ...
  private static final Logger log =
      LogManager.getLogger(RunJointDemandCarToggleJspritExample.class);
  ...
  private static void prepareConfig(Config config) {
    ...
    ReplanningConfigGroup.StrategySettings changeJobOperator =
        new ReplanningConfigGroup.StrategySettings();
    ...
    config
        .controller()
        .setOutputDirectory(
            "output/commercialTrafficApplications/jointDemand/RunJointDemandCarToggleJspritExample");
    config
        .controller()
