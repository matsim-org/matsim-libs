...
public class JointDemandConfigGroup extends ReflectiveConfigGroup {
  ...
  @Positive private double firstLegTraveltimeBufferFactor = 2.0;
  public static final String FIRSTLEGBUFFER = "firstLegBufferFactor";
  private static final String FIRSTLEGBUFFERDESC =
      "Buffer travel time factor for the first leg of a freight tour.";

  public static final String MAXJOBSCORE = "maxJobScore";

  @Positive private double zeroUtilityDelay = 1800;
  public static final String ZEROUTILDELAY = "zeroUtilityDelay";
  private static final String ZEROUTILDELAYDESC =
      "Delay (in seconds) that marks the threshold for zero utility";
  ...
  private static final String MINJOBSCOREDESC =
      "Minimum score for delayed commercial jobs. "
  ...
  @Positive private double maxJobScore = 6;
  private double minJobScore = -6;

  public static final String CHANGEOPERATORINTERVAL = "changeOperatorInterval";
  public static final String CHANGEOPERATORINTERVALDESC =
      ChangeCommercialJobOperator.SELECTOR_NAME
  ...
  @PositiveOrZero private int changeOperatorInterval = 0;
