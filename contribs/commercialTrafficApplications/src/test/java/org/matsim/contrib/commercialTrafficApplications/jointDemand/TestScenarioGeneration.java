...
public class TestScenarioGeneration {
  ...
  public static Scenario generateScenario() {
    ...
    Config config =
        loadConfig("./scenarios/grid/jointDemand_config.xml", new JointDemandConfigGroup());
  ...
  public static Carriers generateCarriers() {
    ...
    italianPizzaPlace
        .getAttributes()
        .putAttribute(JointDemandUtils.CARRIER_MARKET_ATTRIBUTE_NAME, "pizza");

    Carrier americanPizzaPlace =
        CarrierImpl.newInstance(Id.create("pizza_american", Carrier.class));
    ...
    shopping_1
        .getAttributes()
        .putAttribute(JointDemandUtils.CARRIER_MARKET_ATTRIBUTE_NAME, "shopping");
    ...
    CarrierVehicle v =
        getLightVehicle(italianPizzaPlace.getId(), type, Id.createLinkId(111), "one");
  ...
  private static void addPopulation(Scenario scenario) {
    ...
    work.getAttributes()
        .putAttribute(
            JointDemandUtils.COMMERCIALJOB_ATTRIBUTE_NAME + "1",
            List.of(
                "pizza_italian", "1", String.valueOf(12 * 3600), String.valueOf(13 * 3600), "180"));
  ...
  private static CarrierVehicle getLightVehicle(
      Id<?> id, VehicleType type, Id<Link> homeId, String depot) {
    CarrierVehicle.Builder vBuilder =
        CarrierVehicle.Builder.newInstance(
            Id.create((id.toString() + "_lightVehicle_" + depot), Vehicle.class), homeId, type);
