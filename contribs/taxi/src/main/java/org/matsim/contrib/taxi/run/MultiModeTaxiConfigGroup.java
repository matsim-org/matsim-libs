 ...
 */
public final class MultiModeTaxiConfigGroup extends ReflectiveConfigGroup
    implements MultiModal<TaxiConfigGroup> {
  ...
  protected void checkConsistency(Config config) {
    ...
    Verify.verify(
        config.getModule(TaxiConfigGroup.GROUP_NAME) == null,
