...
public abstract class AbstractTaxiOptimizerParams extends ReflectiveConfigGroup {
  ...
  protected static final String REOPTIMIZATION_TIME_STEP_EXP =
      "Specifies how often the reoptimization algorithm is executed."
  ...
  protected AbstractTaxiOptimizerParams(
      String paramSetName, boolean doUnscheduleAwaitingRequests, boolean doUpdateTimelines) {
    super(paramSetName);
