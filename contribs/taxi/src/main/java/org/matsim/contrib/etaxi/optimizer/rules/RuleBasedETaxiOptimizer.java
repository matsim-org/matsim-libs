...
public class RuleBasedETaxiOptimizer extends RuleBasedTaxiOptimizer {
	public static RuleBasedETaxiOptimizer create(EventsManager eventsManager, TaxiConfigGroup taxiCfg, Fleet fleet,
			ETaxiScheduler eScheduler, ScheduleUpdater scheduleUpdater, Network network, MobsimTimer timer, TravelTime travelTime,
		...
		double cellSize = ((RuleBasedETaxiOptimizerParams)taxiCfg.getTaxiOptimizerParams()).getRuleBasedTaxiOptimizerParams()
				.getCellSize();
		return RuleBasedETaxiOptimizer.create(eventsManager, taxiCfg, fleet, eScheduler,  scheduleUpdater, network, timer, travelTime,
	...
	public static RuleBasedETaxiOptimizer create(EventsManager eventsManager, TaxiConfigGroup taxiCfg, Fleet fleet,
		...
		return new RuleBasedETaxiOptimizer(eventsManager, taxiCfg, fleet, eScheduler, scheduleUpdater, chargingInfrastructure,
	...
	public RuleBasedETaxiOptimizer(EventsManager eventsManager, TaxiConfigGroup taxiCfg, Fleet fleet,
		...
		super(eventsManager, taxiCfg, fleet, eScheduler, scheduleUpdater, idleTaxiRegistry, unplannedRequestRegistry, requestInserter);
