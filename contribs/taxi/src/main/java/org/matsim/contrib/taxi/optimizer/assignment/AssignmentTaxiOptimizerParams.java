...
public final class AssignmentTaxiOptimizerParams extends AbstractTaxiOptimizerParams {
  ...
  @Parameter
  @Comment(
      "Specifies the formula used to calculate assgnment cost."
  ...
  @Parameter
  @Comment(
      "Vehicle planning horizon in the case of oversupply."
  ...
  @Parameter
  @Comment(
      "Vehicle planning horizon in the case of undersupply."
          + " Only vehicles available within the time horizon are considered in the assignment procedure."
          + " The value should not be smaller than 'reoptimizationTimeStep'."
  ...
  @Parameter
  @Comment(
      "Limits the number of open requests considered in"
  ...
  @Parameter
  @Comment(
      "Limits the number of available vehicles considered in"
  ...
  @Parameter
  @Comment(
      "Specifies the cost for vehicle-request pairs not included in the matrix"
  ...
  protected void checkConsistency(Config config) {
    ...
    if (vehPlanningHorizonUndersupply < getReoptimizationTimeStep()
      ...
      throw new RuntimeException(
          "'vehPlanningHorizonUndersupply' and 'vehPlanningHorizonOversupply'"
