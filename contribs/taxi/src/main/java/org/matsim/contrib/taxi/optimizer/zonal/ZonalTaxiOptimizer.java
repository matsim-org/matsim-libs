...
public class ZonalTaxiOptimizer extends RuleBasedTaxiOptimizer {
	public static ZonalTaxiOptimizer create(EventsManager eventsManager, TaxiConfigGroup taxiCfg, Fleet fleet,
			TaxiScheduler scheduler, ScheduleUpdater scheduleUpdater, Network network, MobsimTimer timer, TravelTime travelTime,
		...
		double cellSize = ((ZonalTaxiOptimizerParams)taxiCfg.getTaxiOptimizerParams()).getRuleBasedTaxiOptimizerParams()
				.getCellSize();
		return create(eventsManager, taxiCfg, fleet, scheduler, scheduleUpdater, network, timer, travelTime, travelDisutility,
	...
	public static ZonalTaxiOptimizer create(EventsManager eventsManager, TaxiConfigGroup taxiCfg, Fleet fleet,
		...
		return new ZonalTaxiOptimizer(eventsManager, taxiCfg, fleet, scheduler, scheduleUpdater, idleTaxiRegistry,
	...
	public ZonalTaxiOptimizer(EventsManager eventsManager, TaxiConfigGroup taxiCfg, Fleet fleet,
							  TaxiScheduler scheduler, ScheduleUpdater scheduleUpdater,  IdleTaxiZonalRegistry idleTaxiRegistry,
							  UnplannedRequestZonalRegistry unplannedRequestRegistry, ZonalRequestInserter requestInserter) {
		super(eventsManager, taxiCfg, fleet, scheduler, scheduleUpdater, idleTaxiRegistry, unplannedRequestRegistry, requestInserter);
	}
}
