...
/* *********************************************************************** *
 * project: org.matsim.*
 * TaxiExamplesAnalysisMainModeIdentifier.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
 ...
 *
 */
public final class TaxiExamplesAnalysisMainModeIdentifier implements AnalysisMainModeIdentifier {

	private static final Logger log = LogManager.getLogger(TaxiExamplesAnalysisMainModeIdentifier.class);

	private final List<String> modeHierarchy = new ArrayList<>() ;

	public TaxiExamplesAnalysisMainModeIdentifier() {
		...
		modeHierarchy.add( "taxi_A" ) ;
		modeHierarchy.add( "taxi_B" ) ;
		modeHierarchy.add( "taxi_C" ) ;
