...
public final class RuleBasedTaxiOptimizerParams extends AbstractTaxiOptimizerParams {
  ...
  @Parameter
  @Comment(
      "Limits the number of open requests considered during"
  ...
  @Parameter
  @Comment(
      "Limits the number of idle vehicles considered during"
  ...
  @Parameter
  @Comment(
      "The side length of square zones used in zonal registers of idle vehicles"
