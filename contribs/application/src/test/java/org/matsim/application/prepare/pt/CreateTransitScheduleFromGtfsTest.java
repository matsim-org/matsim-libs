...
public class CreateTransitScheduleFromGtfsTest {
  ...
  public void run() {
    ...
    // Just test for execution without exception, the given parameter may not lead to sensible
    // results
    new CreateTransitScheduleFromGtfs()
        .execute(
    ...
    Assertions.assertThat(Path.of(output))
        ...
        .isDirectoryContaining(
            p -> p.getFileName().toString().equals("test-transitSchedule.xml.gz"));
  }
}
