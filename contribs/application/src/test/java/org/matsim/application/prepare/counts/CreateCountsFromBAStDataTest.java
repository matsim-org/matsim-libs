...
public class CreateCountsFromBAStDataTest {
  ...
  String network =
      IOUtils.extendUrl(ExamplesUtils.getTestScenarioURL("berlin"), "network.xml.gz").toString();
  ...
  public void testManualMatchedCounts() {
    ...
    Map<Id<Link>, String> manual =
        Map.of(Id.createLinkId("4205"), "Neukölln_N", Id.createLinkId("4219"), "Neukölln_S");
