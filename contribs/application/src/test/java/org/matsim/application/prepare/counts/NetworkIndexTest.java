...
public class NetworkIndexTest {
  ...
  public void angle() {
    ...
    assertThat(angle).isEqualTo(Math.PI);
    ...
    assertThat(angle).isEqualTo(-Math.PI / 2);
    ...
    assertThat(angle).isCloseTo(-0.1, Offset.offset(0.001));
    ...
    assertThat(angle).isCloseTo(-Math.PI + 0.1, Offset.offset(0.001));
  }
}
