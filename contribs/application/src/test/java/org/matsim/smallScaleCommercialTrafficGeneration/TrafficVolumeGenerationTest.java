...
public class TrafficVolumeGenerationTest {
  ...
  public void testTrafficVolumeGenerationCommercialPersonTraffic() throws IOException {
    ...
    double sample = 1.;
    ArrayList<String> modesORvehTypes = new ArrayList<>(List.of("total"));
    ...
    HashMap<TrafficVolumeKey, Object2DoubleMap<Integer>> trafficVolumePerTypeAndZone_start =
        TrafficVolumeGeneration.createTrafficVolume_start(
            resultingDataPerZone, output, sample, modesORvehTypes, usedTrafficType);
    ...
    for (String zone : resultingDataPerZone.keySet()) {
      TrafficVolumeKey trafficVolumeKey =
          TrafficVolumeGeneration.makeTrafficVolumeKey(zone, modesORvehTypes.get(0));
    ...
    TrafficVolumeKey trafficVolumeKey =
        TrafficVolumeGeneration.makeTrafficVolumeKey("testArea1_area1", modesORvehTypes.get(0));
    Assert.assertEquals(
        30,
        trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(1),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        124,
        trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(2),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        277,
        trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(3),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        175,
        trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(4),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        250,
        trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(5),
        MatsimTestUtils.EPSILON);

    Assert.assertEquals(
        10,
        trafficVolumePerTypeAndZone_stop.get(trafficVolumeKey).getDouble(1),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        105,
        trafficVolumePerTypeAndZone_stop.get(trafficVolumeKey).getDouble(2),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        426,
        trafficVolumePerTypeAndZone_stop.get(trafficVolumeKey).getDouble(3),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        121,
        trafficVolumePerTypeAndZone_stop.get(trafficVolumeKey).getDouble(4),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        65,
        trafficVolumePerTypeAndZone_stop.get(trafficVolumeKey).getDouble(5),
        MatsimTestUtils.EPSILON);

    trafficVolumeKey =
        TrafficVolumeGeneration.makeTrafficVolumeKey("testArea1_area2", modesORvehTypes.get(0));
    Assert.assertEquals(
        30,
        trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(1),
        MatsimTestUtils.EPSILON);
    ...
    trafficVolumeKey =
        TrafficVolumeGeneration.makeTrafficVolumeKey("testArea2_area3", modesORvehTypes.get(0));
    Assert.assertEquals(
        6,
        trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(1),
        MatsimTestUtils.EPSILON);
  ...
  public void testTrafficVolumeGenerationGoodsTraffic() throws IOException {
    ...
    for (String zone : resultingDataPerZone.keySet()) {
      for (String modesORvehType : modesORvehTypes) {
        TrafficVolumeKey trafficVolumeKey =
            TrafficVolumeGeneration.makeTrafficVolumeKey(zone, modesORvehType);
        Assert.assertTrue(trafficVolumePerTypeAndZone_start.containsKey(trafficVolumeKey));
        Assert.assertTrue(trafficVolumePerTypeAndZone_stop.containsKey(trafficVolumeKey));
      }
    }
    ...
    for (int i = 1; i < 7; i++) {
      ...
      for (String modeORvehType : modesORvehTypes) {
        TrafficVolumeKey trafficVolumeKey =
            TrafficVolumeGeneration.makeTrafficVolumeKey("testArea1_area1", modeORvehType);
        ...
        if (modeORvehType.equals("vehTyp1")) {
          ...
          Assert.assertEquals(
              0,
              trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(6),
              MatsimTestUtils.EPSILON);
          ...
          Assert.assertEquals(
              0,
              trafficVolumePerTypeAndZone_stop.get(trafficVolumeKey).getDouble(6),
              MatsimTestUtils.EPSILON);
        }
    ...
    for (int i = 1; i < 7; i++) {
      ...
      for (String modeORvehType : modesORvehTypes) {
        TrafficVolumeKey trafficVolumeKey =
            TrafficVolumeGeneration.makeTrafficVolumeKey("testArea1_area2", modeORvehType);
        sumStart += trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(i);
        sumStop += trafficVolumePerTypeAndZone_stop.get(trafficVolumeKey).getDouble(i);
      }
      Assert.assertEquals(estimatesStart.get(i), sumStart, MatsimTestUtils.EPSILON);
    ...
    for (int i = 1; i < 7; i++) {
      ...
      for (String modeORvehType : modesORvehTypes) {
        TrafficVolumeKey trafficVolumeKey =
            TrafficVolumeGeneration.makeTrafficVolumeKey("testArea2_area3", modeORvehType);
        sumStart += trafficVolumePerTypeAndZone_start.get(trafficVolumeKey).getDouble(i);
        sumStop += trafficVolumePerTypeAndZone_stop.get(trafficVolumeKey).getDouble(i);
      }
      Assert.assertEquals(estimatesStart.get(i), sumStart, MatsimTestUtils.EPSILON);
  ...
  public void testAddingExistingScenarios() throws Exception {
    ...
    Map<String, HashMap<Id<Link>, Link>> regionLinksMap =
        GenerateSmallScaleCommercialTrafficDemand.filterLinksForZones(
            scenario,
            shpZones,
            SmallScaleCommercialTrafficUtils.getIndexZones(
                shapeFileZonePath, config.global().getCoordinateSystem()),
            buildingsPerZone);

    SmallScaleCommercialTrafficUtils.readExistingModels(scenario, sample, regionLinksMap);

    Assert.assertEquals(
        3, CarriersUtils.getCarriers(scenario).getCarriers().size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1,
        CarriersUtils.getCarrierVehicleTypes(scenario).getVehicleTypes().size(),
        MatsimTestUtils.EPSILON);
    Assert.assertTrue(
        CarriersUtils.getCarriers(scenario)
            .getCarriers()
            .containsKey(Id.create("exampleServiceCarrier_carrier1", Carrier.class)));
    Assert.assertTrue(
        CarriersUtils.getCarriers(scenario)
            .getCarriers()
            .containsKey(Id.create("exampleServiceCarrier_carrier2", Carrier.class)));
    Assert.assertTrue(
        CarriersUtils.getCarriers(scenario)
            .getCarriers()
            .containsKey(Id.create("exampleShipmentCarrier_carrier1", Carrier.class)));

    Carrier addedCarrier1 =
        CarriersUtils.getCarriers(scenario)
            .getCarriers()
            .get(Id.create("exampleServiceCarrier_carrier1", Carrier.class));
    Assert.assertNotNull(addedCarrier1.getSelectedPlan());
    Assert.assertEquals(
        0, CarriersUtils.getJspritIterations(addedCarrier1), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1,
        addedCarrier1.getCarrierCapabilities().getCarrierVehicles().size(),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1,
        addedCarrier1.getCarrierCapabilities().getVehicleTypes().size(),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        3, addedCarrier1.getSelectedPlan().getScheduledTours().size(), MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        "commercialPersonTraffic", addedCarrier1.getAttributes().getAttribute("subpopulation"));
    Assert.assertEquals(2, (int) addedCarrier1.getAttributes().getAttribute("purpose"));
    Assert.assertEquals(
        "exampleServiceCarrier", addedCarrier1.getAttributes().getAttribute("existingModel"));
    ...
    Assert.assertEquals(
        "testArea2_area3", addedCarrier1.getAttributes().getAttribute("tourStartArea"));

    Carrier addedCarrier2 =
        CarriersUtils.getCarriers(scenario)
            .getCarriers()
            .get(Id.create("exampleServiceCarrier_carrier2", Carrier.class));
    Assert.assertNotNull(addedCarrier2.getSelectedPlan());
    Assert.assertEquals(
        0, CarriersUtils.getJspritIterations(addedCarrier2), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1,
        addedCarrier2.getCarrierCapabilities().getCarrierVehicles().size(),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1,
        addedCarrier2.getCarrierCapabilities().getVehicleTypes().size(),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        2, addedCarrier2.getSelectedPlan().getScheduledTours().size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(20, addedCarrier2.getServices().size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        "commercialPersonTraffic", addedCarrier2.getAttributes().getAttribute("subpopulation"));
    Assert.assertEquals(2, (int) addedCarrier2.getAttributes().getAttribute("purpose"));
    Assert.assertEquals(
        "exampleServiceCarrier", addedCarrier2.getAttributes().getAttribute("existingModel"));
    ...
    Assert.assertEquals(
        "testArea2_area3", addedCarrier2.getAttributes().getAttribute("tourStartArea"));

    Carrier addedCarrier3 =
        CarriersUtils.getCarriers(scenario)
            .getCarriers()
            .get(Id.create("exampleShipmentCarrier_carrier1", Carrier.class));
    Assert.assertNull(addedCarrier3.getSelectedPlan());
    Assert.assertEquals(
        50, CarriersUtils.getJspritIterations(addedCarrier3), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1,
        addedCarrier3.getCarrierCapabilities().getCarrierVehicles().size(),
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1,
        addedCarrier3.getCarrierCapabilities().getVehicleTypes().size(),
        MatsimTestUtils.EPSILON);
  ...
  public void testAddingExistingScenariosWithSample() throws Exception {
    ...
    Assert.assertEquals(
        2, CarriersUtils.getCarriers(scenario).getCarriers().size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1,
        CarriersUtils.getCarrierVehicleTypes(scenario).getVehicleTypes().size(),
        MatsimTestUtils.EPSILON);
    ...
    Assert.assertEquals(
        ...
        MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1, addedCarrier1.getSelectedPlan().getScheduledTours().size(), MatsimTestUtils.EPSILON);
  ...
  @Test
  public void testReducingDemandAfterAddingExistingScenarios_commercialPersonTraffic()
      throws Exception {
    HashMap<String, ArrayList<String>> landuseCategoriesAndDataConnection = new HashMap<>();
    HashMap<String, HashMap<String, ArrayList<SimpleFeature>>> buildingsPerZone = new HashMap<>();
    ...
    // because the reduction of the start volume in zone3 (purpose 2) is higher than the value, a
    // start reduction will be distributed over other zones
