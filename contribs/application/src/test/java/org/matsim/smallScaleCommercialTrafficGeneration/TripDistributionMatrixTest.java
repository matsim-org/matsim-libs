...
public class TripDistributionMatrixTest {
  ...
  public void testTripDistributionCommercialPersonTrafficTraffic() throws IOException {
    ...
    ArrayList<String> modesORvehTypes = new ArrayList<String>(List.of("total"));
    ...
    regionLinksMap
        .get("testArea1_area1")
        .put(Id.createLinkId("i(8,6)"), network.getLinks().get(Id.createLinkId("i(8,6)")));
    regionLinksMap.put("testArea1_area2", new HashMap<>());
    regionLinksMap
        .get("testArea1_area2")
        .put(Id.createLinkId("i(2,7)R"), network.getLinks().get(Id.createLinkId("i(2,7)R")));
    regionLinksMap.put("testArea2_area3", new HashMap<>());
    regionLinksMap
        .get("testArea2_area3")
        .put(Id.createLinkId("i(2,1)R"), network.getLinks().get(Id.createLinkId("i(2,7)R")));
    ...
    for (String zone : resultingDataPerZone.keySet()) {
      for (String modeORvehType : modesORvehTypes) {
        ...
        for (Integer purpose : trafficVolumePerTypeAndZone_start.get(key).keySet()) {
          int generatedVolume =
              odMatrix.getSumOfServicesForStopZone(zone, modeORvehType, purpose, usedTrafficType);
          sumStopServices += generatedVolume;
          sumStartServices +=
              odMatrix.getSumOfServicesForStartZone(zone, modeORvehType, purpose, usedTrafficType);
  ...
  public void testTripDistributionGoodsTraffic() throws IOException {
    ...
    ArrayList<String> modesORvehTypes =
        new ArrayList<String>(Arrays.asList("vehTyp1", "vehTyp2", "vehTyp3", "vehTyp4", "vehTyp5"));
    TrafficVolumeGeneration.setInputParameters(usedTrafficType);
