  ...
  public void testReadOfDataDistributionPerZoneAndBuildingAnalysis() throws IOException {
    ...
    for (String zone : resultingDataPerZone.keySet()) {
      ...
      if (zone.equals("testArea1_area1")) {
        Assert.assertEquals(
            4000, resultingDataPerZone.get(zone).getDouble("Inhabitants"), MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            3500, resultingDataPerZone.get(zone).getDouble("Employee"), MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            0,
            resultingDataPerZone.get(zone).getDouble("Employee Primary Sector"),
            MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            500,
            resultingDataPerZone.get(zone).getDouble("Employee Construction"),
            MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            500,
            resultingDataPerZone.get(zone).getDouble("Employee Secondary Sector Rest"),
            MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            1000,
            resultingDataPerZone.get(zone).getDouble("Employee Retail"),
            MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            500,
            resultingDataPerZone.get(zone).getDouble("Employee Traffic/Parcels"),
            MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            1000,
            resultingDataPerZone.get(zone).getDouble("Employee Tertiary Sector Rest"),
            MatsimTestUtils.EPSILON);
      }
      if (zone.equals("testArea1_area2")) {
        Assert.assertEquals(
            4000, resultingDataPerZone.get(zone).getDouble("Inhabitants"), MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            6500, resultingDataPerZone.get(zone).getDouble("Employee"), MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            500,
            resultingDataPerZone.get(zone).getDouble("Employee Primary Sector"),
            MatsimTestUtils.EPSILON);
      ...
      if (zone.equals("testArea2_area3")) {
        Assert.assertEquals(
            800, resultingDataPerZone.get(zone).getDouble("Inhabitants"), MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            1000, resultingDataPerZone.get(zone).getDouble("Employee"), MatsimTestUtils.EPSILON);
        Assert.assertEquals(
            50,
            resultingDataPerZone.get(zone).getDouble("Employee Primary Sector"),
            MatsimTestUtils.EPSILON);
    ...
    // test for area1
    HashMap<String, ArrayList<SimpleFeature>> builingsPerArea1 =
        buildingsPerZone.get("testArea1_area1");
    ...
    Assert.assertEquals(
        1, builingsPerArea1.get("Employee Construction").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1, builingsPerArea1.get("Employee Secondary Sector Rest").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(2, builingsPerArea1.get("Employee Retail").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1, builingsPerArea1.get("Employee Traffic/Parcels").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        2, builingsPerArea1.get("Employee Tertiary Sector Rest").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(6, builingsPerArea1.get("Employee").size(), MatsimTestUtils.EPSILON);

    // test for area2
    HashMap<String, ArrayList<SimpleFeature>> builingsPerArea2 =
        buildingsPerZone.get("testArea1_area2");
    ...
    Assert.assertEquals(
        1, builingsPerArea2.get("Employee Primary Sector").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1, builingsPerArea2.get("Employee Construction").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1, builingsPerArea2.get("Employee Secondary Sector Rest").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        2, builingsPerArea2.get("Employee Traffic/Parcels").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        2, builingsPerArea2.get("Employee Tertiary Sector Rest").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(8, builingsPerArea2.get("Employee").size(), MatsimTestUtils.EPSILON);

    // test for area3
    HashMap<String, ArrayList<SimpleFeature>> builingsPerArea3 =
        buildingsPerZone.get("testArea2_area3");
    ...
    Assert.assertEquals(
        1, builingsPerArea3.get("Employee Primary Sector").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1, builingsPerArea3.get("Employee Construction").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1, builingsPerArea3.get("Employee Secondary Sector Rest").size(), MatsimTestUtils.EPSILON);
    Assert.assertEquals(
        1, builingsPerArea3.get("Employee Traffic/Parcels").size(), MatsimTestUtils.EPSILON);
