...
public class FreightDemandGenerationUtilsTest {
  ...
  public void testPreparePopulation() {
    ...
    FreightDemandGenerationUtils.preparePopulation(
        population, 1.0, 1.0, "changeNumberOfLocationsWithDemand");
    ...
    Assert.assertEquals(
        ...
        population.getAttributes().getAttribute("samplingOption"));
  ...
  public void testCheckPositionInShape_point() {
    ...
    Assert.assertTrue(
        FreightDemandGenerationUtils.checkPositionInShape(
            null, point, polygonsInShape, null, null));
    Assert.assertTrue(
        FreightDemandGenerationUtils.checkPositionInShape(
            null, point, polygonsInShape, new String[] {"area1"}, null));
    Assert.assertFalse(
        FreightDemandGenerationUtils.checkPositionInShape(
            null, point, polygonsInShape, new String[] {"area2"}, null));
