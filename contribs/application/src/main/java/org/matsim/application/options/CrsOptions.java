...
public final class CrsOptions {
  ...
  @CommandLine.Option(
      names = "--target-crs",
      description = "Target coordinate system of the output")
  ...
  public CoordinateTransformation getTransformation() {
    if (inputCRS == null) throw new IllegalArgumentException(("inputCRS not specified!"));

    if (targetCRS == null) throw new IllegalArgumentException(("targetCRS not specified!"));
