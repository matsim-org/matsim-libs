...
public class GermanNutsTransformation {
  ...
  private void generateTransformationMap() {
    ...
    System.out.println(
        "There are "
            + germanNuts2021Lv3Features.size()
            + " NUTS-3 regions in the new shape file (2021 version)");
    ...
    for (SimpleFeature feature2006 : oldFeatures) {
      ...
      if (germanNuts2021Lv3Features.containsKey(oldNutsId)
          && germanNuts2021Lv3Features
              .get(oldNutsId)
              .getAttribute("NUTS_NAME")
              .toString()
              .equals(oldNutsName)) {
        nuts2006To2021Mapping.put(
            oldNutsId, oldNutsId); // NUTS region remains the same (mapping to itself)
      } else {
        counter++;
          ...
          if (geometry2021Candidate.contains(MGC.coordinate2Point(MGC.coord2Coordinate(coord)))) {
            ...
            System.out.println(
                "Old NUTS ID:"
                    + oldNutsId
                    + " Old NUTS name = "
                    + feature2006.getAttribute("NUTS_NAME"));
            System.out.println(
                "New NUTS ID: "
                    + nutsId2021
                    + " New NUTS name = "
                    + feature2021.getAttribute("NUTS_NAME"));
            System.out.println("=====================================================");
          }
        }
      }
  ...
  public static void main(String[] args) {
    String german2006shp =
        "/Users/luchengqi/Documents/MATSimScenarios/GermanFreight/to-put-on-public-svn/raw-data/NUTS3/NUTS3_2010_DE.shp"; // TODO
    String nuts2021shp =
        "/Users/luchengqi/Documents/MATSimScenarios/GermanFreight/NUTS_RG_20M_2016_4326.shp/NUTS_RG_20M_2016_4326.shp";
    ShpOptions oldShapeFile =
        new ShpOptions(Path.of(german2006shp), "EPSG:5677", StandardCharsets.UTF_8);
    ShpOptions shapeFile2021 =
        new ShpOptions(Path.of(nuts2021shp), "EPSG:4326", StandardCharsets.UTF_8);
    GermanNutsTransformation germanNutsTransformation =
        new GermanNutsTransformation(oldShapeFile, shapeFile2021);
    ...
    System.out.println(
        "There are "
            + getCounter()
            + " NUTS regions that has been changed from 2006 version to 2021 version. "
