...
public final class CsvOptions {
  ...
  @CommandLine.Option(
      names = "--csv-charset",
      description = "CSV input encoding",
      defaultValue = "UTF8")
  ...
  public CSVFormat getFormat() {
    ...
    if (csvDelimiter != null) format = format.withDelimiter(csvDelimiter);
  ...
  public CSVPrinter createPrinter(Path path) throws IOException {
    return new CSVPrinter(
        IOUtils.getBufferedWriter(path.toUri().toURL(), csvCharset, false), getFormat());
  }
}
