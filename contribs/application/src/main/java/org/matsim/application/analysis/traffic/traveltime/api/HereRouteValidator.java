...
public class HereRouteValidator extends AbstractRouteValidator {
  ...
  public Result retrieve(Coord from, Coord to, int hour) {
    ...
    try {
      ...
      // Dynamic traffic information is not considered. Instead, the duration is calculated using
      // speeds that are typical for the given time of day/day of week, based on historical traffic
      // data.
