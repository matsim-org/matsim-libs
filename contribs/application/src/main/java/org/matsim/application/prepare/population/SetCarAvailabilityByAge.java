...
@CommandLine.Command(
    name = "set-car-avail",
    description = "Set car availability to true above a certain age.",
...
public class SetCarAvailabilityByAge implements MATSimAppCommand, PersonAlgorithm {
  ...
  @CommandLine.Option(
      names = "--age",
      description = "Agents with age greater or equal will have car availability set to always",
      defaultValue = "18")
  private int age;
  ...
  public void run(Person person) {
    ...
    if (age >= this.age) {
      ...
      if ("no".equals(PersonUtils.getLicense(person))) PersonUtils.setLicence(person, "yes");
    }
  }
}
