...
/**
 * Interface for {@link MATSimApplication} commands. This is just a subtype of {@link
 * Callable<Integer>}.
 *
 * <p>The developer needs to override {@link #call()} to implement the commands functionality.
 */
public interface MATSimAppCommand extends Callable<Integer> {
  ...
  default void execute(String... args) {
    ...
    if (code > 0) {
      ...
      else throw new RuntimeException("Command exited with error", e);
    }
  }
