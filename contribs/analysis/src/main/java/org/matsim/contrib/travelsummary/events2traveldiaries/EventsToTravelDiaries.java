 ...
 *     <p>Converts events into journeys, trips/stages, transfers and activities tables. Originally
 *     designed for transit scenarios with full transit simulation, but should work with most
 *     teleported modes
 */
public class EventsToTravelDiaries
  ...
  // those unscheduled modes that have been simulated on the network need to be processed the same
  // way as car
  ...
  public EventsToTravelDiaries(
      TransitSchedule transitSchedule, Network network, Config config, int maxEvents) {
  ...
  public static void runEventsProcessing(Properties properties) {
    ...
    new MatsimNetworkReader(scenario.getNetwork())
        .readFile(properties.get("networkFile").toString());
