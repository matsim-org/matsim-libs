  ...
  public List<String> getTripData() {
    String[] data =
        new String[] {
          ...
          Double.toString(departureLocation.getX()),
          Double.toString(departureLocation.getY()),
          Double.toString(arrivalLocation.getX()),
          Double.toString(arrivalLocation.getY()),
          Double.toString(actualTravelTime),
          Double.toString(validatedTravelTime),
          Double.toString(travelledDistance),
          Double.toString(validatedTravelDistance)
        };
    return Arrays.asList(data);
  }

  /**
   * This function should not be used in the future! It is a bad design with a bad naming. Please
   * use getTripData instead.
   */
  @Deprecated
