...
/**
 * This class provides minimum functionality for rendering a qgis symbol layer. Can be extended by
 * use cases that use a singleSymbolRenderer. The renderer describes how a layer is to be drawn. It
 * contains 1...n {@code QgisSymbolLayer}s in which the symbols for the contained geometry are
 * specified (e.g. points as markers with size, color, transparency, ...).
 *
 * @author dhosse
 */
