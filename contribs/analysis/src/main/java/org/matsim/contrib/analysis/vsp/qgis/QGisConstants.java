...
public class QGisConstants {
  ...
  // predefined geometry types that quantum gis can handle. "no geometry" means a data table used
  // for vectorjoin
  ...
  public static enum pointLayerSymbol {
    circle,
    rectangle
  };

  public static enum rasterRendererType {
    multibandcolor
  };
