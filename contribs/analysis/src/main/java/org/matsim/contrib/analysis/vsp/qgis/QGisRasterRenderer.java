...
/**
 * Renderer for QGis raster layers. So far, no project or use case specific settings exist, so this
 * is the only class that renders raster data.
 *
 * @author dhosse
 */
public class QGisRasterRenderer extends QGisRenderer {
  ...
  public QGisRasterRenderer(
      double opacity,
      int alpha,
      int blue,
      int green,
      QGisConstants.rasterRendererType type,
      int red,
      QGisLayer layer) {
