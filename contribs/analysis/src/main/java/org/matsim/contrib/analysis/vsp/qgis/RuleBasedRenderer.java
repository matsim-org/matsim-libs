...
public class RuleBasedRenderer extends QGisRenderer {
  public static final Logger log = LogManager.getLogger(RuleBasedRenderer.class);
  ...
  public RuleBasedRenderer(
      VectorLayer layer,
      double lowerBound,
      double upperBound,
      int range,
      int symbolSize,
      String nameOfAccessibilityLayer,
      String nameOfDensityLayer,
    ...
    this(
        ...
        range,
        symbolSize,
        ColorRangeUtils.ColorRange.RED_TO_GREEN,
        nameOfAccessibilityLayer,
        nameOfDensityLayer,
        minimumDensity);
  }
  ...
  private void createFirstRule() {
    rules[0] =
        AccessibilityRuleWithFilterCreator.createRuleWithoutLowerBound(
            nameOfAccessibilityLayer,
            lowerBound,
            nameOfDensityLayer,
            minimumDensity,
  ...
  private void createMidRule(int i) {
    ...
    rules[i] =
        AccessibilityRuleWithFilterCreator.createRule(
            nameOfAccessibilityLayer,
            lowerBound,
            upperBound,
            nameOfDensityLayer,
  ...
  private void createLastRule() {
    ...
    rules[range - 1] =
        AccessibilityRuleWithFilterCreator.createRuleWithoutUpperBound(
            nameOfAccessibilityLayer,
            lowerBound,
            nameOfDensityLayer,
            minimumDensity,
