...
/**
 * Calculates: - average leg travel time per mode - average leg travel time over all modes - number
 * of trips per mode - number of trips over all modes
 *
 * @author cdobler
 */
public class TripsAnalyzer
  ...
  public TripsAnalyzer(
      String tripsFileName, String durationsFileName, Set<String> modes, boolean createGraphs) {
  ...
  public void handleEvent(PersonArrivalEvent event) {
    ...
    if (departureTime == null)
      throw new RuntimeException(
          "No departure time for agent " + event.getPersonId() + " was found!");
  ...
  public void notifyStartup(final StartupEvent event) {
    ...
    if (autoConfig) {
      this.tripsFileName =
          event.getServices().getControlerIO().getOutputFilename(defaultTripsFileName);
      this.durationsFileName =
          event.getServices().getControlerIO().getOutputFilename(defaultDurationsFileName);
  ...
  public void notifyIterationEnds(IterationEndsEvent event) {
    ...
    if (this.createGraphs && event.getIteration() != this.minIteration) {
       ...
       */
      chart =
          new XYLineChart("Number of Trips per Mode Statistics", "iteration", "number of trips");
