...
/**
 * @author pieterfourie
 *     <p>Running this class with or without arguments prints out instructions for use.
 */
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (args.length > 3) {
        ...
        System.err.println(
            "No output directory specified. " + "Output directory from config will be used.");
      }
      ...
      if (!f.exists() && f.canWrite()) {
        System.err.println(
            "Cannot write to output directory. " + "Check for existence and permissions");
        System.exit(1);
      }
