...
public class QGisWriter extends AbstractMatsimWriter implements MatsimWriter {
  ...
  /**
   * Creates a new instance of a QGis project file (*.qgs) writer. Coordinate reference system and
   * working directory are mandatory for writing the file. Layers have to be added separately with
   * the method {@code addLayer}. If no layers were added, the writer creates an empty project file.
  ...
  public void write(String filename) {
    ...
    log.info(
        "Writing QuantumGIS project file (*.qgs) to " + this.workingDirectory + filename + "...");
    log.info(
        "Make sure all your input files exist. This writer will do absolutely no file writing except for the project file.");
