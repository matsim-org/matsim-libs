...
public class MainForQGisWriter {
  ...
  public static void main(String args[]) {
    ...
    //		VectorLayer nodesLayer = new VectorLayer("nodes", workingDirectory + "nodes.shp",
    // QGisConstants.geometryType.Point,false);
    ...
    //		double[] extent = {4582770.625,5807267.875,4608784.375,5825459.125};
    //		writer.setEnvelope(extent);
    //		VectorLayer linksLayer = new VectorLayer("links", workingDirectory + "links.shp",
    // QGisConstants.geometryType.Line,false);
    ...
    //		writer.setEnvelope(extent);
    //
    //		VectorLayer networkLayer = new VectorLayer("network", workingDirectory +
    // "testFiles/network_detail/network.shp", QGisConstants.geometryType.Line);
    //		new SimpleNetworkRenderer(networkLayer);
    //		writer.addLayer(networkLayer);
    //
    //		VectorLayer noiseLayer = new VectorLayer("receiverPoints", workingDirectory +
    // "testFiles/baseCase_rpGap25meters/receiverPoints/receiverPoints.csv",
    ...
    //
    //		VectorLayer joinLayer = new VectorLayer("immissions_3600", workingDirectory +
    // "testFiles/baseCase_rpGap25meters/immissions/100.immission_39600.0.csv",
    //				QGisConstants.geometryType.No_geometry,true);
    //		writer.addLayer(joinLayer);
    //
    //		noiseLayer.addVectorJoin(joinLayer, "Receiver Point Id", "receiverPointId", "Immission
    // 11:00:00");
    //
    ...
    RasterLayer mapnikLayer =
        new RasterLayer(
            "osm_mapnik_xml", workingDirectory + "testfiles/accessibility/osm_mapnik.xml");
    ...
    VectorLayer densityLayer =
        new VectorLayer(
            "density",
            workingDirectory + "testFiles/accessibility/accessibilities.csv",
    ...
    GraduatedSymbolRenderer renderer =
        new GraduatedSymbolRenderer(accessibilityLayer, upperBound, lowerBound, range, symbolSize);
    ...
    //		writer.setEnvelope(extent);
    //
    //		VectorLayer layer = new VectorLayer("immissions", workingDirectory +
    // "/testFiles/noise/immission_merged.csv",
    //				QGisConstants.geometryType.Point,true);
