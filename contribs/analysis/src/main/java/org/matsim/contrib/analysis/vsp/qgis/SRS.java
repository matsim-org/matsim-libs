...
public class SRS {
  ...
  public static SRS createSpatialRefSys(String srs) {
    ...
    switch (srs) {
      ...
      case TransformationFactory.WGS84_SA_Albers:
        return new SRS(
            "+proj=aea +lat_1=-18 +lat_2=-32 +lat_0=0 +lon_0=24 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs",
            "100000",
            "0",
            "USER:100000",
            "WGS84_SA_Albers",
      ...
      case "WGS84_Pseudo_Mercator":
        ...
        // see, however, why we need this class instead of just using the coordinate systems from
        // MGC
      case "EPSG:21037":
        return new SRS(
            ...
            "21037",
            "EPSG:21037",
            "Arc 1960 / UTM zone 3Ss",
            "",
            "");

        // TODO the following is a quick fixing to make TransformationFactory.WGS84_UTM31N useable;
        // right now I don't
        // see, however, why we need this class instead of just using the coordinate systems from
        // MGC
      case TransformationFactory.WGS84_UTM31N: // EPSG:32641, e.g. for Hasselt
        ...
        // TODO the following is a quick fixing to make TransformationFactory.WGS84_UTM33N
        // useable... see above
  ...
  private static String getEllipsoidacronymFromSrs(String srs) {
    return (new org.osgeo.proj4j.CRSFactory())
        .createFromName(srs)
        .getProjection()
        .getEllipsoid()
        .getName();
