...
public class SpatialInterpolationTest {
  ...
  public void calculateWeightFromLine() {
    ...
    // expected value is taken from running
    // playground.agarwalamit.analysis.spatial.SpatialInterpolation with same
    // parameters
  ...
  public void calculateWeightFromLine_invalidSmoothingRadius() {
    ...
    double weight =
        SpatialInterpolation.calculateWeightFromLine(from, to, cellCentroid, smoothingRadius);
  ...
  public void calculateWeightFromPoint_invalidSmoothingRadius() {
    ...
    double weight =
        SpatialInterpolation.calculateWeightFromPoint(source, centroid, smoothingRadius);
