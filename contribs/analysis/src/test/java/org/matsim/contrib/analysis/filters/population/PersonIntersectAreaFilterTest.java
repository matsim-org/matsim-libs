...
public class PersonIntersectAreaFilterTest extends MatsimTestCase {
	...
	public void testFilter() throws Exception {
		...
		Node node0 = network.createAndAddNode(Id.create("0", Node.class), new CoordImpl(0, 0));
		Node node1 = network.createAndAddNode(Id.create("1", Node.class), new CoordImpl(10, 10));
		Node node2 = network.createAndAddNode(Id.create("2", Node.class), new CoordImpl(90, 10));
		Node node3 = network.createAndAddNode(Id.create("3", Node.class), new CoordImpl(10, 90));
		Node node4 = network.createAndAddNode(Id.create("4", Node.class), new CoordImpl(90, 90));
		Node node5 = network.createAndAddNode(Id.create("5", Node.class), new CoordImpl(100, 100));
