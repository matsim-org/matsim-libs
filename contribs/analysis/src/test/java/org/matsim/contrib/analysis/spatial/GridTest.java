...
public class GridTest {
  ...
  public void initializeHexagonalGrid() {
    ...
    final String testValue = "test-value";
    Grid<String> grid =
        new HexagonalGrid<>(2, () -> testValue, SpatialTestUtils.createRect(10, 10));
  ...
  public void getArea_squareGrid() {
    ...
    Grid<String> grid =
        new SquareGrid<>(horizontalDistance, () -> "value", SpatialTestUtils.createRect(10, 10));
  ...
  public void getArea_HexagonalGrid() {
    ...
    Grid<String> grid =
        new HexagonalGrid<>(horizontalDistance, () -> "value", SpatialTestUtils.createRect(10, 10));

    final double horizontalDistance5 = 5;
    final double expected5 = Math.sqrt(3) / 2 * horizontalDistance5 * horizontalDistance5;
    Grid<String> grid5 =
        new HexagonalGrid<>(
            horizontalDistance5, () -> "value", SpatialTestUtils.createRect(10, 10));
