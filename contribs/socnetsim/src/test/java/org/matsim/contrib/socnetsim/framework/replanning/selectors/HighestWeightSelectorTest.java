...
public class HighestWeightSelectorTest {
	...
	public static Fixture createIndividualPlans() {
		...
		PlanImpl plan = PersonImpl.createAndAddPlan(person, false);
		plan.setScore( 1d );
	...
	public static Fixture createIndividualPlansWithSpecialForbidder() {
		...
		Person person = PersonImpl.createPerson(id);
		group.addPerson( person );
		final PlanImpl p11 = PersonImpl.createAndAddPlan(person, false);
		p11.setScore( 1000d );
		final PlanImpl p12 = PersonImpl.createAndAddPlan(person, false);
		p12.setScore( 1d );

		id = Id.create( "milou" , Person.class );
		person = PersonImpl.createPerson(id);
		group.addPerson( person );
		final PlanImpl p21 = PersonImpl.createAndAddPlan(person, false);
		p21.setScore( 1000d );
		final PlanImpl p22 = PersonImpl.createAndAddPlan(person, false);
		p22.setScore( 0d );

		id = Id.create( "tim" , Person.class );
		person = PersonImpl.createPerson(id);
		group.addPerson( person );
		final PlanImpl p31 = PersonImpl.createAndAddPlan(person, false);
		p31.setScore( 1000d );
		final PlanImpl p32 = PersonImpl.createAndAddPlan(person, false);
		p32.setScore( 1d );

		id = Id.create( "struppy" , Person.class );
		person = PersonImpl.createPerson(id);
		group.addPerson( person );
		final PlanImpl p41 = PersonImpl.createAndAddPlan(person, false);
		p41.setScore( 1000d );
		final PlanImpl p42 = PersonImpl.createAndAddPlan(person, false);
		p42.setScore( 0d );
