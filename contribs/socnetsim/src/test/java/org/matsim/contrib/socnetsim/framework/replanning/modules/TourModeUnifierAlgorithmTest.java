...
public class TourModeUnifierAlgorithmTest {
	...
	public void testPlanWithOneSingleTour() throws Exception {
		...
		plan.addActivity( PopulationUtils.createActivityImpl("h", anchorLink1) );
		plan.addLeg( new LegImpl( mode ) );
		plan.addActivity( PopulationUtils.createActivityImpl("type-"+random.nextLong(), Id.create( random.nextLong() , Link.class )) );
		...
		plan.addActivity( PopulationUtils.createActivityImpl("type-"+random.nextLong(), Id.create( random.nextLong() , Link.class )) );
		plan.addLeg( new LegImpl( "mode-"+random.nextLong() ) );
		plan.addActivity( PopulationUtils.createActivityImpl("w", anchorLink2) );
		plan.addLeg( new LegImpl( "mode-"+random.nextLong() ) );
		plan.addActivity( PopulationUtils.createActivityImpl("type-"+random.nextLong(), Id.create( random.nextLong() , Link.class )) );
		plan.addLeg( new LegImpl( "mode-"+random.nextLong() ) );
		plan.addActivity( PopulationUtils.createActivityImpl("type-"+random.nextLong(), Id.create( random.nextLong() , Link.class )) );
		...
		plan.addActivity( PopulationUtils.createActivityImpl("type-"+random.nextLong(), Id.create( random.nextLong() , Link.class )) );
		plan.addLeg( new LegImpl( "mode-"+random.nextLong() ) );
		plan.addActivity( PopulationUtils.createActivityImpl(stageType, Id.create( random.nextLong() , Link.class )) );
		plan.addLeg( new LegImpl( "mode-"+random.nextLong() ) );
		plan.addActivity( PopulationUtils.createActivityImpl(stageType, Id.create( random.nextLong() , Link.class )) );
		plan.addLeg( new LegImpl( "mode-"+random.nextLong() ) );
		plan.addActivity( PopulationUtils.createActivityImpl(stageType, Id.create( random.nextLong() , Link.class )) );
	...
	public void testPlanWithTwoToursOnOpenTour() throws Exception {
		...
		plan.addActivity( PopulationUtils.createActivityImpl("e", entranceLink) );
		...
		plan.addActivity( PopulationUtils.createActivityImpl("type-"+random.nextLong(), Id.create( random.nextLong() , Link.class )) );
		plan.addLeg( new LegImpl( modeOfOpenTour ) );
		plan.addActivity( PopulationUtils.createActivityImpl("s", exitLink) );
	...
	public void testPlanWithTwoHomeBasedTours() throws Exception {
		...
		plan.addActivity( PopulationUtils.createActivityImpl("h", anchorLink) );
		plan.addLeg( new LegImpl( mode1 ) );
		plan.addActivity( PopulationUtils.createActivityImpl(stageType, Id.create( random.nextLong() , Link.class )) );
		plan.addLeg( new LegImpl( "mode-"+random.nextLong() ) );
		plan.addActivity( PopulationUtils.createActivityImpl("type-"+random.nextLong(), Id.create( random.nextLong() , Link.class )) );
