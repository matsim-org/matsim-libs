...
public class SynchronizeCoTravelerPlansAlgorithmTest {
  ...
  private static class Fixture {
    ...
    public Fixture(final JointPlan jp, final Map<Activity, Double> expectedEndTimes) {
      this.jointPlan = jp;
  ...
  private static class FixtureBuilder {
    ...
    public Fixture build() {
      return new Fixture(new JointPlanFactory().createJointPlan(plans), expectedEndTimes);
    }
  }
  ...
  public void testDepartureTimes() throws Exception {
    final SynchronizeCoTravelerPlansAlgorithm testee =
        new SynchronizeCoTravelerPlansAlgorithm(
    ...
    for (Fixture fixture : fixtures) {
      ...
      for (Plan p : fixture.jointPlan.getIndividualPlans().values()) {
        for (Activity activity :
            TripStructureUtils.getActivities(p, StageActivityHandling.StagesAsNormalActivities)) {
