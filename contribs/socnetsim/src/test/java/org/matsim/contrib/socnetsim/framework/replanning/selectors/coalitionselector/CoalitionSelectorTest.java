		...
		return toArgList(
				...
				new FixtureFactory() {
					...
					public Fixture create() {
						...
						Person person = PopulationUtils.getDefaultFactory().createPerson(Id.createPersonId("tintin"));
						group.addPerson( person );
						Plan plan = PersonUtils.createAndAddPlan(person, false);
						plan.setScore( 1d );
						...
						person = PopulationUtils.getDefaultFactory().createPerson(Id.createPersonId("milou"));
						group.addPerson( person );
						plan = PersonUtils.createAndAddPlan(person, false);
						plan.setScore( -10d );
						jp1.put( person.getId() , plan );
						...
						person = PopulationUtils.getDefaultFactory().createPerson(Id.createPersonId("tim"));
						group.addPerson( person );
						plan = PersonUtils.createAndAddPlan(person, false);
						plan.setScore( 10d );
						...
						person = PopulationUtils.getDefaultFactory().createPerson(Id.createPersonId("struppy"));
						group.addPerson( person );
						plan = PersonUtils.createAndAddPlan(person, false);
						plan.setScore( -10d );
						jp3.put( person.getId() , plan );
