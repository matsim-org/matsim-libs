...
public class CoalitionSelectorTest {
    ...
    return toArgList(
        new FixtureFactory() {
          ...
          public Fixture create() {
            ...
            return new Fixture("all individual", group, exp, jointPlans);
          }
        },
        new FixtureFactory() {
          @Override
          public Fixture create() {
            ...
            final JointPlan jpl1 = jointPlans.getFactory().createJointPlan(jp1);
            jointPlans.addJointPlan(jpl1);
            final JointPlan jpl3 = jointPlans.getFactory().createJointPlan(jp3);
            jointPlans.addJointPlan(jpl3);

            final GroupPlans exp =
                new GroupPlans(Arrays.asList(jpl1, jpl3), Collections.<Plan>emptyList());
            return new Fixture("well-defined", group, exp, jointPlans);
          }
        });
  }
  ...
  public void testSelectedPlans() {
    ...
    try {
      final GroupPlans selected = selector.selectPlans(fixture.jointPlans, fixture.group);
