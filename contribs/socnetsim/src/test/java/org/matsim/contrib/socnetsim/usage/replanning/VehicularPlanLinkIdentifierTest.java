...
public class VehicularPlanLinkIdentifierTest {
  ...
  public void testNotLinkedWhenNoVehicleDefined() {
    ...
    Assert.assertFalse(
        "plans without vehicle allocated are considered linked", testee.areLinked(plan1, plan2));
  }
  ...
  public void testSameVehiclesAreLinked() {
    final Plan plan1 =
        createVehicularPlan(Id.create(1, Person.class), Id.create("car", Vehicle.class));
    final Plan plan2 =
        createVehicularPlan(Id.create(2, Person.class), Id.create("car", Vehicle.class));
  ...
  private static Plan createVehicularPlan(final Id<Person> personId, final Id<Vehicle> vehicleId) {
