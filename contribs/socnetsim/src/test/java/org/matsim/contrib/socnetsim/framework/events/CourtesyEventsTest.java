...
public class CourtesyEventsTest {
  private static final Logger log = LogManager.getLogger(CourtesyEventsTest.class);
  ...
  public void testFullOverlap() {
    ...
    testEvents(
        ...
        // 1:|------------------|
        // 2:      |-------|
        new ActivityStartEvent(0, ID_1, LINK_ID, FACILITY_ID, TYPE),
        new ActivityStartEvent(2, ID_2, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(3, ID_2, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(4, ID_1, LINK_ID, FACILITY_ID, TYPE));
  }
  ...
  public void testPartialOverlap() {
    testEvents(
        ...
        new ActivityStartEvent(0, ID_1, LINK_ID, FACILITY_ID, TYPE),
        new ActivityStartEvent(2, ID_2, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(3, ID_1, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(4, ID_2, LINK_ID, FACILITY_ID, TYPE));
  }
  ...
  public void testNoOverlap() {
    testEvents(
        ...
        // 2:            |------------|
        new ActivityStartEvent(0, ID_1, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(2, ID_1, LINK_ID, FACILITY_ID, TYPE),
        new ActivityStartEvent(3, ID_2, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(4, ID_2, LINK_ID, FACILITY_ID, TYPE));
  }
  ...
  public void testStartTogether() {
    testEvents(
        ...
        // 2:|------------------------|
        new ActivityStartEvent(0, ID_1, LINK_ID, FACILITY_ID, TYPE),
        new ActivityStartEvent(0, ID_2, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(2, ID_1, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(4, ID_2, LINK_ID, FACILITY_ID, TYPE));
  }
  ...
  public void testEndTogether() {
    testEvents(
        ...
        // 2:            |------------|
        new ActivityStartEvent(0, ID_1, LINK_ID, FACILITY_ID, TYPE),
        new ActivityStartEvent(1, ID_2, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(2, ID_1, LINK_ID, FACILITY_ID, TYPE),
        new ActivityEndEvent(2, ID_2, LINK_ID, FACILITY_ID, TYPE));
  }
  ...
  public void testEvents(int expectedCourtesy, Event... events) {
    ...
    eventManager.addHandler(new CourtesyEventsGenerator(eventManager, sn));
    ...
    Assert.assertEquals(
        "wrong number of events in " + collected, expectedCourtesy, collected.size());
  }
}
