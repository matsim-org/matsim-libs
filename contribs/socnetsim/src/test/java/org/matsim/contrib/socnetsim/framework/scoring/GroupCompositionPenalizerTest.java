...
public class GroupCompositionPenalizerTest {
  ...
  private void test(final double[] times1, final double[] times2) {
    ...
    final GroupCompositionPenalizer penalizer =
    ...
    final EventsToScore eventsToScore =
        EventsToScore.createWithoutScoreUpdating(
            sc,
    ...
    Assert.assertEquals(
        "unexpected score",
        calcExpectedScore(
            times1[0], times1[times1.length - 1], times2[0], times2[times2.length - 1]),
        score,
        1E-9);
  }

  private double calcExpectedScore(
      final double start1, final double end1, final double start2, final double end2) {
  ...
  private void createPerson(final Scenario sc, final int id, final double[] times) {
