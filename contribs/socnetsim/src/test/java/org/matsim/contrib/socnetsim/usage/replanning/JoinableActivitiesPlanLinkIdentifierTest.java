...
public class JoinableActivitiesPlanLinkIdentifierTest {
  ...
  public void testOpenPlansSamePlaceDifferentType() {
    ...
    final PlanLinkIdentifier testee = new JoinableActivitiesPlanLinkIdentifier(type);
    Assert.assertEquals(
        "inconsistency!", testee.areLinked(plan1, plan2), testee.areLinked(plan2, plan1));
    Assert.assertFalse(
  ...
  private static Plan createOpenPlan(
      final Id<Person> personId, final String type, final Id<ActivityFacility> facility) {
    final Person pers1 = factory.createPerson(personId);
    final Plan plan1 = factory.createPlan();
    pers1.addPlan(plan1);
    final Activity act1 =
        (Activity) factory.createActivityFromLinkId(type, Id.create("link", Link.class));
  ...
  public void testSingleTourOverlaping() {
    ...
    final Plan plan1 = createSingleTripPlan(Id.create(1, Person.class), type, facility, 10, 30);
    final Plan plan2 = createSingleTripPlan(Id.create(2, Person.class), type, facility, 20, 40);

    final PlanLinkIdentifier testee = new JoinableActivitiesPlanLinkIdentifier(type);
    Assert.assertEquals(
        "inconsistency!", testee.areLinked(plan1, plan2), testee.areLinked(plan2, plan1));
    Assert.assertTrue(
        "plans with overlaping activities should be joint", testee.areLinked(plan1, plan2));
  }
  ...
  public void testSingleTourPlansNonOverlaping() {
    ...
    final Plan plan1 = createSingleTripPlan(Id.create(1, Person.class), type, facility, 10, 20);
    ...
    Assert.assertEquals(
        "inconsistency!", testee.areLinked(plan1, plan2), testee.areLinked(plan2, plan1));
    Assert.assertFalse(
        "plans with non overlaping activities should not be joint", testee.areLinked(plan1, plan2));
  }
  ...
  public void testSingleTourPlansZeroDurationBegin() {
    ...
    final Plan plan1 = createSingleTripPlan(Id.create(1, Person.class), type, facility, 22, 22);
    final Plan plan2 = createSingleTripPlan(Id.create(2, Person.class), type, facility, 22, 40);
  ...
  public void testSingleTourPlansZeroDurationEnd() {
    ...
    final Plan plan1 = createSingleTripPlan(Id.create(1, Person.class), type, facility, 40, 40);
    final Plan plan2 = createSingleTripPlan(Id.create(2, Person.class), type, facility, 22, 40);
  ...
  public void testDoubleTourPlansZeroDurationEnd() {
    ...
    final Plan plan1 =
        createDoubleTripPlan(Id.create(1, Person.class), type, 30, wrongFacility, 40, facility, 40);
    final Plan plan2 = createSingleTripPlan(Id.create(2, Person.class), type, facility, 22, 40);
  ...
  public void testSingleTourPlansInconsistentDurationAct() {
    ...
    Assert.assertEquals(
        "inconsistency!", testee.areLinked(plan1, plan2), testee.areLinked(plan2, plan1));
    Assert.assertFalse(
        "plans with inconsistent duration not handled correctly", testee.areLinked(plan1, plan2));
  }
  ...
  private static Plan createDoubleTripPlan(
    ...
    {
      final Activity act =
          (Activity) factory.createActivityFromLinkId("home", Id.create("link", Link.class));
