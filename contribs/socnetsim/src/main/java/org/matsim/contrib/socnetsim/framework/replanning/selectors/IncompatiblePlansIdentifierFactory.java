...
/**
 * Create instances of {@link IncompatiblePlansIdentifierFactory} for specific replanning groups.
 * <br>
 * It is safe to assume that the instances returned by this factory will always be called on plans
 * from the group used at construction.
 *
 * @author thibautd
 */
