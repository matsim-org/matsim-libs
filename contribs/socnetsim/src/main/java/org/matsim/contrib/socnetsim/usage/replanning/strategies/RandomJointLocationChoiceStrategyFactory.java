...
import org.matsim.contrib.socnetsim.jointactivities.replanning.modules.randomlocationchoice.RandomJointLocationChoiceModule;
 ...
 * @author thibautd
 */
public class RandomJointLocationChoiceStrategyFactory
  ...
  public GroupPlanStrategy get() {
    ...
    strategy.addStrategyModule(new RandomJointLocationChoiceModule(sc));
