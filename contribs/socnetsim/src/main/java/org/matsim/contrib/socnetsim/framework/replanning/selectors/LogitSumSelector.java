...
/**
 * A selector which draws gumbel-distributed scores for individual plans. Without joint plan, this
 * results in logit marginals for the selection for each agent.
 *
 * @author thibautd
 */
public class LogitSumSelector implements GroupLevelPlanSelector {
  static final Logger log = LogManager.getLogger(LogitSumSelector.class);
