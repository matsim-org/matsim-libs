 ...
 * @author thibautd
 */
public class ElementalCharyparNagelLegScoringFunction
    implements LegScoring, ScoringFunctionAccumulator.LegScoring {
  ...
  public ElementalCharyparNagelLegScoringFunction(
      final String mode, final LegScoringParameters params, final Network network) {
    this.mode = mode;
    this.params = params;
  ...
  private double calcLegScore(final Leg leg) {
    ...
    final double dist =
        ...
        params.marginalUtilityOfDistance_m != 0.0 ? getDistance(leg.getRoute()) : 0;
