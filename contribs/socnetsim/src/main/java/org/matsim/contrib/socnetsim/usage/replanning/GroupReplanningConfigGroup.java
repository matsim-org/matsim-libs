...
public class GroupReplanningConfigGroup extends ReflectiveConfigGroup {
  ...
  public void setConsiderVehicleIncompatibilities(final boolean considerVehicleIncompatibilities) {
  ...
  public void setInitialTimeMutationTemperature(final double initialTimeMutationTemperature) {
  ...
  public void setMaxPlansPerComposition(final int maxPlansPerComposition) {
    if (maxPlansPerComposition < 1)
      throw new IllegalArgumentException(maxPlansPerComposition + " too small");
