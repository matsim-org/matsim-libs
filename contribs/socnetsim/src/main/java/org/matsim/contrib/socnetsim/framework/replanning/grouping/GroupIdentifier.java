...
/**
 * Identifies groups of agents to replan together. Various approaches are valid:
 *
 * <ul>
 ...
 * </ul>
 *
 * Note that new joint plans can only be created for agents belonging to the same group.
 *
 * @author thibautd
 */
