...
public class ActivitySequenceMutatorAlgorithm implements PlanAlgorithm {
  ...
  public ActivitySequenceMutatorAlgorithm(
      final Random random, final StageActivityHandling stageActivityHandling) {
    this.random = random;
  ...
  public void run(final Plan plan) {
    ...
    swap(
        ...
        activities.get(secondActIndex < firstActIndex ? secondActIndex : secondActIndex + 1));
  }

  private static void swap(final Plan plan, final Activity activity1, final Activity activity2) {
