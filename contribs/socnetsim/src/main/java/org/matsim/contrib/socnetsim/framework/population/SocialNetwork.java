...
public interface SocialNetwork {
  ...
  /**
   * Must be called before adding ties. This allows to make sure that isolated agents (without
   * social contacts) are identified as such in the network. This is necessary for analysing the
   * topology of the network, but also for more safety in simulation (fail if the social network
  ...
  /**
   * add metadata. Metadata associates attribute names to values, and can be used to store any
   * information useful to organize data: date of generation, source, author, etc.
   */
