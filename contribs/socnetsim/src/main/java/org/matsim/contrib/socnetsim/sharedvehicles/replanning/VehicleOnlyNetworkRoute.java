...
/**
 * to put vehicle Id in legs without route. Try to make this the less dirty as possible: anything
 * except vehicle-related operations throws an UnsupportedOperationException, so that we are sure
 * this is not used for more than what it is meant to do.
 */
