...
public class CharyparNagelWithJointModesScoringFunctionFactory implements ScoringFunctionFactory {
    ...
    public CharyparNagelWithJointModesScoringFunctionFactory(
		...
		this.params = new ScoringParameters.Builder(scenario.getConfig().scoring(), scenario.getConfig().scoring().getScoringParametersOrDefault(null), scenario.getConfig().scenario()).build();
