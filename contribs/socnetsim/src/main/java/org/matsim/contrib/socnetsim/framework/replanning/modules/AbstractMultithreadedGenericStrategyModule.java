 ...
 * @author thibautd
 */
public abstract class AbstractMultithreadedGenericStrategyModule<T>
    implements GenericStrategyModule<T> {
  private static final Logger log =
      LogManager.getLogger(AbstractMultithreadedGenericStrategyModule.class);
  ...
  public void handlePlans(
      final ReplanningContext replanningContext, final Collection<T> groupPlans) {
  ...
  private static class PlanRunnable<T> implements Runnable {
    ...
    public PlanRunnable(final Counter counter, final GenericPlanAlgorithm<T> algo) {
  ...
  /**
   * It is possible to override this method, which is used in log messages. It is called once, at
   * construction.
   */
