...
public class SocialNetworkReader extends MatsimXmlParser {
  ...
  public SocialNetworkReader(final String elementName, final Scenario scenario) {
    super(ValidationType.DTD_ONLY);
    this.scenario = scenario;
  ...
  public void startTag(final String name, final Attributes atts, final Stack<String> context) {
    if (name.equals(SocialNetworkWriter.ROOT_TAG)) {
      ...
      final Id<Person> ego = Id.create(atts.getValue(SocialNetworkWriter.EGO_ATT), Person.class);
      this.socialNetwork.addEgo(ego);
    } else if (name.equals(SocialNetworkWriter.TIE_TAG)) {
      final Id<Person> ego = Id.create(atts.getValue(SocialNetworkWriter.EGO_ATT), Person.class);
      final Id<Person> alter =
          Id.create(atts.getValue(SocialNetworkWriter.ALTER_ATT), Person.class);
