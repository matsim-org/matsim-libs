...
public class JointTripsModule extends AbstractModule {
  ...
  @Override
  public void install() {
    final com.google.inject.Provider<TripRouter> tripRouterProvider =
        binder().getProvider(TripRouter.class);
            ...
            new AbstractPrepareForSimListener() {
              ...
              public GenericPlanAlgorithm<ReplanningGroup> createAlgorithm(
                ...
                final PlanAlgorithm routingAlgorithm =
                    routingAlgoFactory.createPlanRoutingAlgorithm(tripRouterProvider.get());
