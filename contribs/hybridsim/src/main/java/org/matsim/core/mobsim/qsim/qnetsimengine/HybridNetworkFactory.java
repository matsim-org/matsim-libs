...
public final class HybridNetworkFactory implements QNetworkFactory {
  ...
  public void initializeFactory(
      AgentCounter agentCounter, MobsimTimer mobsimTimer, NetsimInternalInterface arg2) {
  ...
  public QLinkI createNetsimLink(Link link, QNodeI queueNode) {
    if (link.getAllowedModes().contains("2ext")) {
      ...
      // yyyyyy I don't think that this would have been set correctly before I refactored this.
      // kai, feb'18
      return new QSimExternalTransitionLink(
          link,
          this.externalEngine,
          context,
          netsimEngine,
