...
public class QSimExternalTransitionLink extends AbstractQLink {
	...
	QSimExternalTransitionLink(Link link, ExternalEngine e, NetsimEngineContext context, InternalInterface internalInterface, QNodeI toQNode) {
		super(link, toQNode, context, internalInterface);
		this.e = e;
