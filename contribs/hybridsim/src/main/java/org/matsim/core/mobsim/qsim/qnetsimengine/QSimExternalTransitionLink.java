...
public class QSimExternalTransitionLink extends AbstractQLink {
  ...
  public List<QLaneI> getOfferingQLanes() {
    ...
    // Gregor, the popFirstVehicle/getFirstVehicle etc. is now delegated down to QLane.  This
    // probably makes it slightly more
    // complicated from the perspective here, but makes the QNetsimEngine simpler (no exception for
    // the "multiple lanes" any more).
