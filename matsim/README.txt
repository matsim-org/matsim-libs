...
Snapshot-Release  (internal number: 0.2.0-SNAPSHOT)
=========================================================================
...
- java -jar matsim-0.1.0-rc1.jar
  this should show the release info
- java -cp matsim-0.1.0-rc1.jar org.matsim.run.Controler myconfig.xml
  this should run the simulation
- A Tutorial can be found online: http://matsim.org/docs/tutorials/getting-started
  files required for the tutorial are included in this release.
