...
\]
the minus steps from the fact that we are \emph{reducing} the travel time.
...
mUTTS 
%
= \left( \beta_{perf} \cdot \frac{t_{typ,i}}{t_{perf}} - \beta_{trav,mode} \right)
%
\approx \beta_{perf} - \beta_{trav,mode} \ .
\]
