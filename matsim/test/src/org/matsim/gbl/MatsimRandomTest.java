...
public class MatsimRandomTest extends MatsimTestCase {
	...
	public void testRandomness() {
		final double value1 = MatsimRandom.random.nextDouble();
		final double value2 = MatsimRandom.random.nextDouble();
		final double value3 = MatsimRandom.random.nextDouble();
	...
	public void testReset() {
		MatsimRandom.reset();
		int value1 = MatsimRandom.random.nextInt();
		MatsimRandom.reset();
		int value2 = MatsimRandom.random.nextInt();
	...
	public void testSeedReset() {
		...
		double value1 = MatsimRandom.random.nextDouble();
		MatsimRandom.reset(seed1);
		double value2 = MatsimRandom.random.nextDouble();
		assertEquals(value1, value2, EPSILON);

		MatsimRandom.reset(seed2);
		double value3 = MatsimRandom.random.nextInt();
		assertTrue(Math.abs(value1 - value3) > EPSILON);
	}
