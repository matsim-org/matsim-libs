...
public abstract class AbstractPlanSelectorTest extends MatsimTestCase {
	 ...
	 * Currently, the {@link org.matsim.replanning.StrategyManager} should never pass a person to
	 ...
	 * {@link PlanSelector#selectPlan(org.matsim.interfaces.core.v01.Person) PlanSelector.selectPlan(Person)}
	 *
	 * @author mrieser
	 */
