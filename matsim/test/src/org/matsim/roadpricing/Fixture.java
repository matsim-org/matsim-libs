...
/*package*/ class Fixture {
	...
	protected static NetworkLayer createNetwork1() {
		...
		NodeImpl node5 = network.createAndAddNode(new IdImpl(5), new CoordImpl(400, 0));
		NodeImpl node6 = network.createAndAddNode(new IdImpl(6), new CoordImpl(500, 0));
     ...
     * (11)                                  |
		...
		NetworkLayer network = new NetworkLayer();
		network.setCapacityPeriod(Time.parseTime("01:00:00"));
		NodeImpl node0 = network.createAndAddNode(new IdImpl( "0"), new CoordImpl(  0,   10));
		NodeImpl node1 = network.createAndAddNode(new IdImpl( "1"), new CoordImpl(  0,  100));
		NodeImpl node2 = network.createAndAddNode(new IdImpl( "2"), new CoordImpl(100,  100));
		NodeImpl node3 = network.createAndAddNode(new IdImpl( "3"), new CoordImpl(150,  150));
		NodeImpl node4 = network.createAndAddNode(new IdImpl( "4"), new CoordImpl(200,  100));
		NodeImpl node5 = network.createAndAddNode(new IdImpl( "5"), new CoordImpl(300,  100));
		NodeImpl node6 = network.createAndAddNode(new IdImpl( "6"), new CoordImpl(300, -100));
		NodeImpl node7 = network.createAndAddNode(new IdImpl( "7"), new CoordImpl(200, -100));
		NodeImpl node8 = network.createAndAddNode(new IdImpl( "8"), new CoordImpl(150, -150));
		NodeImpl node9 = network.createAndAddNode(new IdImpl( "9"), new CoordImpl(100, -100));
		NodeImpl node10 =network.createAndAddNode(new IdImpl("10"), new CoordImpl(  0, -100));
		NodeImpl node11 =network.createAndAddNode(new IdImpl("11"), new CoordImpl(  0,  -10));
