...
public class AbstractControlInputImplTest extends MatsimTestCase {
	...
	public void testAbstractControlInputImpl() {
		...
		LinkEnterEvent enterEvent = new LinkEnterEvent(0.0, "0", "5");
		ci.handleEvent(enterEvent);
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		enterEvent = new LinkEnterEvent(0.0, "1", "5");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		LinkLeaveEvent leaveEvent = new LinkLeaveEvent(1.0, "0", "5");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEvent(1.0, "0", "6");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		enterEvent = new LinkEnterEvent(1.0, "2", "7");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(2.0, "2", "7");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEvent(2.0, "2", "8");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(3.0, "2", "8");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEvent(3.0, "2", "16");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(4.0, "2", "16");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEvent(4.0, "2", "20");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(4.0, "1", "5");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEvent(4.0, "1", "6");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(4.0, "1", "5");
		...
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(4.0, "1", "6");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEvent(4.0, "1", "20");
		ci.handleEvent(enterEvent);
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
    leaveEvent = new LinkLeaveEvent(1.0, "0", "6");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEvent(1.0, "0", "20");
		ci.handleEvent(enterEvent);
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
	}
