...
public class AbstractControlInputImplTest extends MatsimTestCase {
	...
	public void testAbstractControlInputImpl() {
		...
		LinkEnterEnter enterEvent = new LinkEnterEnter(0.0, "0", 0, "5");
		ci.handleEvent(enterEvent);
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		enterEvent = new LinkEnterEnter(0.0, "1", 0, "5");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		LinkLeaveEvent leaveEvent = new LinkLeaveEvent(1.0, "0", 0, "5");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEnter(1.0, "0", 0, "6");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		enterEvent = new LinkEnterEnter(1.0, "2", 0, "7");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(2.0, "2", 0, "7");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEnter(2.0, "2", 0, "8");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(3.0, "2", 0, "8");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEnter(3.0, "2", 0, "16");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(4.0, "2", 0, "16");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEnter(4.0, "2", 0, "20");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(4.0, "1", 0, "5");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEnter(4.0, "1", 0, "6");
		ci.handleEvent(enterEvent);
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(4.0, "1", 0, "5");
		...
		assertEquals(2, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
		leaveEvent = new LinkLeaveEvent(4.0, "1", 0, "6");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEnter(4.0, "1", 0, "20");
		ci.handleEvent(enterEvent);
		assertEquals(1, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
    leaveEvent = new LinkLeaveEvent(1.0, "0", 0, "6");
		ci.handleEvent(leaveEvent);
		enterEvent = new LinkEnterEnter(1.0, "0", 0, "20");
		ci.handleEvent(enterEvent);
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route1));
		assertEquals(0, ci.getNumberOfVehiclesOnRoute(route2));
	}
