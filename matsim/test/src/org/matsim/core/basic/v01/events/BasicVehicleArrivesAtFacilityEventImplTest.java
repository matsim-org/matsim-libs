...
public class BasicVehicleArrivesAtFacilityEventImplTest extends MatsimTestCase {
	...
	public void testWriteReadXml() {
		BasicVehicleArrivesAtFacilityEventImpl event = new BasicVehicleArrivesAtFacilityEventImpl(Time.parseTime("10:55:00"), new IdImpl(5), new IdImpl(11));
		BasicVehicleArrivesAtFacilityEventImpl event2 = XmlEventsTester.testWriteReadXml(getOutputDirectory() + "events.xml", event);
