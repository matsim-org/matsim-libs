...
public class TestEventLibrary extends MatsimTestCase {
	...
	public void testGetTravelTime(){
		...
		events.add(new AgentDepartureEventImpl(20, new IdImpl("2"), new IdImpl("0")));
		events.add(new AgentArrivalEventImpl(30, new IdImpl("2"), new IdImpl("0")));
		events.add(new AgentDepartureEventImpl(90, new IdImpl("1"), new IdImpl("0")));
		events.add(new AgentArrivalEventImpl(110, new IdImpl("1"), new IdImpl("0")));
