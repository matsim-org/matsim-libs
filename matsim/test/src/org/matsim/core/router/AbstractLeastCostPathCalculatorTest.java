...
public abstract class AbstractLeastCostPathCalculatorTest extends MatsimTestCase {
	...
	private static class MultiModeFixture {
		...
		public MultiModeFixture() {
			...
			this.nodes[0] = network.createNode(new IdImpl(0), new CoordImpl(0, 0), null);
			this.nodes[1] = network.createNode(new IdImpl(1), new CoordImpl(1000, 0), null);
			this.nodes[2] = network.createNode(new IdImpl(2), new CoordImpl(2000, 0), null);
			this.nodes[3] = network.createNode(new IdImpl(3), new CoordImpl(3000, 0), null);
			this.nodes[4] = network.createNode(new IdImpl(4), new CoordImpl(0, 1000), null);
			this.nodes[5] = network.createNode(new IdImpl(5), new CoordImpl(1000, 1000), null);
			this.nodes[6] = network.createNode(new IdImpl(6), new CoordImpl(2000, 1000), null);
			this.nodes[7] = network.createNode(new IdImpl(7), new CoordImpl(3000, 1000), null);
			this.links[0] = network.createLink(new IdImpl(0), this.nodes[0], this.nodes[1], 1000.0, 100.0, 3600.0, 1.0);
			this.links[1] = network.createLink(new IdImpl(1), this.nodes[1], this.nodes[2], 1000.0, 100.0, 3600.0, 1.0);
			this.links[2] = network.createLink(new IdImpl(2), this.nodes[2], this.nodes[3], 1000.0, 100.0, 3600.0, 1.0);
			this.links[3] = network.createLink(new IdImpl(3), this.nodes[0], this.nodes[4], 1000.0, 100.0, 3600.0, 1.0);
			this.links[4] = network.createLink(new IdImpl(4), this.nodes[0], this.nodes[5], 1000.0, 100.0, 3600.0, 1.0);
			this.links[5] = network.createLink(new IdImpl(5), this.nodes[5], this.nodes[1], 1000.0, 100.0, 3600.0, 1.0);
			this.links[6] = network.createLink(new IdImpl(6), this.nodes[5], this.nodes[2], 1000.0, 100.0, 3600.0, 1.0);
			this.links[7] = network.createLink(new IdImpl(7), this.nodes[2], this.nodes[6], 1000.0, 100.0, 3600.0, 1.0);
			this.links[8] = network.createLink(new IdImpl(8), this.nodes[2], this.nodes[7], 1000.0, 100.0, 3600.0, 1.0);
			this.links[9] = network.createLink(new IdImpl(9), this.nodes[4], this.nodes[5], 1000.0, 100.0, 3600.0, 1.0);
			this.links[10] = network.createLink(new IdImpl(10), this.nodes[5], this.nodes[6], 1000.0, 100.0, 3600.0, 1.0);
			this.links[11] = network.createLink(new IdImpl(11), this.nodes[6], this.nodes[7], 1000.0, 100.0, 3600.0, 1.0);
