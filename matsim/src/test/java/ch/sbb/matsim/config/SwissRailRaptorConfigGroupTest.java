...
public class SwissRailRaptorConfigGroupTest {
  ...
  public void testConfigIO_intermodalAccessEgress() {
    ...
    List<IntermodalAccessEgressParameterSet> parameterSets =
        config2.getIntermodalAccessEgressParameterSets();
  ...
  public void testConfigIO_modeMappings() {
    ...
    ModeMappingForPassengersParameterSet trainMapping =
        config2.getModeMappingForPassengersParameterSet("train");
    ...
    ModeMappingForPassengersParameterSet tramMapping =
        config2.getModeMappingForPassengersParameterSet("tram");
    ...
    ModeMappingForPassengersParameterSet busMapping =
        config2.getModeMappingForPassengersParameterSet("bus");
