...
/**
 * Provides a simple scenario with a single transit line connecting two areas (one around
 * coordinates 10000/10000, the other around 50000/10000). In each area, several transit stops with
 * different characteristics are located along the transit line:
 *
 * <pre>
 * [n]  stop facility
 * ---  link, transit route
 ...
 *
 * <ul>
 *   <li>0: bikeAccessible=true hub=false
 *   <li>1: bikeAccessible=false hub=true
 *   <li>2: bikeAccessible=false hub=false
 *   <li>3: bikeAccessible=true hub=true
 *   <li>4: bikeAccessible=false hub=false
 *   <li>5: bikeAccessible=true hub=true
 *   <li>6: (none)
 *   <li>7: bikeAccessible=true
 * </ul>
 *
  ...
  IntermodalFixture() {
    ...
    stops[0] =
        sf.createTransitStopFacility(
            Id.create(0, TransitStopFacility.class), new Coord(9000, 10000), false);
    stops[1] =
        sf.createTransitStopFacility(
            Id.create(1, TransitStopFacility.class), new Coord(9500, 10000), false);
    stops[2] =
        sf.createTransitStopFacility(
            Id.create(2, TransitStopFacility.class), new Coord(10000, 10000), false);
    stops[3] =
        sf.createTransitStopFacility(
            Id.create(3, TransitStopFacility.class), new Coord(10500, 10000), false);
    stops[4] =
        sf.createTransitStopFacility(
            Id.create(4, TransitStopFacility.class), new Coord(49500, 10000), false);
    stops[5] =
        sf.createTransitStopFacility(
            Id.create(5, TransitStopFacility.class), new Coord(50000, 10000), false);
    stops[6] =
        sf.createTransitStopFacility(
            Id.create(6, TransitStopFacility.class), new Coord(50500, 10000), false);
    stops[7] =
        sf.createTransitStopFacility(
            Id.create(7, TransitStopFacility.class), new Coord(51000, 10000), false);
    ...
    NetworkRoute networkRoute =
        RouteUtils.createLinkNetworkRouteImpl(
            ptLinkIds[0], Arrays.copyOfRange(ptLinkIds, 1, 7), ptLinkIds[7]);
    TransitRoute route =
        sf.createTransitRoute(
            Id.create("goEast", TransitRoute.class), networkRoute, rStops, "train");
