  ...
  public void testUseSlowerAlternative() {
    ...
    tracker.handleEvent(
        new TransitDriverStartsEvent(
            Time.parseTime("06:55:00"), driver1, vehicle1, f.fastLineId, f.fastRouteId, fastDep1));
    tracker.handleEvent(
        new PersonEntersVehicleEvent(Time.parseTime("06:55:00"), driver1, vehicle1));
    tracker.handleEvent(
    ...
    tracker.handleEvent(
        new PersonEntersVehicleEvent(Time.parseTime("07:00:20"), person2, vehicle1));
    tracker.handleEvent(
    ...
    tracker.handleEvent(
        new TransitDriverStartsEvent(
            Time.parseTime("07:05:00"), driver2, vehicle2, f.fastLineId, f.fastRouteId, fastDep2));
    tracker.handleEvent(
        new PersonEntersVehicleEvent(Time.parseTime("07:05:00"), driver2, vehicle2));
    tracker.handleEvent(
    ...
    tracker.handleEvent(
        new PersonEntersVehicleEvent(Time.parseTime("07:10:20"), person4, vehicle2));
    tracker.handleEvent(
        new PersonEntersVehicleEvent(Time.parseTime("07:10:25"), person5, vehicle2));
    tracker.handleEvent(
    ...
    tracker.handleEvent(
        new TransitDriverStartsEvent(
            Time.parseTime("07:15:00"), driver3, vehicle3, f.fastLineId, f.fastRouteId, fastDep3));
    tracker.handleEvent(
        new PersonEntersVehicleEvent(Time.parseTime("07:15:00"), driver3, vehicle3));
    tracker.handleEvent(
        new VehicleArrivesAtFacilityEvent(Time.parseTime("07:20:00"), vehicle2, f.stopAId, 0));
    tracker.handleEvent(
        new PersonEntersVehicleEvent(Time.parseTime("07:20:10"), person6, vehicle3));
    tracker.handleEvent(
    ...
    List<? extends PlanElement> route2 =
        raptor.calcRoute(
            DefaultRoutingRequest.withoutAttributes(
                fromFacility, toFacility, Time.parseTime("07:00:00"), null));
