...
public class SwissRailRaptorTreeTest {
  ...
  public void testSingleStop_dep0740atN_optimized() {
    ...
    SwissRailRaptorData data =
        SwissRailRaptorData.create(
            f.scenario.getTransitSchedule(), null, config, f.scenario.getNetwork(), null);
    ...
    TransitStopFacility fromStop =
        f.schedule.getFacilities().get(Id.create(23, TransitStopFacility.class));
    double depTime = 7 * 3600 + 40 * 60;
    Map<Id<TransitStopFacility>, TravelInfo> map =
        raptor.calcTree(fromStop, depTime, raptorParams, null);

    Assert.assertEquals(
        "wrong number of reached stops.", f.schedule.getFacilities().size(), map.size());

    assertTravelInfo(
        map, 0, "23", 1, "07:41:00", "08:14:07"); // transfer at C, 7:50/8:02 blue, walk at A
    assertTravelInfo(map, 1, "23", 1, "07:41:00", "08:14:00"); // transfer at C, 7:50/8:02 blue
    assertTravelInfo(
        map, 2, "23", 1, "07:41:00", "08:09:07"); // transfer at C, 7:50/8:02 blue, walk at B
    ...
    assertTravelInfo(
        ...
        0,
        "07:41:00",
        "07:50:04"); // transfer at C, 7:50, walk 3.12 (-> 4) seconds (2.6 meters)
    assertTravelInfo(
        map,
        5,
        "23",
    ...
    assertTravelInfo(
        map, 7, "23", 1, "07:41:00", "08:09:07"); // transfer at C, 7:50/8:02 blue, walk at D
    assertTravelInfo(map, 8, "23", 1, "07:41:00", "08:16:00"); // transfer at C, 7:50/8:02 blue
    assertTravelInfo(
        map, 9, "23", 1, "07:41:00", "08:16:07"); // transfer at C, 7:50/8:02 blue, walk at E
    assertTravelInfo(
        map,
        10,
        "23",
        1,
        "07:41:00",
        "08:23:00"); // transfer at C, 7:50/8:02 blue (travelling to 11 and transferring would be
    ...
    assertTravelInfo(
        ...
        2,
        "07:41:00",
        "08:19:00"); // transfer at C, 7:50/8:00 red, transfer at G, 8:09/8:12
    ...
    assertTravelInfo(
        ...
        1,
        "07:41:00",
        "08:09:07"); // transfer at C, 7:50/8:00 red, walk 4 meters / 7 seconds
    assertTravelInfo(
        map,
        14,
        "23",
    ...
    assertTravelInfo(
        ...
        2,
        "07:41:00",
        "08:24:00"); // transfer at C, 7:50/8:00 red, transfer at G, 8:09/8:12
    ...
    assertTravelInfo(
        ...
        1,
        "07:41:00",
        "08:09:04"); // transfer at C, 7:50/8:00 red, walk 2.6 meters / 4 seconds
    assertTravelInfo(
        map,
        22,
        "23",
        2,
        "07:41:00",
        "08:21:00"); // transfer at C, 7:50/8:00 red, transfer at G 8:09/8:11
  ...
  public void testSingleStop_dep0740atN_unoptimized() {
    ...
    assertTravelInfo(
        ...
        2,
        "07:41:00",
        "08:33:00"); // transfer at C, 7:50/8:00 red, transfer at G 8:09/8.12
    assertTravelInfo(map, 8, "23", 1, "07:41:00", "08:16:00"); // transfer at C, 7:50/8:02 blue
    assertTravelInfo(
        map,
        9,
        ...
        2,
        "07:41:00",
        "08:26:00"); // transfer at C, 7:50/8:00 red, transfer at G 8:09/8.12
    assertTravelInfo(
        map,
        10,
        "23",
    ...
    assertTravelInfo(
        ...
        1,
        "07:41:00",
        "08:09:04"); // transfer at C, 7:50/8:00 red, walk 2.6 meters / 3.12 (-> 4) seconds
    assertTravelInfo(
        map,
        22,
        "23",
  ...
  public void testSingleStop_dep0750atN_optimized() {
    ...
    assertTravelInfo(
        ...
        0,
        "07:51:00",
        "08:00:04"); // transfer at C, 8:00, walk 3.12 (-> 4) seconds (2 meters)
    assertTravelInfo(
        map,
        5,
        "23",
    ...
    assertTravelInfo(
        ...
        1,
        "07:51:00",
        "08:28:07"); // transfer at C, 8:00/8:02 blue, walk (4 meters) (transfer to red line is
    // allowed)
    ...
    assertTravelInfo(
        ...
        1,
        "07:51:00",
        "08:28:04"); // transfer at C, 8:00/8:01 green, walk 2 meters / 3.12 (-> 4) seconds
  ...
  public void testSingleStop_dep0750atN_unoptimized() {
    ...
    assertTravelInfo(
        ...
        0,
        "07:51:00",
        "08:00:04"); // transfer at C, 8:00, walk 3.12 (-> 4) seconds (2.6 meters)
    assertTravelInfo(
        map,
        5,
        "23",
    ...
    Assert.assertNull(
        map.get(
            Id.create(
                7,
                TransitStopFacility
                    .class))); // unreachable, no more departures at C(red) or G(blue)
    assertTravelInfo(map, 8, "23", 1, "07:51:00", "08:16:00"); // transfer at C, 8:00/8:02 blue
    Assert.assertNull(
        map.get(
            Id.create(
    ...
    assertTravelInfo(
        ...
        1,
        "07:51:00",
        "08:28:04"); // transfer at C, 8:00/8:01 green, walk 2.6 meters / 4 seconds
    Assert.assertNull(map.get(Id.create(22, TransitStopFacility.class)));
    assertTravelInfo(map, 23, "23", 0, "07:50:00", "07:50:00"); // our start location
  }
  ...
  public void testMultipleStops_optimized() {
    ...
    // start at B and H
    TransitStopFacility fromStopB =
        f.schedule.getFacilities().get(Id.create(2, TransitStopFacility.class));
    TransitStopFacility fromStopH =
        f.schedule.getFacilities().get(Id.create(15, TransitStopFacility.class));
    ...
    Map<Id<TransitStopFacility>, TravelInfo> map =
        raptor.calcTree(fromStops, depTime, raptorParams, null);

    Assert.assertEquals(
        "wrong number of reached stops.", f.schedule.getFacilities().size(), map.size());

    assertTravelInfo(
        map, 0, "2", 0, "07:49:00", "07:54:07"); // initial transfer at B (not counted), walk at A
    ...
    assertTravelInfo(
        ...
        0,
        "07:33:00",
        "08:03:00"); // from B, directly reachable (would be faster from H, but not cheaper due to
    // the transfer penalty at the end)
    ...
    assertTravelInfo(
        map, 19, "2", 1, "07:33:00", "07:51:00"); // from B, transfer at C, 7:38/7:41 green
    assertTravelInfo(
        map, 20, "2", 1, "07:33:00", "08:01:00"); // from B, transfer at C, 7:38/7:41 green
    assertTravelInfo(map, 21, "15", 0, "07:43:00", "07:48:04"); // from H, transfer at G (walk)
    assertTravelInfo(
        map, 22, "15", 1, "07:43:00", "08:01:00"); // from H, transfer at G, 7:48/7:51 green
    assertTravelInfo(
        map, 23, "15", 1, "07:43:00", "08:11:00"); // from H, transfer at G, 7:48/7:51 green
  }
  ...
  public void testMultipleStops_unoptimized() {
    ...
    Assert.assertNull(map.get(Id.create(17, TransitStopFacility.class))); // unreachable
    assertTravelInfo(
        map, 18, "2", 0, "07:33:00", "07:38:04"); // from B, transfer at C, 7:38 (walk 2.6m)
    assertTravelInfo(
        map, 19, "2", 1, "07:33:00", "07:51:00"); // from B, transfer at C, 7:38/7:41 green
    assertTravelInfo(
        map, 20, "2", 1, "07:33:00", "08:01:00"); // from B, transfer at C, 7:38/7:41 green
  ...
  public void testSingleStop_costs_dep0740atN_optimized() {
    ...
    TravelInfo info0739 =
        raptor.calcTree(fromStop, 7 * 3600 + 39 * 60, raptorParams, null).get(stop19id);

    Assert.assertEquals(
        "departure time should be the same.",
        info0740.ptDepartureTime,
        info0739.ptDepartureTime,
        0.0);
    Assert.assertEquals(
        "arrival time should be the same.", info0740.ptArrivalTime, info0739.ptArrivalTime, 0.0);
    Assert.assertEquals(
        "travel time should be the same.", info0740.ptTravelTime, info0739.ptTravelTime, 0.0);
    Assert.assertEquals(
        "access time should be independent of waiting time.",
        info0740.accessTime,
        info0739.accessTime,
        0.0);
    Assert.assertEquals(
        "access cost should be independent of waiting time.",
        info0740.accessCost,
        info0739.accessCost,
        0.0);
    Assert.assertEquals(
        "travel cost should be independent of waiting time.",
        info0740.travelCost,
        info0739.travelCost,
        0.0);

    Assert.assertEquals(
        "waiting time should differ by 1 minute",
        info0740.waitingTime,
        info0739.waitingTime - 60,
        0.0);
  ...
  private void assertTravelInfo(
      Map<Id<TransitStopFacility>, TravelInfo> map,
      int stopId,
      String expectedDepartureStop,
    ...
    Assert.assertEquals(
        "wrong departure stop", expectedDepartureStop, info.departureStop.toString());
    Assert.assertEquals("wrong number of transfers", expectedTransfers, info.transferCount);
    Assert.assertEquals(
        "unexpected arrival time: " + Time.writeTime(info.ptArrivalTime),
        Time.parseTime(expectedArrivalTime),
        Math.floor(info.ptArrivalTime),
        0.0);
    Assert.assertEquals(
        "unexpected departure time: " + Time.writeTime(info.ptDepartureTime),
        Time.parseTime(expectedDepartureTime),
        Math.floor(info.ptDepartureTime),
        0.0);
  }
}
