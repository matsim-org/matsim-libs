...
/*package*/ class Fixture {
	...
	protected void buildNetwork() {
		this.nodes[0]  = this.network.getFactory().createNode(Id.create("0", Node.class), new Coord(0, 5000));
		this.nodes[1]  = this.network.getFactory().createNode(Id.create("1", Node.class), new Coord(4000, 5000));
		this.nodes[2]  = this.network.getFactory().createNode(Id.create("2", Node.class), new Coord(8000, 5000));
		this.nodes[3]  = this.network.getFactory().createNode(Id.create("3", Node.class), new Coord(12000, 5000));
		this.nodes[4]  = this.network.getFactory().createNode(Id.create("4", Node.class), new Coord(16000, 5000));
		this.nodes[5]  = this.network.getFactory().createNode(Id.create("5", Node.class), new Coord(20000, 5000));
		this.nodes[6]  = this.network.getFactory().createNode(Id.create("6", Node.class), new Coord(24000, 5000));
		this.nodes[7]  = this.network.getFactory().createNode(Id.create("7", Node.class), new Coord(28000, 5000));
		this.nodes[8]  = this.network.getFactory().createNode(Id.create("8", Node.class), new Coord(32000, 5000));
		this.nodes[9]  = this.network.getFactory().createNode(Id.create("9", Node.class), new Coord(36000, 5000));
		this.nodes[10] = this.network.getFactory().createNode(Id.create("10", Node.class), new Coord(40000, 5000));
		this.nodes[11] = this.network.getFactory().createNode(Id.create("11", Node.class), new Coord(12000, 5000));
		this.nodes[12] = this.network.getFactory().createNode(Id.create("12", Node.class), new Coord(16000, 10000));
		this.nodes[13] = this.network.getFactory().createNode(Id.create("13", Node.class), new Coord(24000, 10000));
		this.nodes[14] = this.network.getFactory().createNode(Id.create("14", Node.class), new Coord(28000, 5000));
		this.nodes[15] = this.network.getFactory().createNode(Id.create("15", Node.class), new Coord(24000, 0));
		this.nodes[16] = this.network.getFactory().createNode(Id.create("16", Node.class), new Coord(16000, 0));
		for (int i = 0; i < 17; i++) {
	...
	protected void buildStops() {
		this.stopFacilities[ 0] = this.builder.createTransitStopFacility(Id.create( "0", TransitStopFacility.class), new Coord(4000, 5002), true);
		this.stopFacilities[ 1] = this.builder.createTransitStopFacility(Id.create( "1", TransitStopFacility.class), new Coord(4000, 4998), true);
		this.stopFacilities[ 2] = this.builder.createTransitStopFacility(Id.create( "2", TransitStopFacility.class), new Coord(8000, 5002), true);
		this.stopFacilities[ 3] = this.builder.createTransitStopFacility(Id.create( "3", TransitStopFacility.class), new Coord(8000, 4998), true);
		this.stopFacilities[ 4] = this.builder.createTransitStopFacility(Id.create( "4", TransitStopFacility.class), new Coord(12000, 5002), true);
		this.stopFacilities[ 5] = this.builder.createTransitStopFacility(Id.create( "5", TransitStopFacility.class), new Coord(12000, 4998), true);
		this.stopFacilities[ 6] = this.builder.createTransitStopFacility(Id.create( "6", TransitStopFacility.class), new Coord(16000, 5002), true);
		this.stopFacilities[ 7] = this.builder.createTransitStopFacility(Id.create( "7", TransitStopFacility.class), new Coord(16000, 4998), true);
		this.stopFacilities[ 8] = this.builder.createTransitStopFacility(Id.create( "8", TransitStopFacility.class), new Coord(20000, 5002), true);
		this.stopFacilities[ 9] = this.builder.createTransitStopFacility(Id.create( "9", TransitStopFacility.class), new Coord(20000, 4998), true);
		this.stopFacilities[10] = this.builder.createTransitStopFacility(Id.create("10", TransitStopFacility.class), new Coord(24000, 5002), true);
		this.stopFacilities[11] = this.builder.createTransitStopFacility(Id.create("11", TransitStopFacility.class), new Coord(24000, 4998), true);
		this.stopFacilities[12] = this.builder.createTransitStopFacility(Id.create("12", TransitStopFacility.class), new Coord(28000, 5002), true);
		this.stopFacilities[13] = this.builder.createTransitStopFacility(Id.create("13", TransitStopFacility.class), new Coord(28000, 4998), true);
		this.stopFacilities[14] = this.builder.createTransitStopFacility(Id.create("14", TransitStopFacility.class), new Coord(32000, 5002), true);
		this.stopFacilities[15] = this.builder.createTransitStopFacility(Id.create("15", TransitStopFacility.class), new Coord(32000, 4998), true);
		this.stopFacilities[16] = this.builder.createTransitStopFacility(Id.create("16", TransitStopFacility.class), new Coord(36000, 5002), true);
		this.stopFacilities[17] = this.builder.createTransitStopFacility(Id.create("17", TransitStopFacility.class), new Coord(36000, 4998), true);
		this.stopFacilities[18] = this.builder.createTransitStopFacility(Id.create("18", TransitStopFacility.class), new Coord(12000, 5000), true);
		this.stopFacilities[19] = this.builder.createTransitStopFacility(Id.create("19", TransitStopFacility.class), new Coord(16000, 10000), true);
		this.stopFacilities[20] = this.builder.createTransitStopFacility(Id.create("20", TransitStopFacility.class), new Coord(24000, 10000), true);
		this.stopFacilities[21] = this.builder.createTransitStopFacility(Id.create("21", TransitStopFacility.class), new Coord(28000, 5000), true);
		this.stopFacilities[22] = this.builder.createTransitStopFacility(Id.create("22", TransitStopFacility.class), new Coord(24000, 0), true);
		this.stopFacilities[23] = this.builder.createTransitStopFacility(Id.create("23", TransitStopFacility.class), new Coord(16000, 0), true);
