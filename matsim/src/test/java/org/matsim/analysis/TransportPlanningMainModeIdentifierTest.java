...
public class TransportPlanningMainModeIdentifierTest {
  ...
  private void performTest(ArrayList<Plan> plansList) {
    ...
    TransportPlanningMainModeIdentifier transportPlanningMainModeIdentifier =
        new TransportPlanningMainModeIdentifier();
    mainMode =
        transportPlanningMainModeIdentifier.identifyMainMode(plansList.get(0).getPlanElements());
    validateValues(plansList.get(0), mainMode);
    mainMode =
        transportPlanningMainModeIdentifier.identifyMainMode(plansList.get(1).getPlanElements());
    validateValues(plansList.get(1), mainMode);
    mainMode =
        transportPlanningMainModeIdentifier.identifyMainMode(plansList.get(2).getPlanElements());
    validateValues(plansList.get(2), mainMode);
    mainMode =
        transportPlanningMainModeIdentifier.identifyMainMode(plansList.get(3).getPlanElements());
