...
public class VolumesAnalyzerTest {
  ...
  public void performTest() {
    ...
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(3600.0, person4, link1, veh4, TransportMode.car, 1.0));
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(3610.0, person1, link1, veh1, TransportMode.car, 2.0));

    analyzer.handleEvent(new LinkLeaveEvent(5100, veh4, link1));
    analyzer.handleEvent(new LinkLeaveEvent(5410, veh1, link1));

    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(7200.0, person2, link1, veh2, TransportMode.car, 1.0));
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(7210.0, person5, link1, veh5, TransportMode.car, 2.0));
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(7215.0, person4, link1, veh4, TransportMode.car, 3.0));
    ...
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(10800.0, person1, link1, veh1, TransportMode.car, 1.0));
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(10810.0, person3, link1, veh3, TransportMode.car, 2.0));

    analyzer.handleEvent(new LinkLeaveEvent(12600, veh1, link1));
    analyzer.handleEvent(new LinkLeaveEvent(12370, veh3, link1));

    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(21600.0, person1, link1, veh1, TransportMode.car, 1.0));
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(21650.0, person2, link1, veh2, TransportMode.car, 2.0));
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(21700.0, person3, link1, veh3, TransportMode.car, 3.0));
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(21750.0, person4, link1, veh4, TransportMode.car, 4.0));
    analyzer.handleEvent(
        new VehicleEntersTrafficEvent(21800.0, person5, link1, veh5, TransportMode.car, 5.0));
    ...
    analyzerBike.handleEvent(
        new VehicleEntersTrafficEvent(21600.0, person1, link2, veh1, TransportMode.bike, 1.0));
    analyzerBike.handleEvent(
        new VehicleEntersTrafficEvent(21650.0, person2, link2, veh2, TransportMode.bike, 2.0));
    analyzerBike.handleEvent(
        new VehicleEntersTrafficEvent(21700.0, person3, link2, veh3, TransportMode.bike, 3.0));
    analyzerBike.handleEvent(
        new VehicleEntersTrafficEvent(21750.0, person4, link2, veh4, TransportMode.car, 4.0));
    analyzerBike.handleEvent(
        new VehicleEntersTrafficEvent(21800.0, person5, link2, veh5, TransportMode.car, 5.0));
