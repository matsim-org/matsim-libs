...
public class Plans {
  ...
  public Plan createPlanOne() {
    ...
    leg3.getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("car3"));
    ...
    leg6.getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("car6"));
    ...
    leg9.getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("car9"));
    ...
    leg12
        .getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("pt12"));
    ...
    TransitStopFacility egressFacility =
        sBuilder.createTransitStopFacility(
            Id.create("1", TransitStopFacility.class), act12.getCoord(), false);
    TransitStopFacility accessFacility =
        sBuilder.createTransitStopFacility(
            Id.create("2", TransitStopFacility.class), act12.getCoord(), false);
    TransitPassengerRoute ptRoute =
        new DefaultTransitPassengerRoute(
            accessFacility.getLinkId(),
            egressFacility.getLinkId(),
            accessFacility.getId(),
            egressFacility.getId(),
            Id.create("transitline1", TransitLine.class),
            Id.create("transitroute1", TransitRoute.class));
    ...
    leg15
        .getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("pt15"));
    ...
    leg17
        .getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("car17"));
  ...
  public Plan createPlanTwo() {
    ...
    final Plan plan2 =
        PopulationUtils.createPlan(
            PopulationUtils.getFactory().createPerson(Id.create("2", Person.class)));
    ...
    legp2_2
        .getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("carp2_2"));
    ...
    legp2_7
        .getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("carp2_7"));
  ...
  public Plan createPlanThree() {
    ...
    final Plan plan3 =
        PopulationUtils.createPlan(
            PopulationUtils.getFactory().createPerson(Id.create("3", Person.class)));
    ...
    legp3_2
        .getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("carp3_2"));
    ...
    legp3_5
        .getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("carp3_5"));
  ...
  public Plan createPlanFour() {
    ...
    final Plan plan4 =
        PopulationUtils.createPlan(
            PopulationUtils.getFactory().createPerson(Id.create("4", Person.class)));
    ...
    legp4_2
        .getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("ptp4_2"));
    // pt route
    TransitStopFacility egressFacility =
        sBuilder.createTransitStopFacility(
            Id.create("3", TransitStopFacility.class), actp4_2.getCoord(), false);
    TransitStopFacility accessFacility =
        sBuilder.createTransitStopFacility(
            Id.create("4", TransitStopFacility.class), actp4_2.getCoord(), false);
    TransitPassengerRoute ptRoute =
        new DefaultTransitPassengerRoute(
            accessFacility.getLinkId(),
            egressFacility.getLinkId(),
            accessFacility.getId(),
            egressFacility.getId(),
            Id.create("transitline2", TransitLine.class),
            Id.create("transitroute2", TransitRoute.class));
    ...
    legp4_5
        .getAttributes()
        .putAttribute(EventsToLegs.VEHICLE_ID_ATTRIBUTE_NAME, Id.createVehicleId("ptp4_5"));
