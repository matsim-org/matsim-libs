...
public class CalcAverageTripLengthTest {
  ...
  public void testWithRoute() {
    ...
    Node n1, n2, n3, n4, n5;
    network.addNode(
        n1 = nf.createNode(Id.create("1", Node.class), new Coord((double) 0, (double) 0)));
    network.addNode(
        n2 = nf.createNode(Id.create("2", Node.class), new Coord((double) 50, (double) 0)));
    network.addNode(
        n3 = nf.createNode(Id.create("3", Node.class), new Coord((double) 100, (double) 0)));
    network.addNode(
        n4 = nf.createNode(Id.create("4", Node.class), new Coord((double) 200, (double) 0)));
    network.addNode(
        n5 = nf.createNode(Id.create("5", Node.class), new Coord((double) 400, (double) 0)));
