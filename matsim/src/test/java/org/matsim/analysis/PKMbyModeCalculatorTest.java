...
public class PKMbyModeCalculatorTest {
	...
	public void testPKMbyModeCalculator() {
		...
		Activity actp4_2 = PopulationUtils.createActivityFromLinkId("car interaction", link1);
		...
		Activity actp4_3 = PopulationUtils.createActivityFromLinkId("pt interaction", link3);
		...
		Activity actp4_5 = PopulationUtils.createActivityFromLinkId("pt interaction", link3);
		...
		Activity actp4_6 = PopulationUtils.createActivityFromLinkId("pt interaction", link1);
