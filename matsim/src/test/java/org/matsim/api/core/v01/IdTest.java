...
public class IdTest {
  ...
  private static final Logger LOG = LogManager.getLogger(IdTest.class);
  ...
  public void testResetCaches() {
    ...
    Assert.assertTrue(
        count > 0); // it might be > 2 if other tests have run before creating Ids of this class
    Id.resetCaches();
  ...
  public void testResetCaches_onlyFromJUnit() throws InterruptedException {
    ...
    Assert.assertEquals(
        "The number of created Ids should not have changed.", countBefore, countAfter);
  }
