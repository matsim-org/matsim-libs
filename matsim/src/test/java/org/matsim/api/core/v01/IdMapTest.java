...
public class IdMapTest {
  ...
  public void testEqualsAndHashCode() {
    ...
    // The commented out tests will fail right now because the hashCode of IdImpl is based on the
    // id, not the index
    ...
    // Best way I could think of to explicitly test the equals() of Entry (i.e. not inside the
    // EntrySet)
