...
public class VehiclesImplTest {
  ...
  public void testAddVehicle() {
    ...
    VehicleType testType =
        vehicles.getFactory().createVehicleType(Id.create("test", VehicleType.class));
    ...
    try {
      ...
      Assert.fail(
          "Should not allow adding a vehicle if vehicle type has not been added to container first.");
