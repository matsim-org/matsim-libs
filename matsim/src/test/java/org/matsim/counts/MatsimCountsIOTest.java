...
public class MatsimCountsIOTest {
  ...
  /**
   * Such a file with year 0 could be created by MATSim when the year was not explicitly set, but it
   * could not be read back in as "0" was not recognized as a valid year by the XML validator
   * originally.
   */
  @Test
