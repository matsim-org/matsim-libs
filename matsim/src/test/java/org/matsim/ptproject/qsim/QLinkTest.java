...
public class QLinkTest extends MatsimTestCase {
	...
	public void testAdd() {
		...
		v.setDriver(new QPersonAgent(p, new QSim(scenario, new EventsManagerImpl())));
	...
	public void testGetVehicle_Driving() {
		...
		veh.setDriver(new QPersonAgent(p, qsim));
