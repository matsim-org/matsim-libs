...
public class TripsToLegsAlgorithmTest {
  private static class Fixture {
    ...
    public Fixture(final String name, final Plan plan, final List<PlanElement> structure) {
      this.name = name;
      this.plan = plan;
  ...
  public void testMonoLegPlan() throws Exception {
    final Plan plan =
        PopulationUtils.createPlan(
            PopulationUtils.getFactory().createPerson(Id.create("id", Person.class)));
    ...
    performTest(new Fixture("mono leg trips", plan, structure));
  }
  ...
  public void testMultiLegPlan() throws Exception {
    ...
    performTest(new Fixture("multi leg trips", plan, structure));
  }
  ...
  public void testDummyActsPlan() throws Exception {
    ...
    performTest(new Fixture("dummy act trips", plan, structure));
  }
