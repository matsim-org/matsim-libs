...
/**
 * Tests specific to the "complex trip" handling (tests in ChooseRandomLegModeForSubtourTest were
 * designed for mono-leg trips, and I tried to keep them as close to the original as possible.
 *
 * @author thibautd
 */
