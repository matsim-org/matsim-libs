...
public class LanesUtilsTest {
  ...
  private LanesToLinkAssignment createLaneAssignment(
      Scenario scenario, double inLength, double leftLength, double straightLength) {
    ...
    LanesToLinkAssignment laneLinkAssignment =
        factory.createLanesToLinkAssignment(linkIdBeforeIntersection);
