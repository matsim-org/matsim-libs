...
public class LinkChangeFlowCapacityEventTest extends MatsimTestCase {
	...
	public void testWriteReadXml() {
		...
		final LinkChangeFlowCapacityEventImpl event1 = new LinkChangeFlowCapacityEventImpl(6823.8, new IdImpl("abcd"), changeValue);
		final LinkChangeFlowCapacityEventImpl event2 = XmlEventsTester.testWriteReadXml(getOutputDirectory() + "events.xml", event1);
