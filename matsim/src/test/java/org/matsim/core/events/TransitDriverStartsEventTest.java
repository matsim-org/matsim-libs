...
public class TransitDriverStartsEventTest {
  ...
  public void testWriteReadXml() {
    final TransitDriverStartsEvent event1 =
    ...
    final TransitDriverStartsEvent event2 =
        XmlEventsTester.testWriteReadXml(this.utils.getOutputDirectory() + "events.xml", event1);
