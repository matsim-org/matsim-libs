...
public class EventWriterXMLTest {
  ...
  /**
   * Some people use the ids as names, including special characters in there... so make sure
   * attribute values are correctly encoded when written to a file.
   */
  @Test
  public void testSpecialCharacters() {
    ...
    writer.handleEvent(
        new LinkLeaveEvent(
            3600.0, Id.create("vehicle>3", Vehicle.class), Id.create("link<2", Link.class)));
    writer.handleEvent(
        new LinkLeaveEvent(
            3601.0, Id.create("vehicle\"4", Vehicle.class), Id.create("link'3", Link.class)));
    writer.closeFile();
