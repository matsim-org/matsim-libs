...
public class CustomEventTest {
  ...
  public void testCustomEventCanBeWrittenAndRead_XML() {
    ...
    eventsReaderXMLv1.addCustomEventMapper(
        "rain",
        event ->
            new RainOnPersonEvent(
                event.getTime(), Id.createPersonId(event.getAttributes().get("person"))));
  ...
  public void testCustomEventCanBeWrittenAndRead_Json() {
    ...
    eventsReader.addCustomEventMapper(
        "rain",
        event ->
            new RainOnPersonEvent(
                event.getTime(), Id.createPersonId(event.getAttributes().get("person"))));
