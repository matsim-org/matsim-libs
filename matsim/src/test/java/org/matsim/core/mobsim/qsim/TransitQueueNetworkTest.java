...
public class TransitQueueNetworkTest {
  ...
  /**
   * Tests that a non-blocking stops on the first link of a transit vehicle's network route is
   * correctly handled.
   *
   ...
   */
  @Test
  public void testNonBlockingStop_FirstLink()
      throws SecurityException,
    ...
    assertEquals(
        f.normalVehicle,
        f.qlink2.getAllVehicles().toArray(new MobsimVehicle[1])[0]); // first the normal vehicle
  ...
  /**
   * Tests that blocking stops are correctly handled on the first link of a transit vehicle's
   * network route. Note that on the first link, a stop is by definition non-blocking, as the
   * wait2buffer-queue is seen as similary independent than the transit stop queue! So, it
   * essentially tests the same thing as {@link #testNonBlockingStop_FirstLink()}.
   *
   * @throws NoSuchMethodException
   * @throws SecurityException
   * @throws InvocationTargetException
   ...
   */
  @Test
  public void testBlockingStop_FirstLink()
      throws SecurityException,
          NoSuchMethodException,
          IllegalArgumentException,
          IllegalAccessException,
  ...
  /**
   * Tests that a non-blocking stop is correctly handled when it is somewhere in the middle of the
   * transit vehicle's network route.
   *
   * @throws NoSuchMethodException
   * @throws SecurityException
   * @throws InvocationTargetException
   ...
   */
  @Test
  public void testNonBlockingStop_MiddleLink()
      throws SecurityException,
          NoSuchMethodException,
          IllegalArgumentException,
          IllegalAccessException,
  ...
  /**
   * Tests that a blocking stop is correctly handled when it is somewhere in the middle of the
   * transit vehicle's network route.
   *
   * @throws NoSuchMethodException
   * @throws SecurityException
   ...
   */
  @Test
  public void testBlockingStop_MiddleLink()
      throws SecurityException,
          NoSuchMethodException,
          IllegalArgumentException,
          IllegalAccessException,
  ...
  /**
   * Tests that a non-blocking stop is correctly handled when it is the last link of the transit
   ...
   */
  @Test
  public void testNonBlockingStop_LastLink()
      throws SecurityException,
          NoSuchMethodException,
          IllegalArgumentException,
          IllegalAccessException,
  ...
  /**
   * Tests that a blocking stop is correctly handled when it is the last link of the transit
   * vehicle's network route.
   *
   * @throws NoSuchMethodException
   * @throws SecurityException
   ...
   */
  @Test
  public void testBlockingStop_LastLink()
      throws SecurityException,
          NoSuchMethodException,
          IllegalArgumentException,
          IllegalAccessException,
  ...
  @Test
  public void testTwoStopsOnOneLink_FirstLink()
      throws IllegalArgumentException,
          SecurityException,
          IllegalAccessException,
          InvocationTargetException,
    ...
    Fixture f =
        new Fixture(
            1, true, 1, true); // first stop at the first link is non-blocking by definition!

    // time 100: agents start, transitVeh is moved to qlink1.transitStopQueue (delay 19, exit-time
    // 119), normalVeh is moved to qlink1.buffer
    f.simEngine.doSimStep(100);
    assertEquals(0, f.qlink2.getAllVehicles().size());
  ...
  @Test
  public void testTwoStopsOnOneLink_MiddleLink_FirstBlockThenNonBlock()
      throws IllegalArgumentException,
          SecurityException,
          IllegalAccessException,
          InvocationTargetException,
    ...
    // time 220: transitVeh moved from stop1 (blocking) to stop2 (non-blocking, delay 19, exit-time
    // 239), normalVeh moved to qlink2.buffer
    f.qsim.getSimTimer().setTime(220);
    f.simEngine.doSimStep(220);
    assertEquals(3, f.qlink2.getAllVehicles().size());
  ...
  @Test
  public void testTwoStopsOnOneLink_MiddleLink_FirstNonBlockThenBlock()
      throws IllegalArgumentException,
          SecurityException,
          IllegalAccessException,
          InvocationTargetException,
  ...
  @Test
  public void testTwoStopsOnOneLink_LastLink_FirstBlockThenNonBlock()
      throws IllegalArgumentException,
          SecurityException,
          IllegalAccessException,
          InvocationTargetException,
  ...
  @Test
  public void testTwoStopsOnOneLink_LastLink_FirstNonBlockThenBlock()
      throws IllegalArgumentException,
          SecurityException,
          IllegalAccessException,
          InvocationTargetException,
    ...
    // time 340: transitVeh left qlink3, and also normalVeh2 left qlink3 (no flow-restriction when
    // leaving link)
    f.qsim.getSimTimer().setTime(340);
    f.simEngine.doSimStep(340);
    assertEquals(0, f.qlink3.getAllNonParkedVehicles().size());
  ...
  protected static class Fixture {
     ...
     */
    public Fixture(
        final int firstStopLocation,
        final boolean firstStopisBlocking,
        final int secondStopLocation,
        final boolean secondStopIsBlocking)
        throws IllegalArgumentException,
            IllegalAccessException,
            InvocationTargetException,
            SecurityException,
      ...
      Node node2 =
          NetworkUtils.createAndAddNode(network, id4, new Coord((double) 1000, (double) 0));
      final Id<Node> id5 = nodeId3;
      Node node3 =
          NetworkUtils.createAndAddNode(network, id5, new Coord((double) 2000, (double) 0));
      final Id<Node> id6 = nodeId4;
      Node node4 =
          NetworkUtils.createAndAddNode(network, id6, new Coord((double) 3000, (double) 0));
      ...
      links[1] =
          NetworkUtils.createAndAddLink(
              network, id, fromNode, toNode, 1000.0, 10.0, 3600.0, (double) 1);
      final Id<Link> id1 = linkId2;
      final Node fromNode1 = node2;
      final Node toNode1 = node3;
      links[2] =
          NetworkUtils.createAndAddLink(
              network, id1, fromNode1, toNode1, 1000.0, 10.0, 3600.0, (double) 1);
      final Id<Link> id2 = linkId3;
      final Node fromNode2 = node3;
      final Node toNode2 = node4;
      links[3] =
          NetworkUtils.createAndAddLink(
              network, id2, fromNode2, toNode2, 1000.0, 10.0, 3600.0, (double) 1);
      ...
      NetworkRoute route =
          RouteUtils.createLinkNetworkRouteImpl(links[1].getId(), links[3].getId());
      ...
      if (secondStopLocation > 0) {
        stop2 =
            builder.createTransitStopFacility(
                ...
                new Coord((double) 100, (double) 0),
                secondStopIsBlocking);
      ...
      TransitRoute tRoute =
          builder.createTransitRoute(
              Id.create("1", TransitRoute.class), netRoute, stops, TransportMode.pt);
      ...
      TransitQSimEngine transitEngine =
          qsim.getChildInjector().getInstance(TransitQSimEngine.class);
      ...
      tracker.addAgentToStop(
          90,
          new FakeAgent(null, null),
          stop1.getId()); // just add some agent so the transit vehicle has to stop
      if (stop2 != null) {
        tracker.addAgentToStop(
            92,
            new FakeAgent(null, null),
            stop2.getId()); // just add some agent so the transit vehicle has to stop
      }
      qsim.getSimTimer().setTime(100);

      // setup: vehicles
      VehicleType vehicleType =
          VehicleUtils.createVehicleType(Id.create("testVehicleType", VehicleType.class));
      ...
      this.transitVehicle =
          new TransitQVehicle(
              VehicleUtils.createVehicle(Id.create(tDriver.getId(), Vehicle.class), vehicleType));

      //            this.qlink1.addParkedVehicle(this.transitVehicle);
      ((QNetsimEngineI) this.simEngine)
          .addParkedVehicle(this.transitVehicle, this.qlink1.getLink().getId());
      ...
      this.normalVehicle =
          new QVehicleImpl(VehicleUtils.createVehicle(Id.create("2", Vehicle.class), vehicleType));
      //            this.qlink1.addParkedVehicle(this.normalVehicle);
      ((QNetsimEngineI) this.simEngine)
          .addParkedVehicle(this.normalVehicle, this.qlink1.getLink().getId());
      ...
      if (stop2 != null) {
        ...
        this.normalVehicle2 =
            new QVehicleImpl(
                VehicleUtils.createVehicle(Id.create("3", Vehicle.class), vehicleType));
        //                this.qlink1.addParkedVehicle(this.normalVehicle2);
        ((QNetsimEngineI) this.simEngine)
            .addParkedVehicle(this.normalVehicle2, this.qlink1.getLink().getId());
    ...
    private PersonDriverAgentImpl createAndInsertPersonDriverAgentImpl(Person person) {
      PersonDriverAgentImpl agent =
          new PersonDriverAgentImpl(
              person.getSelectedPlan(),
              qsim,
              qsim.getChildInjector().getInstance(TimeInterpretation.class));
  ...
  /**
   * A simple extension of {@link TransitDriverAgentImpl} that ignores the fact when there are still
   * people in the vehicle after the last stop is handled.
   *
   * @author mrieser
   */
  private static class FakeTransitDriver extends TransitDriverAgentImpl {

    public FakeTransitDriver(
        final TransitLine line,
        final TransitRoute route,
        final Departure departure,
        final TransitStopAgentTracker agentTracker,
        final TransitQSimEngine trEngine) {
      super(
          new SingletonUmlaufBuilderImpl(Collections.singleton(line)).build().get(0),
          TransportMode.car,
          agentTracker,
          trEngine.getInternalInterface());
    }
