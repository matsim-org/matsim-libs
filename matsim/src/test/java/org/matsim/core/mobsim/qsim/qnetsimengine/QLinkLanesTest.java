...
public class QLinkLanesTest {
  ...
  private static void initNetwork(Network network) {
    ...
    Node node2 =
        network
            .getFactory()
            .createNode(Id.create("2", Node.class), new Coord((double) 1, (double) 0));
    Node node3 =
        network
            .getFactory()
            .createNode(Id.create("3", Node.class), new Coord((double) 2, (double) 0));
  ...
  private static void createOneLane(Scenario scenario, int numberOfRepresentedLanes) {
    ...
    // lanes for link 1
    LanesToLinkAssignment lanesForLink1 =
        builder.createLanesToLinkAssignment(Id.create(1, Link.class));
