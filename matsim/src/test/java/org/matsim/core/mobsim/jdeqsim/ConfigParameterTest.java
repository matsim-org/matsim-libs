...
public class ConfigParameterTest {
  ...
  public void testParametersSetCorrectly() {
    ...
    JDEQSimConfigGroup jdeqSimConfigGroup =
        ConfigUtils.addOrGetModule(config, JDEQSimConfigGroup.NAME, JDEQSimConfigGroup.class);
    assertEquals(
        360.0, jdeqSimConfigGroup.getSimulationEndTime().seconds(), MatsimTestUtils.EPSILON);
