...
public class TransitQueueSimulationTest {
    ...
    public void testAddAgentToStopWrongLink() {
        ...
        // run simulation
        EventsManager events = EventsUtils.createEventsManager();
        QSim simulation = (QSim) QSimUtils.createDefaultQSim(scenario, events);
        simulation.run();
    }
    ...
    public void testStartAndEndTime() {
        ...
        sim = (QSim) QSimUtils.createDefaultQSim(scenario, events);
        sim.run();
    ...
    public void testEvents() {
        ...
        assertTrue(allEvents.get(++idx) instanceof VehicleDepartsAtFacilityEvent);
        assertTrue(allEvents.get(++idx) instanceof VehicleLeavesTrafficEvent);
