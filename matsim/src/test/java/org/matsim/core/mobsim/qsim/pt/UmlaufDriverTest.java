...
public class UmlaufDriverTest {
  ...
  public void testInitializationNetworkRoute() {
    ...
    TransitRoute tRoute =
        builder.createTransitRoute(
            Id.create("L", TransitRoute.class),
            route,
    ...
    AbstractTransitDriverAgent driver =
        new TransitDriverAgentImpl(
            umlauf, TransportMode.walk, null, trEngine.getInternalInterface());
  ...
  public void testInitializationDeparture() {
    ...
    AbstractTransitDriverAgent driver =
        new TransitDriverAgentImpl(
            umlauf, TransportMode.car, tracker, trEngine.getInternalInterface());
  ...
  public void testInitializationStops() {
    ...
    TransitRoute tRoute =
        builder.createTransitRoute(Id.create("L", TransitRoute.class), route, stops, "bus");
    Departure dep = builder.createDeparture(Id.create("L1.1", Departure.class), 9876.0);
    TransitStopAgentTracker tracker = new TransitStopAgentTracker(events);
    Scenario scenario = ScenarioUtils.createScenario(ConfigUtils.createConfig());
    PrepareForSimUtils.createDefaultPrepareForSim(scenario).run();
  ...
  public void testReturnSensiblePlanElements() {
    ...
    AbstractTransitDriverAgent driver =
        new TransitDriverAgentImpl(
            umlauf, TransportMode.walk, tracker, trEngine.getInternalInterface());
    TransitQVehicle queueVehicle = new TransitQVehicle(vehicle);
    queueVehicle.setStopHandler(new SimpleTransitStopHandler());
    driver.setVehicle(queueVehicle);
