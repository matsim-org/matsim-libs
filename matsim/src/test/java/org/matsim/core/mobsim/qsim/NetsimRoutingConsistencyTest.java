...
public class NetsimRoutingConsistencyTest {
  ...
  public void testRoutingVsSimulation() {
    ...
    Arrays.asList(link12, link23, link34, link45)
        .forEach(l -> l.setAllowedModes(Collections.singleton(TransportMode.car)));
    ...
    Activity startActivity =
        population.getFactory().createActivityFromLinkId("A", Id.createLinkId("L12"));
    startActivity.setEndTime(0.0);
    Activity endActivity =
        population.getFactory().createActivityFromLinkId("A", Id.createLinkId("L45"));
    ...
    Vehicle vehicle =
        scenario
            ...
            .getFactory()
            .createVehicle(
                VehicleUtils.createVehicleId(person, TransportMode.car),
    ...
    NetworkRoutingModule routingModule =
        new NetworkRoutingModule(TransportMode.car, population.getFactory(), network, router);
            ...
            routingModule
                .calcRoute(
                    DefaultRoutingRequest.withoutAttributes(
                        new LinkWrapperFacility(link12),
                        new LinkWrapperFacility(link45),
                        0.0,
                        person))
                .get(0);
  ...
  public void testRoutingVsSimulationFullStack() {
    ...
    Vehicle vehicle =
        scenario
            .getVehicles()
            .getFactory()
            .createVehicle(Id.createVehicleId("P"), VehicleUtils.getDefaultVehicleType());
    scenario.getVehicles().addVehicleType(VehicleUtils.getDefaultVehicleType());
    scenario.getVehicles().addVehicle(vehicle);
