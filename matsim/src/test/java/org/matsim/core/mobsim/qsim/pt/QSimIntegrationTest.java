...
public class QSimIntegrationTest {
  ...
  @Test
  public void test_twoStopsOnFirstLink()
    ...
    SelectiveEventsCollector coll =
        new SelectiveEventsCollector(
            TransitDriverStartsEvent.class,
            PersonDepartureEvent.class,
            VehicleArrivesAtFacilityEvent.class,
            VehicleDepartsAtFacilityEvent.class,
            PersonArrivalEvent.class,
  ...
  @Test
  public void test_multipleStopsOnFirstLink_singleLinkRoute_noPassengers()
      throws SAXException, ParserConfigurationException, IOException {
    Fixture f = new Fixture();
    String scheduleXml =
        ""
  ...
  @Test
  public void test_multipleStopsOnFirstLink_singleLinkRoute_withPassengersAtFirstStop()
      throws SAXException, ParserConfigurationException, IOException {
    Fixture f = new Fixture();
    String scheduleXml =
        ""
    ...
    SelectiveEventsCollector coll =
        new SelectiveEventsCollector(
            ...
            PersonArrivalEvent.class,
            LinkEnterEvent.class,
            PersonEntersVehicleEvent.class,
            PersonLeavesVehicleEvent.class);
    eventsManager.addHandler(coll);
  ...
  @Test
  public void test_multipleStopsOnFirstLink_singleLinkRoute_withPassengersAtSecondStop()
      throws SAXException, ParserConfigurationException, IOException {
    Fixture f = new Fixture();
    String scheduleXml =
        ""
  ...
  /**
   * This checks for the right events in the case of a stupid-looking transit route which has only
   * two stops which are even the same. But think about round-trip ship cruises, tourist buses etc
   * and it makes more sense. To add a twist assume some non-useful (because automatically
   * generated) network route with only a single link and no real round-trip route.
   *
   * <p>And yes, this case has appeared in real data, that's why there is a test case for it...
   * (mrieser, jan2014)
   *
   * @throws SAXException
   ...
   */
  @Test
  public void test_circularEmptyRoute_singleLinkRoute_noPassengers()
      throws SAXException, ParserConfigurationException, IOException {
    Fixture f = new Fixture();
    String scheduleXml =
        ""
  ...
  private static class Fixture {
    ...
    public Fixture() throws SAXException, ParserConfigurationException, IOException {
      ...
      new MatsimVehicleReader(this.scenario.getTransitVehicles())
          .readStream(new ByteArrayInputStream(vehiclesXml.getBytes()));
    }
