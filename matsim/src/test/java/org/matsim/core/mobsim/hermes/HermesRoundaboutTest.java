...
public class HermesRoundaboutTest {
    ...
    config
        ...
        .setAccessEgressType(
            RoutingConfigGroup.AccessEgressType
                .accessEgressModeToLink); // standard accessEgressMode is walk
  ...
  private void buildPopulation(Scenario scenario) {
    List<Tuple<Coord, Coord>> startEndRelations =
        List.of(
            new Tuple<>(A_START, D_START),
            new Tuple<>(B_START, A_START),
            new Tuple<>(C_START, B_START),
            new Tuple<>(D_START, C_START));
  ...
  private void buildRoundaboutNetwork(Scenario scenario) {
    ...
    Link a1a =
        NetworkUtils.createAndAddLink(network, Id.createLinkId("a1_a"), a1, a, 20, 8, 1100, 1);
    Link aa1 =
        NetworkUtils.createAndAddLink(network, Id.createLinkId("a_a1"), a, a1, 20, 8, 1100, 1);
    Link a1a2 =
        NetworkUtils.createAndAddLink(
            network, Id.createLinkId("a1_a2"), a1, a2, 2000, 8, 720000, 1);
    Link a2a1 =
        NetworkUtils.createAndAddLink(
            network, Id.createLinkId("a2_a1"), a2, a1, 2000, 8, 720000, 1);
    ...
    Link b1b =
        NetworkUtils.createAndAddLink(network, Id.createLinkId("b1_b"), b1, b, 20, 8, 1100, 1);
    Link bb1 =
        NetworkUtils.createAndAddLink(network, Id.createLinkId("b_b1"), b, b1, 20, 8, 1100, 1);
    Link b1b2 =
        NetworkUtils.createAndAddLink(
            network, Id.createLinkId("b1_b2"), b1, b2, 2000, 8, 720000, 1);
    Link b2b1 =
        NetworkUtils.createAndAddLink(
            network, Id.createLinkId("b2_b1"), b2, b1, 2000, 8, 720000, 1);
    ...
    Link c1c =
        NetworkUtils.createAndAddLink(network, Id.createLinkId("c1_c"), c1, c, 20, 8, 1100, 1);
    Link cc1 =
        NetworkUtils.createAndAddLink(network, Id.createLinkId("c_c1"), c, c1, 20, 8, 1100, 1);
    Link c1c2 =
        NetworkUtils.createAndAddLink(
            network, Id.createLinkId("c1_c2"), c1, c2, 2000, 8, 720000, 1);
    Link c2c1 =
        NetworkUtils.createAndAddLink(
            network, Id.createLinkId("c2_c1"), c2, c1, 2000, 8, 720000, 1);
    ...
    Link d1d =
        NetworkUtils.createAndAddLink(network, Id.createLinkId("d1_d"), d1, d, 20, 8, 1100, 1);
    Link dd1 =
        NetworkUtils.createAndAddLink(network, Id.createLinkId("d_d1"), d, d1, 20, 8, 1100, 1);
    Link d1d2 =
        NetworkUtils.createAndAddLink(
            network, Id.createLinkId("d1_d2"), d1, d2, 2000, 8, 720000, 1);
    Link d2d1 =
        NetworkUtils.createAndAddLink(
            network, Id.createLinkId("d2_d1"), d2, d1, 2000, 8, 720000, 1);
  }
}
