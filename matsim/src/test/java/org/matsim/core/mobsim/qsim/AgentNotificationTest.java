...
public class AgentNotificationTest {
  ...
  public void testAgentNotification() {
        ...
        .addQSimModule(
            new AbstractQSimModule() {
              ...
              protected void configureQSim() {
                ...
                addQSimComponentBinding(PopulationModule.COMPONENT_NAME)
                    .to(PopulationAgentSource.class);
    ...
    assumeThat(
        handler.getEvents(),
        hasItem(is(both(eventWithTime(25200.0)).and(instanceOf(PersonDepartureEvent.class)))));
    assertThat(
        handler.getEvents(),
        hasItem(
            is(
                both(eventWithTime(25800.0))
                    .and(instanceOf(MyAgentFactory.MyAgent.HomesicknessEvent.class)))));
  }
  ...
  private static Scenario createSimpleScenario() {
    ...
    Node node2 =
        network.getFactory().createNode(Id.create("2", Node.class), new Coord(1000.0, 0.0));
