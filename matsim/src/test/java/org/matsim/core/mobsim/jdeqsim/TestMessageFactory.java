...
public class TestMessageFactory {
  ...
  public void testMessageFactory1() {
    ...
    MessageFactory.disposeEndLegMessage(
        new EndLegMessage(null, null, TimeInterpretation.create(ConfigUtils.createConfig())));
  ...
  public void testMessageFactory3() {
    ...
    MessageFactory.getEndLegMessage(
        null, null, TimeInterpretation.create(ConfigUtils.createConfig()));
  ...
  public void testMessageFactory5() {
    ...
    assertEquals(
        true,
        MessageFactory.getEndLegMessage(scheduler, vehicle, timeInterpretation).scheduler
            == scheduler);
    assertEquals(
        true, MessageFactory.getEnterRoadMessage(scheduler, vehicle).scheduler == scheduler);
    assertEquals(
        true, MessageFactory.getStartingLegMessage(scheduler, vehicle).scheduler == scheduler);
    assertEquals(
        true, MessageFactory.getLeaveRoadMessage(scheduler, vehicle).scheduler == scheduler);
    assertEquals(true, MessageFactory.getEndRoadMessage(scheduler, vehicle).scheduler == scheduler);
    assertEquals(
        true,
        MessageFactory.getDeadlockPreventionMessage(scheduler, vehicle).scheduler == scheduler);

    assertEquals(
        true,
        MessageFactory.getEndLegMessage(scheduler, vehicle, timeInterpretation).vehicle == vehicle);
