...
/**
 * This test shows that Guice creates Singletons solely based on the *class name*. So as shown in
 * the example one can bind the same class to different interfaces, even with different names. If
 * the class is declared in the Singleton scope, it will always be the *same* object that is used.
 */
