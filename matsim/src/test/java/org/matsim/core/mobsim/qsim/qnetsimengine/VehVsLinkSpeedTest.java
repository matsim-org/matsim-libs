...
public class VehVsLinkSpeedTest {
  ...
  private static final double MAX_SPEED_ON_LINK = 25; // in m/s

  @Parameters(name = "{index}: vehicleSpeed == {0};")
  public static Collection<Object> createFds() {
    Object[] vehSpeeds = new Object[] {30, 20};
  ...
  public void testVehicleSpeed() {
    ...
    Assert.assertEquals(
        "In the simulation minimum of vehicle speed and link speed should be used.",
        Math.min(vehSpeed, MAX_SPEED_ON_LINK),
        speedUsedInSimulation,
  ...
  private static final class SimpleNetwork {
    ...
    public SimpleNetwork() {
      ...
      allowedModes.addAll(Arrays.asList("car", "bike"));
  ...
  private static class VehicleLinkTravelTimeHandler
