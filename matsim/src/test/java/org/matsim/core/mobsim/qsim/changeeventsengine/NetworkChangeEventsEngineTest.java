...
public class NetworkChangeEventsEngineTest {
  ...
  public void testActivation_inactive() {
    ...
    Link link1 =
        scenario.getNetwork().getFactory().createLink(Id.create(1, Link.class), node1, node2);
    ...
    NetworkChangeEventsEngine engine =
        new NetworkChangeEventsEngine(scenario.getNetwork(), new MessageQueue());
    ...
    changeEvent.setFreespeedChange(
        new NetworkChangeEvent.ChangeValue(NetworkChangeEvent.ChangeType.ABSOLUTE_IN_SI_UNITS, 50));
  ...
  public void testActivation_timedepOnly_capacity() {
    ...
    NetworkChangeEvent changeEvent = new NetworkChangeEvent(37);
    changeEvent.addLink(link1);
    changeEvent.setFlowCapacityChange(
        new NetworkChangeEvent.ChangeValue(NetworkChangeEvent.ChangeType.FACTOR, 2));
    engine.addNetworkChangeEvent(changeEvent);
