...
public class TransitDriverTest {
  ...
  public void testInitializationNetworkRoute() {
    ...
    Node node4 =
        NetworkUtils.createAndAddNode(
            network, Id.create("4", Node.class), new Coord((double) 3000, (double) 0));
    Node node5 =
        NetworkUtils.createAndAddNode(
            network, Id.create("5", Node.class), new Coord((double) 4000, (double) 0));
    Node node6 =
        NetworkUtils.createAndAddNode(
            network, Id.create("6", Node.class), new Coord((double) 5000, (double) 0));
    ...
    TransitRoute tRoute =
        builder.createTransitRoute(
            Id.create("L1", TransitRoute.class),
            route,
    ...
    driver.setVehicle(
        new TransitQVehicle(VehicleUtils.createVehicle(Id.create("V1", Vehicle.class), vehType)));
  ...
  public void testInitializationStops() {
    ...
    TransitStopFacility stop1 =
        builder.createTransitStopFacility(
            Id.create("1", TransitStopFacility.class), new Coord((double) 500, (double) 0), false);
    TransitStopFacility stop2 =
        builder.createTransitStopFacility(
            Id.create("2", TransitStopFacility.class), new Coord((double) 1500, (double) 0), false);
    TransitStopFacility stop3 =
        builder.createTransitStopFacility(
            Id.create("3", TransitStopFacility.class), new Coord((double) 2500, (double) 0), false);
    TransitStopFacility stop4 =
        builder.createTransitStopFacility(
            Id.create("4", TransitStopFacility.class), new Coord((double) 3500, (double) 0), false);
    ...
    TransitRoute tRoute =
        builder.createTransitRoute(Id.create("L1", TransitRoute.class), route, stops, "bus");
    Departure dep = builder.createDeparture(Id.create("L1.1", Departure.class), 9876.0);
    tRoute.addDeparture(dep);
    tLine.addRoute(tRoute);
    TransitStopAgentTracker tracker = new TransitStopAgentTracker(eventsManager);
  ...
  public void testHandleStop_EnterPassengers() {
    ...
    TransitStopFacility stop3 =
        builder.createTransitStopFacility(
            Id.create("3", TransitStopFacility.class), new Coord((double) 1500, (double) 0), false);
    stops.add(builder.createTransitRouteStop(stop1, 50, 60));
    stops.add(builder.createTransitRouteStop(stop2, 150, 160));
    stops.add(builder.createTransitRouteStop(stop3, 250, 260));
    NetworkRoute route = RouteUtils.createLinkNetworkRouteImpl(null, null);
    ...
    assertEquals(
        "driver must not proceed in stop list when persons entered.",
        stop1,
        driver.getNextTransitStop());
    assertEquals(0, tracker.getAgentsAtFacility(stop1.getId()).size());
    assertEquals(
        "stop time must be 0 when nobody enters or leaves",
        0.0,
        driver.handleTransitStop(stop1, 60),
        MatsimTestUtils.EPSILON);
    assertEquals(2, queueVehicle.getPassengers().size());
    assertEquals(
        "driver must proceed in stop list when no persons entered.",
        stop2,
        driver.getNextTransitStop());
    assertEquals(
        "driver must return same stop again when queried again without handling stop.",
        stop2,
        driver.getNextTransitStop());
    ...
    assertTrue(
        "The first stoptime should be larger as it contains door-opening/closing times as well. stoptime1="
            + stoptime1
            + "  stoptime2="
            + stoptime2,
        stoptime1 > stoptime2);
    ...
    assertEquals(
        "vehicle should have reached capacity, so not more passenger can enter.",
        0.0,
        driver.handleTransitStop(stop2, 170),
        MatsimTestUtils.EPSILON);
  ...
  public void testHandleStop_CorrectIdentification() {
    ...
    TransitStopFacility stop2 =
        builder.createTransitStopFacility(
            Id.create("1", TransitStopFacility.class), new Coord((double) 1000, (double) 0), false);
    stops.add(builder.createTransitRouteStop(stop1, 50, 60));
  ...
  public void testHandleStop_AwaitDepartureTime() {
    ...
    TransitStopFacility stop2 =
        builder.createTransitStopFacility(
            Id.create("2", TransitStopFacility.class), new Coord((double) 500, (double) 0), false);
    TransitStopFacility stop3 =
        builder.createTransitStopFacility(
            Id.create("3", TransitStopFacility.class), new Coord((double) 500, (double) 0), false);
    double departureOffset1 = 60;
    double departureOffset2 = 160;
    TransitRouteStop routeStop1 =
        builder.createTransitRouteStop(stop1, departureOffset1 - 10.0, departureOffset1);
    routeStop1.setAwaitDepartureTime(true);
    stops.add(routeStop1);
    TransitRouteStop routeStop2 =
        builder.createTransitRouteStop(stop2, departureOffset2 - 10.0, departureOffset2);
    ...
    assertEquals(
        50.0, driver.handleTransitStop(stop1, departureTime + 10), MatsimTestUtils.EPSILON);
    assertEquals(
        40.0, driver.handleTransitStop(stop1, departureTime + 20), MatsimTestUtils.EPSILON);
    assertEquals(
        30.0, driver.handleTransitStop(stop1, departureTime + 30), MatsimTestUtils.EPSILON);
    assertEquals(0.0, driver.handleTransitStop(stop1, departureTime + 60), MatsimTestUtils.EPSILON);

    // stop2 is not awaitDepartureTime
    assertEquals(
        0.0, driver.handleTransitStop(stop2, departureTime + 110), MatsimTestUtils.EPSILON);

    // stop3 has no departure time
    assertEquals(
        0.0, driver.handleTransitStop(stop3, departureTime + 210), MatsimTestUtils.EPSILON);
  }
  ...
  public void testExceptionWhenNotAllStopsServed() {
    ...
    stops.add(builder.createTransitRouteStop(stop3, 250, 260));
    NetworkRoute route =
        RouteUtils.createLinkNetworkRouteImpl(Id.create(1, Link.class), Id.create(2, Link.class));
    TransitRoute tRoute =
        builder.createTransitRoute(Id.create("L1", TransitRoute.class), route, stops, "bus");
    Departure dep = builder.createDeparture(Id.create("L1.1", Departure.class), 9876.0);
    tRoute.addDeparture(dep);
    ...
    try {
      ...
      fail(
          "missing exception: driver has not yet handled all stops, although it has no more links in its route.");
    } catch (RuntimeException e) {
      log.info("catched expected exception.", e);
    }
  }
