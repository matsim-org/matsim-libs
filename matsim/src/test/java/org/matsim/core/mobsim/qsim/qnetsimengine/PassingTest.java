...
public class PassingTest {
  ...
  /**
   * A bike enters at t=0; and a car at t=5sec link length = 1000m Assume car speed = 20 m/s, bike
   * speed = 5 m/s tt_car = 50 sec; tt_bike = 200 sec
   */
  @Test
  public void test4PassingInFreeFlowState() {
    ...
    Map<Id<Vehicle>, Map<Id<Link>, Double>> vehicleLinkTravelTimes =
        handler.getVehicleId2LinkTravelTime();
