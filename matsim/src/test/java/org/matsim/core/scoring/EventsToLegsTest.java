...
public class EventsToLegsTest {
	...
	public static Scenario createTriangularNetwork() {
	...
	public static void assertLeg(RememberingLegHandler lh, double departureTime, double travelTime, double distance,
								 String mode) {
	...
	public static class RememberingLegHandler implements LegHandler {
