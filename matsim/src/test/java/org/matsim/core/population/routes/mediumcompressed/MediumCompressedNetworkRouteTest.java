...
public class MediumCompressedNetworkRouteTest extends AbstractNetworkRouteTest {
  ...
  /**
   * Tests that {@link MediumCompressedNetworkRoute#getLinkIds()} doesn't crash or hang when a route
  ...
  public void testClone() {
    ...
    MediumCompressedNetworkRoute route1 =
        new MediumCompressedNetworkRoute(startLink.getId(), endLink.getId());
