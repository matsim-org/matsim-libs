...
/**
 * Tests several methods of {@link NetworkRoute}. Classes inheriting from RouteImpl should be able
 * to inherit from this test, too, and only overwrite the method getRouteInstance().
 *
 * @author mrieser
 */
public abstract class AbstractNetworkRouteTest {

  private static final Logger log = LogManager.getLogger(AbstractNetworkRouteTest.class);

  protected abstract NetworkRoute getNetworkRouteInstance(
  ...
  protected Network createTestNetwork() {
    ...
    Node node0 =
        NetworkUtils.createAndAddNode(
            network, Id.create("0", Node.class), new Coord((double) 0, (double) 500));
    Node node1 =
        NetworkUtils.createAndAddNode(
    ...
    Node node11 =
        NetworkUtils.createAndAddNode(
            network, Id.create("11", Node.class), new Coord((double) 0, (double) 1000));
    Node node12 =
        NetworkUtils.createAndAddNode(
            network, Id.create("12", Node.class), new Coord((double) 1000, (double) 1000));
    Node node13 =
        NetworkUtils.createAndAddNode(
            network, Id.create("13", Node.class), new Coord((double) 2000, (double) 1000));
    Node node14 =
        NetworkUtils.createAndAddNode(
            network, Id.create("14", Node.class), new Coord((double) 3000, (double) 1000));
    Node node15 =
        NetworkUtils.createAndAddNode(
            network, Id.create("15", Node.class), new Coord((double) 4000, (double) 1000));
    Node node16 =
        NetworkUtils.createAndAddNode(
            network, Id.create("16", Node.class), new Coord((double) 5000, (double) 1000));
    final Node fromNode = node0;
    final Node toNode = node1;

    NetworkUtils.createAndAddLink(
        network, Id.create("0", Link.class), fromNode, toNode, 500.0, 100.0, 3600.0, (double) 1);
    final Node fromNode1 = node1;
    final Node toNode1 = node2;
    NetworkUtils.createAndAddLink(
        network, Id.create("1", Link.class), fromNode1, toNode1, 1000.0, 100.0, 3600.0, (double) 1);
    final Node fromNode2 = node2;
    final Node toNode2 = node3;
    NetworkUtils.createAndAddLink(
        network, Id.create("2", Link.class), fromNode2, toNode2, 1000.0, 100.0, 3600.0, (double) 1);
    final Node fromNode3 = node3;
    final Node toNode3 = node4;
    NetworkUtils.createAndAddLink(
        network, Id.create("3", Link.class), fromNode3, toNode3, 1000.0, 100.0, 3600.0, (double) 1);
    final Node fromNode4 = node4;
    final Node toNode4 = node5;
    NetworkUtils.createAndAddLink(
        network, Id.create("4", Link.class), fromNode4, toNode4, 1000.0, 100.0, 3600.0, (double) 1);
