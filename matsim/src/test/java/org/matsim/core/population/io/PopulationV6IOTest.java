...
public class PopulationV6IOTest {
  ...
  public void testPlanAttributesIO() {
    ...
    Assert.assertEquals(
        plan.getAttributes().getAttribute("beauty"),
  ...
  public void testRouteIO() {
    ...
    GenericRouteImpl route =
        new GenericRouteImpl(Id.create("a", Link.class), Id.create("b", Link.class));
  ...
  public void testSpecialCharactersIO() {
    ...
    Person p1 =
        scenario.getPopulation().getPersons().get(person1.getId()); // this already checks the id
  ...
  public void testPopulationCoordinateTransformationIO() {
    ...
    plan.addActivity(
        population
            .getFactory()
            .createInteractionActivityFromCoord("home", new Coord(712568.0, 256600.0)));
    person.addPlan(plan);
