...
public class MatsimPopulationReaderTest {
  ...
  public void testReadFile_v5() {
    Scenario s = ScenarioUtils.createScenario(ConfigUtils.createConfig());
    Assert.assertEquals(0, s.getPopulation().getPersons().size());
    new PopulationReader(s)
        .readFile(
            "test/input/org/matsim/core/utils/io/MatsimFileTypeGuesserTest/population_v5_example.xml");
    Assert.assertEquals(1, s.getPopulation().getPersons().size());
  ...
  public void testReadFile_v5_multipleSuccessiveLegs() {
    ...
    new PopulationReader(s)
        .readFile(
            "test/input/org/matsim/core/utils/io/MatsimFileTypeGuesserTest/population_v5_multipleLegs.xml");
    Assert.assertEquals(1, s.getPopulation().getPersons().size());
    Person person = s.getPopulation().getPersons().get(Id.create(1, Person.class));
    Assert.assertNotNull(person);
    Plan plan = person.getSelectedPlan();
  ...
  public void testReadFile_v5_multipleSuccessiveLegsWithRoutes() {
    ...
    new PopulationReader(s)
        .readFile(
            "test/input/org/matsim/core/utils/io/MatsimFileTypeGuesserTest/population_v5_multipleLegsWithRoutes.xml");
    Assert.assertEquals(1, s.getPopulation().getPersons().size());
    Person person = s.getPopulation().getPersons().get(Id.create(1, Person.class));
    Assert.assertNotNull(person);
    Plan plan = person.getSelectedPlan();
    ...
    Assert.assertTrue(planElements.get(1) instanceof Leg);
    Assert.assertEquals(
        Id.create("1", Link.class), ((Leg) planElements.get(1)).getRoute().getStartLinkId());
    Assert.assertEquals(
        Id.create("2", Link.class), ((Leg) planElements.get(1)).getRoute().getEndLinkId());
    Assert.assertTrue(planElements.get(2) instanceof Leg);
    Assert.assertEquals(
        Id.create("2", Link.class), ((Leg) planElements.get(2)).getRoute().getStartLinkId());
    Assert.assertEquals(
        Id.create("4", Link.class), ((Leg) planElements.get(2)).getRoute().getEndLinkId());
    Assert.assertTrue(planElements.get(3) instanceof Leg);
    Assert.assertEquals(
        Id.create("4", Link.class), ((Leg) planElements.get(3)).getRoute().getStartLinkId());
    Assert.assertEquals(
        Id.create("6", Link.class), ((Leg) planElements.get(3)).getRoute().getEndLinkId());
    Assert.assertTrue(planElements.get(4) instanceof Activity);
  }
  ...
  public void testReadFile_v5_multipleSuccessiveLegsWithTeleportation() {
    ...
    new PopulationReader(s)
        .readFile(
            "test/input/org/matsim/core/utils/io/MatsimFileTypeGuesserTest/population_v5_multipleTeleportedLegs.xml");
    Assert.assertEquals(1, s.getPopulation().getPersons().size());
    Person person = s.getPopulation().getPersons().get(Id.create(1, Person.class));
    Assert.assertNotNull(person);
    Plan plan = person.getSelectedPlan();
