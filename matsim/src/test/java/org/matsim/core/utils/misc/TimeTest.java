...
public class TimeTest {
  ...
  public void testFormats() {
    ...
    assertEquals(
        12 * 3600.0 + 34 * 60.0 + 56.78,
        Time.parseTime("12:34:56.78"),
        0.0); // HHMMSS, support parts of seconds
  ...
  public void testSetDefault() {
    ...
    assertEquals(
        Integer.toString(12 * 3600 + 34 * 60 + 56), Time.writeTime(12 * 3600 + 34 * 60 + 56.789));
  ...
  public void testWriting() {
    ...
    assertEquals(
        "-01:02:03", Time.writeTime(-1 * 3600 - 2 * 60 - 3.4)); // negative with leading zero
