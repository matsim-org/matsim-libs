...
public class OsmNetworkReaderTest {
  ...
  /**
   * Tests that the conversion does not fail if a way does not contain any node. This might happen
   * if the osm-file was edited, e.g. with JOSM, and a link was deleted. Then, the way still exists,
   * but marked as deleted, and all nodes removed from it. Reported by jjoubert,15nov2012.
   */
  @Test
