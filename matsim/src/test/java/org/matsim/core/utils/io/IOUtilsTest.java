...
public class IOUtilsTest {
  ...
  public void testGetBufferedReader_encodingMacRoman() throws IOException {
    URL url =
        IOUtils.resolveFileOrResource(
            this.utils.getClassInputDirectory() + "textsample_MacRoman.txt");
  ...
  public void testGetBufferedReader_encodingIsoLatin1() throws IOException {
    URL url =
        IOUtils.resolveFileOrResource(
            this.utils.getClassInputDirectory() + "textsample_IsoLatin1.txt");
  ...
  public void testGetBufferedReader_encodingUTF8() throws IOException {
    URL url =
        IOUtils.resolveFileOrResource(this.utils.getClassInputDirectory() + "textsample_UTF8.txt");
  ...
  public void testGetBufferedWriter_encodingMacRoman() throws IOException {
    ...
    writer.close();
    long crc1 =
        CRCChecksum.getCRCFromFile(this.utils.getClassInputDirectory() + "textsample_MacRoman.txt");
  ...
  public void testGetBufferedWriter_encodingUTF8() throws IOException {
    ...
    writer.close();
    long crc1 =
        CRCChecksum.getCRCFromFile(this.utils.getClassInputDirectory() + "textsample_UTF8.txt");
    long crc2 = CRCChecksum.getCRCFromFile(filename);
  ...
  public void testGetBufferedWriter_gzipped() throws IOException {
    ...
    Assert.assertTrue(
        "compressed file should be less than 50 bytes, but is " + file.length(),
        file.length() < 50);
  }
  ...
  public void testGetBufferedWriter_lz4() throws IOException {
    ...
    File file = new File(filename);
    Assert.assertEquals(
        "compressed file should be equal 35 bytes, but is " + file.length(), 35, file.length());
  ...
  public void testGetBufferedWriter_bz2() throws IOException {
    ...
    File file = new File(filename);
    Assert.assertTrue(
        "compressed file should be equal 51 bytes, but is " + file.length(), file.length() == 51);
  }
  ...
  public void testGetBufferedWriter_zst() throws IOException {
    ...
    File file = new File(filename);
    Assert.assertEquals(
        "compressed file should be equal 28 bytes, but is " + file.length(), 28, file.length());
  }
  ...
  public void testGetBufferedReader_UTFwithoutBOM() throws IOException {
    ...
    {
      BufferedReader in =
          IOUtils.getBufferedReader(IOUtils.resolveFileOrResource(filename), IOUtils.CHARSET_UTF8);
      Assert.assertEquals(
          "ABCdef",
          new String(
              new byte[] {
    ...
    }
    {
      BufferedReader in =
          IOUtils.getBufferedReader(
              IOUtils.resolveFileOrResource(filename), IOUtils.CHARSET_WINDOWS_ISO88591);
      Assert.assertEquals(
          "ABCdef",
          new String(
              new byte[] {
  ...
  public void testGetBufferedReader_UTFwithBOM_Compressed() throws IOException {
    ...
    }
    {
      BufferedReader in =
          IOUtils.getBufferedReader(
              IOUtils.resolveFileOrResource(
                  filename.substring(0, filename.length() - 3))); // without the .gz extension
      Assert.assertEquals(
          "ABCdef",
          new String(
              new byte[] {
  ...
  /**
   * Based on a report from a user on the mailing list that he has problems creating files with '+'
   * in the filename.
   *
   * @author mrieser
   * @throws IOException
  ...
  public void testResolveFileOrResource_withWhitespace() throws URISyntaxException, IOException {
    ...
    File jarFile =
        new File("test/input/org/matsim/core/utils/io/IOUtils/test directory/testfile.jar");
    String fileUrlString = "jar:" + jarFile.toURI().toString() + "!/the_file.txt";
    Assert.assertTrue(
        fileUrlString.contains(
            "test%20directory")); // just make sure the space is correctly URL-encoded
  ...
  public void testEncryptedFile() throws IOException {
    ...
    String input =
        IOUtils.getBufferedReader(
                new File("test/input/org/matsim/core/utils/io/IOUtils/some.secret").toURL())
            .readLine();

    // openssl enc -aes256 -md sha512 -pbkdf2 -iter 10000 -in some.secret -out some.secret.enc
    BufferedReader decrypted =
        IOUtils.getBufferedReader(
            new File("test/input/org/matsim/core/utils/io/IOUtils/some.secret.enc").toURL());
    Assert.assertEquals(input, decrypted.readLine());

    BufferedReader gziped =
        IOUtils.getBufferedReader(
            new File("test/input/org/matsim/core/utils/io/IOUtils/some.secret.gz.enc").toURL());
