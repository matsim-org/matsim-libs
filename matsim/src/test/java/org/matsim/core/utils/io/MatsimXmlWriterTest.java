...
public class MatsimXmlWriterTest {
  ...
  /**
   * According to the type specificiation for the data type xs:double in XSD, special values like
   * infinity and not-a-number must be written as "INF", "-INF" and "NaN".
   */
  @Test
