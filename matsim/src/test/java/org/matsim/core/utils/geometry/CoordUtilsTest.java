...
public class CoordUtilsTest {
  ...
  public void testCalcEuclideanDistance() {
    ...
    assertEquals(
        Math.sqrt(2.0), CoordUtils.calcEuclideanDistance(c2a, c2d), MatsimTestUtils.EPSILON);
    ...
    assertEquals(
        Math.sqrt(3.0), CoordUtils.calcEuclideanDistance(c3a, c3e), MatsimTestUtils.EPSILON);

    // Mixed 2D and 3D
    assertEquals(
        Math.sqrt(2.0), CoordUtils.calcEuclideanDistance(c2a, c3e), MatsimTestUtils.EPSILON);
  }
  ...
  public void testCalcProjectedDistance() {
    ...
    assertEquals(
        Math.sqrt(2.0),
        CoordUtils.calcProjectedEuclideanDistance(c2a, c2b),
    ...
    assertEquals(
        Math.sqrt(2.0),
        CoordUtils.calcProjectedEuclideanDistance(c3a, c3b),
        MatsimTestUtils.EPSILON);

    // Mixed 2D and 3D
    assertEquals(
        Math.sqrt(2.0),
        CoordUtils.calcProjectedEuclideanDistance(c2a, c3b),
        MatsimTestUtils.EPSILON);
  }
