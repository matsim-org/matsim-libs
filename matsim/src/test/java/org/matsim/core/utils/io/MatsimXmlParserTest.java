...
public class MatsimXmlParserTest {
  ...
  /**
   * Tests that reading XML files with CRLF as newline characters works as expected. Based on a
   * (non-reproducible) bug message on the users-mailing list 2012-04-26.
   */
  @Test
  ...
  public void testParse_preventXEEattack_woodstox() throws IOException {
    ...
    String xml =
        "<?xml version='1.0' encoding='UTF-8'?>\n"
            + "<!DOCTYPE a SYSTEM \"network_v1.dtd\" [\n"
            + "<!ENTITY B_VALUE  \"b2\">\n"
            + "<!ENTITY SECRET_VALUE SYSTEM \"file://"
