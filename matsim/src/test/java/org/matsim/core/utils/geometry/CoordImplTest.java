...
public class CoordImplTest {
	...
	public void testHashCode() {
		int[] hashCodes = new int[] {
				new CoordImpl(1.0, 1.0).hashCode(),
				new CoordImpl(2.0, 2.0).hashCode(),
				new CoordImpl(3.0, 3.0).hashCode(),
				new CoordImpl(2.0, 1.0).hashCode(),
				new CoordImpl(3.0, 2.0).hashCode(),
				new CoordImpl(1.0, 2.0).hashCode(),
				new CoordImpl(2.0, 3.0).hashCode(),
				new CoordImpl(1.0, 3.0).hashCode(),
				new CoordImpl(3.0, 1.0).hashCode(),
				new CoordImpl(3.0, 1.5).hashCode(),
				new CoordImpl(3.0, 1.1).hashCode()
		};
