...
public class CoordImplTest {
  ...
  /**
   * The old hashCode implementation of CoordImpl has problems that it generated the same hash
   * values for coordinates that were located in a grid-like structure. Make sure the new hashCode
  ...
  public void testHashCode() {
    ...
    Assert.assertEquals(
        "There has been a hashCode collision, which is undesired!", hashCodes.length, cnt);
  }
}
