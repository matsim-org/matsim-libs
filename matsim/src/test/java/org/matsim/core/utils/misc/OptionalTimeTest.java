...
public class OptionalTimeTest {
  ...
  public void test_defined_seconds() {
    ...
    assertThat(OptionalTime.defined(Double.POSITIVE_INFINITY).seconds())
        .isEqualTo(Double.POSITIVE_INFINITY);

    // undefined
    assertThatThrownBy(() -> OptionalTime.defined(Time.UNDEFINED_TIME))
        .isExactlyInstanceOf(IllegalArgumentException.class)
        .hasMessage("Undefined time is not allowed");

    // NaN
    assertThatThrownBy(() -> OptionalTime.defined(Double.NaN))
        .isExactlyInstanceOf(IllegalArgumentException.class)
  ...
  public void test_undefined_seconds() {
    ...
    assertThatThrownBy(() -> OptionalTime.undefined().seconds())
    ...
    assertThatThrownBy(
            () ->
                OptionalTime.undefined()
                    .orElseThrow(() -> new IllegalStateException("Undefined time error")))
        .isExactlyInstanceOf(IllegalStateException.class)
        .hasMessage("Undefined time error");

    assertThatCode(
            () ->
                OptionalTime.defined(1)
                    .orElseThrow(() -> new IllegalStateException("Undefined time error")))
  ...
  public void test_or_OptionalTime() {
    ...
    assertThatThrownBy(() -> OptionalTime.undefined().or((OptionalTime) null))
  ...
  public void test_or_OptionalTimeSupplier() {
    ...
    assertThatThrownBy(() -> OptionalTime.undefined().or((Supplier<OptionalTime>) null))
        .isExactlyInstanceOf(NullPointerException.class);
    assertThatThrownBy(() -> OptionalTime.undefined().or(() -> null))
        .isExactlyInstanceOf(NullPointerException.class);
  }
  ...
  public void test_hashCode() {
    ...
    assertThat(OptionalTime.defined(Double.POSITIVE_INFINITY))
        .hasSameHashCodeAs(Double.POSITIVE_INFINITY);
  }
}
