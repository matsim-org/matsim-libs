...
public class ArrayMapTest {
	...
	void testForEach() {
		...
		Assertions.assertEquals("2", data.get(1).getFirst());
		Assertions.assertEquals("two", data.get(1).getSecond());

		Assertions.assertEquals("4", data.get(2).getFirst());
		Assertions.assertEquals("four", data.get(2).getSecond());

		Assertions.assertEquals("5", data.get(3).getFirst());
	...
	void testEntrySet() {
		...
		Assertions.assertEquals(key1, entries.get(key1).getKey());
	...
	void testCopyConstructor() {
		...
		Assertions.assertTrue(map.containsValue("four"));
		Assertions.assertFalse(map.containsValue("five"));
