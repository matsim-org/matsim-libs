...
public class TransformationFactoryTest {
  ...
  private static final Logger log = LogManager.getLogger(TransformationFactoryTest.class);
  ...
  public final void testKnownGeotoolsTransformation() {
    CoordinateTransformation transformation =
        TransformationFactory.getCoordinateTransformation(
            TransformationFactory.WGS84_UTM35S, TransformationFactory.WGS84);
    assertNotNull(transformation);
    assertTrue(transformation instanceof GeotoolsTransformation);
  }

  /**
   * Test if a correct, GeoTools' Well-Known-Text (WKT) is correctly recognized, instead of our
   * shortcut names.
   */
  @Test
  public final void testUnknownWKTTransformation() {
    final String wgs84utm35s =
    ...
    CoordinateTransformation transformation1 =
        TransformationFactory.getCoordinateTransformation(wgs84utm35s, TransformationFactory.WGS84);
    assertNotNull(transformation1);
    assertTrue(transformation1 instanceof GeotoolsTransformation);
    CoordinateTransformation transformation2 =
        TransformationFactory.getCoordinateTransformation(wgs84utm35s, wgs84);
  ...
  public final void testUnknownBadTransformation() {
    ...
    final String bad1 =
        "ROJCS[\"WGS_1984_UTM_Zone_35S\",GEOGCS[\"GCS_WGS_1984\",DATUM[\"D_WGS_1984\",SPHEROID[\"WGS_1984\",6378137,298.257223563]],PRIMEM[\"Greenwich\",0],UNIT[\"Degree\",0.017453292519943295]],PROJECTION[\"Transverse_Mercator\"],PARAMETER[\"latitude_of_origin\",0],PARAMETER[\"central_meridian\",27],PARAMETER[\"scale_factor\",0.9996],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",10000000],UNIT[\"Meter\",1]]";
    try {
  ...
  public final void testIdentityTransformation() {
    CoordinateTransformation transformation =
        TransformationFactory.getCoordinateTransformation(
            TransformationFactory.ATLANTIS, TransformationFactory.ATLANTIS);
  ...
  public final void testFromCH1903LV03Plus() {
    CoordinateTransformation transformation =
        TransformationFactory.getCoordinateTransformation(
            TransformationFactory.CH1903_LV03_Plus, TransformationFactory.WGS84);
  ...
  public final void testFromAtlantis() {
    CoordinateTransformation transformation =
        TransformationFactory.getCoordinateTransformation(
            TransformationFactory.ATLANTIS, TransformationFactory.WGS84);
