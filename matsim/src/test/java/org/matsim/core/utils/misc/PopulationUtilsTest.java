...
public class PopulationUtilsTest {
  ...
  public void testLegOverlap() {
    ...
    //		Assert.assertEquals( 2., PopulationUtils.calculateSimilarity( legs1, legs2, null, 1., 1. ) ,
    // 0.001 ) ;
    ...
    //		Assert.assertEquals( 1., PopulationUtils.calculateSimilarity( legs1, legs3, null, 1., 1. ) ,
    // 0.001 ) ;
  ...
  public void testActivityOverlap() {
    Fixture f = new Fixture();
    List<Activity> acts1 =
        PopulationUtils.getActivities(f.plan1, StageActivityHandling.StagesAsNormalActivities);
    List<Activity> acts2 =
        PopulationUtils.getActivities(f.plan2, StageActivityHandling.StagesAsNormalActivities);
    List<Activity> acts3 =
        PopulationUtils.getActivities(f.plan3, StageActivityHandling.StagesAsNormalActivities);
