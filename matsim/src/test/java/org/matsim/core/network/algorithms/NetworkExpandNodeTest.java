...
public class NetworkExpandNodeTest {
  ...
  public void testExpandNode() {
    ...
    Assert.assertNotNull(
        findLinkBetween(n, Id.create("1", Link.class), Id.create("6", Link.class)));
    Assert.assertNotNull(
        findLinkBetween(n, Id.create("3", Link.class), Id.create("6", Link.class)));
    Assert.assertNotNull(
        findLinkBetween(n, Id.create("5", Link.class), Id.create("2", Link.class)));
    Assert.assertNotNull(
        findLinkBetween(n, Id.create("5", Link.class), Id.create("4", Link.class)));
    ...
    Assert.assertTrue(
        CoordUtils.calcEuclideanDistance(c, new Coord((double) 1000, (double) 0)) < 30);
  ...
  public void testExpandNode_sameCoordinateLinks() {
    ...
    //		f.scenario.getNetwork().getNodes().get(Id.create("1",
    // Node.class)).getCoord().setXY(c.getX(), c.getY()); // move it on top of node 3
    f.scenario
        .getNetwork()
        .getNodes()
        .get(Id.create("1", Node.class))
        .setCoord(c); // move it on top of node 3
  ...
  public void testTurnsAreSameAsSingleNode_IgnoreUTurns() {
    ...
    turns.add(new TurnInfo(Id.create("3", Link.class), Id.create("2", Link.class), walkCar));
    turns.add(
        new TurnInfo(Id.create("3", Link.class), Id.create("4", Link.class), walkCar)); // u-turn
    turns.add(new TurnInfo(Id.create("3", Link.class), Id.create("6", Link.class), walkCar));
    turns.add(new TurnInfo(Id.create("5", Link.class), Id.create("2", Link.class)));
    turns.add(new TurnInfo(Id.create("5", Link.class), Id.create("4", Link.class)));
    turns.add(
        new TurnInfo(Id.create("5", Link.class), Id.create("6", Link.class), emptySet)); // u-turn
  ...
  private static Link findLinkBetween(
      final Network network, final Id<Link> fromLinkId, final Id<Link> toLinkId) {
  ...
  private static class Fixture {
    ...
    public void createNetwork_ThreeWayIntersection() {
      ...
      Node node1 =
          nf.createNode(Id.create("1", Node.class), new Coord((double) 1000, (double) 1000));
    ...
    private Link createLink(
        final NetworkFactory nf, final String id, final Node fromNode, final Node toNode) {
