...
public class NetworkReaderMatsimV1Test {
  ...
  /**
   * Helper method to set up a fixture that is used more than once. It creates a single link by
   * specifying the XML-Attributes and using {@link NetworkReaderMatsimV1} to "read" the attributes
