...
public class NetworkCollectorTest {
  ...
  public void testWithSequentialStream() {
    ...
    var collectedNetwork =
        network.getLinks().values().stream().collect(NetworkUtils.getCollector());
  ...
  public void testWithParallelStream() {
    ...
    var collectedNetwork =
        network.getLinks().values().parallelStream().collect(NetworkUtils.getCollector());
