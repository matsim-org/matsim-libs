...
public class NetworkV2IOTest {
  ...
  public void testNo3DCoord() {
    ...
    Assert.assertFalse("did not expect Z", zhCoord.hasZ());
  }
  ...
  public void test3DCoord() {
    ...
    Assert.assertTrue("did expect Z", zhCoord.hasZ());

    Assert.assertEquals("unexpected Z value", 400, zhCoord.getZ(), MatsimTestUtils.EPSILON);
  }
  ...
  private Scenario createTestNetwork(boolean threeD) {
    ...
    final Node zurichNode =
        factory.createNode(
            Id.createNodeId("Zurich"), threeD ? new Coord(0, 0, 400) : new Coord(0, 0));
    final Node teltowNode =
        factory.createNode(
            Id.createNodeId("Teltow"), threeD ? new Coord(1, 1, 1) : new Coord(1, 1));
    ...
    final Link link = factory.createLink(Id.createLinkId("trip"), zurichNode, teltowNode);
