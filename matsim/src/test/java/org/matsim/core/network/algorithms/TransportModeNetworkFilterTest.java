...
public class TransportModeNetworkFilterTest {
	...
	public void testFilter_SingleMode() {
		...
		Assert.assertTrue(subNetwork.getLinks().containsKey(f.linkIds[16]));
		Assert.assertTrue(subNetwork.getNodes().containsKey(f.linkIds[1]));
		Assert.assertTrue(subNetwork.getNodes().containsKey(f.linkIds[4]));
		Assert.assertTrue(subNetwork.getNodes().containsKey(f.linkIds[7]));
		Assert.assertTrue(subNetwork.getNodes().containsKey(f.linkIds[10]));
		Assert.assertTrue(subNetwork.getNodes().containsKey(f.linkIds[13]));
