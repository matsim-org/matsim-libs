...
public class TransportModeNetworkFilterTest {
  ...
  /**
   * Tests the algorithm for the case the network contains direct loops, i.e. links with the same
   * from and to node. <code>Issue #178</code> - http://sourceforge.net/apps/trac/matsim/ticket/178
   *
   * <p>The problem seems only to happen when the loop link is (accidentally / randomly) chosen as
   * start link for the algorithm, as otherwise the node already exists. Thus cannot extend existing
   * Fixture to test this, but have to create test scenario from scratch.
   */
  @Test
  ...
  public void testFilter_timeVariant() {
    ...
    new TransportModeNetworkFilter(sourceNetwork)
        .filter(targetNetwork, Collections.singleton("car"));
  ...
  private static class Fixture {
    ...
    /*package*/ final Set<String> modesCBW =
        createHashSet(TransportMode.car, TransportMode.bike, TransportMode.walk);
    ...
    /*package*/ Fixture() {
      ...
      network.addLink(
          createLink(network, this.linkIds[1], this.nodeIds[1], this.nodeIds[2], this.modesC));
      network.addLink(
          createLink(network, this.linkIds[2], this.nodeIds[2], this.nodeIds[3], this.modesC));
      network.addLink(
          createLink(network, this.linkIds[3], this.nodeIds[3], this.nodeIds[4], this.modesC));
      network.addLink(
          createLink(network, this.linkIds[4], this.nodeIds[4], this.nodeIds[5], this.modesCB));
      network.addLink(
          createLink(network, this.linkIds[5], this.nodeIds[5], this.nodeIds[6], this.modesCB));
      network.addLink(
          createLink(network, this.linkIds[6], this.nodeIds[6], this.nodeIds[7], this.modesCB));
      network.addLink(
          createLink(network, this.linkIds[7], this.nodeIds[7], this.nodeIds[8], this.modesCB));
      network.addLink(
          createLink(network, this.linkIds[8], this.nodeIds[8], this.nodeIds[9], this.modesCB));
      network.addLink(
          createLink(network, this.linkIds[9], this.nodeIds[9], this.nodeIds[10], this.modesCB));
      network.addLink(
          createLink(network, this.linkIds[10], this.nodeIds[10], this.nodeIds[11], this.modesC));
      network.addLink(
          createLink(network, this.linkIds[11], this.nodeIds[11], this.nodeIds[12], this.modesC));
      network.addLink(
          createLink(network, this.linkIds[12], this.nodeIds[12], this.nodeIds[13], this.modesC));
      network.addLink(
          createLink(network, this.linkIds[13], this.nodeIds[1], this.nodeIds[4], this.modesWB));
      network.addLink(
          createLink(network, this.linkIds[14], this.nodeIds[4], this.nodeIds[7], this.modesCW));
      network.addLink(
          createLink(network, this.linkIds[15], this.nodeIds[7], this.nodeIds[10], this.modesW));
      network.addLink(
          createLink(network, this.linkIds[16], this.nodeIds[10], this.nodeIds[13], this.modesCBW));
    }
  }
  ...
  private static Link createLink(
      ...
      final Id<Link> id,
      final Id<Node> fromNodeId,
      final Id<Node> toNodeId,
      final Set<String> modes) {
    Link link =
        network
            .getFactory()
            .createLink(id, network.getNodes().get(fromNodeId), network.getNodes().get(toNodeId));
