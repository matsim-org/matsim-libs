...
/**
 * A very simple test for the NetworkCleaner, it doesn't test by far all possible cases. I used it
 * to debug the NetworkCleaner and thought that instead of deleting it, I'll make a test case out of
 * it, maybe someone else feels like extending it some time.
 *
 * @author mrieser
 */
public class NetworkCleanerTest {
  ...
  public void testSink() {
    ...
    Node node3 =
        NetworkUtils.createAndAddNode(
            network, Id.create("3", Node.class), new Coord((double) 100, (double) 100));
    Node node4 =
        NetworkUtils.createAndAddNode(
            network, Id.create("4", Node.class), new Coord((double) 0, (double) 100));
    Node node5 =
        NetworkUtils.createAndAddNode(
            network, Id.create("5", Node.class), new Coord((double) 200, (double) 200));
