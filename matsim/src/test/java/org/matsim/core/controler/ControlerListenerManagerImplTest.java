...
public class ControlerListenerManagerImplTest {
  ...
  private static class CountingControlerListener
  ...
  private static class ExtendedControlerListener extends CountingControlerListener
      implements ShutdownListener, StartupListener {
    // StartupListener is explicitly implemented, even if not necessary, to test that it will not be
    // called twice
