...
/**
 * Mostly tests adaptation of old plans to routing mode and the related replacement of helper modes
 * for access and egress to pt/drt and the related replacement of fallback modes for pt/drt (if no
 * route could be found).
 *
 * <p>Does not test the combination of already a routing mode and outdated helper / fallback modes,
 * because those never existed in the code at the same time.
 *
 * <p>TODO: add tests for other methods of {@link PrepareForSimImpl}.
 *
 * @author vsp-gleich
 */
public class PrepareForSimImplTest {
  ...
  public void testSingleLegTripRoutingMode() {
    ...
    // test routing mode not set, such as after TripsToLegsAlgorithm + replanning strategy
    {
      ...
      final PrepareForSimImpl prepareForSimImpl =
          new PrepareForSimImpl(
              config.global(),
              scenario,
              scenario.getNetwork(),
              pop,
              scenario.getActivityFacilities(),
              new DummyTripRouterProvider(),
              config.qsim(),
              config.facilities(),
              config.plans(),
      ...
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.pt, TripStructureUtils.getRoutingMode(leg));
    }
  ...
  public void testSingleFallbackModeLegTrip() {
    ...
    // test outdated fallback mode single leg trip (arbitrary drt mode)
    {
      ...
      Assert.assertEquals("wrong leg mode replacement", TransportMode.walk, leg.getMode());
      Assert.assertEquals("wrong routing mode!", "drt67", TripStructureUtils.getRoutingMode(leg));
    }
  }
  ...
  public void testCorrectTripsRemainUnchanged() {
    ...
    // test car trip with access/egress walk legs
    {
      ...
      Activity activity2 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) 0, -10), null, TransportMode.car);
      plan.addActivity(activity2);
      ...
      Activity activity3 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -10, -10), null, TransportMode.car);
      ...
      // Check routing mode:
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.car, TripStructureUtils.getRoutingMode(leg1));
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.car, TripStructureUtils.getRoutingMode(leg2));
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.car, TripStructureUtils.getRoutingMode(leg3));
    }
    ...
    // test complicated intermodal trip with consistent routing modes passes unchanged
    {
      ...
      Activity activity2 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) 0, -10), null, TransportMode.walk);
      plan.addActivity(activity2);
      ...
      Activity activity4 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) 0, -10), null, TransportMode.drt);
      plan.addActivity(activity4);
      ...
      Activity activity5 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -10, -10), null, TransportMode.drt);
      ...
      Activity activity6 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -10, -10), null, TransportMode.walk);
      ...
      Activity activity7 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -20, -10), null, TransportMode.walk);
      ...
      Activity activity8 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -20, -10), null, TransportMode.pt);
      ...
      Activity activity9 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -1800, -10), null, TransportMode.pt);
      ...
      Activity activity10 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -1800, -10), null, TransportMode.walk);
      ...
      Activity activity11 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -1900, -10), null, TransportMode.walk);
      ...
      // TODO: Currently all TransportMode.non_network_walk legs are replaced by TransportMode.walk,
      // so we cannot check
      // the correct handling of them right now.
      //			Assert.assertEquals("wrong routing mode!", TransportMode.non_network_walk,
      // leg1.getMode());
      ...
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg1));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg2));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg3));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg4));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg5));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg6));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg7));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg8));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg9));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg10));
      Assert.assertEquals(
          "wrong routing mode!", "intermodal pt", TripStructureUtils.getRoutingMode(leg11));
    }
  }
  ...
  public void testRoutingModeConsistency() {
    ...
    // test trip with inconsistent routing modes causes exception
    {
      ...
      Activity activity3 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -20, -10), null, TransportMode.drt);
      plan.addActivity(activity3);
      Leg leg3 = pf.createLeg(TransportMode.walk);
  ...
  public void testOutdatedHelperModesReplacement() {
    ...
    // test car trip with outdated access/egress walk modes
    {
      ...
      // Should give an exception with default:
      // config.plans().setHandlingOfPlansWithoutRoutingMode(HandlingOfPlansWithoutRoutingMode.reject);
      try {
        final PrepareForSimImpl prepareForSimImpl =
            new PrepareForSimImpl(
    ...
    // test complicated intermodal drt+pt trip with outdated access/egress walk modes
    {
       ...
       */
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.drt, TripStructureUtils.getRoutingMode(leg1));
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.drt, TripStructureUtils.getRoutingMode(leg2));
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.drt, TripStructureUtils.getRoutingMode(leg3));
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.drt, TripStructureUtils.getRoutingMode(leg4));
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.drt, TripStructureUtils.getRoutingMode(leg5));
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.drt, TripStructureUtils.getRoutingMode(leg6));
      Assert.assertEquals(
          "wrong routing mode!", TransportMode.drt, TripStructureUtils.getRoutingMode(leg7));
    }
  }
  ...
  public void testOutdatedFallbackAndHelperModesReplacement() {
    ...
    // test complicated intermodal trip with consistent routing modes passes unchanged
    {
      ...
      Activity activity3 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -10, -10), null, TransportMode.pt);
      plan.addActivity(activity3);
      ...
      Activity activity4 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -20, -10), null, "drt67");
      plan.addActivity(activity4);
      ...
      Activity activity5 =
          PopulationUtils.createStageActivityFromCoordLinkIdAndModePrefix(
              new Coord((double) -1800, -10), null, "drt_fallback");
      plan.addActivity(activity5);
  ...
  public void vehicleTypes() {
    ...
    VehicleType truckType =
        scenario
            .getVehicles()
            .getFactory()
            .createVehicleType(Id.create("truck", VehicleType.class));
    ...
    Person p1 = f.createPerson(Id.createPersonId("1"));
    {
      VehicleUtils.insertVehicleTypesIntoAttributes(
          p1, Map.of(TransportMode.car, Id.create("truck", VehicleType.class)));
    ...
    assertThat(scenario.getVehicles().getVehicles().get(id).getType()).isEqualTo(truckType);
  }
