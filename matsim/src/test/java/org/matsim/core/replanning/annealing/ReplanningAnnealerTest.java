...
public class ReplanningAnnealerTest {
  ...
  public void testLinearAnneal() throws IOException {
    ...
    Assert.assertEquals(
        expectedLinearAnneal,
        readResult(controler.getControlerIO().getOutputFilename(FILENAME_ANNEAL)));
  ...
  public void testTwoParameterAnneal() throws IOException {
    ...
    ReplanningAnnealerConfigGroup.AnnealingVariable otherAv =
  ...
  public void testInnovationSwitchoffAnneal() throws IOException {
    ...
    Assert.assertEquals(
        expectedInnovationSwitchoffAnneal,
        readResult(controler.getControlerIO().getOutputFilename(FILENAME_ANNEAL)));
