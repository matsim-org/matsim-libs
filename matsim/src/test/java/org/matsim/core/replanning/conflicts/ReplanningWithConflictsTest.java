...
public class ReplanningWithConflictsTest {
  ...
  public void testModeRestriction() {
    ...
    config
        .replanning()
        .setPlanSelectorForRemoval(WorstPlanForRemovalSelectorWithConflicts.SELECTOR_NAME);
    ...
    for (int i = 0; i < 100; i++) {
      ...
      Activity firstActivity =
          populationFactory.createActivityFromCoord("generic", new Coord(0.0, 0.0));
    ...
    controller.addOverridingModule(
        new AbstractModule() {
          @Override
          public void install() {
            ConflictModule.bindResolver(binder())
                .toInstance(
