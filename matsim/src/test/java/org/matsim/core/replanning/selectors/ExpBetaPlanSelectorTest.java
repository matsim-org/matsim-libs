...
public class ExpBetaPlanSelectorTest extends AbstractPlanSelectorTest {
  ...
  private static final Logger log = LogManager.getLogger(ExpBetaPlanSelectorTest.class);
  ...
  public void testExpBeta2() {
    ...
    ExpBetaPlanSelector<Plan, Person> selector =
        new ExpBetaPlanSelector<Plan, Person>(this.config.scoring());
    int cnt1 = 0;
    int cnt2 = 0;
    int cnt3 = 0;
    int cnt4 = 0;
  ...
  public void testGetSelectionProbability() {
    ...
    assertEquals(
        0.2024421, ExpBetaPlanSelector.getSelectionProbability(testee, person, plan1), EPSILON_R);
    assertEquals(
        0.2472634, ExpBetaPlanSelector.getSelectionProbability(testee, person, plan2), EPSILON_R);
    assertEquals(
        0.5502947, ExpBetaPlanSelector.getSelectionProbability(testee, person, plan3), EPSILON_R);
    assertEquals(
        6.208075e-10,
        ExpBetaPlanSelector.getSelectionProbability(testee, person, plan4),
        EPSILON_R);
  }
}
