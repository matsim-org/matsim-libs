...
public class BinaryMinHeapTest {
  ...
  private MinHeap<HasIndex> createMinHeap(boolean classicalRemove) {
    MinHeap<HasIndex> pq =
        new BinaryMinHeap<HasIndex>(maxElements, BinaryMinHeap.defaultFanout, classicalRemove);
    return pq;
  }

  private MinHeap<HasIndex> createWrappedMinHeap(boolean classicalRemove) {
    MinHeap<HasIndex> pq =
        new WrappedBinaryMinHeap<HasIndex>(
            maxElements, BinaryMinHeap.defaultFanout, classicalRemove);
    return pq;
  }
