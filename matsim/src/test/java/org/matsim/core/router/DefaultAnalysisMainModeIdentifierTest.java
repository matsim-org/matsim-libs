...
public class DefaultAnalysisMainModeIdentifierTest {
  ...
  public void correctModes() {
    ...
    assertThat(
            mmi.identifyMainMode(legs(TransportMode.walk, TransportMode.car, TransportMode.walk)))
    ...
    assertThat(mmi.identifyMainMode(legs("new_mode", TransportMode.walk))).isEqualTo("new_mode");

    assertThat(mmi.identifyMainMode(legs(TransportMode.non_network_walk, "new_mode")))
        .isEqualTo("new_mode");

    assertThat(
            mmi.identifyMainMode(
                legs("new_mode", "new_mode", TransportMode.walk, TransportMode.non_network_walk)))
        .isEqualTo("new_mode");
  }
  ...
  public void failingModes() {
    ...
    assertThatThrownBy(
            () -> mmi.identifyMainMode(legs("new_mode", TransportMode.walk, "other_new_mode")))
