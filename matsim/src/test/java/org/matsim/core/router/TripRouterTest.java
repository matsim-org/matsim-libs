...
public class TripRouterTest {
  ...
  public void testTripInsertion() {
    ...
    assertEquals(
        "insertion did not produce the expected plan length!", 13, plan.getPlanElements().size());
    ...
    for (PlanElement pe : plan.getPlanElements()) {
      ...
      assertTrue("wrong inserted sequence: " + plan.getPlanElements(), newIndex > oldIndex);
      oldIndex = newIndex;
    }
  }
