...
public class FastMultiNodeTest {
	...
	public void testFastMultiNodeDijkstra_OneToOne() {
		...
		Node fromNode = scenario.getNetwork().getNodes().get(scenario.createId("n0"));
		Node toNode = scenario.getNetwork().getNodes().get(scenario.createId("n3"));
	...
	public void testFastMultiNodeDijkstra_OneToMany() {
		...
		Node fromNode = scenario.getNetwork().getNodes().get(scenario.createId("n0"));
		Node toNode1 = scenario.getNetwork().getNodes().get(scenario.createId("n3"));
		...
		Assert.assertEquals(scenario.createId("n1"), path.nodes.get(1).getId());
		Assert.assertEquals(scenario.createId("n2"), path.nodes.get(2).getId());
		Assert.assertEquals(scenario.createId("n4"), path.nodes.get(3).getId());
		
		Assert.assertEquals(3, path.links.size());
		Assert.assertEquals(scenario.createId("l0"), path.links.get(0).getId());
		Assert.assertEquals(scenario.createId("l1"), path.links.get(1).getId());
		Assert.assertEquals(scenario.createId("l3"), path.links.get(2).getId());
	...
	public void testFastMultiNodeDijkstra_OneToMany_SearchAllNodes() {
		...
		Assert.assertEquals(scenario.createId("n2"), path.nodes.get(2).getId());
		Assert.assertEquals(scenario.createId("n4"), path.nodes.get(3).getId());
		Assert.assertEquals(scenario.createId("n5"), path.nodes.get(4).getId());
		
		Assert.assertEquals(4, path.links.size());
		Assert.assertEquals(scenario.createId("l0"), path.links.get(0).getId());
		Assert.assertEquals(scenario.createId("l1"), path.links.get(1).getId());
		Assert.assertEquals(scenario.createId("l3"), path.links.get(2).getId());
		Assert.assertEquals(scenario.createId("l4"), path.links.get(3).getId());
	}
	...
	private void createNetwork(Scenario scenario) {
		...
		Node n4 = scenario.getNetwork().getFactory().createNode(scenario.createId("n4"), scenario.createCoord(2000.0, -2000.0));
		Node n5 = scenario.getNetwork().getFactory().createNode(scenario.createId("n5"), scenario.createCoord(2000.0, -4000.0));
		...
		Link l3 = scenario.getNetwork().getFactory().createLink(scenario.createId("l3"), n2, n4);
		Link l4 = scenario.getNetwork().getFactory().createLink(scenario.createId("l4"), n4, n5);
