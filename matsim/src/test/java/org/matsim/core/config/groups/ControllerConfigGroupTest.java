...
public class ControllerConfigGroupTest {
  ...
  /**
   * Ensure that the events-file-format is correctly stored and returned with the different setters
   * and getters.
   *
   * @author mrieser
   */
  ...
  /**
   * Ensure that the mobsim-selector is correctly stored and returned with the different setters and
   * getters.
   *
   * @author mrieser
   */
  ...
  /**
   * Ensure that the write-plans-interval value is correctly stored and returned with the different
   * setters and getters.
   *
   * @author mrieser
   */
  ...
  /**
   * Ensure that the enableLinkToLinkRouting value is correctly stored and returned with the getters
   * and setters.
   */
  @Test
  ...
  /**
   * Ensure that the writeSnapshotsInterval value is correctly stored and returned with the getters
   * and setters.
   */
  @Test
