...
public class DownloadAndReadXmlTest {
  ...
  public final void testHttpFromSvn() {
    ...
    config
        .network()
        .setInputFile(
            "http://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/atlantis/minibus/input/network.xml");
  ...
  public final void testHttpsFromSvn() {
    ...
    config
        .network()
        .setInputFile(
            "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/atlantis/minibus/input/network.xml");
