...
public class PlansCalcAreaTollRouteTest extends MatsimTestCase {
	...
	public void testBestAlternatives() {
		...
		Fixture.compareRoutes("1 2 3 4 5", (NetworkRouteWRefs) leg1.getRoute());
		Fixture.compareRoutes("6 7 9 10", (NetworkRouteWRefs) leg2.getRoute());
		...
		new PlansCalcAreaTollRoute(config.plansCalcRoute(), network, timeCostCalc, timeCostCalc, factory, toll).run(population);
		Fixture.compareRoutes("1 2 4 5", (NetworkRouteWRefs) leg1.getRoute());
		Fixture.compareRoutes("6 7 9 10", (NetworkRouteWRefs) leg2.getRoute());
	...
	public void testTolledActLink() {
		...
		new PlansCalcAreaTollRoute(config.plansCalcRoute(), network, timeCostCalc, timeCostCalc, factory, toll).run(population);
		Fixture.compareRoutes("1 2 4 5", (NetworkRouteWRefs) leg1.getRoute()); // agent should take shortest route
		Fixture.compareRoutes("6 7 9 10", (NetworkRouteWRefs) leg2.getRoute());
	}
	...
	public void testOutsideTollTime() {
		...
		new PlansCalcAreaTollRoute(config.plansCalcRoute(), network, timeCostCalc, timeCostCalc, factory, toll).run(population);
		Fixture.compareRoutes("1 2 4 5", (NetworkRouteWRefs) leg1.getRoute()); // agent should take shortest route, as tolls are not active at that time
		Fixture.compareRoutes("6 7 9 10", (NetworkRouteWRefs) leg2.getRoute());
	}
