 ...
 * @author mrieser
 */
public class PlansCalcRouteWithTollOrNotTest extends MatsimTestCase {
	...
	public void testBestAlternatives() {
		...
		new PlansCalcRouteWithTollOrNot(config, config.plansCalcRoute(), network, timeCostCalc, timeCostCalc, factory, routeFactory, toll).run(population);
