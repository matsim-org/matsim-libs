...
public class AttributesTest {
  ...
  public void testInsertion() {
    ...
    Assert.assertEquals("unexpected number of elements in " + attributes, 4, attributes.size());
  ...
  public void testReplacement() {
    ...
    Assert.assertEquals("unexpected replaced value ", 7, wrong);
  ...
  public void testRemoval() {
    ...
    Assert.assertEquals("unexpected number of elements in " + attributes, 3, attributes.size());

    Assert.assertEquals("unexpected removed value ", false, wrong);
