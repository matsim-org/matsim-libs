...
public class ObjectAttributesXmlReaderTest {
  ...
  @Test
  public void testParse_customConverter()
    ...
    String str =
        "<?xml version='1.0' encoding='UTF-8'?>\n"
            + "<objectAttributes>\n"
            + " <object id=\"one\">\n"
            + "  <attribute name=\"a\" class=\""
            + tupleClass
            + "\">1,2</attribute>\n"
            + " </object>\n"
            + " <object id=\"two\">\n"
            + "  <attribute name=\"b\" class=\""
            + tupleClass
            + "\">3,4</attribute>\n"
            + " </object>\n"
            + "</objectAttributes>";
  ...
  @Test
  public void testParse_missingConverter()
      throws SAXException, ParserConfigurationException, IOException {
    String tupleClass = MyTuple.class.getCanonicalName();
    String str =
        "<?xml version='1.0' encoding='UTF-8'?>\n"
  ...
  @Test
  public void testParse_withoutDtd()
      throws SAXException, ParserConfigurationException, IOException {
