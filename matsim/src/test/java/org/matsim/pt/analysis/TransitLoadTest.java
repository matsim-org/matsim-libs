  ...
  public void testTransitLoad_singleLine() {
    ...
    TransitStopFacility stop1 =
        factory.createTransitStopFacility(
            Id.create(0, TransitStopFacility.class), new Coord((double) 0, (double) 0), false);
    ...
    Collections.addAll(
        stops,
        factory.createTransitRouteStop(stop1, 0, 0),
        ...
        // add first stop again to check whether serving the same stop multiple times is counted
        // right
        ,
        factory.createTransitRouteStop(stop1, 420, 420));
    TransitLine line1 = factory.createTransitLine(Id.create(1, TransitLine.class));
    TransitRoute route1 =
        factory.createTransitRoute(Id.create(1, TransitRoute.class), null, stops, "bus");
    ...
    tl.handleEvent(
        new TransitDriverStartsEvent(
            7.0 * 3600 - 20,
            Id.create("ptDriver1", Person.class),
            vehicleIdDep1,
            line1.getId(),
            route1.getId(),
            dep1.getId()));
    tl.handleEvent(
        new PersonEntersVehicleEvent(
            7.0 * 3600 - 20, Id.create("ptDriver1", Person.class), vehicleIdDep1));

    tl.handleEvent(
        new VehicleArrivesAtFacilityEvent(7.0 * 3600 - 10, vehicleIdDep1, stop1.getId(), 0));
    tl.handleEvent(
        new PersonEntersVehicleEvent(7.0 * 3600 - 5, Id.create(0, Person.class), vehicleIdDep1));
    tl.handleEvent(
        new VehicleDepartsAtFacilityEvent(7.0 * 3600 + 10, vehicleIdDep1, stop1.getId(), 0));

    tl.handleEvent(
        new VehicleArrivesAtFacilityEvent(7.1 * 3600 - 25, vehicleIdDep1, stop2.getId(), 0));
    tl.handleEvent(
        new PersonLeavesVehicleEvent(7.1 * 3600 - 5, Id.create(0, Person.class), vehicleIdDep1));
    tl.handleEvent(
        new PersonEntersVehicleEvent(7.1 * 3600, Id.create(1, Person.class), vehicleIdDep1));
    tl.handleEvent(
        new PersonEntersVehicleEvent(7.1 * 3600 + 5, Id.create(2, Person.class), vehicleIdDep1));
    tl.handleEvent(
        new VehicleDepartsAtFacilityEvent(7.1 * 3600 + 25, vehicleIdDep1, stop2.getId(), 0));

    tl.handleEvent(
        new VehicleArrivesAtFacilityEvent(7.2 * 3600 - 15, vehicleIdDep1, stop3.getId(), 0));
    tl.handleEvent(
        new PersonLeavesVehicleEvent(7.2 * 3600 - 5, Id.create(2, Person.class), vehicleIdDep1));
    tl.handleEvent(
        new PersonEntersVehicleEvent(7.2 * 3600, Id.create(3, Person.class), vehicleIdDep1));
    tl.handleEvent(
        new VehicleDepartsAtFacilityEvent(7.2 * 3600 + 20, vehicleIdDep1, stop3.getId(), 0));

    tl.handleEvent(
        new PersonEntersVehicleEvent(
            7.25 * 3600, Id.create("carDriver1", Person.class), Id.create("car1", Vehicle.class)));

    tl.handleEvent(
        new VehicleArrivesAtFacilityEvent(7.3 * 3600 - 20, vehicleIdDep1, stop4.getId(), 0));
    tl.handleEvent(
        new VehicleDepartsAtFacilityEvent(7.3 * 3600 + 5, vehicleIdDep1, stop4.getId(), 0));

    tl.handleEvent(
        new PersonLeavesVehicleEvent(
            7.35 * 3600 - 5,
            Id.create("carDriver1", Person.class),
            Id.create("car1", Vehicle.class)));

    tl.handleEvent(
        new VehicleArrivesAtFacilityEvent(7.4 * 3600 - 20, vehicleIdDep1, stop1.getId(), 0));
    tl.handleEvent(
        new PersonLeavesVehicleEvent(7.4 * 3600 - 5, Id.create(1, Person.class), vehicleIdDep1));
    tl.handleEvent(
        new PersonLeavesVehicleEvent(7.4 * 3600, Id.create(3, Person.class), vehicleIdDep1));
    tl.handleEvent(
        new VehicleDepartsAtFacilityEvent(7.4 * 3600 + 5, vehicleIdDep1, stop1.getId(), 0));
    ...
    TransitLoad.StopInformation si =
        tl.getDepartureStopInformation(line1, route1, stop1, dep1).get(0);
    ...
    List<TransitLoad.StopInformation> siList =
        tl.getDepartureStopInformation(line1, route1, stop1, dep2);
