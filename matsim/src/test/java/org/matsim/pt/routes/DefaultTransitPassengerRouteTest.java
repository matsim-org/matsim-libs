...
public class DefaultTransitPassengerRouteTest {
  ...
  public void testReadWrite() {
    ...
    DefaultTransitPassengerRoute routeA =
        new DefaultTransitPassengerRoute(null, null, accessId, egressId, lineId, routeId);
    String description = routeA.getRouteDescription();
  ...
  public void testInitializationLinks() {
    ...
    DefaultTransitPassengerRoute route =
        new DefaultTransitPassengerRoute(link1.getId(), link2.getId());
  ...
  public void testInitializationStops() {
    ...
    TransitStopFacility stop1 =
        builder.createTransitStopFacility(
            Id.create(1, TransitStopFacility.class), new Coord(5, 11), false);
    TransitStopFacility stop2 =
        builder.createTransitStopFacility(
            Id.create(2, TransitStopFacility.class), new Coord(18, 7), false);
    ...
    TransitRoute tRoute =
        builder.createTransitRoute(
            Id.create(6, TransitRoute.class),
            null,
            Collections.<TransitRouteStop>emptyList(),
            "bus");
    DefaultTransitPassengerRoute route =
        new DefaultTransitPassengerRoute(stop1, line, tRoute, stop2);
  ...
  public void testSetRouteDescription_PtRoute() {
    ...
    assertEquals(
        "{\"transitRouteId\":\"1980\",\"boardingTime\":\"undefined\",\"transitLineId\":\"11\",\"accessFacilityId\":\"5\",\"egressFacilityId\":\"1055\"}",
