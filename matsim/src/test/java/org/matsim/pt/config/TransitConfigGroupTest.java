...
public class TransitConfigGroupTest {
  ...
  /**
   * Test {@link TransitConfigGroup#setTransitScheduleFile(String)}, {@link
   * TransitConfigGroup#getTransitScheduleFile()}, {@link TransitConfigGroup#addParam(String,
   * String)}, {@link TransitConfigGroup#getValue(String)} and {@link
   * TransitConfigGroup#getParams()} for setting and getting the transit schedule input file.
   */
  @Test
