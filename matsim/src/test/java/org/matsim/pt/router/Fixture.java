...
/*package*/ class Fixture {
	...
	protected void buildStops() {
		...
		this.stopFacilities[ 1] = this.builder.createTransitStopFacility(Id.create( "1", org.matsim.facilities.Facility.class), new Coord((double) 4000, (double) 4998), true);
		this.stopFacilities[ 2] = this.builder.createTransitStopFacility(Id.create( "2", org.matsim.facilities.Facility.class), new Coord((double) 8000, (double) 5002), true);
		this.stopFacilities[ 3] = this.builder.createTransitStopFacility(Id.create( "3", org.matsim.facilities.Facility.class), new Coord((double) 8000, (double) 4998), true);
		this.stopFacilities[ 4] = this.builder.createTransitStopFacility(Id.create( "4", org.matsim.facilities.Facility.class), new Coord((double) 12000, (double) 5002), true);
		this.stopFacilities[ 5] = this.builder.createTransitStopFacility(Id.create( "5", org.matsim.facilities.Facility.class), new Coord((double) 12000, (double) 4998), true);
		this.stopFacilities[ 6] = this.builder.createTransitStopFacility(Id.create( "6", org.matsim.facilities.Facility.class), new Coord((double) 16000, (double) 5002), true);
		this.stopFacilities[ 7] = this.builder.createTransitStopFacility(Id.create( "7", org.matsim.facilities.Facility.class), new Coord((double) 16000, (double) 4998), true);
		this.stopFacilities[ 8] = this.builder.createTransitStopFacility(Id.create( "8", org.matsim.facilities.Facility.class), new Coord((double) 20000, (double) 5002), true);
		this.stopFacilities[ 9] = this.builder.createTransitStopFacility(Id.create( "9", org.matsim.facilities.Facility.class), new Coord((double) 20000, (double) 4998), true);
		this.stopFacilities[10] = this.builder.createTransitStopFacility(Id.create("10", org.matsim.facilities.Facility.class), new Coord((double) 24000, (double) 5002), true);
		this.stopFacilities[11] = this.builder.createTransitStopFacility(Id.create("11", org.matsim.facilities.Facility.class), new Coord((double) 24000, (double) 4998), true);
		this.stopFacilities[12] = this.builder.createTransitStopFacility(Id.create("12", org.matsim.facilities.Facility.class), new Coord((double) 28000, (double) 5002), true);
		this.stopFacilities[13] = this.builder.createTransitStopFacility(Id.create("13", org.matsim.facilities.Facility.class), new Coord((double) 28000, (double) 4998), true);
		this.stopFacilities[14] = this.builder.createTransitStopFacility(Id.create("14", org.matsim.facilities.Facility.class), new Coord((double) 32000, (double) 5002), true);
		this.stopFacilities[15] = this.builder.createTransitStopFacility(Id.create("15", org.matsim.facilities.Facility.class), new Coord((double) 32000, (double) 4998), true);
		this.stopFacilities[16] = this.builder.createTransitStopFacility(Id.create("16", org.matsim.facilities.Facility.class), new Coord((double) 36000, (double) 5002), true);
		this.stopFacilities[17] = this.builder.createTransitStopFacility(Id.create("17", org.matsim.facilities.Facility.class), new Coord((double) 36000, (double) 4998), true);
		this.stopFacilities[18] = this.builder.createTransitStopFacility(Id.create("18", org.matsim.facilities.Facility.class), new Coord((double) 12000, (double) 5000), true);
		this.stopFacilities[19] = this.builder.createTransitStopFacility(Id.create("19", org.matsim.facilities.Facility.class), new Coord((double) 16000, (double) 10000), true);
		this.stopFacilities[20] = this.builder.createTransitStopFacility(Id.create("20", org.matsim.facilities.Facility.class), new Coord((double) 24000, (double) 10000), true);
		this.stopFacilities[21] = this.builder.createTransitStopFacility(Id.create("21", org.matsim.facilities.Facility.class), new Coord((double) 28000, (double) 5000), true);
		this.stopFacilities[22] = this.builder.createTransitStopFacility(Id.create("22", org.matsim.facilities.Facility.class), new Coord((double) 24000, (double) 0), true);
		this.stopFacilities[23] = this.builder.createTransitStopFacility(Id.create("23", org.matsim.facilities.Facility.class), new Coord((double) 16000, (double) 0), true);
