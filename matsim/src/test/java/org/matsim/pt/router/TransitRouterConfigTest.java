...
public class TransitRouterConfigTest {
  ...
  public void testConstructor() {
    ...
    // naturally, this failed after the functionality was moved to a separate planCalcScore
    // parameter.  kai, oct'12
    ...
    // test without marginal utl of time:
    {
      TransitRouterConfig config =
          new TransitRouterConfig(planScoring, planRouting, transitRouting, vspConfig);
