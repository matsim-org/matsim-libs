...
public class AdaptedTransitRouterNetworkTravelTimeCostTest extends TestCase {
	...
	public void testVehArrivalTime() {
		...
		assertEquals(9.0*60 , tc.getLinkTravelTime(testLink, 6.0*3600, null, null) , MatsimTestUtils.EPSILON);
		assertEquals(9.0*60+1 , tc.getLinkTravelTime(testLink, 6.0*3600-1, null, null) , MatsimTestUtils.EPSILON);
		...
		*/
		...
		assertEquals((5.0*3600) + (58*60) , tc.getVehArrivalTime(testLink, (5.0*3600) + (56*60)), MatsimTestUtils.EPSILON);
		assertEquals((5.0*3600) + (58*60) , tc.getVehArrivalTime(testLink, (5.0*3600) + (57*60)), MatsimTestUtils.EPSILON);

		//this arrival would be for waiting inside the vehicle
		assertEquals((5.0*3600) + (58*60) , tc.getVehArrivalTime(testLink, (5.0*3600) + (58*60)), MatsimTestUtils.EPSILON);
		assertEquals((5.0*3600) + (58*60) , tc.getVehArrivalTime(testLink, (5.0*3600) + (59*60)), MatsimTestUtils.EPSILON);
		assertEquals((5.0*3600) + (58*60) , tc.getVehArrivalTime(testLink, (6.0*3600) + (1*60)), MatsimTestUtils.EPSILON);
		assertEquals((5.0*3600) + (58*60) , tc.getVehArrivalTime(testLink, (6.0*3600) + (2*60)), MatsimTestUtils.EPSILON);
	...
	public void testTravelTimeAfterMidnight() {
		...
		assertEquals((29.0*3600) + (18*60.0) , tc.getVehArrivalTime(testLink, 25.0*3600), MatsimTestUtils.EPSILON);
		...
		assertEquals((53.0*3600) + (18*60.0), tc.getVehArrivalTime(testLink, 47.0*3600), MatsimTestUtils.EPSILON);
