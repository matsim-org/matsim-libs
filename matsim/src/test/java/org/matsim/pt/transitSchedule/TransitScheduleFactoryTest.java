...
public class TransitScheduleFactoryTest {
  ...
  public void testCreateTransitRoute() {
    ...
    NetworkRoute route =
        RouteUtils.createLinkNetworkRouteImpl(Id.create(3, Link.class), Id.create(4, Link.class));
  ...
  public void testCreateTransitRouteStop() {
    ...
    TransitStopFacility stopFacility =
        new TransitStopFacilityImpl(
            Id.create(5, TransitStopFacility.class), new Coord((double) 6, (double) 6), false);
    ...
    Assert.assertEquals(
        departureOffset, stop.getDepartureOffset().seconds(), MatsimTestUtils.EPSILON);
  }
