...
/**
 * Detailed tests for {@link TransitScheduleReaderV1}, also testing special cases and possible
 * Exceptions.
 *
 * @author mrieser
 */
public class TransitScheduleReaderV1Test {
  ...
  public void testStopFacility_Minimalistic() {
    ...
    TransitStopFacility stop =
        schedule.getFacilities().get(Id.create("stop1", TransitStopFacility.class));
    assertNotNull(stop);
  ...
  public void testStopFacility_withLink() {
    ...
    Node node1 =
        NetworkUtils.createAndAddNode(
            network, Id.create(1, Node.class), new Coord((double) 10, (double) 5));
    Node node2 =
        NetworkUtils.createAndAddNode(
            network, Id.create(2, Node.class), new Coord((double) 5, (double) 11));
    final Node fromNode = node1;
    final Node toNode = node2;
    Link link3 =
        NetworkUtils.createAndAddLink(
            network, Id.create(3, Link.class), fromNode, toNode, (double) 1000, 10.0, 2000.0, 1.0);
  ...
  public void testStopFacility_withName() {
    ...
    Attributes atts =
        new AttributesBuilder()
            ...
            .add(Constants.X, "79")
            .add(Constants.Y, "80")
            .add(Constants.NAME, "some stop name")
            .get();
    reader.startTag(Constants.STOP_FACILITY, atts, context);
    reader.endTag(Constants.STOP_FACILITY, EMPTY_STRING, context);
    reader.endTag(context.pop(), EMPTY_STRING, context); // TRANSIT_STOPS
  ...
  public void testStopFacility_isBlocking() {
    ...
    Attributes atts =
        new AttributesBuilder()
            ...
            .add(Constants.X, "79")
            .add(Constants.Y, "80")
            .add(Constants.IS_BLOCKING, "true")
            .get();
    reader.startTag(Constants.STOP_FACILITY, atts, context);
    reader.endTag(Constants.STOP_FACILITY, EMPTY_STRING, context);
    reader.endTag(context.pop(), EMPTY_STRING, context); // TRANSIT_STOPS
  ...
  public void testStopFacility_Multiple() {
    ...
    TransitStopFacility stop2 =
        schedule.getFacilities().get(Id.create("stop2", TransitStopFacility.class));
    assertNotNull(stop2);
  ...
  public void testTransitLine_Single() {
    ...
    reader.startTag(
        Constants.TRANSIT_LINE,
        new AttributesBuilder().add(Constants.ID, lineId.toString()).get(),
        context);
  ...
  public void testTransitLine_Multiple() {
    ...
    reader.startTag(
        Constants.TRANSIT_LINE,
        new AttributesBuilder().add(Constants.ID, lineId1.toString()).get(),
        context);
    reader.endTag(Constants.TRANSIT_LINE, EMPTY_STRING, context); // TRANSIT_LINE
    Id<TransitLine> lineId2 = Id.create("42", TransitLine.class);
    reader.startTag(
        Constants.TRANSIT_LINE,
        new AttributesBuilder().add(Constants.ID, lineId2.toString()).get(),
        context);
    reader.endTag(Constants.TRANSIT_LINE, EMPTY_STRING, context); // TRANSIT_LINE
    reader.endTag(context.pop(), EMPTY_STRING, context); // TRANSIT_SCHEDULE
  ...
  public void testTransitRoute_Single() {
    ...
    reader.startTag(
        Constants.TRANSIT_ROUTE,
        new AttributesBuilder().add(Constants.ID, routeId1.toString()).get(),
        context);
    context.push(Constants.TRANSIT_ROUTE);

    // by definition of the file format, transitRoute *must* have transportMode, routeProfile and
    // departures defined
    ...
    reader.startTag(
        ...
        AttributesBuilder.getEmpty(),
        context); // route profile can be empty
    reader.endTag(Constants.ROUTE_PROFILE, EMPTY_STRING, context);
    reader.startTag(
        Constants.DEPARTURES, AttributesBuilder.getEmpty(), context); // departures can be empty
  ...
  public void testTransitRoute_Multiple() {
    ...
    reader.startTag(
        Constants.TRANSIT_ROUTE,
        new AttributesBuilder().add(Constants.ID, routeId2.toString()).get(),
        context);
    context.push(Constants.TRANSIT_ROUTE);
  ...
  public void testTransitRoute_Description() {
    ...
    String description =
        "This could be some really long text, even containing line\nbreaks\n\nand other\tspecial characters.";
  ...
  public void testRouteProfile_SingleStop() {
    ...
    Attributes atts =
        new AttributesBuilder()
            .add(Constants.ID, stopId.toString())
            .add(Constants.X, "79")
            .add(Constants.Y, "80")
            .get();
    reader.startTag(Constants.STOP_FACILITY, atts, context);
    ...
    reader.startTag(
        Constants.STOP, new AttributesBuilder().add(Constants.REF_ID, "stop1").get(), context);
  ...
  public void testRouteProfile_MultipleStop() {
    ...
    Attributes atts =
        new AttributesBuilder()
            .add(Constants.ID, stopId1.toString())
            .add(Constants.X, "79")
            .add(Constants.Y, "80")
            .get();
    reader.startTag(Constants.STOP_FACILITY, atts, context);
    ...
    atts =
        new AttributesBuilder()
            .add(Constants.ID, stopId2.toString())
            .add(Constants.X, "51")
            .add(Constants.Y, "42")
            .get();
    reader.startTag(Constants.STOP_FACILITY, atts, context);
    ...
    atts =
        new AttributesBuilder()
            .add(Constants.ID, stopId3.toString())
            .add(Constants.X, "76")
            .add(Constants.Y, "80")
            .get();
    reader.startTag(Constants.STOP_FACILITY, atts, context);
    ...
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
    reader.startTag(
        Constants.STOP, new AttributesBuilder().add(Constants.REF_ID, "stop2").get(), context);
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
    reader.startTag(
        Constants.STOP, new AttributesBuilder().add(Constants.REF_ID, "stop3").get(), context);
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
  ...
  public void testRouteProfileStop_Offsets() {
    ...
    atts =
        new AttributesBuilder()
            .add(Constants.ID, stopId4.toString())
            .add(Constants.X, "5")
            .add(Constants.Y, "11")
            .get();
    reader.startTag(Constants.STOP_FACILITY, atts, context);
    ...
    reader.startTag(
        Constants.STOP,
        new AttributesBuilder()
            .add(Constants.REF_ID, "stop1")
            .add(Constants.ARRIVAL_OFFSET, "60")
            .get(),
        context);
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
    reader.startTag(
        Constants.STOP,
        new AttributesBuilder()
            .add(Constants.REF_ID, "stop2")
            .add(Constants.DEPARTURE_OFFSET, "90")
            .get(),
        context);
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
    reader.startTag(
        Constants.STOP,
        new AttributesBuilder()
            .add(Constants.REF_ID, "stop3")
            .add(Constants.ARRIVAL_OFFSET, "120")
            .add(Constants.DEPARTURE_OFFSET, "150")
            .get(),
        context);
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
    reader.startTag(
        Constants.STOP, new AttributesBuilder().add(Constants.REF_ID, "stop4").get(), context);
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
  ...
  public void testRouteProfileStop_AwaitDeparture() {
    ...
    reader.startTag(
        Constants.STOP,
        new AttributesBuilder().add(Constants.REF_ID, "stop1").get(),
        context); // awaitDeparture not specified
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
    reader.startTag(
        Constants.STOP,
        new AttributesBuilder()
            .add(Constants.REF_ID, "stop2")
            .add(Constants.AWAIT_DEPARTURE, "true")
            .get(),
        context);
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
    reader.startTag(
        ...
        new AttributesBuilder()
            .add(Constants.REF_ID, "stop3")
            .add(Constants.AWAIT_DEPARTURE, "false")
            .get(),
        context);
    reader.endTag(Constants.STOP, EMPTY_STRING, context);
  ...
  public void testRouteProfileRoute_NoLink() {
    ...
    reader.startTag(
        Constants.ROUTE_PROFILE,
        AttributesBuilder.getEmpty(),
        context); // route profile can be empty, but must exist
    reader.endTag(Constants.ROUTE_PROFILE, EMPTY_STRING, context);
    ...
    reader.startTag(
        ...
        AttributesBuilder.getEmpty(),
        context); // departures can be empty, but must exist
    reader.endTag(Constants.DEPARTURES, EMPTY_STRING, context);
  ...
  public void testRouteProfileRoute_OneLink() {
    ...
    Node node3 =
        NetworkUtils.createAndAddNode(
            network, Id.create(3, Node.class), new Coord((double) 5, (double) 11));
    Node node4 =
        NetworkUtils.createAndAddNode(
            network, Id.create(4, Node.class), new Coord((double) 5, (double) 11));
    Node node5 =
        NetworkUtils.createAndAddNode(
            network, Id.create(5, Node.class), new Coord((double) 5, (double) 11));
    final Node fromNode = node1;
    final Node toNode = node2;
    /*Link link1 =*/ NetworkUtils.createAndAddLink(
        network, Id.create(1, Link.class), fromNode, toNode, (double) 1000, 10.0, 2000.0, 1.0);
    ...
    /*Link link3 =*/ NetworkUtils.createAndAddLink(
        network, Id.create(3, Link.class), fromNode2, toNode2, (double) 1000, 10.0, 2000.0, 1.0);
    final Node fromNode3 = node4;
    final Node toNode3 = node5;
    /*Link link4 =*/ NetworkUtils.createAndAddLink(
        network, Id.create(4, Link.class), fromNode3, toNode3, (double) 1000, 10.0, 2000.0, 1.0);
    ...
    reader.startTag(
        Constants.LINK, new AttributesBuilder().add(Constants.REF_ID, "2").get(), context);
  ...
  public void testRouteProfileRoute_TwoLinks() {
    ...
    final Node fromNode1 = node2;
    final Node toNode1 = node3;
    /*Link link2 =*/ NetworkUtils.createAndAddLink(
        network, Id.create(2, Link.class), fromNode1, toNode1, (double) 1000, 10.0, 2000.0, 1.0);
    final Node fromNode2 = node3;
    final Node toNode2 = node4;
    Link link3 =
        NetworkUtils.createAndAddLink(
    ...
    reader.startTag(
        Constants.LINK, new AttributesBuilder().add(Constants.REF_ID, "3").get(), context);
    reader.endTag(Constants.LINK, EMPTY_STRING, context);
    reader.startTag(
        Constants.LINK, new AttributesBuilder().add(Constants.REF_ID, "4").get(), context);
    reader.endTag(Constants.LINK, EMPTY_STRING, context);
  ...
  public void testRouteProfileRoute_MoreLinks() {
    ...
    reader.startTag(
        Constants.LINK, new AttributesBuilder().add(Constants.REF_ID, "1").get(), context);
    reader.endTag(Constants.LINK, EMPTY_STRING, context);
    reader.startTag(
        Constants.LINK, new AttributesBuilder().add(Constants.REF_ID, "2").get(), context);
    reader.endTag(Constants.LINK, EMPTY_STRING, context);
  ...
  public void testDepartures_Single() {
    ...
    reader.startTag(
        Constants.DEPARTURE,
        new AttributesBuilder()
            .add(Constants.ID, depId1.toString())
            .add(Constants.DEPARTURE_TIME, depTime1)
            .get(),
        context);
  ...
  public void testDepartures_Multiple() {
    ...
    reader.startTag(
        Constants.DEPARTURE,
        new AttributesBuilder()
            .add(Constants.ID, depId2.toString())
            .add(Constants.DEPARTURE_TIME, depTime2)
            .get(),
        context);
    reader.endTag(Constants.DEPARTURE, EMPTY_STRING, context);
  ...
  public void testDepartures_withVehicleRef() {
    ...
    reader.startTag(
        ...
        new AttributesBuilder()
            .add(Constants.ID, depId1.toString())
            .add(Constants.DEPARTURE_TIME, depTime1)
            .add(Constants.VEHICLE_REF_ID, "v 975")
            .get(),
        context);
    reader.endTag(Constants.DEPARTURE, EMPTY_STRING, context);
