...
public class TransitRouteTest {
  ...
  /**
   * In case we once should have more than one implementation of {@link TransitRoute}, simply
   ...
   */
  protected static TransitRoute createTransitRoute(
  ...
  public void testInitialization() {
    ...
    TransitRouteStop stop =
        new TransitRouteStopImpl.Builder().arrivalOffset(50).departureOffset(60).build();
    stops.add(stop);
  ...
  public void testStops() {
    ...
    TransitStopFacility stopFacility1 =
        new TransitStopFacilityImpl(
            Id.create(1, TransitStopFacility.class), new Coord((double) 0, (double) 0), false);
    TransitStopFacility stopFacility2 =
        new TransitStopFacilityImpl(
            Id.create(2, TransitStopFacility.class), new Coord((double) 0, (double) 0), false);
    TransitStopFacility stopFacility3 =
        new TransitStopFacilityImpl(
            Id.create(3, TransitStopFacility.class), new Coord((double) 0, (double) 0), false);
    TransitStopFacility stopFacility4 =
        new TransitStopFacilityImpl(
            Id.create(4, TransitStopFacility.class), new Coord((double) 0, (double) 0), false);
    TransitRouteStop stop1 =
        new TransitRouteStopImpl.Builder()
            .stop(stopFacility1)
            .arrivalOffset(50)
            .departureOffset(60)
            .build();
