...
public class TransitRouteTest extends MatsimTestCase {
	...
	public void testStops() {
		...
		NetworkRoute route = RouteUtils.createLinkNetworkRouteImpl(fromLink.getId(), toLink.getId());
		List<TransitRouteStop> stops = new ArrayList<TransitRouteStop>();
		TransitStopFacility stopFacility1 = new TransitStopFacilityImpl(Id.create(1, org.matsim.facilities.Facility.class), new Coord((double) 0, (double) 0), false);
		TransitStopFacility stopFacility2 = new TransitStopFacilityImpl(Id.create(2, org.matsim.facilities.Facility.class), new Coord((double) 0, (double) 0), false);
		TransitStopFacility stopFacility3 = new TransitStopFacilityImpl(Id.create(3, org.matsim.facilities.Facility.class), new Coord((double) 0, (double) 0), false);
		TransitStopFacility stopFacility4 = new TransitStopFacilityImpl(Id.create(4, org.matsim.facilities.Facility.class), new Coord((double) 0, (double) 0), false);
