...
public class PositionInfoTest extends MatsimTestCase {
	...
	public void testDistanceOnLink_shortLink() {
		...
		AgentSnapshotInfo posInfo = AgentSnapshotInfoFactory.staticCreateAgentSnapshotInfo(new IdImpl(1), link1, 250, 0);
	...
	public void testDistanceOnLink_longLink() {
		...
		// place the vehicle at one quarter of the link
		AgentSnapshotInfo posInfo = AgentSnapshotInfoFactory.staticCreateAgentSnapshotInfo(new IdImpl(1), link1, 500, 0);
