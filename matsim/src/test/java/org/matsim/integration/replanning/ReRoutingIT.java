...
public class ReRoutingIT {
	...
	private Scenario loadScenario() {
		Config config = utils.loadConfig(IOUtils.newUrl(utils.getClassInputResourcePath(), "config.xml"));
	...
	private void evaluate() {
		...
		new PopulationReader(referenceScenario).parse(IOUtils.newUrl(utils.getInputResourcePath(), "1.plans.xml.gz"));
