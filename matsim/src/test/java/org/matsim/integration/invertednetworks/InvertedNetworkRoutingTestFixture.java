 ...
 *
 * <ul>
 *   <li>The link (2)->(3) may have only one mode pt, while the rest also allows car.
 *   <li>A lane with turning move restrictions to Link (2)->(5) only can be attached to link
 *       (1)->(2).
 *   <li>A signal with turning move restrictions to Link only can be attached to link (1)->(2).
 * </ul>
 *
 * <pre>
 * 			(4)
...
public class InvertedNetworkRoutingTestFixture {
  ...
  public InvertedNetworkRoutingTestFixture(
  ...
  private void createNetwork() {
    ...
    l =
        f.createLink(
            Id.create(01, Link.class),
            network.getNodes().get(Id.create(0, Node.class)),
            network.getNodes().get(Id.create(1, Node.class)));
    l.setLength(300.0);
    l.setFreespeed(10.0);
    ...
    l =
        f.createLink(
            ...
            network.getNodes().get(Id.create(1, Node.class)),
            network.getNodes().get(Id.create(2, Node.class)));
    l.setLength(300.0);
    l.setFreespeed(10.0);
    l.setCapacity(3600.0);
    network.addLink(l);
