...
/**
 * Tests that a simple simulation can be run with plans where activities and legs are not always
 * alternating.
 *
...
public class NonAlternatingPlanElementsIT {
  ...
  private static Plan createPlanWithConsecutiveLegsForEquilNet(final Scenario scenario) {
    ...
    leg1.setRoute(
        RouteUtils.createGenericRouteImpl(Id.create(1, Link.class), Id.create(14, Link.class)));
    ...
    leg2.setRoute(
        RouteUtils.createLinkNetworkRouteImpl(
            ...
            new Id[] {Id.create(20, Link.class)},
    ...
    leg3.setRoute(
        RouteUtils.createLinkNetworkRouteImpl(
            Id.create(14, Link.class), new Id[0], Id.create(14, Link.class)));
    ...
    leg4.setRoute(
        RouteUtils.createLinkNetworkRouteImpl(
            Id.create(21, Link.class),
            new Id[] {Id.create(22, Link.class), Id.create(23, Link.class)},
  ...
  private static Plan createPlanWithConsecutiveActivitiesForEquilNet(final Scenario scenario) {
    ...
    leg1.setRoute(
        RouteUtils.createGenericRouteImpl(Id.create(1, Link.class), Id.create(21, Link.class)));
  ...
  private void addSimpleTransitServices(Scenario scenario) {
    ...
    TransitStopFacility stopFacility1 =
        f.createTransitStopFacility(
            Id.create(1, TransitStopFacility.class), new Coord(x, (double) 1500), false);
    stopFacility1.setLinkId(Id.create(14, Link.class));
    final double y = -4000;
    TransitStopFacility stopFacility2 =
        f.createTransitStopFacility(
            Id.create(2, TransitStopFacility.class), new Coord((double) 5000, y), false);
    ...
    TransitRoute route1 =
        f.createTransitRoute(Id.create(1, TransitRoute.class), netRoute, stops, "bus");
