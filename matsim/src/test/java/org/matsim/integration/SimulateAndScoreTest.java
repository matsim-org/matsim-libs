...
public class SimulateAndScoreTest {
  ...
  public void testRealPtScore() {
    ...
    TransitStopFacility stop1 =
        builder.createTransitStopFacility(
            Id.create("1", TransitStopFacility.class), new Coord(100, 0), false);
    stop1.setLinkId(link1.getId());
    TransitStopFacility stop2 =
        builder.createTransitStopFacility(
            Id.create("2", TransitStopFacility.class), new Coord(1100, 0), false);
    stop2.setLinkId(link2.getId());
    TransitStopFacility stop3 =
        builder.createTransitStopFacility(
            Id.create("3", TransitStopFacility.class), new Coord(1200, 0), false);
    ...
    TransitRoute route1 =
        builder.createTransitRoute(
            Id.create("R1", TransitRoute.class),
            route,
            Arrays.asList(
                builder.createTransitRouteStop(stop1, 0, 10),
                builder.createTransitRouteStop(stop2, 0, 20),
                builder.createTransitRouteStop(stop3, 0, 30)),
            TransportMode.car);
    ...
    VehicleType vehicleType =
        vehicles.getFactory().createVehicleType(Id.create("VT1", VehicleType.class));
    ...
    Vehicle vehicle =
        vehicles.getFactory().createVehicle(Id.create("V1", Vehicle.class), vehicleType);
  ...
  public void testTeleportationScore() {
    ...
    Route ptRoute =
        populationFactory
            .getRouteFactories()
            .createRoute(Route.class, link1.getId(), link3.getId());
    ...
    scenario
        ...
        .setMarginalUtilityOfTraveling(travelingPt);
    ...
    scenario
        ...
        .getModes()
        .get(TransportMode.pt)
        .setMonetaryDistanceRate(monetaryDistanceRatePt);
    ...
    assertEquals(
        "Expecting -1.0 from travel time, -1.0 from travel distance.",
        -2.0,
        score,
