...
/**
 * A very simple fake implementation of {@link Node} to be used in tests. Only stores an Id and
 * returns it in {@link #getId()}, all other operations throw {@link UnsupportedOperationException}.
 *
 * @author mrieser
 */
