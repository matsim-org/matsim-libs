...
/**
 * A very simple Mock for {@link Link} to be used in tests. Only stores an Id and from- and toNode
 * (which both can be <code>null</code>). Some getters return hard-coded defaults, while all
 * remaining methods just throw {@link UnsupportedOperationException}s.
 *
 * @author mrieser
 */
public class FakeLink implements Link {
  ...
  /**
   * Creates a new link with the specified id and <code>null</code> for the fromNode and toNode
   *
   * @param id
   */
