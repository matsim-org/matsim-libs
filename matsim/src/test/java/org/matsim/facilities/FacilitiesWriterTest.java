...
public class FacilitiesWriterTest {
  ...
  public void testWriteLinkId() {
    ...
    ActivityFacility fac3 =
        factory.createActivityFacility(
            Id.create("3", ActivityFacility.class), new Coord(30.0, 35.0));
  ...
  public void testWrite3DCoord() {
    ...
    ActivityFacility fac1 =
        factory.createActivityFacility(
            Id.create("1", ActivityFacility.class), new Coord(10.0, 15.0, 12.3));
    ActivityFacility fac2 =
        factory.createActivityFacility(
            Id.create("2", ActivityFacility.class), new Coord(20.0, 25.0, -4.2));
    ActivityFacility fac3 =
        factory.createActivityFacility(
            Id.create("3", ActivityFacility.class), new Coord(30.0, 35.0));
