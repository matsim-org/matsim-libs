...
public class FacilitiesParserWriterTest {
  ...
  public void testWriteReadV2_withActivities() {
    ...
    ActivityFacility fac1 =
        factory.createActivityFacility(
            Id.create("1", ActivityFacility.class), new Coord(10.0, 15.0));
    fac1.addActivityOption(new ActivityOptionImpl("home"));
    facilities.addActivityFacility(fac1);

    ActivityFacility fac2 =
        factory.createActivityFacility(
            Id.create("2", ActivityFacility.class), new Coord(20.0, 25.0));
    ...
    ActivityFacility fac1b =
        facilities2.getFacilities().get(Id.create("1", ActivityFacility.class));
    ...
    ActivityFacility fac2b =
        facilities2.getFacilities().get(Id.create("2", ActivityFacility.class));
    ...
    Assert.assertEquals(
        8 * 3600,
        fac2b.getActivityOptions().get("shop").getOpeningTimes().first().getStartTime(),
        0.0);
    Assert.assertEquals(
        20 * 3600,
        fac2b.getActivityOptions().get("shop").getOpeningTimes().first().getEndTime(),
        0.0);
