...
public class FacilitiesFromPopulationTest {
  ...
  public void testRun_onePerLink_assignLinks() {
    ...
    FacilitiesFromPopulation generator =
        new FacilitiesFromPopulation(f.scenario.getActivityFacilities());
    ...
    Assert.assertEquals(
        ...
        f.scenario
            ...
            .getFacilities()
            .get(Id.create("bc", ActivityFacility.class))
            .getLinkId()
            .toString());
    Assert.assertEquals(
        "ca",
        f.scenario
            .getActivityFacilities()
            .getFacilities()
            .get(Id.create("ca", ActivityFacility.class))
            .getLinkId()
            .toString());
    Assert.assertEquals(
        "ab",
        f.scenario
            .getActivityFacilities()
            .getFacilities()
            .get(Id.create("ab", ActivityFacility.class))
            .getLinkId()
            .toString());

    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("1", Person.class)).getSelectedPlan(),
        "ab",
        "bc",
        true);
    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("2", Person.class)).getSelectedPlan(),
        "ab",
        "bc",
        true);
    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("3", Person.class)).getSelectedPlan(),
        "ab",
        "bc",
        true);
    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("4", Person.class)).getSelectedPlan(),
        "bc",
        "ca",
        true);
    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("5", Person.class)).getSelectedPlan(),
        "bc",
        "ca",
        true);
    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("6", Person.class)).getSelectedPlan(),
        "bc",
        "ca",
        true);
    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("7", Person.class)).getSelectedPlan(),
        "bc",
        "ca",
        true);
    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("8", Person.class)).getSelectedPlan(),
        "ca",
        "ab",
        true);
    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("9", Person.class)).getSelectedPlan(),
        "ca",
        "ab",
        true);
    assertPlan(
        f.scenario.getPopulation().getPersons().get(Id.create("0", Person.class)).getSelectedPlan(),
        "ca",
        "ab",
        true);
  }
  ...
  public void testRun_onePerLink_assignLinks_openingTimes() {
    ...
    Map<Id<ActivityFacility>, ? extends ActivityFacility> ffs =
        f.scenario.getActivityFacilities().getFacilities();
    Assert.assertEquals(
        7 * 3600,
        ffs.get(Id.create("ab", ActivityFacility.class))
            .getActivityOptions()
            .get("work")
            .getOpeningTimes()
            .first()
  ...
  public void testRun_multiple_assignLinks() {
    ...
    //			System.out.println(af.getId() + "\t" + af.getLinkId() + "\t" + af.getCoord().getX() + "\t"
    // + af.getCoord().getY());
    //		}
    ...
    Assert.assertEquals(
        "ab",
        ffs.get(Id.create("0", ActivityFacility.class)).getLinkId().toString()); // home of agent 1
    Assert.assertEquals(
        "bc",
        ffs.get(Id.create("1", ActivityFacility.class))
            .getLinkId()
            .toString()); // work of agent 1-3
    Assert.assertEquals(
        "ab",
        ffs.get(Id.create("2", ActivityFacility.class)).getLinkId().toString()); // home of agent 2
    Assert.assertEquals(
        "ab",
        ffs.get(Id.create("3", ActivityFacility.class)).getLinkId().toString()); // home of agent 3
    Assert.assertEquals(
        "bc",
        ffs.get(Id.create("4", ActivityFacility.class)).getLinkId().toString()); // home of agent 4
    Assert.assertEquals(
        "ca",
        ffs.get(Id.create("5", ActivityFacility.class))
            .getLinkId()
            .toString()); // work of agent 4-7
    Assert.assertEquals(
        "bc",
        ffs.get(Id.create("6", ActivityFacility.class)).getLinkId().toString()); // home of agent 5
    Assert.assertEquals(
        "bc",
        ffs.get(Id.create("7", ActivityFacility.class)).getLinkId().toString()); // home of agent 6
    Assert.assertEquals(
        "bc",
        ffs.get(Id.create("8", ActivityFacility.class)).getLinkId().toString()); // home of agent 7
    Assert.assertEquals(
        "ca",
        ffs.get(Id.create("9", ActivityFacility.class)).getLinkId().toString()); // home of agent 8
    Assert.assertEquals(
        "ab",
        ffs.get(Id.create("10", ActivityFacility.class))
            .getLinkId()
            .toString()); // work of agent 8-10
    Assert.assertEquals(
        "ca",
        ffs.get(Id.create("11", ActivityFacility.class)).getLinkId().toString()); // home of agent 9
    Assert.assertEquals(
        "ca",
        ffs.get(Id.create("12", ActivityFacility.class))
            .getLinkId()
            .toString()); // home of agent 10
  ...
  private void assertPlan(
      Plan plan, String homeFacilityId, String workFacilityId, boolean linkCoordMustBeNull) {
  ...
  /**
   * Creates a simple scenario with a network with 3 links and 10 agents.
   *
   * <pre>         (C)
   *               / \
   *            8 /   \
  ...
  private static class Fixture {
    ...
    private void createNetwork() {
      ...
      Node c =
          factory.createNode(Id.create("C", Node.class), new Coord((double) 500, (double) 600));
    ...
    private Person createPersonWithPlan(
