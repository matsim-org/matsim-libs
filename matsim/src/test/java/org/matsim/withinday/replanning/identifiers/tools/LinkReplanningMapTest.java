...
public class LinkReplanningMapTest {
  ...
  public void testScenarioRun() {
    ...
    qSimConfig.setStorageCapFactor(
        100.0); // ensure that agents don't have to wait at an intersection
   ...
   * @author cdobler
   */
  private static class MobsimListenerForTests
    ...
    public void notifyMobsimBeforeSimStep(final MobsimBeforeSimStepEvent e) {
      ...
      if (e.getSimulationTime() == t1) {
        ...
        assertEquals(
            0,
            this.lrp
                .getReplanningAgents(e.getSimulationTime())
                .size()); // no agent needs a replanning
      }
    ...
    public void notifyMobsimAfterSimStep(final MobsimAfterSimStepEvent e) {
      if (e.getSimulationTime() == t1) {
        ...
        assertEquals(
            ...
            this.lrp
                .getReplanningAgents(e.getSimulationTime())
                .size()); // one agent has just departed but cannot do a replanning
      }
      ...
      if (e.getSimulationTime() == t1 + linkTravelTime) {
        assertEquals(
            ...
            this.lrp
                .getReplanningAgents(e.getSimulationTime())
                .size()); // one agent could leave the second link in its route and should be
        // identified as to be replanned
      }
      ...
      if (e.getSimulationTime() == t3) {
        ...
        assertEquals(
            ...
            this.lrp
                .getReplanningAgents(e.getSimulationTime())
                .size()); // one agent has just departed and might do a replanning
      }
      ...
      if (e.getSimulationTime() == t4) {
        ...
        assertEquals(
            ...
            this.lrp
                .getReplanningAgents(e.getSimulationTime())
                .size()); // 97 agents have just departed but cannot do a replanning
      }
      if (e.getSimulationTime() == t4 + linkTravelTime) {
        assertEquals(
            ...
            this.lrp
                .getReplanningAgents(e.getSimulationTime())
                .size()); // 97 agents could leave the second link in its route and should be
        // identified as to be replanned
      }
    }
  }
