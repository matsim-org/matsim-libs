...
public class WithinDayTravelTimeWithNetworkChangeEventsTest {
  ...
  public final void testTTviaMobSimAfterSimStepListener() {
    ...
    String outputDirectory =
        testUtils.getOutputDirectory() + "output_TTviaMobsimAfterSimStepListener/";
    ...
    controler
        .getConfig()
        .controller()
        .setOverwriteFileSetting(OverwriteFileSetting.overwriteExistingFiles);

    Set<String> analyzedModes = new HashSet<>();
    analyzedModes.add(TransportMode.car);
    final WithinDayTravelTime travelTime =
        new WithinDayTravelTime(controler.getScenario(), analyzedModes);
