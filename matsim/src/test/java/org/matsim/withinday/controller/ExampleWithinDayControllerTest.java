...
public class ExampleWithinDayControllerTest {
	...
	private static void preparePlans(Scenario scenario) {
		...
		PlanAlgorithm router = new PlanRouter(new TripRouterFactoryBuilderWithDefaults().build(scenario).get(), TimeInterpreterModule.createFromConfig(scenario.getConfig()));
