...
public class ExperiencedPlansWriterTest {
  ...
  public void testWriteFile() {
    ...
    Person p01 =
        experiencedScenario.getPopulation().getPersons().get(Id.create("p01", Person.class));
    Person p02 =
        experiencedScenario.getPopulation().getPersons().get(Id.create("p02", Person.class));
  ...
  private static class WriterInitializer implements StartupListener {
    ...
    public void notifyStartup(StartupEvent event) {
       ...
       */
      ActivityEndIdentifierFactory identifierFactory =
          new ActivityEndIdentifierFactory(activityReplanningMap);
  ...
  private static class ReplannerFactory extends WithinDayDuringActivityReplannerFactory {
    ...
    public WithinDayDuringActivityReplanner createReplanner() {
      ...
      WithinDayDuringActivityReplanner replanner =
          new Replanner(id, scenario, this.getWithinDayEngine().getActivityRescheduler());
      return replanner;
    }
  }
  ...
  private Person createPerson(Scenario scenario, String id) {
    ...
    Activity from =
        scenario
            .getPopulation()
            .getFactory()
            .createActivityFromLinkId("home", Id.create("l0", Link.class));
    Leg leg = scenario.getPopulation().getFactory().createLeg(TransportMode.car);
    Activity to =
        scenario
            .getPopulation()
            .getFactory()
            .createActivityFromLinkId("home", Id.create("l2", Link.class));
