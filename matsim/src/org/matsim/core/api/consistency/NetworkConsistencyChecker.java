 ...
 */
@Deprecated
public interface NetworkConsistencyChecker extends ConsistencyChecker {

	public boolean checkConsistency(BasicNetwork net);

	public boolean checkConsistency(Network net);
