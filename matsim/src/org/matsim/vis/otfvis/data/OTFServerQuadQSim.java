 ...
 *
 */
public class OTFServerQuadQSim extends QuadTree<OTFDataWriter> {
  
	private static final Logger log = Logger.getLogger(OTFServerQuadQSim.class);
...
//				
	...
	public OTFServerQuadQSim(QueueNetwork net) {
		super(0,0,0,0);
	...
	public OTFServerQuadQSim(double minX, double minY, double maxX, double maxY) {
