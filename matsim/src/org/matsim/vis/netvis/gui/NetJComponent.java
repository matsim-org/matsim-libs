...
package org.matsim.vis.netvis.gui;
...
public class NetJComponent extends JComponent {
    ...
    public NetJComponent(DisplayableNetI network, RendererA networkRenderer, VisConfig visconfig) {
    ...
    private double networkClippingMinEasting() {
        return network.minEasting() - networkClippingEastingBorder();
    }

    private double networkClippingMaxEasting() {
        return network.maxEasting() + networkClippingEastingBorder();
    }

    private double networkClippingMinNorthing() {
        return network.minNorthing() - networkClippingNorthingBorder();
    }

    private double networkClippingMaxNorthing() {
        return network.maxNorthing() + networkClippingNorthingBorder();
    }
