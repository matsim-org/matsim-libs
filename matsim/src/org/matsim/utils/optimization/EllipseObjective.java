...
public class EllipseObjective implements ObjectiveI {
	...
	private final Collection<CoordI> coords;	// list of points which the calculated elliptic region should cover
	...
	public EllipseObjective(Collection<CoordI> coords, double minCover, double theta) {
		this.coords = coords;
