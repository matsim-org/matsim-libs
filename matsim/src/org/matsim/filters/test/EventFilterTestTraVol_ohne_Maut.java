...
public class EventFilterTestTraVol_ohne_Maut {
	...
	public static void testRunTraVolCal_ohne_Maut() throws IOException {
		...
		plansReader.readFile(config.plans().getInputFile());// very important for the rebuilding of event.
		System.out.println("  done.");
	...
	/**
	 * @param args - test/yu/config_hms_ohne_Maut.xml config_v1.dtd
	 * @throws Exception
	 */
