...
public class PlansReaderMatsimV1 extends MatsimXmlParser implements PlansReaderI {
	...
	private void startPerson(final Attributes atts) {
		this.currperson = new Person(atts.getValue("id"), atts.getValue("sex"), atts.getValue("age"), atts
	...
	private void startLeg(final Attributes atts) {
		try {
			this.currleg = this.currplan.createLeg(atts.getValue("num"), atts.getValue("mode"), atts.getValue("dep_time"),
