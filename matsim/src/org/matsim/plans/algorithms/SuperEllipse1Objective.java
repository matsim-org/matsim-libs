 ...
 */
public class SuperEllipse1Objective implements ObjectiveI {
	...
	public SuperEllipse1Objective(Collection<Coord> coords, double minCover, double theta) {
		this.coords = coords;
