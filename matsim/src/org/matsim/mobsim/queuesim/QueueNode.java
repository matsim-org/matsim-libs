...
public class QueueNode {
	...
	public boolean moveVehicleOverNode(final QueueVehicle veh, final double now) {
		...
		if (nextLink != null) {
			...
			// FIXME: Ich hŠtte gerne die alte Konstruktion wieder, dass explizit Ÿber den Knoten nach den outgoing links
			// gesucht wird.  Ansonsten kann man hier nŠmlich teleportieren.  kai, nov08
