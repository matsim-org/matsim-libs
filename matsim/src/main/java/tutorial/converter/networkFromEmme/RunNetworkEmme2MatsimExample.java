 ...
 * Keyword(s): emme/2
 * <p/>
 * I moved this here because in this way it can be html-referenced out of matsim.org.  
 * Additional code that does similar things can be found by searching the playground for "emme/2".  kai, mar'11
 * 
 * @author nagel
 * 
 */
...
//						String type = parts[5] ;
						...
						Id<Link> id = Id.create(linkCnt, Link.class);
						linkCnt++;
