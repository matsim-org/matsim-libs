...
/**
 * This class is similar to {@link org.matsim.core.router.Transit}, but adapted to SwissRailRaptor.
 *
 * @author mrieser / SBB
 */
public class SwissRailRaptorRoutingModuleProvider implements Provider<RoutingModule> {
  ...
  SwissRailRaptorRoutingModuleProvider(
      ...
      Scenario scenario,
      @Named(TransportMode.walk) RoutingModule transitWalkRouter) {
    this.raptor = raptor;
