...
/**
 * A default implementation of {@link RaptorIntermodalAccessEgress} returning a new
 * RIntermodalAccessEgress, which contains a list of legs (same as in the input), the associated
 * travel time as well as the disutility.
 *
 * @author pmanser / SBB
 */
public class DefaultRaptorIntermodalAccessEgress implements RaptorIntermodalAccessEgress {
  ...
  public RIntermodalAccessEgress calcIntermodalAccessEgress(
      final List<? extends PlanElement> legs,
