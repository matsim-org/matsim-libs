...
public class RaptorParameters {
  ...
  /**
   * Factor with which direct walk generalized cost is multiplied before it is compared to the pt
   * generalized cost. Set to a very high value to reduce direct walk results.
   */
  ...
  public void setMarginalUtilityOfTravelTime_utl_s(
      String mode, double marginalUtilityOfTravelTime_utl_s) {
