...
public class SwissRailRaptorConfigGroup extends ReflectiveConfigGroup {
    ...
    public static class IntermodalAccessEgressParameterSet extends ReflectiveConfigGroup {
        ...
        private double searchExtensionRadius = 0.0;
        ...
        public Map<String, String> getComments() {
            ...
            map.put(PARAM_SEARCH_EXTENSION_RADIUS, "If less than 2 stops were found in initialSearchRadius take the distance of the closest transit stop and add this extension radius to search again.The search radius will not exceed the maximum search radius set in param radius. Default value is 0.");
		...
		if (useIntermodality) {
            ...
            for (IntermodalAccessEgressParameterSet paramset : intermodalAccessEgressSettings) {
                ...
                Verify.verify(paramset.searchExtensionRadius >= 0.0, "searchExtensionRadius of IntermodalAccessEgressParameterSet "
                        + "for mode " + paramset.mode + " is negative. Please set a positive value in the config.");
