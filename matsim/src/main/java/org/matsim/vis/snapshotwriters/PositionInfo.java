 ...
 * {@link SnapshotWriter snapshots}. It also provides a way to convert graph coordinates (linkId,
 * offset) into Euclidean coordinates. Also does some additional coordinate shifting (e.g. to the
 * "right") to improve visualization. In contrast to earlier versions of this comment, it does _not_
 * define a physical position of particles in the queue model; that functionality needs to be
 * provided elsewhere.
 *
 * <p>This class has two builders since different parts of the code set different things which are
 * only loosely related. I guess this could be improved...
 *
...
public class PositionInfo implements AgentSnapshotInfo {
  ...
  public static class LinkBasedBuilder {
    ...
    public LinkBasedBuilder setLinkWidthCalculator(
