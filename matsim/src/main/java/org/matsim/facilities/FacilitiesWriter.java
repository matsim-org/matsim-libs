...
public class FacilitiesWriter implements MatsimWriter {
   ...
   * Creates a new FacilitiesWriter to write the specified facilities to the file.
   *
   * @param coordinateTransformation a transformation from the CRS in the data structure to the CRS
   *     to use in the file
   * @param facilities the facilities to write
   */
  ...
  /**
   * Writes the activity facilities in the current default format to the stream (currently
   * facilities_v2.dtd).
   */
