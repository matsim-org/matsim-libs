...
/**
 * When ActivityFacilities are not used, use this class to wrap activity geographical information
 * (coord and linkid) in a facility interface (for example to pass to the router)
 *
 * @author thibautd
 */
