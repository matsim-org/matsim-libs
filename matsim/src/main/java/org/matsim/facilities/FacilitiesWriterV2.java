...
class FacilitiesWriterV2 extends MatsimXmlWriter implements MatsimWriter {
  ...
  private void writeCapacity(final ActivityOptionImpl activity, final BufferedWriter out)
      throws IOException {
  ...
  private void writeOpentime(final OpeningTime opentime, final BufferedWriter out)
      throws IOException {
    out.write("\t\t\t<opentime");
    out.write(" day=\"wkday\"");
