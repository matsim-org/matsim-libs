...
public class OpeningTimeImpl implements OpeningTime {
  public static OpeningTime createFromOptionalTimes(OptionalTime start, OptionalTime end) {
    return new OpeningTimeImpl(
        start.orElse(Double.NEGATIVE_INFINITY), end.orElse(Double.POSITIVE_INFINITY));
  }
  ...
  public final int hashCode() {
    ...
    return (Double.hashCode(this.startTime) + Double.hashCode(this.endTime));
  }
  ...
  private final void validateTimes() {
    ...
    Preconditions.checkState(
        ...
        "[startTime=%s] >= [endTime=%s] not allowed]",
        this.startTime,
        this.endTime);
  }
