...
public class CountSimComparisonTimeFilter {
  ...
  /**
   * Fills the Array for each hour with the appropriate CountSimComparison objects from the list
   * given as parameter.
   *
   * @param countSimComparisons
   */
  public CountSimComparisonTimeFilter(final List<CountSimComparison> countSimComparisons) {
  ...
  /**
   * @param timefilter A time step to filter the counts. Time may be null to avoid filtering. A
   *     value in 1..24, 1 for 0 a.m. to 1 a.m., 2 for 1 a.m. to 2 a.m. If null nothing is filtered.
