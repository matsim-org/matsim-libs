...
public final class BoxPlotNormalizedErrorGraph extends CountsGraph {

	public BoxPlotNormalizedErrorGraph(final List<CountSimComparison> ccl, final int iteration, final String filename,
