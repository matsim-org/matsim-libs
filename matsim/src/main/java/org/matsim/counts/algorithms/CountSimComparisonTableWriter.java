 ...
 *
 * @author dgrether
 *     <p>anhorni 31.03.2008: Writing the 'average weekday traffic volume' (german: DWV) per link to
 *     another table. Future work: Use parameter in the config file to choose which table to be
 *     printed.
 *     <p>Added normalized relative errors and geh values to output file. cdobler jun'17
 */
public class CountSimComparisonTableWriter extends CountSimComparisonWriter {
  ...
  private void writeAWTVTable(final String file) {
    ...
    CountSimComparisonLinkFilter linkFilter =
        new CountSimComparisonLinkFilter(this.countComparisonFilter.getCountsForHour(null));
