...
public final class CountsSimRealPerHourGraph extends CountsGraph {
  /**
   * The time at which the data was measured. A value in 1..24, 1 for 0 a.m. to 1 a.m., 2 for 1 a.m.
   * to 2 a.m. ...
   */
  private int hour;

  public CountsSimRealPerHourGraph(
  ...
  public JFreeChart createChart(final int hour) {
    ...
    String title =
        "Volumes " + (hour - 1) + ":00 - " + (hour) + ":00, Iteration: " + this.iteration_;
