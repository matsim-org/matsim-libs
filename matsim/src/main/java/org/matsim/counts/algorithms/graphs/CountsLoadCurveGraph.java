...
public final class CountsLoadCurveGraph extends CountsGraph {
  ...
  public void add2LoadCurveDataSets(final CountSimComparison cc) {
    ...
    // relative error
    // TRRE: this.dataset1.addValue(cc.calculateRelativeError(),"Signed Rel.
    // Error",Integer.toString(cc.getHour()));
  ...
  public JFreeChart createChart(final int nbr) {
    ...
    //		plot.getRangeAxis().setRange(0.0, 10000.0); // do not set a fixed range for the single link
    // graphs
