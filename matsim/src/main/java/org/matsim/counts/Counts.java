...
public class Counts<T> {
   ...
   * @param stationName some additional identifier for humans, e.g. the original name/id of the
   *     counting station
   * @return the created Count object, or {@linkplain RuntimeException} if it could not be created
