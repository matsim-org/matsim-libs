...
/**
 * This class provides methods to aggregate the errors and the bias of a CountSimComparison
 * instances list to hourly based mean values.
 *
 * @author dgrether
 */
  ...
  public double[] getMeanNormRelError() {
    if (this.meanNormRelError == null) {
      throw new RuntimeException(
          "Object not initialized correctly. Call calculateErrorStats(..) first!");
    }
