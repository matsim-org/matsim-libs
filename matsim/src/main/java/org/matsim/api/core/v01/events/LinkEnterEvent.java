...
public class LinkEnterEvent extends Event implements HasLinkId, HasVehicleId {
  ...
  static final String missingVehicleIdMessage =
      "vehicleId=null in LinkEnter/LeaveEvent; this would cause problems downstream thus we are not accepting it";
  ...
  /**
   * Please use getVehicleId() instead. Vehicle-driver relations can be made by {@link
   * VehicleEntersTrafficEvent} and {@link VehicleLeavesTrafficEvent}.
   */
  @Deprecated
