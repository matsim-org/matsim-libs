...
public class LinkLeaveEvent extends Event implements HasLinkId, HasVehicleId {
  ...
  static final String missingDriverIdMessage =
      "driver (or person) ID does no longer exist in LinkEnter/LeaveEvent; use vehicle ID instead. "
  ...
  /**
   * Please use getVehicleId() instead. Vehicle-driver relations can be made by Wait2Link (now:
   * VehicleEntersTraffic) and VehicleLeavesTraffic Events.
   */
  @Deprecated
