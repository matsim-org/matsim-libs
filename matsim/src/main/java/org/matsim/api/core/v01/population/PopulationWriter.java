...
public final class PopulationWriter implements MatsimWriter {
  ...
  public PopulationWriter(
      final CoordinateTransformation transformation, Population population, Network network) {
    this.transformation = transformation;
    this.population = population;
    this.network = network;
  }

  public PopulationWriter(final CoordinateTransformation transformation, Population population) {
  ...
  public void writeV4(final String filename) {
    new org.matsim.core.population.io.PopulationWriter(
            transformation, this.population, this.network)
        .writeV4(filename);
  }
