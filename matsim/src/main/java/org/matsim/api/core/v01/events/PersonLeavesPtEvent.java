...
public class PersonLeavesPtEvent extends Event implements HasPersonId, HasVehicleId {
	...
	public PersonLeavesPtEvent(double time, Id<Person> person, Id<Vehicle> vehicle, Id<TransitStopFacility> stop, Id<TransitLine> line, Id<TransitRoute> route) {
		super(time);
		this.person = person;
