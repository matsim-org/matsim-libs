...
public abstract class Event {
  ...
  public Map<String, String> getAttributes() {
    ...
    if (this instanceof HasPersonId && ((HasPersonId) this).getPersonId() != null) {
      ...
      // many derived types do this by themselves, for historical reasons.  Since the information is
      // put into a map, it still exists only once under that key.  kai,
      // mar'19
    }
  ...
  public int hashCode() {
    return getAttributes()
        .hashCode(); // Two equal events must at least have the same attributes, so they will get
    // the same hashCode like this.
  }
}
