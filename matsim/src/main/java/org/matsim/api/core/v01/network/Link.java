...
/**
 * This interface deliberately does NOT have a back pointer ... ... since, at this level, one should
 * be able to get the relevant container from the context. (This becomes clear if you think about a
 * nodeId/linkId given by person.)
 */
public interface Link extends BasicLocation, Attributable, Identifiable<Link> {
   ...
   *
   * @param node the <code>BasicNodeI</code> to be set
   * @return <true> if <code>node</code> has been set and <code>false</code> otherwise
   ...
   *
   * @param node the <code>BasicNodeI</code> to be set
   * @return <code>true</code> if <code>node</code> has been set and <code>false</code> otherwise
   * @throws IllegalArgumentException if <code>node</code> is <code>null</code>
   */
   ...
   * capperiod attribute).
   *
   * @param time the time at which the capacity is requested. Use {@link Double#NEGATIVE_INFINITY}
