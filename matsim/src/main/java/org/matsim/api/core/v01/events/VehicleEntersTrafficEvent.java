...
public class VehicleEntersTrafficEvent extends Event
    implements HasPersonId, HasLinkId, HasVehicleId {
  ...
  public VehicleEntersTrafficEvent(
      final double time,
      final Id<Person> driverId,
      final Id<Link> linkId,
      Id<Vehicle> vehicleId,
      String networkMode,
      double relativePositionOnLink) {
    super(time);
