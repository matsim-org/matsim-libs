...
/**
 * This event specifies that an agent has gained (or lost) some score-utility. Scoring functions
 * should handle these Events by adding the amount to the agents score.
 *
