...
public class ActivityStartEvent extends Event
    implements HasFacilityId, HasPersonId, HasLinkId, BasicLocation {
  ...
  //	public ActivityStartEvent( final double time, final Id<Person> agentId, final Activity
  // activity ){
  ...
  public void setCoord(Coord coord) {
    // yy  this is to retrofit the coordinate into existing events that don't have it.  :-(  kai,
    // mar'20
    this.coord = coord;
  }
}
