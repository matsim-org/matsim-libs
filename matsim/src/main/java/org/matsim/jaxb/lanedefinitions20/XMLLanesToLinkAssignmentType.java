...
/**
 * Java class for lanesToLinkAssignmentType complex type.
 *
...
@XmlType(
    name = "lanesToLinkAssignmentType",
    propOrder = {"lane"})
public class XMLLanesToLinkAssignmentType {
  ...
  @XmlAttribute protected String linkIdRef;
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link XMLLaneType }
   */
