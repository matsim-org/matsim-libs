...
public class VisumNetworkReader {
  ...
  private final String[] ATTRIBUTE_VJS_VEHJOURNEYNO = {
    "VEHJOURNEYNO", "FZGFAHRTNR"
  ...
  public void read(final String filename) throws UncheckedIOException {
    BufferedReader reader =
        IOUtils.getBufferedReader(IOUtils.getFileUrl(filename), Charset.forName("ISO-8859-1"));
  ...
  private void readVersion(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(tableAttributes.substring("$VERSION:".length()), ';');
  ...
  private void readEdgeTypes(String tableAttributes, BufferedReader reader) throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_LINKTYPE[this.language].length()), ';');
    ...
    final int idxNoOfLanes =
        getAttributeIndex(this.ATTRIBUTE_LINKTYPE_NOLANES[this.language], attributes);

    String line = reader.readLine();
    while (line != null && line.length() > 0) {
      final String[] parts = StringUtils.explode(line, ';');
      VisumNetwork.EdgeType edgeType =
          new VisumNetwork.EdgeType(
              Id.create(parts[idxNo], VisumNetwork.EdgeType.class),
              parts[idxKapIV],
              parts[idxV0IV],
              parts[idxNoOfLanes]);
  ...
  private void readStops(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_STOP[this.language].length()), ';');
    ...
    while (line != null && line.length() > 0) {
      final String[] parts = StringUtils.explode(line, ';');
      VisumNetwork.Stop stop =
          new VisumNetwork.Stop(
              Id.create(parts[idxNo], VisumNetwork.Stop.class),
              parts[idxName],
              new Coord(
                  Double.parseDouble(parts[idxXcoord].replace(',', '.')),
  ...
  private void readStopAreas(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_STOPAREA[this.language].length()), ';');
    ...
    while (line != null && line.length() > 0) {
      final String[] parts = StringUtils.explode(line, ';');
      VisumNetwork.StopArea stopAr =
          new VisumNetwork.StopArea(
              Id.create(parts[idxNo], VisumNetwork.StopArea.class),
              Id.create(parts[idxStopId], VisumNetwork.Stop.class));
  ...
  private void readStopPoints(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_STOPPOINT[this.language].length()), ';');
    final int idxNo = getAttributeIndex(this.ATTRIBUTE_STOPPT_NO[this.language], attributes);
    final int idxStopAreaNo =
    ...
    while (line != null && line.length() > 0) {
      final String[] parts = StringUtils.explode(line, ';');
      VisumNetwork.StopPoint stopPt =
          new VisumNetwork.StopPoint(
              Id.create(parts[idxNo], VisumNetwork.StopPoint.class),
              Id.create(parts[idxStopAreaNo], VisumNetwork.StopArea.class),
              parts[idxName],
              Id.create(parts[idxRLNo], Link.class),
              Id.create(parts[idxNode], Node.class));
  ...
  private void readLineRoutes(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_LINEROUTE[this.language].length()), ';');
    final int idxName = getAttributeIndex(this.ATTRIBUTE_LR_NAME[this.language], attributes);
    final int idxLineName =
    ...
    while (line != null && line.length() > 0) {
      final String[] parts = StringUtils.explode(line, ';');
      VisumNetwork.TransitLineRoute lr1 =
          new VisumNetwork.TransitLineRoute(
  ...
  private void readLines(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_LINE[this.language].length()), ';');
    ...
    final int idxVehCombNo =
        getAttributeIndex(this.ATTRIBUTE_L_VEHCOMBNO[this.language], attributes);

    String line = reader.readLine();
    while (line != null && line.length() > 0) {
      final String[] parts = StringUtils.explode(line, ';');
      VisumNetwork.TransitLine tLine =
          new VisumNetwork.TransitLine(
              Id.create(parts[idxName], TransitLine.class), parts[idxTCode], parts[idxVehCombNo]);
  ...
  private void readLineRouteItems(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_LINEROUTEITEM[this.language].length()), ';');
    final int idxLineRouteName =
    ...
    while (line != null && line.length() > 0) {
      ...
      VisumNetwork.LineRouteItem lri1 =
          new VisumNetwork.LineRouteItem(
              parts[idxLineName],
              parts[idxLineRouteName],
              parts[idxIndex],
              parts[idxDCode],
              nodeId,
              stopPointNo);
  ...
  private void readTimeProfile(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_TIMEPROFILE[this.language].length()), ';');
    ...
    while (line != null && line.length() > 0) {
      ...
      VisumNetwork.TimeProfile tp1 =
          new VisumNetwork.TimeProfile(
              Id.create(parts[idxLineName], VisumNetwork.TransitLine.class),
              Id.create(parts[idxLineRouteName], TransitLineRoute.class),
              Id.create(parts[idxIndex], VisumNetwork.TimeProfile.class),
              parts[idxDCode],
              parts[idxVehCombNo]);
  ...
  private void readTimeProfileItems(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_TIMEPROFILEITEM[this.language].length()), ';');
    final int idxLineRouteName =
    ...
    while (line != null && line.length() > 0) {
      ...
      VisumNetwork.TimeProfileItem tpi1 =
          new VisumNetwork.TimeProfileItem(
              parts[idxLineName],
              parts[idxLineRouteName],
              parts[idxTPName],
              parts[idxDCode],
  ...
  private void readDepartures(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_VEHJOURNEY[this.language].length()), ';');
    final int idxLineRouteName =
    ...
    while (line != null && line.length() > 0) {
      ...
      VisumNetwork.Departure d =
          new VisumNetwork.Departure(
              parts[idxLineName],
              parts[idxLineRouteName],
              parts[idxNo],
              parts[idxTRI],
  ...
  private void readDepartureSections(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_VEHJOURNEYSECTION[this.language].length()), ';');
    final int idxVehicleJourneyNo =
        getAttributeIndex(this.ATTRIBUTE_VJS_VEHJOURNEYNO[this.language], attributes);
    final int idxVehCombinationNo =
  ...
  private void readVehicleUnits(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_VEHUNIT[this.language].length()), ';');
    ...
    while (line != null && line.length() > 0) {
      ...
      VisumNetwork.VehicleUnit vehicleUnit =
          new VisumNetwork.VehicleUnit(
              parts[idxId],
              parts[idxCode],
              Integer.parseInt(parts[idxSeatCap]),
              Integer.parseInt(parts[idxTotalCap]));
  ...
  private void readVehicleCombinations(final String tableAttributes, final BufferedReader reader)
      throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_VEHCOMB[this.language].length()), ';');
    ...
    while (line != null && line.length() > 0) {
      ...
      VisumNetwork.VehicleCombination vehicleComb =
          new VisumNetwork.VehicleCombination(parts[idxId], parts[idxName]);
  ...
  private void readVehicleUnitToVehicleCombination(
      final String tableAttributes, final BufferedReader reader) throws IOException {
    final String[] attributes =
        StringUtils.explode(
            tableAttributes.substring(this.TABLE_VEHUNITTOVEHCOMB[this.language].length()), ';');
    final int idxVehicleUnit =
        getAttributeIndex(this.ATTRIBUTE_VEHUNITTOVEHCOMB_VEHUNITNO[this.language], attributes);
    final int idxVehicleComb =
        getAttributeIndex(this.ATTRIBUTE_VEHUNITTOVEHCOMB_VEHCOMBNO[this.language], attributes);
    final int idxVehicleNumber =
    ...
    while (line != null && line.length() > 0) {
      ...
      VisumNetwork.VehicleCombination vehicleComb =
          this.network.vehicleCombinations.get(parts[idxVehicleComb]);
