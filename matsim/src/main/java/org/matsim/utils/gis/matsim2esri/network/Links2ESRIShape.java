...
/**
 * Simple class to convert the links of MATSim network files to ESRI shape files. The network can be
 * written either as line strings or as polygons. Furthermore the width of the links could be
 * calculated according to freespeed, lanes or capacity. For some basic examples please have a look
 * at the <code>main</code> method. Can also be called as Links2ESRIShape inputNetwork.xml
 * outputAsLines.shp outputAsPolygons.shp .
 *
 * <p><strong>Keywords:</strong> converter, network, links, esri, shp, matsim
 *
 * @author laemmel
 */
public class Links2ESRIShape {
  ...
  public Links2ESRIShape(
      final Network network, final String filename, final FeatureGeneratorBuilder builder) {
  ...
  public static void main(final String[] args) {
    ...
    boolean commonWealth =
        false; // to render Commonwealth networks correctly (e.g. drive on left-hand side of the
    // road)
    if (args.length == 0) {
