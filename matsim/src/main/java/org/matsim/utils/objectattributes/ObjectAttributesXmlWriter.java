...
public class ObjectAttributesXmlWriter extends MatsimXmlWriter {
  ...
  private static final Logger log = LogManager.getLogger(ObjectAttributesXmlWriter.class);

  /*package*/ static final String TAG_OBJECT_ATTRIBUTES = "objectAttributes";
  /*package*/ static final String TAG_OBJECT = "object";
  /*package*/ static final String TAG_ATTRIBUTE = "attribute";
  /*package*/ static final String ATTR_OBJECTID = "id";
  /*package*/ static final String ATTR_ATTRIBUTENAME = "name";
  /*package*/ static final String ATTR_ATTRIBUTECLASS = "class";
