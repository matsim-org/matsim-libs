...
public abstract class ParallelReplanner<
  ...
  private static final Logger log = LogManager.getLogger(ParallelReplanner.class);
  ...
  public final void init(String replannerName) {
    ...
    for (int i = 0; i < numOfThreads; i++) {
      ReplanningRunnable replanningRunnable =
          new InternalReplanningRunnable(replannerName + " Thread" + i + " replanned plans: ");
  ...
  public final void onPrepareSim() {
    ...
    this.uncaughtExceptionHandler =
        new ExceptionHandler(
            this.hadException,
            this.timeStepStartBarrier,
            this.betweenReplannerBarrier,
            this.timeStepEndBarrier);
