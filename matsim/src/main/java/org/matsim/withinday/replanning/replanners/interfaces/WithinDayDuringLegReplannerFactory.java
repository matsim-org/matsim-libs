...
public abstract class WithinDayDuringLegReplannerFactory extends WithinDayReplannerFactory<DuringLegIdentifier> {

	public WithinDayDuringLegReplannerFactory(ReplanningManager replanningManager,
