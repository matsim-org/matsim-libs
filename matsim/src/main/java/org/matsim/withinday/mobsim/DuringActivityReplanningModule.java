...
public class DuringActivityReplanningModule
    extends WithinDayReplanningModule<WithinDayDuringActivityReplannerFactory> {

  public DuringActivityReplanningModule(
