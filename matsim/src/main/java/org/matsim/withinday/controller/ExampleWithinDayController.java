...
//			System.out.println("Usage: Controler config-file [dtd-file]");
	...
	private void initReplanners( ) {
		...
		this.initialReplannerFactory = new InitialReplannerFactory(this.scenario, this.withinDayEngine, this.tripRouterProvider, this.timeInterpreterFactory);
		...
		this.duringActivityReplannerFactory = new NextLegReplannerFactory(this.scenario, this.withinDayEngine, this.tripRouterProvider, this.timeInterpreterFactory);
