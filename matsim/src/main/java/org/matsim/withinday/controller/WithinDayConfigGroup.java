...
public final class WithinDayConfigGroup extends ReflectiveConfigGroup {
  ...
  // yyyy I cannot say yet if this should restrict to "TravelTimePrediction".  Probably yes.  Needs
  // to be decided before escalated to xml config.  kai, may'17
  ...
  // I think this is what the original code does: use "current" travel times (whatever that means; I
  // still need to find out). kai, may'17

  @SuppressWarnings("unused")
  private static final String SHORT_TERM_PREDICTION_METHOD_CMT =
