...
public class CharyparNagelLegScoring implements LegScoring, ArbitraryEventScoring {
  ...
  public CharyparNagelLegScoring(
      final ScoringParameters params, Network network, TransitSchedule transitSchedule) {
    this(params, network);
  ...
  //		double legScore = calcLegScore(leg.getDepartureTime(), leg.getDepartureTime() +
  // leg.getTravelTime(), leg);
  //		this.score += legScore;
  //	}
