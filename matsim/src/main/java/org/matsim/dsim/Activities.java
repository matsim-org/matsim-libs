...
/**
 * Defines available activities and open- and closing times in many scenarios at vsp.
 * This class has been copied to be compatible with existing scenarios, that usually have a custom run class.
 */
