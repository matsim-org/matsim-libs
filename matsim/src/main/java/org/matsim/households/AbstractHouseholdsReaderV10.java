...
abstract class AbstractHouseholdsReaderV10 extends MatsimXmlParser {
  ...
  public void endTag(String name, String content, Stack<String> context) {
    if (HouseholdsSchemaV10Names.HOUSEHOLD.equalsIgnoreCase(name)) {
      ...
      this.currentincome =
          this.builder.createIncome(Double.parseDouble(content.trim()), this.currentIncomePeriod);
  ...
  public void startTag(String name, Attributes atts, Stack<String> context) {
    if (HouseholdsSchemaV10Names.HOUSEHOLD.equalsIgnoreCase(name)) {
      ...
      Id<Vehicle> vehicleId =
          Id.create(atts.getValue(HouseholdsSchemaV10Names.REFID), Vehicle.class);
