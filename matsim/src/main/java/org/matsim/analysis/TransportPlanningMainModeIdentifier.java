...
/**
 * Attempt to provide a {@link MainModeIdentifier} that is justified from the transport engineering
 * perspective, not from the software perspective.
 *
 * @author nagel
 */
public final class TransportPlanningMainModeIdentifier implements AnalysisMainModeIdentifier {
  // I am against other people changing this lightheartedly since some of my analysis depends on it.
  //  So either please discuss,
  // or use your own variant.  kai, sep'16

  // yyyyyy some variant of this (maybe not exactly this one here) should be able to deal with
  // multi-leg trips.  kai/amit, mar'17
