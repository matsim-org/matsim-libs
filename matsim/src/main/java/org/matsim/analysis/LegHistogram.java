...
/**
 * @author mrieser
 *     <p>Counts the number of persons departed, arrived or got stuck per time bin based on events.
 *     <p>The chart plotting was moved to its own class. This class could be moved to
 *     trafficmonitoring.
 */
public class LegHistogram
  ...
  public void handleEvent(final PersonDepartureEvent event) {
    ...
    if ((this.personIds == null || this.personIds.contains(event.getPersonId()))
  ...
  DataFrame getDataForMode(final String legMode) {
    ...
    if (dataFrame == null) {
      dataFrame =
          new DataFrame(this.binSize, this.nofBins + 1); // +1 for all times out of our range
