...
/**
 * @author mrieser
 *     <p>Calculates the distribution of legs-durations, e.g. how many legs took at most 5 minutes,
 *     how many between 5 and 10 minutes, and so on. Also calculates the average leg duration. Legs
 *     ended because of vehicles being stuck are not counted.
 */
public class CalcLegTimes
  ...
  private static final Logger log = LogManager.getLogger(CalcLegTimes.class);

  private static final int SLOT_SIZE = 300; // 5-min slots
  private static final int MAXINDEX =
      12; // slots 0..11 are regular slots, slot 12 is anything above
