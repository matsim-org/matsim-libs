...
/**
 * Reads {@link TransitSchedule}s from file as long as the files are in one of the supported file
 * formats.
 *
 * @author mrieser
 */
public class TransitScheduleReader implements MatsimReader {
  ...
  public TransitScheduleReader(final String targetCRS, final Scenario scenario) {
