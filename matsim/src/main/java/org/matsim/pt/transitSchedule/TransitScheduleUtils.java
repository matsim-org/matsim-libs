...
public final class TransitScheduleUtils {
  ...
  public static final String ACCESSTIME_ATTRIBUTE = "accessTime";
  public static final String EGRESSTIME_ATTRIBUTE = "egressTime";
  ...
  public static void setSymmetricStopAccessEgressTime(
      TransitStopFacility stopFacility, double stopAccessEgressTime) {
    setStopAccessTime(stopFacility, stopAccessEgressTime);
    setStopEgressTime(stopFacility, stopAccessEgressTime);
  }

  public static QuadTree<TransitStopFacility> createQuadTreeOfTransitStopFacilities(
