...
/**
 * Describes the stop within a route of a transit line. Specifies also at what time a headway is
 * expected at the stop as offset from the route start.
 *
 * @author mrieser
 */
public class TransitRouteStopImpl implements TransitRouteStop {
  ...
  /**
   * TransitRouteStops are typical Value Objects, so we consider two stops equal if they are equal
   * field-wise.
   */
  @Override
