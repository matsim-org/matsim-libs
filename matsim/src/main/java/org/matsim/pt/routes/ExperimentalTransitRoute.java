...
public class ExperimentalTransitRoute extends AbstractRoute implements TransitPassengerRoute {
  ...
  private static final String IDENTIFIER_1 = "PT1" + SEPARATOR;

  /* package */ static final String ROUTE_TYPE = "experimentalPt1";
  ...
  public ExperimentalTransitRoute(
  ...
  public void setRouteDescription(final String routeDescription) {
    ...
    if (routeDescription.startsWith(IDENTIFIER_1)) {
      String[] parts =
          routeDescription.split(SEPARATOR, 6); // StringUtils.explode(routeDescription, '\t', 6);
  ...
  public String getRouteDescription() {
    ...
    String str =
        IDENTIFIER_1
            + this.accessStopId.toString()
            + SEPARATOR
            + this.lineId.toString()
            + SEPARATOR
            + this.routeId.toString()
            + SEPARATOR
            + this.egressStopId.toString();
