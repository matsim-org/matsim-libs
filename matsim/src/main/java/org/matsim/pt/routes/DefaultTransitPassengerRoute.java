...
public class DefaultTransitPassengerRoute extends AbstractRoute implements TransitPassengerRoute {
  ...
  public DefaultTransitPassengerRoute( //
      final Id<Link> accessLinkId,
      final Id<Link> egressLinkId, //
    ...
    this.accessFacilityIndex =
        Objects.isNull(accessFacilityId) ? NULL_ID : accessFacilityId.index();
    this.egressFacilityIndex =
        Objects.isNull(egressFacilityId) ? NULL_ID : egressFacilityId.index();
  }
  ...
  public String getRouteDescription() {
    ...
    try {
      ...
      routeDescription.accessFacilityId =
          this.accessFacilityIndex == NULL_ID
              ? null
              : Id.get(this.accessFacilityIndex, TransitStopFacility.class);
      routeDescription.egressFacilityId =
          this.egressFacilityIndex == NULL_ID
              ? null
              : Id.get(this.egressFacilityIndex, TransitStopFacility.class);
      routeDescription.transitLineId =
          this.transitLineIndex == NULL_ID
              ? null
              : Id.get(this.transitLineIndex, TransitLine.class);
      routeDescription.transitRouteId =
          this.transitRouteIndex == NULL_ID
              ? null
              : Id.get(this.transitRouteIndex, TransitRoute.class);
  ...
  public void setRouteDescription(String routeDescription) {
    try {
      ...
      this.accessFacilityIndex =
          parsed.accessFacilityId == null ? NULL_ID : parsed.accessFacilityId.index();
      this.egressFacilityIndex =
          parsed.egressFacilityId == null ? NULL_ID : parsed.egressFacilityId.index();
      this.transitLineIndex = parsed.transitLineId == null ? NULL_ID : parsed.transitLineId.index();
      this.transitRouteIndex =
          parsed.transitRouteId == null ? NULL_ID : parsed.transitRouteId.index();
    } catch (IOException e) {
      throw new RuntimeException(e);
    }
  }
  ...
  public Id<TransitStopFacility> getAccessStopId() {
    return this.accessFacilityIndex >= 0
        ? Id.get(this.accessFacilityIndex, TransitStopFacility.class)
        : null;
  }
  ...
  public Id<TransitStopFacility> getEgressStopId() {
    return this.egressFacilityIndex >= 0
        ? Id.get(this.egressFacilityIndex, TransitStopFacility.class)
        : null;
  }
  ...
  public DefaultTransitPassengerRoute clone() {
    DefaultTransitPassengerRoute copy =
  ...
  public static class RouteDescription {
    ...
    public void setTransitLineId(String transitLineId) {
      this.transitLineId =
          transitLineId == null ? null : Id.create(transitLineId, TransitLine.class);
    }

    @JsonProperty("transitRouteId")
    public void setRouteLineId(String transitRouteId) {
      this.transitRouteId =
          transitRouteId == null ? null : Id.create(transitRouteId, TransitRoute.class);
    }

    @JsonProperty("accessFacilityId")
    public void setAccessFacilityId(String accessFacilityId) {
      this.accessFacilityId =
          accessFacilityId == null ? null : Id.create(accessFacilityId, TransitStopFacility.class);
    }

    @JsonProperty("egressFacilityId")
    public void setEgressFacilityId(String egressFacilityId) {
      this.egressFacilityId =
          egressFacilityId == null ? null : Id.create(egressFacilityId, TransitStopFacility.class);
    }
  }
}
