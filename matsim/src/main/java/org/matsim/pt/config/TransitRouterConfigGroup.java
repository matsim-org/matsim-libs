...
public class TransitRouterConfigGroup extends ReflectiveConfigGroup {
  ...
  /*package*/ static final String MAX_BEELINE_WALK_CONNECTION_DISTANCE =
  ...
  static final String DIRECT_WALK_FACTOR_CMT =
      "Factor with which direct walk generalized cost is multiplied before it is compared "
  ...
  public Map<String, String> getComments() {
    ...
    comments.put(
        MAX_BEELINE_WALK_CONNECTION_DISTANCE,
