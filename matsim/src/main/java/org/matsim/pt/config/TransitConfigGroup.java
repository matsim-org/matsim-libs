...
public class TransitConfigGroup extends ReflectiveConfigGroup {
  ...
  public enum TransitRoutingAlgorithmType {
    @Deprecated
    DijkstraBased,
    SwissRailRaptor
  }
  ...
  private TransitRoutingAlgorithmType routingAlgorithmType =
  ...
  public Map<String, String> getComments() {
    ...
    comments.put(
        TRANSIT_SCHEDULE_FILE, "Input file containing the transit schedule to be simulated.");
    comments.put(
        VEHICLES_FILE,
    ...
    comments.put(
        USE_TRANSIT, "Set this parameter to true if transit should be simulated, false if not.");
    comments.put(
        ROUTINGALGORITHM_TYPE,
        "The type of transit routing algorithm used, may have the values: "
            + Arrays.toString(TransitRoutingAlgorithmType.values()));
  ...
  public static final String BOARDING_ACCEPTANCE_CMT =
      "under which conditions agent boards transit vehicle";

  public enum BoardingAcceptance {
    checkLineAndStop,
    checkStopOnly
  }
