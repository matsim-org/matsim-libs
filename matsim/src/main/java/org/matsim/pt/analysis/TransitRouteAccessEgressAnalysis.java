...
public class TransitRouteAccessEgressAnalysis
  ...
  private final Map<Departure, Map<Id, Integer>> accessCounters =
      new LinkedHashMap<Departure, Map<Id, Integer>>();
  private final Map<Departure, Map<Id, Integer>> egressCounters =
      new LinkedHashMap<Departure, Map<Id, Integer>>();
  ...
  private void collectHeadingsInfo() {
    Map<Id, Departure> map =
        new HashMap<Id, Departure>(this.transitRoute.getDepartures().size() * 2);
