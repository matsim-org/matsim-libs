 ...
 * Currently, it is ensured that every link can be reached by every other link.
 *
 * @author mrieser
 */
public class NetworkCleaner {
  ...
  /**
   * Runs the network cleaning algorithms over the network read in from <code>inputNetworkFile
   * </code> and writes the resulting ("cleaned") network to the specified file.
   *
   ...
   *
   * @param args <code>args[0]</code> filename of the network to be handled, <code>args[1]</code>
