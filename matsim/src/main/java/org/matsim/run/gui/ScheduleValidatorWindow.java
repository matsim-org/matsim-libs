...
public class ScheduleValidatorWindow extends JDialog {
  ...
  public ScheduleValidatorWindow(JFrame parent) throws HeadlessException {
    ...
    btnChooseSchedule.addActionListener(
        e -> {
    ...
    btnChooseNetwork.addActionListener(
        e -> {
          JFileChooser chooser = new JFileChooser();
          chooser.setCurrentDirectory(this.lastUsedDirectory);
          int result = chooser.showOpenDialog(null);
        ...
        groupLayout
            ...
            .addGroup(
                groupLayout
                    ...
                    .addComponent(
                        outputPane, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE, Short.MAX_VALUE))
            .addContainerGap());
  ...
  public void loadFromConfig(Config config, File configDirectory) {
    ...
    if (scheduleFilename != null) {
      this.txtScheduleFilename.setText(
            ...
            () -> {
              ...
              SwingUtilities.invokeLater(
                  () -> {
                    this.resultTableModel.setRowCount(0);
                    if (result.isValid()) {
                      this.resultTableModel.addRow(
                          new Object[] {"SUCCESS", "The schedule appears valid"});
                    }
