...
class ConfigEditor extends JDialog {
  ...
  ConfigEditor(JFrame parent, File configFile, ConfigChangeListener configChangeListener) {
    ...
    groupLayout.setHorizontalGroup(
        groupLayout
            ...
            .addComponent(
                scrollPane, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 661, Short.MAX_VALUE));
    ...
    this.loadConfig();
    undoManager
        .discardAllEdits(); // clear history, otherwise the loading of the initial config could be
    // redone.
    ...
    textPane
        ...
        .put(
            KeyStroke.getKeyStroke(
                KeyEvent.VK_Z, IS_MAC ? InputEvent.META_DOWN_MASK : InputEvent.CTRL_DOWN_MASK),
            UNDO_ACTION);
    textPane
        .getInputMap()
        .put(
            KeyStroke.getKeyStroke(
                KeyEvent.VK_Y, IS_MAC ? InputEvent.META_DOWN_MASK : InputEvent.CTRL_DOWN_MASK),
            REDO_ACTION);
  ...
  private void addSaveFunctionality() {
    ...
    this.xmlPane
        ...
        .put(
            KeyStroke.getKeyStroke(
                KeyEvent.VK_S, IS_MAC ? InputEvent.META_DOWN_MASK : InputEvent.CTRL_DOWN_MASK),
            SAVE_ACTION);
  }
  ...
  private void addCloseFunctionality() {
    ...
    this.xmlPane
        ...
        .put(
            KeyStroke.getKeyStroke(
                KeyEvent.VK_W, IS_MAC ? InputEvent.META_DOWN_MASK : InputEvent.CTRL_DOWN_MASK),
            CLOSE_ACTION);
  }
  ...
  /**
   * XmlEditorKit based on
   * https://boplicity.nl/knowledgebase/Java/Xml+syntax+highlighting+in+Swing+JTextPane.html
   *
   * <p>Copyright 2006-2008 Kees de Kooter Licensed under the Apache License, Version 2.0
   */
   ...
   *
   * <p>IMPORTANT NOTE: regex should contain 1 group.
   *
   * <p>Using PlainView here because we don't want line wrapping to occur.
   *
