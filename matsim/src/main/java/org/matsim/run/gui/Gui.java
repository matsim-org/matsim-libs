...
public class Gui extends JFrame {
  ...
  private static final JLabel lblFilepaths =
      new JLabel(
  ...
  private static final JLabel lblYouAreUsingMATSimVersion =
      new JLabel("You are using MATSim version:");
  ...
  private void createLayout() {
    ...
    this.btnEdit.addActionListener(
        e -> {
          if (editor == null) {
    ...
    btnStartMatsim.addActionListener(
        e -> {
          if (exeRunner == null) {
            startMATSim();
          } else {
    ...
    final GroupLayout.SequentialGroup prebuttonsSequentialGroup =
    ...
    final GroupLayout.SequentialGroup postbuttonsSequentialGroup =
        groupLayout.createSequentialGroup();
                ...
                groupLayout
                    ...
                    .addGroup(
                        groupLayout
                            ...
                            // a bunch of stuff that can in principle stretch from left to right
                            // (although most of it won't):
                            .addComponent(
                                tabbedPane, GroupLayout.DEFAULT_SIZE, 729, Short.MAX_VALUE)
    ...
    mntmCreateDefaultConfig.addActionListener(
        e -> {
    ...
    mntmCreateSamplePopulation.addActionListener(
        e -> {
          if (popSampler == null) {
    ...
    mntmTransitValidator.addActionListener(
        e -> {
          ...
          if (!configFilename.isEmpty()) {
            ...
            try {
              ...
              this.transitValidator.loadFromConfig(
                  config, new File(configFilename).getParentFile());
  ...
  private void startMATSim() {
    ...
    new Thread(
            () -> {
              ...
              // see https://jogamp.org/bugzilla/show_bug.cgi?id=1317#c21 and/or
  ...
  //
  //	/**
  //	 * @param str -- name.  These are named so that they can be replaced, and in theory removed.
  // Maybe not necessary. kai, sep'18
  //	 * @param button
  //	 */
