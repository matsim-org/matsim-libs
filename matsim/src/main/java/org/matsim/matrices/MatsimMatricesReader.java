...
/**
 * A reader for matrices-files of MATSim. This reader recognizes the format of the matrices-file and
 * uses the correct reader for the specific version, without manual setting.
 *
 * @author mrieser
 */
public class MatsimMatricesReader extends MatsimXmlParser {

  private static final Logger log = LogManager.getLogger(MatsimMatricesReader.class);
