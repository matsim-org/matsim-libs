...
final class VehicleReaderV2 extends MatsimXmlParser {
  ...
  public void startTag(final String name, final Attributes atts, final Stack<String> context) {
    switch (name) {
      case VehicleSchemaV2Names.VEHICLETYPE:
        this.currentVehType =
            this.builder.createVehicleType(
                Id.create(atts.getValue(VehicleSchemaV2Names.ID), VehicleType.class));
        this.currAttributes = this.currentVehType.getAttributes();
        break;
      case VehicleSchemaV2Names.LENGTH:
        this.currentVehType.setLength(
            Double.parseDouble(atts.getValue(VehicleSchemaV2Names.METER)));
        break;
      ...
      case VehicleSchemaV2Names.MAXIMUMVELOCITY:
        ...
        if (val == 1.0)
          log.warn(
              "The vehicle type's maximum velocity is set to 1.0 meter per second, is this really intended? vehicletype = "
                  + this.currentVehType.getId().toString());
      ...
      case VehicleSchemaV2Names.CAPACITY:
        if (atts.getValue(VehicleSchemaV2Names.SEATS) != null) {
          this.currentVehType
              .getCapacity()
              .setSeats(Integer.valueOf(atts.getValue(VehicleSchemaV2Names.SEATS)));
        }
        if (atts.getValue(VehicleSchemaV2Names.STANDINGROOM) != null) {
          this.currentVehType
              .getCapacity()
              .setStandingRoom(Integer.valueOf(atts.getValue(VehicleSchemaV2Names.STANDINGROOM)));
        }
        if (atts.getValue(VehicleSchemaV2Names.WEIGHT) != null) {
          if (atts.getValue(VehicleSchemaV2Names.WEIGHT).contentEquals("INF")) {
            ...
            this.currentVehType
                .getCapacity()
                .setWeightInTons(Double.parseDouble(atts.getValue(VehicleSchemaV2Names.WEIGHT)));
          }
        }
          ...
          if (atts.getValue(VehicleSchemaV2Names.VOLUME).contentEquals("INF")) {
            ...
            this.currentVehType
                ...
                .setVolumeInCubicMeters(
                    Double.parseDouble(atts.getValue(VehicleSchemaV2Names.VOLUME)));
          }
        }
        if (atts.getValue(VehicleSchemaV2Names.OTHER) != null) {
          this.currentVehType
              .getCapacity()
              .setOther(Double.valueOf(atts.getValue(VehicleSchemaV2Names.OTHER)));
        }
      ...
      case VehicleSchemaV2Names.COSTINFORMATION:
        if (atts.getValue(VehicleSchemaV2Names.FIXEDCOSTSPERDAY) != null) {
          this.currentVehType
              .getCostInformation()
              .setFixedCost(Double.valueOf(atts.getValue(VehicleSchemaV2Names.FIXEDCOSTSPERDAY)));
        }
        if (atts.getValue(VehicleSchemaV2Names.COSTSPERMETER) != null) {
          this.currentVehType
              .getCostInformation()
              .setCostsPerMeter(Double.valueOf(atts.getValue(VehicleSchemaV2Names.COSTSPERMETER)));
        }
        if (atts.getValue(VehicleSchemaV2Names.COSTSPERSECOND) != null) {
          this.currentVehType
              .getCostInformation()
              .setCostsPerSecond(
                  Double.valueOf(atts.getValue(VehicleSchemaV2Names.COSTSPERSECOND)));
        }
      ...
      case VehicleSchemaV2Names.VEHICLE:
        ...
        Id<VehicleType> typeId =
            Id.create(atts.getValue(VehicleSchemaV2Names.TYPE), VehicleType.class);
      ...
      case VehicleSchemaV2Names.PASSENGERCAREQUIVALENTS:
        this.currentVehType.setPcuEquivalents(
            Double.parseDouble(atts.getValue(VehicleSchemaV2Names.PCE)));
        break;
      case VehicleSchemaV2Names.FLOWEFFICIENCYFACTOR:
        this.currentVehType.setFlowEfficiencyFactor(
            Double.parseDouble(atts.getValue(VehicleSchemaV2Names.FACTOR)));
        break;
      case VehicleSchemaV2Names.ATTRIBUTES:
        /* fall-through */
      case VehicleSchemaV2Names.ATTRIBUTE:
