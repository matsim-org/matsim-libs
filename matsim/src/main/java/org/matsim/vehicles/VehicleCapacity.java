...
public final class VehicleCapacity implements Attributable {
  ...
  // --> no, we make them fully settable, "data base in memory".  This has been the matsim design
  // from the beginning, and all attempts to deviate from it
  // always seem to lead to awkward code.  If parallel computing pieces need immutable data
  // structures, they first need to copy them from the in-memory
