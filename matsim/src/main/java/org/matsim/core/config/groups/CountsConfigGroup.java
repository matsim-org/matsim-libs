...
public final class CountsConfigGroup extends ReflectiveConfigGroup {
  ...
  // the following are public so they can be re-used in PtCountsComparisonConfigGroup.  Once that
  // group is moved into the same
  ...
  public static final String COUNTS_DISTANCEFILTER_COMMENT =
      "distance to distanceFilterCenterNode to include counting stations. The unit of distance is "
          + "the Euclidean distance implied by the coordinate system";
  public static final String COUNTS_DISTANCEFILTERCENTERNODE_COMMENT =
  ...
  public static final String COUNTSSCALEFACTOR_COMMENT =
      "factor by which to re-scale the simulated values.  necessary when "
  ...
  public Map<String, String> getComments() {
    ...
    comments.put(
        ...
        "Specifies over how many iterations the link volumes should be averaged that are used for the "
            + "counts comparison. Use 1 or 0 to only use the link volumes of a single iteration. This values cannot be larger than the value specified for "
            + WRITECOUNTSINTERVAL);
    comments.put(
        ANALYZEDMODES,
