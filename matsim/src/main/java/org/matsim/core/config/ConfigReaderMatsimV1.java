...
class ConfigReaderMatsimV1 extends MatsimXmlParser {
  ...
  private static final Logger log = LogManager.getLogger(ConfigReaderMatsimV1.class);
  ...
  public void endTag(final String name, final String content, final Stack<String> context) {
    if (MODULE.equals(name)) {
      ...
      // decide if the user is insisting on it.  However, this clearly does not work in full since
      // the condition
