...
/**
 * config group for experimental parameters. this group and its parameters should not be used
 * outside of vsp.
 *
 * @author dgrether
 * @author nagel
...
public final class VspExperimentalConfigGroup extends ReflectiveConfigGroup {
  ...
  private static final Logger log = LogManager.getLogger(VspExperimentalConfigGroup.class);
  ...
  // ---
  private static final String LOGIT_SCALE_PARAM_FOR_PLANS_REMOVAL =
  ...
  // ---
  private static final String GENERATING_BOARDING_DENIED_EVENT =
      "isGeneratingBoardingDeniedEvent"; // seems to be singular.
  private boolean isGeneratingBoardingDeniedEvent =
      false; // default is that this event is NOT generated.  kai, oct'12
  ...
  // ---
  private static final String ABLE_TO_OVERWRITE_PT_INTERACTION_PARAMS =
      "isAbleToOverwritePtInteractionParams";
  private boolean isAbleToOverwritePtInteractionParams =
      false; // default is that this NOT allowed.  kai, nov'12
  ...
  // ---
  private static final String USING_OPPORTUNITY_COST_OF_TIME_FOR_LOCATION_CHOICE =
  ...
  public void setUsingOpportunityCostOfTimeForLocationChoice(
      boolean isUsingOpportunityCostOfTimeForLocationChoice) {
    testForLocked();
    this.isUsingOpportunityCostOfTimeForLocationChoice =
        isUsingOpportunityCostOfTimeForLocationChoice;
  }

  // ---
  public enum CheckingOfMarginalUtilityOfTravellng {
    allZero,
    none
  };

  private CheckingOfMarginalUtilityOfTravellng checkingOfMarginalUtilityOfTravellng =
      CheckingOfMarginalUtilityOfTravellng.allZero;
  ...
  public void setCheckingOfMarginalUtilityOfTravellng(
  ...
  public Map<String, String> getComments() {
    ...
    map.put(
        ABLE_TO_OVERWRITE_PT_INTERACTION_PARAMS,
        "(do not use except of you have to) There was a problem with pt interaction scoring.  Some people solved it by overwriting the "
    ...
    map.put(
        ...
        "if an approximation of the opportunity cost of time is included into the radius calculation for location choice."
