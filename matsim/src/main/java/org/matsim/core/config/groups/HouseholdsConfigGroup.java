...
public final class HouseholdsConfigGroup extends ReflectiveConfigGroup {
  ...
  public static final String HOUSEHOLD_ATTRIBUTES_DEPRECATION_MESSAGE =
      "using the separate households attribute file is deprecated.  Add the information directly into each household, using "
