...
public final class GlobalConfigGroup extends ReflectiveConfigGroup {
  ...
  //	private static final String RELATIVE_POSITION_ON_LINK_CMT="where along the link the vehicle
  // entry/exit is located.  Depends on the mobsim!"
  ...
  // ---
  @PositiveOrZero private int numberOfThreads = 2;
  private static final String NUMBER_OF_THREADS = "numberOfThreads";
  private static final String NUMBER_OF_THREADS_CMT =
  ...
  private static final String DEFAULT_DELIMITER_CMT =
      "Default Delimiter for CSV files. May not be recognized by all writers.";
  @NotBlank private String defaultDelimiter = ";";
  ...
  public void setNumberOfThreads(final int numberOfThreads) {
    log.info(
        "setting number of threads to: "
            + numberOfThreads); // might not be so bad to do this everywhere?  benjamin/kai, oct'10
  ...
  private static final String INSITING_ON_DEPRECATED_CONFIG_VERSION =
