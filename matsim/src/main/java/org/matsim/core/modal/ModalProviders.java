...
public class ModalProviders {
  public static <M extends Annotation, T> Provider<T> createProvider(
      String mode,
      ModalAnnotationCreator<M> modalAnnotationCreator,
      Function<InstanceGetter<M>, T> delegate) {
    return new Provider<>() {
  ...
  public static final class InstanceGetter<M extends Annotation> {
    ...
    private InstanceGetter(
        String mode, ModalAnnotationCreator<M> modalAnnotationCreator, Injector injector) {
      this.mode = mode;
  ...
  public abstract static class AbstractProvider<M extends Annotation, T> implements Provider<T> {
    private final String mode;
    private final ModalAnnotationCreator<M> modalAnnotationCreator;
