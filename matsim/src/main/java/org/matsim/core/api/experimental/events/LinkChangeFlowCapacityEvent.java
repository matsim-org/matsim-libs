/* *********************************************************************** *
 * project: org.matsim.*
 * LinkChangeFlowCapacityEventImpl.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
...
public class LinkChangeFlowCapacityEvent extends Event {

	public static final String EVENT_TYPE = "linkChangeFlowCapacity";
	...
	public LinkChangeFlowCapacityEvent(double time, Id linkId, ChangeValue changeValue) {
		super(time);
		this.linkId = linkId;
