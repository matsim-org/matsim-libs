...
/**
 * @author mrieser
 *     <p>Should be replaced by some more generic VehicleArrivalEvent which supports both links and
 *     facilities.
 */
public final class VehicleArrivesAtFacilityEvent extends Event {
  ...
  public VehicleArrivesAtFacilityEvent(
      final double time,
      final Id<Vehicle> vehicleId,
      final Id<TransitStopFacility> facilityId,
      double delay) {
    super(time);
