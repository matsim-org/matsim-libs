...
public class AgentArrivalEvent extends Event implements HasPersonId {
	...
	public AgentArrivalEvent(final double time, final Id agentId, final Id linkId, final String legMode) {
		super(time);
		this.linkId = linkId;
