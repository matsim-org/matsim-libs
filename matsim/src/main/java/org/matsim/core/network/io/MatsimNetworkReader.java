...
/**
 * A reader for network-files of MATSim. This reader recognizes the format of the network-file and
 * uses the correct reader for the specific network-version, without manual setting.
 *
 * @author mrieser
 */
public final class MatsimNetworkReader extends MatsimXmlParser {

  private static final Logger log = LogManager.getLogger(MatsimNetworkReader.class);
   ...
   *
   * @param targetCRS the string representation of the CRS the coordinates should be transformed to
   *     (usually an EPSG code)
   * @param network The network where to store the loaded data.
   */
