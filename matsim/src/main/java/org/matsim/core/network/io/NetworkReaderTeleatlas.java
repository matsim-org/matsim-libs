...
/**
 * A reader for TeleAtlas network description files. The reader is based on <strong>Tele Atlas
 * MultiNet Shapefile 4.3.2.1 Format Specifications document version Final v1.0, June 2007</strong>
...
public final class NetworkReaderTeleatlas implements MatsimSomeReader {
  ...
  private static final Logger log = LogManager.getLogger(NetworkReaderTeleatlas.class);
   ...
   *
   * <p><code>{@link #LINK_FRCTYP_NAME} == 8</code>
   *
   ...
   * option flag: if set, the reader ignores all network links with
   *
   * <p><code>{@link #LINK_FRCTYP_NAME} == 8 && {@link #LINK_ONEWAY_NAME} == "N"</code>
   *
   * <p><b>Default:</b> <code>false</code>
   */
  ...
  /**
   * option parameter: the reader redefines the number of lanes (see permlanes in {@link Link}) if
   * the value of <code>{@link #LINK_LANES_NAME}<1</code>. In that case the link gets 2 lanes for
   * <code>{@link #LINK_FRCTYP_NAME}</code> less or equal this parameter, 1 lane otherwise.
   *
   * <p><b>Default:</b> <code>3</code>
   */
   ...
   * Therefore, link flow capacities must be derived from the given data. Below the given parameter
   * the link gets capacity = 1000 [veh/h] per lane assigned, 2000 [veh/h] otherwise.
   *
   * <p><b>Default:</b> <code>40</code>(km/h)
   */
  ...
  /**
   * Instantiate a new Tele Atlas MultiNet Shapefile reader based on the junction and the network
   * shape file.
   *
   ...
   */
  public NetworkReaderTeleatlas(
      final Network network, final String jcShpFileName, final String nwShpFileName) {
   ...
   *
   * <ul>
   *   <li>center coordinate
   *   <li><code>{@link #NODE_ID_NAME} (Feature Identification)</code>
   *   <li><code>{@link #NODE_FEATTYP_NAME} (Feature Type)</code>
   *       <ul>
   *         <li><code>4120: Junction</code>
   *         <li><code>4220: Railway Element Junction</code>
   *       </ul>
   *   <li><code>{@link #NODE_JNCTTYP_NAME} (Junction Type)</code>
   *       <ul>
   *         <li><code>0: Junction (default)</code>
   *         <li><code>2: Bifurcation</code>
   *         <li><code>3: Railway Crossing</code>
   *         <li><code>4: Country Border Crossing</code>
   *         <li><code>5: Ferry Operated by Train Crossing</code>
   *         <li><code>6: Internal Data Set Border Crossing</code>
   *       </ul>
   * </ul>
   *
    ...
    while (fIt.hasNext()) {
      ...
      if ((feattyp != 4120) && (feattyp != 4220)) {
        throw new IllegalArgumentException(
            NODE_ID_NAME + "=" + id + ": " + NODE_FEATTYP_NAME + "=" + feattyp + " not allowed.");
      }
      int jncttyp = Integer.parseInt(f.getAttribute(NODE_JNCTTYP_NAME).toString());
      if ((jncttyp < 0) || (jncttyp == 1) || (jncttyp > 6)) {
        throw new IllegalArgumentException(
            NODE_ID_NAME + "=" + id + ": " + NODE_JNCTTYP_NAME + "=" + jncttyp + " not allowed.");
      }
      if (id == null) {
        throw new IllegalArgumentException(
            "In "
   ...
   *
   * <ul>
   *   <li><code>{@link #LINK_ID_NAME} (Feature Identification)</code>
   *   <li><code>{@link #LINK_FEATTYP_NAME} (Feature Type)</code>
   *       <ul>
   *         <li><code>4110: Road Element</code>
   *         <li><code>4130: Ferry Connection Element</code>
   *         <li><code>4165: Address Area Boundary Element</code>
   *       </ul>
   *   <li><code>{@link #LINK_FERRYTYP_NAME} (Ferry Type)</code>
   *       <ul>
   *         <li><code>0: No Ferry (default)</code>
   *         <li><code>1: Ferry Operated by Ship or Hovercraft</code>
   *         <li><code>2: Ferry Operated by Train</code>
   *       </ul>
   *   <li><code>{@link #LINK_FJNCTID_NAME} (From (Start) Junction Identification)</code>
   *   <li><code>{@link #LINK_TJNCTID_NAME} (To (End) Junction Identification)</code>
   *   <li><code>{@link #LINK_LENGTH_NAME} (Feature Length (meters))</code>
   *   <li><code>{@link #LINK_FRCTYP_NAME} (Functional Road Class)</code>
   *   <li><code>{@link #LINK_FERRYTYP_NAME} (Ferry Type)</code>
   *       <ul>
   *         <li><code>-1: Not Applicable (for {@link #LINK_FEATTYP_NAME} 4165)</code>
   *         <li><code>0: Motorway, Freeway, or Other Major Road</code>
   *         <li><code>1: a Major Road Less Important than a Motorway</code>
   *         <li><code>2: Other Major Road</code>
   *         <li><code>3: Secondary Road</code>
   *         <li><code>4: Local Connecting Road</code>
   *         <li><code>5: Local Road of High Importance</code>
   *         <li><code>6: Local Road</code>
   *         <li><code>7: Local Road of Minor Importance</code>
   *         <li><code>8: Other Road</code>
   *       </ul>
   *   <li><code>{@link #LINK_ONEWAY_NAME} (Direction of Traffic Flow)</code>
   *       <ul>
   *         <li><code>Blank: Open in Both Directions (default)</code>
   *         <li><code>FT: Open in Positive Direction</code>
   *         <li><code>N: Closed in Both Directions</code>
   *         <li><code>TF: Open in Negative Direction</code>
   *       </ul>
   *   <li><code>{@link #LINK_SPEED_NAME} (Calculated Average Speed (kilometers per hour))</code>
   *   <li><code>{@link #LINK_LANES_NAME} (Number of Lanes)</code>
   * </ul>
   *
   * <b>Conversion rules:</b>
   *
   * <ul>
   *   <li>Links that refer to not existing from- or to-link will be ignored (produces a wanring
   *       message)
   *   <li>Links with {@link #LINK_FEATTYP_NAME} not equal to 4110 or 4130 will be ignored
   *   <li>Links with {@link #LINK_FRCTYP_NAME} less than zero will be ignored
   *   <li>Links with {@link #LINK_FRCTYP_NAME} equals 8 will be ignored if {@link #ignoreFrcType8}
   *       flag is set
   *   <li>Links with {@link #LINK_FRCTYP_NAME} equals 7 and {@link #LINK_ONEWAY_NAME} equals "N"
   *       will be ignored if {@link #ignoreFrcType7onewayN} is set
   *   <li>Links with {@link #LINK_LANES_NAME} less than 1 will get lanes according to the rule
   *       defined by {@link #maxFrcTypeForDoubleLaneLink}
   *   <li>Links get capacities according to the rule defined by {@link #minSpeedForNormalCapacity}
   *   <li>Directed links in the MATSim network DB will be created according to the information in
   *       {@link #LINK_ONEWAY_NAME} (two links if " " or "N", one link for "TF" or "FT"). The link
   *       id is defined as <code>{@link #LINK_ID_NAME}+"TF"</code>, <code>
   *       {@link #LINK_ID_NAME}+"FT"</code> resp.
  ...
  private void readLinksFromNWshp() throws IOException {
    ...
    while (fIt.hasNext()) {
      ...
      if ((featTyp != 4110) && (featTyp != 4130) && (featTyp != 4165)) {
        throw new IllegalArgumentException(
            LINK_ID_NAME + "=" + id + ": " + LINK_FEATTYP_NAME + "=" + featTyp + " not allowed.");
      }
      ...
      if ((linksType < -1) || (linksType > 8)) {
        throw new IllegalArgumentException(
            LINK_ID_NAME + "=" + id + ": " + LINK_FRCTYP_NAME + "=" + linksType + " not allowed.");
      }
      ...
      if (!oneway.equals(" ")
          ...
          && !oneway.equals("N")) {
        throw new IllegalArgumentException(
            LINK_ID_NAME + "=" + id + ": " + LINK_ONEWAY_NAME + "=" + oneway + " not allowed.");
      }
      ...
      if ((featTyp != 4110) && (featTyp != 4130)) {
        log.trace(
            "  linkId=" + id.toString() + ": ignoring " + LINK_FEATTYP_NAME + "=" + featTyp + ".");
        ignore = true;
      }
      // ignore links FRC types = -1 [Not Applicable (for FeatTyp 4165)]
      if (linksType < 0) {
        log.trace(
            "  linkId=" + id.toString() + ": ignoring " + LINK_FRCTYP_NAME + "=" + linksType + ".");
        ignore = true;
      }
      ...
      // ignore links FRC types = 7 [Local Road of Minor Importance] that are ONEWAY = N [Closed in
      // Both Directions]
      ...
      if (ignore) {
        ...
        if (oneway.equals(" ") || oneway.equals("N")) {
          Link l =
              network
                  .getFactory()
                  .createLink(Id.create(id.toString() + "FT", Link.class), fNode, tNode);
          l.setLength(length);
          ...
          l =
              network
                  .getFactory()
                  .createLink(Id.create(id.toString() + "TF", Link.class), tNode, fNode);
          l.setLength(length);
          l.setFreespeed(speed / 3.6);
          l.setCapacity(cap);
          l.setNumberOfLanes(lanes);
          ...
          Link l =
              network
                  .getFactory()
                  .createLink(Id.create(id.toString() + oneway, Link.class), fNode, tNode);
          l.setLength(length);
          l.setFreespeed(speed / 3.6);
          l.setCapacity(cap);
          l.setNumberOfLanes(lanes);
          ...
          Link l =
              network
                  .getFactory()
                  .createLink(Id.create(id.toString() + oneway, Link.class), tNode, fNode);
          l.setLength(length);
          l.setFreespeed(speed / 3.6);
          l.setCapacity(cap);
          l.setNumberOfLanes(lanes);
          ...
          throw new IllegalArgumentException(
              "linkId=" + id.toString() + ": " + LINK_ONEWAY_NAME + "=" + oneway + " not known!");
        }
      }
    }
    fIt.close();
