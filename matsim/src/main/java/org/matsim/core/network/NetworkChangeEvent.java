...
/**
 * A container class for events that represent time-variant changes for link attributes (in SI
 * units).
 *
 * @author illenberger
 */
public final class NetworkChangeEvent {
  ...
  /**
   * @return the flow capacity changes or <tt>null</tt> if flow capacity should not be changed.
   */
  ...
  /**
   * @param flowCapacityChange the flow capacity changes in veh/s (!!), i.e. the unit which LinkImpl
   *     wants, not the unit in network.xml
   */
  ...
  /**
   * @return the free-speed changes or <tt>null</tt> if free-speed should not be changed.
   */
  ...
  /**
   * @return the lanes changes or <tt>null</tt> if the number of lanes should not be changed.
   */
  ...
  public static class StartTimeComparator
      implements Comparator<NetworkChangeEvent>, Serializable, MatsimComparator {
  ...
  public boolean equals(Object o) {
    ...
    if (flowCapacityChange != null
        ? !flowCapacityChange.equals(that.flowCapacityChange)
        : that.flowCapacityChange != null) return false;
    if (freespeedChange != null
        ? !freespeedChange.equals(that.freespeedChange)
        : that.freespeedChange != null) return false;
