...
/**
 * Add several filter instances to this class and create a new network containing only the links and
 * nodes that passed the filters.
 *
 * <p>Note that the Network instance created is connected, i.e. in- and outlink references are set
...
public final class NetworkFilterManager {
  ...
  public Network applyFilters() {
    log.info(
        "applying filters to network with "
