...
/**
 * A container class for clusters. Activity locations are grouped into clusters, each believed to
 * represent a significant point of activity. Each cluster has a unique identity; contains a list of
 * points, each associated with an activity; and has a centre of gravity.
 *
 * @author jwjoubert
 */
    ...
    if (this.concaveHull == null) {
      if (activities.size() > 0) {
        ...
        throw new IllegalArgumentException(
            "Not enough points in cluster " + clusterId + " to calculate a center of gravity!");
      }
    } else {
