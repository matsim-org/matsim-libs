...
/**
 * Example to illustrate how the density-based algorithm is used to simplify a network's
 * intersections.
 *
 * @author jwjoubert
 */
public class RunIntersectionSimplifier {
  private static final Logger LOG = LogManager.getLogger(RunIntersectionSimplifier.class);
