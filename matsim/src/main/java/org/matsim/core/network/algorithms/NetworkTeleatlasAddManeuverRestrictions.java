...
/**
 * Adds maneuver restrictions to a MATSim {@link Network network} created by {@link
 * NetworkReaderTeleatlas}. The input maneuver shape file and the maneuver path DBF file is based on
 * <strong>Tele Atlas MultiNet Shapefile 4.3.2.1 Format Specifications document version Final v1.0,
 * June 2007</strong>.
 *
 * @author balmermi
 */
public final class NetworkTeleatlasAddManeuverRestrictions implements NetworkRunnable {
  ...
  private static final Logger log =
      LogManager.getLogger(NetworkTeleatlasAddManeuverRestrictions.class);
   ...
   * will not include new virtual {@link Link links} providing a u-turn maneuver at the junction.
   */
   ...
   *
   * <p><b>Default:</b> <code>0.000030</code> (appropriate for world coordinate system WGS84)
   *
  ...
  /**
   * option parameter: defines the offset of a in- and out-link pair of an expanded {@link Node
   * node}.
   *
   * <p><b>Default:</b> <code>0.000005</code> (appropriate for world coordinate system WGS84)
   *
   * @see NetworkExpandNode
   */
   ...
   */
  public NetworkTeleatlasAddManeuverRestrictions(
      final String mnShpFileName, final String mpDbfFileName) {
  ...
  /**
   * Reading and assigning (expanding {@link Node nodes}) maneuver restrictions to the {@link
   * Network network}.
   *
   * <p>It uses the following attributes from the Tele Atlas MultiNet maneuver Shape file:
   *
   * <ul>
   *   <li>{@link #MN_ID_NAME} (Feature Identification)
   *   <li>{@link #MN_FEATTYP_NAME} (Feature Type)
   *       <ul>
   *         <li>9401: Bifurcation
   *         <li>2104: Priority Maneuver
   *         <li>2103: Prohibited Maneuver
   *         <li>2102: Restricted Maneuver
   *         <li>2101: Calculated/Derived Prohibited Maneuver
   *       </ul>
   *   <li>{@link #MN_JNCTID_NAME} (Junction Identification of the Location of the Maneuver Sign)
   * </ul>
   *
   * <p>And it uses the following attributes from the Tele Atlas MultiNet maneuver path DBF file:
   *
   * <ul>
   *   <li>{@link #MP_ID_NAME} (Feature Identification)
   *   <li>{@link #MP_SEQNR_NAME} (Transportation Element Sequential Number within the Maneuver)
   *   <li>{@link #MP_TRPELID_NAME} (Transportation Element Identification)
   * </ul>
   *
   * <p><b>Conversion rules:</b>
   *
   * <ul>
   *   <li>The maneuver types 'Bifurcation' (9401) and 'Priority Maneuver' (2104) are ignored
   *   <li>Maneuver restriction sequences that contain links that are not incident to the given
   *       junction are ignored
   *   <li>Maneuver restrictions will be modelled in the natwork topology by expanding {@link Node
   *       nodes} with {@link NetworkExpandNode node expanding procedure}.
   * </ul>
   *
