...
public class EventWriterTXT
  ...
  /**
   * Returns the passed time as Seconds, including a trailing tab-character. Internally caches the
   * returned result to speed up writing many events with the same time. This may no longer be
   * useful if times are switched to double.
   *
   * @param time
   * @return
   */
  ...
  public void handleEvent(ActivityEndEvent event) {
    writeLine(
        ...
        event.getPersonId(),
        event.getLinkId(),
        Number.ActivityEnd.ordinal(),
        ActivityEndEvent.EVENT_TYPE + " " + event.getActType());
  }
  ...
  public void handleEvent(ActivityStartEvent event) {
    writeLine(
        ...
        event.getPersonId(),
        event.getLinkId(),
        Number.ActivityStart.ordinal(),
        ActivityStartEvent.EVENT_TYPE + " " + event.getActType());
  }
  ...
  public void handleEvent(PersonDepartureEvent event) {
    writeLine(
        ...
        event.getPersonId(),
        event.getLinkId(),
        Number.PersonDeparture.ordinal(),
  ...
  public void handleEvent(PersonStuckEvent event) {
    writeLine(
        ...
        event.getPersonId(),
        event.getLinkId(),
        Number.PersonStuck.ordinal(),
        PersonStuckEvent.EVENT_TYPE);
  }
  ...
  public void handleEvent(PersonMoneyEvent event) {
    writeLine(
        ...
        event.getPersonId(),
        null,
        Number.PersonMoney.ordinal(),
        "agentMoney" + "\t" + event.getAmount());
  }
  ...
  public void handleEvent(VehicleEntersTrafficEvent event) {
    writeLine(
        ...
        event.getPersonId(),
        event.getLinkId(),
        Number.VehicleEntersTraffic.ordinal(),
  ...
  public void handleEvent(LinkEnterEvent event) {
    writeLine(
        event.getTime(),
        vehicleToDriverMap.get(event.getVehicleId()),
        event.getLinkId(),
        Number.LinkEnter.ordinal(),
