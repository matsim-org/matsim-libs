...
/**
 * ParallelEvents allows parallelization for events handling. Usage: First create an object of this
 * class. Before each iteration, call initProcessing. After each iteration, call finishProcessing.
 * This has already been incorporated into the Controller.
 *
 * <p>Usage via config.xml:
 *
 * <pre>
...
public final class ParallelEventsManagerImpl implements EventsManager {
  ...
  private static final Logger log = LogManager.getLogger(ParallelEventsManagerImpl.class);
   ...
   * @param estimatedNumberOfEvents Only use this constructor for larger simulations (20M+ events).
   */
