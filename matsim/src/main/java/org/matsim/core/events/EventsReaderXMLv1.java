    ...
    if (LinkLeaveEvent.EVENT_TYPE.equals(eventType)) {
      ...
      this.events.processEvent(
          new VehicleLeavesTrafficEvent(
              ...
              atts.getValue(VehicleLeavesTrafficEvent.ATTRIBUTE_VEHICLE) == null
                  ? null
                  : Id.create(
                      atts.getValue(VehicleLeavesTrafficEvent.ATTRIBUTE_VEHICLE), Vehicle.class),
    ...
    // === material related to wait2link above here
      ...
      this.events.processEvent(
          new ActivityEndEvent(
              ...
              atts.getValue(HasFacilityId.ATTRIBUTE_FACILITY) == null
                  ? null
                  : Id.create(
                      atts.getValue(HasFacilityId.ATTRIBUTE_FACILITY), ActivityFacility.class),
      ...
      this.events.processEvent(
          new PersonArrivalEvent(
              ...
              Id.create(atts.getValue(PersonArrivalEvent.ATTRIBUTE_LINK), Link.class),
              mode));
      ...
      this.events.processEvent(
          new PersonDepartureEvent(
              ...
              Id.create(atts.getValue(PersonDepartureEvent.ATTRIBUTE_LINK), Link.class),
              canonicalLegMode,
      ...
      this.events.processEvent(
          new PersonStuckEvent(
              time,
              Id.create(atts.getValue(PersonStuckEvent.ATTRIBUTE_PERSON), Person.class),
              linkId,
              mode));
      ...
      this.events.processEvent(
          new VehicleAbortsEvent(
              time,
              Id.create(atts.getValue(VehicleAbortsEvent.ATTRIBUTE_VEHICLE), Vehicle.class),
              linkId));
      ...
      this.events.processEvent(
          new PersonEntersVehicleEvent(
              time,
              Id.create(personString, Person.class),
              Id.create(vehicleString, Vehicle.class)));
    } else if (PersonLeavesVehicleEvent.EVENT_TYPE.equals(eventType)) {
      Id<Person> pId =
          Id.create(atts.getValue(PersonLeavesVehicleEvent.ATTRIBUTE_PERSON), Person.class);
      Id<Vehicle> vId =
          Id.create(atts.getValue(PersonLeavesVehicleEvent.ATTRIBUTE_VEHICLE), Vehicle.class);
      ...
      this.events.processEvent(
          new VehicleArrivesAtFacilityEvent(
              time,
              Id.create(
                  atts.getValue(VehicleArrivesAtFacilityEvent.ATTRIBUTE_VEHICLE), Vehicle.class),
              Id.create(
                  atts.getValue(VehicleArrivesAtFacilityEvent.ATTRIBUTE_FACILITY),
      ...
      this.events.processEvent(
          new TransitDriverStartsEvent(
              ...
              Id.create(
                  atts.getValue(TransitDriverStartsEvent.ATTRIBUTE_VEHICLE_ID), Vehicle.class),
              Id.create(
                  atts.getValue(TransitDriverStartsEvent.ATTRIBUTE_TRANSIT_LINE_ID),
                  TransitLine.class),
              Id.create(
                  atts.getValue(TransitDriverStartsEvent.ATTRIBUTE_TRANSIT_ROUTE_ID),
                  TransitRoute.class),
              Id.create(
                  atts.getValue(TransitDriverStartsEvent.ATTRIBUTE_DEPARTURE_ID),
                  Departure.class)));
    } else if (BoardingDeniedEvent.EVENT_TYPE.equals(eventType)) {
      Id<Person> personId =
          Id.create(atts.getValue(BoardingDeniedEvent.ATTRIBUTE_PERSON_ID), Person.class);
      Id<Vehicle> vehicleId =
          Id.create(atts.getValue(BoardingDeniedEvent.ATTRIBUTE_VEHICLE_ID), Vehicle.class);
      ...
      Id<Person> agentId =
          Id.create(atts.getValue(AgentWaitingForPtEvent.ATTRIBUTE_AGENT), Person.class);
      Id<TransitStopFacility> waitStopId =
          Id.create(
              atts.getValue(AgentWaitingForPtEvent.ATTRIBUTE_WAITSTOP), TransitStopFacility.class);
      Id<TransitStopFacility> destinationStopId =
          Id.create(
              atts.getValue(AgentWaitingForPtEvent.ATTRIBUTE_DESTINATIONSTOP),
              TransitStopFacility.class);
      this.events.processEvent(
