 ...
 * presence of any Unicode BOM (Byte Order Mark) at its beginning, as defined by <a
 * href="http://www.faqs.org/rfcs/rfc3629.html">RFC 3629 - UTF-8, a transformation format of ISO
 * 10646</a>
 *
 * <p>The <a href="http://www.unicode.org/unicode/faq/utf_bom.html">Unicode FAQ</a> defines 5 types
 * of BOMs:
 *
 * <ul>
 *   <li>
 ...
 * </ul>
 *
 * <p>Use the {@link #getBOM()} method to know whether a BOM has been detected or not.
 */
public class UnicodeInputStream extends InputStream {
  ...
  /**
   * Wraps the existing inputStream and tries to detect if it contains a Byte Order Mark (BOM). If
   * it does, the BOM is skipped by default.
   *
   * @param inputStream
  ...
  public UnicodeInputStream(final InputStream inputStream, final boolean skipBom)
      throws NullPointerException, IOException {
    if (inputStream == null) {
  ...
  public static final class BOM {
    ...
    public static final BOM UTF_16_LE =
        new BOM(new byte[] {(byte) 0xFF, (byte) 0xFE}, "UTF-16 little-endian");
    public static final BOM UTF_16_BE =
        new BOM(new byte[] {(byte) 0xFE, (byte) 0xFF}, "UTF-16 big-endian");
