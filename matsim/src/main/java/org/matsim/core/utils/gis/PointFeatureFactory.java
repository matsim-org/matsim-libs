...
public class PointFeatureFactory {
  ...
  public SimpleFeature createPoint(
      final Coordinate coordinate, final Map<String, Object> attributeValues, final String id) {
  ...
  public SimpleFeature createPoint(
      final Coordinate coordinate, final Object[] attributeValues, final String id) {
    Point p = this.fac.createPoint(coordinate);
    return this.createPoint(p, attributeValues, id);
  }

  public SimpleFeature createPoint(
      final Point point, final Object[] attributeValues, final String id) {
  ...
  public SimpleFeature createPoint(
      final Coord coordinate, final Object[] attributeValues, final String id) {
