...
/**
 * This is a helper class which makes it possible to track time along a plan while taking into
 * account the system configuration with respect to leg and activity end time calculation.
 *
 * @author sebhoerl
 */
