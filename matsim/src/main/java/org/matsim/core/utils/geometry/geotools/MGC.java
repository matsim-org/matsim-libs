...
public class MGC {
  ...
  private static final Logger log = LogManager.getLogger(MGC.class);

  public static final GeometryFactory geoFac = new GeometryFactory();

  private static final Map<String, String> COORDINATE_REFERENCE_SYSTEMS = new HashMap<>();

  static {
    COORDINATE_REFERENCE_SYSTEMS.put(TransformationFactory.WGS84, "EPSG:4326");
    COORDINATE_REFERENCE_SYSTEMS.put(
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.WGS84_UTM35S, // south-africa
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.WGS84_UTM36S, // South Africa (eThekwini)
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.WGS84_UTM33N, // berlin
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.DHDN_GK4, // Berlin
        "EPSG:31468");
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.WGS84_UTM29N, // Coimbra, Portugal
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.WGS84_UTM31N, // Barcelona, Spain
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.CH1903_LV03_Plus_GT,
        "PROJCS[\"Hotine_Oblique_Mercator_Azimuth_Center\",GEOGCS[\"Bessel"
            + "1841\",DATUM[\"D_unknown\",SPHEROID[\"bessel\",6377397.155,299.1528128]]"
            + ",PRIMEM[\"Greenwich\",0],UNIT[\"Degree\",0.017453292519943295]],PROJECTION["
            + "\"Hotine_Oblique_Mercator_Azimuth_Center\"],PARAMETER[\"latitude_of_center\",46.95240555555556]"
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.WGS84_Albers, // South Africa (Africa Albers equal area conic)
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory
            .WGS84_SA_Albers, // South Africa (Adapted version of Africa Albers equal area conic)
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory
            .HARTEBEESTHOEK94_LO19, // South Africa adaption of Transverse Mercator - 17 degrees
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory
            .HARTEBEESTHOEK94_LO25, // South Africa adaption of Transverse Mercator - 25 degrees
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory
            .HARTEBEESTHOEK94_LO29, // South Africa adaption of Transverse Mercator - 29 degrees
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory
            .HARTEBEESTHOEK94_LO31, // South Africa adaption of Transverse Mercator - 31 degrees
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.WGS84_UTM48N, // Singapore
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.WGS84_SVY21, // Singapore2
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.NAD83_UTM17N, // Toronto, Canada - UTM_NAD1983_Zone17N
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.WGS84_TM, // Singapore3
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory
            .PCS_ITRF2000_TM_UOS, // South Korea - but used by University of Seoul - probably a
        // wrong one. !NEW!: Replaced by the correct one! TODO: probably
        // needs to be renamed but since UOS use that already let's keep
        // it.
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.DHDN_SoldnerBerlin, // Berlin
    ...
    COORDINATE_REFERENCE_SYSTEMS.put(
        TransformationFactory.KROVAK, // Krovak EPSG5514
  ...
  /**
   * Generates a Geotools <code>CoordinateReferenceSystem</code> from a coordinate system <code>
   * String</code>. The coordinate system can either be specified as shortened names, as defined in
   * {@link TransformationFactory}, as EPSG Code or as Well-Known-Text (WKT) as supported by the
   * GeoTools.
   *
  ...
  public static CoordinateReferenceSystem getCRS(final String wktOrAuthorityCodeOrShorthandName) {
    ...
    try {
      ...
      try {
        log.warn(
            "Assuming that coordinates are in longitude first notation, i.e. (longitude, latitude).");
  ...
  /**
   * Guesses the Universal Transverse Mercator (UTM) zone for a given WGS 84 coordinate, returns the
