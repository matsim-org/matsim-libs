...
public final class ClassUtils {
  ...
  /**
   * Returns all classes and implemented interfaces of the given class. For each of the returned
   * classes, an according call to <code>instanceof</code> would also return <code>true</code>.
   *
   * @param klass
