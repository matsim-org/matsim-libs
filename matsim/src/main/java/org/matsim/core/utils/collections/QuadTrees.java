...
public class QuadTrees {
  ...
  public static <E> QuadTree<E> createQuadTree(
      Collection<E> elements, Function<E, Coord> coordFunction, double buffer) {
    ...
    QuadTree<E> quadTree =
        new QuadTree<E>(minX - buffer, minY - buffer, maxX + buffer, maxY + buffer);
    for (E stop : elements) {
