...
public class PolylineFeatureFactory {
  ...
  public SimpleFeature createPolyline(
  ...
  public SimpleFeature createPolyline(
      final LineString lineString, final Object[] attributeValues, final String id) {
  ...
  public SimpleFeature createPolyline(
      final MultiLineString multiLineString, final Object[] attributeValues, final String id) {
