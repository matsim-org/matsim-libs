 ...
 * PlanAlgorithm into a {@link PlanStrategyModule} so it can be used for plans replanning. Supports
 * multiple threads.
 *
 * @author mrieser
...
class TimeAllocationMutatorModule extends AbstractMultithreadedModule {
  ...
  TimeAllocationMutatorModule(
      TimeAllocationMutatorConfigGroup timeAllocationMutatorConfigGroup,
  ...
  public PlanAlgorithm getPlanAlgoInstance() {
    PlanAlgorithm pmta =
        new MutateActivityTimeAllocation(
            this.mutationRange,
            this.affectingDuration,
            MatsimRandom.getLocalInstance(),
            timeAllocationMutatorConfigGroup.getLatestActivityEndTime(),
            timeAllocationMutatorConfigGroup.isMutateAroundInitialEndTimeOnly(),
