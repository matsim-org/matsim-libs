...
public class KeepSelected<T extends BasicPlan, I> implements PlanSelector<T, I> {
   ...
   *
   * <p>One must be careful when using it, since the last executed plan might not be selected since
   * it might have been removed at the start of the new iteration (because of the maxnumberofplans
   * limit). balac aug '17
   */
  @Override
