...
public class WeightedStrategyChooser<
        PL extends BasicPlan, AG extends HasPlansAndId<? extends BasicPlan, AG>>
    implements StrategyChooser<PL, AG> {

  @Override
  public GenericPlanStrategy<PL, AG> chooseStrategy(
      HasPlansAndId<PL, AG> person,
      String subpopulation,
      ReplanningContext replanningContext,
      StrategyChooser.Weights<PL, AG> weights) {
