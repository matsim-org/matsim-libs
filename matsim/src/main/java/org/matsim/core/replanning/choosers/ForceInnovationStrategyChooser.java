...
/**
 * This chooser forces to select an innovative strategy every X iteration for every X person in the
 * population.
 */
public class ForceInnovationStrategyChooser<
   ...
   * @param permute Permute which agents are selected at which iteration. This requires a
   *     sufficiently large number of agents (> 10.000) or the amount of agents forced to innovate
   *     each iteration may deviate from the mean.
   */
