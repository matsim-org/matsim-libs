...
public class PlanInheritanceRecordWriter {
  ...
  public PlanInheritanceRecordWriter(String filename) {
    ...
    header.append(DELIMITER);
    header.append(ANCESTOR_ID);
    header.append(DELIMITER);
    header.append(MUTATED_BY);
    header.append(DELIMITER);
    header.append(ITERATION_CREATED);
    header.append(DELIMITER);
    header.append(ITERATION_REMOVED);
    header.append(DELIMITER);
  ...
  public void write(PlanInheritanceRecord planInheritanceRecord) {
    ...
    line.append(planInheritanceRecord.getAgentId());
    line.append(DELIMITER);
    line.append(planInheritanceRecord.getPlanId());
    line.append(DELIMITER);
    line.append(planInheritanceRecord.getAncestorId());
    line.append(DELIMITER);
    line.append(planInheritanceRecord.getMutatedBy());
    line.append(DELIMITER);
    line.append(planInheritanceRecord.getIterationCreated());
    line.append(DELIMITER);
    line.append(planInheritanceRecord.getIterationRemoved());
    line.append(DELIMITER);
