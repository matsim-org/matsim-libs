...
public class RandomPlanSelector<T extends BasicPlan, I> implements PlanSelector<T, I> {
  ...
  public T selectPlan(final HasPlansAndId<T, I> person) {
    // this used to use person.getRandomPlan(), but I inlined the function here in order to get rid
    // of the function of the data class.
    // kai, nov'13
    ...
    // yyyy As far as I can tell, this produces race conditions when running multi-threaded.  I.e.
    // when running the same
    // setup twice, this function may return different results per thread or per person.  kai,
    // jun'14
