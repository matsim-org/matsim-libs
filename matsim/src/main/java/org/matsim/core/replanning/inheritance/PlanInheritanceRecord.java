...
public class PlanInheritanceRecord {
  ...
  /**
   * Iteration in which this plan had been created. May be {@linkplain
   * PlanInheritanceModule#INITIAL_PLAN} if the plan had been in the choice-set from the very
   * beginning.
   */
  ...
  /**
   * Collection of iterations this plan had been the selected plan. Initialize this with one since
   * each plan is selected at least once.
   */
