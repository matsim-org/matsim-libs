...
class DepartureDelayAverageCalculator
  ...
  private HashMap<DepartureEvent, Double> departureEventsTimes =
  ...
  /*package*/ class DepartureDelayData {
    ...
    public double getDepartureDelay(double time) {
      ...
      try {
        ...
        log.warn(
            "A departure delay for an invalid value of time was requested. Returning departureDelay = 0.0. time = "
    ...
    public void resetDepartureDelays() {
      int nofSlots =
          ((27 * 3600)
              / DepartureDelayAverageCalculator.this.timeBinSize); // default number of slots
