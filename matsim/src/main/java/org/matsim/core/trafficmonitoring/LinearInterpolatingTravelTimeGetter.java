...
class LinearInterpolatingTravelTimeGetter implements TravelTimeGetter {
  ...
  public LinearInterpolatingTravelTimeGetter(
      int numSlots, double travelTimeBinSize, TimeSlotComputation aggregator) {
  ...
  public double getTravelTime(TravelTimeData travelTimeData, double time) {
    ...
    else if (time >= numSlots * travelTimeBinSize - halfBinSize)
    ...
    //		double dy = (secondTravelTime - firstTravelTime) * (travelTimeBinSize - dx) /
    // travelTimeBinSize;
    /*
