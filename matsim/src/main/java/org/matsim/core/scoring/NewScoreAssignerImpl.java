...
class NewScoreAssignerImpl implements NewScoreAssigner {
  ...
  private static final Logger log = LogManager.getLogger(NewScoreAssignerImpl.class);
  ...
  @Inject
  NewScoreAssignerImpl(
      ScoringConfigGroup scoringConfigGroup, ControllerConfigGroup controllerConfigGroup) {
    if (scoringConfigGroup.getFractionOfIterationsToStartScoreMSA() != null) {
      ...
      this.scoreMSAstartsAtIteration =
          (int)
              (diff * scoringConfigGroup.getFractionOfIterationsToStartScoreMSA()
