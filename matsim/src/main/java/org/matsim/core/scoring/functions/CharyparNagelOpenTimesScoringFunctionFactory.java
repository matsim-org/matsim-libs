...
public final class CharyparNagelOpenTimesScoringFunctionFactory implements ScoringFunctionFactory {
  ...
  public CharyparNagelOpenTimesScoringFunctionFactory(
      final ScoringParametersForPerson params, final Scenario scenario) {
    this.params = params;
    this.scenario = scenario;
  }

  public CharyparNagelOpenTimesScoringFunctionFactory(final Scenario scenario) {
  ...
  public ScoringFunction createNewScoringFunction(Person person) {
    ...
    sumScoringFunction.addScoringFunction(
        new CharyparNagelActivityScoring(
            parameters, new FacilityOpeningIntervalCalculator(scenario.getActivityFacilities())));
    sumScoringFunction.addScoringFunction(
        new CharyparNagelLegScoring(
            parameters, scenario.getNetwork(), scenario.getConfig().transit().getTransitModes()));
