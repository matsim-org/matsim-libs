...
class NewScoreAssigner {

	static private final Logger log = Logger.getLogger(NewScoreAssigner.class);
	...
	public NewScoreAssigner(PlanCalcScoreConfigGroup planCalcScoreConfigGroup, ControlerConfigGroup controlerConfigGroup) {
