...
public abstract class Gbl {
  ...
  public static final String FUTURE_SUPPRESSED =
      " Future occurences of this logging statement are suppressed.";

  public static final String SEPARATOR = "****************************";

  public static final String CREATE_ROUTING_ALGORITHM_WARNING_MESSAGE =
  ...
  public static final String ABSORBED_INTO_CORE =
  ...
  /**
   * Prints some information about the current build/revision of this code. Currently, this will
   * only work with the Nightly-Build-Jars.
   */
  ...
  /**
   * Prints the cpu time for the current thread, i.e. the time the current thread was effectively
   * active on the CPU.
   */
  ...
  public static final String RUN_MOB_SIM_NO_LONGER_POSSIBLE =
      "overriding runMobSim() no longer possible.  use the following syntax instead:\n"
  ...
  public static final String SET_UP_IS_NOW_FINAL =
      "controler.setUp() is now final. You should be able to do whatever you need to do with a "
          + "ControlerStartupListener. Please talk to MZ or KN if you have difficulties. kai, may'15";

  public static final String LOAD_DATA_IS_NOW_FINAL =
      "controler.loadData() is now final.  If you need this functionality, use ScenarioUtils.loadScenario(...), "
          + "then modify the scenario, then pass it into new Controler( scenario ).  Talk to MZ or KN if you need help.  kai, may'15";

  public static final String CONTROLER_IS_NOW_FINAL =
      "The Controler class is now final.  Everything that used to be "
  ...
  public static final String RETROFIT_CONTROLER =
      Gbl.CONTROLER_IS_NOW_FINAL
          + " I tried to adapt this to new syntax"
          + "but please check functionality. kai, mar'15";

  public static final String PROBLEM_WITH_ACCESS_EGRESS =
      "When the TripRouter also generates access/egress legs, within-day replanning "
  ...
  public static final String COPY_PASTE_FROM_CORE_NO_LONGER_WORKING =
      "Another solution for this has been found in the core, and thus this copy-and-paste from the core is no longer working.";
