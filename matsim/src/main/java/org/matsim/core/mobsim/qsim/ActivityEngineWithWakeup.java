...
public final class ActivityEngineWithWakeup implements ActivityEngine {
  ...
  private final Queue<AgentEntry> wakeUpList =
  ...
  static class AgentEntry {
    AgentEntry(MobsimAgent agent, double time, AgentWakeup agentWakeup) {
      // yyyy Let us be careful that the executeOnWakeUp does not become overkill here; if we want
      // something more
  ...
  public static final class AgentWakeupEvent extends Event implements HasPersonId {
    ...
    public Map<String, String> getAttributes() {
      ...
      //			attr.put(ATTRIBUTE_PERSON, this.personId.toString()); // already done in superclass.
      // kai, apr'23
      return attr;
    }
  }
