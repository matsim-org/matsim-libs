...
public interface MobsimVehicle extends VisVehicle {
   ...
   *
   * @return <tt>true</tt> when the agent was added as a passenger (as per the general contract of
   ...
   *
   * @return <tt>true</tt> when the agent was removed as a passenger, <tt>false</tt> if the agent
   *     was not a passenger of this vehicle or could not be removed for other reasons
   */
  boolean removePassenger(final PassengerAgent passenger);

  /**
   * @return an immutable Collection of all passengers in this vehicle. Should <i> not </i> include
   *     the driver
   */
