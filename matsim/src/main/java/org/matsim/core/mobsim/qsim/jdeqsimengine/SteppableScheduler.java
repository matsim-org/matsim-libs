...
public class SteppableScheduler extends Scheduler implements Steppable {
  ...
  public void doSimStep(double time) {
    ...
    // "lookahead" is, I think, just a cache of the next message in the queue, to avoid having to
    // retreive it again.
    // yyyy looks like a potential bug to me if some other message gets inserted with an earlier
    // message arrival time?  kai, feb'19
