...
public abstract class AbstractMobsimModule extends AbstractModule {
  ...
  public static AbstractMobsimModule overrideMobsimModules(
      Collection<AbstractMobsimModule> base, List<AbstractMobsimModule> overrides) {
    Module composite = Modules.override(base).with(overrides);

    AbstractMobsimModule wrapper =
        new AbstractMobsimModule() {
          @Override
