...
public class CppEventFileParser {
  ...
  public static boolean equals(
      final Event personEvent, Id<Person> personId, final EventLog deqSimEvent) {
  ...
  public static boolean equals(final Event personEvent, final EventLog deqSimEvent) {
    ...
    if (personEvent instanceof PersonDepartureEvent) {
      if (Integer.parseInt(((PersonDepartureEvent) personEvent).getLinkId().toString())
          != deqSimEvent.getLinkId()) {
        CppEventFileParser.printNotEqualEvents(personEvent, deqSimEvent);
        return false;
      }
      if (Integer.parseInt(((PersonDepartureEvent) personEvent).getPersonId().toString())
          != deqSimEvent.getVehicleId()) {
        CppEventFileParser.printNotEqualEvents(personEvent, deqSimEvent);
        return false;
      }
    ...
    if (personEvent instanceof LinkEnterEvent) {
      if (Integer.parseInt(((LinkEnterEvent) personEvent).getLinkId().toString())
          != deqSimEvent.getLinkId()) {
        CppEventFileParser.printNotEqualEvents(personEvent, deqSimEvent);
        return false;
      }
      if (Integer.parseInt(((LinkEnterEvent) personEvent).getVehicleId().toString())
          != deqSimEvent.getVehicleId()) {
        CppEventFileParser.printNotEqualEvents(personEvent, deqSimEvent);
        return false;
      }
    ...
    if (personEvent instanceof LinkLeaveEvent) {
      if (Integer.parseInt(((LinkLeaveEvent) personEvent).getLinkId().toString())
          != deqSimEvent.getLinkId()) {
        CppEventFileParser.printNotEqualEvents(personEvent, deqSimEvent);
        return false;
      }
      if (Integer.parseInt(((LinkLeaveEvent) personEvent).getVehicleId().toString())
          != deqSimEvent.getVehicleId()) {
        CppEventFileParser.printNotEqualEvents(personEvent, deqSimEvent);
        return false;
      }
    ...
    if (personEvent instanceof PersonArrivalEvent) {
      if (Integer.parseInt(((PersonArrivalEvent) personEvent).getLinkId().toString())
          != deqSimEvent.getLinkId()) {
        CppEventFileParser.printNotEqualEvents(personEvent, deqSimEvent);
        return false;
      }
      if (Integer.parseInt(((PersonArrivalEvent) personEvent).getPersonId().toString())
          != deqSimEvent.getVehicleId()) {
        CppEventFileParser.printNotEqualEvents(personEvent, deqSimEvent);
        return false;
      }
