...
public final class HermesConfigGroup extends ReflectiveConfigGroup {
  ...
  // Maximum vehicle velocity (limited to 8 bits in the plan: integers 0-99 reserved for speeds 0.0
  // - 9.9
  ...
  private static final String DETPTDESC =
  ...
  @Positive private double storageCapacityFactor = 1.0;

  @Positive private double flowCapacityFactor = 1.0;

  @Positive private int stuckTime = 10;
  ...
  protected void checkConsistency(Config config) {
    ...
    if (config.eventsManager().getOneThreadPerHandler() != true
        && config.controller().getMobsim().equals("hermes")) {
