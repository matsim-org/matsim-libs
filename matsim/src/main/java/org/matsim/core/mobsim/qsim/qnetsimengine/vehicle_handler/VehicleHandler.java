...
/**
 * This interface provides functionality to decide what happens if a vehicle interacts with a link
...
public interface VehicleHandler {
   ...
   *
   * @return Return value defines whether vehicle is currently allowed to arrive at the link. If
   *     not, the link will block until the next query or until the agent changes its plan
   *     dynamically.
   */
