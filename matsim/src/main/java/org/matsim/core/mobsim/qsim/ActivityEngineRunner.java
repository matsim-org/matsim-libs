...
class ActivityEngineRunner implements ActivityEngine {
	private static final Logger log = LogManager.getLogger( ActivityEngineRunner.class ) ;

	private final EventsManager eventsManager;
	private final AtomicInteger counter;

	ActivityEngineRunner(final EventsManager eventsManager, final AtomicInteger counter) {
...
//		try {
//			if (lock.tryLock()) {
//				return internalHandleActivity(agent);
//			} else {
//				lock.lock();
//				log.error("Had to wait for lock #" + this.counter.incrementAndGet());
//				return internalHandleActivity(agent);
//			}
//		} catch (Exception e) {
//			e.printStackTrace();
...
//		}
////		return false;
//		throw new RuntimeException("Could not handle activity.");
//	}
	@Override
	public boolean handleActivity(MobsimAgent agent) {
		return internalHandleActivity(agent);
	...
	private boolean internalHandleActivity(MobsimAgent agent) {
