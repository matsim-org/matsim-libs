 ...
 *     <p>I think this class is reasonable in terms of what is public and/or final and what not.
 */
public class PersonDriverAgentImpl
    implements MobsimDriverAgent, MobsimPassengerAgent, HasPerson, PlanAgent, HasModifiablePlan {
  ...
  public PersonDriverAgentImpl(
      final Plan plan1, final Netsim simulation, final TimeInterpretation timeInterpretation) {
    basicAgentDelegate =
    ...
    // deliberately does NOT keep a back pointer to the whole Netsim; this should also be removed in
