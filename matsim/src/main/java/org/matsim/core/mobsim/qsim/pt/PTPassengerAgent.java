...
public interface PTPassengerAgent extends PassengerAgent {
   ...
   * @return <code>true</code> if the passenger wants to exit the vehicle, <code>false</code>
   *     otherwise
   */
  public boolean getExitAtStop(final TransitStopFacility stop);

  /**
   * Asks a passenger which is departing on a transit leg about the stop it wants to use for
   * accessing the transit line.
   *
  ...
  /**
   * @return a statistical weight, how many "real" agents this agent represents, e.g. "5.0" if you
   *     simulate a 20%-sample.
   */
