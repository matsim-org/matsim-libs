...
class HLink {
  ...
  // The whole purpose of this implementation is to have a dynamically sized queue that never goes
  // over the capacity
  // restriction. This becomes a big memory waste when large scenarios are used. This implementation
  // is inspired in
