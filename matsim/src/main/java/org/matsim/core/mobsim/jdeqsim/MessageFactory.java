...
/**
 * The message factory is used for creating and disposing messages - mainly for performance gain to
 * have lesser garbage collection.
 *
...
public class MessageFactory {
  ...
  private static LinkedList<EnterRoadMessage> enterRoadMessageQueue =
      new LinkedList<EnterRoadMessage>();
  private static LinkedList<StartingLegMessage> startingLegMessageQueue =
      new LinkedList<StartingLegMessage>();
  private static LinkedList<LeaveRoadMessage> leaveRoadMessageQueue =
      new LinkedList<LeaveRoadMessage>();
  private static LinkedList<EndRoadMessage> endRoadMessageQueue = new LinkedList<EndRoadMessage>();

  private static LinkedList<DeadlockPreventionMessage> deadlockPreventionMessageQueue =
      new LinkedList<DeadlockPreventionMessage>();
  ...
  public static EndLegMessage getEndLegMessage(
      Scheduler scheduler, Vehicle vehicle, TimeInterpretation timeInterpretation) {
