 ...
 * </ul>
 * 
 * <strike><small>Towards a concept for status pointers:<ul>
 ...
 * plan is needed.
 * <p/>
 * <strike><small>Should add Identifiable to this interface; could then replace many PersonAgent by PlanAgent.  done.  kai, dec'10</small></strike>
 *
 * @author dgrether
 * @author nagel
 *
