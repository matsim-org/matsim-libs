...
/**
 * To avoid problems with the order of some SimulationListeners, this class can be used execute them
 * in a fixed order. Even something like ParallelListenerHandling (which is not available yet)
 * should not able to break the order.
 *
 * @author cdobler
 */
public class FixedOrderSimulationListener
