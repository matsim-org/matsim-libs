 ...
 * @author cdobler
 */
public class BikeTravelTimeOld implements TravelTime {
	...
	public BikeTravelTimeOld(PlansCalcRouteConfigGroup plansCalcRouteConfigGroup, TravelTime walkTravelTime) {
