 ...
 *
 * <ul>
 *   <li>set start-time of first act to 00:00
 *   <li>use end-time of first act as "current" time
 *   <li>sets start-time, duration, end-time of acts and departure-time, travel-time, arrival-time
 *       of legs by continually adding duration of acts and travel-time of legs to the current time.
 *   <li>the last act is extended until 24:00 if it ends before this time. Otherwise, a duration of
 *       0 is assumed for the last act.
 * </ul>
 *
