...
/* deliberately package */ final class LegImpl implements Leg {
  ...
  public final void setMode(String transportMode) {
    ...
    //		TripStructureUtils.setRoutingMode( this, null ); // setting routingMode to null leads to
    // exceptions in AttributesXmlWriterDelegate.writeAttributes() : Class<?> clazz =
    // objAttribute.getValue().getClass();
