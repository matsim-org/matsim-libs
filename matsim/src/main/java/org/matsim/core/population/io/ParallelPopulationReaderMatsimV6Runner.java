...
/**
 * Runnable used by ParallelPopulationReaderMatsimV6. Processes xml data taken from a BlockingQueue
 * which is filled in the main class.
 *
 * @author cdobler, steffenaxer
 */
/* deliberately package */ class ParallelPopulationReaderMatsimV6Runner
    extends PopulationReaderMatsimV6 implements Runnable {
