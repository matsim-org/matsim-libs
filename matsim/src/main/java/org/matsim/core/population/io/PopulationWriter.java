...
public final class PopulationWriter extends AbstractMatsimWriter implements MatsimWriter {
  ...
  private static final Logger log = LogManager.getLogger(PopulationWriter.class);
  ...
  public PopulationWriter(
      final CoordinateTransformation coordinateTransformation, final Population population) {
    this(coordinateTransformation, population, null, 1.0);
  }

  /**
   * Creates a new PlansWriter to write out the specified plans to the file and with version as
   * specified in the {@linkplain org.matsim.core.config.groups.PlansConfigGroup configuration}. If
   * plans-streaming is on, the file will already be opened and the file-header be written. If
   * plans-streaming is off, the file will not be created until {@link #write(java.lang.String)} is
   * called.
   *
  ...
  /**
   * Creates a new PlansWriter to write out the specified plans to the specified file and with the
   * specified version. If plans-streaming is on, the file will already be opened and the
   * file-header be written. If plans-streaming is off, the file will not be created until {@link
   * #write(java.lang.String)} is called.
   *
   ...
   */
  public PopulationWriter(
      final Population population, final Network network, final double fraction) {
