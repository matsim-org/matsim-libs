...
/* deliberately package */ class PopulationImpl implements Population, Lockable {
  ...
  /**
   * Attributes of the population itself. Can be used as metadata, for instance to store source of
   * data, date of conversion, authors, sampling rate, or whatever is felt useful
   *
   * @return
   */
  @Override
