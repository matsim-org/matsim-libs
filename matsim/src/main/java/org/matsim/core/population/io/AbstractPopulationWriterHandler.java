...
abstract class AbstractPopulationWriterHandler implements PopulationWriterHandler {
  ...
  private static final Logger log = LogManager.getLogger(AbstractPopulationWriterHandler.class);

  @Override
  public final void writePerson(final Person person, final BufferedWriter writer)
      throws IOException {
  ...
  public abstract void startPerson(final Person person, final BufferedWriter out)
      throws IOException;

  public abstract void endPerson(final BufferedWriter out) throws IOException;

  public abstract void startTravelCard(final String travelcard, final BufferedWriter out)
      throws IOException;
