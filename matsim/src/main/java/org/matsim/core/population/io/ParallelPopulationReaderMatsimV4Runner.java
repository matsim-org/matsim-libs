...
/**
 * Runnable used by ParallelPopulationReaderMatsimV4. Processes xml data taken from a BlockingQueue
 * which is filled in the main class.
 *
 * @author cdobler
 */
/* deliberately package */ class ParallelPopulationReaderMatsimV4Runner
    extends PopulationReaderMatsimV4 implements Runnable {
