...
/**
 * Simplifies a plan to its structure, so that plan algorithms working with strict leg/act
 * alternance can work on it. Routing will be necessary before execution.
 *
 * @author thibautd
 */
public final class TripsToLegsAlgorithm implements PlanAlgorithm {
  ...
  public TripsToLegsAlgorithm(final MainModeIdentifier mainModeIdentifier) {
