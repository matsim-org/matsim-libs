...
/**
 * A wrapper class that allows to use a BinaryMinHeap for objects that do not implement the HasIndex
 * interface.
 *
 * @author cdobler
 * @param <E>
...
public class WrappedBinaryMinHeap<E> implements MinHeap<E> {
  ...
  private WrappedEntry getOrCreateWrappedEntry(E value) {
    ...
    if (wrappedEntry == null) {
      ...
      //			if (index > maxSize) throw new RuntimeException("Number of elements exceeds the number of
      // specified elements.");
