 ...
 * @author cdobler
 */
class MultiNodeDijkstraImpl extends DijkstraImpl implements MultiNodePathCalculator {
	...
	MultiNodeDijkstraImpl(Network network, TravelDisutility costFunction, TravelTime timeFunction, boolean searchAllEndNodes) {
		super(network, costFunction, timeFunction);
		this.searchAllEndNodes = searchAllEndNodes;
	}

	MultiNodeDijkstraImpl(final Network network, final TravelDisutility costFunction, final TravelTime timeFunction,
