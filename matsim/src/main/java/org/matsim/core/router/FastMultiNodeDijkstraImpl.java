 ...
 * @author cdobler
 */
class FastMultiNodeDijkstraImpl extends MultiNodeDijkstraImpl {
	 ...
	 */
	protected FastMultiNodeDijkstraImpl(final RoutingNetwork routingNetwork, final TravelDisutility costFunction,
