...
public class DefaultRoutingRequest implements RoutingRequest {
  ...
  protected DefaultRoutingRequest(
  ...
  public static RoutingRequest withoutAttributes(
      Facility fromFacility, Facility toFacility, double departureTime, Person person) {
    return new DefaultRoutingRequest(
        fromFacility, toFacility, departureTime, person, new AttributesImpl());
  }
}
