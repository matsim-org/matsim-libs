...
final class RandomizingTimeDistanceTravelDisutility implements TravelDisutility {
  ...
  public double getLinkTravelDisutility(
    ...
    if (sigma != 0.) {
      ...
      // do not use custom attributes in core??  but what would be a better solution here?? kai,
      // mar'15
      // Is this actually used anywhere? As far as I can see, this is at least no used in this
      // class... td, Oct'15
    ...
    return this.marginalCostOfTime * travelTime
        + logNormalRnd * this.marginalCostOfDistance * link.getLength();
  }
