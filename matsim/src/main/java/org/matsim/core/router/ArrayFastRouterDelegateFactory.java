...
public final class ArrayFastRouterDelegateFactory implements FastRouterDelegateFactory {

	@Override
	public ArrayFastRouterDelegate createFastRouterDelegate( DijkstraImpl dijkstra,
