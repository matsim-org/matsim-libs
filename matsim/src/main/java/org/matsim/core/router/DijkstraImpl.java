 ...
 * @author mrieser
 */
class DijkstraImpl implements LeastCostPathCalculator {
	...
	private final static Logger log = Logger.getLogger( DijkstraImpl.class );
	...
	protected DijkstraImpl( final Network network, final TravelDisutility costFunction, final TravelTime timeFunction ) {
