...
public class GraphvizRenderer {
  ...
  public void render(Graph<Node, Edge> graph) {
    ...
    //		out.println("{");
    //		out.println("rank=same;");
    //		out.println(nodes.get(NodeId.newTypeId(Key.get(RoutingModule.class,
    // Names.named("car")))).getIdentifier()+";");
    //		out.println(nodes.get(NodeId.newTypeId(Key.get(TravelTime.class,
    // Names.named("car")))).getIdentifier()+";");
    //		out.println(nodes.get(NodeId.newTypeId(Key.get(TravelDisutilityFactory.class,
    // Names.named("car")))).getIdentifier()+";");
    //		out.println("}");
