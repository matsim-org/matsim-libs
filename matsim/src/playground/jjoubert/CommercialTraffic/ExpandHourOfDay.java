...
public class ExpandHourOfDay {
	...
	public static void main ( String args[] ){
		...
		try{
			...
			BufferedWriter outFile = new BufferedWriter( new FileWriter( new File("/Users/johanwjoubert/MATSim/workspace/MATSimData/GautengVehicles/Activities/20090214-2230/hourOfDayInGautengStatsForGIS.txt")));
			outFile.write(header[0] + DELIMETER +
						  header[1] + DELIMETER +
						  header[2] + DELIMETER +
						  header[3] + DELIMETER +
						  header[4] + DELIMETER +
