/* *********************************************************************** *
 * project: org.matsim.*
 * PersonAlgo_CreateVehicleDistributed.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
	...
	public void run(Person person) {
		...
		for( Iterator i = plaene.iterator(); i.hasNext(); )
		{
			...
			if (actPlan.isSelected())
			{
				...
				if (startlinkpart != -1) DistributedQueueSimulation.sendVehicle(startlinkpart, person.getId().toString(),actPlan.getActsLegs());
