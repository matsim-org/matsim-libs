...
public class PrintShopAndLeisureLocations implements StartupListener, IterationEndsListener, ShutdownListener {
	...
	public void notifyIterationEnds(final IterationEndsEvent event) {
		...
		PopulationImpl plans = event.getControler().getPopulation();		
		...
		try {
			ShapeFileWriter.writeGeometries((Collection<Feature>)featuresShop, shopFile);
			ShapeFileWriter.writeGeometries((Collection<Feature>)featuresLeisure, leisureFile);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
