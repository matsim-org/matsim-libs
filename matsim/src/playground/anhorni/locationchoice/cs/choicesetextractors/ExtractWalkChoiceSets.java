...
public class ExtractWalkChoiceSets extends ChoiceSetExtractor {


	private final static Logger log = Logger.getLogger(ExtractWalkChoiceSets.class);
	private QuadTree<ZHFacility> shoppingQuadTree = null;
	private double walkingSpeed = 1.39;
	
	public ExtractWalkChoiceSets(Controler controler, List<ZHFacility> zhFacilities, double walkingSpeed, 
	...
	protected void computeChoiceSet(ChoiceSet choiceSet, SpanningTree spanningTree, String type,
		...
		if (facilities != null) {
			choiceSet.addFacilities(facilities, null);
		}
	}
