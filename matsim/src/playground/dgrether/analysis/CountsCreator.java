...
//		r1.setRoute("9296 9298 9294 9282 9281");
		//the new route
		r1.setNodes("1341 5268 1342 1348 1349 1375 1585 1581 1583");
		CarRoute r2 = new NodeCarRoute();
...
//		r2.setRoute("9286 1725 1727 1722 1718 9284 9281");
		//the new routes
		r2.setNodes("1583 1588 1597 1596 1591 1593 1600 2216 1603 1601 9250 9254");
		CarRoute r3 = new NodeCarRoute();
		r3.setNodes("1583 1587 1641 1644 1645 1648 5210 2420 9275 9272");
		CarRoute r4 = new NodeCarRoute();
		r4.setNodes("1370 9180 9183 9181 9261 9265 9269 9408 9409 9404 9400 9403 9402 9398 9394 9414 9276");

		log.info("  creating routes done");
		Set<CarRoute> routes = new HashSet<CarRoute>();
		routes.add(r1);
		routes.add(r2);
		routes.add(r3);
		routes.add(r4);
