 ...
 * @author dgrether
 */
public class DgAvgDeltaMoneyModeGroupChart extends DgAvgDeltaMoneyGroupChart {
	
	private static final Logger log = Logger.getLogger(DgAvgDeltaMoneyModeGroupChart.class);
	
	public DgAvgDeltaMoneyModeGroupChart(DgAnalysisPopulation ana) {
		super(ana);
	}
	...
	protected XYSeriesCollection createDatasets() {
		...
		ds.addSeries(this.createXYSeries("Mean "+  '\u0394' + "Money Car2Car", car2carPop).getFirst());
		ds.addSeries(this.createXYSeries("Mean "+  '\u0394' + "Money Pt2Pt", pt2ptPop).getFirst());
		ds.addSeries(this.createXYSeries("Mean "+  '\u0394' + "Money Pt2Car", pt2carPop).getFirst());
		ds.addSeries(this.createXYSeries("Mean "+  '\u0394' + "Money Car2Pt", car2ptPop).getFirst());		
		return ds;
	}
	...
	public JFreeChart createChart() {
		...
		ValueAxis yAxis = this.axisBuilder.createValueAxis("Money [Chf]");
