...
public class DgAvgDeltaMoneyGroupChart {
	...
	public DgAvgDeltaMoneyGroupChart(DgAnalysisPopulation ana) {
		this.ana = ana;
...
//			xvalues[i] = incomeThresholds[i].max;Utility
//			yvalues[i] = calcAverageScoreDifference(groups[i]);
			Double avgScore = calcAverageMoneyDifference(groups[i]);
			if (avgScore != null) {
	...
	protected Double calcAverageMoneyDifference(DgAnalysisPopulation group) {
