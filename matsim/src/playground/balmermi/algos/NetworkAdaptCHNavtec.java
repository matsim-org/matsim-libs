...
public class NetworkAdaptCHNavtec extends NetworkAlgorithm {
	...
	public void run(NetworkLayer network) {
		...
		while (l_it.hasNext()) {
			...
			if (type == 31) {
				System.out.println("        link id=" + l.getId() + "; type=" + l.getType() + "; lanes=" + l.getLanes() + " ==> lanes=1");
				l.setLanes(1);
			}
			if (l.getLanes() == 3) {
				System.out.println("        link id=" + l.getId() + "; lanes=" + l.getLanes() + " ==> lanes=2");
				l.setLanes(2);
			}
			int lanes = l.getLanes();
