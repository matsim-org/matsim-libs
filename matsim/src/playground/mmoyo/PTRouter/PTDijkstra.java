 ...
 * @author mrieser
 */
public class PTDijkstra implements LeastCostPathCalculator {
	...
	private final static Logger log = Logger.getLogger(PTDijkstra.class);
	 ...
	 */
	public PTDijkstra(final Network network, final TravelCost costFunction, final TravelTime timeFunction) {
