...
/*
private void ORIGINALcreateQuadTree (NetworkLayer cityNetworkLayer, PTNetworkLayer ptNetworkLayer){
	double maxX = Double.NEGATIVE_INFINITY;
	double maxY = Double.NEGATIVE_INFINITY;
	double minX = Double.POSITIVE_INFINITY;
	double minY = Double.POSITIVE_INFINITY;
	...
	for (Iterator<Node> iter2 = FatherNodeList.iterator(); iter2.hasNext();) {
		...
		this.PTQuadTree.put(node2.getCoord().getX(), node2.getCoord().getY(), node2);
	}
}//CreateQuadTree
*/