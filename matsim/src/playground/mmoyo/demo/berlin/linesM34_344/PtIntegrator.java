...
public class PtIntegrator {
	...
	private final static String STREET_NETWORK_FILE = "../shared-svn/studies/countries/de/berlin-bvg09/pt/baseplan_10x_900s_bignetwork/network.multimodal.xml.gz";
	private final static String INPUT_PLANS_FILE = "../shared-svn/studies/countries/de/berlin-bvg09/ptManuel/344plans.xml";
	private final static String TRANSIT_SCHEDULE_FILE = "../shared-svn/studies/countries/de/berlin-bvg09/ptManuel/transitScheduleM44_344.xml";

	private final static String VEHICLE_FILE = "../shared-svn/studies/countries/de/berlin-bvg09/pt/baseplan_10x_900s_bignetwork/vehicles.oevModellBln.xml.gz";
	private final static String ROUTED_PLANS_FILE = "output/routedPlans.xml";
	...
	public PtIntegrator() {
		...
		config.network().setInputFile(STREET_NETWORK_FILE);
		...
		new MatsimNetworkReader(scenario.getNetwork()).readFile(STREET_NETWORK_FILE);
