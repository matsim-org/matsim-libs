...
package playground.mmoyo.demo.X5.player2;
...
public class ScenarioPlayer {
	...
	public static void main(final String[] args) throws SAXException, ParserConfigurationException, IOException {
		ScenarioLoader sl = new ScenarioLoader("src/playground/mmoyo/demo/X5/player2/config.xml");
		...
		new TransitScheduleReaderV1(schedule, network).parse("src/playground/mmoyo/demo/X5/player2/simple1transitSchedule.xml");
