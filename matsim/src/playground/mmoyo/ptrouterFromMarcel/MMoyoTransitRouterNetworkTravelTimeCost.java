 ...
 * @author mrieser
 */
public class MMoyoTransitRouterNetworkTravelTimeCost implements TravelCost, TravelTime {

	private final static double MIDNIGHT = 24.0*3600;

	private final MMoyoTransitRouterConfig config;
	private Link previousLink = null;
	private double previousTime = Double.NaN;
	private double cachedTravelTime = Double.NaN;

	public MMoyoTransitRouterNetworkTravelTimeCost(final MMoyoTransitRouterConfig config) {
		this.config = config;
	}
