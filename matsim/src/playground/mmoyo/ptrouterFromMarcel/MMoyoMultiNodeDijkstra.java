 ...
 * @author mrieser
 */
public class MMoyoMultiNodeDijkstra extends Dijkstra {

	private static final Logger log = Logger.getLogger(MMoyoMultiNodeDijkstra.class);

	public MMoyoMultiNodeDijkstra(final Network network, final TravelCost costFunction, final TravelTime timeFunction) {
