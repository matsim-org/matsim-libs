package playground.wrashid.test.root.PHV.Utility;
...
public class EnergyConsumptionSamplesTest extends TestCase {
	...
	public void testGetInterpolatedValue(){
		...
		assertEquals(125.0, EnergyConsumptionSamples.getInterpolatedValue(new AverageSpeedEnergyConsumption(20,100), new AverageSpeedEnergyConsumption(30,150), 25));
		assertEquals(60.0, EnergyConsumptionSamples.getInterpolatedValue(new AverageSpeedEnergyConsumption(20,100), new AverageSpeedEnergyConsumption(30,20), 25));
		assertEquals(91.0, EnergyConsumptionSamples.getInterpolatedValue(new AverageSpeedEnergyConsumption(20,100), new AverageSpeedEnergyConsumption(30,10), 21));
