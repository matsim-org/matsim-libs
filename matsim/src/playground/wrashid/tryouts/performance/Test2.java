...
public class Test2 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		//volatile  (score: 1.9sec)
		Thread t0 = new Thread(new BRunnable(t2, 0, endTime));
		Thread t1 = new Thread(new BRunnable(t2, 1, endTime));
		*/
		
		
		//volatile Lock used (score: 3.1sec)
		Thread t0 = new Thread(new CRunnable(t2, 0, endTime,0));
		Thread t1 = new Thread(new CRunnable(t2, 1, endTime,1));
		
		/*
		// java.util.concurrent.locks.ReentrantLock is good: (score: 12.7sec)
		java.util.concurrent.locks.ReentrantLock lock=new java.util.concurrent.locks.ReentrantLock();
		Thread t0 = new Thread(new DRunnable(t2, 0, endTime,lock));
		Thread t1 = new Thread(new DRunnable(t2, 1, endTime,lock));
		*/
	...
	static class DRunnable implements Runnable {
		...
		public DRunnable(Test2 t2, int parameter, int endTime,java.util.concurrent.locks.ReentrantLock lock) {
			super();
			this.t2 = t2;
			this.parameter = parameter;
			this.endTime = endTime;
