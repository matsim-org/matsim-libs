...
public class Run {
	...
	public static void main(String[] args) {
		...
		final String outputFileBiogeme = "/home/baug/mfeil/data/choiceSet/it0/output_plans0571.dat";
		final String attributesInputFile = "/home/baug/mfeil/data/mz/attributes_MZ2005.txt";
		final String outputFileMod = "/home/baug/mfeil/data/choiceSet/it0/model0571.mod";
...
//		log.info("Size of sime is "+sims.size()+" times "+sims.get(0).size());
		...
		pc.writePlansForBiogemeWithRandomSelectionAccumulated(outputFileBiogeme, attributesInputFile, 
				beta, gamma, similarity, incomeConstant, incomeDivided, incomeDividedLN, incomeBoxCox, age, gender, employed, license, carAvail, seasonTicket, travelDistance, travelCost, travelConstant, bikeIn);
