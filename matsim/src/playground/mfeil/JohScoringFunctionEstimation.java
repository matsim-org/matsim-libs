...
public class JohScoringFunctionEstimation implements ScoringFunction {
	...
	private static double marginalUtilityOfWaiting = -4.73; //war -6
	private static double marginalUtilityOfLateArrival = -14.29; //war -18
	private static double marginalUtilityOfEarlyDeparture = -0; // war -0
	private static double marginalUtilityOfTraveling = -4.73; // war fuer alle -6
	private static double marginalUtilityOfTravelingPT = -2.13; 
	private static double marginalUtilityOfTravelingWalk = -0.80;
	...
	private static final double uMax_home = 3.08; //60
	private static final double uMax_work= 3.62;  //55
	private static final double uMax_shopping = 2.68; //12
	private static final double uMax_leisure = 3.39;  //35
	private static final double alpha_home = 9.26;//6
	private static final double alpha_work = 0.80;//4
	private static final double alpha_shopping = -1.28;//1
	private static final double alpha_leisure = -0.03;//2
	...
	private static final double uMax_education = 3.28;//40
	private static final double alpha_education = 0.04;//3
	private static final double beta_education = 1.2;
	private static final double gamma_education = 1;
	
	
	
	public JohScoringFunctionEstimation(final PlanImpl plan) {
		init();
		this.reset();
