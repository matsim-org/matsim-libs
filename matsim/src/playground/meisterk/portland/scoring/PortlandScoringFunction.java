...
/**
 * Same as CharyparNagelScoringFunction, but takes open times from the facilities layer
 * instead of the config file.
 * 
 * @author meisterk
 *
 */
public class PortlandScoringFunction implements ScoringFunction {
	...
	public PortlandScoringFunction(final Plan plan) {
		init();
		this.reset();
