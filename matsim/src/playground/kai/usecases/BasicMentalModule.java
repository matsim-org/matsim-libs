...
public class BasicMentalModule implements 
ActEndEventHandler,
...
{
	private static final Logger log = Logger.getLogger(BasicMentalModule.class);
	
	public BasicMentalModule ( BasicScenario sc ) {
