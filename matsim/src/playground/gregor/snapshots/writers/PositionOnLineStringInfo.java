...
public class PositionOnLineStringInfo extends PositionInfo{
...
//	public enum VehicleState {Driving, Parking};
	...
	public PositionOnLineStringInfo(final Id agentId, final Link link, final double distanceOnLink, final int lane, final double speed,
...
//		final CoordI fromCoord = link.getFromNode().getCoord();
	...
	public PositionOnLineStringInfo(final Id driverId, final double easting, final double northing, final double elevation, final double azimuth, final double speed, final VehicleState vehicleState, final String visualizerData) {
