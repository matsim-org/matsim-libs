...
public class Events2Snapshot {
	...
	private void prepare() {
		...
		this.visualizer = new SnapshotGenerator(this.network, this.config.simulation().getSnapshotPeriod(),lst);
		this.events.addHandler(this.visualizer);
	}

	private Collection<Feature> getFeatures() {
		final String file = "./padang/network_v20080618/d_ls.shp";
	...
	public static void main(final String[] args) {
		final Events2Snapshot app = new Events2Snapshot();
		app.run(args);
	}
