...
public class WithindayQueueSimulation extends QueueSimulation {
	...
	private final playground.gregor.withindayevac.controler.WithindayControler controler;
	private final InformationExchanger informationExchanger;


	public WithindayQueueSimulation(final NetworkLayer net,
			final Population plans, final Events events, final playground.gregor.withindayevac.controler.WithindayControler withindayControler) {
