...
public class EventsFilesCompare {
	
	private final static Logger log = Logger.getLogger(EventsFilesCompare.class);
	...
	public EventsFilesCompare(final String eventsFile1, final String eventsFile2,
	...
	public static void main(final String [] args) {
		...
		new EventsFilesCompare(eventsFile1, eventsFile2, crs, net).run();
	}
	...
	private class TravelTimesFromEvents implements AgentDepartureEventHandler, AgentArrivalEventHandler, AgentStuckEventHandler {
		...
		private final QuadTree<AgentInfo> ttimesTree = new QuadTree<AgentInfo>(EventsFilesCompare.ENVELOPE.getMinX(),EventsFilesCompare.ENVELOPE.getMinY(),EventsFilesCompare.ENVELOPE.getMaxX(),EventsFilesCompare.ENVELOPE.getMaxY());
		...
		public void handleEvent(final AgentDepartureEvent event) {
			...
			ai.time = event.time;
			Link link = EventsFilesCompare.this.network.getLink(event.linkId);
