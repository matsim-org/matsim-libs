...
//		net.setEffectiveLaneWidth(0.71);
		...
		NodeImpl n1 = net.createAndAddNode(new IdImpl(1),new CoordImpl(0,100));
		NodeImpl n2 = net.createAndAddNode(new IdImpl(2),new CoordImpl(0,200));
		NodeImpl n3 = net.createAndAddNode(new IdImpl(3),new CoordImpl(0,300));
		NodeImpl n4 = net.createAndAddNode(new IdImpl(4),new CoordImpl(0,2300));
		NodeImpl en1 = net.createAndAddNode(new IdImpl("en1"),new CoordImpl(300,400));
		NodeImpl en2 = net.createAndAddNode(new IdImpl("en2"),new CoordImpl(400,400));
		NodeImpl sna = net.createAndAddNode(new IdImpl("sn1a"),new CoordImpl(100,200));
		NodeImpl snb = net.createAndAddNode(new IdImpl("sn1b"),new CoordImpl(200,200));
		this.l0 = net.createAndAddLink(new IdImpl(0), n0, n1, 100, 16.6, 100, 1);
		LinkImpl l1 = net.createAndAddLink(new IdImpl(1), n1, n2, 100, 16.6, 1, 1);
		LinkImpl l2 = net.createAndAddLink(new IdImpl(2), n2, n3, 100, 16.6, 1, 1);
		LinkImpl l3 = net.createAndAddLink(new IdImpl(3), n3, n4, 2000, 16.6, 1, 1);
		this.el1 = net.createAndAddLink(new IdImpl("el1"), en1, en2, 100, 10000., 10000., 1);
		LinkImpl el2 = net.createAndAddLink(new IdImpl("el2"), n4, en1, 100, 10000., 10000., 1);
		LinkImpl sl1a = net.createAndAddLink(new IdImpl("sl1a"), n2, sna, 100, 16.6, 1, 1);
		LinkImpl sl1b = net.createAndAddLink(new IdImpl("sl1b"), sna, snb, 100, 16.6, 0.1, 1);
		LinkImpl sl1c = net.createAndAddLink(new IdImpl("sl1c"), snb, en1, 100, 10000., 10000., 1);
