...
//		factory.setTravelTimeAggregatorPrototype(PessimisticTravelTimeAggregator.class);
	...
	protected NetworkLayer loadNetwork() {
		...
		NodeImpl ns0 = net.createAndAddNode(new IdImpl(0),new CoordImpl(-1,0));
		NodeImpl ns1 = net.createAndAddNode(new IdImpl("s"),new CoordImpl(0,0));
		NodeImpl n0 = net.createAndAddNode(new IdImpl(1),new CoordImpl(4,0));
		NodeImpl n1 = net.createAndAddNode(new IdImpl(2),new CoordImpl(10,0));
		NodeImpl n2 = net.createAndAddNode(new IdImpl(3),new CoordImpl(10,-4));
		NodeImpl nt0 = net.createAndAddNode(new IdImpl("t"),new CoordImpl(14,0));
		NodeImpl nt1 = net.createAndAddNode(new IdImpl(6),new CoordImpl(15,0));

		this.l0 = net.createAndAddLink(new IdImpl(0), ns0, ns1, 1, 1, 100, 1);
		net.createAndAddLink(new IdImpl(0+100000), ns1, ns0, 1, 1, 100, 1);
		LinkImpl l1 = net.createAndAddLink(new IdImpl(1), ns1, n0, 4, 1, 1, 1);
		net.createAndAddLink(new IdImpl(1+100000), n0, ns1, 4, 1, 1, 1);
		LinkImpl l2 = net.createAndAddLink(new IdImpl(2), n0, n1, 10, 1, 1./3., 1);
		net.createAndAddLink(new IdImpl(2+100000), n1, n0, 10, 1./3., 1, 1);
		LinkImpl l3 = net.createAndAddLink(new IdImpl(3), n0, n2, 8, 1, 1, 1);
		net.createAndAddLink(new IdImpl(3+100000), n2, n0, 8, 1, 1, 1);
		LinkImpl l4 = net.createAndAddLink(new IdImpl(4), n2, n1, 4, 1, 1, 1);
		net.createAndAddLink(new IdImpl(4+100000), n1, n2, 4, 1, 1, 1);
		LinkImpl l5 = net.createAndAddLink(new IdImpl(5), n1, nt0, 4, 1, 4, 1);
