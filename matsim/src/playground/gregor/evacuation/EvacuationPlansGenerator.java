...
public class EvacuationPlansGenerator {
	...
	private HashMap<IdI, EvacuationAreaLink> desasterAreaLinks = new HashMap<IdI, EvacuationAreaLink>();
	...
	//////////////////////////////////////////////////////////////////////
	private boolean isSaveNode(Node node) {
	...
	public void generatePlans(Plans plans, NetworkLayer network, HashMap<IdI, EvacuationAreaLink> desasterAreaLinks) {
