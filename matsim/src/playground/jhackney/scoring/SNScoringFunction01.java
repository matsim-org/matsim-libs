...
public class SNScoringFunction01 extends CharyparNagelScoringFunction{

    public SNScoringFunction01(final Plan plan) {
	super(plan);
    }
...
//	System.out.println("SN score");
	this.score=score - getPlanLength(plan);
//	this.score=score;
