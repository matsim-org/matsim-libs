...
public class CompareTimeWindows {
	 ...
	 * @return
	 */
	public static LinkedHashMap<ActivityImpl,ArrayList<Double>> calculateTimeWindowEventActStats(LinkedHashMap<ActivityFacility,ArrayList<TimeWindow>> timeWindowMap) {
