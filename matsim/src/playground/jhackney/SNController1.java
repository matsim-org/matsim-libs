...
public class SNController1 extends Controler {

	public SNController1(final String[] args) {
		super(args);
	}
...
//	}
	...
	public static void main(final String[] args) {
		final Controler controler = new SNController1(args);
		controler.addControlerListener(new SNControllerListener1());
		controler.run();
		System.exit(0);
	}
}
