...
//			osmReader.parse("../mystudies/zueri.osm");
			osmReader.parse("/Users/nagel/shared-svn/studies/north-america/ca/metro-vancouver/network/osm/map.osm");
...
//		new NetworkWriter(network, "../mystudies/zueri-net.xml").write();
		new NetworkWriter(network, "/Users/nagel/net.xml").write();
