...
public class VolumefromEventsTestUpDate {
	...
	public static void main(final String[] args) {
		...
		final String plansFilename = "../data/ivtch/input/all_zrh30km_10pct100.plans.xml.gz";
		final String eventsFilename = "../data/ivtch/input/all_zrh30km_10pct100.events.txt.gz";
		final String chartFilename = "../data/ivtch/analysis/all_zrh30km_10pctChart.png";
		final String legFilename = "../data/ivtch/analysis/all_zrh30km_10pctLeg.txt.gz";
