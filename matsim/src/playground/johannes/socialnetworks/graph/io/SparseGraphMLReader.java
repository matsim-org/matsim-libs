 ...
 * 
 */
public class SparseGraphMLReader extends AbstractGraphMLReader {

	private SparseGraphFactory factory = new SparseGraphFactory();
	...
	protected SparseEdge addEdge(SparseVertex v1, SparseVertex v2,
			Attributes attrs) {
		return factory.addEdge(graph, v1, v2);
	}
	...
	protected SparseVertex addVertex(Attributes attrs) {
		return factory.addVertex(graph);
	}
