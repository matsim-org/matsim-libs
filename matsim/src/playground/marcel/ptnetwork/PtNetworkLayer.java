...
//					 check for arrival node
		...
		if (reachedNodes.size() == 0) {
			throw new RuntimeException("No route found from coord " + fromCoord + " to coord " + toCoord + " with desired departure time  " + Gbl.writeTime(depTime, Gbl.TIMEFORMAT_HHMMSS) + ".");
		}
