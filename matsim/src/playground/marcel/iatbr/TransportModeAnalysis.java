...
public class TransportModeAnalysis extends AbstractPersonAlgorithm {
	...
	public static void main(final String[] args) {
		...
		try {
			...
			new MatsimNetworkReader(scenario.getNetwork()).parse("/Volumes/Data/VSP/projects/diss/runs/tr10pct2-S7/output_network.xml.gz");
			log.info("analyzing plans");
			BufferedWriter infoFile = IOUtils.getBufferedWriter("/Volumes/Data/VSP/projects/diss/runs/tr10pct2-S7/coords.txt");
			...
			new MatsimPopulationReader(scenario).parse("/Volumes/Data/VSP/projects/diss/runs/tr10pct2-S7/output_plans.xml.gz");
