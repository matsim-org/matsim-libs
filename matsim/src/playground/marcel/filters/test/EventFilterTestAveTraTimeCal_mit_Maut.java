/* *********************************************************************** *
 * project: org.matsim.*
 * EventFilterTestAveTraTimeCal_mit_Maut.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
...
import playground.marcel.filters.filter.finalFilters.AveTraTimeCal;
import playground.marcel.filters.writer.PrintStreamATTA;
...
public class EventFilterTestAveTraTimeCal_mit_Maut {
	...
	public static void testRunAveTraTimeCal() throws IOException {
		...
		PrintStreamUDANET psUdaNet = new PrintStreamUDANET(config.getParam("attribut_aveTraTime", "outputAttNetFile"));
		psUdaNet.output(attc);
		psUdaNet.close();
		System.out.println("\tdone.");

		System.out.println("\tprinting attributsFile of link...");
		PrintStreamATTA psLinkAtt = new PrintStreamLinkATT(config.getParam("attribut_aveTraTime", "outputAttFile"), network);
